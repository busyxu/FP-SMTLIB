...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!74))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!75))
             ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!75) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!75) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FADD_ACCURACY a_ack!75 #x3ff0000000000000))
