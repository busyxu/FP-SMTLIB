...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!16))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!17) ((_ to_fp 11 53) #xbfe0000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 a_ack!17))
