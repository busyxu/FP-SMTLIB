...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!140))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!141) ((_ to_fp 11 53) #xbfe0000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!141))
                           ((_ to_fp 11 53) b_ack!140)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!140))))
