...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!888))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!889) ((_ to_fp 11 53) #x4024000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW #x4026000000000000 a_ack!889))
