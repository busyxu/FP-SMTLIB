...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!142))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!143) ((_ to_fp 11 53) #xbfe0000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!143))
                           ((_ to_fp 11 53) b_ack!142)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!142))))
...
(assert (FPCHECK_FSUB_OVERFLOW b_ack!142 #x3ff0000000000000))
