...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!166))
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fb999999999999a)
                          (fp.abs ((_ to_fp 11 53) a_ack!167))))))
  (not a!1)))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!167))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!167) ((_ to_fp 11 53) #xbfe0000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!167))
                           ((_ to_fp 11 53) b_ack!166)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!166))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!166)
                                   ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW b_ack!166 (CF_log a!3))))))
