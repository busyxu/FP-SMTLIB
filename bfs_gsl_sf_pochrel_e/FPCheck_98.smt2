...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!298))
  ...
  (not a!1)))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!299))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!299))
             ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!299) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!299) ((_ to_fp 11 53) #x0000000000000000)))
