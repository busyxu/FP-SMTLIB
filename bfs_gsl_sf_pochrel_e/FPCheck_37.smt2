...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!118))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!119))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!118)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!119))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!119))))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!119))))))
  (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!118))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!118))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!119))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x3fb999999999999a)))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!118) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!119) ((_ to_fp 11 53) #xbfe0000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 a_ack!119))
