(declare-fun h_ack!1494 () (_ BitVec 64))
(declare-fun x_ack!1495 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) x_ack!1495)
                   (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) h_ack!1494))
...
(let ((a!16 (CF_pow (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (CF_pow (fp.add roundNearestTiesToEven ((_ to_fp 11 53) x_ack!1495) a!15)
            #x3ff8000000000000)
    a!16)))))))))
