(declare-fun h_ack!906 () (_ BitVec 64))
(declare-fun x_ack!907 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) x_ack!907)
                   (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) h_ack!906))
...
(let ((a!16 (CF_pow (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (CF_pow (fp.add roundNearestTiesToEven ((_ to_fp 11 53) x_ack!907) a!15)
            #x3ff8000000000000)
    a!16))))))))))
