(declare-fun h_ack!1190 () (_ BitVec 64))
(declare-fun x_ack!1191 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) x_ack!1191)
                   (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) h_ack!1190))
...
(let ((a!20 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.abs (fp.div roundNearestTiesToEven a!20 a!15))
    (fp.abs (fp.div roundNearestTiesToEven ((_ to_fp 11 53) x_ack!1191) a!15))))))))))))))
