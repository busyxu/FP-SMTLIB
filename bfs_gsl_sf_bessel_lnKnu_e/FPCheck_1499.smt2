...
(assert (fp.lt ((_ to_fp 11 53) b_ack!4221) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!4222) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x400921fb54442d18
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!4222) a!1))))
