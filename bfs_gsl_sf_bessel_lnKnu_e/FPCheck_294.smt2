...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!875))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log b_ack!875)
                                    a!12))
                    (fp.mul roundNearestTiesToEven (CF_log b_ack!875) a!12))))
  (fp.eq a!13 a!7))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3e14c2029d5d2fb5)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log b_ack!875)
                                    a!12)))))
  (fp.eq a!13 (fp.mul roundNearestTiesToEven (CF_log b_ack!875) a!12)))))))))))
(assert (FPCHECK_FADD_OVERFLOW
  #x3ff999999999999a
  (fp.mul roundNearestTiesToEven
          (fp.abs (CF_log b_ack!875))
