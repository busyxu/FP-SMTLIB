...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2675) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2676) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2675) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2676) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2675) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!42 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (CF_exp a!37))
                            a!41))))
  (FPCHECK_FDIV_ACCURACY a!42 a!43)))))))))))))))))))))))
