...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4329) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!4329) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!4330) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4010000000000000
    (fp.abs (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!4330) a!1)))))
