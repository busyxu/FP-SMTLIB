...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4399) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!4399) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!4400) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FADD_OVERFLOW a!5 #x3be598c5460217e6)))))))
