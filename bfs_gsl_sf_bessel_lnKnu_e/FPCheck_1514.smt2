...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4277) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!4277) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!4278) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4277) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4278) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!4277) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!4278)
                                   a!1)))))
  (fp.eq a!2 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!4278) a!1)))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
