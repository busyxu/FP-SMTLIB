...
(assert (fp.lt ((_ to_fp 11 53) b_ack!4171) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!4172) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             ((_ fp.to_sbv 32)
               ...
               (fp.add roundNearestTiesToEven
                       ((_ to_fp 11 53) a_ack!4172)
                       ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FSUB_OVERFLOW a_ack!4172 a!1)))
