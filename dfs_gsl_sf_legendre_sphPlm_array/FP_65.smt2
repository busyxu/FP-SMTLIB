...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
...
(assert (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
       (fp.mul roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323))))
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
            ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
            ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1323)
             ((_ to_fp 11 53) #x4065600000000000))))
