...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!552)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!552)
...
(assert (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
       (fp.mul roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) roundNearestTiesToEven b_ack!552))))
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!552)
