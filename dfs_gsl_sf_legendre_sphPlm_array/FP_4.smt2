...
(assert (bvslt #x00000000 b_ack!39))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!40) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) c_ack!40) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (bvsle b_ack!39 a_ack!41))
(assert (not (bvsle (bvadd #x00000001 b_ack!39) a_ack!41)))
