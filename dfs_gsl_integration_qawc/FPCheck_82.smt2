...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1300) ((_ to_fp 11 53) a_ack!1305))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1301) ((_ to_fp 11 53) a_ack!1305))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1301) ((_ to_fp 11 53) b_ack!1300))))
