...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4240) ((_ to_fp 11 53) a_ack!4245))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4241) ((_ to_fp 11 53) a_ack!4245))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4241) ((_ to_fp 11 53) b_ack!4240))))
