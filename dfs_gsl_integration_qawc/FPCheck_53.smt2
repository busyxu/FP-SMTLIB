...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!868) ((_ to_fp 11 53) a_ack!873))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!869) ((_ to_fp 11 53) a_ack!873))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!869) ((_ to_fp 11 53) b_ack!868))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!873))
...
(assert (not (fp.leq (fp.mul roundNearestTiesToEven
                     ...
                     ((_ to_fp 11 53) a_ack!873))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FINVALID_SQRT a_ack!873 a_ack!873))
