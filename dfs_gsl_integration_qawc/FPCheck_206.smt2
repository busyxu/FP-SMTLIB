...
(declare-fun epsrel_ack!3211 () (_ BitVec 64))
(declare-fun c_ack!3209 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_SQRT
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!3212)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3208) ((_ to_fp 11 53) a_ack!3213))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3210) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3211)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3211)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3209) ((_ to_fp 11 53) a_ack!3213))))
