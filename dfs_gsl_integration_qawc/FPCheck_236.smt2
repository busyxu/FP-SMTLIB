...
(declare-fun b_ack!3640 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3640) ((_ to_fp 11 53) a_ack!3645))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3641) ((_ to_fp 11 53) a_ack!3645))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3641) ((_ to_fp 11 53) b_ack!3640))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) c_ack!3641))
                   ((_ to_fp 11 53) b_ack!3640))))
