...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3820) ((_ to_fp 11 53) a_ack!3825))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3821) ((_ to_fp 11 53) a_ack!3825))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3821) ((_ to_fp 11 53) b_ack!3820))))
