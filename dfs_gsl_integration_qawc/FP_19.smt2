...
(declare-fun epsrel_ack!727 () (_ BitVec 64))
(declare-fun c_ack!725 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!728)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!724) ((_ to_fp 11 53) a_ack!729))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!726) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!727)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!727)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!725) ((_ to_fp 11 53) a_ack!729))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!729))
