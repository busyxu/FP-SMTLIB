...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2380) ((_ to_fp 11 53) a_ack!2385))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2381) ((_ to_fp 11 53) a_ack!2385))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2381) ((_ to_fp 11 53) b_ack!2380))))
