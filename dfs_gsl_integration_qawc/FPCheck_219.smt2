...
(declare-fun epsrel_ack!3415 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3412) ((_ to_fp 11 53) a_ack!3417))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3414) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3415)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3415)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3413) ((_ to_fp 11 53) a_ack!3417))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3413) ((_ to_fp 11 53) b_ack!3412))))
