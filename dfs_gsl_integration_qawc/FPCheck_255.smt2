(declare-fun limit_ack!3932 () (_ BitVec 64))
(declare-fun a_ack!3933 () (_ BitVec 64))
(declare-fun b_ack!3928 () (_ BitVec 64))
(declare-fun epsabs_ack!3930 () (_ BitVec 64))
(declare-fun epsrel_ack!3931 () (_ BitVec 64))
(declare-fun c_ack!3929 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FINVALID_SQRT
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!3932)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3928) ((_ to_fp 11 53) a_ack!3933))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3930) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3931)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3931)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3929) ((_ to_fp 11 53) a_ack!3933))))
