...
(declare-fun nu_ack!2615 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!2616) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!2616) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2616) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2616) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!2616)
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           a!2
                           ((_ to_fp 11 53) #x4000000000000000)))))
  (FPCHECK_FSUB_ACCURACY a!3 #x3ff0000000000000)))))
