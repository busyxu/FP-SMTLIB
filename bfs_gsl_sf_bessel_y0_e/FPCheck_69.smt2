...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!94)) ((_ to_fp 11 53) #x3e60000000000000)))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!94)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) a_ack!94)))
                   (fp.abs ((_ to_fp 11 53) a_ack!94)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) a_ack!94)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!94)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
