...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   (CF_exp b_ack!717))))))
  (not (fp.eq (fp.mul roundNearestTiesToEven (CF_sin a_ack!718) a!1)
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   (CF_exp b_ack!717))))))
(let ((a!3 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven (CF_sin a_ack!718) a!1))
                  (fp.abs (fp.mul roundNearestTiesToEven (CF_cos a_ack!718) a!2)))))
  (not a!3))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.add roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   (CF_exp b_ack!717))))))
  (fp.gt (fp.abs (fp.mul roundNearestTiesToEven (CF_sin a_ack!718) a!1))
         (fp.abs (fp.mul roundNearestTiesToEven (CF_cos a_ack!718) a!2)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   (CF_exp b_ack!717))))))
(let ((a!3 (CF_atan2 (fp.mul roundNearestTiesToEven (CF_cos a_ack!718) a!1)
                     (fp.mul roundNearestTiesToEven (CF_sin a_ack!718) a!2))))
