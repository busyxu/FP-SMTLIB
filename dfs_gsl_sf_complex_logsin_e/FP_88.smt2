...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1691) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1691) ((_ to_fp 11 53) #xc04e000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1691))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!8)
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.eq (fp.mul roundNearestTiesToEven (CF_sin a_ack!1692) a!9)
...
(let ((a!18 (CF_atan2 (fp.mul roundNearestTiesToEven
                              ...
                              (fp.mul roundNearestTiesToEven
                                      ((_ to_fp 11 53) b_ack!1691)
                                      a!8))
                      (fp.mul roundNearestTiesToEven (CF_sin a_ack!1692) a!17))))
...
(let ((a!18 (CF_atan2 (fp.mul roundNearestTiesToEven
                              ...
                              (fp.mul roundNearestTiesToEven
                                      ...
                                      a!8))
                      (fp.mul roundNearestTiesToEven (CF_sin a_ack!1692) a!17))))
  (fp.gt (fp.abs a!18) ((_ to_fp 11 53) #x42f0000000000000)))))))))))))
