...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1208) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1208) ((_ to_fp 11 53) #xc04e000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1208))
...
(let ((a!9 (fp.abs (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!1208)
                                   a!8)))))
  (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 a!9)))))))))))
