...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1889) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1889) ((_ to_fp 11 53) #xc04e000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1889))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!8)
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.eq (fp.mul roundNearestTiesToEven (CF_sin a_ack!1890) a!9)
...
(let ((a!9 (fp.add roundNearestTiesToEven
      ...
      (a!18 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) b_ack!1889)
                                    a!17)))))
  (fp.gt (fp.abs (fp.mul roundNearestTiesToEven (CF_sin a_ack!1890) a!9)) a!18)))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3d6ae7f3e733b81f)
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!18 (CF_atan2 (fp.mul roundNearestTiesToEven
                              ...
                              (fp.mul roundNearestTiesToEven
                                      ((_ to_fp 11 53) b_ack!1889)
                                      a!8))
                      (fp.mul roundNearestTiesToEven (CF_sin a_ack!1890) a!17))))
