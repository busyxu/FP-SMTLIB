...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!61) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!61) ((_ to_fp 11 53) #xc04e000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3cc0000000000000
    (fp.abs (fp.mul roundNearestTiesToEven (CF_sin a_ack!62) a!1)))))
