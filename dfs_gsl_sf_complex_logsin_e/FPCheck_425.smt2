...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1321) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1321) ((_ to_fp 11 53) #xc04e000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1321))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!8)
                   ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!10 (not (fp.eq (fp.mul roundNearestTiesToEven (CF_sin a_ack!1322) a!9)
...
(let ((a!9 (fp.add roundNearestTiesToEven
      ...
      (a!18 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) b_ack!1321)
                                    a!17)))))
  (fp.lt (fp.abs (fp.mul roundNearestTiesToEven (CF_sin a_ack!1322) a!9)) a!18)))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3d2ae7f3e733b81f)
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
