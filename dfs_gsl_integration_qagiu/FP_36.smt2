(declare-fun limit_ack!1013 () (_ BitVec 64))
(declare-fun epsabs_ack!1012 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!1014 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!1013)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!1012)
