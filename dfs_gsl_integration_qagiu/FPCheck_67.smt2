(declare-fun limit_ack!551 () (_ BitVec 64))
(declare-fun epsabs_ack!549 () (_ BitVec 64))
(declare-fun epsrel_ack!550 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!552 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!551)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!549) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!550)
