...
(declare-fun epsrel_ack!400 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!402 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!401)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!399) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!400)
