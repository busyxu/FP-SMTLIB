...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!152))
       ((_ to_fp 11 53) #x4024000000000000)))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!152)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) a_ack!152)))
                   (fp.abs ((_ to_fp 11 53) a_ack!152)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) a_ack!152)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!152)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3f95995995995996)
                                   a!1)))))
  (FPCHECK_FADD_UNDERFLOW #x3f71111111111111 a!2))))
