...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1292) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1292) ((_ to_fp 11 53) #x41dfffffff800000)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) roundNearestTiesToEven a!2))
                   a!3)))
  (fp.eq (CF_log a!4) ((_ to_fp 11 53) #x0000000000000000))))))
