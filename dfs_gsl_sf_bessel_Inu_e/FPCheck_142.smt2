...
(assert (fp.eq ((_ to_fp 11 53) a_ack!518) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!517) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!517) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (CF_exp (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
