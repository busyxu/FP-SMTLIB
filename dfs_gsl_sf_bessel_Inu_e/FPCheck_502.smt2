...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1938) ((_ to_fp 11 53) #x41dfffffff800000)))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1937) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1937) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (CF_floor (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) a_ack!1938)
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_exp (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) b_ack!1937))))))
  (FPCHECK_FADD_UNDERFLOW b_ack!1937 (CF_log (fp.abs a!5))))))))
