...
(assert (bvsle #x00000001 b_ack!801))
(assert (bvsle #x00000002 b_ack!801))
(assert (bvsle #x00000003 b_ack!801))
(assert (bvsle #x00000004 b_ack!801))
(assert (not (bvsle #x00000005 b_ack!801)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000003 b_ack!801)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_ACCURACY c_ack!802 a!1)))
