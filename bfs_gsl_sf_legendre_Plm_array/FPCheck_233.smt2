...
(assert (bvslt #x00000000 b_ack!1227))
...
(assert (bvsle #x00000001 b_ack!1227))
(assert (bvsle #x00000002 b_ack!1227))
(assert (bvsle #x00000003 b_ack!1227))
(assert (bvsle #x00000004 b_ack!1227))
(assert (not (bvsle #x00000005 b_ack!1227)))
...
(assert (bvsle (bvadd #x00000005 b_ack!1227) a_ack!1229))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000003 b_ack!1227)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!5 (fp.sub roundNearestTiesToEven
      ...
      (a!6 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1227 b_ack!1227)))
                   (fp.mul roundNearestTiesToEven
                           a!3
                           ((_ to_fp 11 53) #x405a400000000000)))))
(let ((a!7 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000004 (bvadd b_ack!1227 b_ack!1227)))
