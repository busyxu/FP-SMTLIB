...
(assert (bvsle #x00000002 b_ack!756))
(assert (bvsle #x00000003 b_ack!756))
(assert (bvsle #x00000004 b_ack!756))
(assert (not (bvsle #x00000005 b_ack!756)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 b_ack!756 b_ack!756))
                           ((_ to_fp 11 53) #x405a400000000000)))))
