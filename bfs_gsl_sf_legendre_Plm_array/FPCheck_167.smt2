...
(assert (bvslt #x00000000 b_ack!861))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!862) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!862) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (bvsle #x00000001 b_ack!861))
(assert (not (bvsle #x00000002 b_ack!861)))
(assert (not (= a_ack!863 b_ack!861)))
(assert (not (= a_ack!863 (bvadd #x00000001 b_ack!861))))
(assert (bvsle (bvadd #x00000002 b_ack!861) a_ack!863))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!861)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!862) a!1)
    (fp.mul roundNearestTiesToEven a!2 ((_ to_fp 11 53) #xbff0000000000000)))))
