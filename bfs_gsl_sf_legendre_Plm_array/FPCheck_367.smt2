...
(assert (bvsle (bvadd #x00000005 b_ack!1974) a_ack!1976))
(assert (bvsle (bvadd #x00000006 b_ack!1974) a_ack!1976))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000006 b_ack!1974))))
