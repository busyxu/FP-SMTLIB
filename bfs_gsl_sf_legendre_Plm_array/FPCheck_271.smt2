...
(assert (not (= a_ack!1448 b_ack!1446)))
(assert (not (= a_ack!1448 (bvadd #x00000001 b_ack!1446))))
(assert (bvsle (bvadd #x00000002 b_ack!1446) a_ack!1448))
(assert (bvsle (bvadd #x00000003 b_ack!1446) a_ack!1448))
(assert (bvsle (bvadd #x00000004 b_ack!1446) a_ack!1448))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!1446)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      ...
      (a!3 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!1446 b_ack!1446)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000003 (bvadd b_ack!1446 b_ack!1446)))
