...
(assert (bvslt #x00000000 b_ack!1161))
...
(assert (bvsle #x00000001 b_ack!1161))
(assert (bvsle #x00000002 b_ack!1161))
(assert (bvsle #x00000003 b_ack!1161))
(assert (bvsle #x00000004 b_ack!1161))
(assert (not (bvsle #x00000005 b_ack!1161)))
...
(assert (bvsle (bvadd #x00000005 b_ack!1161) a_ack!1163))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000005 b_ack!1161))))
