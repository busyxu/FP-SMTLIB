...
(assert (bvsle (bvadd #x00000004 b_ack!1746) a_ack!1748))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 b_ack!1746))))
