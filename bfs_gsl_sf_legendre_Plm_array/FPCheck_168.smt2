...
(assert (bvsle #x00000001 b_ack!867))
(assert (not (bvsle #x00000002 b_ack!867)))
(assert (not (= a_ack!869 b_ack!867)))
(assert (not (= a_ack!869 (bvadd #x00000001 b_ack!867))))
(assert (bvsle (bvadd #x00000002 b_ack!867) a_ack!869))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!867)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!868) a!1)
