...
(assert (bvslt #x00000000 b_ack!1050))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1051) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1051) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (not (= #x00000000 b_ack!1050)))
(assert (bvsle #x00000001 b_ack!1050))
(assert (bvsle #x00000002 b_ack!1050))
(assert (bvsle #x00000003 b_ack!1050))
(assert (bvsle #x00000004 b_ack!1050))
(assert (not (bvsle #x00000005 b_ack!1050)))
...
(assert (bvsle (bvadd #x00000004 b_ack!1050) a_ack!1052))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 b_ack!1050))))
