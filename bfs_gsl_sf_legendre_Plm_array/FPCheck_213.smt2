...
(assert (bvsle #x00000001 b_ack!1122))
(assert (bvsle #x00000002 b_ack!1122))
(assert (bvsle #x00000003 b_ack!1122))
(assert (bvsle #x00000004 b_ack!1122))
(assert (not (bvsle #x00000005 b_ack!1122)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
      ...
      (a!3 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!1122 b_ack!1122)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000003 (bvadd b_ack!1122 b_ack!1122)))
