...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!671 b_ack!669))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!671 b_ack!669))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!671 b_ack!669))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!669))
(assert (not (bvsle #x00000002 b_ack!669)))
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53)
                                     ...
                                     b_ack!669))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FMUL_OVERFLOW a!1 #xbff0000000000000)))
