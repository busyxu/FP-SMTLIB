...
(assert (bvsle (bvadd #x00000007 b_ack!2214) a_ack!2216))
(assert (bvsle (bvadd #x00000008 b_ack!2214) a_ack!2216))
(assert (FPCHECK_FSUB_UNDERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000008 b_ack!2214)))
  #x3ff0000000000000))
