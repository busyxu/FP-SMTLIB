...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!992 b_ack!990))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!992 b_ack!990))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!992 b_ack!990))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!990))
...
(assert (bvsle #x00000001 b_ack!990))
(assert (bvsle #x00000002 b_ack!990))
(assert (bvsle #x00000003 b_ack!990))
(assert (bvsle #x00000004 b_ack!990))
(assert (not (bvsle #x00000005 b_ack!990)))
(assert (not (= a_ack!992 b_ack!990)))
(assert (not (= a_ack!992 (bvadd #x00000001 b_ack!990))))
(assert (bvsle (bvadd #x00000002 b_ack!990) a_ack!992))
(assert (bvsle (bvadd #x00000003 b_ack!990) a_ack!992))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000002 b_ack!990 b_ack!990))
