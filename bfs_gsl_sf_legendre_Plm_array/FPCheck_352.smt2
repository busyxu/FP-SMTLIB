...
(assert (bvsle (bvadd #x00000004 b_ack!1872) a_ack!1874))
(assert (bvsle (bvadd #x00000005 b_ack!1872) a_ack!1874))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000005 b_ack!1872)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_OVERFLOW c_ack!1873 a!1)))
