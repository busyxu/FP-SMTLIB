...
(assert (bvsle (bvadd #x00000005 b_ack!1986) a_ack!1988))
(assert (bvsle (bvadd #x00000006 b_ack!1986) a_ack!1988))
(assert (FPCHECK_FSUB_UNDERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000006 b_ack!1986)))
  #x3ff0000000000000))
