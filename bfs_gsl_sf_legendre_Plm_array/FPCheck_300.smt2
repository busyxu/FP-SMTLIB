...
(assert (not (bvslt #x00000000 b_ack!1605)))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (not (= a_ack!1607 b_ack!1605)))
(assert (not (= a_ack!1607 (bvadd #x00000001 b_ack!1605))))
(assert (bvsle (bvadd #x00000002 b_ack!1605) a_ack!1607))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!1605)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1606) a!1)
            (fp.mul roundNearestTiesToEven
                    a!2
                    ((_ to_fp 11 53) #x3ff0000000000000)))
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvadd #x00000001 b_ack!1605 b_ack!1605))
            ((_ to_fp 11 53) #x3ff0000000000000)))))
