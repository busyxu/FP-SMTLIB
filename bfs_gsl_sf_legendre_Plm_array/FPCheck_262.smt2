...
(assert (bvsle #x00000001 b_ack!1395))
(assert (not (bvsle #x00000002 b_ack!1395)))
(assert (not (= a_ack!1397 b_ack!1395)))
(assert (not (= a_ack!1397 (bvadd #x00000001 b_ack!1395))))
(assert (bvsle (bvadd #x00000002 b_ack!1395) a_ack!1397))
(assert (bvsle (bvadd #x00000003 b_ack!1395) a_ack!1397))
(assert (bvsle (bvadd #x00000004 b_ack!1395) a_ack!1397))
(assert (FPCHECK_FSUB_OVERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 b_ack!1395)))
  #x3ff0000000000000))
