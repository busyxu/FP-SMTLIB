...
(assert (bvsle #x00000002 b_ack!1164))
(assert (bvsle #x00000003 b_ack!1164))
(assert (bvsle #x00000004 b_ack!1164))
(assert (not (bvsle #x00000005 b_ack!1164)))
...
(assert (FPCHECK_FMUL_UNDERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000005 b_ack!1164))))
