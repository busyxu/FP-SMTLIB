...
(assert (bvsle (bvadd #x00000005 b_ack!1995) a_ack!1997))
(assert (bvsle (bvadd #x00000006 b_ack!1995) a_ack!1997))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000006 b_ack!1995)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!1996 a!1)))
