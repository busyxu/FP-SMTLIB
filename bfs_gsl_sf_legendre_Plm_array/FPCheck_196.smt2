...
(assert (bvsle #x00000001 b_ack!1029))
(assert (bvsle #x00000002 b_ack!1029))
(assert (bvsle #x00000003 b_ack!1029))
(assert (bvsle #x00000004 b_ack!1029))
(assert (not (bvsle #x00000005 b_ack!1029)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!1029 b_ack!1029)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
      ...
      (a!6 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1029 b_ack!1029)))
                   (fp.mul roundNearestTiesToEven
                           a!3
                           ((_ to_fp 11 53) #x405a400000000000)))))
