...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!692 b_ack!690))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!692 b_ack!690))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!692 b_ack!690))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!690))
(assert (not (bvsle #x00000002 b_ack!690)))
(assert (not (= a_ack!692 b_ack!690)))
(assert (not (= a_ack!692 (bvadd #x00000001 b_ack!690))))
(assert (bvsle (bvadd #x00000002 b_ack!690) a_ack!692))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000002 b_ack!690))))
