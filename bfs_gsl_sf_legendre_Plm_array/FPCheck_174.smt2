...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!902 b_ack!900))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!902 b_ack!900))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!902 b_ack!900))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!900))
(assert (not (bvsle #x00000002 b_ack!900)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!901) a!1)
            (fp.mul roundNearestTiesToEven
                    a!2
    ...
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvadd #x00000001 b_ack!900 b_ack!900))
            ((_ to_fp 11 53) #xbff0000000000000)))))
