...
(assert (bvslt #x00000000 b_ack!882))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!883) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!883) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (bvsle #x00000001 b_ack!882))
(assert (not (bvsle #x00000002 b_ack!882)))
(assert (not (= a_ack!884 b_ack!882)))
(assert (not (= a_ack!884 (bvadd #x00000001 b_ack!882))))
(assert (bvsle (bvadd #x00000002 b_ack!882) a_ack!884))
(assert (FPCHECK_FMUL_UNDERFLOW
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 b_ack!882 b_ack!882))
  #xbff0000000000000))
