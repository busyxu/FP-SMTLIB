...
(assert (bvsle #x00000001 b_ack!1107))
(assert (bvsle #x00000002 b_ack!1107))
(assert (bvsle #x00000003 b_ack!1107))
(assert (bvsle #x00000004 b_ack!1107))
(assert (not (bvsle #x00000005 b_ack!1107)))
