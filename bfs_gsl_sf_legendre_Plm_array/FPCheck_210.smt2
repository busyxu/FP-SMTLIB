...
(assert (bvsle #x00000002 b_ack!1101))
(assert (bvsle #x00000003 b_ack!1101))
(assert (bvsle #x00000004 b_ack!1101))
(assert (not (bvsle #x00000005 b_ack!1101)))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1102) a!1)
