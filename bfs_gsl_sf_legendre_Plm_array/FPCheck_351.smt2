...
(assert (bvsle (bvadd #x00000004 b_ack!1869) a_ack!1871))
(assert (bvsle (bvadd #x00000005 b_ack!1869) a_ack!1871))
(assert (FPCHECK_FSUB_ACCURACY
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000005 b_ack!1869)))
  #x3ff0000000000000))
