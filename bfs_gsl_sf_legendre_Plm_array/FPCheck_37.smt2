...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!169 b_ack!167))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!169 b_ack!167))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt b_ack!167 #x00000000)))
(assert (not (bvslt a_ack!169 b_ack!167)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!168) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!168) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000000 b_ack!167))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!168) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!168) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (not (bvsle #x00000002 b_ack!167)))
(assert (FPCHECK_FMUL_UNDERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven b_ack!167)))
