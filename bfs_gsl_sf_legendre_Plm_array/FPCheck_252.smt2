...
(assert (not (bvslt a_ack!1334 b_ack!1332)))
...
(assert (bvslt #x00000000 b_ack!1332))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1333) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1333) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (bvsle #x00000001 b_ack!1332))
(assert (not (bvsle #x00000002 b_ack!1332)))
(assert (not (= a_ack!1334 b_ack!1332)))
(assert (not (= a_ack!1334 (bvadd #x00000001 b_ack!1332))))
(assert (bvsle (bvadd #x00000002 b_ack!1332) a_ack!1334))
(assert (bvsle (bvadd #x00000003 b_ack!1332) a_ack!1334))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000002 b_ack!1332 b_ack!1332))
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #xbff0000000000000)))))
