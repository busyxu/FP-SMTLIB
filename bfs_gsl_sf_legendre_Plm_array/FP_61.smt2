...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!965 b_ack!963))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!965 b_ack!963))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!965 b_ack!963))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!963))
...
(assert (bvsle #x00000001 b_ack!963))
(assert (bvsle #x00000002 b_ack!963))
(assert (bvsle #x00000003 b_ack!963))
(assert (bvsle #x00000004 b_ack!963))
(assert (not (bvsle #x00000005 b_ack!963)))
