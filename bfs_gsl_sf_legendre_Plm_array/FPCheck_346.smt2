...
(assert (bvsle (bvadd #x00000004 b_ack!1854) a_ack!1856))
(assert (bvsle (bvadd #x00000005 b_ack!1854) a_ack!1856))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000005 b_ack!1854))))
