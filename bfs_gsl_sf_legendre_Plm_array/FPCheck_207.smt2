...
(assert (bvsle #x00000002 b_ack!1080))
(assert (bvsle #x00000003 b_ack!1080))
(assert (bvsle #x00000004 b_ack!1080))
(assert (not (bvsle #x00000005 b_ack!1080)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_ACCURACY c_ack!1081 a!1)))
