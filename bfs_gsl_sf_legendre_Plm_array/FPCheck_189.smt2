...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!980 b_ack!978))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!980 b_ack!978))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!980 b_ack!978))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!978))
...
(assert (bvsle #x00000001 b_ack!978))
(assert (bvsle #x00000002 b_ack!978))
(assert (bvsle #x00000003 b_ack!978))
(assert (bvsle #x00000004 b_ack!978))
(assert (not (bvsle #x00000005 b_ack!978)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 b_ack!978 b_ack!978))
                           ((_ to_fp 11 53) #x405a400000000000)))))
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!979) a!1)
