...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!971 b_ack!969))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!971 b_ack!969))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!971 b_ack!969))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!969))
...
(assert (bvsle #x00000001 b_ack!969))
(assert (bvsle #x00000002 b_ack!969))
(assert (bvsle #x00000003 b_ack!969))
(assert (bvsle #x00000004 b_ack!969))
(assert (not (bvsle #x00000005 b_ack!969)))
(assert (not (= a_ack!971 b_ack!969)))
(assert (not (= a_ack!971 (bvadd #x00000001 b_ack!969))))
(assert (bvsle (bvadd #x00000002 b_ack!969) a_ack!971))
(assert (bvsle (bvadd #x00000003 b_ack!969) a_ack!971))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000003 b_ack!969)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 b_ack!969 b_ack!969))
                           ((_ to_fp 11 53) #x405a400000000000)))))
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!970) a!1)
