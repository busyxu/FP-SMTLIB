...
(assert (bvsle #x00000001 b_ack!1248))
(assert (bvsle #x00000002 b_ack!1248))
(assert (bvsle #x00000003 b_ack!1248))
(assert (bvsle #x00000004 b_ack!1248))
(assert (not (bvsle #x00000005 b_ack!1248)))
...
(assert (bvsle (bvadd #x00000005 b_ack!1248) a_ack!1250))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000005 b_ack!1248)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!7 (fp.sub roundNearestTiesToEven
      ...
      (a!8 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1248 b_ack!1248)))
                   (fp.mul roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x405a400000000000)))))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
      ...
      (a!12 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000004 (bvadd b_ack!1248 b_ack!1248)))
                    (fp.div roundNearestTiesToEven
                            a!9
                            ((_ to_fp 11 53) #x4008000000000000)))))
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1249) a!1)
            (fp.div roundNearestTiesToEven
                    a!11
