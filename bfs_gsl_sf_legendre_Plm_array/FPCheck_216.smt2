...
(assert (bvslt #x00000000 b_ack!1143))
...
(assert (bvsle #x00000001 b_ack!1143))
(assert (bvsle #x00000002 b_ack!1143))
(assert (bvsle #x00000003 b_ack!1143))
(assert (bvsle #x00000004 b_ack!1143))
(assert (not (bvsle #x00000005 b_ack!1143)))
