...
(assert (bvsle #x00000001 b_ack!1428))
(assert (not (bvsle #x00000002 b_ack!1428)))
(assert (not (= a_ack!1430 b_ack!1428)))
(assert (not (= a_ack!1430 (bvadd #x00000001 b_ack!1428))))
(assert (bvsle (bvadd #x00000002 b_ack!1428) a_ack!1430))
(assert (bvsle (bvadd #x00000003 b_ack!1428) a_ack!1430))
(assert (bvsle (bvadd #x00000004 b_ack!1428) a_ack!1430))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000004 b_ack!1428)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!1428 b_ack!1428)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
      ...
      (a!7 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1428 b_ack!1428)))
                   (fp.mul roundNearestTiesToEven
                           a!4
                           ((_ to_fp 11 53) #xbff0000000000000)))))
(let ((a!8 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1429) a!1)
