...
(assert (bvsle #x00000002 b_ack!1065))
(assert (bvsle #x00000003 b_ack!1065))
(assert (bvsle #x00000004 b_ack!1065))
(assert (not (bvsle #x00000005 b_ack!1065)))
...
(assert (FPCHECK_FSUB_UNDERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 b_ack!1065)))
  #x3ff0000000000000))
