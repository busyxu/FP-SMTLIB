...
(declare-fun epsabs_ack!3841 () (_ BitVec 64))
(declare-fun epsrel_ack!3842 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3841) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3842)
...
(let ((a!38 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!37))))
  (FPCHECK_FMUL_ACCURACY a!38 (fp.abs a!3)))))))))))
