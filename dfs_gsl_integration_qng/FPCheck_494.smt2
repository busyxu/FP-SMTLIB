...
(declare-fun epsrel_ack!3894 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3893) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3894)
...
(let ((a!37 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3fe0000000000000)
                                    a!36)))))
  (FPCHECK_FMUL_OVERFLOW #x3fc321082b7cd10f a!37)))))))))
