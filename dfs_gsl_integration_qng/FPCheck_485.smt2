(declare-fun a_ack!3827 () (_ BitVec 64))
(declare-fun b_ack!3824 () (_ BitVec 64))
(declare-fun epsabs_ack!3825 () (_ BitVec 64))
(declare-fun epsrel_ack!3826 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!3827))))))
  (not (fp.leq a!1 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3825) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3826)
...
(let ((a!38 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!37))))
  (FPCHECK_FMUL_OVERFLOW a!38 (fp.abs a!3)))))))))))
