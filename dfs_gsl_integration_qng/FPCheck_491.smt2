...
(declare-fun epsrel_ack!3874 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3873) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3874)
...
(let ((a!36 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    a!2
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fe0000000000000) a!36)))))))))
