...
(declare-fun epsabs_ack!3857 () (_ BitVec 64))
(declare-fun epsrel_ack!3858 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3857) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3858)
...
(let ((a!36 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!32)
                    a!35)))
  (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 a!36))))))))
