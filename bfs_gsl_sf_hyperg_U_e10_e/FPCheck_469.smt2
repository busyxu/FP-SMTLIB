...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2077)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2078) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2078) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2078) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) roundNearestTiesToEven a!2))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_ACCURACY #x3fa0163058fbcc17 a!3))))
