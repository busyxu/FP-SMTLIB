...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1868) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1867)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1868) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1868) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1868) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) roundNearestTiesToEven a!2))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FADD_UNDERFLOW a!3 #xbff007228b4cd147))))
