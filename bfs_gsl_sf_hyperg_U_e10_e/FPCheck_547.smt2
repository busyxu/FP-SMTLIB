...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2464)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2465) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2465) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2465) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
             ...
             (CF_floor (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) a_ack!2466)
                               ((_ to_fp 11 53) #x3fe0000000000000))))))
  (not (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a!1)
              ((_ to_fp 11 53) #x0000000000000000)))))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
             (CF_floor (fp.add roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) roundNearestTiesToEven a!1))
                           ((_ to_fp 11 53) roundNearestTiesToEven a!2)))))
  (FPCHECK_FADD_OVERFLOW ((_ to_fp 11 53) roundNearestTiesToEven a!1) a!3))))
