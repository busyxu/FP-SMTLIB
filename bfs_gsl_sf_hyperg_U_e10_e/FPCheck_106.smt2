...
(assert (fp.geq ((_ to_fp 11 53) b_ack!490) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!492) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!492) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!492))
...
(assert (FPCHECK_FMUL_OVERFLOW #x3fefae147ae147ae (fp.abs ((_ to_fp 11 53) c_ack!491))))
