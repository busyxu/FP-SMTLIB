(declare-fun c_ack!4088 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_ZERO
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4088) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_floor (fp.add roundNearestTiesToEven
                                     ...
                                     ((_ to_fp 11 53) #x3fe0000000000000))))))
  (not (fp.lt (fp.abs a!1) ((_ to_fp 11 53) #x3d4f400000000000)))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4088) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4087) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!4088))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x4000000000000000)
                       ((_ to_fp 11 53) b_ack!4087))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!4088))))))
(assert (fp.leq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) #x4000000000000000)
                ((_ to_fp 11 53) b_ack!4087))
        ((_ to_fp 11 53) c_ack!4088)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           ((_ to_fp 11 53) a_ack!4089))
