(declare-fun c_ack!2129 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2129) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2130) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2129) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2128)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2129) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2129) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2129) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!3
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) #x3f93c8855b9a90b0) a!4))))))
