...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2419)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2420) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2420) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2420) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!4 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) roundNearestTiesToEven a!2))
                           a!3))))
  (not (fp.lt a!4 ((_ to_fp 11 53) #x3d19000000000000)))))))
