...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2389)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2390) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2390) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2390) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!4 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FADD_UNDERFLOW #x3feffffffffff950 a!4)))))
