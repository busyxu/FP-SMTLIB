...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1747)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1748) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1748) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1748) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x8000000000000000)
                           ((_ to_fp 11 53) roundNearestTiesToEven a!1)))))
  (FPCHECK_FMUL_UNDERFLOW #x400921fb54442d18 a!3))))
