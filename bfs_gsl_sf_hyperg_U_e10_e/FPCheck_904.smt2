...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!4002) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4001) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4000) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x4000000000000000)
                       ((_ to_fp 11 53) b_ack!4000))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!4001))))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!1)
                   ((_ to_fp 11 53) c_ack!4001))))
  (FPCHECK_FSUB_UNDERFLOW a!2 #x4018000000000000))))
