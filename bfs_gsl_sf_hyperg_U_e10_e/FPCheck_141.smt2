...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!694) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x4000000000000000)
                       ((_ to_fp 11 53) b_ack!694))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!695))))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x4000000000000000)
                     ((_ to_fp 11 53) b_ack!694))
             ((_ to_fp 11 53) c_ack!695))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           ((_ to_fp 11 53) a_ack!696))
