...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1443) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000013 a_ack!1444))
(assert (bvsle #x00000014 a_ack!1444))
(assert (bvsle #x00000015 a_ack!1444))
(assert (bvsle #x00000016 a_ack!1444))
