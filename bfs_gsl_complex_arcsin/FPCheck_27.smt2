...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!89)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) y_ack!89)))
                   (fp.abs ((_ to_fp 11 53) y_ack!89)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) y_ack!89)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!89)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 (fp.abs ((_ to_fp 11 53) x_ack!90))))
