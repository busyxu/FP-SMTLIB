...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x6a9965fea53d6d85)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!614) ((_ to_fp 11 53) #x4010000000000000)))
(assert (not (= #x00000000 (bvand b_ack!613 #x00000007))))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!6
                                    ((_ to_fp 11 53) #xbe08f67c36e09364))))))
  (fp.eq a!11 ((_ to_fp 11 53) #x3e40172435916640))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4021805a83b66b50)
                           (fp.mul roundNearestTiesToEven
...
(let ((a!11 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    a!11
    (fp.add roundNearestTiesToEven a!8 ((_ to_fp 11 53) #x3e13126b6a961275)))))))))))))))
