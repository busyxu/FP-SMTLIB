...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!366)))
                  ((_ to_fp 11 53) #x3e60000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!366)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!366))))))
