...
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!316)))
                  ((_ to_fp 11 53) #x3e60000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!316)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!316))))))
