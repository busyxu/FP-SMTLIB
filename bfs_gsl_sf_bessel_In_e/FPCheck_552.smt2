...
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!869)))
                  ((_ to_fp 11 53) #x3e60000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!869)))
                   ((_ to_fp 11 53) #x4008000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!869)))
                   ((_ to_fp 11 53) #x4020000000000000))))
  (not a!1)))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!869))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4030000000000000)
                   (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!869))))))
...
(let ((a!53 (fp.div roundNearestTiesToEven
      ...
      (a!57 (fp.mul roundNearestTiesToEven
                    (CF_exp (fp.abs ((_ to_fp 11 53) b_ack!869)))
                    a!55)))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3cc0000000000000)
                                    (fp.abs a!55))))))
  (FPCHECK_FADD_OVERFLOW a!56 a!58))))))))))))))))))))))))))))))
