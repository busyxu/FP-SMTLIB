...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3449))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3448)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3449)))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!3449))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!3448) a!1))))
...
(let ((a!178 (fp.add roundNearestTiesToEven
      ...
      (a!180 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.div roundNearestTiesToEven
                             a!179
                             ((_ to_fp 11 53) b_ack!3448)))))
  (FPCHECK_FADD_OVERFLOW a!178 a!180))))))))))))))))))))))))))))))))))))))))))))))))
