...
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!2083))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2082)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!2083)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!2083)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!2083)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!2082)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!2083))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!2082) a!1))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (bvadd #xffffffce
                    ((_ fp.to_sbv 32)
                      roundTowardZero
                      ((_ to_fp 11 53) a_ack!2083))))))
  (FPCHECK_FDIV_OVERFLOW a!1 b_ack!2082)))
