...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1161))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1160) a!1))))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven
            a!30
            (fp.div roundNearestTiesToEven a!31 ((_ to_fp 11 53) b_ack!1160)))
    (fp.div roundNearestTiesToEven a!32 ((_ to_fp 11 53) b_ack!1160)))))))))))))))
