...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1357))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1356) a!1))))
...
(let ((a!39 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!39
            (fp.div roundNearestTiesToEven a!40 ((_ to_fp 11 53) b_ack!1356)))
    (fp.div roundNearestTiesToEven a!41 ((_ to_fp 11 53) b_ack!1356))))))))))))))))))
