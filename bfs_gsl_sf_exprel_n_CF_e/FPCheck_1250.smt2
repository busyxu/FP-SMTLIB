...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3909))
            #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3908) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!3909))))))
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3908)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3909)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3909)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3909)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!3908)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!3909))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!3908) a!1))))
...
(let ((a!153 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!153
            (fp.div roundNearestTiesToEven a!154 ((_ to_fp 11 53) b_ack!3908)))
    (fp.div roundNearestTiesToEven a!155 ((_ to_fp 11 53) b_ack!3908))))))))))))))))))))))))))))))))))))))))))))))))))))))))
