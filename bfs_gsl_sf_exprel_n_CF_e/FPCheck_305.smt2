...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1021))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1020) a!1))))
...
(let ((a!24 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            a!24
            (fp.div roundNearestTiesToEven a!25 ((_ to_fp 11 53) b_ack!1020)))
    (fp.div roundNearestTiesToEven a!26 ((_ to_fp 11 53) b_ack!1020)))))))))))))
