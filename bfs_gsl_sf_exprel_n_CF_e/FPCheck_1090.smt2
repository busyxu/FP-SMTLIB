...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3419))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3418)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3419)))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!3419))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!3418) a!1))))
...
(let ((a!174 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            a!176
            (fp.div roundNearestTiesToEven a!177 ((_ to_fp 11 53) b_ack!3418))))))))))))))))))))))))))))))))))))))))))))))))))
