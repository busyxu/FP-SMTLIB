...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4517))
            #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4516) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!4516)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4517)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4517)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4517)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!4516)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4517))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!4516) a!1))))
...
(let ((a!180 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            a!180
            (fp.div roundNearestTiesToEven a!181 ((_ to_fp 11 53) b_ack!4516)))
    (fp.div roundNearestTiesToEven a!182 ((_ to_fp 11 53) b_ack!4516)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
