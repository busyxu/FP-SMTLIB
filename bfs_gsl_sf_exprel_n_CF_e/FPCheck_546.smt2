...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1763))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1762) a!1))))
...
(let ((a!57 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!57
            (fp.div roundNearestTiesToEven a!58 ((_ to_fp 11 53) b_ack!1762)))
    (fp.div roundNearestTiesToEven a!59 ((_ to_fp 11 53) b_ack!1762))))))))))))))))))))))))
