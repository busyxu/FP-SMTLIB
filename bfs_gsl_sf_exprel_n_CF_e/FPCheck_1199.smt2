...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3755))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3754)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3755)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3755)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!3755)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!3754)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!3755))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!3754) a!1))))
...
(let ((a!194 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            a!196
            (fp.div roundNearestTiesToEven a!197 ((_ to_fp 11 53) b_ack!3754)))))))))))))))))))))))))))))))))))))))))))))))))))))))
