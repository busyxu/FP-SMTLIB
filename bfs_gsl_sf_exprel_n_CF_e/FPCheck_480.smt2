...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!1561))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1561))))))
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1560)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!1561)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!1561)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!1561)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!1560)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1561))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1560) a!1))))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!48
            (fp.div roundNearestTiesToEven a!49 ((_ to_fp 11 53) b_ack!1560)))
    (fp.div roundNearestTiesToEven a!50 ((_ to_fp 11 53) b_ack!1560)))))))))))))))))))))
