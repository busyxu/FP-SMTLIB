...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1835))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1834) a!1))))
...
(let ((a!60 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven
            a!60
            (fp.div roundNearestTiesToEven a!61 ((_ to_fp 11 53) b_ack!1834)))
    (fp.div roundNearestTiesToEven a!62 ((_ to_fp 11 53) b_ack!1834)))))))))))))))))))))))))
