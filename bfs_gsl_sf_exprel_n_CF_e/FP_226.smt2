...
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4189))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!4188)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4189)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4189)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4189)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!4188)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4189))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!4188) a!1))))
