...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1495))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1494) a!1))))
...
(let ((a!45 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            a!45
            (fp.div roundNearestTiesToEven a!46 ((_ to_fp 11 53) b_ack!1494)))
    (fp.div roundNearestTiesToEven a!47 ((_ to_fp 11 53) b_ack!1494))))))))))))))))))))
