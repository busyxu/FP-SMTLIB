...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!885))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!884) a!1))))
...
(let ((a!18 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            a!18
            (fp.div roundNearestTiesToEven a!19 ((_ to_fp 11 53) b_ack!884)))
    (fp.div roundNearestTiesToEven a!20 ((_ to_fp 11 53) b_ack!884)))))))))))
