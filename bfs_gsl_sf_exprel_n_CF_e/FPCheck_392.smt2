...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1291))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1290) a!1))))
...
(let ((a!36 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!36
            (fp.div roundNearestTiesToEven a!37 ((_ to_fp 11 53) b_ack!1290)))
    (fp.div roundNearestTiesToEven a!38 ((_ to_fp 11 53) b_ack!1290)))))))))))))))))
