...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4659))
            #x00000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4659))))))
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!4658)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4659)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4659)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4659)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!4658)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4659))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!4658) a!1))))
...
(let ((a!250 (fp.add roundNearestTiesToEven
      ...
      (a!252 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.div roundNearestTiesToEven
                             a!251
                             ((_ to_fp 11 53) b_ack!4658)))))
  (FPCHECK_FADD_OVERFLOW a!250 a!252))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
