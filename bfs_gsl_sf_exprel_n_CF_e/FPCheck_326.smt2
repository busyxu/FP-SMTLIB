...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1087))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1086) a!1))))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            a!27
            (fp.div roundNearestTiesToEven a!28 ((_ to_fp 11 53) b_ack!1086)))
    (fp.div roundNearestTiesToEven a!29 ((_ to_fp 11 53) b_ack!1086))))))))))))))
