...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!1567))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!1566) a!1))))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven
            a!48
            (fp.div roundNearestTiesToEven a!49 ((_ to_fp 11 53) b_ack!1566)))
    (fp.div roundNearestTiesToEven a!50 ((_ to_fp 11 53) b_ack!1566)))))))))))))))))))))
