(declare-fun a_ack!4549 () (_ BitVec 64))
(declare-fun b_ack!4548 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4549))
            #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4548) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4549))))))
  (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!4548)) a!1))))
(assert (not (= #x00000000
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4549)))))
(assert (not (= #x00000001
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4549)))))
(assert (not (= #x00000002
        ((_ fp.to_sbv 32) roundTowardZero ((_ to_fp 11 53) a_ack!4549)))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!4548)
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    ((_ fp.to_sbv 32)
                      roundTowardZero
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32)
                       roundTowardZero
                       ((_ to_fp 11 53) a_ack!4549))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!4548) a!1))))
...
(let ((a!183 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!183
    (fp.div roundNearestTiesToEven a!184 ((_ to_fp 11 53) b_ack!4548))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
