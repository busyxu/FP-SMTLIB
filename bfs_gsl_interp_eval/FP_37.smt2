...
(assert (not (fp.gt ((_ to_fp 11 53) xx_ack!1138) ((_ to_fp 11 53) x2_ack!1137))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1138) ((_ to_fp 11 53) x0_ack!1139))))
(assert (fp.geq ((_ to_fp 11 53) xx_ack!1138) ((_ to_fp 11 53) x1_ack!1136)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!1136) ((_ to_fp 11 53) xx_ack!1138))))
