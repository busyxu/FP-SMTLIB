...
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1134) ((_ to_fp 11 53) x0_ack!1135))))
(assert (fp.geq ((_ to_fp 11 53) xx_ack!1134) ((_ to_fp 11 53) x1_ack!1132)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!1132) ((_ to_fp 11 53) xx_ack!1134))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) x2_ack!1133)
               ((_ to_fp 11 53) x1_ack!1132))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FSUB_ACCURACY xx_ack!1134 x1_ack!1132))
