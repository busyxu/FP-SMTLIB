(declare-fun h_ack!1202 () (_ BitVec 64))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x8000000000000000)
                            ((_ to_fp 11 53) h_ack!1202))
                    (CF_pow (fp.div roundNearestTiesToEven a!11 a!14)
                            #x3fe0000000000000))))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3cb0000000000000)))
                    (fp.abs a!27))))
  (fp.lt a!28 (fp.add roundNearestTiesToEven a!11 a!14))))))))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!1203)
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
...
(let ((a!21 (fp.sub roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven a!20 a!15)
                    (fp.div roundNearestTiesToEven
                            a!12
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x8000000000000000)
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x8000000000000000)
                                    ((_ to_fp 11 53) h_ack!1202))))))
  (fp.eq a!22 (fp.div roundNearestTiesToEven a!20 a!15))))))))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!1203)
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
