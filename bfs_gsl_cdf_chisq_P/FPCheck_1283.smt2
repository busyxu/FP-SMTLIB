(declare-fun x_ack!2882 () (_ BitVec 64))
(declare-fun nu_ack!2881 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!2882) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!2882)
                    ((_ to_fp 11 53) #x4000000000000000))
            (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu_ack!2881)
                    ((_ to_fp 11 53) #x4000000000000000)))))
...
(let ((a!80 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!77))
                    a!79)))
  (FPCHECK_FADD_UNDERFLOW a!80 (fp.mul roundNearestTiesToEven a!79 a!81)))))))))))))))))))))
