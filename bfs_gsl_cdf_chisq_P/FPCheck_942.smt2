(declare-fun x_ack!2200 () (_ BitVec 64))
(declare-fun nu_ack!2199 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!2200) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!2200)
                    ((_ to_fp 11 53) #x4000000000000000))
            (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu_ack!2199)
                    ((_ to_fp 11 53) #x4000000000000000)))))
...
(let ((a!50 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!47))
                    a!49)))
  (FPCHECK_FADD_ACCURACY a!50 (fp.mul roundNearestTiesToEven a!49 a!51)))))))))))))))
