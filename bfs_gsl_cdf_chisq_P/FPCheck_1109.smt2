(declare-fun x_ack!2534 () (_ BitVec 64))
(declare-fun nu_ack!2533 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!2534) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!2534)
                    ((_ to_fp 11 53) #x4000000000000000))
            (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu_ack!2533)
                    ((_ to_fp 11 53) #x4000000000000000)))))
...
(let ((a!49 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!47)
                    a!48)))
  (FPCHECK_FMUL_UNDERFLOW a!49 a!50)))))))))))))
