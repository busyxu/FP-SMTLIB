...
(assert (not (bvslt a_ack!1430 #x00000000)))
(assert (not (= #x00000000 (bvand a_ack!1430 #x00000001))))
(assert (let ((a!1 (= #x00000000
              (ite (= ((_ extract 31 31) a_ack!1430) #b1)
                   (concat #b1 ((_ extract 31 1) a_ack!1430))
                   (concat #b0 ((_ extract 31 1) a_ack!1430))))))
  (not a!1)))
(assert (let ((a!1 (bvand (ite (= ((_ extract 31 31) a_ack!1430) #b1)
                       (concat #b1 ((_ extract 31 1) a_ack!1430))
                       (concat #b0 ((_ extract 31 1) a_ack!1430)))
                  #x00000001)))
  (not (= #x00000000 a!1))))
(assert (let ((a!1 (ite (= ((_ extract 31 31) a_ack!1430) #b1)
                (concat #b1 ((_ extract 31 1) a_ack!1430))
                (concat #b0 ((_ extract 31 1) a_ack!1430)))))
(let ((a!2 (= #x00000000
...
(assert (not (bvult a_ack!1430 #x00000012)))
(assert (bvule a_ack!1430 #x000000aa))
...
(assert (bvslt #x00000001 a_ack!1430))
(assert (bvslt #x00000002 a_ack!1430))
(assert (bvslt #x00000003 a_ack!1430))
(assert (bvslt #x00000004 a_ack!1430))
(assert (bvslt #x00000005 a_ack!1430))
(assert (bvslt #x00000006 a_ack!1430))
(assert (bvslt #x00000007 a_ack!1430))
(assert (bvslt #x00000008 a_ack!1430))
(assert (bvslt #x00000009 a_ack!1430))
(assert (bvslt #x0000000a a_ack!1430))
(assert (bvslt #x0000000b a_ack!1430))
(assert (bvslt #x0000000c a_ack!1430))
(assert (bvslt #x0000000d a_ack!1430))
(assert (bvslt #x0000000e a_ack!1430))
(assert (bvslt #x0000000f a_ack!1430))
(assert (bvslt #x00000010 a_ack!1430))
(assert (bvslt #x00000011 a_ack!1430))
(assert (bvslt #x00000012 a_ack!1430))
(assert (not (bvslt #x00000013 a_ack!1430)))
(assert (bvult #x0000000000000000
...
(assert (bvult (bvmul #x0000000000000008
              ((_ sign_extend 32) (bvadd #x00000001 a_ack!1430)))
       #x0000000000000319))
(assert (bvslt (bvadd #x00000001 a_ack!1430) b_ack!1429))
(assert (FPCHECK_FADD_UNDERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!1430))
  #x3ff0000000000000))
