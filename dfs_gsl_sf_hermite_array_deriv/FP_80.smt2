...
(assert (not (bvslt b_ack!1371 a_ack!1372)))
(assert (not (= b_ack!1371 a_ack!1372)))
(assert (not (= b_ack!1371 (bvadd #x00000001 a_ack!1372))))
(assert (not (bvslt a_ack!1372 #x00000000)))
(assert (not (= #x00000000 (bvand a_ack!1372 #x00000001))))
(assert (let ((a!1 (= #x00000000
              (ite (= ((_ extract 31 31) a_ack!1372) #b1)
                   (concat #b1 ((_ extract 31 1) a_ack!1372))
                   (concat #b0 ((_ extract 31 1) a_ack!1372))))))
  (not a!1)))
(assert (let ((a!1 (bvand (ite (= ((_ extract 31 31) a_ack!1372) #b1)
                       (concat #b1 ((_ extract 31 1) a_ack!1372))
                       (concat #b0 ((_ extract 31 1) a_ack!1372)))
                  #x00000001)))
  (not (= #x00000000 a!1))))
(assert (let ((a!1 (ite (= ((_ extract 31 31) a_ack!1372) #b1)
                (concat #b1 ((_ extract 31 1) a_ack!1372))
                (concat #b0 ((_ extract 31 1) a_ack!1372)))))
(let ((a!2 (= #x00000000
...
(assert (not (bvult a_ack!1372 #x00000012)))
(assert (bvule a_ack!1372 #x000000aa))
...
(assert (bvult (bvadd #x0000000000000008
              (bvmul #x0000000000000018 (concat #x00000000 a_ack!1372)))
       #x0000000000001001))
(assert (not (bvslt #x00000000 a_ack!1372)))
