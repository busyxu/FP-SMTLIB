...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!28)) ((_ to_fp 11 53) #x403205966f2b4f12)))
(assert (FPCHECK_FMUL_OVERFLOW #xc000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!28))))
