...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2842) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!2843 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2842) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 a_ack!2843)))
(assert (not (= #x00000001 a_ack!2843)))
(assert (not (= #x00000002 a_ack!2843)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2843)
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) b_ack!2842))
              a!1))))
(assert (bvslt a_ack!2843 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2842))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2842)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           a!1)
                   a!1)))
  (not (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!2842)))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!23 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!3
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!23))))))))))))))))))
