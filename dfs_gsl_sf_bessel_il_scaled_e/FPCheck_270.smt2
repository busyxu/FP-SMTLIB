...
(assert (not (= #x00000002 a_ack!1001)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1000))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1001)
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) b_ack!1000))
              a!1))))
(assert (not (bvslt a_ack!1001 #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvmul a_ack!1001 a_ack!1001))
