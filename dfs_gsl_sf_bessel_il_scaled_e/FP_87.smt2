...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1284))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1285)
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) b_ack!1284))
              a!1))))
(assert (bvslt a_ack!1285 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1284))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!1284)))
