...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!50)) ((_ to_fp 11 53) #x403205966f2b4f12)))
...
(assert (let ((a!1 (CF_exp (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         a!1))
         a!1)))
(assert (FPCHECK_FMUL_ACCURACY #x4000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!50))))
