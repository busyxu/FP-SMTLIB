...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!30)) ((_ to_fp 11 53) #x403205966f2b4f12)))
(assert (FPCHECK_FMUL_UNDERFLOW #xc000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!30))))
