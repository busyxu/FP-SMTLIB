...
(assert (not (bvslt b_ack!1602 a_ack!1604)))
(assert (not (bvslt a_ack!1604 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1603) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1602))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1603))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1603))
