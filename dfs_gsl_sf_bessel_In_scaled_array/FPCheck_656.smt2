...
(declare-fun b_ack!2754 () (_ BitVec 32))
(declare-fun c_ack!2755 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (bvslt b_ack!2754 a_ack!2756)))
(assert (not (bvslt a_ack!2756 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2755) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2754))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2755))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2755))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2755)))
...
(let ((a!36 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW #x3cc0000000000000 (fp.abs a!36)))))))))))))))))))))))))))))))))))))))
