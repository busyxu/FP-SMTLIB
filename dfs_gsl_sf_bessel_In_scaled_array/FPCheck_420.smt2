...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt b_ack!1710 a_ack!1712)))
(assert (not (bvslt a_ack!1712 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1711) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1710))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1711))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1711))
