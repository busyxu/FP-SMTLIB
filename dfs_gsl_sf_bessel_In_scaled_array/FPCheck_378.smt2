...
(declare-fun b_ack!1542 () (_ BitVec 32))
(declare-fun c_ack!1543 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt b_ack!1542 a_ack!1544)))
(assert (not (bvslt a_ack!1544 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1543) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1542))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1543))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1543))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!1543)))
