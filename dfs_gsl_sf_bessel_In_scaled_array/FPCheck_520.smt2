...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2113))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2113))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2113)))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!25 a!22)
                                    ((_ to_fp 11 53) #x3e00f9ccb61ab9a0))))))
  (FPCHECK_FADD_ACCURACY a!28 #x3e58569280edf9e5))))))))))))))))))))))))))))))
