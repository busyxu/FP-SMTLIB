...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt b_ack!2202 a_ack!2204)))
(assert (not (bvslt a_ack!2204 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2203) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2202))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2203))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2203))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2203)))
