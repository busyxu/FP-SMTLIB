(declare-fun a_ack!2504 () (_ BitVec 32))
(declare-fun b_ack!2502 () (_ BitVec 32))
(declare-fun c_ack!2503 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt b_ack!2502 a_ack!2504)))
(assert (not (bvslt a_ack!2504 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2503) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2502))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2503))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2503))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2503)))
...
(let ((a!60 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!58
    (fp.add roundNearestTiesToEven a!60 ((_ to_fp 11 53) #x3f6b998ca2e5903f))))))))))))))))))))))))))))))))))))))
