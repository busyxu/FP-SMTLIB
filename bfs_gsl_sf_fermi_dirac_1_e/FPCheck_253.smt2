...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!322) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!322) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!322) ((_ to_fp 11 53) #x403e000000000000)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven a!3 ((_ to_fp 11 53) #xbc5b357d957c8a37)))))))
