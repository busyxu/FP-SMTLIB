...
(assert (not (= #x00000001 b_ack!156)))
(assert (= #x00000000 a_ack!158))
(assert (not (bvslt b_ack!156 #x00000000)))
(assert (not (= #x00000000 b_ack!156)))
(assert (not (= #x00000001 b_ack!156)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!157) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!157))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!156))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!157))
