...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!163))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!162))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!163))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!163))))))
  (not a!1)))
(assert (FPCHECK_FMUL_OVERFLOW c_ack!163 c_ack!163))
