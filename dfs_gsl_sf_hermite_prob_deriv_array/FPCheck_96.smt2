...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!526))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!525))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!526))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!526))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!525))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!2
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 ((_ to_fp 11 53) c_ack!526))))))
(assert (bvslt #x00000003 b_ack!525))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) c_ack!526)
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (bvslt #x00000004 b_ack!525))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x3cb0000000000000))))))
  (FPCHECK_FMUL_ACCURACY (fp.abs ((_ to_fp 11 53) c_ack!526)) a!4)))))
