...
(declare-fun xx_ack!635 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x0_ack!636) ((_ to_fp 11 53) x1_ack!630)))
...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!630))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!635) ((_ to_fp 11 53) x0_ack!636))))
(assert (not (fp.gt ((_ to_fp 11 53) xx_ack!635) ((_ to_fp 11 53) x2_ack!631))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!635) ((_ to_fp 11 53) x0_ack!636))))
(assert (fp.geq ((_ to_fp 11 53) xx_ack!635) ((_ to_fp 11 53) x1_ack!630)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!630) ((_ to_fp 11 53) xx_ack!635))))
