...
(declare-fun y2_ack!185 () (_ BitVec 64))
(assert (fp.lt ((_ to_fp 11 53) x0_ack!186) ((_ to_fp 11 53) x1_ack!182)))
(assert (fp.lt ((_ to_fp 11 53) x1_ack!182) ((_ to_fp 11 53) x2_ack!183)))
