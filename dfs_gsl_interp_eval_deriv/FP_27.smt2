...
(assert (fp.lt ((_ to_fp 11 53) x0_ack!700) ((_ to_fp 11 53) x1_ack!697)))
...
(assert (not (fp.gt ((_ to_fp 11 53) xx_ack!699) ((_ to_fp 11 53) x2_ack!698))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!699) ((_ to_fp 11 53) x0_ack!700))))
(assert (fp.geq ((_ to_fp 11 53) xx_ack!699) ((_ to_fp 11 53) x1_ack!697)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!697) ((_ to_fp 11 53) xx_ack!699))))
