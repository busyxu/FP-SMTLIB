...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!1385))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1390) ((_ to_fp 11 53) x0_ack!1391))))
(assert (not (fp.gt ((_ to_fp 11 53) xx_ack!1390) ((_ to_fp 11 53) x2_ack!1386))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1390) ((_ to_fp 11 53) x0_ack!1391))))
(assert (not (fp.geq ((_ to_fp 11 53) xx_ack!1390) ((_ to_fp 11 53) x1_ack!1385))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) y2_ack!1389)
                           ((_ to_fp 11 53) y1_ack!1388))
