...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!1399))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1404) ((_ to_fp 11 53) x0_ack!1405))))
(assert (not (fp.gt ((_ to_fp 11 53) xx_ack!1404) ((_ to_fp 11 53) x2_ack!1400))))
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!1404) ((_ to_fp 11 53) x0_ack!1405))))
(assert (not (fp.geq ((_ to_fp 11 53) xx_ack!1404) ((_ to_fp 11 53) x1_ack!1399))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) y2_ack!1403)
                           ((_ to_fp 11 53) y1_ack!1402))
