...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!321))
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!322)))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!321) ((_ to_fp 11 53) #xbf60624dd2f1a9fc)))
(assert (FPCHECK_FMUL_UNDERFLOW b_ack!321 b_ack!321))
