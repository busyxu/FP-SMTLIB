...
(assert (= #x00000002 a_ack!268))
(assert (fp.lt ((_ to_fp 11 53) b_ack!267) ((_ to_fp 11 53) #xc086232bdd7abcd2)))
(assert (FPCHECK_FDIV_ACCURACY #xc000000000000000 b_ack!267))
