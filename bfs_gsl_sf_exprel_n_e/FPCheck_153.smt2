...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!495))
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!496)))))
(assert (not (= #x00000000 a_ack!496)))
(assert (not (= #x00000001 a_ack!496)))
(assert (not (= #x00000002 a_ack!496)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!495)
       ((_ to_fp 11 53) roundNearestTiesToEven a_ack!496)))
(assert (FPCHECK_FDIV_ZERO b_ack!495 ((_ to_fp 11 53) roundNearestTiesToEven a_ack!496)))
