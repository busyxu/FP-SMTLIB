...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!551))
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!552)))))
(assert (not (= #x00000000 a_ack!552)))
(assert (not (= #x00000001 a_ack!552)))
(assert (not (= #x00000002 a_ack!552)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!551)
            ((_ to_fp 11 53) roundNearestTiesToEven a_ack!552))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!551)
            ((_ to_fp 11 53) roundNearestTiesToEven a_ack!552))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!551)
       (fp.mul roundNearestTiesToEven
