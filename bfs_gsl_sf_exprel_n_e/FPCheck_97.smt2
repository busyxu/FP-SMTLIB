...
(assert (= #x00000002 a_ack!320))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!319) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!319) ((_ to_fp 11 53) #xbf60624dd2f1a9fc)))
(assert (FPCHECK_FMUL_OVERFLOW b_ack!319 b_ack!319))
