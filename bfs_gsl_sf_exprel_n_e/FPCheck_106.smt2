...
(assert (= #x00000002 a_ack!346))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!345) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!345) ((_ to_fp 11 53) #xbf60624dd2f1a9fc)))
