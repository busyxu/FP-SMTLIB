...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.div roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53)
                                     ...
                                     a_ack!520))))))
  (FPCHECK_FMUL_ACCURACY ((_ to_fp 11 53) roundNearestTiesToEven a_ack!520) a!1)))
