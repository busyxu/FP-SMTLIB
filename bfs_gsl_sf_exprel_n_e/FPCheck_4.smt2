...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!17) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!17) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 (fp.abs (CF_exp b_ack!17))))
