...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!104) ((_ to_fp 11 53) #xc024000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!104) ((_ to_fp 11 53) #xc010000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!104) ((_ to_fp 11 53) #x4085eeaad5511c64))))
