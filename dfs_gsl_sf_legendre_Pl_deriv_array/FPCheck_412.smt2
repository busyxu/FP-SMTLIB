...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1496) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000016 a_ack!1497))
(assert (bvsle #x00000017 a_ack!1497))
(assert (bvsle #x00000018 a_ack!1497))
