...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1516) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x0000000d a_ack!1517))
(assert (bvsle #x0000000e a_ack!1517))
(assert (bvsle #x0000000f a_ack!1517))
(assert (bvsle #x00000010 a_ack!1517))
(assert (bvsle #x00000011 a_ack!1517))
(assert (bvsle #x00000012 a_ack!1517))
(assert (bvsle #x00000013 a_ack!1517))
(assert (bvsle #x00000014 a_ack!1517))
(assert (bvsle #x00000015 a_ack!1517))
(assert (bvsle #x00000016 a_ack!1517))
(assert (bvsle #x00000017 a_ack!1517))
(assert (bvsle #x00000018 a_ack!1517))
