...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!94)) ((_ to_fp 11 53) #x3cb0000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!93)) ((_ to_fp 11 53) #x3cb0000000000000)))
(assert (bvsle #x00000001 b_ack!92))
