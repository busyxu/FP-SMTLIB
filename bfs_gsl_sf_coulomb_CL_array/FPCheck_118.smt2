...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!412) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (bvsle #x00000001 b_ack!410))
(assert (bvsle #x00000002 b_ack!410))
(assert (bvsle #x00000003 b_ack!410))
...
(let ((a!4 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x4000000000000000))
                           a!3))))
  (FPCHECK_FMUL_ACCURACY a!4 #x7fdfffffffffffff)))))
