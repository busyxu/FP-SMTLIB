...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!277) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!277))
       ((_ to_fp 11 53) #x3cb0000000000000)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!276))
            ((_ to_fp 11 53) #x3cb0000000000000))))
...
(assert (bvsle #x00000001 b_ack!275))
