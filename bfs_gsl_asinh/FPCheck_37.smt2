...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!56)) ((_ to_fp 11 53) #x3e50000000000000)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           a!1)
                   a!1)))
  (fp.eq a!2 (fp.abs ((_ to_fp 11 53) a_ack!56))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.lt ((_ to_fp 11 53) a_ack!56)
                         ((_ to_fp 11 53) #x0000000000000000))
                  #xffffffff
                  #x00000001))))
  (FPCHECK_FMUL_UNDERFLOW a!1 #x3fe3656568313bd5)))
