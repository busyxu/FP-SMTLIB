...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) b_ack!531))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!531))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!531))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!533))
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!533))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!531)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fe999999999999a)
                          (fp.abs ((_ to_fp 11 53) c_ack!532))))))
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!532) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!531)
                  (fp.mul roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!532))))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!532) ((_ to_fp 11 53) #xc03e000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!532) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!532) ((_ to_fp 11 53) #x0000000000000000))))
