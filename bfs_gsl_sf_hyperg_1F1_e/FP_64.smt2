...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!725) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!727) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (fp.eq ((_ to_fp 11 53) a_ack!727) ((_ to_fp 11 53) b_ack!725)))
