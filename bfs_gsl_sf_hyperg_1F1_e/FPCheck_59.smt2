...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!286) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) b_ack!286))))
...
(assert (let ((a!1 (fp.lt (CF_floor (fp.add roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!286) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!288)))
...
(assert (FPCHECK_FMUL_ACCURACY a_ack!288 (fp.abs ((_ to_fp 11 53) c_ack!287))))
