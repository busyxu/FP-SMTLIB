...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!401) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!401) ((_ to_fp 11 53) b_ack!399))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!399))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!399))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!401) ((_ to_fp 11 53) #x0000000000000000))))
