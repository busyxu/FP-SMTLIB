...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!698) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!700) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!700) ((_ to_fp 11 53) b_ack!698))))
...
(assert (FPCHECK_FMUL_OVERFLOW #x3fe0000000000000 b_ack!698))
