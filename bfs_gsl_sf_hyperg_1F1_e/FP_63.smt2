...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!719) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!721) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (fp.eq ((_ to_fp 11 53) a_ack!721) ((_ to_fp 11 53) #x0000000000000000)))
