...
(assert (fp.lt ((_ to_fp 11 53) b_ack!355) ((_ to_fp 11 53) #xbfb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!357) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (let ((a!1 (fp.lt (CF_floor (fp.add roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!355) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!357) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW b_ack!355 a_ack!357))
