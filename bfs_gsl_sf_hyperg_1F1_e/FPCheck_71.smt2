...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!396) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!398) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!396)
                    ((_ to_fp 11 53) a_ack!398))
            ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!397) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!398) ((_ to_fp 11 53) b_ack!396))))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!398) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_ACCURACY b_ack!396 a_ack!398))
