...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!233) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!235) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!235) ((_ to_fp 11 53) b_ack!233))))
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!233))
       ((_ to_fp 11 53) #x3d19000000000000)))
(assert (FPCHECK_FMUL_OVERFLOW c_ack!234 a_ack!235))
