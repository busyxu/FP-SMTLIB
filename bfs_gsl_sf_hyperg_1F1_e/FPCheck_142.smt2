...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!701) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!703) ((_ to_fp 11 53) #xbfb999999999999a))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!703) ((_ to_fp 11 53) b_ack!701))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!701))
...
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 b_ack!701))
