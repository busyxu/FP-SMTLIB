...
(assert (not (= a_ack!3006 b_ack!3004)))
(assert (not (= #x00000000 b_ack!3004)))
(assert (not (= #x00000000 a_ack!3006)))
(assert (not (bvslt b_ack!3004 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3005) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3005) ((_ to_fp 11 53) #xc059000000000000))))
(assert (not (bvslt a_ack!3006 #x00000000)))
(assert (not (bvslt a_ack!3006 #x00000000)))
(assert (not (= a_ack!3006 b_ack!3004)))
(assert (not (= #x00000001 a_ack!3006)))
(assert (not (= b_ack!3004 (bvadd #x00000001 a_ack!3006))))
(assert (not (= a_ack!3006 (bvadd #x00000001 b_ack!3004))))
(assert (not (= a_ack!3006 (bvadd #x00000002 b_ack!3004))))
(assert (not (= b_ack!3004 (bvmul #x00000002 a_ack!3006))))
(assert (bvslt b_ack!3004 #x0000000a))
(assert (bvslt a_ack!3006 #x0000000a))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!3005))
            ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!3004)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3006)
                          (fp.abs ((_ to_fp 11 53) c_ack!3005))))))
  (not a!1)))
(assert (not (bvslt a_ack!3006 b_ack!3004)))
(assert (not (bvslt a_ack!3006 b_ack!3004)))
(assert (not (bvslt a_ack!3006 b_ack!3004)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!3005) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3006)
                   (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3006)
             (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xffffffff ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xfffffffe ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xfffffffd ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xfffffffc ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xfffffffb ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!3005))
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!3004)
                                    ((_ to_fp 11 53) c_ack!3005))))))
  (bvslt b_ack!3004 (bvadd #xfffffffa ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(let ((a!29 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #xc014000000000000))
                            (fp.div roundNearestTiesToEven a!23 a!25)))))
  (FPCHECK_FMUL_UNDERFLOW a!3 (fp.div roundNearestTiesToEven a!29 a!31))))))))))))
