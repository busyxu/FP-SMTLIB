(declare-fun c_ack!2987 () (_ BitVec 64))
(declare-fun b_ack!2986 () (_ BitVec 32))
(declare-fun a_ack!2988 () (_ BitVec 32))
(declare-fun CF_ceil ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun CF_exp ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2987) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= a_ack!2988 b_ack!2986)))
(assert (not (= #x00000000 b_ack!2986)))
(assert (not (= #x00000000 a_ack!2988)))
(assert (not (bvslt b_ack!2986 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2987) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2987) ((_ to_fp 11 53) #xc059000000000000))))
(assert (not (bvslt a_ack!2988 #x00000000)))
(assert (not (bvslt a_ack!2988 #x00000000)))
(assert (not (= a_ack!2988 b_ack!2986)))
(assert (not (= #x00000001 a_ack!2988)))
(assert (not (= b_ack!2986 (bvadd #x00000001 a_ack!2988))))
(assert (not (= a_ack!2988 (bvadd #x00000001 b_ack!2986))))
(assert (not (= a_ack!2988 (bvadd #x00000002 b_ack!2986))))
(assert (not (= b_ack!2986 (bvmul #x00000002 a_ack!2988))))
(assert (bvslt b_ack!2986 #x0000000a))
(assert (bvslt a_ack!2988 #x0000000a))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2987))
            ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2986)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2988)
                          (fp.abs ((_ to_fp 11 53) c_ack!2987))))))
  (not a!1)))
(assert (not (bvslt a_ack!2988 b_ack!2986)))
(assert (not (bvslt a_ack!2988 b_ack!2986)))
(assert (not (bvslt a_ack!2988 b_ack!2986)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!2987) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2988)
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53)
                                     ...
                                     b_ack!2986)
                                   ((_ to_fp 11 53) c_ack!2987))))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2988)
             (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xffffffff ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xfffffffe ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xfffffffd ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xfffffffc ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xfffffffb ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2987))
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2986)
                                    ((_ to_fp 11 53) c_ack!2987))))))
  (bvslt b_ack!2986 (bvadd #xfffffffa ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
