...
(assert (not (= a_ack!2979 b_ack!2977)))
(assert (not (= #x00000000 b_ack!2977)))
(assert (not (= #x00000000 a_ack!2979)))
(assert (not (bvslt b_ack!2977 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2978) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2978) ((_ to_fp 11 53) #xc059000000000000))))
(assert (not (bvslt a_ack!2979 #x00000000)))
(assert (not (bvslt a_ack!2979 #x00000000)))
(assert (not (= a_ack!2979 b_ack!2977)))
(assert (not (= #x00000001 a_ack!2979)))
(assert (not (= b_ack!2977 (bvadd #x00000001 a_ack!2979))))
(assert (not (= a_ack!2979 (bvadd #x00000001 b_ack!2977))))
(assert (not (= a_ack!2979 (bvadd #x00000002 b_ack!2977))))
(assert (not (= b_ack!2977 (bvmul #x00000002 a_ack!2979))))
(assert (bvslt b_ack!2977 #x0000000a))
(assert (bvslt a_ack!2979 #x0000000a))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2978))
            ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2977)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2979)
                          (fp.abs ((_ to_fp 11 53) c_ack!2978))))))
  (not a!1)))
(assert (not (bvslt a_ack!2979 b_ack!2977)))
(assert (not (bvslt a_ack!2979 b_ack!2977)))
(assert (not (bvslt a_ack!2979 b_ack!2977)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!2978) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2979)
                   (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2979)
             (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xffffffff ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xfffffffe ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xfffffffd ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xfffffffc ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xfffffffb ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2978))
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2977)
                                    ((_ to_fp 11 53) c_ack!2978))))))
  (bvslt b_ack!2977 (bvadd #xfffffffa ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
