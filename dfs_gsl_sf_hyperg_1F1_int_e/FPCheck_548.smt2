...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2942) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2942) ((_ to_fp 11 53) #xc059000000000000))))
(assert (not (bvslt a_ack!2943 #x00000000)))
(assert (not (bvslt a_ack!2943 #x00000000)))
(assert (not (= a_ack!2943 b_ack!2941)))
(assert (not (= #x00000001 a_ack!2943)))
(assert (not (= b_ack!2941 (bvadd #x00000001 a_ack!2943))))
(assert (not (= a_ack!2943 (bvadd #x00000001 b_ack!2941))))
(assert (not (= a_ack!2943 (bvadd #x00000002 b_ack!2941))))
(assert (not (= b_ack!2941 (bvmul #x00000002 a_ack!2943))))
(assert (bvslt b_ack!2941 #x0000000a))
(assert (bvslt a_ack!2943 #x0000000a))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2942))
            ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2941)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2943)
                          (fp.abs ((_ to_fp 11 53) c_ack!2942))))))
  (not a!1)))
(assert (not (bvslt a_ack!2943 b_ack!2941)))
(assert (not (bvslt a_ack!2943 b_ack!2941)))
(assert (not (bvslt a_ack!2943 b_ack!2941)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!2942) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2943)
                   (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2943)
             (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2941)
                                    ((_ to_fp 11 53) c_ack!2942))))))
  (bvslt b_ack!2941 (bvadd #xffffffff ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2941)
                                    ((_ to_fp 11 53) c_ack!2942))))))
  (bvslt b_ack!2941 (bvadd #xfffffffe ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2941)
                                    ((_ to_fp 11 53) c_ack!2942))))))
  (bvslt b_ack!2941 (bvadd #xfffffffd ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2941)
                                    ((_ to_fp 11 53) c_ack!2942))))))
  (bvslt b_ack!2941 (bvadd #xfffffffc ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2941)
                                    ((_ to_fp 11 53) c_ack!2942))))))
  (bvslt b_ack!2941 (bvadd #xfffffffb ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2942))
...
(let ((a!27 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #xc014000000000000))
                            (fp.div roundNearestTiesToEven a!21 a!23)))))
  (FPCHECK_FDIV_OVERFLOW a!27 a!29)))))))))))
