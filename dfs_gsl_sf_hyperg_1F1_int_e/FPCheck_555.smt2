...
(assert (not (= a_ack!2976 b_ack!2974)))
(assert (not (= #x00000000 b_ack!2974)))
(assert (not (= #x00000000 a_ack!2976)))
(assert (not (bvslt b_ack!2974 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2975) ((_ to_fp 11 53) #x4059000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2975) ((_ to_fp 11 53) #xc059000000000000))))
(assert (not (bvslt a_ack!2976 #x00000000)))
(assert (not (bvslt a_ack!2976 #x00000000)))
(assert (not (= a_ack!2976 b_ack!2974)))
(assert (not (= #x00000001 a_ack!2976)))
(assert (not (= b_ack!2974 (bvadd #x00000001 a_ack!2976))))
(assert (not (= a_ack!2976 (bvadd #x00000001 b_ack!2974))))
(assert (not (= a_ack!2976 (bvadd #x00000002 b_ack!2974))))
(assert (not (= b_ack!2974 (bvmul #x00000002 a_ack!2976))))
(assert (bvslt b_ack!2974 #x0000000a))
(assert (bvslt a_ack!2976 #x0000000a))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2975))
            ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2974)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2976)
                          (fp.abs ((_ to_fp 11 53) c_ack!2975))))))
  (not a!1)))
(assert (not (bvslt a_ack!2976 b_ack!2974)))
(assert (not (bvslt a_ack!2976 b_ack!2974)))
(assert (not (bvslt a_ack!2976 b_ack!2974)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!2975) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2976)
                   (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2976)
             (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xffffffff ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xfffffffe ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xfffffffd ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xfffffffc ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xfffffffb ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2975))
...
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
                                      ...
                                      b_ack!2974)
                                    ((_ to_fp 11 53) c_ack!2975))))))
  (bvslt b_ack!2974 (bvadd #xfffffffa ((_ fp.to_sbv 32) roundTowardZero a!1)))))
(assert (let ((a!1 (CF_ceil (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fe0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53)
