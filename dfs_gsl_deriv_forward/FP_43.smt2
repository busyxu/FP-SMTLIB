(declare-fun h_ack!686 () (_ BitVec 64))
(declare-fun x_ack!687 () (_ BitVec 64))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             (_ FloatingPoint 11 53))
(assert (let ((a!1 (fp.eq (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) x_ack!687)
                          (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) h_ack!686)
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!686))))))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!686))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!687)
                                   ((_ to_fp 11 53) h_ack!686))
