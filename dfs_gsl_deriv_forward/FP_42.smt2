(declare-fun h_ack!670 () (_ BitVec 64))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!670))))))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!670))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!671)
                                   ((_ to_fp 11 53) h_ack!670))
