(declare-fun h_ack!366 () (_ BitVec 64))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!366))))))))
(assert (FPCHECK_FDIV_ACCURACY x_ack!367 h_ack!366))
