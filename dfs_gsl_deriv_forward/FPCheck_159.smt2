(declare-fun h_ack!664 () (_ BitVec 64))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!664))))))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!664))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!665)
                                   ((_ to_fp 11 53) h_ack!664))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3cb0000000000000)))
                    (fp.abs a!12))))
(let ((a!14 (CF_pow (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) x_ack!665)
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!664)
                                    (CF_pow a!13 #x3fe0000000000000)))
      ...
      (a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (CF_pow a!13 #x3fe0000000000000))
                            ((_ to_fp 11 53) #x4000000000000000)))))
  (FPCHECK_FSUB_UNDERFLOW a!14 (CF_pow a!15 #x3ff8000000000000)))))))))
