...
(assert (bvult a_ack!133 #x00000012))
...
(assert (bvult (bvadd #x0000000000000008
       ...
       #x0000000000001001))
(assert (not (bvslt a_ack!133 #x00000000)))
(assert (= #x00000000 (bvand a_ack!133 #x00000001)))
(assert (let ((a!1 (= #x00000000
              (ite (= ((_ extract 31 31) a_ack!133) #b1)
                   (concat #b1 ((_ extract 31 1) a_ack!133))
                   (concat #b0 ((_ extract 31 1) a_ack!133))))))
  (not a!1)))
(assert (let ((a!1 (bvand (ite (= ((_ extract 31 31) a_ack!133) #b1)
                       (concat #b1 ((_ extract 31 1) a_ack!133))
                       (concat #b0 ((_ extract 31 1) a_ack!133)))
                  #x00000001)))
  (= #x00000000 a!1)))
(assert (let ((a!1 (ite (= ((_ extract 31 31) a_ack!133) #b1)
                (concat #b1 ((_ extract 31 1) a_ack!133))
                (concat #b0 ((_ extract 31 1) a_ack!133)))))
(let ((a!2 (= #x00000000
