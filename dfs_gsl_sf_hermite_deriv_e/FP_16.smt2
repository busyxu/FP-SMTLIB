...
(assert (not (bvslt b_ack!380 a_ack!381)))
(assert (not (bvult b_ack!380 a_ack!381)))
(assert (= a_ack!381 b_ack!380))
...
(assert (let ((a!1 (= #x00000000
              (ite (= ((_ extract 31 31) a_ack!381) #b1)
                   (concat #b1 ((_ extract 31 1) a_ack!381))
                   (concat #b0 ((_ extract 31 1) a_ack!381))))))
  (not a!1)))
(assert (let ((a!1 (bvand (ite (= ((_ extract 31 31) a_ack!381) #b1)
                       (concat #b1 ((_ extract 31 1) a_ack!381))
                       (concat #b0 ((_ extract 31 1) a_ack!381)))
                  #x00000001)))
  (= #x00000000 a!1)))
(assert (let ((a!1 (ite (= ((_ extract 31 31) a_ack!381) #b1)
                (concat #b1 ((_ extract 31 1) a_ack!381))
                (concat #b0 ((_ extract 31 1) a_ack!381)))))
(let ((a!2 (= #x00000000
...
(assert (not (bvslt (bvsub b_ack!380 a_ack!381) #x00000000)))
(assert (not (= #x00000000 (bvsub b_ack!380 a_ack!381))))
