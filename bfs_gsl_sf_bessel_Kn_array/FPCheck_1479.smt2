...
(assert (= #x00000000 b_ack!5759))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5760) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!5760) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5760))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    a!7
    (fp.mul roundNearestTiesToEven (CF_log c_ack!5760) a!12))))))))))
