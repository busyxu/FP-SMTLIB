...
(declare-fun b_ack!929 () (_ BitVec 32))
(declare-fun c_ack!930 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!931 #x00000000)))
(assert (not (bvslt b_ack!929 a_ack!931)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!930) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!929)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!930) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!930) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!930) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!930) ((_ to_fp 11 53) #x4020000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4030000000000000)
                                   ((_ to_fp 11 53) c_ack!930))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!10
                                    ((_ to_fp 11 53) #x3dffb014035fe5c4))))))
  (FPCHECK_FADD_ACCURACY a!13 #x3e850b0771f4ea8b)))))))))))))))
