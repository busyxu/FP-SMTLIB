(declare-fun a_ack!5764 () (_ BitVec 32))
(declare-fun b_ack!5762 () (_ BitVec 32))
(declare-fun c_ack!5763 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ BitVec 64)) (_ FloatingPoint 11 53))
(assert (not (bvslt a_ack!5764 #x00000000)))
(assert (not (bvslt b_ack!5762 a_ack!5764)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5763) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!5762))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5763) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!5763) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5763))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) c_ack!5763)
                       ((_ to_fp 11 53) c_ack!5763))
               ((_ to_fp 11 53) c_ack!5763))
       ((_ to_fp 11 53) c_ack!5763)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5763))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    a!7
    (fp.mul roundNearestTiesToEven (CF_log c_ack!5763) a!12))))))))))
