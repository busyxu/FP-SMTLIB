(declare-fun a_ack!5890 () (_ BitVec 32))
(declare-fun b_ack!5888 () (_ BitVec 32))
(declare-fun c_ack!5889 () (_ BitVec 64))
(declare-fun CF_log ((_ BitVec 64)) (_ FloatingPoint 11 53))
(assert (not (bvslt a_ack!5890 #x00000000)))
(assert (not (bvslt b_ack!5888 a_ack!5890)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5889) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!5888))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5889) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!5889) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5889))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log c_ack!5889)
                                    a!12))
                    (fp.mul roundNearestTiesToEven (CF_log c_ack!5889) a!12))))
  (fp.eq a!13 a!7))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3e14c2029d5d2fb5)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log c_ack!5889)
                                    a!12)))))
  (fp.eq a!13 (fp.mul roundNearestTiesToEven (CF_log c_ack!5889) a!12)))))))))))
