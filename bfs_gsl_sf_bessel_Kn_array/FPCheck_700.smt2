...
(declare-fun b_ack!2726 () (_ BitVec 32))
(declare-fun c_ack!2727 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!2728 #x00000000)))
(assert (not (bvslt b_ack!2726 a_ack!2728)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2727) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2726))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2727) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2727) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2727) ((_ to_fp 11 53) #x4020000000000000))))
