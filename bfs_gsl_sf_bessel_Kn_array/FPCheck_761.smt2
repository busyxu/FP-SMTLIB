...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2970) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2970) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2970) ((_ to_fp 11 53) #x4020000000000000))))
(assert (bvsle #x00000000 (bvsub b_ack!2969 a_ack!2971)))
