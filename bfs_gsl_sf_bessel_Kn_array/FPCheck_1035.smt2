(declare-fun a_ack!4024 () (_ BitVec 32))
(declare-fun b_ack!4022 () (_ BitVec 32))
(declare-fun c_ack!4023 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!4024 #x00000000)))
(assert (not (bvslt b_ack!4022 a_ack!4024)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!4022)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4023) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!25 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!25
    (fp.add roundNearestTiesToEven a!27 ((_ to_fp 11 53) #x3e44ea9cce60ab63))))))))))))))))))
