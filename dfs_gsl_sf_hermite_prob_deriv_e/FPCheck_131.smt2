...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!745))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 (bvsub b_ack!744 a_ack!746)))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!745))
...
(assert (not (bvslt #x00000002 (bvsub b_ack!744 a_ack!746))))
