...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!284) ((_ to_fp 11 53) #x3e68000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!284) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!284) ((_ to_fp 11 53) #x404205966f2b4f12))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!284) ((_ to_fp 11 53) #x4348000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) #x3ff0000000000000))
         (fp.mul roundNearestTiesToEven a!2 a!1)))))
(assert (FPCHECK_FMUL_ACCURACY #x4008000000000000 (CF_log a_ack!284)))
