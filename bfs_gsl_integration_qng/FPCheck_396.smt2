...
(declare-fun epsabs_ack!2346 () (_ BitVec 64))
...
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!2346)
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!27))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fb7d711dddcb389) a!30)))))))))
