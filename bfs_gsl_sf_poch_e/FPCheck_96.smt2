...
(assert (fp.leq ((_ to_fp 11 53) a_ack!343) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!343) (CF_floor a_ack!343)))
(assert (fp.lt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) a_ack!343)
               ((_ to_fp 11 53) b_ack!342))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!342) (CF_floor b_ack!342)))
