...
(assert (fp.leq ((_ to_fp 11 53) a_ack!347) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!347) (CF_floor a_ack!347)))
(assert (fp.lt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) a_ack!347)
               ((_ to_fp 11 53) b_ack!346))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!346) (CF_floor b_ack!346)))
