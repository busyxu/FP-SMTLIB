...
(let ((a!59 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!57)
                    a!58)))
  (FPCHECK_FMUL_OVERFLOW (fp.mul roundNearestTiesToEven a!59 a!60) a!61)))))))))))))))
