...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1253) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1253) ((_ to_fp 11 53) a_ack!1254))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1254 #x402e000000000000))
