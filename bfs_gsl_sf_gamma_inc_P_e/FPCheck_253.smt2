...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!681)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!682) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!682) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!682) ((_ to_fp 11 53) #x4330000000000000))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!682)) a!3)
