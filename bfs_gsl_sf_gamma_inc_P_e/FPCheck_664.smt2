...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1503) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1503) ((_ to_fp 11 53) a_ack!1504))))
...
(let ((a!26 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW (fp.add roundNearestTiesToEven a!24 a!25) a!26)))))))))))))))))))))))
