...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1443) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1443) ((_ to_fp 11 53) a_ack!1444))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!19 a!24))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1444 #x4034000000000000))
