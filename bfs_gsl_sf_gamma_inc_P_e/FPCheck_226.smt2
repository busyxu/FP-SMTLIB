...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!627)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!628) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!628) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!628) ((_ to_fp 11 53) #x4330000000000000))))
(assert (FPCHECK_FMUL_OVERFLOW #x401921fb54442d18 a_ack!628))
