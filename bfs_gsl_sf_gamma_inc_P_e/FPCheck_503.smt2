...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1181) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1182) ((_ to_fp 11 53) #x4330000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1181) ((_ to_fp 11 53) a_ack!1182))))
