...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2011) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2012) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2011)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2011)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2011) ((_ to_fp 11 53) a_ack!2012))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!2012 #x4041800000000000))
