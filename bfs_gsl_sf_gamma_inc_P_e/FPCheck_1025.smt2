...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2225) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2226) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2225)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2225)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2225) ((_ to_fp 11 53) a_ack!2226))))
...
(let ((a!49 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW a!49 a!50))))))))))))))))))))))))))))))))))))))))))
