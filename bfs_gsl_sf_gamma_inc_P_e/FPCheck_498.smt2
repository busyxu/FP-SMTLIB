...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1171) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1172) ((_ to_fp 11 53) #x4330000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1171) ((_ to_fp 11 53) a_ack!1172))))
...
(let ((a!12 (fp.mul roundNearestTiesToEven
      ...
      (a!15 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!10)
                    a!11)))
  (FPCHECK_FDIV_INVALID a!12 (fp.add roundNearestTiesToEven a!15 a!12)))))))))))))))
