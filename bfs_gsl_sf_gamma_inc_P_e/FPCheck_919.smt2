...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2013) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2014) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2013)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2013)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2013) ((_ to_fp 11 53) a_ack!2014))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!2014 #x4041800000000000))
