...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1365) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1366) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1365)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1365) ((_ to_fp 11 53) a_ack!1366))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!1366 #x4032000000000000))
