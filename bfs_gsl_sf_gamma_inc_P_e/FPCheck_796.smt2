...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1767) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1767) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1767) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1768) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1767)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1768) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1767)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1767) ((_ to_fp 11 53) a_ack!1768))))
...
(let ((a!34 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW a!34 a!35))))))))))))))))))))))))))))))
