...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2191) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2192) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2191)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2191)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2191) ((_ to_fp 11 53) a_ack!2192))))
...
(let ((a!49 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!38)
                    a!39)))
  (FPCHECK_FDIV_OVERFLOW a!39 a!49))))))))))))))))))))))))))))))))))))))))))
