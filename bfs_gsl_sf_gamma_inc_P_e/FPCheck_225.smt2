...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!625)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!626) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!626) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!626) ((_ to_fp 11 53) #x4330000000000000))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1))
                   a!1)))
  (FPCHECK_FMUL_ACCURACY a_ack!626 a!2))))
