...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!653)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!654) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!654) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!654) ((_ to_fp 11 53) #x4330000000000000))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.abs (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!654) a!2))
    #x3ff0000000000000))))
