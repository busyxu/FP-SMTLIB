...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!639)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!640) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!640) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!640) ((_ to_fp 11 53) #x4330000000000000))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY
    (CF_exp (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!640) a!2))
    #x7ff8000000000001))))
