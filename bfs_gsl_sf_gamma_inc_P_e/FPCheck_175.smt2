...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!503) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!503)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!504)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!504) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!504) ((_ to_fp 11 53) b_ack!503)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!504)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fc999999999999a)
                    ((_ to_fp 11 53) b_ack!503)))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!504) ((_ to_fp 11 53) #x4024000000000000)))
