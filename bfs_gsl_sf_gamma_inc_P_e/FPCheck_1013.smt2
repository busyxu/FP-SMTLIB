...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2201) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2202) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2201)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2201)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2201) ((_ to_fp 11 53) a_ack!2202))))
...
(let ((a!49 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!39 a!49))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2202 #x4044000000000000))
