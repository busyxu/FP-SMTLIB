...
(declare-fun b_ack!3113 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3114) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3113) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3113) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3113) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3114) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3113)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3114)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3113)
                                   ((_ to_fp 11 53) a_ack!3114))
                           ((_ to_fp 11 53) a_ack!3114))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3113)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3113) ((_ to_fp 11 53) a_ack!3114))))
...
(let ((a!79 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!63 a!79))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!3114 #x4050000000000000))
