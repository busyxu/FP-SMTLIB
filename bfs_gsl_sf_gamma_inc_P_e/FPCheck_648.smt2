...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1471) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1471) ((_ to_fp 11 53) a_ack!1472))))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
      ...
      (a!25 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!18)
                    a!19)))
  (FPCHECK_FDIV_UNDERFLOW a!20 (fp.add roundNearestTiesToEven a!25 a!20)))))))))))))))))))))))
