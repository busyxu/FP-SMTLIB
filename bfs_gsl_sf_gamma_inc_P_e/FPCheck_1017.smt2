...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2209) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2210) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2209)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2209)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2209) ((_ to_fp 11 53) a_ack!2210))))
