...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2049) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2050) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2049)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2049)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2049) ((_ to_fp 11 53) a_ack!2050))))
...
(let ((a!44 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!35 a!44))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2050 #x4042000000000000))
