...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!311) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!311)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!312)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!312) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!312) ((_ to_fp 11 53) b_ack!311))))
