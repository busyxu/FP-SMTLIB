...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!17) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!17)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!18)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!18) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!18) ((_ to_fp 11 53) b_ack!17))))
(assert (FPCHECK_FSUB_OVERFLOW b_ack!17 a_ack!18))
