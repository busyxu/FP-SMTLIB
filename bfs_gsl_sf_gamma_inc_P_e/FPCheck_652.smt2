...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1479) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1479) ((_ to_fp 11 53) a_ack!1480))))
...
(let ((a!26 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!26)))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!1480 #x4035000000000000))
