...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1044) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1043) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1044) ((_ to_fp 11 53) b_ack!1043))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1044) ((_ to_fp 11 53) b_ack!1043)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (FPCHECK_FSUB_ACCURACY b_ack!1043 #x4000000000000000))
