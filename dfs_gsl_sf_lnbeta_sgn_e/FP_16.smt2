...
(assert (fp.gt ((_ to_fp 11 53) b_ack!145) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!146) ((_ to_fp 11 53) b_ack!145))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!146) ((_ to_fp 11 53) b_ack!145)))
