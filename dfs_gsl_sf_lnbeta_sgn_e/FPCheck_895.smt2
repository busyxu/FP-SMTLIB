...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2964) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!2963) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2964) ((_ to_fp 11 53) b_ack!2963)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2964) ((_ to_fp 11 53) b_ack!2963))))
...
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) #x4000000000000000)))
       ((_ to_fp 11 53) #x3f847ae147ae147b)))
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!2963 #x4000000000000000))
