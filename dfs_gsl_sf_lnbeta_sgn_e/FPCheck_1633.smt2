...
(assert (fp.gt ((_ to_fp 11 53) a_ack!5278) ((_ to_fp 11 53) b_ack!5277)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!5278) ((_ to_fp 11 53) b_ack!5277))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!5278) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_ACCURACY a_ack!5278 #x3ff0000000000000))
