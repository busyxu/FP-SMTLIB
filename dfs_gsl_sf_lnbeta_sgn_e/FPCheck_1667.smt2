...
(assert (fp.gt ((_ to_fp 11 53) a_ack!5402) ((_ to_fp 11 53) b_ack!5401)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!5402) ((_ to_fp 11 53) b_ack!5401))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!5402) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!5402) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!5402))
