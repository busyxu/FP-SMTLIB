...
(assert (fp.gt ((_ to_fp 11 53) b_ack!111) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!112) ((_ to_fp 11 53) b_ack!111))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!112) ((_ to_fp 11 53) b_ack!111))))
(assert (FPCHECK_FDIV_UNDERFLOW b_ack!111 b_ack!111))
