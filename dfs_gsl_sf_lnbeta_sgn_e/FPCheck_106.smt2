...
(assert (fp.gt ((_ to_fp 11 53) a_ack!308) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!307) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!308) ((_ to_fp 11 53) b_ack!307))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!308) ((_ to_fp 11 53) b_ack!307)))
...
(assert (FPCHECK_FMUL_ACCURACY a_ack!308 #xbf3fbdf153d2eadd))
