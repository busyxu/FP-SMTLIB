...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2971) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2972) ((_ to_fp 11 53) b_ack!2971)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2972) ((_ to_fp 11 53) b_ack!2971))))
