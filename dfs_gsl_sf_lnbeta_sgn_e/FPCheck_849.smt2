...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2821) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2822) ((_ to_fp 11 53) b_ack!2821)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2822) ((_ to_fp 11 53) b_ack!2821))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) #xbf122c77e28883ce))))
(assert (FPCHECK_FSUB_ACCURACY b_ack!2821 #x3ff0000000000000))
