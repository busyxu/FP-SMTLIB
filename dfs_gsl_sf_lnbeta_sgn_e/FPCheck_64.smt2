...
(assert (fp.gt ((_ to_fp 11 53) b_ack!181) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!182) ((_ to_fp 11 53) b_ack!181))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!182) ((_ to_fp 11 53) b_ack!181)))
...
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
       ...
       ((_ to_fp 11 53) #x3f847ae147ae147b)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!182 #x4000000000000000))
