...
(assert (fp.gt ((_ to_fp 11 53) a_ack!172) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!171) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!172) ((_ to_fp 11 53) b_ack!171))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!172) ((_ to_fp 11 53) b_ack!171)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!172 #x4000000000000000))
