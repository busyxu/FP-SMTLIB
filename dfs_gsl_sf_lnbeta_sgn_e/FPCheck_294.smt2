...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1000) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!999) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1000) ((_ to_fp 11 53) b_ack!999))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1000) ((_ to_fp 11 53) b_ack!999)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) #xbf122c77e28883ce))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!1000 #x4000000000000000))
