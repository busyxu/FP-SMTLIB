...
(assert (fp.gt ((_ to_fp 11 53) a_ack!904) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!903) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!904) ((_ to_fp 11 53) b_ack!903))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!904) ((_ to_fp 11 53) b_ack!903)))
