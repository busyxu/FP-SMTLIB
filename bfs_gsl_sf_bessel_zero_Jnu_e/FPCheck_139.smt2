...
(assert (bvule b_ack!585 #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!586)
            ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!585))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!585))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!585))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!585))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!585))
