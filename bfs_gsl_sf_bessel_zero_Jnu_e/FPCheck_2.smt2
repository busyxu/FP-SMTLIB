...
(assert (fp.lt ((_ to_fp 11 53) a_ack!10) ((_ to_fp 11 53) #x4000000000000000)))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!9))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!9))
       #x00000000000000a1))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!9))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!9))
       #x00000000000000a1))
(assert (FPCHECK_FDIV_ACCURACY a_ack!10 #x4000000000000000))
