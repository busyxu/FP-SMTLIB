...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!607) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!607) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000007 a_ack!608))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x402e000000000000)
                 ((_ to_fp 11 53) b_ack!607)))))))))))))
(assert (bvslt #x00000008 a_ack!608))
(assert (bvslt #x00000009 a_ack!608))
(assert (let ((a!1 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
...
(let ((a!11 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!11
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4033000000000000)
                 ((_ to_fp 11 53) b_ack!607)))))))))))))))
(assert (bvslt #x0000000a a_ack!608))
(assert (bvslt #x0000000b a_ack!608))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
