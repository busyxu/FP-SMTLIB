...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!433) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!433) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!5 a!3)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!433))
                 a!4))))))))
(assert (bvslt #x00000004 a_ack!434))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!6 a!4)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!433))
                 a!5)))))))))
(assert (bvslt #x00000005 a_ack!434))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!7 a!5)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!433))
                 a!6))))))))))
(assert (bvslt #x00000006 a_ack!434))
(assert (bvslt #x00000007 a_ack!434))
