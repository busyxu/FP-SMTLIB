...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!503) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!503) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000007 a_ack!504))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x402e000000000000)
                 ((_ to_fp 11 53) b_ack!503)))))))))))))
(assert (bvslt #x00000008 a_ack!504))
(assert (bvslt #x00000009 a_ack!504))
(assert (FPCHECK_FDIV_ACCURACY #x4033000000000000 b_ack!503))
