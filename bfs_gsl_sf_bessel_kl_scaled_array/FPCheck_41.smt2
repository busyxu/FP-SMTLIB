...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!181) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!181) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000001 a_ack!182))
(assert (FPCHECK_FDIV_UNDERFLOW #x4008000000000000 b_ack!181))
