...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!335) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!335) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000001 a_ack!336))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!3 a!1)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!335))
                 a!2))))))
(assert (bvslt #x00000002 a_ack!336))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!4 a!2)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!335))
                 a!3)))))))
(assert (bvslt #x00000003 a_ack!336))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!5 a!3)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!335))
                 a!4))))))))
(assert (bvslt #x00000004 a_ack!336))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
