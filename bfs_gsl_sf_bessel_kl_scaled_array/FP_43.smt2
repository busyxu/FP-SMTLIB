...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!487) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!487) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000007 a_ack!488))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!487))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x402e000000000000)
                 ((_ to_fp 11 53) b_ack!487)))))))))))))
(assert (bvslt #x00000008 a_ack!488))
