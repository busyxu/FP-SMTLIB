...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!7 a!5)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!531))
                 a!6))))))))))
(assert (bvslt #x00000006 a_ack!532))
(assert (bvslt #x00000007 a_ack!532))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x402e000000000000)
                 ((_ to_fp 11 53) b_ack!531)))))))))))))
(assert (bvslt #x00000008 a_ack!532))
(assert (bvslt #x00000009 a_ack!532))
(assert (let ((a!1 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
