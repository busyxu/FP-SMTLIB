...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!305) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!305) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!5 a!3)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!305))
                 a!4))))))))
(assert (bvslt #x00000004 a_ack!306))
(assert (FPCHECK_FDIV_OVERFLOW #x4022000000000000 b_ack!305))
