...
(assert (bvslt #x00000009 a_ack!576))
(assert (let ((a!1 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
...
(let ((a!11 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!11
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4033000000000000)
                 ((_ to_fp 11 53) b_ack!575)))))))))))))))
(assert (bvslt #x0000000a a_ack!576))
(assert (bvslt #x0000000b a_ack!576))
(assert (FPCHECK_FDIV_ACCURACY #x4037000000000000 b_ack!575))
