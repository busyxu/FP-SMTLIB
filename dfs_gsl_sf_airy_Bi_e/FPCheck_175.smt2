...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!720) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!720) ((_ to_fp 11 53) #x4010000000000000))))
...
(let ((a!20 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!20 (CF_exp a!21)))))))))))))))))))))))
