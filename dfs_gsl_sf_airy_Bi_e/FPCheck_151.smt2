...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!600) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!600) ((_ to_fp 11 53) #x4010000000000000))))
...
(let ((a!19 (fp.sub roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!18)
                    a!16)))
  (FPCHECK_FADD_OVERFLOW a!19 #xbfad14ad00dd36aa)))))))))))))))))))))
