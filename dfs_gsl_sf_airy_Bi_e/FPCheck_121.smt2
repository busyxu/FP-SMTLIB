...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (= #x00000000 (bvand b_ack!439 #x00000007))))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW a!14 a!12))))))))))))))))
