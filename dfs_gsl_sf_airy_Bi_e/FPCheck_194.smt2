...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!812) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!812) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!812) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!812) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (= #x00000000 (bvand b_ack!811 #x00000007))))
...
(let ((a!20 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3cb0000000000000
    (fp.abs (fp.mul roundNearestTiesToEven a!20 (CF_exp a!21)))))))))))))))))))))))))
