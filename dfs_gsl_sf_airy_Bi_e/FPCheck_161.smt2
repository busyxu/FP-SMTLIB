...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!648) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!648) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!648) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!648) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (= #x00000000 (bvand b_ack!647 #x00000007))))
...
(let ((a!19 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    #x3fe4000000000000
    (fp.add roundNearestTiesToEven a!19 ((_ to_fp 11 53) #xbfad14ad00dd36aa)))))))))))))))))))))))
