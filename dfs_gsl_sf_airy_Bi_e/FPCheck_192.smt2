...
(declare-fun b_ack!799 () (_ BitVec 32))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_exp ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!800) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!800) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!800) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!800) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (= #x00000000 (bvand b_ack!799 #x00000007))))
...
(let ((a!22 (fp.add roundNearestTiesToEven
      ...
      (a!24 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3cb0000000000000)
                            (fp.mul roundNearestTiesToEven a!21 (CF_exp a!23))))))
  (FPCHECK_FADD_ACCURACY
    (fp.mul roundNearestTiesToEven a!22 (CF_exp a!23))
    (fp.abs a!24))))))))))))))))))))))))
