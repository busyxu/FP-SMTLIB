...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!676) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!676) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!676) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!676) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (= #x00000000 (bvand b_ack!675 #x00000007))))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.add roundNearestTiesToEven a!20 ((_ to_fp 11 53) #x3e03d0a543132a2d))
    #x3ffae89f995ad3ae))))))))))))))))))))))
