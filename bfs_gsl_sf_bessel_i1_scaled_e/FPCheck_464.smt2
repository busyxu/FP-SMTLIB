...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!681))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!681))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!681))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!681))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) a_ack!681)))
...
(let ((a!30 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!26 a!24)
                                    ((_ to_fp 11 53) #xbe30790b9b1fa782))))))
  (FPCHECK_FADD_UNDERFLOW a!30 #x3e90dbfd2e996c58))))))))))))))))))))))))))))))))
