...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!285))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!285))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!285))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!285))
...
(let ((a!11 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    a!11
    (fp.add roundNearestTiesToEven a!8 ((_ to_fp 11 53) #xbce0c0de350f7675)))))))))))))))
