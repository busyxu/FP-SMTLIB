...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!655))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!655))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!655))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!655))
...
(let ((a!49 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!47
    (fp.add roundNearestTiesToEven a!49 ((_ to_fp 11 53) #x3e5c415394c05f14))))))))))))))))))))))))))))))))
