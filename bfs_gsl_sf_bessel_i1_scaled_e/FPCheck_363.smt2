...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!532))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!532))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!532))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!532))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!36
    (fp.add roundNearestTiesToEven a!38 ((_ to_fp 11 53) #x3dc1e1a15f5692e9))))))))))))))))))))))))))
