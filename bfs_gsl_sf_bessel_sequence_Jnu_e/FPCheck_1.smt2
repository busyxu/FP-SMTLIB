...
(assert (not (= #x00000000 c_ack!19)))
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand b_ack!18 #x00000007)))
       #x0000000000000011))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!20) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!20) ((_ to_fp 11 53) #x4024000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!20 (CF_pow a_ack!20 #x3fd5555555555555)))
