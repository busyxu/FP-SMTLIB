...
(assert (bvsle #x0000000f a_ack!1762))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000010 a_ack!1762))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1761))
...
(assert (bvsle #x00000011 a_ack!1762))
(assert (FPCHECK_FMUL_ACCURACY #x3fd5f3aa673fa911 b_ack!1761))
