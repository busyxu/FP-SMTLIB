...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fde2b7dddfefa66))
       ((_ to_fp 11 53) b_ack!2127)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000010 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000011 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000012 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000013 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000014 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(assert (bvsle #x00000015 a_ack!2128))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2127))
...
(let ((a!24 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fef3a92ca2f4b7c)
                            a!22))))
  (FPCHECK_FMUL_ACCURACY a!24 (CF_exp a!25))))))))))))))))))))))))))
