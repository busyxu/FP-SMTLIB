...
(assert (bvsle #x0000000e a_ack!1790))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1789))
...
(assert (bvsle #x0000000f a_ack!1790))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000010 a_ack!1790))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1789))
...
(assert (bvsle #x00000011 a_ack!1790))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1789))
...
(let ((a!18 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3feeea3950a8511e)
                            a!16))))
  (FPCHECK_FMUL_ACCURACY #x3fef0b6848d2af1c a!18)))))))))))))))))))
