...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fde2b7dddfefa66))
       ((_ to_fp 11 53) b_ack!2043)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2043))
...
(assert (bvsle #x00000010 a_ack!2044))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2043))
...
(assert (bvsle #x00000011 a_ack!2044))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2043))
...
(assert (bvsle #x00000012 a_ack!2044))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2043))
...
(assert (bvsle #x00000013 a_ack!2044))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2043))
...
(assert (bvsle #x00000014 a_ack!2044))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!2043))
