...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!3 a!2)))))
(assert (bvsle #x00000006 a_ack!255))
(assert (bvsle #x00000007 a_ack!255))
(assert (FPCHECK_FDIV_ACCURACY b_ack!254 #x401c000000000000))
