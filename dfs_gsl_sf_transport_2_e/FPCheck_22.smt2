...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!32) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!32) ((_ to_fp 11 53) #x404205966f2b4f12))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!32) ((_ to_fp 11 53) #x4340000000000000)))
