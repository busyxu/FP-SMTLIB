...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!74)) ((_ to_fp 11 53) #x7fefffffffffffff)))
(assert (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) a_ack!74)) #x3ff0000000000000))
