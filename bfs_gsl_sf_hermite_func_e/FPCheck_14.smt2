...
(assert (= #x00000000 (bvand a_ack!62 #x00000001)))
(assert (bvslt #x00000001 a_ack!62))
(assert (bvslt #x00000003 a_ack!62))
(assert (let ((a!1 (not (= #x00000000 (bvand (bvsdiv a_ack!62 #x00000002) #x00000001)))))
