...
(assert (fp.eq ((_ to_fp 11 53) b_ack!123) ((_ to_fp 11 53) #x0000000000000000)))
(assert (= #x00000000 (bvand a_ack!124 #x00000001)))
(assert (bvslt #x00000001 a_ack!124))
(assert (not (bvslt #x00000003 a_ack!124)))
(assert (let ((a!1 (not (= #x00000000 (bvand (bvsdiv a_ack!124 #x00000002) #x00000001)))))
