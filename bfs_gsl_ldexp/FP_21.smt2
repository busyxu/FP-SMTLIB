...
(declare-fun e_ack!382 () (_ BitVec 32))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!383) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!383) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (or (fp.isNaN (fp.abs ((_ to_fp 11 53) x_ack!383)))
               (fp.eq (fp.abs ((_ to_fp 11 53) x_ack!383))
                      ((_ to_fp 11 53) #x7ff0000000000000)))))
  (not a!1)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) x_ack!383))
             ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) x_ack!383)))
...
(assert (not (fp.geq ((_ to_fp 11 53)
               ...
               (bvadd #xfffffc02 e_ack!382))
             ((_ to_fp 11 53) #x4090000000000000))))
(assert (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #xfffffc02 e_ack!382))
