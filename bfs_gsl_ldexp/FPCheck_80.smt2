...
(assert (let ((a!1 (or (fp.isNaN (fp.abs ((_ to_fp 11 53) x_ack!324)))
  ...
  (not (not a!1))))
(assert (not (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven e_ack!323)
             ((_ to_fp 11 53) #x4090000000000000))))
(assert (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven e_ack!323)
...
(assert (let ((a!1 (CF_pow #x4000000000000000
  ...
  (FPCHECK_FMUL_UNDERFLOW x_ack!324 a!1)))
