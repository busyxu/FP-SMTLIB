...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!170) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (or (fp.isNaN (fp.abs ((_ to_fp 11 53) x_ack!170)))
               (fp.eq (fp.abs ((_ to_fp 11 53) x_ack!170))
                      ((_ to_fp 11 53) #x7ff0000000000000)))))
  (not a!1)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) x_ack!170))
             ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) x_ack!170)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4000000000000000))
                   a!4)))
  (FPCHECK_FMUL_OVERFLOW a!5 #x7fe0000000000000))))))
