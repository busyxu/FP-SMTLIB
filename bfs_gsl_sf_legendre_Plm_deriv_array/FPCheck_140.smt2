...
(assert (not (bvsle #x00000003 a_ack!587)))
(assert (bvsle #x00000000 a_ack!587))
(assert (bvsle #x00000001 a_ack!587))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3e50000000000000))))
  (not a!2))))
(assert (FPCHECK_FADD_ACCURACY #x3ff0000000000000 c_ack!586))
