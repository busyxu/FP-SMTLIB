...
(assert (= #x00000000 b_ack!247))
(assert (not (bvslt a_ack!249 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!248) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!248) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (= #x00000000 a_ack!249)))
(assert (= #x00000001 a_ack!249))
(assert (bvsle #x00000000 a_ack!249))
(assert (bvsle #x00000001 a_ack!249))
