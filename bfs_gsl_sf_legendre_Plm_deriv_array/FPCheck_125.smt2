...
(assert (not (bvsle #x00000003 a_ack!530)))
(assert (bvsle #x00000000 a_ack!530))
(assert (bvsle #x00000001 a_ack!530))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!529)
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!530)
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!2))))
(assert (FPCHECK_FADD_ACCURACY c_ack!529 #x3ff0000000000000))
