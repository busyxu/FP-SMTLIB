(declare-fun c_ack!3959 () (_ BitVec 64))
(declare-fun b_ack!3958 () (_ BitVec 64))
(declare-fun a_ack!3960 () (_ BitVec 64))
(declare-fun CF_floor ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun CF_sin ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (fp.eq ((_ to_fp 11 53) c_ack!3959) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!3958) ((_ to_fp 11 53) #x3ff0000000000000))))
