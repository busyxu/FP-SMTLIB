...
(assert (fp.eq ((_ to_fp 11 53) c_ack!2549) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!2548) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!2548) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2548) (CF_floor b_ack!2548))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2548) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2548) ((_ to_fp 11 53) #xc3045f306dc9c883)))
