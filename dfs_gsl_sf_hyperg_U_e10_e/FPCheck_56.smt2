...
(assert (fp.eq ((_ to_fp 11 53) c_ack!296) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!295) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!297))
                           ((_ to_fp 11 53) b_ack!295)))))
  (FPCHECK_FSUB_OVERFLOW a!1 #x402e000000000000)))
