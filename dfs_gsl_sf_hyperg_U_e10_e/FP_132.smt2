...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2638) (CF_floor b_ack!2638))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #x3fe0000000000000)))
