...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1075) (CF_floor b_ack!1075))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1075) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) b_ack!1075)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (FPCHECK_FSUB_ACCURACY b_ack!1075 #x4000000000000000))
