...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) c_ack!1466) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1465) (CF_floor b_ack!1465))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1465) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!1465) ((_ to_fp 11 53) #x3fe0000000000000))))
