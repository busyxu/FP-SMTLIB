...
(assert (fp.leq ((_ to_fp 11 53) b_ack!2320) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2320) (CF_floor b_ack!2320))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2320) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2320) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2320) ((_ to_fp 11 53) #xc1dfffffff800000))))
