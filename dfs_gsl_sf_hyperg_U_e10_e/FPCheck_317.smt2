...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1735) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!1735) ((_ to_fp 11 53) #x4065600000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1735) (CF_floor b_ack!1735))))
