...
(assert (fp.eq ((_ to_fp 11 53) c_ack!1385) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!1384) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1384) (CF_floor b_ack!1384))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1384) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!1384) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   a!5)))))
  (FPCHECK_FMUL_ACCURACY b_ack!1384 a!6))))))))
