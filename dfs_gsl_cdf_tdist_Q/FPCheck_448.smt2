(declare-fun mu_ack!1377 () (_ BitVec 64))
(declare-fun x_ack!1378 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (fp.gt ((_ to_fp 11 53) mu_ack!1377) ((_ to_fp 11 53) #x403e000000000000)))
(assert (fp.lt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!1378)
               ((_ to_fp 11 53) x_ack!1378))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x4024000000000000)
               ((_ to_fp 11 53) mu_ack!1377))))
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.div roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    a!6)
            a!7)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x8000000000000000) a!11)))))))))
