(declare-fun mu_ack!2023 () (_ BitVec 64))
(declare-fun x_ack!2024 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.gt ((_ to_fp 11 53) mu_ack!2023) ((_ to_fp 11 53) #x403e000000000000))))
(assert (not (fp.lt (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!2024)
                    ((_ to_fp 11 53) x_ack!2024))
            ((_ to_fp 11 53) mu_ack!2023))))
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) mu_ack!2023)
                ...
                (fp.eq (fp.mul roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) #x0000000000000000)))))
  (not a!1)))
(assert (fp.geq ((_ to_fp 11 53) x_ack!2024) ((_ to_fp 11 53) #x0000000000000000)))
