(declare-fun mu_ack!1457 () (_ BitVec 64))
(declare-fun x_ack!1458 () (_ BitVec 64))
(assert (fp.gt ((_ to_fp 11 53) mu_ack!1457) ((_ to_fp 11 53) #x403e000000000000)))
(assert (fp.lt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!1458)
               ((_ to_fp 11 53) x_ack!1458))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x4024000000000000)
               ((_ to_fp 11 53) mu_ack!1457))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1458) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!21 (fp.abs (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!20 a!7)
                                    ((_ to_fp 11 53) #x0000000000000000))
                            ((_ to_fp 11 53) #xbff0000000000000)))))
  (not (fp.lt a!21 ((_ to_fp 11 53) #x3ca0000000000000)))))))))))))))
