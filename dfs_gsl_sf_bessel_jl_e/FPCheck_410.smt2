...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd (bvmul a_ack!1269 a_ack!1269) a_ack!1269))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) #x3f20000000000000)
                      ((_ to_fp 11 53) b_ack!1268))
              a!1))))
(assert (not (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1269)
            ((_ to_fp 11 53) #x407965fea53d6e3a))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1268) ((_ to_fp 11 53) #x408f400000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1268)
            ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvmul a_ack!1269 a_ack!1269)))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1268)
                           a!2))))
  (fp.eq a!3 (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!1268))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!1268)
                                   a!2)))))
  (fp.eq a!3 (fp.div roundNearestTiesToEven ((_ to_fp 11 53) b_ack!1268) a!2)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!4)
                   a!4)))
  (fp.eq a!5 (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!1268)))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
