...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!492))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!491))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!492))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!492))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!491))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!492))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!492))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 b_ack!491))
...
(assert (bvslt #x00000004 b_ack!491))
...
(assert (bvslt #x00000005 b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(assert (bvslt #x00000006 b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(assert (bvslt #x00000007 b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(assert (bvslt #x00000008 b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(assert (bvslt #x00000009 b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4022000000000000)
                 a!7))))))))))))
(assert (bvslt #x0000000a b_ack!491))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!492))
...
(let ((a!9 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4022000000000000)
                                   a!7)))))
  (fp.eq (fp.div roundNearestTiesToEven a!9 ((_ to_fp 11 53) c_ack!492))
         (fp.sub roundNearestTiesToEven
                 a!8
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x4022000000000000)
...
(let ((a!10 (fp.div roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4022000000000000)
                                    a!7)))))
  (fp.eq a!10 ((_ to_fp 11 53) c_ack!492)))))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!492)
                           ((_ to_fp 11 53) c_ack!492))
