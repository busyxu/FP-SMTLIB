...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!111))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!111))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!110))
...
(assert (FPCHECK_FMUL_OVERFLOW #x4000000000000000 c_ack!111))
