...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!363))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!362))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!363))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!363))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!363))
...
(assert (bvslt #x00000005 b_ack!362))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!363)
                           ((_ to_fp 11 53) c_ack!363))
...
(assert (bvslt #x00000006 b_ack!362))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!363)
                           ((_ to_fp 11 53) c_ack!363))
...
(assert (bvslt #x00000007 b_ack!362))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!363)
                           ((_ to_fp 11 53) c_ack!363))
