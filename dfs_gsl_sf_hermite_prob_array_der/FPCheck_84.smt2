...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!465))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!464))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!465))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!465))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!465))
...
(assert (bvslt #x00000008 b_ack!464))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!465)
                           ((_ to_fp 11 53) c_ack!465))
...
(assert (bvslt #x00000009 b_ack!464))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!465)
                           ((_ to_fp 11 53) c_ack!465))
