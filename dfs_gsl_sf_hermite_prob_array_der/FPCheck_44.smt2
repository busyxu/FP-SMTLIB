...
(assert (not (= #x00000001 b_ack!251)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!252))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!251))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!252))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!252))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!251))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!252))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!252))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 b_ack!251))
...
(assert (bvslt #x00000004 b_ack!251))
...
(assert (bvslt #x00000005 b_ack!251))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!252)
                           ((_ to_fp 11 53) c_ack!252))
