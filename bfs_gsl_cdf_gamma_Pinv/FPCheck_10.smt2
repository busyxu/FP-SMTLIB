...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!32) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (fp.gt ((_ to_fp 11 53) x_ack!32) ((_ to_fp 11 53) #x3fee666666666666)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!31 #x3ff0000000000000))
