...
(assert (fp.lt ((_ to_fp 11 53) x_ack!1278) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!11 (fp.div roundNearestTiesToEven
                    (CF_exp (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) a_ack!1277)))
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt a!11 ((_ to_fp 11 53) a_ack!1277)))))))))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1277) ((_ to_fp 11 53) #x4024000000000000)))
