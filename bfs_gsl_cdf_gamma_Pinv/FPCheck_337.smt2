...
(assert (let ((a!1 (fp.leq (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1022) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1022) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (fp.leq ((_ to_fp 11 53) a_ack!1021) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1021) ((_ to_fp 11 53) #x3ff0000000000000))))
