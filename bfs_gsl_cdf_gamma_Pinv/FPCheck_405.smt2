...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1232) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1232) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1232) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!9)
                    (CF_log x_ack!1232))))
  (FPCHECK_FDIV_ZERO a!10 a_ack!1231))))))))
