...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!526) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!526) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt a_ack!527 #x00000000)))
(assert (not (= #x00000000 a_ack!527)))
(assert (not (= #x00000001 a_ack!527)))
(assert (not (bvslt #x000186a0 a_ack!527)))
...
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 a_ack!527))
          ((_ to_fp 11 53) #x0000000000000000))))
