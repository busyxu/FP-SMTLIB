...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!888) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt a_ack!889 #x00000000)))
(assert (not (= #x00000000 a_ack!889)))
(assert (not (= #x00000001 a_ack!889)))
(assert (bvslt #x000186a0 a_ack!889))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!888) ((_ to_fp 11 53) #x3ff0000000000000))))
