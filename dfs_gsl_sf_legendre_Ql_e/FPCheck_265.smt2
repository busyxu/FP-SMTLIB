...
(assert (bvslt #x000186a0 a_ack!791))
(assert (fp.lt ((_ to_fp 11 53) b_ack!790) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (fp.lt (CF_acos b_ack!790) ((_ to_fp 11 53) #x3f20000000000000)))
(assert (FPCHECK_FDIV_ACCURACY
  (fp.mul roundNearestTiesToEven (CF_acos b_ack!790) (CF_acos b_ack!790))
  #x402e000000000000))
