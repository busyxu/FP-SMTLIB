...
(assert (bvslt #x00000001 a_ack!1499))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!1498))
  ...
  (fp.eq a!4
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3fe0000000000000)
                         a!1))))))))
(assert (bvslt #x00000002 a_ack!1499))
...
(let ((a!4 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!4
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!1498)
                 ((_ to_fp 11 53) #x4014000000000000))))))))
(assert (bvslt #x00000003 a_ack!1499))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) b_ack!1498)
...
(let ((a!5 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!1498)
                 ((_ to_fp 11 53) #x401c000000000000)))))))))
(assert (bvslt #x00000004 a_ack!1499))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) b_ack!1498)
...
(let ((a!6 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!1498)
                 ((_ to_fp 11 53) #x4022000000000000))))))))))
(assert (bvslt #x00000005 a_ack!1499))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1498))
            ((_ to_fp 11 53) #x0000000000000000))))
