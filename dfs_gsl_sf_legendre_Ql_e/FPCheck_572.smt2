...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1922) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1922) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt a_ack!1923 #x00000000)))
(assert (not (= #x00000000 a_ack!1923)))
(assert (not (= #x00000001 a_ack!1923)))
(assert (not (bvslt #x000186a0 a_ack!1923)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1922) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1922) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1922) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvslt #x00000001 a_ack!1923))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!1922))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1922))
            ((_ to_fp 11 53) #x0000000000000000))))
