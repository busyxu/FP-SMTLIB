...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!615) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!615) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!615) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!615) ((_ to_fp 11 53) #x4020000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!23 (fp.sub roundNearestTiesToEven
                    ...
                    (CF_floor (fp.sub roundNearestTiesToEven
                                      ((_ to_fp 11 53) #x8000000000000000)
                                      ((_ to_fp 11 53) a_ack!615)))))
      (a!53 (fp.abs (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3cb0000000000000)
                            (fp.abs ((_ to_fp 11 53) a_ack!615))))))
(let ((a!2 (fp.div roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   a!1
