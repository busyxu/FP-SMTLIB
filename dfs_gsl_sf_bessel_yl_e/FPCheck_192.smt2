...
(assert (fp.lt ((_ to_fp 11 53) b_ack!860) ((_ to_fp 11 53) #x4008000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!861) #x00000000)))
(assert (not (= #x00000000 (bvand (bvadd #x00000001 a_ack!861) #x00000001))))
(assert (let ((a!1 (ite (= ((_ extract 31 31) (bvadd #x00000001 a_ack!861)) #b1)
                (concat #b1 ((_ extract 31 1) (bvadd #x00000001 a_ack!861)))
                (concat #b0 ((_ extract 31 1) (bvadd #x00000001 a_ack!861))))))
  (not (= #x00000000 a!1))))
(assert (let ((a!1 (ite (= ((_ extract 31 31) (bvadd #x00000001 a_ack!861)) #b1)
                (concat #b1 ((_ extract 31 1) (bvadd #x00000001 a_ack!861)))
                (concat #b0 ((_ extract 31 1) (bvadd #x00000001 a_ack!861))))))
...
(assert (bvult (bvadd #xffffffff (bvmul #x00000002 a_ack!861)) #x0000001a))
(assert (let ((a!1 (bvmul #x0000000000000018
                  (concat #x00000000
                          (bvadd #xffffffff (bvmul #x00000002 a_ack!861))))))
