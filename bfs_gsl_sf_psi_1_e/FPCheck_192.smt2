...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!303) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!303) ((_ to_fp 11 53) #xc000000000000000))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_pow (fp.add roundNearestTiesToEven
                           ...
                           #xc000000000000000))))
  (fp.eq a!5 a!3)))))))
(assert (FPCHECK_FADD_ACCURACY #x4000000000000000 a_ack!303))
