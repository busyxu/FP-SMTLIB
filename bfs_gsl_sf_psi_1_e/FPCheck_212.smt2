...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!330) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!330) ((_ to_fp 11 53) #xc000000000000000))))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_pow (fp.add roundNearestTiesToEven
                           ...
                           #xc000000000000000))))
  (fp.eq a!6 a!4))))))))
(assert (FPCHECK_FADD_UNDERFLOW #x4008000000000000 a_ack!330))
