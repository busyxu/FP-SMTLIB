...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!358) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!358) ((_ to_fp 11 53) #xc000000000000000))))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_pow (fp.add roundNearestTiesToEven
                           ...
                           #xc000000000000000))))
  (fp.eq a!7 a!5)))))))))
(assert (FPCHECK_FADD_UNDERFLOW #x4010000000000000 a_ack!358))
