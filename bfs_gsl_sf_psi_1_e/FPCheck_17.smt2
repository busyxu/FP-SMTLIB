...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!33) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!33) ((_ to_fp 11 53) #xc014000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             ((_ fp.to_sbv 32)
               ...
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       (CF_floor a_ack!33))))))
  (not (fp.eq (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!33) a!1)
...
(assert (bvslt #x00000000
       ((_ fp.to_sbv 32)
         ...
         (fp.sub roundNearestTiesToEven
                 ((_ to_fp 11 53) #x8000000000000000)
                 (CF_floor a_ack!33)))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!33 #x0000000000000000))
