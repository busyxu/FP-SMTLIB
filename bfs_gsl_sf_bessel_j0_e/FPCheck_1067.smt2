...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1582))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!1582))
             ((_ to_fp 11 53) #x4010000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4040000000000000)
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1582))
                           (fp.abs ((_ to_fp 11 53) a_ack!1582))))))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!28 (fp.sub roundNearestTiesToEven
                    (CF_sin (fp.abs ((_ to_fp 11 53) a_ack!1582)))
                    (CF_cos (fp.abs ((_ to_fp 11 53) a_ack!1582))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           (fp.sub roundNearestTiesToEven
