...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1512))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!1512))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!28 (fp.add roundNearestTiesToEven
                    (CF_sin (fp.abs ((_ to_fp 11 53) a_ack!1512)))
                    (CF_cos (fp.abs ((_ to_fp 11 53) a_ack!1512))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           (fp.sub roundNearestTiesToEven
...
(let ((a!27 (CF_cos (fp.div roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #xbfbf89c2dd0e99d3))
                            (fp.abs ((_ to_fp 11 53) a_ack!1512))))))
  (FPCHECK_FMUL_ACCURACY a!27 a!28)))))))))))))))))))))))))))))
