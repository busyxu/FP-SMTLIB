...
(declare-fun c_ack!12 () (_ BitVec 32))
...
(assert (not (= #x00000000 c_ack!12)))
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand b_ack!11 #x00000007)))
       #x0000000000000011))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!13) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!13) ((_ to_fp 11 53) #x4024000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!13 (CF_pow a_ack!13 #x3fd5555555555555)))
