(declare-fun t_ack!6841 () (_ BitVec 64))
(declare-fun t1_ack!6842 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6844 () (_ BitVec 64))
(declare-fun h_ack!6845 () (_ BitVec 64))
(declare-fun y0_ack!6843 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6842)
                    ((_ to_fp 11 53) t_ack!6841))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6844))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6843)
                                   ((_ to_fp 11 53) y0_ack!6843))
...
(let ((a!115 (fp.sub roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     a!114
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3fa6c16c16c16c17 a!115)))))))))))))))))))))))))))))))))))
