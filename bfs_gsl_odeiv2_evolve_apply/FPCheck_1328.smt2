(declare-fun t_ack!6382 () (_ BitVec 64))
(declare-fun t1_ack!6383 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6385 () (_ BitVec 64))
(declare-fun h_ack!6386 () (_ BitVec 64))
(declare-fun y0_ack!6384 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6383)
                    ((_ to_fp 11 53) t_ack!6382))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6385))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6384)
                                   ((_ to_fp 11 53) y0_ack!6384))
