(declare-fun t_ack!1670 () (_ BitVec 64))
(declare-fun t1_ack!1671 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!1673 () (_ BitVec 64))
(declare-fun h_ack!1674 () (_ BitVec 64))
(declare-fun y0_ack!1672 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1671)
                    ((_ to_fp 11 53) t_ack!1670))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1673))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1672)
                                   ((_ to_fp 11 53) y0_ack!1672))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33)))))
  (FPCHECK_FADD_UNDERFLOW y1_ack!1673 a!34))))))))))))))))))
