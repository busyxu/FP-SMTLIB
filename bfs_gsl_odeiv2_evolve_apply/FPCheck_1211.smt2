(declare-fun t_ack!5809 () (_ BitVec 64))
(declare-fun t1_ack!5810 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5812 () (_ BitVec 64))
(declare-fun h_ack!5813 () (_ BitVec 64))
(declare-fun y0_ack!5811 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5810)
                    ((_ to_fp 11 53) t_ack!5809))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5812))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5811)
                                   ((_ to_fp 11 53) y0_ack!5811))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5811)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5813) a!132)))))))))))))))))))))))))))))))))))))))
