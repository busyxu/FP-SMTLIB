(declare-fun t_ack!4489 () (_ BitVec 64))
(declare-fun t1_ack!4490 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!4492 () (_ BitVec 64))
(declare-fun h_ack!4493 () (_ BitVec 64))
(declare-fun y0_ack!4491 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4490)
                    ((_ to_fp 11 53) t_ack!4489))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4492))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4491)
                                   ((_ to_fp 11 53) y0_ack!4491))
...
(let ((a!95 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4493)
                                    a!94)))))
  (FPCHECK_FSUB_ACCURACY a!95 #x3ff0000000000000))))))))))))))))))))))))))))))))
