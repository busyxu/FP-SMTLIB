(declare-fun t_ack!4295 () (_ BitVec 64))
(declare-fun t1_ack!4296 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4298 () (_ BitVec 64))
(declare-fun h_ack!4299 () (_ BitVec 64))
(declare-fun y0_ack!4297 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4296)
                    ((_ to_fp 11 53) t_ack!4295))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!43
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x40189f9250f88c23) a!55))))))))))))))))))))))))
