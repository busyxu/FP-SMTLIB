...
(declare-fun t1_ack!3176 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3178 () (_ BitVec 64))
(declare-fun h_ack!3179 () (_ BitVec 64))
(declare-fun y0_ack!3177 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3176)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3178))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3177)
                                   ((_ to_fp 11 53) y0_ack!3177))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3177)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3179) a!62)))))))))))))))))))))))))))
