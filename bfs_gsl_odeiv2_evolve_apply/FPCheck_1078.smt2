(declare-fun t_ack!5159 () (_ BitVec 64))
(declare-fun t1_ack!5160 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5162 () (_ BitVec 64))
(declare-fun h_ack!5163 () (_ BitVec 64))
(declare-fun y0_ack!5161 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5160)
                    ((_ to_fp 11 53) t_ack!5159))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5162))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5161)
                                   ((_ to_fp 11 53) y0_ack!5161))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5162) a!124)))))))))))))))))))))))))))))))))))))
