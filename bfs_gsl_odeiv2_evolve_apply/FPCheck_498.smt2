(declare-fun t_ack!2346 () (_ BitVec 64))
(declare-fun t1_ack!2347 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2348 () (_ BitVec 64))
(declare-fun y1_ack!2349 () (_ BitVec 64))
(declare-fun h_ack!2350 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2347)
                    ((_ to_fp 11 53) t_ack!2346))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2349))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2348)
                                   ((_ to_fp 11 53) y0_ack!2348))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2349)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2350) a!43)))))))))))))))))))))))
