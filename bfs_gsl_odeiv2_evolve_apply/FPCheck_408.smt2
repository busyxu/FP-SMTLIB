...
(declare-fun t1_ack!1918 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!1920 () (_ BitVec 64))
(declare-fun h_ack!1921 () (_ BitVec 64))
(declare-fun y0_ack!1919 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1918)
...
(let ((a!38 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!1920)
                                    a!37)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!1921 a!38)))))))))))))))))))
