(declare-fun t_ack!6162 () (_ BitVec 64))
(declare-fun t1_ack!6163 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6164 () (_ BitVec 64))
(declare-fun y1_ack!6165 () (_ BitVec 64))
(declare-fun h_ack!6166 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6163)
                    ((_ to_fp 11 53) t_ack!6162))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6165)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6166) a!26)))))))))))))))))
