(declare-fun t_ack!6337 () (_ BitVec 64))
(declare-fun t1_ack!6338 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6339 () (_ BitVec 64))
(declare-fun y1_ack!6340 () (_ BitVec 64))
(declare-fun h_ack!6341 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6338)
                    ((_ to_fp 11 53) t_ack!6337))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6340))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6339)
                                   ((_ to_fp 11 53) y0_ack!6339))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6340)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6341) a!103)))))))))))))))))))))))))))))))))))
