(declare-fun t_ack!3661 () (_ BitVec 64))
(declare-fun t1_ack!3662 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3664 () (_ BitVec 64))
(declare-fun h_ack!3665 () (_ BitVec 64))
(declare-fun y0_ack!3663 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3662)
                    ((_ to_fp 11 53) t_ack!3661))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3664))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3663)
                                   ((_ to_fp 11 53) y0_ack!3663))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!43
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x402db2d7daa814a6) a!55))))))))))))))))))))))))
