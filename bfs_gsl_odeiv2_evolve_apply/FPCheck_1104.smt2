(declare-fun t_ack!5283 () (_ BitVec 64))
(declare-fun t1_ack!5284 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5286 () (_ BitVec 64))
(declare-fun h_ack!5287 () (_ BitVec 64))
(declare-fun y0_ack!5285 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5284)
                    ((_ to_fp 11 53) t_ack!5283))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5286))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5285)
                                   ((_ to_fp 11 53) y0_ack!5285))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fcea1cd5438b4f0
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5286) a!34)))))))))))))))))))
