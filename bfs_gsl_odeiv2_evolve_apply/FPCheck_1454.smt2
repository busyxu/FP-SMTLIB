(declare-fun t_ack!7000 () (_ BitVec 64))
(declare-fun t1_ack!7001 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!7002 () (_ BitVec 64))
(declare-fun y1_ack!7003 () (_ BitVec 64))
(declare-fun h_ack!7004 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7001)
                    ((_ to_fp 11 53) t_ack!7000))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7003))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7002)
                                   ((_ to_fp 11 53) y0_ack!7002))
