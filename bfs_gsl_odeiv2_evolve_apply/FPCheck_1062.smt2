(declare-fun t_ack!5085 () (_ BitVec 64))
(declare-fun t1_ack!5086 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5088 () (_ BitVec 64))
(declare-fun h_ack!5089 () (_ BitVec 64))
(declare-fun y0_ack!5087 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5086)
                    ((_ to_fp 11 53) t_ack!5085))
...
(let ((a!115 (fp.sub roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     a!114
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x0000000000000000 a!115)))))))))))))))))))))))))))))))))))
