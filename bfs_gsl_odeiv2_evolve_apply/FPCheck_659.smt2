(declare-fun t_ack!3127 () (_ BitVec 64))
(declare-fun t1_ack!3128 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3129 () (_ BitVec 64))
(declare-fun y1_ack!3130 () (_ BitVec 64))
(declare-fun h_ack!3131 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3128)
                    ((_ to_fp 11 53) t_ack!3127))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3130))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3129)
                                   ((_ to_fp 11 53) y0_ack!3129))
...
(let ((a!69 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!55))
                    a!68)))
  (FPCHECK_FMUL_ACCURACY h_ack!3131 a!69)))))))))))))))))))))))))))
