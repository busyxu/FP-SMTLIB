(declare-fun t_ack!4613 () (_ BitVec 64))
(declare-fun t1_ack!4614 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4615 () (_ BitVec 64))
(declare-fun y1_ack!4616 () (_ BitVec 64))
(declare-fun h_ack!4617 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4614)
                    ((_ to_fp 11 53) t_ack!4613))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4616))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4615)
                                   ((_ to_fp 11 53) y0_ack!4615))
...
(let ((a!29 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4617)
                                    a!28)))))
  (FPCHECK_FADD_UNDERFLOW (fp.add roundNearestTiesToEven a!14 a!21) a!29))))))))))))))))
