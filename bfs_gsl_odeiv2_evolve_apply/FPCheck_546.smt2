(declare-fun t_ack!2583 () (_ BitVec 64))
(declare-fun t1_ack!2584 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2586 () (_ BitVec 64))
(declare-fun h_ack!2587 () (_ BitVec 64))
(declare-fun y0_ack!2585 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2584)
                    ((_ to_fp 11 53) t_ack!2583))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2586))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2585)
                                   ((_ to_fp 11 53) y0_ack!2585))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!55)))))
  (FPCHECK_FADD_OVERFLOW y1_ack!2586 a!56))))))))))))))))))))))))
