(declare-fun t_ack!2880 () (_ BitVec 64))
(declare-fun t1_ack!2881 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2883 () (_ BitVec 64))
(declare-fun h_ack!2884 () (_ BitVec 64))
(declare-fun y0_ack!2882 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2881)
                    ((_ to_fp 11 53) t_ack!2880))
...
(let ((a!61 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2883) a!61))))))))))))))))))))))))))
