(declare-fun t_ack!6312 () (_ BitVec 64))
(declare-fun t1_ack!6313 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6315 () (_ BitVec 64))
(declare-fun h_ack!6316 () (_ BitVec 64))
(declare-fun y0_ack!6314 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6313)
                    ((_ to_fp 11 53) t_ack!6312))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6315))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6314)
                                   ((_ to_fp 11 53) y0_ack!6314))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fb454949b1a0f2c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6315) a!86)))))))))))))))))))))))))))))))
