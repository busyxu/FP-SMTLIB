(declare-fun t_ack!4370 () (_ BitVec 64))
(declare-fun t1_ack!4371 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4372 () (_ BitVec 64))
(declare-fun y1_ack!4373 () (_ BitVec 64))
(declare-fun h_ack!4374 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4371)
                    ((_ to_fp 11 53) t_ack!4370))
...
(let ((a!62 (fp.add roundNearestTiesToEven
      ...
      (a!89 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven a!87 a!88)
                    (fp.mul roundNearestTiesToEven
      ...
      (a!82 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!72)
                            a!73)))
      (a!90 (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) y0_ack!4372)
                            (fp.mul roundNearestTiesToEven
...
(let ((a!77 (fp.add roundNearestTiesToEven
      ...
      (a!93 (fp.sub roundNearestTiesToEven
                    a!90
                    (fp.mul roundNearestTiesToEven
                            a!91
                            (fp.sub roundNearestTiesToEven
                                    a!92
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
(let ((a!94 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) h_ack!4374)
                    (fp.add roundNearestTiesToEven
                            a!83
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x401489672d167d27)
                                    a!93)))))
(let ((a!95 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4024000000000000)
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!4373)
                                    a!94))
                    (fp.sub roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven a!77 a!77)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
