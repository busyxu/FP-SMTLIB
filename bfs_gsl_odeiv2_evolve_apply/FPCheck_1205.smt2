(declare-fun t_ack!5785 () (_ BitVec 64))
(declare-fun t1_ack!5786 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5787 () (_ BitVec 64))
(declare-fun y1_ack!5788 () (_ BitVec 64))
(declare-fun h_ack!5789 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5786)
                    ((_ to_fp 11 53) t_ack!5785))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5788))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5787)
                                   ((_ to_fp 11 53) y0_ack!5787))
...
(let ((a!144 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y1_ack!5788
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5789) a!144))))))))))))))))))))))))))))))))))))))))
