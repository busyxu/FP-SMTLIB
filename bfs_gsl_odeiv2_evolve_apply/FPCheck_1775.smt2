(declare-fun t_ack!9932 () (_ BitVec 64))
(declare-fun t1_ack!9933 () (_ BitVec 64))
(declare-fun h_ack!9936 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!9934 () (_ BitVec 64))
(declare-fun y1_ack!9935 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!9933)
                    ((_ to_fp 11 53) t_ack!9932))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!9932))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!9936)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!9935))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!9934)
                                   ((_ to_fp 11 53) y0_ack!9934))
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!25))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!9936 a!26)))))))))))))))
