(declare-fun t_ack!6013 () (_ BitVec 64))
(declare-fun t1_ack!6014 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6016 () (_ BitVec 64))
(declare-fun h_ack!6017 () (_ BitVec 64))
(declare-fun y0_ack!6015 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6014)
                    ((_ to_fp 11 53) t_ack!6013))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6016))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6015)
                                   ((_ to_fp 11 53) y0_ack!6015))
...
(let ((a!59 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6016) a!59))))))))))))))))))))))))))
