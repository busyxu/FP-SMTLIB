(declare-fun t_ack!6796 () (_ BitVec 64))
(declare-fun t1_ack!6797 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6799 () (_ BitVec 64))
(declare-fun h_ack!6800 () (_ BitVec 64))
(declare-fun y0_ack!6798 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6797)
                    ((_ to_fp 11 53) t_ack!6796))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6799))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6798)
                                   ((_ to_fp 11 53) y0_ack!6798))
