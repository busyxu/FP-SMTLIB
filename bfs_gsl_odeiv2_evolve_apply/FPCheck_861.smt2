(declare-fun t_ack!4098 () (_ BitVec 64))
(declare-fun t1_ack!4099 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4101 () (_ BitVec 64))
(declare-fun h_ack!4102 () (_ BitVec 64))
(declare-fun y0_ack!4100 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4099)
                    ((_ to_fp 11 53) t_ack!4098))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4101))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4100)
                                   ((_ to_fp 11 53) y0_ack!4100))
...
(let ((a!93 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4101) a!93))))))))))))))))))))))))))))))))
