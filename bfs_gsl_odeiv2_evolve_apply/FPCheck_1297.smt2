(declare-fun t_ack!6227 () (_ BitVec 64))
(declare-fun t1_ack!6228 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6229 () (_ BitVec 64))
(declare-fun y1_ack!6230 () (_ BitVec 64))
(declare-fun h_ack!6231 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6228)
                    ((_ to_fp 11 53) t_ack!6227))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6230))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6229)
                                   ((_ to_fp 11 53) y0_ack!6229))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!6231)
                                    a!45)))))
  (FPCHECK_FADD_OVERFLOW a!36 a!46))))))))))))))))))))))
