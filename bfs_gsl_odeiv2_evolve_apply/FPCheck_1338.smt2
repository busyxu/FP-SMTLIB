(declare-fun t_ack!6429 () (_ BitVec 64))
(declare-fun t1_ack!6430 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6432 () (_ BitVec 64))
(declare-fun h_ack!6433 () (_ BitVec 64))
(declare-fun y0_ack!6431 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6430)
                    ((_ to_fp 11 53) t_ack!6429))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6432))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6431)
                                   ((_ to_fp 11 53) y0_ack!6431))
...
(let ((a!32 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!2
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfac643f63bea075) a!32))))))))))))))))))
