(declare-fun t_ack!3454 () (_ BitVec 64))
(declare-fun t1_ack!3455 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3456 () (_ BitVec 64))
(declare-fun y1_ack!3457 () (_ BitVec 64))
(declare-fun h_ack!3458 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3455)
                    ((_ to_fp 11 53) t_ack!3454))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3457)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3458) a!69)))))))))))))))))))))))))))))
