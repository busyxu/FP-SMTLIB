(declare-fun t_ack!2641 () (_ BitVec 64))
(declare-fun t1_ack!2642 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2644 () (_ BitVec 64))
(declare-fun h_ack!2645 () (_ BitVec 64))
(declare-fun y0_ack!2643 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2642)
                    ((_ to_fp 11 53) t_ack!2641))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2644))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2643)
                                   ((_ to_fp 11 53) y0_ack!2643))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2644) a!56)))))))))))))))))))))))))
