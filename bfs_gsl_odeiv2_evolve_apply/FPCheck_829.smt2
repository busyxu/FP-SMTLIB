(declare-fun t_ack!3938 () (_ BitVec 64))
(declare-fun t1_ack!3939 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3940 () (_ BitVec 64))
(declare-fun y1_ack!3941 () (_ BitVec 64))
(declare-fun h_ack!3942 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3939)
                    ((_ to_fp 11 53) t_ack!3938))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3941)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3942) a!26)))))))))))))))))
