(declare-fun t_ack!11782 () (_ BitVec 64))
(declare-fun t1_ack!11783 () (_ BitVec 64))
(declare-fun h_ack!11786 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y1_ack!11785 () (_ BitVec 64))
(declare-fun y0_ack!11784 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11783)
                    ((_ to_fp 11 53) t_ack!11782))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11782))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11786)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11785))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11784)
                                   ((_ to_fp 11 53) y0_ack!11784))
...
(let ((a!39 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!11786)
                                    a!38)))))
  (FPCHECK_FSUB_UNDERFLOW a!39 #x3ff0000000000000))))))))))))))))))))
