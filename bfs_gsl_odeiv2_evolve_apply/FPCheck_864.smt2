(declare-fun t_ack!4113 () (_ BitVec 64))
(declare-fun t1_ack!4114 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4116 () (_ BitVec 64))
(declare-fun h_ack!4117 () (_ BitVec 64))
(declare-fun y0_ack!4115 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4114)
                    ((_ to_fp 11 53) t_ack!4113))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4116))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4115)
                                   ((_ to_fp 11 53) y0_ack!4115))
...
(let ((a!94 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!4116)
                                    a!93)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!4117 a!94)))))))))))))))))))))))))))))))
