(declare-fun t_ack!5313 () (_ BitVec 64))
(declare-fun t1_ack!5314 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5315 () (_ BitVec 64))
(declare-fun y1_ack!5316 () (_ BitVec 64))
(declare-fun h_ack!5317 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5314)
                    ((_ to_fp 11 53) t_ack!5313))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5316))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5315)
                                   ((_ to_fp 11 53) y0_ack!5315))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5316)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5317) a!43)))))))))))))))))))))))
