(declare-fun t_ack!6716 () (_ BitVec 64))
(declare-fun t1_ack!6717 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6719 () (_ BitVec 64))
(declare-fun h_ack!6720 () (_ BitVec 64))
(declare-fun y0_ack!6718 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6717)
                    ((_ to_fp 11 53) t_ack!6716))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6719))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6718)
                                   ((_ to_fp 11 53) y0_ack!6718))
...
(let ((a!51 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!50
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x4003bd1f79ac8e22 a!51)))))))))))))))))))))))
