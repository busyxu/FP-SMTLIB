(declare-fun t_ack!6157 () (_ BitVec 64))
(declare-fun t1_ack!6158 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6159 () (_ BitVec 64))
(declare-fun y1_ack!6160 () (_ BitVec 64))
(declare-fun h_ack!6161 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6158)
                    ((_ to_fp 11 53) t_ack!6157))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6160))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6159)
                                   ((_ to_fp 11 53) y0_ack!6159))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6160)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6161) a!26)))))))))))))))))
