(declare-fun t_ack!4598 () (_ BitVec 64))
(declare-fun t1_ack!4599 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4600 () (_ BitVec 64))
(declare-fun y1_ack!4601 () (_ BitVec 64))
(declare-fun h_ack!4602 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4599)
                    ((_ to_fp 11 53) t_ack!4598))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4601)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4602) a!26)))))))))))))))))
