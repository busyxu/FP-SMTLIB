(declare-fun t_ack!3324 () (_ BitVec 64))
(declare-fun t1_ack!3325 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3326 () (_ BitVec 64))
(declare-fun y1_ack!3327 () (_ BitVec 64))
(declare-fun h_ack!3328 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3325)
                    ((_ to_fp 11 53) t_ack!3324))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3327))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3326)
                                   ((_ to_fp 11 53) y0_ack!3326))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3327)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3328) a!26)))))))))))))))))
