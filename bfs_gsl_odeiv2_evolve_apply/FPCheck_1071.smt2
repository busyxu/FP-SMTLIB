(declare-fun t_ack!5130 () (_ BitVec 64))
(declare-fun t1_ack!5131 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5133 () (_ BitVec 64))
(declare-fun h_ack!5134 () (_ BitVec 64))
(declare-fun y0_ack!5132 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5131)
                    ((_ to_fp 11 53) t_ack!5130))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5133))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5132)
                                   ((_ to_fp 11 53) y0_ack!5132))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x0000000000000000)
                                     a!123)))))
  (FPCHECK_FADD_ACCURACY y1_ack!5133 a!124))))))))))))))))))))))))))))))))))))
