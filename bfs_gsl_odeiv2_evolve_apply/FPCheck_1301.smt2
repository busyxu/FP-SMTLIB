(declare-fun t_ack!6247 () (_ BitVec 64))
(declare-fun t1_ack!6248 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6250 () (_ BitVec 64))
(declare-fun h_ack!6251 () (_ BitVec 64))
(declare-fun y0_ack!6249 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6248)
                    ((_ to_fp 11 53) t_ack!6247))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6250))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6249)
                                   ((_ to_fp 11 53) y0_ack!6249))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xc0046022f1dbd988
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6250) a!56)))))))))))))))))))))))))
