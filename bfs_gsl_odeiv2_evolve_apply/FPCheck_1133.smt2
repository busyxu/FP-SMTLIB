(declare-fun t_ack!5428 () (_ BitVec 64))
...
(declare-fun h_ack!5432 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5429)
                    ((_ to_fp 11 53) t_ack!5428))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5431)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5432) a!103)))))))))))))))))))))))))))))))))))
