(declare-fun t_ack!7010 () (_ BitVec 64))
(declare-fun t1_ack!7011 () (_ BitVec 64))
(declare-fun y0_ack!7012 () (_ BitVec 64))
(declare-fun y1_ack!7013 () (_ BitVec 64))
(declare-fun h_ack!7014 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7011)
                    ((_ to_fp 11 53) t_ack!7010))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7013))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7012)
                                   ((_ to_fp 11 53) y0_ack!7012))
...
(let ((a!145 (fp.abs (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!7014)
                                     a!144)))))
  (FPCHECK_FMUL_OVERFLOW #x3ff0000000000000 a!145))))))))))))))))))))))))))))))))))))))))
