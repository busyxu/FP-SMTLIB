...
(declare-fun y0_ack!5245 () (_ BitVec 64))
(declare-fun y1_ack!5246 () (_ BitVec 64))
(declare-fun h_ack!5247 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5246))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5245)
                                   ((_ to_fp 11 53) y0_ack!5245))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5246)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5247) a!26)))))))))))))))))
