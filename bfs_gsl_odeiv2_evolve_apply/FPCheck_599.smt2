(declare-fun t_ack!2830 () (_ BitVec 64))
(declare-fun t1_ack!2831 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2831)
                    ((_ to_fp 11 53) t_ack!2830))
...
(let ((a!37 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2833) a!37))))))))))))))))))))
