(declare-fun t_ack!3170 () (_ BitVec 64))
(declare-fun t1_ack!3171 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3173 () (_ BitVec 64))
(declare-fun h_ack!3174 () (_ BitVec 64))
(declare-fun y0_ack!3172 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3171)
                    ((_ to_fp 11 53) t_ack!3170))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3172)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3174) a!62)))))))))))))))))))))))))))
