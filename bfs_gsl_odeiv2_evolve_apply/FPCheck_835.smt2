(declare-fun t_ack!3968 () (_ BitVec 64))
(declare-fun t1_ack!3969 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3971 () (_ BitVec 64))
(declare-fun h_ack!3972 () (_ BitVec 64))
(declare-fun y0_ack!3970 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3969)
                    ((_ to_fp 11 53) t_ack!3968))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3971))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3970)
                                   ((_ to_fp 11 53) y0_ack!3970))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x40164fca455cea0c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3971) a!34)))))))))))))))))))
