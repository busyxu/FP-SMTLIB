(declare-fun t_ack!5874 () (_ BitVec 64))
(declare-fun t1_ack!5875 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5877 () (_ BitVec 64))
(declare-fun h_ack!5878 () (_ BitVec 64))
(declare-fun y0_ack!5876 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5875)
                    ((_ to_fp 11 53) t_ack!5874))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5877))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5876)
                                   ((_ to_fp 11 53) y0_ack!5876))
...
(let ((a!144 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!122))
                     a!143)))
(let ((a!145 (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x4024000000000000)
                     (fp.add roundNearestTiesToEven
                             ((_ to_fp 11 53) y1_ack!5877)
                             (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    a!145
    (fp.sub roundNearestTiesToEven a!154 ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))))))))))))))))))))
