...
(declare-fun y1_ack!5276 () (_ BitVec 64))
(declare-fun h_ack!5277 () (_ BitVec 64))
(declare-fun y0_ack!5275 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5276))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5275)
                                   ((_ to_fp 11 53) y0_ack!5275))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fcea1cd5438b4f0
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5276) a!34)))))))))))))))))))
