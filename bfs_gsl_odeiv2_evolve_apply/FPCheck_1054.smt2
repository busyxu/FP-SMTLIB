(declare-fun t_ack!5045 () (_ BitVec 64))
(declare-fun t1_ack!5046 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5048 () (_ BitVec 64))
(declare-fun h_ack!5049 () (_ BitVec 64))
(declare-fun y0_ack!5047 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5046)
                    ((_ to_fp 11 53) t_ack!5045))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5048))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5047)
                                   ((_ to_fp 11 53) y0_ack!5047))
...
(let ((a!85 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!69
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfcdfd195e96a441) a!85))))))))))))))))))))))))))))))
