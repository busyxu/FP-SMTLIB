(declare-fun t_ack!2386 () (_ BitVec 64))
(declare-fun t1_ack!2387 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2388 () (_ BitVec 64))
(declare-fun y1_ack!2389 () (_ BitVec 64))
(declare-fun h_ack!2390 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2387)
                    ((_ to_fp 11 53) t_ack!2386))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2389))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2388)
                                   ((_ to_fp 11 53) y0_ack!2388))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!2390)
                                    a!47)))))
  (FPCHECK_FMUL_ACCURACY h_ack!2390 (fp.add roundNearestTiesToEven a!38 a!48)))))))))))))))))))))))
