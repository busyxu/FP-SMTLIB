(declare-fun t_ack!6736 () (_ BitVec 64))
(declare-fun t1_ack!6737 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6739 () (_ BitVec 64))
(declare-fun h_ack!6740 () (_ BitVec 64))
(declare-fun y0_ack!6738 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6737)
                    ((_ to_fp 11 53) t_ack!6736))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6739))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6738)
                                   ((_ to_fp 11 53) y0_ack!6738))
...
(let ((a!54 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!42
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x4003bd1f79ac8e22) a!54))))))))))))))))))))))))
