(declare-fun t_ack!1349 () (_ BitVec 64))
(declare-fun t1_ack!1350 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!1351 () (_ BitVec 64))
(declare-fun y1_ack!1352 () (_ BitVec 64))
(declare-fun h_ack!1353 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1350)
                    ((_ to_fp 11 53) t_ack!1349))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1352))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1351)
                                   ((_ to_fp 11 53) y0_ack!1351))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!1352)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!1353) a!26)))))))))))))))))
