(declare-fun t_ack!7090 () (_ BitVec 64))
(declare-fun t1_ack!7091 () (_ BitVec 64))
(declare-fun y0_ack!7092 () (_ BitVec 64))
(declare-fun y1_ack!7093 () (_ BitVec 64))
(declare-fun h_ack!7094 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7091)
                    ((_ to_fp 11 53) t_ack!7090))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7093))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7092)
                                   ((_ to_fp 11 53) y0_ack!7092))
...
(let ((a!167 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.abs (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!7094) a!152))
    (fp.abs (fp.add roundNearestTiesToEven
                    a!167
                    ((_ to_fp 11 53) #x3eb0c6f7a0b5ed8d))))))))))))))))))))))))))))))))))))))))))))))
