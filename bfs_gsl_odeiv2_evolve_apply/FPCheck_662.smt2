(declare-fun t_ack!3142 () (_ BitVec 64))
(declare-fun t1_ack!3143 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3143)
                    ((_ to_fp 11 53) t_ack!3142))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!3145
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3146) a!69))))))))))))))))))))))))))))
