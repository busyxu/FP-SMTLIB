(declare-fun t_ack!5908 () (_ BitVec 64))
(declare-fun t1_ack!5909 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5910 () (_ BitVec 64))
(declare-fun y1_ack!5911 () (_ BitVec 64))
(declare-fun h_ack!5912 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5909)
                    ((_ to_fp 11 53) t_ack!5908))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5911))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5910)
                                   ((_ to_fp 11 53) y0_ack!5910))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5911)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5912) a!26)))))))))))))))))
