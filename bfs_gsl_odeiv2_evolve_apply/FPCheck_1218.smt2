(declare-fun t_ack!5844 () (_ BitVec 64))
(declare-fun t1_ack!5845 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5847 () (_ BitVec 64))
(declare-fun h_ack!5848 () (_ BitVec 64))
(declare-fun y0_ack!5846 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5845)
                    ((_ to_fp 11 53) t_ack!5844))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5847))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5846)
                                   ((_ to_fp 11 53) y0_ack!5846))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5846)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5848) a!132))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5846)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5848) a!132)))))))))))))))))))))))))))))))))))))))
