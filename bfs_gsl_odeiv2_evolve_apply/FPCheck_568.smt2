(declare-fun t_ack!2681 () (_ BitVec 64))
(declare-fun t1_ack!2682 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2683 () (_ BitVec 64))
(declare-fun y1_ack!2684 () (_ BitVec 64))
(declare-fun h_ack!2685 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2682)
                    ((_ to_fp 11 53) t_ack!2681))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2684))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2683)
                                   ((_ to_fp 11 53) y0_ack!2683))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x4024000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2684) a!56))
    (fp.sub roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!62 a!62)
            ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))))
