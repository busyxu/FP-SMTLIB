(declare-fun t_ack!4033 () (_ BitVec 64))
(declare-fun t1_ack!4034 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4036 () (_ BitVec 64))
(declare-fun h_ack!4037 () (_ BitVec 64))
(declare-fun y0_ack!4035 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4034)
                    ((_ to_fp 11 53) t_ack!4033))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4036))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4035)
                                   ((_ to_fp 11 53) y0_ack!4035))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xc0143f985843ddf3
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4036) a!56)))))))))))))))))))))))))
