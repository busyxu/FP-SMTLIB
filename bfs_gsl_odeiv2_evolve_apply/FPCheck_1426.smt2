(declare-fun t_ack!6866 () (_ BitVec 64))
(declare-fun t1_ack!6867 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6868 () (_ BitVec 64))
(declare-fun y1_ack!6869 () (_ BitVec 64))
(declare-fun h_ack!6870 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6867)
                    ((_ to_fp 11 53) t_ack!6866))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6869))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6868)
                                   ((_ to_fp 11 53) y0_ack!6868))
