(declare-fun t_ack!2132 () (_ BitVec 64))
(declare-fun t1_ack!2133 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2135 () (_ BitVec 64))
(declare-fun h_ack!2136 () (_ BitVec 64))
(declare-fun y0_ack!2134 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2133)
                    ((_ to_fp 11 53) t_ack!2132))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2135))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2134)
                                   ((_ to_fp 11 53) y0_ack!2134))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!2134)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2136) a!38)))))))))))))))))))))
