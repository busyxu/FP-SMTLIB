(declare-fun t_ack!4415 () (_ BitVec 64))
(declare-fun t1_ack!4416 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4417 () (_ BitVec 64))
(declare-fun y1_ack!4418 () (_ BitVec 64))
(declare-fun h_ack!4419 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4416)
                    ((_ to_fp 11 53) t_ack!4415))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y1_ack!4418
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4419) a!103))))))))))))))))))))))))))))))))))
