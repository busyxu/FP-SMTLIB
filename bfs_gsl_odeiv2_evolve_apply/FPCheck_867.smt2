(declare-fun t_ack!4128 () (_ BitVec 64))
(declare-fun t1_ack!4129 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4131 () (_ BitVec 64))
(declare-fun h_ack!4132 () (_ BitVec 64))
(declare-fun y0_ack!4130 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4129)
                    ((_ to_fp 11 53) t_ack!4128))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4131))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4130)
                                   ((_ to_fp 11 53) y0_ack!4130))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y0_ack!4130
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4132) a!94))))))))))))))))))))))))))))))))
