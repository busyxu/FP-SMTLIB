(declare-fun t_ack!2291 () (_ BitVec 64))
(declare-fun t1_ack!2292 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2293 () (_ BitVec 64))
(declare-fun y1_ack!2294 () (_ BitVec 64))
(declare-fun h_ack!2295 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2292)
                    ((_ to_fp 11 53) t_ack!2291))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2294)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2295) a!26)))))))))))))))))
