(declare-fun t_ack!3137 () (_ BitVec 64))
(declare-fun t1_ack!3138 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3139 () (_ BitVec 64))
(declare-fun y1_ack!3140 () (_ BitVec 64))
(declare-fun h_ack!3141 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3138)
                    ((_ to_fp 11 53) t_ack!3137))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3140))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3139)
                                   ((_ to_fp 11 53) y0_ack!3139))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y1_ack!3140
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3141) a!69))))))))))))))))))))))))))))
