(declare-fun t_ack!6123 () (_ BitVec 64))
(declare-fun t1_ack!6124 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6126 () (_ BitVec 64))
(declare-fun h_ack!6127 () (_ BitVec 64))
(declare-fun y0_ack!6125 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6124)
                    ((_ to_fp 11 53) t_ack!6123))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6126))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6125)
                                   ((_ to_fp 11 53) y0_ack!6125))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fd0000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6126) a!124)))))))))))))))))))))))))))))))))))))
