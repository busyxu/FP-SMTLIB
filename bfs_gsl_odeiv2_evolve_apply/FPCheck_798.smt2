(declare-fun t_ack!3789 () (_ BitVec 64))
(declare-fun t1_ack!3790 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3792 () (_ BitVec 64))
(declare-fun h_ack!3793 () (_ BitVec 64))
(declare-fun y0_ack!3791 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3790)
                    ((_ to_fp 11 53) t_ack!3789))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3792))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3791)
                                   ((_ to_fp 11 53) y0_ack!3791))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3792) a!86)))))))))))))))))))))))))))))))
