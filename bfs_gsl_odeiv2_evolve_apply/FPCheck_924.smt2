...
(declare-fun y0_ack!4412 () (_ BitVec 64))
(declare-fun y1_ack!4413 () (_ BitVec 64))
(declare-fun h_ack!4414 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4413))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4412)
                                   ((_ to_fp 11 53) y0_ack!4412))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y1_ack!4413
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4414) a!103))))))))))))))))))))))))))))))))))
