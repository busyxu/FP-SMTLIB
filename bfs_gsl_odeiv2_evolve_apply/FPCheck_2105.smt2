(declare-fun t_ack!13183 () (_ BitVec 64))
(declare-fun t1_ack!13184 () (_ BitVec 64))
(declare-fun h_ack!13187 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!13185 () (_ BitVec 64))
(declare-fun y1_ack!13186 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!13184)
                    ((_ to_fp 11 53) t_ack!13183))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!13183))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!13187)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!13186))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!13185)
                                   ((_ to_fp 11 53) y0_ack!13185))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!13187)
                                    a!47)))))
  (FPCHECK_FADD_UNDERFLOW a!38 a!48))))))))))))))))))))))
