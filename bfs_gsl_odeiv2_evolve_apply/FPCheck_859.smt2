(declare-fun t_ack!4088 () (_ BitVec 64))
(declare-fun t1_ack!4089 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4091 () (_ BitVec 64))
(declare-fun h_ack!4092 () (_ BitVec 64))
(declare-fun y0_ack!4090 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4089)
                    ((_ to_fp 11 53) t_ack!4088))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4091))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4090)
                                   ((_ to_fp 11 53) y0_ack!4090))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fc13b7d81af1344
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4091) a!86)))))))))))))))))))))))))))))))
