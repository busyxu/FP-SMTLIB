(declare-fun t_ack!5993 () (_ BitVec 64))
(declare-fun t1_ack!5994 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5996 () (_ BitVec 64))
(declare-fun h_ack!5997 () (_ BitVec 64))
(declare-fun y0_ack!5995 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5994)
                    ((_ to_fp 11 53) t_ack!5993))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5996))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5995)
                                   ((_ to_fp 11 53) y0_ack!5995))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xbfe84ff364c4f34c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5996) a!56)))))))))))))))))))))))))
