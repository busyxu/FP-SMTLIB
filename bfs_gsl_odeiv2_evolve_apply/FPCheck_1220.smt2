(declare-fun t_ack!5854 () (_ BitVec 64))
(declare-fun t1_ack!5855 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y1_ack!5857 () (_ BitVec 64))
(declare-fun h_ack!5858 () (_ BitVec 64))
(declare-fun y0_ack!5856 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5855)
                    ((_ to_fp 11 53) t_ack!5854))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5857))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5856)
                                   ((_ to_fp 11 53) y0_ack!5856))
...
(let ((a!132 (fp.add roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.add roundNearestTiesToEven
                                     ((_ to_fp 11 53) y1_ack!5857)
                                     a!131)))))
(let ((a!133 (fp.mul roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ((_ to_fp 11 53) y0_ack!5856)
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!5858)
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!5858)
                                     a!132)))))
  (FPCHECK_FSUB_UNDERFLOW a!133 #x3ff0000000000000))))))))))))))))))))))))))))))))))))))
