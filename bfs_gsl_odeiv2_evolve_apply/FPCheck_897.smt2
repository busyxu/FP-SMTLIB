(declare-fun t_ack!4275 () (_ BitVec 64))
(declare-fun t1_ack!4276 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4278 () (_ BitVec 64))
(declare-fun h_ack!4279 () (_ BitVec 64))
(declare-fun y0_ack!4277 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4276)
                    ((_ to_fp 11 53) t_ack!4275))
...
(let ((a!51 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!50
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x40189f9250f88c23 a!51)))))))))))))))))))))))
