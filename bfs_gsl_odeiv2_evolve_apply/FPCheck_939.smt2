(declare-fun t_ack!4479 () (_ BitVec 64))
(declare-fun t1_ack!4480 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!4482 () (_ BitVec 64))
(declare-fun h_ack!4483 () (_ BitVec 64))
(declare-fun y0_ack!4481 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4480)
                    ((_ to_fp 11 53) t_ack!4479))
...
(let ((a!95 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4483)
                                    a!94)))))
  (FPCHECK_FSUB_OVERFLOW a!95 #x3ff0000000000000))))))))))))))))))))))))))))))))
