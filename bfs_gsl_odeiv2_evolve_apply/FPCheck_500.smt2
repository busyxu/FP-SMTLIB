(declare-fun t_ack!2356 () (_ BitVec 64))
(declare-fun t1_ack!2357 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2358 () (_ BitVec 64))
(declare-fun y1_ack!2359 () (_ BitVec 64))
(declare-fun h_ack!2360 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2357)
                    ((_ to_fp 11 53) t_ack!2356))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2359))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2358)
                                   ((_ to_fp 11 53) y0_ack!2358))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2359)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2360) a!43)))))))))))))))))))))))
