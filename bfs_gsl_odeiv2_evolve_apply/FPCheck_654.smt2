(declare-fun t_ack!3102 () (_ BitVec 64))
(declare-fun t1_ack!3103 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3104 () (_ BitVec 64))
(declare-fun y1_ack!3105 () (_ BitVec 64))
(declare-fun h_ack!3106 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3103)
                    ((_ to_fp 11 53) t_ack!3102))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3105))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3104)
                                   ((_ to_fp 11 53) y0_ack!3104))
