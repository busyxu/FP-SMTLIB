(declare-fun t_ack!11283 () (_ BitVec 64))
(declare-fun t1_ack!11284 () (_ BitVec 64))
(declare-fun h_ack!11287 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!11286 () (_ BitVec 64))
(declare-fun y0_ack!11285 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11284)
                    ((_ to_fp 11 53) t_ack!11283))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11283))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11287)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11286))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11285)
                                   ((_ to_fp 11 53) y0_ack!11285))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y0_ack!11285
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11287) a!38))))))))))))))))))))
