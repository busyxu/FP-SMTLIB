(declare-fun t_ack!6975 () (_ BitVec 64))
(declare-fun t1_ack!6976 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y0_ack!6977 () (_ BitVec 64))
(declare-fun y1_ack!6978 () (_ BitVec 64))
(declare-fun h_ack!6979 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6976)
                    ((_ to_fp 11 53) t_ack!6975))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6978))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6977)
                                   ((_ to_fp 11 53) y0_ack!6977))
...
(let ((a!155 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x0000000000000000)
                                     (fp.abs a!154))))))
  (FPCHECK_FADD_UNDERFLOW a!155 #x3eb0c6f7a0b5ed8d)))))))))))))))))))))))))))))))))))))))))
