(declare-fun t_ack!5998 () (_ BitVec 64))
(declare-fun t1_ack!5999 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6001 () (_ BitVec 64))
(declare-fun h_ack!6002 () (_ BitVec 64))
(declare-fun y0_ack!6000 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5999)
                    ((_ to_fp 11 53) t_ack!5998))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6001))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6000)
                                   ((_ to_fp 11 53) y0_ack!6000))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbfe84ff364c4f34c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6001) a!56)))))))))))))))))))))))))
