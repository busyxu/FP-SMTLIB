(declare-fun t_ack!4783 () (_ BitVec 64))
(declare-fun t1_ack!4784 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4785 () (_ BitVec 64))
(declare-fun y1_ack!4786 () (_ BitVec 64))
(declare-fun h_ack!4787 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4784)
                    ((_ to_fp 11 53) t_ack!4783))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4786))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4785)
                                   ((_ to_fp 11 53) y0_ack!4785))
...
(let ((a!112 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!4787)
                                     a!111)))))
  (FPCHECK_FADD_OVERFLOW a!94 a!112))))))))))))))))))))))))))))))))))
