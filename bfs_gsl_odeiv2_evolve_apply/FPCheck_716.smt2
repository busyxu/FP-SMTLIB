(declare-fun t_ack!3394 () (_ BitVec 64))
(declare-fun t1_ack!3395 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3396 () (_ BitVec 64))
(declare-fun y1_ack!3397 () (_ BitVec 64))
(declare-fun h_ack!3398 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3395)
                    ((_ to_fp 11 53) t_ack!3394))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3397))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3396)
                                   ((_ to_fp 11 53) y0_ack!3396))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3397)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3398) a!43)))))))))))))))))))))))
