...
(declare-fun t1_ack!1307 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!1308 () (_ BitVec 64))
(declare-fun y1_ack!1309 () (_ BitVec 64))
(declare-fun h_ack!1310 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1307)
                    ((_ to_fp 11 53) t_ack!1306))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1309))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1308)
                                   ((_ to_fp 11 53) y0_ack!1308))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!1309
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!1310) a!26))))))))))))))))
