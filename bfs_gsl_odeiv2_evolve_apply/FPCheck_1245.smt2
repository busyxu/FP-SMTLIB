(declare-fun t_ack!5973 () (_ BitVec 64))
(declare-fun t1_ack!5974 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5975 () (_ BitVec 64))
(declare-fun y1_ack!5976 () (_ BitVec 64))
(declare-fun h_ack!5977 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5974)
                    ((_ to_fp 11 53) t_ack!5973))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5976))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5975)
                                   ((_ to_fp 11 53) y0_ack!5975))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5976)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5977) a!43)))))))))))))))))))))))
