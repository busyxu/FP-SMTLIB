(declare-fun t_ack!11807 () (_ BitVec 64))
(declare-fun t1_ack!11808 () (_ BitVec 64))
(declare-fun h_ack!11811 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!11810 () (_ BitVec 64))
(declare-fun y0_ack!11809 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11808)
                    ((_ to_fp 11 53) t_ack!11807))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11807))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11811)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11810))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11809)
                                   ((_ to_fp 11 53) y0_ack!11809))
...
(let ((a!44 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    a!44
    (fp.sub roundNearestTiesToEven a!49 ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))
