(declare-fun t_ack!6058 () (_ BitVec 64))
(declare-fun t1_ack!6059 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6061 () (_ BitVec 64))
(declare-fun h_ack!6062 () (_ BitVec 64))
(declare-fun y0_ack!6060 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6059)
                    ((_ to_fp 11 53) t_ack!6058))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6061))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6060)
                                   ((_ to_fp 11 53) y0_ack!6060))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fc43f7cc8023f22
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6061) a!86)))))))))))))))))))))))))))))))
