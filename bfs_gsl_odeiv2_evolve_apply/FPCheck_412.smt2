(declare-fun t_ack!1937 () (_ BitVec 64))
(declare-fun t1_ack!1938 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!1940 () (_ BitVec 64))
(declare-fun h_ack!1941 () (_ BitVec 64))
(declare-fun y0_ack!1939 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1938)
                    ((_ to_fp 11 53) t_ack!1937))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y0_ack!1939
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!1941) a!38))))))))))))))))))))
