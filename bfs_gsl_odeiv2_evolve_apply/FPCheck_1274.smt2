(declare-fun t_ack!6118 () (_ BitVec 64))
(declare-fun t1_ack!6119 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6121 () (_ BitVec 64))
(declare-fun h_ack!6122 () (_ BitVec 64))
(declare-fun y0_ack!6120 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6119)
                    ((_ to_fp 11 53) t_ack!6118))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6121))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6120)
                                   ((_ to_fp 11 53) y0_ack!6120))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fd0000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6121) a!124)))))))))))))))))))))))))))))))))))))
