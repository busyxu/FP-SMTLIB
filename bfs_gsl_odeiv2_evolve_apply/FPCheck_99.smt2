...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!464)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!466) a!3)))))))
