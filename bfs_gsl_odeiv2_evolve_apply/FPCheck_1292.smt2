(declare-fun t_ack!6202 () (_ BitVec 64))
(declare-fun t1_ack!6203 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6205 () (_ BitVec 64))
(declare-fun h_ack!6206 () (_ BitVec 64))
(declare-fun y0_ack!6204 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6203)
                    ((_ to_fp 11 53) t_ack!6202))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6205) a!35))))))))))))))))))))
