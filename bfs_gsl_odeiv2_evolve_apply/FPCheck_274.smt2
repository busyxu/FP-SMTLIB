...
(declare-fun t1_ack!1287 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!1288 () (_ BitVec 64))
(declare-fun y1_ack!1289 () (_ BitVec 64))
(declare-fun h_ack!1290 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1287)
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!25))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!1290 a!26)))))))))))))))
