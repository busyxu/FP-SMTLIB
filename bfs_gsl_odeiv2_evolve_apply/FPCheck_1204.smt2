(declare-fun t_ack!5780 () (_ BitVec 64))
(declare-fun t1_ack!5781 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5782 () (_ BitVec 64))
(declare-fun y1_ack!5783 () (_ BitVec 64))
(declare-fun h_ack!5784 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5781)
                    ((_ to_fp 11 53) t_ack!5780))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5783))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5782)
                                   ((_ to_fp 11 53) y0_ack!5782))
...
(let ((a!144 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y1_ack!5783
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5784) a!144))))))))))))))))))))))))))))))))))))))))
