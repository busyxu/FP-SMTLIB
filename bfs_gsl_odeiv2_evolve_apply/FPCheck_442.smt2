(declare-fun t_ack!2084 () (_ BitVec 64))
(declare-fun t1_ack!2085 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2086 () (_ BitVec 64))
(declare-fun y1_ack!2087 () (_ BitVec 64))
(declare-fun h_ack!2088 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2085)
                    ((_ to_fp 11 53) t_ack!2084))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2087))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2086)
                                   ((_ to_fp 11 53) y0_ack!2086))
...
(let ((a!43 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33))
                    a!42)))
  (FPCHECK_FMUL_UNDERFLOW h_ack!2088 a!43)))))))))))))))))))))
