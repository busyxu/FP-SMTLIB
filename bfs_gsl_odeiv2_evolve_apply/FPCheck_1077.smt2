(declare-fun t_ack!5154 () (_ BitVec 64))
(declare-fun t1_ack!5155 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5156 () (_ BitVec 64))
(declare-fun y1_ack!5157 () (_ BitVec 64))
(declare-fun h_ack!5158 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5155)
                    ((_ to_fp 11 53) t_ack!5154))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5157))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5156)
                                   ((_ to_fp 11 53) y0_ack!5156))
