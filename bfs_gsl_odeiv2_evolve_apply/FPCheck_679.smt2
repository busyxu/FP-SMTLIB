...
(declare-fun t1_ack!3216 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y1_ack!3218 () (_ BitVec 64))
(declare-fun h_ack!3219 () (_ BitVec 64))
(declare-fun y0_ack!3217 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3216)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3218))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3217)
                                   ((_ to_fp 11 53) y0_ack!3217))
...
(let ((a!63 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!3219)
                                    a!62)))))
  (FPCHECK_FSUB_UNDERFLOW a!63 #x3ff0000000000000))))))))))))))))))))))))))
