...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xc02abe3f2cbe1d36
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3422) a!56)))))))))))))))))))))))))
