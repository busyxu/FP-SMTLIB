(declare-fun t_ack!3389 () (_ BitVec 64))
(declare-fun t1_ack!3390 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3391 () (_ BitVec 64))
(declare-fun y1_ack!3392 () (_ BitVec 64))
(declare-fun h_ack!3393 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3390)
                    ((_ to_fp 11 53) t_ack!3389))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3392))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3391)
                                   ((_ to_fp 11 53) y0_ack!3391))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3392)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3393) a!43)))))))))))))))))))))))
