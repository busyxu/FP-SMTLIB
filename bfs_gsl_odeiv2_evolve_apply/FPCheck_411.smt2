(declare-fun t_ack!1932 () (_ BitVec 64))
(declare-fun t1_ack!1933 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!1935 () (_ BitVec 64))
(declare-fun h_ack!1936 () (_ BitVec 64))
(declare-fun y0_ack!1934 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1933)
                    ((_ to_fp 11 53) t_ack!1932))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y0_ack!1934
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!1936) a!38))))))))))))))))))))
