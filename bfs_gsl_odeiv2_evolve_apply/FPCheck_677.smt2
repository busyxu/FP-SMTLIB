(declare-fun t_ack!3205 () (_ BitVec 64))
(declare-fun t1_ack!3206 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3208 () (_ BitVec 64))
(declare-fun h_ack!3209 () (_ BitVec 64))
(declare-fun y0_ack!3207 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3206)
                    ((_ to_fp 11 53) t_ack!3205))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3207)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3209) a!62))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3207)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3209) a!62)))))))))))))))))))))))))))
