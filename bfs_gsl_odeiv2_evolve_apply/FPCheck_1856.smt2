(declare-fun t_ack!10732 () (_ BitVec 64))
(declare-fun t1_ack!10733 () (_ BitVec 64))
(declare-fun h_ack!10736 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!10735 () (_ BitVec 64))
(declare-fun y0_ack!10734 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!10733)
                    ((_ to_fp 11 53) t_ack!10732))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!10732))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!10736)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!10735))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!10734)
                                   ((_ to_fp 11 53) y0_ack!10734))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33)))))
  (FPCHECK_FADD_UNDERFLOW y1_ack!10735 a!34))))))))))))))))))
