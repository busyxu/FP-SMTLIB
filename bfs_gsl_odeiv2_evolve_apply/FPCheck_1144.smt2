(declare-fun t_ack!5483 () (_ BitVec 64))
(declare-fun t1_ack!5484 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5486 () (_ BitVec 64))
(declare-fun h_ack!5487 () (_ BitVec 64))
(declare-fun y0_ack!5485 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5484)
                    ((_ to_fp 11 53) t_ack!5483))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5486))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5485)
                                   ((_ to_fp 11 53) y0_ack!5485))
...
(let ((a!132 (fp.add roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.add roundNearestTiesToEven
                                     ((_ to_fp 11 53) y1_ack!5486)
                                     a!131)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!5487 a!132)))))))))))))))))))))))))))))))))))))
