(declare-fun t_ack!2553 () (_ BitVec 64))
(declare-fun t1_ack!2554 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2556 () (_ BitVec 64))
(declare-fun h_ack!2557 () (_ BitVec 64))
(declare-fun y0_ack!2555 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2554)
                    ((_ to_fp 11 53) t_ack!2553))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2556))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2555)
                                   ((_ to_fp 11 53) y0_ack!2555))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!43
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fcb16e62e7158fc) a!55))))))))))))))))))))))))
