(declare-fun t_ack!1758 () (_ BitVec 64))
...
(declare-fun h_ack!1762 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1759)
                    ((_ to_fp 11 53) t_ack!1758))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x4024000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!1761) a!34))
    (fp.sub roundNearestTiesToEven
