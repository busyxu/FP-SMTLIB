(declare-fun t_ack!4803 () (_ BitVec 64))
...
(declare-fun h_ack!4807 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4804)
                    ((_ to_fp 11 53) t_ack!4803))
...
(let ((a!112 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!4807)
                                     a!111)))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!4807 (fp.add roundNearestTiesToEven a!94 a!112)))))))))))))))))))))))))))))))))))
