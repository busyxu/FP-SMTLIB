...
(declare-fun t1_ack!3123 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3124 () (_ BitVec 64))
(declare-fun y1_ack!3125 () (_ BitVec 64))
(declare-fun h_ack!3126 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3123)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3125))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3124)
                                   ((_ to_fp 11 53) y0_ack!3124))
...
(let ((a!69 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!55))
                    a!68)))
  (FPCHECK_FMUL_UNDERFLOW h_ack!3126 a!69)))))))))))))))))))))))))))
