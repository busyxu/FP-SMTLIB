(declare-fun t_ack!11739 () (_ BitVec 64))
(declare-fun t1_ack!11740 () (_ BitVec 64))
(declare-fun h_ack!11743 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!11742 () (_ BitVec 64))
(declare-fun y0_ack!11741 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11740)
                    ((_ to_fp 11 53) t_ack!11739))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11739))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11743)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11742))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11741)
                                   ((_ to_fp 11 53) y0_ack!11741))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11741)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11743) a!38))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11741)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11743) a!38)))))))))))))))))))))
