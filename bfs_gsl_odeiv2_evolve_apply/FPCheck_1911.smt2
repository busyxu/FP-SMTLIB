(declare-fun t_ack!11260 () (_ BitVec 64))
(declare-fun t1_ack!11261 () (_ BitVec 64))
(declare-fun h_ack!11264 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11263 () (_ BitVec 64))
(declare-fun y0_ack!11262 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11261)
                    ((_ to_fp 11 53) t_ack!11260))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11260))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11264)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11263))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11262)
                                   ((_ to_fp 11 53) y0_ack!11262))
...
(let ((a!38 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!11263)
                                    a!37)))))
  (FPCHECK_FMUL_ACCURACY h_ack!11264 a!38)))))))))))))))))))
