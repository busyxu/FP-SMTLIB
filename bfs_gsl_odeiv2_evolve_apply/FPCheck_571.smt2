(declare-fun t_ack!2696 () (_ BitVec 64))
(declare-fun t1_ack!2697 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2698 () (_ BitVec 64))
(declare-fun y1_ack!2699 () (_ BitVec 64))
(declare-fun h_ack!2700 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2697)
                    ((_ to_fp 11 53) t_ack!2696))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2699))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2698)
                                   ((_ to_fp 11 53) y0_ack!2698))
