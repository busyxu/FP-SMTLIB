...
(declare-fun t1_ack!5820 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5821 () (_ BitVec 64))
(declare-fun y1_ack!5822 () (_ BitVec 64))
(declare-fun h_ack!5823 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5820)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5822))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5821)
                                   ((_ to_fp 11 53) y0_ack!5821))
...
(let ((a!144 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5822)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5823) a!144)))))))))))))))))))))))))))))))))))))))))
