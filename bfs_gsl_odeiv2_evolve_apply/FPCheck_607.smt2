(declare-fun t_ack!2870 () (_ BitVec 64))
(declare-fun t1_ack!2871 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2873 () (_ BitVec 64))
(declare-fun h_ack!2874 () (_ BitVec 64))
(declare-fun y0_ack!2872 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2871)
                    ((_ to_fp 11 53) t_ack!2870))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fbfadbee9f5b0f4
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2873) a!56)))))))))))))))))))))))))
