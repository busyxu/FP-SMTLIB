...
(declare-fun t1_ack!3562 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3563 () (_ BitVec 64))
(declare-fun y1_ack!3564 () (_ BitVec 64))
(declare-fun h_ack!3565 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3562)
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!18))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fed4dc1ce9424ac) a!25)))))))))))))))
