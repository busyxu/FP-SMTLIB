(declare-fun t_ack!5705 () (_ BitVec 64))
(declare-fun t1_ack!5706 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5708 () (_ BitVec 64))
(declare-fun h_ack!5709 () (_ BitVec 64))
(declare-fun y0_ack!5707 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5706)
                    ((_ to_fp 11 53) t_ack!5705))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5708))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5707)
                                   ((_ to_fp 11 53) y0_ack!5707))
...
(let ((a!115 (fp.sub roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     a!114
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #xbfce7a5f94e7938d a!115)))))))))))))))))))))))))))))))))))
