(declare-fun t_ack!4058 () (_ BitVec 64))
(declare-fun t1_ack!4059 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4060 () (_ BitVec 64))
(declare-fun y1_ack!4061 () (_ BitVec 64))
(declare-fun h_ack!4062 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4059)
                    ((_ to_fp 11 53) t_ack!4058))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4061))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4060)
                                   ((_ to_fp 11 53) y0_ack!4060))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4061)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4062) a!69)))))))))))))))))))))))))))))
