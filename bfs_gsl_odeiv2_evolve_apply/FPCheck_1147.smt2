(declare-fun t_ack!5498 () (_ BitVec 64))
(declare-fun t1_ack!5499 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5501 () (_ BitVec 64))
(declare-fun h_ack!5502 () (_ BitVec 64))
(declare-fun y0_ack!5500 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5499)
                    ((_ to_fp 11 53) t_ack!5498))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5501))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5500)
                                   ((_ to_fp 11 53) y0_ack!5500))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y0_ack!5500
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5502) a!132))))))))))))))))))))))))))))))))))))))
