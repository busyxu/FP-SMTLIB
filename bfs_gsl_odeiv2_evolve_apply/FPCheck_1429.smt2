(declare-fun t_ack!6881 () (_ BitVec 64))
(declare-fun t1_ack!6882 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6883 () (_ BitVec 64))
(declare-fun y1_ack!6884 () (_ BitVec 64))
(declare-fun h_ack!6885 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6882)
                    ((_ to_fp 11 53) t_ack!6881))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6884))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6883)
                                   ((_ to_fp 11 53) y0_ack!6883))
...
(let ((a!152 (fp.sub roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!122))
                     a!151)))
  (FPCHECK_FMUL_OVERFLOW h_ack!6885 a!152))))))))))))))))))))))))))))))))))))))))
