(declare-fun t_ack!4123 () (_ BitVec 64))
(declare-fun t1_ack!4124 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4126 () (_ BitVec 64))
(declare-fun h_ack!4127 () (_ BitVec 64))
(declare-fun y0_ack!4125 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4124)
                    ((_ to_fp 11 53) t_ack!4123))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4126))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4125)
                                   ((_ to_fp 11 53) y0_ack!4125))
...
(let ((a!94 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!4126)
                                    a!93)))))
  (FPCHECK_FMUL_ACCURACY h_ack!4127 a!94)))))))))))))))))))))))))))))))
