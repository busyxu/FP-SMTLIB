(declare-fun t_ack!11273 () (_ BitVec 64))
(declare-fun t1_ack!11274 () (_ BitVec 64))
(declare-fun h_ack!11277 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11276 () (_ BitVec 64))
(declare-fun y0_ack!11275 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11274)
                    ((_ to_fp 11 53) t_ack!11273))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11273))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11277)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11276))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11275)
                                   ((_ to_fp 11 53) y0_ack!11275))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y0_ack!11275
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11277) a!38))))))))))))))))))))
