(declare-fun t_ack!6282 () (_ BitVec 64))
(declare-fun t1_ack!6283 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6284 () (_ BitVec 64))
(declare-fun y1_ack!6285 () (_ BitVec 64))
(declare-fun h_ack!6286 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6283)
                    ((_ to_fp 11 53) t_ack!6282))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6285))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6284)
                                   ((_ to_fp 11 53) y0_ack!6284))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6285)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6286) a!69)))))))))))))))))))))))))))))
