(declare-fun t_ack!2296 () (_ BitVec 64))
(declare-fun t1_ack!2297 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2298 () (_ BitVec 64))
(declare-fun y1_ack!2299 () (_ BitVec 64))
(declare-fun h_ack!2300 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2297)
                    ((_ to_fp 11 53) t_ack!2296))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2299))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2298)
                                   ((_ to_fp 11 53) y0_ack!2298))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2299)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2300) a!26)))))))))))))))))
