(declare-fun t_ack!4474 () (_ BitVec 64))
(declare-fun t1_ack!4475 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4477 () (_ BitVec 64))
(declare-fun h_ack!4478 () (_ BitVec 64))
(declare-fun y0_ack!4476 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4475)
                    ((_ to_fp 11 53) t_ack!4474))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4477))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4476)
                                   ((_ to_fp 11 53) y0_ack!4476))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4476)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4478) a!94))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4476)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4478) a!94)))))))))))))))))))))))))))))))))
