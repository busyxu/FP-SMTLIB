...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(declare-fun y0_ack!4555 () (_ BitVec 64))
(declare-fun y1_ack!4556 () (_ BitVec 64))
(declare-fun h_ack!4557 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4556))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4555)
                                   ((_ to_fp 11 53) y0_ack!4555))
...
(let ((a!13 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4556) a!13)))))))))))
