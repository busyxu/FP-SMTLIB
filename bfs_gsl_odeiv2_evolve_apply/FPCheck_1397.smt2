(declare-fun t_ack!6721 () (_ BitVec 64))
(declare-fun t1_ack!6722 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6724 () (_ BitVec 64))
(declare-fun h_ack!6725 () (_ BitVec 64))
(declare-fun y0_ack!6723 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6722)
                    ((_ to_fp 11 53) t_ack!6721))
...
(let ((a!51 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!50
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x4003bd1f79ac8e22 a!51)))))))))))))))))))))))
