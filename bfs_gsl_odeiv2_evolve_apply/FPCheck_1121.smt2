(declare-fun t_ack!5368 () (_ BitVec 64))
(declare-fun t1_ack!5369 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5370 () (_ BitVec 64))
(declare-fun y1_ack!5371 () (_ BitVec 64))
(declare-fun h_ack!5372 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5369)
                    ((_ to_fp 11 53) t_ack!5368))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5371))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5370)
                                   ((_ to_fp 11 53) y0_ack!5370))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5371)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5372) a!69)))))))))))))))))))))))))))))
