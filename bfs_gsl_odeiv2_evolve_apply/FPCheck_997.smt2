(declare-fun t_ack!4763 () (_ BitVec 64))
(declare-fun t1_ack!4764 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4766 () (_ BitVec 64))
(declare-fun h_ack!4767 () (_ BitVec 64))
(declare-fun y0_ack!4765 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4764)
                    ((_ to_fp 11 53) t_ack!4763))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4766))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4765)
                                   ((_ to_fp 11 53) y0_ack!4765))
...
(let ((a!93 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4766) a!93))))))))))))))))))))))))))))))))
