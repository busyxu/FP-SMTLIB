(declare-fun t_ack!2137 () (_ BitVec 64))
(declare-fun t1_ack!2138 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2140 () (_ BitVec 64))
(declare-fun h_ack!2141 () (_ BitVec 64))
(declare-fun y0_ack!2139 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2138)
                    ((_ to_fp 11 53) t_ack!2137))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!2139)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2141) a!38)))))))))))))))))))))
