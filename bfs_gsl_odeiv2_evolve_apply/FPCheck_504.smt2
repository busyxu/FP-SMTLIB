(declare-fun t_ack!2376 () (_ BitVec 64))
(declare-fun t1_ack!2377 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2378 () (_ BitVec 64))
(declare-fun y1_ack!2379 () (_ BitVec 64))
(declare-fun h_ack!2380 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2377)
                    ((_ to_fp 11 53) t_ack!2376))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2379))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2378)
                                   ((_ to_fp 11 53) y0_ack!2378))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!2380)
                                    a!47)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!2380 (fp.add roundNearestTiesToEven a!38 a!48)))))))))))))))))))))))
