...
(declare-fun t1_ack!6089 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6090 () (_ BitVec 64))
(declare-fun y1_ack!6091 () (_ BitVec 64))
(declare-fun h_ack!6092 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6089)
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6091)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6092) a!103)))))))))))))))))))))))))))))))))))
