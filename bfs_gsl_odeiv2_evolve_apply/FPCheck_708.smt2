(declare-fun t_ack!3354 () (_ BitVec 64))
(declare-fun t1_ack!3355 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3357 () (_ BitVec 64))
(declare-fun h_ack!3358 () (_ BitVec 64))
(declare-fun y0_ack!3356 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3355)
                    ((_ to_fp 11 53) t_ack!3354))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3357))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3356)
                                   ((_ to_fp 11 53) y0_ack!3356))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xc03000ea32f607ac
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3357) a!34)))))))))))))))))))
