(declare-fun t_ack!1922 () (_ BitVec 64))
(declare-fun t1_ack!1923 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!1925 () (_ BitVec 64))
(declare-fun h_ack!1926 () (_ BitVec 64))
(declare-fun y0_ack!1924 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1923)
                    ((_ to_fp 11 53) t_ack!1922))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1925))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1924)
                                   ((_ to_fp 11 53) y0_ack!1924))
...
(let ((a!38 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!1925)
                                    a!37)))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!1926 a!38)))))))))))))))))))
