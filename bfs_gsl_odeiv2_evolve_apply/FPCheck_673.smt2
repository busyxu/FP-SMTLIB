(declare-fun t_ack!3185 () (_ BitVec 64))
(declare-fun t1_ack!3186 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3187 () (_ BitVec 64))
(declare-fun y1_ack!3188 () (_ BitVec 64))
(declare-fun h_ack!3189 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3186)
                    ((_ to_fp 11 53) t_ack!3185))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3188)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3189) a!69)))))))))))))))))))))))))))))
