(declare-fun t_ack!4459 () (_ BitVec 64))
(declare-fun t1_ack!4460 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4461 () (_ BitVec 64))
(declare-fun y1_ack!4462 () (_ BitVec 64))
(declare-fun h_ack!4463 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4460)
                    ((_ to_fp 11 53) t_ack!4459))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4462))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4461)
                                   ((_ to_fp 11 53) y0_ack!4461))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4462)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4463) a!103)))))))))))))))))))))))))))))))))))
