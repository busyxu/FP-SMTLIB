(declare-fun t_ack!4038 () (_ BitVec 64))
(declare-fun t1_ack!4039 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4041 () (_ BitVec 64))
(declare-fun h_ack!4042 () (_ BitVec 64))
(declare-fun y0_ack!4040 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4039)
                    ((_ to_fp 11 53) t_ack!4038))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4041))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4040)
                                   ((_ to_fp 11 53) y0_ack!4040))
...
(let ((a!61 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4041) a!61))))))))))))))))))))))))))
