(declare-fun t_ack!6836 () (_ BitVec 64))
(declare-fun t1_ack!6837 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6839 () (_ BitVec 64))
(declare-fun h_ack!6840 () (_ BitVec 64))
(declare-fun y0_ack!6838 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6837)
                    ((_ to_fp 11 53) t_ack!6836))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6839))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6838)
                                   ((_ to_fp 11 53) y0_ack!6838))
...
(let ((a!115 (fp.sub roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     a!114
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x3fa6c16c16c16c17 a!115)))))))))))))))))))))))))))))))))))
