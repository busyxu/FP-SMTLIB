(declare-fun t_ack!1892 () (_ BitVec 64))
(declare-fun t1_ack!1893 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!1895 () (_ BitVec 64))
(declare-fun h_ack!1896 () (_ BitVec 64))
(declare-fun y0_ack!1894 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1893)
                    ((_ to_fp 11 53) t_ack!1892))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbfc61b7ccdaf2f38
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!1895) a!34)))))))))))))))))))
