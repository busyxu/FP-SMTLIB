(declare-fun t_ack!6604 () (_ BitVec 64))
(declare-fun t1_ack!6605 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6607 () (_ BitVec 64))
(declare-fun h_ack!6608 () (_ BitVec 64))
(declare-fun y0_ack!6606 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6605)
                    ((_ to_fp 11 53) t_ack!6604))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6607))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6606)
                                   ((_ to_fp 11 53) y0_ack!6606))
...
(let ((a!122 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!102
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfce7a5f94e7938d) a!122))))))))))))))))))))))))))))))))))))
