(declare-fun t_ack!4138 () (_ BitVec 64))
(declare-fun t1_ack!4139 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4141 () (_ BitVec 64))
(declare-fun h_ack!4142 () (_ BitVec 64))
(declare-fun y0_ack!4140 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4139)
                    ((_ to_fp 11 53) t_ack!4138))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y0_ack!4140
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4142) a!94))))))))))))))))))))))))))))))))
