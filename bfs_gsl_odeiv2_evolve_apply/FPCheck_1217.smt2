(declare-fun t_ack!5839 () (_ BitVec 64))
(declare-fun t1_ack!5840 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5842 () (_ BitVec 64))
(declare-fun h_ack!5843 () (_ BitVec 64))
(declare-fun y0_ack!5841 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5840)
                    ((_ to_fp 11 53) t_ack!5839))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5842))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5841)
                                   ((_ to_fp 11 53) y0_ack!5841))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5841)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5843) a!132))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5841)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5843) a!132)))))))))))))))))))))))))))))))))))))))
