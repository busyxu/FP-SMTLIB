(declare-fun t_ack!3032 () (_ BitVec 64))
(declare-fun t1_ack!3033 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3034 () (_ BitVec 64))
(declare-fun y1_ack!3035 () (_ BitVec 64))
(declare-fun h_ack!3036 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3033)
                    ((_ to_fp 11 53) t_ack!3032))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3035))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3034)
                                   ((_ to_fp 11 53) y0_ack!3034))
