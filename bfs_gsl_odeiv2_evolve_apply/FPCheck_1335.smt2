(declare-fun t_ack!6414 () (_ BitVec 64))
(declare-fun t1_ack!6415 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6417 () (_ BitVec 64))
(declare-fun h_ack!6418 () (_ BitVec 64))
(declare-fun y0_ack!6416 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6415)
                    ((_ to_fp 11 53) t_ack!6414))
...
(let ((a!31 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY #xbfac643f63bea075 a!31)))))))))))))))))
