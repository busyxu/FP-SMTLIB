(declare-fun t_ack!6781 () (_ BitVec 64))
(declare-fun t1_ack!6782 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6784 () (_ BitVec 64))
(declare-fun h_ack!6785 () (_ BitVec 64))
(declare-fun y0_ack!6783 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6782)
                    ((_ to_fp 11 53) t_ack!6781))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6784))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6783)
                                   ((_ to_fp 11 53) y0_ack!6783))
      ...
      (a!74 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!61))
                    (fp.sub roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven a!73 a!73)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
...
(let ((a!77 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!6785)
                                    a!76)))))
(let ((a!79 (fp.sub roundNearestTiesToEven
                    a!63
                    (fp.mul roundNearestTiesToEven
                            a!77
                            (fp.sub roundNearestTiesToEven
                                    a!78
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3ff718c66651430c a!79)))))))))))))))))))))))))))))
