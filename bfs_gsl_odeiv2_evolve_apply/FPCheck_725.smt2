...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(declare-fun y1_ack!3442 () (_ BitVec 64))
(declare-fun h_ack!3443 () (_ BitVec 64))
(declare-fun y0_ack!3441 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3442))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3441)
                                   ((_ to_fp 11 53) y0_ack!3441))
...
(let ((a!61 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3442) a!61))))))))))))))))))))))))))
