(declare-fun t_ack!6192 () (_ BitVec 64))
(declare-fun t1_ack!6193 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6195 () (_ BitVec 64))
(declare-fun h_ack!6196 () (_ BitVec 64))
(declare-fun y0_ack!6194 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6193)
                    ((_ to_fp 11 53) t_ack!6192))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6195))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6194)
                                   ((_ to_fp 11 53) y0_ack!6194))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fd3eb5ef3b96b09
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6195) a!34)))))))))))))))))))
