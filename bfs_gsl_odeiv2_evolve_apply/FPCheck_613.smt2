...
(declare-fun t1_ack!2901 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2903 () (_ BitVec 64))
(declare-fun h_ack!2904 () (_ BitVec 64))
(declare-fun y0_ack!2902 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2901)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2903))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2902)
                                   ((_ to_fp 11 53) y0_ack!2902))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!2903)
                                    a!61)))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!2904 a!62)))))))))))))))))))))))))
