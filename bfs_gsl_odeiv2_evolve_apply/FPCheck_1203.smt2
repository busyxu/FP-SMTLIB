...
(declare-fun t1_ack!5776 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5777 () (_ BitVec 64))
(declare-fun y1_ack!5778 () (_ BitVec 64))
(declare-fun h_ack!5779 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5776)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5778))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5777)
                                   ((_ to_fp 11 53) y0_ack!5777))
...
(let ((a!144 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!122))
                     a!143)))
  (FPCHECK_FMUL_ACCURACY h_ack!5779 a!144)))))))))))))))))))))))))))))))))))))))
