(declare-fun t_ack!2780 () (_ BitVec 64))
...
(declare-fun h_ack!2784 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2781)
                    ((_ to_fp 11 53) t_ack!2780))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2783)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2784) a!26)))))))))))))))))
