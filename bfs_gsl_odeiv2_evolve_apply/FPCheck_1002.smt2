...
(declare-fun t1_ack!4789 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4790 () (_ BitVec 64))
(declare-fun y1_ack!4791 () (_ BitVec 64))
(declare-fun h_ack!4792 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4789)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4791))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4790)
                                   ((_ to_fp 11 53) y0_ack!4790))
...
(let ((a!112 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!4792)
                                     a!111)))))
  (FPCHECK_FADD_UNDERFLOW a!94 a!112))))))))))))))))))))))))))))))))))
