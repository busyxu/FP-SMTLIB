(declare-fun t_ack!6876 () (_ BitVec 64))
(declare-fun t1_ack!6877 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6878 () (_ BitVec 64))
(declare-fun y1_ack!6879 () (_ BitVec 64))
(declare-fun h_ack!6880 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6877)
                    ((_ to_fp 11 53) t_ack!6876))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6879))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6878)
                                   ((_ to_fp 11 53) y0_ack!6878))
