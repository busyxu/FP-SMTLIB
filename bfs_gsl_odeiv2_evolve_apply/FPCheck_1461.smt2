(declare-fun t_ack!7035 () (_ BitVec 64))
(declare-fun t1_ack!7036 () (_ BitVec 64))
(declare-fun y0_ack!7037 () (_ BitVec 64))
(declare-fun y1_ack!7038 () (_ BitVec 64))
(declare-fun h_ack!7039 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7036)
                    ((_ to_fp 11 53) t_ack!7035))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7038))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7037)
                                   ((_ to_fp 11 53) y0_ack!7037))
...
(let ((a!154 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!7039)
                                     a!153)))))
(let ((a!156 (fp.sub roundNearestTiesToEven
                     a!133
                     (fp.mul roundNearestTiesToEven
                             a!154
                             (fp.sub roundNearestTiesToEven
                                     a!155
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY h_ack!7039 a!156)))))))))))))))))))))))))))))))))))))))))
