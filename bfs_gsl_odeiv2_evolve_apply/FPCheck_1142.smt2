(declare-fun t_ack!5473 () (_ BitVec 64))
(declare-fun t1_ack!5474 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5476 () (_ BitVec 64))
(declare-fun h_ack!5477 () (_ BitVec 64))
(declare-fun y0_ack!5475 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5474)
                    ((_ to_fp 11 53) t_ack!5473))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5476))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5475)
                                   ((_ to_fp 11 53) y0_ack!5475))
...
(let ((a!131 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5476) a!131))))))))))))))))))))))))))))))))))))))
