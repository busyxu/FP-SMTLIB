(declare-fun t_ack!3736 () (_ BitVec 64))
(declare-fun t1_ack!3737 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3739 () (_ BitVec 64))
(declare-fun h_ack!3740 () (_ BitVec 64))
(declare-fun y0_ack!3738 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3737)
                    ((_ to_fp 11 53) t_ack!3736))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3739))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3738)
                                   ((_ to_fp 11 53) y0_ack!3738))
