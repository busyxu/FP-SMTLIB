(declare-fun t_ack!6252 () (_ BitVec 64))
(declare-fun t1_ack!6253 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6255 () (_ BitVec 64))
(declare-fun h_ack!6256 () (_ BitVec 64))
(declare-fun y0_ack!6254 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6253)
                    ((_ to_fp 11 53) t_ack!6252))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6255))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6254)
                                   ((_ to_fp 11 53) y0_ack!6254))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xc0046022f1dbd988
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6255) a!56)))))))))))))))))))))))))
