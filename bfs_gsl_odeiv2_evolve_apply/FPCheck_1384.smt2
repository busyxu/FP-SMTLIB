(declare-fun t_ack!6656 () (_ BitVec 64))
(declare-fun t1_ack!6657 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6659 () (_ BitVec 64))
(declare-fun h_ack!6660 () (_ BitVec 64))
(declare-fun y0_ack!6658 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6657)
                    ((_ to_fp 11 53) t_ack!6656))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6659))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6658)
                                   ((_ to_fp 11 53) y0_ack!6658))
...
(let ((a!31 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #xbfea83f14f58d042 a!31)))))))))))))))))
