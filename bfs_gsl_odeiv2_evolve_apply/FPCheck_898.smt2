...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(declare-fun y1_ack!4283 () (_ BitVec 64))
(declare-fun h_ack!4284 () (_ BitVec 64))
(declare-fun y0_ack!4282 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4283))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4282)
                                   ((_ to_fp 11 53) y0_ack!4282))
...
(let ((a!51 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!50
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x40189f9250f88c23 a!51)))))))))))))))))))))))
