(declare-fun t_ack!3474 () (_ BitVec 64))
(declare-fun t1_ack!3475 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3476 () (_ BitVec 64))
(declare-fun y1_ack!3477 () (_ BitVec 64))
(declare-fun h_ack!3478 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3475)
                    ((_ to_fp 11 53) t_ack!3474))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3477))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3476)
                                   ((_ to_fp 11 53) y0_ack!3476))
...
(let ((a!76 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!3478)
                                    a!75)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!3478 (fp.add roundNearestTiesToEven a!62 a!76)))))))))))))))))))))))))))))
