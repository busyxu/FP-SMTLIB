(declare-fun t_ack!3220 () (_ BitVec 64))
(declare-fun t1_ack!3221 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!3223 () (_ BitVec 64))
(declare-fun h_ack!3224 () (_ BitVec 64))
(declare-fun y0_ack!3222 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3221)
                    ((_ to_fp 11 53) t_ack!3220))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3223))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3222)
                                   ((_ to_fp 11 53) y0_ack!3222))
...
(let ((a!63 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!3224)
                                    a!62)))))
  (FPCHECK_FSUB_ACCURACY a!63 #x3ff0000000000000))))))))))))))))))))))))))
