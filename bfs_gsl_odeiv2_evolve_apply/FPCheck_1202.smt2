(declare-fun t_ack!5770 () (_ BitVec 64))
(declare-fun t1_ack!5771 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5772 () (_ BitVec 64))
(declare-fun y1_ack!5773 () (_ BitVec 64))
(declare-fun h_ack!5774 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5771)
                    ((_ to_fp 11 53) t_ack!5770))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5773))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5772)
                                   ((_ to_fp 11 53) y0_ack!5772))
...
(let ((a!144 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!122))
                     a!143)))
  (FPCHECK_FMUL_UNDERFLOW h_ack!5774 a!144)))))))))))))))))))))))))))))))))))))))
