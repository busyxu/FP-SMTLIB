(declare-fun t_ack!5963 () (_ BitVec 64))
(declare-fun t1_ack!5964 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5965 () (_ BitVec 64))
(declare-fun y1_ack!5966 () (_ BitVec 64))
(declare-fun h_ack!5967 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5964)
                    ((_ to_fp 11 53) t_ack!5963))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5966))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5965)
                                   ((_ to_fp 11 53) y0_ack!5965))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5966)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5967) a!43)))))))))))))))))))))))
