(declare-fun t_ack!6930 () (_ BitVec 64))
(declare-fun t1_ack!6931 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6932 () (_ BitVec 64))
(declare-fun y1_ack!6933 () (_ BitVec 64))
(declare-fun h_ack!6934 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6931)
                    ((_ to_fp 11 53) t_ack!6930))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6933))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6932)
                                   ((_ to_fp 11 53) y0_ack!6932))
...
(let ((a!144 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6933)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6934) a!144)))))))))))))))))))))))))))))))))))))))))
