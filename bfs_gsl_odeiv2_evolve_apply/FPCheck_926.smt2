...
(declare-fun t1_ack!4421 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4422 () (_ BitVec 64))
(declare-fun y1_ack!4423 () (_ BitVec 64))
(declare-fun h_ack!4424 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4421)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4423))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4422)
                                   ((_ to_fp 11 53) y0_ack!4422))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!4423
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4424) a!103))))))))))))))))))))))))))))))))))
