...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!2107
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2108) a!43))))))))))))))))))))))
