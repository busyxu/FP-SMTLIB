(declare-fun t_ack!11688 () (_ BitVec 64))
(declare-fun t1_ack!11689 () (_ BitVec 64))
(declare-fun h_ack!11692 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!11691 () (_ BitVec 64))
(declare-fun y0_ack!11690 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11689)
                    ((_ to_fp 11 53) t_ack!11688))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11688))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11692)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11691))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11690)
                                   ((_ to_fp 11 53) y0_ack!11690))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11690)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11692) a!38)))))))))))))))))))))
