(declare-fun t_ack!5179 () (_ BitVec 64))
(declare-fun t1_ack!5180 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5181 () (_ BitVec 64))
(declare-fun y1_ack!5182 () (_ BitVec 64))
(declare-fun h_ack!5183 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5180)
                    ((_ to_fp 11 53) t_ack!5179))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5182))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5181)
                                   ((_ to_fp 11 53) y0_ack!5181))
...
(let ((a!113 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW a!113 a!113)))))))))))))))))))))))))))))))))))
