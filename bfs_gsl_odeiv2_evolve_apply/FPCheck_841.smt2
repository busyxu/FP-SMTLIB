(declare-fun t_ack!3998 () (_ BitVec 64))
(declare-fun t1_ack!3999 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4000 () (_ BitVec 64))
(declare-fun y1_ack!4001 () (_ BitVec 64))
(declare-fun h_ack!4002 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3999)
                    ((_ to_fp 11 53) t_ack!3998))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4001))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4000)
                                   ((_ to_fp 11 53) y0_ack!4000))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4001)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4002) a!43)))))))))))))))))))))))
