(declare-fun t_ack!6806 () (_ BitVec 64))
(declare-fun t1_ack!6807 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6808 () (_ BitVec 64))
(declare-fun y1_ack!6809 () (_ BitVec 64))
(declare-fun h_ack!6810 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6807)
                    ((_ to_fp 11 53) t_ack!6806))
