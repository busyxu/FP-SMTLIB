(declare-fun t_ack!4315 () (_ BitVec 64))
(declare-fun t1_ack!4316 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4317 () (_ BitVec 64))
(declare-fun y1_ack!4318 () (_ BitVec 64))
(declare-fun h_ack!4319 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4316)
                    ((_ to_fp 11 53) t_ack!4315))
