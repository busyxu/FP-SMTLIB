(declare-fun t_ack!9975 () (_ BitVec 64))
(declare-fun t1_ack!9976 () (_ BitVec 64))
(declare-fun h_ack!9979 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!9977 () (_ BitVec 64))
(declare-fun y1_ack!9978 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!9976)
                    ((_ to_fp 11 53) t_ack!9975))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!9975))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!9979)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!9978))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!9977)
                                   ((_ to_fp 11 53) y0_ack!9977))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!9978
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!9979) a!26))))))))))))))))
