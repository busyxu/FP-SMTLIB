(declare-fun t_ack!7025 () (_ BitVec 64))
(declare-fun t1_ack!7026 () (_ BitVec 64))
(declare-fun y0_ack!7027 () (_ BitVec 64))
(declare-fun y1_ack!7028 () (_ BitVec 64))
(declare-fun h_ack!7029 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7026)
                    ((_ to_fp 11 53) t_ack!7025))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7028))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7027)
                                   ((_ to_fp 11 53) y0_ack!7027))
...
(let ((a!156 (fp.sub roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     a!155
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW h_ack!7029 a!156)))))))))))))))))))))))))))))))))))))))))
