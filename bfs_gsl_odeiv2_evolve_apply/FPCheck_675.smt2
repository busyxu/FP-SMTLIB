(declare-fun t_ack!3195 () (_ BitVec 64))
(declare-fun t1_ack!3196 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3198 () (_ BitVec 64))
(declare-fun h_ack!3199 () (_ BitVec 64))
(declare-fun y0_ack!3197 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3196)
                    ((_ to_fp 11 53) t_ack!3195))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3198))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3197)
                                   ((_ to_fp 11 53) y0_ack!3197))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3197)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3199) a!62))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3197)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3199) a!62)))))))))))))))))))))))))))
