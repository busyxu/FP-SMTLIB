(declare-fun t_ack!11792 () (_ BitVec 64))
(declare-fun t1_ack!11793 () (_ BitVec 64))
(declare-fun h_ack!11796 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!11795 () (_ BitVec 64))
(declare-fun y0_ack!11794 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11793)
                    ((_ to_fp 11 53) t_ack!11792))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11792))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11796)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11795))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11794)
                                   ((_ to_fp 11 53) y0_ack!11794))
...
(let ((a!39 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!11796)
                                    a!38)))))
  (FPCHECK_FSUB_ACCURACY a!39 #x3ff0000000000000))))))))))))))))))))
