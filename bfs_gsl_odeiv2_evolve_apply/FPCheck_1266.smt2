(declare-fun t_ack!6078 () (_ BitVec 64))
(declare-fun t1_ack!6079 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6081 () (_ BitVec 64))
(declare-fun h_ack!6082 () (_ BitVec 64))
(declare-fun y0_ack!6080 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6079)
                    ((_ to_fp 11 53) t_ack!6078))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6081))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6080)
                                   ((_ to_fp 11 53) y0_ack!6080))
...
(let ((a!91 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6081) a!91))))))))))))))))))))))))))))))))
