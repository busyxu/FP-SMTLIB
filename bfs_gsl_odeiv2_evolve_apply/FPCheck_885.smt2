(declare-fun t_ack!4215 () (_ BitVec 64))
(declare-fun t1_ack!4216 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4218 () (_ BitVec 64))
(declare-fun h_ack!4219 () (_ BitVec 64))
(declare-fun y0_ack!4217 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4216)
                    ((_ to_fp 11 53) t_ack!4215))
...
(let ((a!31 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #xc00865578467943f a!31)))))))))))))))))
