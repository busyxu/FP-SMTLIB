(declare-fun t_ack!6910 () (_ BitVec 64))
(declare-fun t1_ack!6911 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6913 () (_ BitVec 64))
(declare-fun h_ack!6914 () (_ BitVec 64))
(declare-fun y0_ack!6912 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6911)
                    ((_ to_fp 11 53) t_ack!6910))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6913))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6912)
                                   ((_ to_fp 11 53) y0_ack!6912))
...
(let ((a!133 (fp.abs (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!6914)
                                     a!132)))))
  (FPCHECK_FMUL_UNDERFLOW #x3ff0000000000000 a!133))))))))))))))))))))))))))))))))))))))
