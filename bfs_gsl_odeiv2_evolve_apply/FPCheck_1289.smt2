(declare-fun t_ack!6187 () (_ BitVec 64))
(declare-fun t1_ack!6188 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6190 () (_ BitVec 64))
(declare-fun h_ack!6191 () (_ BitVec 64))
(declare-fun y0_ack!6189 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6188)
                    ((_ to_fp 11 53) t_ack!6187))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6190))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6189)
                                   ((_ to_fp 11 53) y0_ack!6189))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fd3eb5ef3b96b09
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6190) a!34)))))))))))))))))))
