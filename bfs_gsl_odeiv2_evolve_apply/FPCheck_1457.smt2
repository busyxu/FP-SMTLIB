(declare-fun t_ack!7015 () (_ BitVec 64))
(declare-fun t1_ack!7016 () (_ BitVec 64))
(declare-fun y0_ack!7017 () (_ BitVec 64))
(declare-fun y1_ack!7018 () (_ BitVec 64))
(declare-fun h_ack!7019 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7016)
                    ((_ to_fp 11 53) t_ack!7015))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7018))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7017)
                                   ((_ to_fp 11 53) y0_ack!7017))
...
(let ((a!145 (fp.abs (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!7019)
                                     a!144)))))
  (FPCHECK_FMUL_UNDERFLOW #x3ff0000000000000 a!145))))))))))))))))))))))))))))))))))))))))
