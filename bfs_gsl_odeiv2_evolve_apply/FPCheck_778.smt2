(declare-fun t_ack!3701 () (_ BitVec 64))
(declare-fun t1_ack!3702 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3704 () (_ BitVec 64))
(declare-fun h_ack!3705 () (_ BitVec 64))
(declare-fun y0_ack!3703 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3702)
                    ((_ to_fp 11 53) t_ack!3701))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3704))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3703)
                                   ((_ to_fp 11 53) y0_ack!3703))
...
(let ((a!79 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!78
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x401489672d167d27 a!79)))))))))))))))))))))))))))))
