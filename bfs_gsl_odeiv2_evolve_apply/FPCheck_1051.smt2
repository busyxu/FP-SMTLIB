(declare-fun t_ack!5030 () (_ BitVec 64))
(declare-fun t1_ack!5031 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5033 () (_ BitVec 64))
(declare-fun h_ack!5034 () (_ BitVec 64))
(declare-fun y0_ack!5032 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5031)
                    ((_ to_fp 11 53) t_ack!5030))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5033))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5032)
                                   ((_ to_fp 11 53) y0_ack!5032))
...
(let ((a!79 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!78
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY #xbfcdfd195e96a441 a!79)))))))))))))))))))))))))))))
