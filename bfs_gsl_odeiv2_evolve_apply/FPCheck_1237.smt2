(declare-fun t_ack!5933 () (_ BitVec 64))
(declare-fun t1_ack!5934 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5936 () (_ BitVec 64))
(declare-fun h_ack!5937 () (_ BitVec 64))
(declare-fun y0_ack!5935 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5934)
                    ((_ to_fp 11 53) t_ack!5933))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5936))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5935)
                                   ((_ to_fp 11 53) y0_ack!5935))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fcea1cd5438b4f0
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5936) a!34)))))))))))))))))))
