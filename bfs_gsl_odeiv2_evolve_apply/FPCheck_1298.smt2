(declare-fun t_ack!6232 () (_ BitVec 64))
(declare-fun t1_ack!6233 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6234 () (_ BitVec 64))
(declare-fun y1_ack!6235 () (_ BitVec 64))
(declare-fun h_ack!6236 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6233)
                    ((_ to_fp 11 53) t_ack!6232))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6235))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6234)
                                   ((_ to_fp 11 53) y0_ack!6234))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!6236)
                                    a!45)))))
  (FPCHECK_FADD_UNDERFLOW a!36 a!46))))))))))))))))))))))
