(declare-fun t_ack!5378 () (_ BitVec 64))
(declare-fun t1_ack!5379 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5380 () (_ BitVec 64))
(declare-fun y1_ack!5381 () (_ BitVec 64))
(declare-fun h_ack!5382 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5379)
                    ((_ to_fp 11 53) t_ack!5378))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5381))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5380)
                                   ((_ to_fp 11 53) y0_ack!5380))
...
(let ((a!74 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!5382)
                                    a!73)))))
  (FPCHECK_FADD_OVERFLOW a!60 a!74))))))))))))))))))))))))))))
