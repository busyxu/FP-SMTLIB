(declare-fun t_ack!12068 () (_ BitVec 64))
(declare-fun t1_ack!12069 () (_ BitVec 64))
(declare-fun h_ack!12072 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!12071 () (_ BitVec 64))
(declare-fun y0_ack!12070 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!12069)
                    ((_ to_fp 11 53) t_ack!12068))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!12068))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!12072)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!12071))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!12070)
                                   ((_ to_fp 11 53) y0_ack!12070))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fee1c165324ef0a
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!12071) a!34)))))))))))))))))))
