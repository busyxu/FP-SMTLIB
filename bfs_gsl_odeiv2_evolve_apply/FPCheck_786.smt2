(declare-fun t_ack!3741 () (_ BitVec 64))
(declare-fun t1_ack!3742 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3744 () (_ BitVec 64))
(declare-fun h_ack!3745 () (_ BitVec 64))
(declare-fun y0_ack!3743 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3742)
                    ((_ to_fp 11 53) t_ack!3741))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3744))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3743)
                                   ((_ to_fp 11 53) y0_ack!3743))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!85)))))
  (FPCHECK_FADD_OVERFLOW y1_ack!3744 a!86))))))))))))))))))))))))))))))
