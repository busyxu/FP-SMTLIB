(declare-fun t_ack!4975 () (_ BitVec 64))
(declare-fun t1_ack!4976 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4978 () (_ BitVec 64))
(declare-fun h_ack!4979 () (_ BitVec 64))
(declare-fun y0_ack!4977 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4976)
                    ((_ to_fp 11 53) t_ack!4975))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4978))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4977)
                                   ((_ to_fp 11 53) y0_ack!4977))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!43
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xc0010572243a9883) a!55))))))))))))))))))))))))
