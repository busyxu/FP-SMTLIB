(declare-fun t_ack!5508 () (_ BitVec 64))
(declare-fun t1_ack!5509 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5511 () (_ BitVec 64))
(declare-fun h_ack!5512 () (_ BitVec 64))
(declare-fun y0_ack!5510 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5509)
                    ((_ to_fp 11 53) t_ack!5508))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5511))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5510)
                                   ((_ to_fp 11 53) y0_ack!5510))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y0_ack!5510
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5512) a!132))))))))))))))))))))))))))))))))))))))
