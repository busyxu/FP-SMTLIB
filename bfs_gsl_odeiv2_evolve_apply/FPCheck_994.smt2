(declare-fun t_ack!4748 () (_ BitVec 64))
(declare-fun t1_ack!4749 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4751 () (_ BitVec 64))
(declare-fun h_ack!4752 () (_ BitVec 64))
(declare-fun y0_ack!4750 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4749)
                    ((_ to_fp 11 53) t_ack!4748))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4751))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4750)
                                   ((_ to_fp 11 53) y0_ack!4750))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fc683d837559248
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4751) a!86)))))))))))))))))))))))))))))))
