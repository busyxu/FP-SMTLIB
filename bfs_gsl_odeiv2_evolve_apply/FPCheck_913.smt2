(declare-fun t_ack!4355 () (_ BitVec 64))
(declare-fun t1_ack!4356 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4358 () (_ BitVec 64))
(declare-fun h_ack!4359 () (_ BitVec 64))
(declare-fun y0_ack!4357 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4356)
                    ((_ to_fp 11 53) t_ack!4355))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4358))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4357)
                                   ((_ to_fp 11 53) y0_ack!4357))
...
(let ((a!85 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!69
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x40018d292a5d3212) a!85))))))))))))))))))))))))))))))
