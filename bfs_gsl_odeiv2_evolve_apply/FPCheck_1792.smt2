(declare-fun t_ack!10083 () (_ BitVec 64))
(declare-fun t1_ack!10084 () (_ BitVec 64))
(declare-fun h_ack!10087 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!10086 () (_ BitVec 64))
(declare-fun y0_ack!10085 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!10084)
                    ((_ to_fp 11 53) t_ack!10083))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!10083))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!10087)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!10086))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!10085)
                                   ((_ to_fp 11 53) y0_ack!10085))
...
(let ((a!22 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!22 a!22))))))))))))))
