...
(declare-fun t1_ack!3974 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3976 () (_ BitVec 64))
(declare-fun h_ack!3977 () (_ BitVec 64))
(declare-fun y0_ack!3975 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3974)
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x40164fca455cea0c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3976) a!34)))))))))))))))))))
