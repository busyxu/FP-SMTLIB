(declare-fun t_ack!12642 () (_ BitVec 64))
(declare-fun t1_ack!12643 () (_ BitVec 64))
(declare-fun h_ack!12646 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!12645 () (_ BitVec 64))
(declare-fun y0_ack!12644 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!12643)
                    ((_ to_fp 11 53) t_ack!12642))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!12642))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!12646)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!12645))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!12644)
                                   ((_ to_fp 11 53) y0_ack!12644))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!55)))))
  (FPCHECK_FADD_ACCURACY y1_ack!12645 a!56))))))))))))))))))))))))
