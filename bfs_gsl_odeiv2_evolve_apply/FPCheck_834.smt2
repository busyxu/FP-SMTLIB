(declare-fun t_ack!3963 () (_ BitVec 64))
(declare-fun t1_ack!3964 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3966 () (_ BitVec 64))
(declare-fun h_ack!3967 () (_ BitVec 64))
(declare-fun y0_ack!3965 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3964)
                    ((_ to_fp 11 53) t_ack!3963))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3966))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3965)
                                   ((_ to_fp 11 53) y0_ack!3965))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x40164fca455cea0c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3966) a!34)))))))))))))))))))
