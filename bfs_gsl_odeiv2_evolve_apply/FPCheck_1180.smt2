(declare-fun t_ack!5660 () (_ BitVec 64))
(declare-fun t1_ack!5661 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5663 () (_ BitVec 64))
(declare-fun h_ack!5664 () (_ BitVec 64))
(declare-fun y0_ack!5662 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5661)
                    ((_ to_fp 11 53) t_ack!5660))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5663))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5662)
                                   ((_ to_fp 11 53) y0_ack!5662))
