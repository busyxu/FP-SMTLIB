(declare-fun t_ack!5790 () (_ BitVec 64))
(declare-fun t1_ack!5791 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5792 () (_ BitVec 64))
(declare-fun y1_ack!5793 () (_ BitVec 64))
(declare-fun h_ack!5794 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5791)
                    ((_ to_fp 11 53) t_ack!5790))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5793))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5792)
                                   ((_ to_fp 11 53) y0_ack!5792))
...
(let ((a!144 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!5793
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5794) a!144))))))))))))))))))))))))))))))))))))))))
