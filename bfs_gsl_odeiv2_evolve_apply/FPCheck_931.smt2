...
(declare-fun t1_ack!4440 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4442 () (_ BitVec 64))
(declare-fun h_ack!4443 () (_ BitVec 64))
(declare-fun y0_ack!4441 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4440)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4442))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4441)
                                   ((_ to_fp 11 53) y0_ack!4441))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4441)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4443) a!94)))))))))))))))))))))))))))))))))
