(declare-fun t_ack!2770 () (_ BitVec 64))
(declare-fun t1_ack!2771 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2773 () (_ BitVec 64))
(declare-fun h_ack!2774 () (_ BitVec 64))
(declare-fun y0_ack!2772 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2771)
                    ((_ to_fp 11 53) t_ack!2770))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2773))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2772)
                                   ((_ to_fp 11 53) y0_ack!2772))
...
(let ((a!21 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!2774)
                                    a!20)))))
  (FPCHECK_FADD_ACCURACY a!14 a!21)))))))))))))
