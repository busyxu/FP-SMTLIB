(declare-fun t_ack!5804 () (_ BitVec 64))
(declare-fun t1_ack!5805 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5807 () (_ BitVec 64))
(declare-fun h_ack!5808 () (_ BitVec 64))
(declare-fun y0_ack!5806 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5805)
                    ((_ to_fp 11 53) t_ack!5804))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5807))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5806)
                                   ((_ to_fp 11 53) y0_ack!5806))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5806)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5808) a!132)))))))))))))))))))))))))))))))))))))))
