(declare-fun t_ack!238 () (_ BitVec 64))
(declare-fun t1_ack!239 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!239)
                    ((_ to_fp 11 53) t_ack!238))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!241) a!2)))))
