(declare-fun t_ack!4970 () (_ BitVec 64))
(declare-fun t1_ack!4971 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4973 () (_ BitVec 64))
(declare-fun h_ack!4974 () (_ BitVec 64))
(declare-fun y0_ack!4972 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4971)
                    ((_ to_fp 11 53) t_ack!4970))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4973))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4972)
                                   ((_ to_fp 11 53) y0_ack!4972))
...
(let ((a!51 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!50
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY #xc0010572243a9883 a!51)))))))))))))))))))))))
