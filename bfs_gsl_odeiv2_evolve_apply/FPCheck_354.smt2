(declare-fun t_ack!1665 () (_ BitVec 64))
(declare-fun t1_ack!1666 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!1668 () (_ BitVec 64))
(declare-fun h_ack!1669 () (_ BitVec 64))
(declare-fun y0_ack!1667 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1666)
                    ((_ to_fp 11 53) t_ack!1665))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33)))))
  (FPCHECK_FADD_OVERFLOW y1_ack!1668 a!34))))))))))))))))))
