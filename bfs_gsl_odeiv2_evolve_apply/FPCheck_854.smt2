...
(declare-fun t1_ack!4064 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4065 () (_ BitVec 64))
(declare-fun y1_ack!4066 () (_ BitVec 64))
(declare-fun h_ack!4067 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4064)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4066))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4065)
                                   ((_ to_fp 11 53) y0_ack!4065))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4066)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4067) a!69)))))))))))))))))))))))))))))
