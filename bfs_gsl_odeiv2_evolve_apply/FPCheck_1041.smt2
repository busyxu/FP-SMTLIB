(declare-fun t_ack!4980 () (_ BitVec 64))
(declare-fun t1_ack!4981 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4983 () (_ BitVec 64))
(declare-fun h_ack!4984 () (_ BitVec 64))
(declare-fun y0_ack!4982 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4981)
                    ((_ to_fp 11 53) t_ack!4980))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4983))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4982)
                                   ((_ to_fp 11 53) y0_ack!4982))
