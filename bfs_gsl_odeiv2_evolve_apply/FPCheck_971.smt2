(declare-fun t_ack!4633 () (_ BitVec 64))
(declare-fun t1_ack!4634 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4636 () (_ BitVec 64))
(declare-fun h_ack!4637 () (_ BitVec 64))
(declare-fun y0_ack!4635 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4634)
                    ((_ to_fp 11 53) t_ack!4633))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4636))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4635)
                                   ((_ to_fp 11 53) y0_ack!4635))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x402826cbfaa51862
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4636) a!34)))))))))))))))))))
