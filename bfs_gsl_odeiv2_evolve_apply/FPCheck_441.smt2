(declare-fun t_ack!2079 () (_ BitVec 64))
(declare-fun t1_ack!2080 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2081 () (_ BitVec 64))
(declare-fun y1_ack!2082 () (_ BitVec 64))
(declare-fun h_ack!2083 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2080)
                    ((_ to_fp 11 53) t_ack!2079))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2082))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2081)
                                   ((_ to_fp 11 53) y0_ack!2081))
...
(let ((a!43 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33))
                    a!42)))
  (FPCHECK_FMUL_OVERFLOW h_ack!2083 a!43)))))))))))))))))))))
