(declare-fun t_ack!4003 () (_ BitVec 64))
(declare-fun t1_ack!4004 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4005 () (_ BitVec 64))
(declare-fun y1_ack!4006 () (_ BitVec 64))
(declare-fun h_ack!4007 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4004)
                    ((_ to_fp 11 53) t_ack!4003))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4006))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4005)
                                   ((_ to_fp 11 53) y0_ack!4005))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4006)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4007) a!43)))))))))))))))))))))))
