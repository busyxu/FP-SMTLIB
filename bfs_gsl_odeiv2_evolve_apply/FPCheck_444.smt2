(declare-fun t_ack!2094 () (_ BitVec 64))
(declare-fun t1_ack!2095 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2096 () (_ BitVec 64))
(declare-fun y1_ack!2097 () (_ BitVec 64))
(declare-fun h_ack!2098 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2095)
                    ((_ to_fp 11 53) t_ack!2094))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2097))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2096)
                                   ((_ to_fp 11 53) y0_ack!2096))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y1_ack!2097
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2098) a!43))))))))))))))))))))))
