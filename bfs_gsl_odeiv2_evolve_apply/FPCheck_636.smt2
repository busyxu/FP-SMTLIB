(declare-fun t_ack!3012 () (_ BitVec 64))
(declare-fun t1_ack!3013 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3015 () (_ BitVec 64))
(declare-fun h_ack!3016 () (_ BitVec 64))
(declare-fun y0_ack!3014 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3013)
                    ((_ to_fp 11 53) t_ack!3012))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3015))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3014)
                                   ((_ to_fp 11 53) y0_ack!3014))
...
(let ((a!33 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!26
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbf9b1bbe5082a5c1) a!33))))))))))))))))))
