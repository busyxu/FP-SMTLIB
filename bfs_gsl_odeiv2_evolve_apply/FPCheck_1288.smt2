(declare-fun t_ack!6182 () (_ BitVec 64))
(declare-fun t1_ack!6183 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6185 () (_ BitVec 64))
(declare-fun h_ack!6186 () (_ BitVec 64))
(declare-fun y0_ack!6184 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6183)
                    ((_ to_fp 11 53) t_ack!6182))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6185))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6184)
                                   ((_ to_fp 11 53) y0_ack!6184))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fd3eb5ef3b96b09
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6185) a!34)))))))))))))))))))
