(declare-fun t_ack!5120 () (_ BitVec 64))
(declare-fun t1_ack!5121 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5123 () (_ BitVec 64))
(declare-fun h_ack!5124 () (_ BitVec 64))
(declare-fun y0_ack!5122 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5121)
                    ((_ to_fp 11 53) t_ack!5120))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5123))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5122)
                                   ((_ to_fp 11 53) y0_ack!5122))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x0000000000000000)
                                     a!123)))))
  (FPCHECK_FADD_OVERFLOW y1_ack!5123 a!124))))))))))))))))))))))))))))))))))))
