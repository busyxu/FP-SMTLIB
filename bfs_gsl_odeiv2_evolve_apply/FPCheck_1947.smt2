(declare-fun t_ack!11631 () (_ BitVec 64))
(declare-fun t1_ack!11632 () (_ BitVec 64))
(declare-fun h_ack!11635 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!11633 () (_ BitVec 64))
(declare-fun y1_ack!11634 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11632)
                    ((_ to_fp 11 53) t_ack!11631))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11631))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11635)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11634))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11633)
                                   ((_ to_fp 11 53) y0_ack!11633))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y1_ack!11634
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11635) a!43))))))))))))))))))))))
