(declare-fun t_ack!11199 () (_ BitVec 64))
(declare-fun t1_ack!11200 () (_ BitVec 64))
(declare-fun h_ack!11203 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11202 () (_ BitVec 64))
(declare-fun y0_ack!11201 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11200)
                    ((_ to_fp 11 53) t_ack!11199))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11199))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11203)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11202))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11201)
                                   ((_ to_fp 11 53) y0_ack!11201))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xbfc61b7ccdaf2f38
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!11202) a!34)))))))))))))))))))
