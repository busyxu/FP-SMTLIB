(declare-fun t_ack!11678 () (_ BitVec 64))
(declare-fun t1_ack!11679 () (_ BitVec 64))
(declare-fun h_ack!11682 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11681 () (_ BitVec 64))
(declare-fun y0_ack!11680 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11679)
                    ((_ to_fp 11 53) t_ack!11678))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11678))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11682)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11681))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11680)
                                   ((_ to_fp 11 53) y0_ack!11680))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11680)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11682) a!38)))))))))))))))))))))
