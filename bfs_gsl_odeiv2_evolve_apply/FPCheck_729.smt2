(declare-fun t_ack!3459 () (_ BitVec 64))
(declare-fun t1_ack!3460 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3461 () (_ BitVec 64))
(declare-fun y1_ack!3462 () (_ BitVec 64))
(declare-fun h_ack!3463 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3460)
                    ((_ to_fp 11 53) t_ack!3459))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3462))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3461)
                                   ((_ to_fp 11 53) y0_ack!3461))
...
(let ((a!76 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!3463)
                                    a!75)))))
  (FPCHECK_FADD_OVERFLOW a!62 a!76))))))))))))))))))))))))))))
