(declare-fun t_ack!12200 () (_ BitVec 64))
(declare-fun t1_ack!12201 () (_ BitVec 64))
(declare-fun h_ack!12204 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!12202 () (_ BitVec 64))
(declare-fun y1_ack!12203 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!12201)
                    ((_ to_fp 11 53) t_ack!12200))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!12200))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!12204)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!12203))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!12202)
                                   ((_ to_fp 11 53) y0_ack!12202))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!12204)
                                    a!47)))))
  (FPCHECK_FMUL_UNDERFLOW h_ack!12204 (fp.add roundNearestTiesToEven a!38 a!48)))))))))))))))))))))))
