(declare-fun t_ack!4628 () (_ BitVec 64))
(declare-fun t1_ack!4629 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4631 () (_ BitVec 64))
(declare-fun h_ack!4632 () (_ BitVec 64))
(declare-fun y0_ack!4630 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4629)
                    ((_ to_fp 11 53) t_ack!4628))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4631))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4630)
                                   ((_ to_fp 11 53) y0_ack!4630))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x402826cbfaa51862
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4631) a!34)))))))))))))))))))
