(declare-fun t_ack!5125 () (_ BitVec 64))
(declare-fun t1_ack!5126 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5128 () (_ BitVec 64))
(declare-fun h_ack!5129 () (_ BitVec 64))
(declare-fun y0_ack!5127 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5126)
                    ((_ to_fp 11 53) t_ack!5125))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5128))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5127)
                                   ((_ to_fp 11 53) y0_ack!5127))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x0000000000000000)
                                     a!123)))))
  (FPCHECK_FADD_UNDERFLOW y1_ack!5128 a!124))))))))))))))))))))))))))))))))))))
