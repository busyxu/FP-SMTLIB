(declare-fun t_ack!5655 () (_ BitVec 64))
(declare-fun t1_ack!5656 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5658 () (_ BitVec 64))
(declare-fun h_ack!5659 () (_ BitVec 64))
(declare-fun y0_ack!5657 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5656)
                    ((_ to_fp 11 53) t_ack!5655))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5658))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5657)
                                   ((_ to_fp 11 53) y0_ack!5657))
...
(let ((a!79 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!78
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY #x3fe5235514d8405c a!79)))))))))))))))))))))))))))))
