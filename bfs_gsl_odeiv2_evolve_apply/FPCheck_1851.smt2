(declare-fun t_ack!10681 () (_ BitVec 64))
(declare-fun t1_ack!10682 () (_ BitVec 64))
(declare-fun h_ack!10685 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!10684 () (_ BitVec 64))
(declare-fun y0_ack!10683 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!10682)
                    ((_ to_fp 11 53) t_ack!10681))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!10681))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!10685)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!10684))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!10683)
                                   ((_ to_fp 11 53) y0_ack!10683))
...
(let ((a!33 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!26
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3f8a4f6f83ae9731) a!33))))))))))))))))))
