(declare-fun t_ack!4078 () (_ BitVec 64))
(declare-fun t1_ack!4079 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4080 () (_ BitVec 64))
(declare-fun y1_ack!4081 () (_ BitVec 64))
(declare-fun h_ack!4082 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4079)
                    ((_ to_fp 11 53) t_ack!4078))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4081))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4080)
                                   ((_ to_fp 11 53) y0_ack!4080))
...
(let ((a!76 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4082)
                                    a!75)))))
  (FPCHECK_FADD_ACCURACY a!62 a!76))))))))))))))))))))))))))))
