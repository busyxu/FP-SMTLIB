...
(declare-fun y1_ack!4026 () (_ BitVec 64))
(declare-fun h_ack!4027 () (_ BitVec 64))
(declare-fun y0_ack!4025 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4026))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4025)
                                   ((_ to_fp 11 53) y0_ack!4025))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xc0143f985843ddf3
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4026) a!56)))))))))))))))))))))))))
