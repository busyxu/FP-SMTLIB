(declare-fun t_ack!5834 () (_ BitVec 64))
(declare-fun t1_ack!5835 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5837 () (_ BitVec 64))
(declare-fun h_ack!5838 () (_ BitVec 64))
(declare-fun y0_ack!5836 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5835)
                    ((_ to_fp 11 53) t_ack!5834))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5837))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5836)
                                   ((_ to_fp 11 53) y0_ack!5836))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5836)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5838) a!132))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5836)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5838) a!132)))))))))))))))))))))))))))))))))))))))
