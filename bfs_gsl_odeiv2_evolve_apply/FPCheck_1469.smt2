(declare-fun t_ack!7075 () (_ BitVec 64))
(declare-fun t1_ack!7076 () (_ BitVec 64))
(declare-fun y0_ack!7077 () (_ BitVec 64))
(declare-fun y1_ack!7078 () (_ BitVec 64))
(declare-fun h_ack!7079 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7076)
                    ((_ to_fp 11 53) t_ack!7075))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7078))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7077)
                                   ((_ to_fp 11 53) y0_ack!7077))
...
(let ((a!159 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!145)
                             a!158))))
  (FPCHECK_FADD_OVERFLOW a!159 #x3eb0c6f7a0b5ed8d)))))))))))))))))))))))))))))))))))))))))))
