(declare-fun t_ack!5333 () (_ BitVec 64))
(declare-fun t1_ack!5334 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5336 () (_ BitVec 64))
(declare-fun h_ack!5337 () (_ BitVec 64))
(declare-fun y0_ack!5335 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5334)
                    ((_ to_fp 11 53) t_ack!5333))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5336))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5335)
                                   ((_ to_fp 11 53) y0_ack!5335))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xbfe84ff364c4f34c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5336) a!56)))))))))))))))))))))))))
