(declare-fun t_ack!6023 () (_ BitVec 64))
(declare-fun t1_ack!6024 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6025 () (_ BitVec 64))
(declare-fun y1_ack!6026 () (_ BitVec 64))
(declare-fun h_ack!6027 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6024)
                    ((_ to_fp 11 53) t_ack!6023))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6026))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6025)
                                   ((_ to_fp 11 53) y0_ack!6025))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6026)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6027) a!69)))))))))))))))))))))))))))))
