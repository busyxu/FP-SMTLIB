(declare-fun t_ack!5968 () (_ BitVec 64))
(declare-fun t1_ack!5969 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5970 () (_ BitVec 64))
(declare-fun y1_ack!5971 () (_ BitVec 64))
(declare-fun h_ack!5972 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5969)
                    ((_ to_fp 11 53) t_ack!5968))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5971))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5970)
                                   ((_ to_fp 11 53) y0_ack!5970))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5971)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5972) a!43)))))))))))))))))))))))
