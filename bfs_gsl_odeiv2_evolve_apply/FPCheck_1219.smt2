(declare-fun t_ack!5849 () (_ BitVec 64))
(declare-fun t1_ack!5850 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!5852 () (_ BitVec 64))
(declare-fun h_ack!5853 () (_ BitVec 64))
(declare-fun y0_ack!5851 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5850)
                    ((_ to_fp 11 53) t_ack!5849))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5852))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5851)
                                   ((_ to_fp 11 53) y0_ack!5851))
...
(let ((a!133 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!5853)
                                     a!132)))))
  (FPCHECK_FSUB_OVERFLOW a!133 #x3ff0000000000000))))))))))))))))))))))))))))))))))))))
