(declare-fun t_ack!13089 () (_ BitVec 64))
(declare-fun t1_ack!13090 () (_ BitVec 64))
(declare-fun h_ack!13093 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!13092 () (_ BitVec 64))
(declare-fun y0_ack!13091 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!13090)
                    ((_ to_fp 11 53) t_ack!13089))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!13089))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!13093)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!13092))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!13091)
                                   ((_ to_fp 11 53) y0_ack!13091))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x4006c85fb0a3e9bf
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!13092) a!34)))))))))))))))))))
