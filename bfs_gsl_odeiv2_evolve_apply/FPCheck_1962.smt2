(declare-fun t_ack!11759 () (_ BitVec 64))
(declare-fun t1_ack!11760 () (_ BitVec 64))
(declare-fun h_ack!11763 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!11762 () (_ BitVec 64))
(declare-fun y0_ack!11761 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11760)
                    ((_ to_fp 11 53) t_ack!11759))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11759))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11763)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11762))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11761)
                                   ((_ to_fp 11 53) y0_ack!11761))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11761)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11763) a!38))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11761)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11763) a!38)))))))))))))))))))))
