(declare-fun t_ack!6332 () (_ BitVec 64))
(declare-fun t1_ack!6333 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6334 () (_ BitVec 64))
(declare-fun y1_ack!6335 () (_ BitVec 64))
(declare-fun h_ack!6336 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6333)
                    ((_ to_fp 11 53) t_ack!6332))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6335))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6334)
                                   ((_ to_fp 11 53) y0_ack!6334))
...
(let ((a!103 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!6335)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!6336) a!103)))))))))))))))))))))))))))))))))))
