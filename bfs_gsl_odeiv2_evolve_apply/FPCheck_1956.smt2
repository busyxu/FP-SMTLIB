(declare-fun t_ack!11698 () (_ BitVec 64))
(declare-fun t1_ack!11699 () (_ BitVec 64))
(declare-fun h_ack!11702 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11701 () (_ BitVec 64))
(declare-fun y0_ack!11700 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11699)
                    ((_ to_fp 11 53) t_ack!11698))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11698))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11702)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11701))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11700)
                                   ((_ to_fp 11 53) y0_ack!11700))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!11700)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11702) a!38)))))))))))))))))))))
