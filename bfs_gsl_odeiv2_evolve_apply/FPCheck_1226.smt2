(declare-fun t_ack!5884 () (_ BitVec 64))
(declare-fun t1_ack!5885 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5887 () (_ BitVec 64))
(declare-fun h_ack!5888 () (_ BitVec 64))
(declare-fun y0_ack!5886 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5885)
                    ((_ to_fp 11 53) t_ack!5884))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5887))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5886)
                                   ((_ to_fp 11 53) y0_ack!5886))
...
(let ((a!132 (fp.add roundNearestTiesToEven
      ...
      (a!151 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.sub roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3ff0000000000000)))))
(let ((a!133 (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x8000000000000000)
                     (fp.add roundNearestTiesToEven
                             ((_ to_fp 11 53) y0_ack!5886)
                             (fp.mul roundNearestTiesToEven
