(declare-fun t_ack!13099 () (_ BitVec 64))
(declare-fun t1_ack!13100 () (_ BitVec 64))
(declare-fun h_ack!13103 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!13102 () (_ BitVec 64))
(declare-fun y0_ack!13101 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!13100)
                    ((_ to_fp 11 53) t_ack!13099))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!13099))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!13103)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!13102))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!13101)
                                   ((_ to_fp 11 53) y0_ack!13101))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4006c85fb0a3e9bf
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!13102) a!34)))))))))))))))))))
