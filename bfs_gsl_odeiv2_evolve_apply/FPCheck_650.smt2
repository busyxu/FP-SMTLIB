(declare-fun t_ack!3082 () (_ BitVec 64))
(declare-fun t1_ack!3083 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3085 () (_ BitVec 64))
(declare-fun h_ack!3086 () (_ BitVec 64))
(declare-fun y0_ack!3084 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3083)
                    ((_ to_fp 11 53) t_ack!3082))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3085))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3084)
                                   ((_ to_fp 11 53) y0_ack!3084))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!43
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fd20240028afd67) a!55))))))))))))))))))))))))
