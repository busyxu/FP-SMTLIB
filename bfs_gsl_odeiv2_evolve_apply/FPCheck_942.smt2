(declare-fun t_ack!4494 () (_ BitVec 64))
(declare-fun t1_ack!4495 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4497 () (_ BitVec 64))
(declare-fun h_ack!4498 () (_ BitVec 64))
(declare-fun y0_ack!4496 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4495)
                    ((_ to_fp 11 53) t_ack!4494))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4497))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4496)
                                   ((_ to_fp 11 53) y0_ack!4496))
...
(let ((a!41 (fp.mul roundNearestTiesToEven
      ...
      (a!108 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             (fp.add roundNearestTiesToEven a!105 a!106)
                             a!107)
                     (fp.mul roundNearestTiesToEven
...
(let ((a!101 (fp.mul roundNearestTiesToEven
      ...
      (a!112 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven a!110 a!111)
                     (fp.mul roundNearestTiesToEven
...
(let ((a!103 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!85))
                     a!102)))
(let ((a!104 (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x4024000000000000)
                     (fp.add roundNearestTiesToEven
                             ((_ to_fp 11 53) y1_ack!4497)
                             (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!104
    (fp.sub roundNearestTiesToEven a!113 ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))))))))))))))
