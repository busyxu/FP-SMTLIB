(declare-fun t_ack!11621 () (_ BitVec 64))
(declare-fun t1_ack!11622 () (_ BitVec 64))
(declare-fun h_ack!11625 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!11623 () (_ BitVec 64))
(declare-fun y1_ack!11624 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11622)
                    ((_ to_fp 11 53) t_ack!11621))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11621))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11625)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11624))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11623)
                                   ((_ to_fp 11 53) y0_ack!11623))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y1_ack!11624
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11625) a!43))))))))))))))))))))))
