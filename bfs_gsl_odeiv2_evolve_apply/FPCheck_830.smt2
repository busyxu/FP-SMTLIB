(declare-fun t_ack!3943 () (_ BitVec 64))
(declare-fun t1_ack!3944 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3945 () (_ BitVec 64))
(declare-fun y1_ack!3946 () (_ BitVec 64))
(declare-fun h_ack!3947 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3944)
                    ((_ to_fp 11 53) t_ack!3943))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3946))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3945)
                                   ((_ to_fp 11 53) y0_ack!3945))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!3946)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3947) a!26)))))))))))))))))
