(declare-fun t_ack!6950 () (_ BitVec 64))
(declare-fun t1_ack!6951 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6952 () (_ BitVec 64))
(declare-fun y1_ack!6953 () (_ BitVec 64))
(declare-fun h_ack!6954 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6951)
                    ((_ to_fp 11 53) t_ack!6950))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6953))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6952)
                                   ((_ to_fp 11 53) y0_ack!6952))
...
(let ((a!154 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!133)
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x0000000000000000)
            (fp.abs a!154))))))))))))))))))))))))))))))))))))))))))
