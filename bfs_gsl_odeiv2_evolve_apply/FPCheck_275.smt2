(declare-fun t_ack!1291 () (_ BitVec 64))
(declare-fun t1_ack!1292 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!1293 () (_ BitVec 64))
(declare-fun y1_ack!1294 () (_ BitVec 64))
(declare-fun h_ack!1295 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1292)
                    ((_ to_fp 11 53) t_ack!1291))
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!25))))
  (FPCHECK_FMUL_ACCURACY h_ack!1295 a!26)))))))))))))))
