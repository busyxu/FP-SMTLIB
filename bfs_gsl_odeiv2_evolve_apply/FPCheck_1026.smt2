(declare-fun t_ack!4905 () (_ BitVec 64))
(declare-fun t1_ack!4906 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4908 () (_ BitVec 64))
(declare-fun h_ack!4909 () (_ BitVec 64))
(declare-fun y0_ack!4907 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4906)
                    ((_ to_fp 11 53) t_ack!4905))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4908))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4907)
                                   ((_ to_fp 11 53) y0_ack!4907))
...
(let ((a!31 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3fe6d8df236b4d37 a!31)))))))))))))))))
