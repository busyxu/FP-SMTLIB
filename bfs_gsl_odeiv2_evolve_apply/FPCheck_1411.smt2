(declare-fun t_ack!6791 () (_ BitVec 64))
(declare-fun t1_ack!6792 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6794 () (_ BitVec 64))
(declare-fun h_ack!6795 () (_ BitVec 64))
(declare-fun y0_ack!6793 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6792)
                    ((_ to_fp 11 53) t_ack!6791))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6794))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6793)
                                   ((_ to_fp 11 53) y0_ack!6793))
...
(let ((a!84 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!68
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3ff718c66651430c) a!84))))))))))))))))))))))))))))))
