(declare-fun t_ack!4693 () (_ BitVec 64))
(declare-fun t1_ack!4694 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4696 () (_ BitVec 64))
(declare-fun h_ack!4697 () (_ BitVec 64))
(declare-fun y0_ack!4695 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4694)
                    ((_ to_fp 11 53) t_ack!4693))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4696))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4695)
                                   ((_ to_fp 11 53) y0_ack!4695))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fffd7b8854e12f5
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4696) a!56)))))))))))))))))))))))))
