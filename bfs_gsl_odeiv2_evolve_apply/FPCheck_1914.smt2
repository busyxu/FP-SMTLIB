(declare-fun t_ack!11293 () (_ BitVec 64))
(declare-fun t1_ack!11294 () (_ BitVec 64))
(declare-fun h_ack!11297 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!11296 () (_ BitVec 64))
(declare-fun y0_ack!11295 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11294)
                    ((_ to_fp 11 53) t_ack!11293))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11293))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11297)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11296))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11295)
                                   ((_ to_fp 11 53) y0_ack!11295))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    y0_ack!11295
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11297) a!38))))))))))))))))))))
