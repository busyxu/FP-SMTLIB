(declare-fun t_ack!3839 () (_ BitVec 64))
(declare-fun t1_ack!3840 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3841 () (_ BitVec 64))
(declare-fun y1_ack!3842 () (_ BitVec 64))
(declare-fun h_ack!3843 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3840)
                    ((_ to_fp 11 53) t_ack!3839))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3842))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3841)
                                   ((_ to_fp 11 53) y0_ack!3841))
...
(let ((a!85 (fp.sub roundNearestTiesToEven
      ...
      (a!94 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) h_ack!3843)
                            (fp.add roundNearestTiesToEven a!92 a!93)))))
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x4024000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3842) a!86))
    (fp.sub roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!94 a!94)
            ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))))))))))
