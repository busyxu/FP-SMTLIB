(declare-fun t_ack!6292 () (_ BitVec 64))
(declare-fun t1_ack!6293 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6294 () (_ BitVec 64))
(declare-fun y1_ack!6295 () (_ BitVec 64))
(declare-fun h_ack!6296 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6293)
                    ((_ to_fp 11 53) t_ack!6292))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6295))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6294)
                                   ((_ to_fp 11 53) y0_ack!6294))
