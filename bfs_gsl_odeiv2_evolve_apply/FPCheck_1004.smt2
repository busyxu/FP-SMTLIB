(declare-fun t_ack!4798 () (_ BitVec 64))
(declare-fun t1_ack!4799 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4800 () (_ BitVec 64))
(declare-fun y1_ack!4801 () (_ BitVec 64))
(declare-fun h_ack!4802 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4799)
                    ((_ to_fp 11 53) t_ack!4798))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4801))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4800)
                                   ((_ to_fp 11 53) y0_ack!4800))
...
(let ((a!112 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!4802)
                                     a!111)))))
  (FPCHECK_FMUL_OVERFLOW h_ack!4802 (fp.add roundNearestTiesToEven a!94 a!112)))))))))))))))))))))))))))))))))))
