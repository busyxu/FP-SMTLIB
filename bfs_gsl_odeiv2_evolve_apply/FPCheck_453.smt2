(declare-fun t_ack!2127 () (_ BitVec 64))
(declare-fun t1_ack!2128 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2130 () (_ BitVec 64))
(declare-fun h_ack!2131 () (_ BitVec 64))
(declare-fun y0_ack!2129 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2128)
                    ((_ to_fp 11 53) t_ack!2127))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!2129)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2131) a!38)))))))))))))))))))))
