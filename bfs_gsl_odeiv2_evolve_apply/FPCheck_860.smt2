(declare-fun t_ack!4093 () (_ BitVec 64))
(declare-fun t1_ack!4094 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4096 () (_ BitVec 64))
(declare-fun h_ack!4097 () (_ BitVec 64))
(declare-fun y0_ack!4095 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4094)
                    ((_ to_fp 11 53) t_ack!4093))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fc13b7d81af1344
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4096) a!86)))))))))))))))))))))))))))))))
