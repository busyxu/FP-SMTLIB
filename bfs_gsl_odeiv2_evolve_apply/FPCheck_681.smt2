(declare-fun t_ack!3225 () (_ BitVec 64))
(declare-fun t1_ack!3226 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3228 () (_ BitVec 64))
(declare-fun h_ack!3229 () (_ BitVec 64))
(declare-fun y0_ack!3227 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3226)
                    ((_ to_fp 11 53) t_ack!3225))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3228))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3227)
                                   ((_ to_fp 11 53) y0_ack!3227))
...
(let ((a!70 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!70
    (fp.sub roundNearestTiesToEven a!77 ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))))))))))))))
