(declare-fun t_ack!4133 () (_ BitVec 64))
(declare-fun t1_ack!4134 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4136 () (_ BitVec 64))
(declare-fun h_ack!4137 () (_ BitVec 64))
(declare-fun y0_ack!4135 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4134)
                    ((_ to_fp 11 53) t_ack!4133))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4136))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4135)
                                   ((_ to_fp 11 53) y0_ack!4135))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y0_ack!4135
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4137) a!94))))))))))))))))))))))))))))))))
