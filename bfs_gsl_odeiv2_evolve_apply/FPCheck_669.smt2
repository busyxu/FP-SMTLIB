(declare-fun t_ack!3165 () (_ BitVec 64))
(declare-fun t1_ack!3166 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3168 () (_ BitVec 64))
(declare-fun h_ack!3169 () (_ BitVec 64))
(declare-fun y0_ack!3167 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3166)
                    ((_ to_fp 11 53) t_ack!3165))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3168))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3167)
                                   ((_ to_fp 11 53) y0_ack!3167))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3167)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3169) a!62)))))))))))))))))))))))))))
