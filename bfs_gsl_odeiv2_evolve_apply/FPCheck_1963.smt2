(declare-fun t_ack!11772 () (_ BitVec 64))
(declare-fun t1_ack!11773 () (_ BitVec 64))
(declare-fun h_ack!11776 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y1_ack!11775 () (_ BitVec 64))
(declare-fun y0_ack!11774 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11773)
                    ((_ to_fp 11 53) t_ack!11772))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11772))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11776)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11775))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11774)
                                   ((_ to_fp 11 53) y0_ack!11774))
...
(let ((a!39 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!11776)
                                    a!38)))))
  (FPCHECK_FSUB_OVERFLOW a!39 #x3ff0000000000000))))))))))))))))))))
