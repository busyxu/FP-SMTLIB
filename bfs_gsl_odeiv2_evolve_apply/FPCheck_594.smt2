(declare-fun t_ack!2805 () (_ BitVec 64))
(declare-fun t1_ack!2806 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2808 () (_ BitVec 64))
(declare-fun h_ack!2809 () (_ BitVec 64))
(declare-fun y0_ack!2807 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2806)
                    ((_ to_fp 11 53) t_ack!2805))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2808))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2807)
                                   ((_ to_fp 11 53) y0_ack!2807))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4006c85fb0a3e9bf
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2808) a!34)))))))))))))))))))
