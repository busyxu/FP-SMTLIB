(declare-fun t_ack!11611 () (_ BitVec 64))
(declare-fun t1_ack!11612 () (_ BitVec 64))
(declare-fun h_ack!11615 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!11613 () (_ BitVec 64))
(declare-fun y1_ack!11614 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!11612)
                    ((_ to_fp 11 53) t_ack!11611))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!11611))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!11615)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!11614))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!11613)
                                   ((_ to_fp 11 53) y0_ack!11613))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y1_ack!11614
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!11615) a!43))))))))))))))))))))))
