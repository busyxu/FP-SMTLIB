(declare-fun t_ack!5814 () (_ BitVec 64))
(declare-fun t1_ack!5815 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5817 () (_ BitVec 64))
(declare-fun h_ack!5818 () (_ BitVec 64))
(declare-fun y0_ack!5816 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5815)
                    ((_ to_fp 11 53) t_ack!5814))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5817))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5816)
                                   ((_ to_fp 11 53) y0_ack!5816))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!5816)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5818) a!132)))))))))))))))))))))))))))))))))))))))
