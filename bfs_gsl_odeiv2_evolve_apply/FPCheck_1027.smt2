(declare-fun t_ack!4910 () (_ BitVec 64))
(declare-fun t1_ack!4911 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4913 () (_ BitVec 64))
(declare-fun h_ack!4914 () (_ BitVec 64))
(declare-fun y0_ack!4912 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4911)
                    ((_ to_fp 11 53) t_ack!4910))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4913))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4912)
                                   ((_ to_fp 11 53) y0_ack!4912))
...
(let ((a!31 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_ACCURACY #x3fe6d8df236b4d37 a!31)))))))))))))))))
