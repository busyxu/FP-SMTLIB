(declare-fun t_ack!5393 () (_ BitVec 64))
(declare-fun t1_ack!5394 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5396 () (_ BitVec 64))
(declare-fun h_ack!5397 () (_ BitVec 64))
(declare-fun y0_ack!5395 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5394)
                    ((_ to_fp 11 53) t_ack!5393))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5396))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5395)
                                   ((_ to_fp 11 53) y0_ack!5395))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fc43f7cc8023f22
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5396) a!86)))))))))))))))))))))))))))))))
