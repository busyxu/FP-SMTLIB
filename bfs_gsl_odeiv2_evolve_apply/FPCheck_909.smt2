...
(declare-fun y1_ack!4338 () (_ BitVec 64))
(declare-fun h_ack!4339 () (_ BitVec 64))
...
(let ((a!79 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!78
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x40018d292a5d3212 a!79)))))))))))))))))))))))))))))
