(declare-fun t_ack!4210 () (_ BitVec 64))
(declare-fun t1_ack!4211 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4212 () (_ BitVec 64))
(declare-fun y1_ack!4213 () (_ BitVec 64))
(declare-fun h_ack!4214 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4211)
                    ((_ to_fp 11 53) t_ack!4210))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4213))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4212)
                                   ((_ to_fp 11 53) y0_ack!4212))
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!18))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfdbd8905e38fcd7) a!25)))))))))))))))
