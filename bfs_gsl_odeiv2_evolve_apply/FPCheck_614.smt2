(declare-fun t_ack!2905 () (_ BitVec 64))
(declare-fun t1_ack!2906 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2908 () (_ BitVec 64))
(declare-fun h_ack!2909 () (_ BitVec 64))
(declare-fun y0_ack!2907 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2906)
                    ((_ to_fp 11 53) t_ack!2905))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2908))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2907)
                                   ((_ to_fp 11 53) y0_ack!2907))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) y1_ack!2908)
                                    a!61)))))
  (FPCHECK_FMUL_ACCURACY h_ack!2909 a!62)))))))))))))))))))))))))
