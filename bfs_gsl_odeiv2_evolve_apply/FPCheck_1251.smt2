(declare-fun t_ack!6003 () (_ BitVec 64))
(declare-fun t1_ack!6004 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6006 () (_ BitVec 64))
(declare-fun h_ack!6007 () (_ BitVec 64))
(declare-fun y0_ack!6005 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6004)
                    ((_ to_fp 11 53) t_ack!6003))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6006))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6005)
                                   ((_ to_fp 11 53) y0_ack!6005))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xbfe84ff364c4f34c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6006) a!56)))))))))))))))))))))))))
