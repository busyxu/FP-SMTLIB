(declare-fun t_ack!5710 () (_ BitVec 64))
(declare-fun t1_ack!5711 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5713 () (_ BitVec 64))
(declare-fun h_ack!5714 () (_ BitVec 64))
(declare-fun y0_ack!5712 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5711)
                    ((_ to_fp 11 53) t_ack!5710))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5713))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5712)
                                   ((_ to_fp 11 53) y0_ack!5712))
      ...
      (a!110 (fp.mul roundNearestTiesToEven
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.add roundNearestTiesToEven
                                     ...
                                     a!93))
                     (fp.sub roundNearestTiesToEven
                             (fp.mul roundNearestTiesToEven a!109 a!109)
                             ((_ to_fp 11 53) #x3ff0000000000000)))))
(let ((a!95 (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) y0_ack!5712)
                            (fp.mul roundNearestTiesToEven
      ...
      (a!114 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!5714)
                                     a!94)))))
(let ((a!112 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             a!101
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x40018d292a5d3212)
                                     a!92))
                     a!111)))
(let ((a!113 (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x4024000000000000)
                     (fp.add roundNearestTiesToEven
                             ((_ to_fp 11 53) y1_ack!5713)
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!5714)
                                     a!112)))))
(let ((a!115 (fp.sub roundNearestTiesToEven
                     a!95
                     (fp.mul roundNearestTiesToEven
                             a!113
                             (fp.sub roundNearestTiesToEven
                                     a!114
                                     ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #xbfce7a5f94e7938d a!115)))))))))))))))))))))))))))))))))))
