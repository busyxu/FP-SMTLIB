...
(declare-fun t1_ack!5504 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5506 () (_ BitVec 64))
(declare-fun h_ack!5507 () (_ BitVec 64))
(declare-fun y0_ack!5505 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5504)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5506))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5505)
                                   ((_ to_fp 11 53) y0_ack!5505))
...
(let ((a!132 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    y0_ack!5505
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5507) a!132))))))))))))))))))))))))))))))))))))))
