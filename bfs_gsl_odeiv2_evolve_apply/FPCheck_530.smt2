(declare-fun t_ack!2503 () (_ BitVec 64))
(declare-fun t1_ack!2504 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2506 () (_ BitVec 64))
(declare-fun h_ack!2507 () (_ BitVec 64))
(declare-fun y0_ack!2505 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2504)
                    ((_ to_fp 11 53) t_ack!2503))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2506))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2505)
                                   ((_ to_fp 11 53) y0_ack!2505))
