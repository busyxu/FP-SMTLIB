(declare-fun t_ack!3824 () (_ BitVec 64))
(declare-fun t1_ack!3825 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y0_ack!3826 () (_ BitVec 64))
(declare-fun y1_ack!3827 () (_ BitVec 64))
(declare-fun h_ack!3828 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3825)
                    ((_ to_fp 11 53) t_ack!3824))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3827))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3826)
                                   ((_ to_fp 11 53) y0_ack!3826))
