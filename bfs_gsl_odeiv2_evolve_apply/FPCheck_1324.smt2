(declare-fun t_ack!6362 () (_ BitVec 64))
(declare-fun t1_ack!6363 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6365 () (_ BitVec 64))
(declare-fun h_ack!6366 () (_ BitVec 64))
(declare-fun y0_ack!6364 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6363)
                    ((_ to_fp 11 53) t_ack!6362))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6365))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6364)
                                   ((_ to_fp 11 53) y0_ack!6364))
...
(let ((a!139 (fp.add roundNearestTiesToEven
                     ...
                     (fp.mul roundNearestTiesToEven
                             ...
                             (fp.add roundNearestTiesToEven
                                     ((_ to_fp 11 53) y1_ack!6365)
                                     a!138)))))
  (FPCHECK_FSUB_OVERFLOW (fp.add roundNearestTiesToEven a!92 a!110) a!139)))))))))))))))))))))))))))))))))))))
