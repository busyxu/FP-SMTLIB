(declare-fun t_ack!3414 () (_ BitVec 64))
(declare-fun t1_ack!3415 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3417 () (_ BitVec 64))
(declare-fun h_ack!3418 () (_ BitVec 64))
(declare-fun y0_ack!3416 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3415)
                    ((_ to_fp 11 53) t_ack!3414))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3417))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3416)
                                   ((_ to_fp 11 53) y0_ack!3416))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xc02abe3f2cbe1d36
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3417) a!56)))))))))))))))))))))))))
