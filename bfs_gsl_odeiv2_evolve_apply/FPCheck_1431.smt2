(declare-fun t_ack!6891 () (_ BitVec 64))
(declare-fun t1_ack!6892 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6893 () (_ BitVec 64))
(declare-fun y1_ack!6894 () (_ BitVec 64))
(declare-fun h_ack!6895 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6892)
                    ((_ to_fp 11 53) t_ack!6891))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6894))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6893)
                                   ((_ to_fp 11 53) y0_ack!6893))
...
(let ((a!152 (fp.sub roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!122))
                     a!151)))
  (FPCHECK_FMUL_ACCURACY h_ack!6895 a!152))))))))))))))))))))))))))))))))))))))))
