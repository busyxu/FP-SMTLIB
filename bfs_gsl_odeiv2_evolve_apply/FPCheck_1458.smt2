(declare-fun t_ack!7020 () (_ BitVec 64))
(declare-fun t1_ack!7021 () (_ BitVec 64))
(declare-fun y0_ack!7022 () (_ BitVec 64))
(declare-fun y1_ack!7023 () (_ BitVec 64))
(declare-fun h_ack!7024 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7021)
                    ((_ to_fp 11 53) t_ack!7020))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7023))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7022)
                                   ((_ to_fp 11 53) y0_ack!7022))
...
(let ((a!145 (fp.abs (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!7024)
                                     a!144)))))
  (FPCHECK_FMUL_ACCURACY #x3ff0000000000000 a!145))))))))))))))))))))))))))))))))))))))))
