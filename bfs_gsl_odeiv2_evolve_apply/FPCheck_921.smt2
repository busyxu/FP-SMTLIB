...
(declare-fun t1_ack!4396 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4397 () (_ BitVec 64))
(declare-fun y1_ack!4398 () (_ BitVec 64))
(declare-fun h_ack!4399 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4396)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4398))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4397)
                                   ((_ to_fp 11 53) y0_ack!4397))
...
(let ((a!103 (fp.add roundNearestTiesToEven
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ...
                                     a!85))
                     a!102)))
  (FPCHECK_FMUL_OVERFLOW h_ack!4399 a!103)))))))))))))))))))))))))))))))))
