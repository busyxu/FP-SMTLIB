(declare-fun t_ack!3799 () (_ BitVec 64))
(declare-fun t1_ack!3800 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3802 () (_ BitVec 64))
(declare-fun h_ack!3803 () (_ BitVec 64))
(declare-fun y0_ack!3801 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3800)
                    ((_ to_fp 11 53) t_ack!3799))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3802))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3801)
                                   ((_ to_fp 11 53) y0_ack!3801))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3802) a!86)))))))))))))))))))))))))))))))
