(declare-fun t_ack!3132 () (_ BitVec 64))
(declare-fun t1_ack!3133 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3134 () (_ BitVec 64))
(declare-fun y1_ack!3135 () (_ BitVec 64))
(declare-fun h_ack!3136 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3133)
                    ((_ to_fp 11 53) t_ack!3132))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    y1_ack!3135
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3136) a!69))))))))))))))))))))))))))))
