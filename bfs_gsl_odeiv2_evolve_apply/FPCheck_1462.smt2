(declare-fun t_ack!7040 () (_ BitVec 64))
(declare-fun t1_ack!7041 () (_ BitVec 64))
(declare-fun y0_ack!7042 () (_ BitVec 64))
(declare-fun y1_ack!7043 () (_ BitVec 64))
(declare-fun h_ack!7044 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7041)
                    ((_ to_fp 11 53) t_ack!7040))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7043))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7042)
                                   ((_ to_fp 11 53) y0_ack!7042))
...
(let ((a!156 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x0000000000000000
    (fp.abs (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!7044) a!156)))))))))))))))))))))))))))))))))))))))))))
