(declare-fun t_ack!2142 () (_ BitVec 64))
(declare-fun t1_ack!2143 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2144 () (_ BitVec 64))
(declare-fun y1_ack!2145 () (_ BitVec 64))
(declare-fun h_ack!2146 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2143)
                    ((_ to_fp 11 53) t_ack!2142))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2145))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2144)
                                   ((_ to_fp 11 53) y0_ack!2144))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2145)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2146) a!43)))))))))))))))))))))))
