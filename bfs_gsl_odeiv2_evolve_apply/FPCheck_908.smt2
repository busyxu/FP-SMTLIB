(declare-fun t_ack!4330 () (_ BitVec 64))
(declare-fun t1_ack!4331 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4332 () (_ BitVec 64))
(declare-fun y1_ack!4333 () (_ BitVec 64))
(declare-fun h_ack!4334 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4331)
                    ((_ to_fp 11 53) t_ack!4330))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4333))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4332)
                                   ((_ to_fp 11 53) y0_ack!4332))
