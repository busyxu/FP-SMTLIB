(declare-fun t_ack!2785 () (_ BitVec 64))
(declare-fun t1_ack!2786 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!2787 () (_ BitVec 64))
(declare-fun y1_ack!2788 () (_ BitVec 64))
(declare-fun h_ack!2789 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2786)
                    ((_ to_fp 11 53) t_ack!2785))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2788))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2787)
                                   ((_ to_fp 11 53) y0_ack!2787))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2788)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2789) a!26)))))))))))))))))
