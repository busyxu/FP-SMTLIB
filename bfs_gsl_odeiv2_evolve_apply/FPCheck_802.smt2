(declare-fun t_ack!3809 () (_ BitVec 64))
(declare-fun t1_ack!3810 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3811 () (_ BitVec 64))
(declare-fun y1_ack!3812 () (_ BitVec 64))
(declare-fun h_ack!3813 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3810)
                    ((_ to_fp 11 53) t_ack!3809))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3812))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3811)
                                   ((_ to_fp 11 53) y0_ack!3811))
...
(let ((a!77 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW a!77 a!77)))))))))))))))))))))))))))))
