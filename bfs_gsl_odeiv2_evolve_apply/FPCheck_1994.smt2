(declare-fun t_ack!12078 () (_ BitVec 64))
(declare-fun t1_ack!12079 () (_ BitVec 64))
(declare-fun h_ack!12082 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!12081 () (_ BitVec 64))
(declare-fun y0_ack!12080 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!12079)
                    ((_ to_fp 11 53) t_ack!12078))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!12078))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!12082)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!12081))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!12080)
                                   ((_ to_fp 11 53) y0_ack!12080))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fee1c165324ef0a
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!12081) a!34)))))))))))))))))))
