(declare-fun t_ack!6940 () (_ BitVec 64))
(declare-fun t1_ack!6941 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6942 () (_ BitVec 64))
(declare-fun y1_ack!6943 () (_ BitVec 64))
(declare-fun h_ack!6944 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6941)
                    ((_ to_fp 11 53) t_ack!6940))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6943))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6942)
                                   ((_ to_fp 11 53) y0_ack!6942))
...
(let ((a!145 (fp.mul roundNearestTiesToEven
                     ...
                     (fp.add roundNearestTiesToEven
                             ...
                             (fp.mul roundNearestTiesToEven
                                     ((_ to_fp 11 53) h_ack!6944)
                                     a!144)))))
  (FPCHECK_FMUL_UNDERFLOW #x0000000000000000 (fp.abs a!145)))))))))))))))))))))))))))))))))))))))))
