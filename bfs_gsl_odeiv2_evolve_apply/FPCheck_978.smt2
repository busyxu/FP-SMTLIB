(declare-fun t_ack!4668 () (_ BitVec 64))
(declare-fun t1_ack!4669 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4670 () (_ BitVec 64))
(declare-fun y1_ack!4671 () (_ BitVec 64))
(declare-fun h_ack!4672 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4669)
                    ((_ to_fp 11 53) t_ack!4668))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4671))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4670)
                                   ((_ to_fp 11 53) y0_ack!4670))
...
(let ((a!48 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4672)
                                    a!47)))))
  (FPCHECK_FADD_OVERFLOW a!38 a!48))))))))))))))))))))))
