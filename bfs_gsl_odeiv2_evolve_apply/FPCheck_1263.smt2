...
(declare-fun t1_ack!6064 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!6066 () (_ BitVec 64))
(declare-fun h_ack!6067 () (_ BitVec 64))
(declare-fun y0_ack!6065 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6064)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6066))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6065)
                                   ((_ to_fp 11 53) y0_ack!6065))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fc43f7cc8023f22
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6066) a!86)))))))))))))))))))))))))))))))
