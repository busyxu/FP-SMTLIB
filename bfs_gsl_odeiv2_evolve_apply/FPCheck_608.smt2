(declare-fun t_ack!2875 () (_ BitVec 64))
(declare-fun t1_ack!2876 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2876)
                    ((_ to_fp 11 53) t_ack!2875))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fbfadbee9f5b0f4
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2878) a!56)))))))))))))))))))))))))
