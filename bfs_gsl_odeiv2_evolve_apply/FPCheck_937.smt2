...
(declare-fun t1_ack!4470 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4472 () (_ BitVec 64))
(declare-fun h_ack!4473 () (_ BitVec 64))
(declare-fun y0_ack!4471 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4470)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4472))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4471)
                                   ((_ to_fp 11 53) y0_ack!4471))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4471)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4473) a!94))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4471)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4473) a!94)))))))))))))))))))))))))))))))))
