(declare-fun t_ack!2162 () (_ BitVec 64))
(declare-fun t1_ack!2163 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2165 () (_ BitVec 64))
(declare-fun h_ack!2166 () (_ BitVec 64))
(declare-fun y0_ack!2164 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2163)
                    ((_ to_fp 11 53) t_ack!2162))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2165))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2164)
                                   ((_ to_fp 11 53) y0_ack!2164))
...
(let ((a!38 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!2164)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2166) a!38))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!2164)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2166) a!38)))))))))))))))))))))
