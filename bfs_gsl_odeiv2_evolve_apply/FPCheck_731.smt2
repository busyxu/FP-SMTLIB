(declare-fun t_ack!3469 () (_ BitVec 64))
(declare-fun t1_ack!3470 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3471 () (_ BitVec 64))
(declare-fun y1_ack!3472 () (_ BitVec 64))
(declare-fun h_ack!3473 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3470)
                    ((_ to_fp 11 53) t_ack!3469))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3472))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3471)
                                   ((_ to_fp 11 53) y0_ack!3471))
