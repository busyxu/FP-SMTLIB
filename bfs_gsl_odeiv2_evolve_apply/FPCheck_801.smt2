(declare-fun t_ack!3804 () (_ BitVec 64))
(declare-fun t1_ack!3805 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3806 () (_ BitVec 64))
(declare-fun y1_ack!3807 () (_ BitVec 64))
(declare-fun h_ack!3808 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3805)
                    ((_ to_fp 11 53) t_ack!3804))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3807))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3806)
                                   ((_ to_fp 11 53) y0_ack!3806))
...
(let ((a!77 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!77 a!77)))))))))))))))))))))))))))))
