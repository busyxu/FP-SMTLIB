...
(declare-fun y1_ack!2259 () (_ BitVec 64))
(declare-fun h_ack!2260 () (_ BitVec 64))
(declare-fun y0_ack!2258 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2259))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2258)
                                   ((_ to_fp 11 53) y0_ack!2258))
...
(let ((a!19 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!2259)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!2260) a!19))))))))))))))
