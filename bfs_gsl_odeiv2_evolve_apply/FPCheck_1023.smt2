(declare-fun t_ack!4890 () (_ BitVec 64))
(declare-fun t1_ack!4891 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4892 () (_ BitVec 64))
(declare-fun y1_ack!4893 () (_ BitVec 64))
(declare-fun h_ack!4894 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4891)
                    ((_ to_fp 11 53) t_ack!4890))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4893))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4892)
                                   ((_ to_fp 11 53) y0_ack!4892))
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!18))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfe83e70bcbd3e65) a!25)))))))))))))))
