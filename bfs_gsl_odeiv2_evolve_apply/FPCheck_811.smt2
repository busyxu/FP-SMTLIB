(declare-fun t_ack!3854 () (_ BitVec 64))
(declare-fun t1_ack!3855 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3856 () (_ BitVec 64))
(declare-fun y1_ack!3857 () (_ BitVec 64))
(declare-fun h_ack!3858 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3855)
                    ((_ to_fp 11 53) t_ack!3854))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3857))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3856)
                                   ((_ to_fp 11 53) y0_ack!3856))
...
(let ((a!95 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x8000000000000000) a!77)
    a!95)))))))))))))))))))))))))))))))
