...
(declare-fun t1_ack!3747 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3749 () (_ BitVec 64))
(declare-fun h_ack!3750 () (_ BitVec 64))
(declare-fun y0_ack!3748 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3747)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3749))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3748)
                                   ((_ to_fp 11 53) y0_ack!3748))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!85)))))
  (FPCHECK_FADD_UNDERFLOW y1_ack!3749 a!86))))))))))))))))))))))))))))))
