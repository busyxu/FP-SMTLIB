(declare-fun t_ack!5229 () (_ BitVec 64))
(declare-fun t1_ack!5230 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5231 () (_ BitVec 64))
(declare-fun y1_ack!5232 () (_ BitVec 64))
(declare-fun h_ack!5233 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5230)
                    ((_ to_fp 11 53) t_ack!5229))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5232))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5231)
                                   ((_ to_fp 11 53) y0_ack!5231))
...
(let ((a!135 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x8000000000000000) a!113)
    a!135)))))))))))))))))))))))))))))))))))))
