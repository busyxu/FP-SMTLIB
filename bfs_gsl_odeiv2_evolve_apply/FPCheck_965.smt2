(declare-fun t_ack!4603 () (_ BitVec 64))
(declare-fun t1_ack!4604 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4605 () (_ BitVec 64))
(declare-fun y1_ack!4606 () (_ BitVec 64))
(declare-fun h_ack!4607 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4604)
                    ((_ to_fp 11 53) t_ack!4603))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4606))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4605)
                                   ((_ to_fp 11 53) y0_ack!4605))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4606)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4607) a!26)))))))))))))))))
