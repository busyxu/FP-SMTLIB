...
(declare-fun t1_ack!4465 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4467 () (_ BitVec 64))
(declare-fun h_ack!4468 () (_ BitVec 64))
(declare-fun y0_ack!4466 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4465)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4467))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4466)
                                   ((_ to_fp 11 53) y0_ack!4466))
...
(let ((a!94 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4466)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4468) a!94))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!4466)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4468) a!94)))))))))))))))))))))))))))))))))
