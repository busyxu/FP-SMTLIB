(declare-fun t_ack!4728 () (_ BitVec 64))
(declare-fun t1_ack!4729 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4730 () (_ BitVec 64))
(declare-fun y1_ack!4731 () (_ BitVec 64))
(declare-fun h_ack!4732 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4729)
                    ((_ to_fp 11 53) t_ack!4728))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4731))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4730)
                                   ((_ to_fp 11 53) y0_ack!4730))
