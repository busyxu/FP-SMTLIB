(declare-fun t_ack!7050 () (_ BitVec 64))
(declare-fun t1_ack!7051 () (_ BitVec 64))
(declare-fun y0_ack!7052 () (_ BitVec 64))
(declare-fun y1_ack!7053 () (_ BitVec 64))
(declare-fun h_ack!7054 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!7051)
                    ((_ to_fp 11 53) t_ack!7050))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!7053))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!7052)
                                   ((_ to_fp 11 53) y0_ack!7052))
...
(let ((a!158 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!145)
    a!158))))))))))))))))))))))))))))))))))))))))))
