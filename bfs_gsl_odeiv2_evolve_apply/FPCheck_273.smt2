(declare-fun t_ack!1281 () (_ BitVec 64))
(declare-fun t1_ack!1282 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!1283 () (_ BitVec 64))
(declare-fun y1_ack!1284 () (_ BitVec 64))
(declare-fun h_ack!1285 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1282)
                    ((_ to_fp 11 53) t_ack!1281))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1284))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1283)
                                   ((_ to_fp 11 53) y0_ack!1283))
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!25))))
  (FPCHECK_FMUL_OVERFLOW h_ack!1285 a!26)))))))))))))))
