(declare-fun t_ack!6856 () (_ BitVec 64))
(declare-fun t1_ack!6857 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6859 () (_ BitVec 64))
(declare-fun h_ack!6860 () (_ BitVec 64))
(declare-fun y0_ack!6858 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6857)
                    ((_ to_fp 11 53) t_ack!6856))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6859))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6858)
                                   ((_ to_fp 11 53) y0_ack!6858))
...
(let ((a!122 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!102
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fa6c16c16c16c17) a!122))))))))))))))))))))))))))))))))))))
