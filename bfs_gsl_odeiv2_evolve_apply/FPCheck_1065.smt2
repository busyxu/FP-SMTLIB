(declare-fun t_ack!5100 () (_ BitVec 64))
(declare-fun t1_ack!5101 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5103 () (_ BitVec 64))
(declare-fun h_ack!5104 () (_ BitVec 64))
(declare-fun y0_ack!5102 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5101)
                    ((_ to_fp 11 53) t_ack!5100))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5103))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5102)
                                   ((_ to_fp 11 53) y0_ack!5102))
...
(let ((a!123 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!103
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x0000000000000000) a!123))))))))))))))))))))))))))))))))))))
