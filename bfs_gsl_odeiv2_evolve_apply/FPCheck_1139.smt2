(declare-fun t_ack!5458 () (_ BitVec 64))
(declare-fun t1_ack!5459 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5461 () (_ BitVec 64))
(declare-fun h_ack!5462 () (_ BitVec 64))
(declare-fun y0_ack!5460 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5459)
                    ((_ to_fp 11 53) t_ack!5458))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5461))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5460)
                                   ((_ to_fp 11 53) y0_ack!5460))
...
(let ((a!124 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fd0000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5461) a!124)))))))))))))))))))))))))))))))))))))
