(declare-fun t_ack!4733 () (_ BitVec 64))
(declare-fun t1_ack!4734 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4735 () (_ BitVec 64))
(declare-fun y1_ack!4736 () (_ BitVec 64))
(declare-fun h_ack!4737 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4734)
                    ((_ to_fp 11 53) t_ack!4733))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4736))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4735)
                                   ((_ to_fp 11 53) y0_ack!4735))
...
(let ((a!76 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!4737)
                                    a!75)))))
  (FPCHECK_FADD_UNDERFLOW a!62 a!76))))))))))))))))))))))))))))
