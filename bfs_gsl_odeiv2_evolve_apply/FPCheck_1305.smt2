(declare-fun t_ack!6267 () (_ BitVec 64))
(declare-fun t1_ack!6268 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!6270 () (_ BitVec 64))
(declare-fun h_ack!6271 () (_ BitVec 64))
(declare-fun y0_ack!6269 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!6268)
                    ((_ to_fp 11 53) t_ack!6267))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6270))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6269)
                                   ((_ to_fp 11 53) y0_ack!6269))
...
(let ((a!59 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!6270) a!59))))))))))))))))))))))))))
