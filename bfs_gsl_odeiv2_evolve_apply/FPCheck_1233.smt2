(declare-fun t_ack!5913 () (_ BitVec 64))
(declare-fun t1_ack!5914 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5915 () (_ BitVec 64))
(declare-fun y1_ack!5916 () (_ BitVec 64))
(declare-fun h_ack!5917 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5914)
                    ((_ to_fp 11 53) t_ack!5913))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5916))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5915)
                                   ((_ to_fp 11 53) y0_ack!5915))
...
(let ((a!26 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!5916)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!5917) a!26)))))))))))))))))
