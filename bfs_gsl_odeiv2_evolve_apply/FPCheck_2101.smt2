(declare-fun t_ack!13140 () (_ BitVec 64))
(declare-fun t1_ack!13141 () (_ BitVec 64))
(declare-fun h_ack!13144 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!13142 () (_ BitVec 64))
(declare-fun y1_ack!13143 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!13141)
                    ((_ to_fp 11 53) t_ack!13140))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!13140))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!13144)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!13143))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!13142)
                                   ((_ to_fp 11 53) y0_ack!13142))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!13143)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!13144) a!43)))))))))))))))))))))))
