(declare-fun t_ack!2316 () (_ BitVec 64))
(declare-fun t1_ack!2317 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2319 () (_ BitVec 64))
(declare-fun h_ack!2320 () (_ BitVec 64))
(declare-fun y0_ack!2318 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2317)
                    ((_ to_fp 11 53) t_ack!2316))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2319))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2318)
                                   ((_ to_fp 11 53) y0_ack!2318))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fee1c165324ef0a
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2319) a!34)))))))))))))))))))
