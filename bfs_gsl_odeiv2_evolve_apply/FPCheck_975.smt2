(declare-fun t_ack!4653 () (_ BitVec 64))
(declare-fun t1_ack!4654 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4655 () (_ BitVec 64))
(declare-fun y1_ack!4656 () (_ BitVec 64))
(declare-fun h_ack!4657 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4654)
                    ((_ to_fp 11 53) t_ack!4653))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4656))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4655)
                                   ((_ to_fp 11 53) y0_ack!4655))
...
(let ((a!43 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y1_ack!4656)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!4657) a!43)))))))))))))))))))))))
