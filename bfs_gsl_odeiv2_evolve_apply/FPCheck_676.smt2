(declare-fun t_ack!3200 () (_ BitVec 64))
(declare-fun t1_ack!3201 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3203 () (_ BitVec 64))
(declare-fun h_ack!3204 () (_ BitVec 64))
(declare-fun y0_ack!3202 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3201)
                    ((_ to_fp 11 53) t_ack!3200))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3203))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3202)
                                   ((_ to_fp 11 53) y0_ack!3202))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3202)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3204) a!62))
    (fp.add roundNearestTiesToEven
            ((_ to_fp 11 53) y0_ack!3202)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) h_ack!3204) a!62)))))))))))))))))))))))))))
