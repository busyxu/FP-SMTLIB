(declare-fun t_ack!13221 () (_ BitVec 64))
(declare-fun t1_ack!13222 () (_ BitVec 64))
(declare-fun h_ack!13225 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!13224 () (_ BitVec 64))
(declare-fun y0_ack!13223 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!13222)
                    ((_ to_fp 11 53) t_ack!13221))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!13221))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!13225)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!13224))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!13223)
                                   ((_ to_fp 11 53) y0_ack!13223))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fbfadbee9f5b0f4
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!13224) a!56)))))))))))))))))))))))))
