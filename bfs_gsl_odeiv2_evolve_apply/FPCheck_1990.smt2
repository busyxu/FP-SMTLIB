(declare-fun t_ack!12040 () (_ BitVec 64))
(declare-fun t1_ack!12041 () (_ BitVec 64))
(declare-fun h_ack!12044 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!12042 () (_ BitVec 64))
(declare-fun y1_ack!12043 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!12041)
                    ((_ to_fp 11 53) t_ack!12040))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) t_ack!12040))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) h_ack!12044)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!12043))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!12042)
                                   ((_ to_fp 11 53) y0_ack!12042))
...
(let ((a!29 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!12044)
                                    a!28)))))
  (FPCHECK_FADD_OVERFLOW (fp.add roundNearestTiesToEven a!14 a!21) a!29))))))))))))))))
