(declare-fun t_ack!972 () (_ BitVec 64))
(declare-fun t1_ack!973 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!975 () (_ BitVec 64))
(declare-fun h_ack!976 () (_ BitVec 64))
(declare-fun y0_ack!974 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!973)
                    ((_ to_fp 11 53) t_ack!972))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!975))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!974)
                                   ((_ to_fp 11 53) y0_ack!974))
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!18))))
  (FPCHECK_FMUL_OVERFLOW h_ack!976 a!19))))))))))))
