...
(declare-fun t1_ack!4084 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4086 () (_ BitVec 64))
(declare-fun h_ack!4087 () (_ BitVec 64))
(declare-fun y0_ack!4085 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4084)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4086))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4085)
                                   ((_ to_fp 11 53) y0_ack!4085))
...
(let ((a!86 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3fc13b7d81af1344
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4086) a!86)))))))))))))))))))))))))))))))
