...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!322) ((_ to_fp 11 53) #xc010000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!322) ((_ to_fp 11 53) #xc000000000000000)))
(assert (= #x00000000 (bvand b_ack!321 #x00000007)))
