...
(assert (fp.lt ((_ to_fp 11 53) a_ack!411) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (fp.leq ((_ to_fp 11 53) a_ack!411) ((_ to_fp 11 53) #xc010000000000000)))
(assert (= #x00000000 (bvand b_ack!410 #x00000007)))
