...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3273) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3273) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) #x3ff8000000000000) ((_ to_fp 11 53) b_ack!3272))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3272) ((_ to_fp 11 53) #x3ff0000000000000)))
