...
(assert (fp.gt ((_ to_fp 11 53) a_ack!114) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!114))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!114)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!114)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!114)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113)))))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!113))))))
