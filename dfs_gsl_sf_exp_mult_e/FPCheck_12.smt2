...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!47)) ((_ to_fp 11 53) #x2003333333333333)))
(assert (FPCHECK_FADD_ACCURACY #x4000000000000000 (fp.abs ((_ to_fp 11 53) a_ack!48))))
