...
(assert (fp.gt ((_ to_fp 11 53) a_ack!122) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!121))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!122)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!122))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!122)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!122)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!122)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121)))))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121)))))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.abs a!2))
         a!1)))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!121))))))
  (FPCHECK_FADD_OVERFLOW (CF_floor a_ack!122) a!1)))
