...
(assert (= #x00000000 (bvsrem n_ack!343 #x00000002)))
...
(assert (not (= #x00000001 n_ack!343)))
(assert (not (= #x00000002 n_ack!343)))
(assert (not (= #x00000003 n_ack!343)))
(assert (bvslt n_ack!343 #x00000046))
