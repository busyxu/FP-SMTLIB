...
(assert (not (bvslt n_ack!539 #x00000001)))
(assert (not (= #x00000001 n_ack!539)))
(assert (not (= #x00000002 n_ack!539)))
(assert (not (= #x00000003 n_ack!539)))
(assert (bvslt n_ack!539 #x00000046))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #xffffffff n_ack!539))))))
