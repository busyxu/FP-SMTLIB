...
(assert (= #x00000000 (bvsrem n_ack!39 #x00000002)))
(assert (not (= #x00000000 n_ack!39)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!40) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt n_ack!39 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!40) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt n_ack!39 #x00000001)))
(assert (= #x00000002 n_ack!39))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!40) ((_ to_fp 11 53) #x4014000000000000))))
