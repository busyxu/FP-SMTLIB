...
(assert (= #x00000000 (bvsrem n_ack!439 #x00000002)))
...
(assert (not (= #x00000001 n_ack!439)))
(assert (not (= #x00000002 n_ack!439)))
(assert (not (= #x00000003 n_ack!439)))
(assert (bvslt n_ack!439 #x00000046))
