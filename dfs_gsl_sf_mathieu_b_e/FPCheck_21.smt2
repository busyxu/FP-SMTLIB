...
(assert (fp.leq ((_ to_fp 11 53) a_ack!90) ((_ to_fp 11 53) #x4014000000000000)))
(assert (not (bvslt #x00000000 (bvadd #xffffffff (bvsdiv n_ack!89 #x00000002)))))
(assert (FPCHECK_FADD_UNDERFLOW
  #x0000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvmul n_ack!89 n_ack!89))))
