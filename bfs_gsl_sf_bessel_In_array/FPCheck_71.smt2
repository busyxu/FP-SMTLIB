...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!285))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!284 a_ack!286)))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!285))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) c_ack!285))
                          (fp.abs ((_ to_fp 11 53) c_ack!285)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!285)))
