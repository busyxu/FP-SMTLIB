...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!192))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!192))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) c_ack!192))
                          (fp.abs ((_ to_fp 11 53) c_ack!192)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!192)))
                   ((_ to_fp 11 53) #x407ea00000000000))))
  (FPCHECK_FDIV_OVERFLOW a!1 #x7ff0000000000001)))
