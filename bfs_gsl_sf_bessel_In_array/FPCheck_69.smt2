...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!279))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!279))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) c_ack!279))
                          (fp.abs ((_ to_fp 11 53) c_ack!279)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!279)))
