...
(declare-fun b_ack!197 () (_ BitVec 32))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!198))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!197 a_ack!199)))
(assert (not (bvslt a_ack!199 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!198) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!197)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!198))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) c_ack!198))
                          (fp.abs ((_ to_fp 11 53) c_ack!198)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!198)))
