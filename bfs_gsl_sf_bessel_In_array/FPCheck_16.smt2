...
(assert (= #x00000000 b_ack!107))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!108))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!108))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!108))
             ((_ to_fp 11 53) #x4020000000000000))))
(assert (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!108))
