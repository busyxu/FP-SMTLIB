...
(assert (not (bvslt b_ack!233 a_ack!235)))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!234))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!234)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x4028000000000000) a!1)
    a!1)))
