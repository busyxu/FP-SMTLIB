...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1181) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.mul roundNearestTiesToEven a!2 a!1))
         ((_ to_fp 11 53) #x3feffffffffff950)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1180))
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    a!12
                                    ((_ to_fp 11 53) b_ack!1180))))))
  (fp.eq a!13 (fp.mul roundNearestTiesToEven a!12 ((_ to_fp 11 53) b_ack!1180)))))))))
(assert (FPCHECK_FMUL_OVERFLOW b_ack!1180 b_ack!1180))
