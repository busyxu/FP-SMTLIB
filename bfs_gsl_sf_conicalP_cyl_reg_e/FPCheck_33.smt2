...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!135) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!136 #xffffffff)))
...
(assert (fp.lt ((_ to_fp 11 53) c_ack!135) ((_ to_fp 11 53) #x3ff0000000000000)))
