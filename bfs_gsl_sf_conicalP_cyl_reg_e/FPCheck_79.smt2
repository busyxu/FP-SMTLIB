...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!338) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!337) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!338) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (not (fp.gt ((_ to_fp 11 53) #x3ff0000000000000)
              (fp.div roundNearestTiesToEven
                      ((_ to_fp 11 53) #x3ff0000000000000)
                      a!1)))))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 c_ack!338))
