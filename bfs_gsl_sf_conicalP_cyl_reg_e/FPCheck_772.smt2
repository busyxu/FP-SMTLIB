(declare-fun c_ack!3201 () (_ BitVec 64))
(declare-fun a_ack!3202 () (_ BitVec 32))
(declare-fun b_ack!3200 () (_ BitVec 64))
(declare-fun CF_acos ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3202 #xffffffff)))
(assert (not (= #xffffffff a_ack!3202)))
(assert (= #x00000000 a_ack!3202))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x408f400000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3fb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3ff8000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) #x3ff8000000000000) ((_ to_fp 11 53) c_ack!3201))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!3201) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!22 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven (fp.abs a!22) (fp.abs a!21))
    #x3f120fa37899a1b5))))))))))))))))))))))))
