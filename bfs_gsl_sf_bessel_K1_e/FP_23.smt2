...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!209) ((_ to_fp 11 53) #x0020000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!209) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3ee845c8e2e1423a)
                         a!2)
                 ((_ to_fp 11 53) #x3ee845c8e2e1423a))
         a!2))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
