...
(assert (bvsle #x00000001 a_ack!142))
(assert (bvsle #x00000002 a_ack!142))
(assert (bvsle #x00000003 a_ack!142))
(assert (FPCHECK_FDIV_OVERFLOW b_ack!141 #x4008000000000000))
