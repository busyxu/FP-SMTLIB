...
(assert (bvsle #x00000002 a_ack!320))
(assert (bvsle #x00000003 a_ack!320))
(assert (bvsle #x00000004 a_ack!320))
(assert (bvsle #x00000005 a_ack!320))
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!3 a!2)))))
(assert (bvsle #x00000006 a_ack!320))
(assert (bvsle #x00000007 a_ack!320))
(assert (bvsle #x00000008 a_ack!320))
(assert (not (bvsle #x00000009 a_ack!320)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           (fp.div roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.abs a!4) ((_ to_fp 11 53) #x0010000000000000)))))))
