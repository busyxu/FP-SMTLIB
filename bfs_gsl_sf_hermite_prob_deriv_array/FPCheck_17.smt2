...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!150))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!149))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!150))
       (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) #x7feccccccccccccc)
               (fp.abs ((_ to_fp 11 53) c_ack!150)))))
(assert (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) c_ack!150)) #x3cb0000000000000))
