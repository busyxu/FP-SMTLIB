...
(assert (not (= #x00000000 b_ack!2218)))
(assert (not (= #x00000001 b_ack!2218)))
...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2219))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!2218))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2219))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!2219))))))
  (not a!1)))
(assert (not (bvslt #x00000002 b_ack!2218)))
