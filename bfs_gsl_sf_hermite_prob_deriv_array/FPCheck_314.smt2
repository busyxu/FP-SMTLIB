...
(assert (= #x00000000 a_ack!2064))
(assert (not (bvslt b_ack!2062 #x00000000)))
(assert (not (= #x00000000 b_ack!2062)))
(assert (not (= #x00000001 b_ack!2062)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2063) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2063))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 b_ack!2062))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2063))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 b_ack!2062))
...
(assert (not (bvslt #x00000003 b_ack!2062)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) c_ack!2063))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!2063))
