...
(assert (not (= #x00000001 b_ack!1315)))
...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1316))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!1315))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1316))
