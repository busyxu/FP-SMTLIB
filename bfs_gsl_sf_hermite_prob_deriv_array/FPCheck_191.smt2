...
(assert (not (= #x00000000 b_ack!1237)))
(assert (not (= #x00000001 b_ack!1237)))
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1238))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 b_ack!1237))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1238))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (not (bvslt #x00000002 b_ack!1237)))
