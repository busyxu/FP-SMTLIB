...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!473))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!473))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!474))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!474))
       (fp.abs ((_ to_fp 11 53) c_ack!473))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!474))
            (fp.abs ((_ to_fp 11 53) c_ack!473)))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!473))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_ACCURACY b_ack!472 c_ack!473))
