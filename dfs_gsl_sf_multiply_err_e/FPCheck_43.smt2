...
(declare-fun d_ack!257 () (_ BitVec 64))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!256))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!256))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!258))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_OVERFLOW d_ack!257 a_ack!258))
