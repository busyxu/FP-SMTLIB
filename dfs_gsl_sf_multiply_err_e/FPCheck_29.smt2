...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!152))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!152))
        ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) a_ack!154))
       ((_ to_fp 11 53) c_ack!152)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!152))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) a_ack!154)
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_UNDERFLOW d_ack!153 a_ack!154))
