...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!897))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!895))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!897))
            (fp.abs ((_ to_fp 11 53) c_ack!895)))))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!897))
       (fp.abs ((_ to_fp 11 53) c_ack!895))))
