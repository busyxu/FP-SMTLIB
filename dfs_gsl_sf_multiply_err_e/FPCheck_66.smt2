...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(declare-fun d_ack!411 () (_ BitVec 64))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!410))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!410))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!412))
        ((_ to_fp 11 53) #x3ff0000000000000)))
