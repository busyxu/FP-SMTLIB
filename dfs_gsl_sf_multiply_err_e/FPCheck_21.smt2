...
(assert (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!109))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!108))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!108))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!109))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FMUL_ACCURACY a_ack!109 c_ack!108))
