(declare-fun t_ack!4570 () (_ BitVec 64))
(declare-fun t1_ack!4567 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4567)
                                  ((_ to_fp 11 53) t_ack!4570)))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    #x8000000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4568) a!46)))))))))))))))))))))))
