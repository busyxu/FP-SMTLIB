(declare-fun t_ack!4796 () (_ BitVec 64))
(declare-fun t1_ack!4793 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4793)
                                  ((_ to_fp 11 53) t_ack!4796)))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbfd2a471c23b2d29
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4795) a!20))))))))))))
