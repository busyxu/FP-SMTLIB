(declare-fun t_ack!4690 () (_ BitVec 64))
(declare-fun t1_ack!4687 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4688 () (_ BitVec 64))
(declare-fun y1_ack!4689 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4687)
                                  ((_ to_fp 11 53) t_ack!4690)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4689))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4688)
                                   ((_ to_fp 11 53) y0_ack!4688))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.sub roundNearestTiesToEven
            ((_ to_fp 11 53) #x8000000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4688) a!46))
    a!56))))))))))))))))))))))))
