(declare-fun t_ack!3284 () (_ BitVec 64))
(declare-fun t1_ack!3281 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3283 () (_ BitVec 64))
(declare-fun y0_ack!3282 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3281)
                                  ((_ to_fp 11 53) t_ack!3284)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3283))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3282)
                                   ((_ to_fp 11 53) y0_ack!3282))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xbfc61b7ccdaf2f38
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3283) a!34))))))))))))))))))
