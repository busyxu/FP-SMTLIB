(declare-fun t_ack!4630 () (_ BitVec 64))
(declare-fun t1_ack!4627 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4628 () (_ BitVec 64))
(declare-fun y1_ack!4629 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4627)
                                  ((_ to_fp 11 53) t_ack!4630)))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4628) a!46)
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4628) a!46)))))))))))))))))))))))
