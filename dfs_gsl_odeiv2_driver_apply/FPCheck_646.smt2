(declare-fun t_ack!5240 () (_ BitVec 64))
(declare-fun t1_ack!5237 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5239 () (_ BitVec 64))
(declare-fun y0_ack!5238 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5237)
                                  ((_ to_fp 11 53) t_ack!5240)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5239))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5238)
                                   ((_ to_fp 11 53) y0_ack!5238))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
