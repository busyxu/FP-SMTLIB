(declare-fun t_ack!5940 () (_ BitVec 64))
(declare-fun t1_ack!5937 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5938 () (_ BitVec 64))
(declare-fun y1_ack!5939 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5937)
                                  ((_ to_fp 11 53) t_ack!5940)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5939))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5938)
                                   ((_ to_fp 11 53) y0_ack!5938))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!45 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!36
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x402db2d7daa814a6) a!45))))))))))))))))))))))
