(declare-fun t_ack!6104 () (_ BitVec 64))
(declare-fun t1_ack!6101 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6102 () (_ BitVec 64))
(declare-fun y1_ack!6103 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!6101)
                                  ((_ to_fp 11 53) t_ack!6104)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6103))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6102)
                                   ((_ to_fp 11 53) y0_ack!6102))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!66 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!65)))))
  (FPCHECK_FADD_ACCURACY y0_ack!6102 a!66))))))))))))))))))))))))))))
