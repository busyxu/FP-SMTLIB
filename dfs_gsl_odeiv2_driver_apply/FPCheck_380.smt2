(declare-fun t_ack!2994 () (_ BitVec 64))
(declare-fun t1_ack!2991 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2993 () (_ BitVec 64))
(declare-fun y0_ack!2992 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!2991)
                                  ((_ to_fp 11 53) t_ack!2994)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2993))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2992)
                                   ((_ to_fp 11 53) y0_ack!2992))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2993) a!34))))))))))))))))))
