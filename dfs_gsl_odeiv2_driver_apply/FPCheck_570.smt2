(declare-fun t_ack!4586 () (_ BitVec 64))
(declare-fun t1_ack!4583 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4583)
                                  ((_ to_fp 11 53) t_ack!4586)))
...
(let ((a!51 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4024000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4585) a!51))))))))))))))))))))))))
