(declare-fun t_ack!4176 () (_ BitVec 64))
(declare-fun t1_ack!4173 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4174 () (_ BitVec 64))
(declare-fun y1_ack!4175 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4173)
                                  ((_ to_fp 11 53) t_ack!4176)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4175))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4174)
                                   ((_ to_fp 11 53) y0_ack!4174))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!45)))))
  (FPCHECK_FADD_UNDERFLOW y0_ack!4174 a!46))))))))))))))))))))))
