(declare-fun t_ack!2908 () (_ BitVec 64))
(declare-fun t1_ack!2905 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2907 () (_ BitVec 64))
(declare-fun y0_ack!2906 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!2905)
                                  ((_ to_fp 11 53) t_ack!2908)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2907))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2906)
                                   ((_ to_fp 11 53) y0_ack!2906))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!33)))))
  (FPCHECK_FADD_UNDERFLOW y1_ack!2907 a!34)))))))))))))))))
