(declare-fun t_ack!6016 () (_ BitVec 64))
(declare-fun t1_ack!6013 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6014 () (_ BitVec 64))
(declare-fun y1_ack!6015 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!6013)
                                  ((_ to_fp 11 53) t_ack!6016)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6015))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6014)
                                   ((_ to_fp 11 53) y0_ack!6014))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
