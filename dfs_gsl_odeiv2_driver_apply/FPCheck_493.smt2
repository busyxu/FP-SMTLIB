(declare-fun t_ack!3940 () (_ BitVec 64))
(declare-fun t1_ack!3937 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3937)
                                  ((_ to_fp 11 53) t_ack!3940)))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbfc4a21f44e45fd3
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3939) a!20))))))))))))
