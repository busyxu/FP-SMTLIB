(declare-fun t_ack!3976 () (_ BitVec 64))
(declare-fun t1_ack!3973 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3975 () (_ BitVec 64))
(declare-fun y0_ack!3974 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3973)
                                  ((_ to_fp 11 53) t_ack!3976)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3975))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3974)
                                   ((_ to_fp 11 53) y0_ack!3974))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3975) a!20)))))))))))))
