(declare-fun t_ack!4952 () (_ BitVec 64))
(declare-fun t1_ack!4949 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4950 () (_ BitVec 64))
(declare-fun y1_ack!4951 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4949)
                                  ((_ to_fp 11 53) t_ack!4952)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4951))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4950)
                                   ((_ to_fp 11 53) y0_ack!4950))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
