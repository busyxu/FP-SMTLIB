(declare-fun t_ack!3196 () (_ BitVec 64))
(declare-fun t1_ack!3193 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3193)
                                  ((_ to_fp 11 53) t_ack!3196)))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fa26ba035d10b6d
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3195) a!20))))))))))))
