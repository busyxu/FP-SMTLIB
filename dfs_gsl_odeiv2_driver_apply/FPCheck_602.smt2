(declare-fun t_ack!4856 () (_ BitVec 64))
(declare-fun t1_ack!4853 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4854 () (_ BitVec 64))
(declare-fun y1_ack!4855 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4853)
                                  ((_ to_fp 11 53) t_ack!4856)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4855))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4854)
                                   ((_ to_fp 11 53) y0_ack!4854))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!4856))
                            a!27))))
  (FPCHECK_FMUL_ACCURACY #xbf9b1bbe5082a5c1 a!28)))))))))))))))
