(declare-fun t_ack!5538 () (_ BitVec 64))
(declare-fun t1_ack!5535 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5537 () (_ BitVec 64))
(declare-fun y0_ack!5536 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5535)
                                  ((_ to_fp 11 53) t_ack!5538)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5537))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5536)
                                   ((_ to_fp 11 53) y0_ack!5536))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
