(declare-fun t_ack!3050 () (_ BitVec 64))
(declare-fun t1_ack!3047 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y0_ack!3048 () (_ BitVec 64))
(declare-fun y1_ack!3049 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3047)
                                  ((_ to_fp 11 53) t_ack!3050)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3049))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3048)
                                   ((_ to_fp 11 53) y0_ack!3048))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3048) a!30)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3048) a!30))
    #x3ff0000000000000))))))))))))))))
