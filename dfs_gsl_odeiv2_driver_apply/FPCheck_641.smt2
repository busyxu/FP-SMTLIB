(declare-fun t_ack!5196 () (_ BitVec 64))
(declare-fun t1_ack!5193 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5194 () (_ BitVec 64))
(declare-fun y1_ack!5195 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5193)
                                  ((_ to_fp 11 53) t_ack!5196)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5195))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5194)
                                   ((_ to_fp 11 53) y0_ack!5194))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!25 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!16))
                    a!24)))
  (FPCHECK_FMUL_ACCURACY #xbfd2a471c23b2d29 a!25)))))))))))))
