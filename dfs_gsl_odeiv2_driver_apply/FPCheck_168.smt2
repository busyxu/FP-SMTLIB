(declare-fun t_ack!1242 () (_ BitVec 64))
(declare-fun t1_ack!1239 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1239)
                                  ((_ to_fp 11 53) t_ack!1242)))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW #x4024000000000000 a!14)))))))))
