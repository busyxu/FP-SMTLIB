(declare-fun t_ack!5852 () (_ BitVec 64))
(declare-fun t1_ack!5849 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5849)
                                  ((_ to_fp 11 53) t_ack!5852)))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xc03000ea32f607ac
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5851) a!34))))))))))))))))))
