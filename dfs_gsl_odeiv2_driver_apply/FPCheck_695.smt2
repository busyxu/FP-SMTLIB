(declare-fun t_ack!5638 () (_ BitVec 64))
(declare-fun t1_ack!5635 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5637 () (_ BitVec 64))
(declare-fun y0_ack!5636 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5635)
                                  ((_ to_fp 11 53) t_ack!5638)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5637))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5636)
                                   ((_ to_fp 11 53) y0_ack!5636))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!62 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x4024000000000000) a!62)
    (fp.sub roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!66 a!66)
            ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))))))))))))))))))
