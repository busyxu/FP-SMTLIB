(declare-fun t_ack!6008 () (_ BitVec 64))
(declare-fun t1_ack!6005 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!6006 () (_ BitVec 64))
(declare-fun y1_ack!6007 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!6005)
                                  ((_ to_fp 11 53) t_ack!6008)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6007))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6006)
                                   ((_ to_fp 11 53) y0_ack!6006))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!6008))
                            a!61))))
  (FPCHECK_FMUL_OVERFLOW #x401489672d167d27 a!62)))))))))))))))))))))))))))
