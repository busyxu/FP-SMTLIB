(declare-fun t_ack!5800 () (_ BitVec 64))
(declare-fun t1_ack!5797 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5798 () (_ BitVec 64))
(declare-fun y1_ack!5799 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5797)
                                  ((_ to_fp 11 53) t_ack!5800)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5799))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5798)
                                   ((_ to_fp 11 53) y0_ack!5798))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!5800))
                            a!27))))
  (FPCHECK_FMUL_OVERFLOW #xc01839f6df39ea9c a!28)))))))))))))))
