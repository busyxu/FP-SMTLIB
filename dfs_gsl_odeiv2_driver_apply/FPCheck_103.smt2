(declare-fun t_ack!732 () (_ BitVec 64))
(declare-fun t1_ack!729 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!729)
                                  ((_ to_fp 11 53) t_ack!732)))
...
(let ((a!8 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW y1_ack!731 a!8))))))
