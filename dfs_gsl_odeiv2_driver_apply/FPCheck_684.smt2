(declare-fun t_ack!5546 () (_ BitVec 64))
(declare-fun t1_ack!5543 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5544 () (_ BitVec 64))
(declare-fun y1_ack!5545 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5543)
                                  ((_ to_fp 11 53) t_ack!5546)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5545))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5544)
                                   ((_ to_fp 11 53) y0_ack!5544))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!5546))
                            a!61))))
  (FPCHECK_FMUL_OVERFLOW #x4024000000000000 a!62)))))))))))))))))))))))))))
