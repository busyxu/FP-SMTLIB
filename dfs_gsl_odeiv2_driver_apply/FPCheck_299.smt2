(declare-fun t_ack!2322 () (_ BitVec 64))
(declare-fun t1_ack!2319 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!2321 () (_ BitVec 64))
(declare-fun y0_ack!2320 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!2319)
                                  ((_ to_fp 11 53) t_ack!2322)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2321))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2320)
                                   ((_ to_fp 11 53) y0_ack!2320))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!2322))
                            a!21))))
  (FPCHECK_FSUB_ACCURACY #x8000000000000000 a!22)))))))))))))
