(declare-fun t_ack!1762 () (_ BitVec 64))
(declare-fun t1_ack!1759 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1759)
                                  ((_ to_fp 11 53) t_ack!1762)))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    #x8000000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1760) a!16)))))))))))
