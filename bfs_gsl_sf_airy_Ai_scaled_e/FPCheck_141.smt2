...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!381) ((_ to_fp 11 53) #xc000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!381) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (= #x00000000 (bvand b_ack!380 #x00000007)))
