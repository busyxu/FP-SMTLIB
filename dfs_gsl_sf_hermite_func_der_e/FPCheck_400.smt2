...
(assert (not (bvslt b_ack!2503 #x00000000)))
(assert (not (= #x00000000 a_ack!2505)))
(assert (= #x00000001 a_ack!2505))
(assert (bvsle #x00000002 b_ack!2503))
...
(assert (not (bvsle #x00000003 b_ack!2503)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2504))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!2504) a!5)))))))
