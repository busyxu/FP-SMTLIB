...
(assert (= #x00000001 a_ack!2427))
(assert (bvsle #x00000002 b_ack!2425))
...
(assert (bvsle #x00000003 b_ack!2425))
(assert (FPCHECK_FMUL_OVERFLOW #x3fea20bd700c2c3e c_ack!2426))
