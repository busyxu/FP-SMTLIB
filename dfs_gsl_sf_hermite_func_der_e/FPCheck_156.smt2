...
(assert (bvsle #x00000002 b_ack!1008))
...
(assert (bvsle #x00000003 b_ack!1008))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1009))
...
(assert (bvsle #x00000004 b_ack!1008))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000005 b_ack!1008))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1009))
...
(assert (bvsle #x00000006 b_ack!1008))
(assert (FPCHECK_FMUL_ACCURACY #x3fe279a74590331c c_ack!1009))
