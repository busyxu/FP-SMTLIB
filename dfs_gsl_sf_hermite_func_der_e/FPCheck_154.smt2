...
(assert (not (= #x00000001 b_ack!999)))
...
(assert (bvsle #x00000005 b_ack!999))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1000))
...
(assert (bvsle #x00000006 b_ack!999))
(assert (FPCHECK_FMUL_OVERFLOW #x3fe279a74590331c c_ack!1000))
