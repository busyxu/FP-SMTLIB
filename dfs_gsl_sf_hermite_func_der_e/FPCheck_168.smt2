...
(assert (bvsle #x00000005 b_ack!1086))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1087))
...
(assert (bvsle #x00000006 b_ack!1086))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1087))
...
(assert (bvsle #x00000007 b_ack!1086))
(assert (FPCHECK_FMUL_ACCURACY #x3fe11acee560242a c_ack!1087))
