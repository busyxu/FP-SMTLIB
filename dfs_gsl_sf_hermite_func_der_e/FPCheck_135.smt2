...
(assert (= #x00000000 a_ack!890))
(assert (not (bvslt b_ack!888 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!889) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!888)))
(assert (not (= #x00000001 b_ack!888)))
(assert (bvsle #x00000002 b_ack!888))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3ff0000000000000)
                                  ((_ to_fp 11 53) c_ack!889)))
...
(assert (bvsle #x00000003 b_ack!888))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!889))
...
(assert (bvsle #x00000004 b_ack!888))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000005 b_ack!888))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!889))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fec9f25c5bfedd9)
                           a!6))))
  (FPCHECK_FINVALID_LOG (fp.abs a!8) (fp.abs a!8))))))))))
