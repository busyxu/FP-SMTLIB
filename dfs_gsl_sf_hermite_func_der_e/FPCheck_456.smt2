...
(assert (bvsle #x00000002 b_ack!2833))
...
(assert (bvsle #x00000003 b_ack!2833))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2834))
...
(assert (bvsle #x00000004 b_ack!2833))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2834))
...
(assert (not (bvsle #x00000005 b_ack!2833)))
(assert (FPCHECK_FMUL_ACCURACY #xbfe0000000000000 c_ack!2834))
