...
(assert (bvsle #x00000002 b_ack!1200))
...
(assert (bvsle #x00000003 b_ack!1200))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1201))
...
(assert (bvsle #x00000004 b_ack!1200))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000005 b_ack!1200))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1201))
...
(assert (bvsle #x00000006 b_ack!1200))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1201))
...
(assert (bvsle #x00000007 b_ack!1200))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1201))
...
(assert (bvsle #x00000008 b_ack!1200))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3fe0000000000000)
                                  ((_ to_fp 11 53) c_ack!1201)))
                  ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fed363d1848dcbf)
                            a!11))))
  (FPCHECK_FMUL_OVERFLOW #x3fedeeea11683f49 a!12))))))))))))
