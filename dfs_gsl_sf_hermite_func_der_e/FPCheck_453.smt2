...
(assert (= #x00000001 a_ack!2826))
(assert (bvsle #x00000002 b_ack!2824))
...
(assert (bvsle #x00000003 b_ack!2824))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2825))
...
(assert (bvsle #x00000004 b_ack!2824))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2825))
...
(assert (not (bvsle #x00000005 b_ack!2824)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2825))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!2825) a!7)))))))))
