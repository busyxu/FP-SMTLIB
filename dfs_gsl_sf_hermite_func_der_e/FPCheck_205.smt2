...
(declare-fun b_ack!1344 () (_ BitVec 32))
...
(assert (not (bvslt b_ack!1344 #x00000000)))
(assert (= #x00000000 a_ack!1346))
(assert (not (bvslt b_ack!1344 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1345) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!1344)))
(assert (not (= #x00000001 b_ack!1344)))
(assert (bvsle #x00000002 b_ack!1344))
...
(assert (bvsle #x00000003 b_ack!1344))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1345))
...
(assert (bvsle #x00000004 b_ack!1344))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000005 b_ack!1344))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1345))
...
(assert (bvsle #x00000006 b_ack!1344))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1345))
...
(assert (bvsle #x00000007 b_ack!1344))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1345))
...
(assert (bvsle #x00000008 b_ack!1344))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3fe0000000000000)
                                  ((_ to_fp 11 53) c_ack!1345)))
                  ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000009 b_ack!1344))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fde2b7dddfefa66))
       ((_ to_fp 11 53) c_ack!1345)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!1345))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) #x3fde2b7dddfefa66)
...
(assert (bvsle #x0000000a b_ack!1344))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1345))
