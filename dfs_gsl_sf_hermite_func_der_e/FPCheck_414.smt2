...
(declare-fun b_ack!2581 () (_ BitVec 32))
(declare-fun c_ack!2582 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!2583 #x00000000)))
(assert (not (bvslt b_ack!2581 #x00000000)))
(assert (not (= #x00000000 a_ack!2583)))
(assert (= #x00000001 a_ack!2583))
(assert (bvsle #x00000002 b_ack!2581))
...
(assert (not (bvsle #x00000003 b_ack!2581)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfe0000000000000)
                           ((_ to_fp 11 53) c_ack!2582)))))
  (fp.eq a!1 ((_ to_fp 11 53) c_ack!2582))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2582))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (FPCHECK_FMUL_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2581)
  #x3cb0000000000000))
