...
(assert (not (bvslt b_ack!2551 #x00000000)))
(assert (not (= #x00000000 a_ack!2553)))
(assert (= #x00000001 a_ack!2553))
(assert (bvsle #x00000002 b_ack!2551))
...
(assert (not (bvsle #x00000003 b_ack!2551)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfe0000000000000)
                           ((_ to_fp 11 53) c_ack!2552)))))
  (fp.eq a!1 ((_ to_fp 11 53) c_ack!2552))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2552))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
