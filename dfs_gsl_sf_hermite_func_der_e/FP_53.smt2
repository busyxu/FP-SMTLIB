...
(assert (not (= #x00000000 b_ack!1608)))
(assert (not (= #x00000001 b_ack!1608)))
(assert (bvsle #x00000002 b_ack!1608))
...
(assert (bvsle #x00000003 b_ack!1608))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1609))
...
(assert (bvsle #x00000004 b_ack!1608))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000005 b_ack!1608))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!1609))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fec9f25c5bfedd9)
                           a!6))))
  (not (fp.geq (CF_log (fp.abs a!8)) ((_ to_fp 11 53) #x0000000000000000)))))))))))
