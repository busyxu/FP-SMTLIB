(declare-fun a_ack!2412 () (_ BitVec 32))
(declare-fun b_ack!2410 () (_ BitVec 32))
(declare-fun c_ack!2411 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt a_ack!2412 #x00000000)))
(assert (not (bvslt b_ack!2410 #x00000000)))
(assert (not (= #x00000000 a_ack!2412)))
(assert (= #x00000001 a_ack!2412))
(assert (bvsle #x00000002 b_ack!2410))
