...
(assert (not (bvslt b_ack!2431 #x00000000)))
(assert (not (= #x00000000 a_ack!2433)))
(assert (= #x00000001 a_ack!2433))
(assert (bvsle #x00000002 b_ack!2431))
...
(assert (bvsle #x00000003 b_ack!2431))
(assert (FPCHECK_FMUL_UNDERFLOW #x3fea20bd700c2c3e c_ack!2432))
