...
(assert (bvsle #x00000002 b_ack!2566))
...
(assert (not (bvsle #x00000003 b_ack!2566)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfe0000000000000)
                           ((_ to_fp 11 53) c_ack!2567)))))
  (fp.eq a!1 ((_ to_fp 11 53) c_ack!2567))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2567))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.sub roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    a!4)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!2567) a!5))
    (CF_exp a!6)))))))
