(declare-fun a_ack!2778 () (_ BitVec 32))
(declare-fun b_ack!2776 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!2778 #x00000000)))
(assert (not (bvslt b_ack!2776 #x00000000)))
(assert (not (= #x00000000 a_ack!2778)))
(assert (= #x00000001 a_ack!2778))
(assert (bvsle #x00000002 b_ack!2776))
...
(assert (bvsle #x00000003 b_ack!2776))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2777))
...
(assert (bvsle #x00000004 b_ack!2776))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2777))
...
(assert (not (bvsle #x00000005 b_ack!2776)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2777))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fea20bd700c2c3e)
                           a!5))))
  (FPCHECK_FMUL_UNDERFLOW #x4006a09e667f3bcd a!6)))))))
