...
(assert (= #x00000001 a_ack!2877))
(assert (bvsle #x00000002 b_ack!2875))
...
(assert (bvsle #x00000003 b_ack!2875))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2876))
...
(assert (bvsle #x00000004 b_ack!2875))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!2876))
...
(assert (not (bvsle #x00000005 b_ack!2875)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfe0000000000000)
                           ((_ to_fp 11 53) c_ack!2876)))))
  (fp.eq a!1 ((_ to_fp 11 53) c_ack!2876))))
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.sub roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    a!6)
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!2876) a!7))
    (CF_exp a!8)))))))))
