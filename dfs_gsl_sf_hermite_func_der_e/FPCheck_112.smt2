...
(assert (bvsle #x00000002 b_ack!711))
...
(assert (bvsle #x00000003 b_ack!711))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) c_ack!712))
...
(assert (bvsle #x00000004 b_ack!711))
(assert (FPCHECK_FMUL_ACCURACY #x3fe6a09e667f3bcd c_ack!712))
