...
(declare-fun y1_ack!419 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) xx_ack!421) ((_ to_fp 11 53) x0_ack!422))))
(assert (fp.geq ((_ to_fp 11 53) xx_ack!421) ((_ to_fp 11 53) x1_ack!417)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!417) ((_ to_fp 11 53) xx_ack!421))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) x2_ack!418)
               ((_ to_fp 11 53) x1_ack!417))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW y2_ack!420 y1_ack!419))
