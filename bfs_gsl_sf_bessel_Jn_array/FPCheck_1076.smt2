...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!4483 #x00000000)))
(assert (not (bvslt b_ack!4481 a_ack!4483)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4482) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4481) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4482) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4481)))
(assert (= #x00000000 b_ack!4481))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4482))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4482))
                           (fp.abs ((_ to_fp 11 53) c_ack!4482))))))
