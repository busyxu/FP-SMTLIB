...
(declare-fun b_ack!1412 () (_ BitVec 32))
(declare-fun c_ack!1413 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!1414 #x00000000)))
(assert (not (bvslt b_ack!1412 a_ack!1414)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1413) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!1412) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1413) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!1412)))
(assert (= #x00000000 b_ack!1412))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!1413))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1413))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!1413))
                           (fp.abs ((_ to_fp 11 53) c_ack!1413))))))
