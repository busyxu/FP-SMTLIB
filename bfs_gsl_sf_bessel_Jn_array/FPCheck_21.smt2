...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 b_ack!107)
                            (bvadd #x00000001 b_ack!107)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) c_ack!108))
              a!1))))
(assert (bvslt #x00000032 (bvadd #x00000001 b_ack!107)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!108) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FDIV_INVALID
  c_ack!108
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 b_ack!107))))
