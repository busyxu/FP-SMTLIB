...
(assert (not (bvslt (bvadd #x00000001 b_ack!227) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!228) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!227)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 b_ack!227)
                            (bvadd #x00000001 b_ack!227)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) c_ack!228))
              a!1))))
(assert (bvslt #x00000032 (bvadd #x00000001 b_ack!227)))
