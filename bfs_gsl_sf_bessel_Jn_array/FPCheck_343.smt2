...
(declare-fun b_ack!1553 () (_ BitVec 32))
(declare-fun c_ack!1554 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!1555 #x00000000)))
(assert (not (bvslt b_ack!1553 a_ack!1555)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1554) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!1553) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1554) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!1553)))
(assert (= #x00000000 b_ack!1553))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!1554))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1554))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!1554))
                           (fp.abs ((_ to_fp 11 53) c_ack!1554))))))
