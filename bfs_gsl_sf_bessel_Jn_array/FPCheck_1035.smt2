(declare-fun a_ack!4279 () (_ BitVec 32))
(declare-fun b_ack!4277 () (_ BitVec 32))
(declare-fun c_ack!4278 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!4279 #x00000000)))
(assert (not (bvslt b_ack!4277 a_ack!4279)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4278) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4277) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4278) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4277)))
(assert (= #x00000000 b_ack!4277))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4278))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4278))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4278))
                           (fp.abs ((_ to_fp 11 53) c_ack!4278))))))
...
(let ((a!22 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW (fp.abs a!22) (fp.abs a!21)))))))))))))))))))))))))
