...
(assert (not (bvslt (bvadd #x00000001 b_ack!383) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!384) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!383)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 b_ack!383)
                            (bvadd #x00000001 b_ack!383)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FMUL_OVERFLOW
  (fp.mul roundNearestTiesToEven
          ...
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 b_ack!383)))
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 b_ack!383))))
