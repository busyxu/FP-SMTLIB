...
(declare-fun b_ack!3578 () (_ BitVec 32))
(declare-fun c_ack!3579 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!3580 #x00000000)))
(assert (not (bvslt b_ack!3578 a_ack!3580)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3579) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!3578) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3579) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!3578)))
(assert (= #x00000000 b_ack!3578))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!3579))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!3579))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!3579))
                           (fp.abs ((_ to_fp 11 53) c_ack!3579))))))
