...
(assert (not (bvslt b_ack!2192 a_ack!2194)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2193) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!2192) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2193) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!2192)))
(assert (= #x00000000 b_ack!2192))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2193))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!2193))
                           (fp.abs ((_ to_fp 11 53) c_ack!2193))))))
