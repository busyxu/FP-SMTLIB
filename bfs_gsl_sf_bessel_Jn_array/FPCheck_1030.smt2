(declare-fun a_ack!4252 () (_ BitVec 32))
(declare-fun b_ack!4250 () (_ BitVec 32))
(declare-fun c_ack!4251 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!4252 #x00000000)))
(assert (not (bvslt b_ack!4250 a_ack!4252)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4251) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4250) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4251) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4250)))
(assert (= #x00000000 b_ack!4250))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4251))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4251))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4251))
                           (fp.abs ((_ to_fp 11 53) c_ack!4251))))))
