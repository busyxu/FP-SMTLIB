...
(declare-fun b_ack!2576 () (_ BitVec 32))
(declare-fun c_ack!2577 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!2578 #x00000000)))
(assert (not (bvslt b_ack!2576 a_ack!2578)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2577) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!2576) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2577) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!2576)))
(assert (= #x00000000 b_ack!2576))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2577))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2577))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!2577))
                           (fp.abs ((_ to_fp 11 53) c_ack!2577))))))
