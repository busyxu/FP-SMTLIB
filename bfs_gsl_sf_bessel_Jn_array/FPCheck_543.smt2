...
(assert (not (bvslt (bvadd #x00000001 b_ack!2321) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2322) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!2321)))
(assert (= #x00000000 b_ack!2321))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2322))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!2322))
                           (fp.abs ((_ to_fp 11 53) c_ack!2322))))))
