...
(assert (not (bvslt (bvadd #x00000001 b_ack!185) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!186) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!185)))
(assert (not (= #x00000000 b_ack!185)))
(assert (fp.eq ((_ to_fp 11 53) c_ack!186) ((_ to_fp 11 53) #x0000000000000000)))
