...
(assert (bvslt (bvadd #x00000001 b_ack!566) #x00000000))
(assert (= #x00000000 (bvand (bvsub #xffffffff b_ack!566) #x00000001)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!567) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!566)))
(assert (not (= #xfffffffe b_ack!566)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!567) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FMUL_ACCURACY #x3f20000000000000 c_ack!567))
