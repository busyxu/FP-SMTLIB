...
(assert (not (bvslt (bvadd #x00000001 b_ack!347) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!348) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!347)))
(assert (not (= #x00000000 b_ack!347)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!348) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53)
              ...
              (bvadd #x00000001 b_ack!347))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 b_ack!347))
