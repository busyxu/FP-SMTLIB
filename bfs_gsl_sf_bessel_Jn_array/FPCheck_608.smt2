...
(declare-fun b_ack!2627 () (_ BitVec 32))
(declare-fun c_ack!2628 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (bvslt a_ack!2629 #x00000000)))
(assert (not (bvslt b_ack!2627 a_ack!2629)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2628) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!2627) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2628) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!2627)))
(assert (= #x00000000 b_ack!2627))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2628))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2628))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!2628))
                           (fp.abs ((_ to_fp 11 53) c_ack!2628))))))
...
(let ((a!49 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3cb0000000000000) a!49)
    #x3c8cd2b297d889bc))))))))))))))))))))))))))
