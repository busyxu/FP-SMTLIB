...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!712)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) b_ack!711)
                 ((_ to_fp 11 53) #x0000000000000000)))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!710)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!710) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!710) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!710) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!710) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!710) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!712)
                    ((_ to_fp 11 53) b_ack!711))
            (fp.mul roundNearestTiesToEven
...
(assert (FPCHECK_FADD_ACCURACY a_ack!710 #x4000000000000000))
