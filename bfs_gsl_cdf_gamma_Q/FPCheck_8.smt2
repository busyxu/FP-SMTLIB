...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!73)
          ...
          (fp.eq ((_ to_fp 11 53) b_ack!72)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!73) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.leq (fp.div roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     ...
                     ((_ to_fp 11 53) a_ack!71)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!71) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!71) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!71)
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53) x_ack!73)
                     ((_ to_fp 11 53) b_ack!72)))))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!71 #x7ff8000000000001))
