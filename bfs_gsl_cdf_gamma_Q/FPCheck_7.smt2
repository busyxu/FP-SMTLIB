...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!67)
          ...
          (fp.eq ((_ to_fp 11 53) b_ack!66)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!67) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!65) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!65)
             (fp.div roundNearestTiesToEven
                     ((_ to_fp 11 53) x_ack!67)
                     ((_ to_fp 11 53) b_ack!66)))))
(assert (FPCHECK_FINVALID_SQRT a_ack!65 a_ack!65))
