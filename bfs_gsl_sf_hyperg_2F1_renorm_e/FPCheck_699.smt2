...
(assert (fp.lt ((_ to_fp 11 53) a_ack!3250) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3248) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!3249) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_ACCURACY c_ack!3249 #xbf3fbdf153d2eadd))
