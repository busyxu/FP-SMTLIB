...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1543) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1541) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1542) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FSUB_OVERFLOW c_ack!1542 #x3ff0000000000000))
