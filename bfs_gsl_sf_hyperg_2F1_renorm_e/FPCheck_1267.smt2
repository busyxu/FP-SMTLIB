...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) a_ack!6319) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6317) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!6318) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fb999999999999a))
       ((_ to_fp 11 53) c_ack!6318)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!6319)
            (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) c_ack!6318)
                    ((_ to_fp 11 53) #x3fb999999999999a)))))
