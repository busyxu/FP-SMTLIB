...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1603) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1601) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1602) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FSUB_ACCURACY a_ack!1603 c_ack!1602))
