...
(assert (fp.lt ((_ to_fp 11 53) a_ack!3214) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.gt ((_ to_fp 11 53) c_ack!3213) ((_ to_fp 11 53) #xc3045f306dc9c883)))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 c_ack!3213))
