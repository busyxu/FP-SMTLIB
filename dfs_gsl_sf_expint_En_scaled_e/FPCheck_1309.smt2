...
(assert (= #x00000001 a_ack!3572))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3571) ((_ to_fp 11 53) #xc085eeaad5511c64)))
(assert (fp.leq ((_ to_fp 11 53) b_ack!3571) ((_ to_fp 11 53) #xc024000000000000)))
