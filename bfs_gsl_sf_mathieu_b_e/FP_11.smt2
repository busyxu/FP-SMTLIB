...
(assert (not (= #x00000000 (bvsrem n_ack!167 #x00000002))))
(assert (not (= #x00000000 n_ack!167)))
...
(assert (not (bvslt (bvmul #xffffffff n_ack!167) #x00000001)))
(assert (= #x00000003 (bvmul #xffffffff n_ack!167)))
