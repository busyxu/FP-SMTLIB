...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!525) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!524) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!524) ((_ to_fp 11 53) #xc085eeaad5511c64)))
