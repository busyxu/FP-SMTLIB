...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2314) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!2315) ((_ to_fp 11 53) b_ack!2314)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2314) ((_ to_fp 11 53) #x412e848000000000))))
