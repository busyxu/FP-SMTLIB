...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!529) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!528) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!528) ((_ to_fp 11 53) #xc010000000000000)))
