...
(assert (fp.eq ((_ to_fp 11 53) a_ack!285) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!284) ((_ to_fp 11 53) #xc010000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!284) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!284) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!284) ((_ to_fp 11 53) #x3ff0000000000000)))
