...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2102) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2103) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2103) ((_ to_fp 11 53) #xc065200000000000)))
