...
(assert (fp.lt ((_ to_fp 11 53) a_ack!109) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!109) ((_ to_fp 11 53) #xc065200000000000))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!109 #x3ff0000000000000))
