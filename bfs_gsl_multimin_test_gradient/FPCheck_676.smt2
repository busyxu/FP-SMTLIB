(declare-fun p0_ack!8030 () (_ BitVec 64))
(declare-fun x0_ack!8027 () (_ BitVec 64))
(declare-fun p2_ack!8026 () (_ BitVec 64))
(declare-fun p1_ack!8025 () (_ BitVec 64))
(declare-fun x1_ack!8028 () (_ BitVec 64))
(declare-fun step_size_ack!8029 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!8026))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!8027)
                                  ((_ to_fp 11 53) p0_ack!8030)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!8028)
                                  ((_ to_fp 11 53) p1_ack!8025)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!8029))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!8029)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!8029))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (not (not (fp.eq ((_ to_fp 11 53) x0_ack!8027) a!16)))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!8026))
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (not (not (fp.eq ((_ to_fp 11 53) x1_ack!8028) a!16)))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!8026))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    (fp.mul roundNearestTiesToEven a!15 a!2))))))
  (FPCHECK_FSUB_UNDERFLOW a!16 p1_ack!8025)))))))))))
