(declare-fun p0_ack!3612 () (_ BitVec 64))
(declare-fun x0_ack!3609 () (_ BitVec 64))
(declare-fun p2_ack!3608 () (_ BitVec 64))
(declare-fun p1_ack!3607 () (_ BitVec 64))
(declare-fun x1_ack!3610 () (_ BitVec 64))
(declare-fun step_size_ack!3611 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!3608))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3609)
                                  ((_ to_fp 11 53) p0_ack!3612)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3611))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!3611)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!3611))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!15 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.abs a!1)
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW a!15 a!1))))))))))
