(declare-fun p0_ack!5324 () (_ BitVec 64))
(declare-fun x0_ack!5321 () (_ BitVec 64))
(declare-fun p2_ack!5320 () (_ BitVec 64))
(declare-fun p1_ack!5319 () (_ BitVec 64))
(declare-fun x1_ack!5322 () (_ BitVec 64))
(declare-fun step_size_ack!5323 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5320))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5321)
                                  ((_ to_fp 11 53) p0_ack!5324)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!5322)
                                  ((_ to_fp 11 53) p1_ack!5319)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5323))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5320))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5321) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5320))
...
(let ((a!15 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!14
                                    ((_ to_fp 11 53) p0_ack!5324))))))
  (FPCHECK_FDIV_OVERFLOW a!15 #x0000000000000000))))))))))
