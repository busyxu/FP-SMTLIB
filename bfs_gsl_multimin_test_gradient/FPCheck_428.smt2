(declare-fun p0_ack!4696 () (_ BitVec 64))
(declare-fun x0_ack!4693 () (_ BitVec 64))
(declare-fun p2_ack!4692 () (_ BitVec 64))
(declare-fun p1_ack!4691 () (_ BitVec 64))
(declare-fun x1_ack!4694 () (_ BitVec 64))
(declare-fun step_size_ack!4695 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4692))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4693)
                                  ((_ to_fp 11 53) p0_ack!4696)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!4694)
                                  ((_ to_fp 11 53) p1_ack!4691)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4695))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!4695)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!4695))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x0_ack!4693)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x0_ack!4693)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x1_ack!4694)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x1_ack!4694)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 p2_ack!4692))
