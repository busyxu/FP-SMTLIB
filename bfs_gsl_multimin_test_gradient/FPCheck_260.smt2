(declare-fun p0_ack!2718 () (_ BitVec 64))
(declare-fun x0_ack!2715 () (_ BitVec 64))
(declare-fun p2_ack!2714 () (_ BitVec 64))
(declare-fun p1_ack!2713 () (_ BitVec 64))
(declare-fun x1_ack!2716 () (_ BitVec 64))
(declare-fun step_size_ack!2717 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2714))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2715)
                                  ((_ to_fp 11 53) p0_ack!2718)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2717))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2714))
            ((_ to_fp 11 53) #x0000000000000000))))
