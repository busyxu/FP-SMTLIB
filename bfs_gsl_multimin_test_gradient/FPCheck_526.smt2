(declare-fun p0_ack!6062 () (_ BitVec 64))
(declare-fun x0_ack!6058 () (_ BitVec 64))
(declare-fun p2_ack!6057 () (_ BitVec 64))
(declare-fun p1_ack!6056 () (_ BitVec 64))
(declare-fun x1_ack!6059 () (_ BitVec 64))
(declare-fun step_size_ack!6060 () (_ BitVec 64))
(declare-fun epsabs_ack!6061 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!6057))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6058)
                                  ((_ to_fp 11 53) p0_ack!6062)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6060))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6061)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW a!11 p0_ack!6062))))))))))
