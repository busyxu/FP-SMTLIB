(declare-fun p0_ack!1654 () (_ BitVec 64))
(declare-fun x0_ack!1651 () (_ BitVec 64))
(declare-fun p2_ack!1650 () (_ BitVec 64))
(declare-fun p1_ack!1649 () (_ BitVec 64))
(declare-fun x1_ack!1652 () (_ BitVec 64))
(declare-fun step_size_ack!1653 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!1650))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!1651)
                                  ((_ to_fp 11 53) p0_ack!1654)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!1653))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!1650))
            ((_ to_fp 11 53) #x0000000000000000))))
