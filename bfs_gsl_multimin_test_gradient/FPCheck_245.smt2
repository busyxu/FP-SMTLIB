(declare-fun p0_ack!2538 () (_ BitVec 64))
(declare-fun x0_ack!2535 () (_ BitVec 64))
(declare-fun p2_ack!2534 () (_ BitVec 64))
(declare-fun p1_ack!2533 () (_ BitVec 64))
(declare-fun x1_ack!2536 () (_ BitVec 64))
(declare-fun step_size_ack!2537 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2534))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2535)
                                  ((_ to_fp 11 53) p0_ack!2538)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2537))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2534))
            ((_ to_fp 11 53) #x0000000000000000))))
