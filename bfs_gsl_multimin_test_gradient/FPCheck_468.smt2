(declare-fun p0_ack!5306 () (_ BitVec 64))
(declare-fun x0_ack!5303 () (_ BitVec 64))
(declare-fun p2_ack!5302 () (_ BitVec 64))
(declare-fun p1_ack!5301 () (_ BitVec 64))
(declare-fun x1_ack!5304 () (_ BitVec 64))
(declare-fun step_size_ack!5305 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5302))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5303)
                                  ((_ to_fp 11 53) p0_ack!5306)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5305))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5302))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5303) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5302))
