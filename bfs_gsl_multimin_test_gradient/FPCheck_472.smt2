(declare-fun p0_ack!5342 () (_ BitVec 64))
(declare-fun x0_ack!5339 () (_ BitVec 64))
(declare-fun p2_ack!5338 () (_ BitVec 64))
(declare-fun p1_ack!5337 () (_ BitVec 64))
(declare-fun x1_ack!5340 () (_ BitVec 64))
(declare-fun step_size_ack!5341 () (_ BitVec 64))
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5338))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5339)
                                  ((_ to_fp 11 53) p0_ack!5342)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5341))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5338))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5339) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5338))
...
(let ((a!15 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!14
                                    ((_ to_fp 11 53) p0_ack!5342))))))
  (not (fp.lt ((_ to_fp 11 53) #x0000000000000000) a!15)))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5338))
