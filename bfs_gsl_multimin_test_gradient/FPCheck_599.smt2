(declare-fun p0_ack!6974 () (_ BitVec 64))
(declare-fun x0_ack!6971 () (_ BitVec 64))
(declare-fun p2_ack!6970 () (_ BitVec 64))
(declare-fun p1_ack!6969 () (_ BitVec 64))
(declare-fun x1_ack!6972 () (_ BitVec 64))
(declare-fun step_size_ack!6973 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!6970))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6971)
                                  ((_ to_fp 11 53) p0_ack!6974)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6973))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!6973)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!6973))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!6971) a!16))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!6970))
...
(let ((a!17 (fp.mul roundNearestTiesToEven
      ...
      (a!19 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!18
                            ((_ to_fp 11 53) p1_ack!6969)))))
  (FPCHECK_FADD_ACCURACY a!17 a!19))))))))))))
