(declare-fun p0_ack!7010 () (_ BitVec 64))
(declare-fun x0_ack!7007 () (_ BitVec 64))
(declare-fun p2_ack!7006 () (_ BitVec 64))
(declare-fun p1_ack!7005 () (_ BitVec 64))
(declare-fun x1_ack!7008 () (_ BitVec 64))
(declare-fun step_size_ack!7009 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!7006))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7007)
                                  ((_ to_fp 11 53) p0_ack!7010)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!7008)
                                  ((_ to_fp 11 53) p1_ack!7005)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7009))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!7009)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!7009))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!7007) a!16))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!7006))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.gt (fp.div roundNearestTiesToEven a!6 a!14)
              ((_ to_fp 11 53) #x0000000000000000)))))))))))
(assert (FPCHECK_FMUL_OVERFLOW #x4000000000000000 p2_ack!7006))
