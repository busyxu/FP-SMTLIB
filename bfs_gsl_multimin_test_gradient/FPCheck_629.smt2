(declare-fun p0_ack!7385 () (_ BitVec 64))
(declare-fun x0_ack!7381 () (_ BitVec 64))
(declare-fun p2_ack!7380 () (_ BitVec 64))
(declare-fun p1_ack!7379 () (_ BitVec 64))
(declare-fun x1_ack!7382 () (_ BitVec 64))
(declare-fun step_size_ack!7383 () (_ BitVec 64))
(declare-fun epsabs_ack!7384 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!7380))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7381)
                                  ((_ to_fp 11 53) p0_ack!7385)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7383))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!7384)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!21 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x0000000000000000)))
                    a!12)))
  (FPCHECK_FDIV_ACCURACY a!13 a!21)))))))))))))
