(declare-fun p0_ack!3534 () (_ BitVec 64))
(declare-fun x0_ack!3531 () (_ BitVec 64))
(declare-fun p2_ack!3530 () (_ BitVec 64))
(declare-fun p1_ack!3529 () (_ BitVec 64))
(declare-fun x1_ack!3532 () (_ BitVec 64))
(declare-fun step_size_ack!3533 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!3530))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3531)
                                  ((_ to_fp 11 53) p0_ack!3534)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3533))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!3533)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!3533))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
