(declare-fun p0_ack!2904 () (_ BitVec 64))
(declare-fun x0_ack!2901 () (_ BitVec 64))
(declare-fun p2_ack!2900 () (_ BitVec 64))
(declare-fun p1_ack!2899 () (_ BitVec 64))
(declare-fun x1_ack!2902 () (_ BitVec 64))
(declare-fun step_size_ack!2903 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2900))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2901)
                                  ((_ to_fp 11 53) p0_ack!2904)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2903))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2900))
            ((_ to_fp 11 53) #x0000000000000000))))
