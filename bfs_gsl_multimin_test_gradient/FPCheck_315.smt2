(declare-fun p0_ack!3234 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!3230))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!3231) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!3230))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq (fp.add roundNearestTiesToEven
               ...
               (fp.add roundNearestTiesToEven
                       a!11
                       ((_ to_fp 11 53) #x0000000000000000)))))))))))))
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 p2_ack!3230))
