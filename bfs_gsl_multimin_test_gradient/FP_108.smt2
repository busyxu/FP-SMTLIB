(declare-fun p0_ack!5672 () (_ BitVec 64))
(declare-fun x0_ack!5669 () (_ BitVec 64))
(declare-fun p2_ack!5668 () (_ BitVec 64))
(declare-fun p1_ack!5667 () (_ BitVec 64))
(declare-fun x1_ack!5670 () (_ BitVec 64))
(declare-fun step_size_ack!5671 () (_ BitVec 64))
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5668))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5669)
                                  ((_ to_fp 11 53) p0_ack!5672)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5671))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!5671)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!5671))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x0_ack!5669)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x0_ack!5669)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x1_ack!5670)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x1_ack!5670)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
