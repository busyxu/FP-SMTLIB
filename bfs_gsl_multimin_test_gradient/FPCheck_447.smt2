(declare-fun p0_ack!4938 () (_ BitVec 64))
(declare-fun x0_ack!4934 () (_ BitVec 64))
(declare-fun p2_ack!4933 () (_ BitVec 64))
(declare-fun p1_ack!4932 () (_ BitVec 64))
(declare-fun x1_ack!4935 () (_ BitVec 64))
(declare-fun step_size_ack!4936 () (_ BitVec 64))
(declare-fun epsabs_ack!4937 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!4933))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4934)
                                  ((_ to_fp 11 53) p0_ack!4938)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4936))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!4937)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
