(declare-fun p0_ack!4330 () (_ BitVec 64))
(declare-fun x0_ack!4327 () (_ BitVec 64))
(declare-fun p2_ack!4326 () (_ BitVec 64))
(declare-fun p1_ack!4325 () (_ BitVec 64))
(declare-fun x1_ack!4328 () (_ BitVec 64))
(declare-fun step_size_ack!4329 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4326))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4327)
                                  ((_ to_fp 11 53) p0_ack!4330)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4329))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!4326))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!4327) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!4326))
