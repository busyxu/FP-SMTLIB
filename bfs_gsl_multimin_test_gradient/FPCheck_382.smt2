(declare-fun p0_ack!4192 () (_ BitVec 64))
(declare-fun x0_ack!4189 () (_ BitVec 64))
(declare-fun p2_ack!4188 () (_ BitVec 64))
(declare-fun p1_ack!4187 () (_ BitVec 64))
(declare-fun x1_ack!4190 () (_ BitVec 64))
(declare-fun step_size_ack!4191 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!4188))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4189)
                                  ((_ to_fp 11 53) p0_ack!4192)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4191))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!4188))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!4189) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!4188))
...
(let ((a!14 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    (fp.mul roundNearestTiesToEven a!13 a!1))))))
  (FPCHECK_FSUB_UNDERFLOW a!14 p0_ack!4192)))))))))
