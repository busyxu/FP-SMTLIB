(declare-fun p0_ack!2922 () (_ BitVec 64))
(declare-fun x0_ack!2919 () (_ BitVec 64))
(declare-fun p2_ack!2918 () (_ BitVec 64))
(declare-fun p1_ack!2917 () (_ BitVec 64))
(declare-fun x1_ack!2920 () (_ BitVec 64))
(declare-fun step_size_ack!2921 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2918))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2919)
                                  ((_ to_fp 11 53) p0_ack!2922)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!2920)
                                  ((_ to_fp 11 53) p1_ack!2917)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2921))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2918))
            ((_ to_fp 11 53) #x0000000000000000))))
