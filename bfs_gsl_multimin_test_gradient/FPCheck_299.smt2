(declare-fun p0_ack!3096 () (_ BitVec 64))
(declare-fun x0_ack!3093 () (_ BitVec 64))
(declare-fun p2_ack!3092 () (_ BitVec 64))
(declare-fun p1_ack!3091 () (_ BitVec 64))
(declare-fun x1_ack!3094 () (_ BitVec 64))
(declare-fun step_size_ack!3095 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!3092))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3093)
                                  ((_ to_fp 11 53) p0_ack!3096)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3095))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!3092))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!3093) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!3092))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY a!14 p1_ack!3091)))))))))
