(declare-fun p0_ack!3408 () (_ BitVec 64))
(declare-fun x0_ack!3405 () (_ BitVec 64))
(declare-fun p2_ack!3404 () (_ BitVec 64))
(declare-fun p1_ack!3403 () (_ BitVec 64))
(declare-fun x1_ack!3406 () (_ BitVec 64))
(declare-fun step_size_ack!3407 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!3404))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3405)
                                  ((_ to_fp 11 53) p0_ack!3408)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3407))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!3407)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!3407))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
