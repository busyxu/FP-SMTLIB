(declare-fun p0_ack!4666 () (_ BitVec 64))
(declare-fun x0_ack!4663 () (_ BitVec 64))
(declare-fun p2_ack!4662 () (_ BitVec 64))
(declare-fun p1_ack!4661 () (_ BitVec 64))
(declare-fun x1_ack!4664 () (_ BitVec 64))
(declare-fun step_size_ack!4665 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4662))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4663)
                                  ((_ to_fp 11 53) p0_ack!4666)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4665))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!4665)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!4665))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(assert (FPCHECK_FADD_ACCURACY x1_ack!4664 #x0000000000000000))
