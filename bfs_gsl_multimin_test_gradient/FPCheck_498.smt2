(declare-fun p0_ack!5714 () (_ BitVec 64))
(declare-fun x0_ack!5711 () (_ BitVec 64))
(declare-fun p2_ack!5710 () (_ BitVec 64))
(declare-fun p1_ack!5709 () (_ BitVec 64))
(declare-fun x1_ack!5712 () (_ BitVec 64))
(declare-fun step_size_ack!5713 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5710))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5711)
                                  ((_ to_fp 11 53) p0_ack!5714)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5713))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!5713)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!5713))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x0_ack!5711)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x0_ack!5711)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x1_ack!5712)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x1_ack!5712)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
