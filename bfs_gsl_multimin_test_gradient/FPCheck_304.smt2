(declare-fun p0_ack!3138 () (_ BitVec 64))
(declare-fun x0_ack!3135 () (_ BitVec 64))
(declare-fun p2_ack!3134 () (_ BitVec 64))
(declare-fun p1_ack!3133 () (_ BitVec 64))
(declare-fun x1_ack!3136 () (_ BitVec 64))
(declare-fun step_size_ack!3137 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!3134))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3135)
                                  ((_ to_fp 11 53) p0_ack!3138)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3137))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!3134))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!3135) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!3134))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY a!14 p1_ack!3133)))))))))
