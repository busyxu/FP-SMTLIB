(declare-fun p0_ack!5336 () (_ BitVec 64))
(declare-fun x0_ack!5333 () (_ BitVec 64))
(declare-fun p2_ack!5332 () (_ BitVec 64))
(declare-fun p1_ack!5331 () (_ BitVec 64))
(declare-fun x1_ack!5334 () (_ BitVec 64))
(declare-fun step_size_ack!5335 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5332))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5333)
                                  ((_ to_fp 11 53) p0_ack!5336)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5335))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5332))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5333) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5332))
...
(let ((a!15 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!14
                                    ((_ to_fp 11 53) p0_ack!5336))))))
  (FPCHECK_FDIV_UNDERFLOW a!15 #x0000000000000000))))))))))
