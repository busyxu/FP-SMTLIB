(declare-fun p0_ack!2766 () (_ BitVec 64))
(declare-fun x0_ack!2763 () (_ BitVec 64))
(declare-fun p2_ack!2762 () (_ BitVec 64))
(declare-fun p1_ack!2761 () (_ BitVec 64))
(declare-fun x1_ack!2764 () (_ BitVec 64))
(declare-fun step_size_ack!2765 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!2762))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2763)
                                  ((_ to_fp 11 53) p0_ack!2766)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!2764)
                                  ((_ to_fp 11 53) p1_ack!2761)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2765))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2762))
            ((_ to_fp 11 53) #x0000000000000000))))
