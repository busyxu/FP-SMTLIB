(declare-fun p0_ack!5318 () (_ BitVec 64))
(declare-fun x0_ack!5315 () (_ BitVec 64))
(declare-fun p2_ack!5314 () (_ BitVec 64))
(declare-fun p1_ack!5313 () (_ BitVec 64))
(declare-fun x1_ack!5316 () (_ BitVec 64))
(declare-fun step_size_ack!5317 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5314))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5315)
                                  ((_ to_fp 11 53) p0_ack!5318)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!5316)
                                  ((_ to_fp 11 53) p1_ack!5313)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5317))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5314))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5315) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5314))
