(declare-fun p0_ack!2820 () (_ BitVec 64))
(declare-fun x0_ack!2817 () (_ BitVec 64))
(declare-fun p2_ack!2816 () (_ BitVec 64))
(declare-fun p1_ack!2815 () (_ BitVec 64))
(declare-fun x1_ack!2818 () (_ BitVec 64))
(declare-fun step_size_ack!2819 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2816))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2817)
                                  ((_ to_fp 11 53) p0_ack!2820)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2819))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2816))
            ((_ to_fp 11 53) #x0000000000000000))))
