(declare-fun p0_ack!4282 () (_ BitVec 64))
(declare-fun x0_ack!4279 () (_ BitVec 64))
(declare-fun p2_ack!4278 () (_ BitVec 64))
(declare-fun p1_ack!4277 () (_ BitVec 64))
(declare-fun x1_ack!4280 () (_ BitVec 64))
(declare-fun step_size_ack!4281 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!4278))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4279)
                                  ((_ to_fp 11 53) p0_ack!4282)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4281))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!4278))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!4279) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!4278))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x0000000000000000
    (fp.sub roundNearestTiesToEven a!14 ((_ to_fp 11 53) p1_ack!4277)))))))))))
