(declare-fun p0_ack!964 () (_ BitVec 64))
(declare-fun x0_ack!961 () (_ BitVec 64))
(declare-fun p2_ack!960 () (_ BitVec 64))
(declare-fun p1_ack!959 () (_ BitVec 64))
(declare-fun x1_ack!962 () (_ BitVec 64))
(declare-fun step_size_ack!963 () (_ BitVec 64))
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!960))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!961)
                                  ((_ to_fp 11 53) p0_ack!964)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!963))
