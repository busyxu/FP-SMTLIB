(declare-fun p0_ack!4600 () (_ BitVec 64))
(declare-fun x0_ack!4597 () (_ BitVec 64))
(declare-fun p2_ack!4596 () (_ BitVec 64))
(declare-fun p1_ack!4595 () (_ BitVec 64))
(declare-fun x1_ack!4598 () (_ BitVec 64))
(declare-fun step_size_ack!4599 () (_ BitVec 64))
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4596))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4597)
                                  ((_ to_fp 11 53) p0_ack!4600)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4599))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!4599)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!4599))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
