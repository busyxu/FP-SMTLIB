(declare-fun p0_ack!6510 () (_ BitVec 64))
(declare-fun x0_ack!6506 () (_ BitVec 64))
(declare-fun p2_ack!6505 () (_ BitVec 64))
(declare-fun p1_ack!6504 () (_ BitVec 64))
(declare-fun x1_ack!6507 () (_ BitVec 64))
(declare-fun step_size_ack!6508 () (_ BitVec 64))
(declare-fun epsabs_ack!6509 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!6505))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6506)
                                  ((_ to_fp 11 53) p0_ack!6510)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6508))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6509)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
