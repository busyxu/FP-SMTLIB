(declare-fun p0_ack!2844 () (_ BitVec 64))
(declare-fun x0_ack!2841 () (_ BitVec 64))
(declare-fun p2_ack!2840 () (_ BitVec 64))
(declare-fun p1_ack!2839 () (_ BitVec 64))
(declare-fun x1_ack!2842 () (_ BitVec 64))
(declare-fun step_size_ack!2843 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2840))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2841)
                                  ((_ to_fp 11 53) p0_ack!2844)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2843))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2840))
            ((_ to_fp 11 53) #x0000000000000000))))
