(declare-fun p0_ack!4288 () (_ BitVec 64))
(declare-fun x0_ack!4285 () (_ BitVec 64))
(declare-fun p2_ack!4284 () (_ BitVec 64))
(declare-fun p1_ack!4283 () (_ BitVec 64))
(declare-fun x1_ack!4286 () (_ BitVec 64))
(declare-fun step_size_ack!4287 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4284))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4285)
                                  ((_ to_fp 11 53) p0_ack!4288)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4287))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!4284))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!4285) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!4284))
