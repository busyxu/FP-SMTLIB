(declare-fun p0_ack!8096 () (_ BitVec 64))
(declare-fun x0_ack!8093 () (_ BitVec 64))
(declare-fun p2_ack!8092 () (_ BitVec 64))
(declare-fun p1_ack!8091 () (_ BitVec 64))
(declare-fun x1_ack!8094 () (_ BitVec 64))
(declare-fun step_size_ack!8095 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!8092))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!8093)
                                  ((_ to_fp 11 53) p0_ack!8096)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!8094)
                                  ((_ to_fp 11 53) p1_ack!8091)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!8095))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!8095)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!8095))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!8093) a!16))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!8092))
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x4000000000000000)
            ((_ to_fp 11 53) p2_ack!8092))
    (fp.sub roundNearestTiesToEven a!16 ((_ to_fp 11 53) p0_ack!8096)))))))))))))
