(declare-fun p0_ack!4204 () (_ BitVec 64))
(declare-fun x0_ack!4201 () (_ BitVec 64))
(declare-fun p2_ack!4200 () (_ BitVec 64))
(declare-fun p1_ack!4199 () (_ BitVec 64))
(declare-fun x1_ack!4202 () (_ BitVec 64))
(declare-fun step_size_ack!4203 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4200))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4201)
                                  ((_ to_fp 11 53) p0_ack!4204)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4203))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!4200))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!4201) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!4200))
...
(let ((a!14 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    (fp.mul roundNearestTiesToEven a!13 a!1))))))
  (FPCHECK_FSUB_ACCURACY a!14 p0_ack!4204)))))))))
