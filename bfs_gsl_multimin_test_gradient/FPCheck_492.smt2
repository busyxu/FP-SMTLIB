(declare-fun p0_ack!5648 () (_ BitVec 64))
(declare-fun x0_ack!5645 () (_ BitVec 64))
(declare-fun p2_ack!5644 () (_ BitVec 64))
(declare-fun p1_ack!5643 () (_ BitVec 64))
(declare-fun x1_ack!5646 () (_ BitVec 64))
(declare-fun step_size_ack!5647 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5644))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5645)
                                  ((_ to_fp 11 53) p0_ack!5648)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5647))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!5647)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!5647))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x0_ack!5645)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x0_ack!5645)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
(assert (let ((a!1 (not (fp.eq ((_ to_fp 11 53) x1_ack!5646)
                       (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) x1_ack!5646)
                               ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!1)))
