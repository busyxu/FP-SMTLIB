(declare-fun p0_ack!5276 () (_ BitVec 64))
(declare-fun x0_ack!5273 () (_ BitVec 64))
(declare-fun p2_ack!5272 () (_ BitVec 64))
(declare-fun p1_ack!5271 () (_ BitVec 64))
(declare-fun x1_ack!5274 () (_ BitVec 64))
(declare-fun step_size_ack!5275 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5272))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5273)
                                  ((_ to_fp 11 53) p0_ack!5276)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5275))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!5272))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq ((_ to_fp 11 53) x0_ack!5273) a!14))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!5272))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.eq (fp.div roundNearestTiesToEven a!6 a!12)
              ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (FPCHECK_FSUB_ACCURACY step_size_ack!5275 #x0000000000000000))
