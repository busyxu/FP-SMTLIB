(declare-fun p0_ack!4420 () (_ BitVec 64))
(declare-fun x0_ack!4417 () (_ BitVec 64))
(declare-fun p2_ack!4416 () (_ BitVec 64))
(declare-fun p1_ack!4415 () (_ BitVec 64))
(declare-fun x1_ack!4418 () (_ BitVec 64))
(declare-fun step_size_ack!4419 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!4416))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4417)
                                  ((_ to_fp 11 53) p0_ack!4420)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4419))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!5)
         ((_ to_fp 11 53) step_size_ack!4419)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) step_size_ack!4419))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
