(declare-fun p0_ack!2778 () (_ BitVec 64))
(declare-fun x0_ack!2775 () (_ BitVec 64))
(declare-fun p2_ack!2774 () (_ BitVec 64))
(declare-fun p1_ack!2773 () (_ BitVec 64))
(declare-fun x1_ack!2776 () (_ BitVec 64))
(declare-fun step_size_ack!2777 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2774))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2775)
                                  ((_ to_fp 11 53) p0_ack!2778)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!2776)
                                  ((_ to_fp 11 53) p1_ack!2773)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2777))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) p2_ack!2774))
            ((_ to_fp 11 53) #x0000000000000000))))
