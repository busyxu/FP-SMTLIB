...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!93) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!93) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!93) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!93) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x4060a4888b1a436e))
                 (fp.mul roundNearestTiesToEven a!1 a!4))
         ((_ to_fp 11 53) #x4060a4888b1a436e)))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fc71eb851eb851f)
