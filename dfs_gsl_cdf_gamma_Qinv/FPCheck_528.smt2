...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!1681) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!1681) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1681) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1681) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!1681) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!1680) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.geq (fp.abs (fp.sub roundNearestTiesToEven
        ...
        (fp.mul roundNearestTiesToEven
                (fp.abs ((_ to_fp 11 53) a_ack!1680))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           ((_ to_fp 11 53) a_ack!1680)))))
  (fp.eq a!1 ((_ to_fp 11 53) a_ack!1680))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1681)
                                   ((_ to_fp 11 53) #x3ff0000000000000))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   a!4
                                   ((_ to_fp 11 53) #x4010000000000000))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!5 ((_ to_fp 11 53) a_ack!1680))
         (fp.add roundNearestTiesToEven
                 a!2
                 (fp.div roundNearestTiesToEven
                         a!4
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   a!4
                                   ((_ to_fp 11 53) #x4010000000000000))))))
  (fp.eq a!6 ((_ to_fp 11 53) a_ack!1680))))))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1681)
                                   ((_ to_fp 11 53) #x3ff0000000000000))
