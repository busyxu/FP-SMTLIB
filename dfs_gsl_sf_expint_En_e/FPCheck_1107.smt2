...
(assert (= #x00000001 a_ack!3004))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3003) ((_ to_fp 11 53) #xc085eeaad5511c64))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!3003) ((_ to_fp 11 53) #xc024000000000000)))
