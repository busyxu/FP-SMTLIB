...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!500) ((_ to_fp 11 53) #x4059000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!500) ((_ to_fp 11 53) #x4085eeaad5511c64)))
