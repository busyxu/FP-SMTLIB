...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2083) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2084) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2083) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2084) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2083) ((_ to_fp 11 53) #x4000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FSUB_OVERFLOW
    #x8000000000000000
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!2084) a!1))))
