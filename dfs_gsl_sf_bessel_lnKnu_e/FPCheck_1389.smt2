...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!37 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW #x3cb0000000000000 a!37))))))))))))))))))))))
