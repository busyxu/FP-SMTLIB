...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1387) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1388) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!1
         (fp.sub roundNearestTiesToEven
                 ((_ to_fp 11 53) a_ack!1388)
                 ((_ to_fp 11 53) #x4000000000000000)))))
(assert (FPCHECK_FMUL_OVERFLOW #x3fe0000000000000 b_ack!1387))
