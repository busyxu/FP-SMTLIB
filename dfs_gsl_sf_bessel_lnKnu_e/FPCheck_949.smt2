...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2737) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2738) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2737) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2738) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2737) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!21 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            a!21)
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven (fp.abs a!22) (fp.abs a!20))
