...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3007) ((_ to_fp 11 53) #x4000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3008) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3007) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3008) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3007) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!34 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW #x3cb0000000000000 a!34))))))))))))))))))))
