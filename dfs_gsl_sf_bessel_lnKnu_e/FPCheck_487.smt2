...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1525) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1526) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   ((_ to_fp 11 53) b_ack!1525))))))
  (FPCHECK_FDIV_ACCURACY (CF_sinh a!2) a!2))))
