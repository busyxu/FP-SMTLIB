...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1809) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1809) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1809) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1810) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
       ...
       ((_ to_fp 11 53) a_ack!1810)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1809) ((_ to_fp 11 53) #x4000000000000000))))
(assert (FPCHECK_FADD_UNDERFLOW #x3ff0000000000000 b_ack!1809))
