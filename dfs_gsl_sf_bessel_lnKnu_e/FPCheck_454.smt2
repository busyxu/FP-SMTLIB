...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1417) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1418) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   ((_ to_fp 11 53) b_ack!1417))))))
  (FPCHECK_FSUB_ACCURACY #xbfe62e42fefa39ef a!1)))
