...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!741) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!741) ((_ to_fp 11 53) #x4020000000000000)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x0000000000000000))
                           ((_ to_fp 11 53) #xbc83ae487d34b2ac)))))
  (FPCHECK_FADD_UNDERFLOW a!6 #xbcbead78ac82afd3))))))))
