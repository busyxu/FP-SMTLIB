...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1457) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1458) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1458) a!1)
    (CF_log (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) b_ack!1457))))))
