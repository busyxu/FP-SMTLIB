...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1471) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1472) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!11 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000))
                            a!10))))
  (fp.gt a!11 ((_ to_fp 11 53) #x40858e42fefa39ef)))))))))
