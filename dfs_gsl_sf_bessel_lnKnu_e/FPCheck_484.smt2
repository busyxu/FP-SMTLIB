...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1513) ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1514) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!2 (CF_sin (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ZERO
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x400921fb54442d18)
            (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1514) a!1))
    a!2))))
