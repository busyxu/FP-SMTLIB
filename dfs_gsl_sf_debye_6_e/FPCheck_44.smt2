...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!81) ((_ to_fp 11 53) #x4041acdd632f662a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!81) ((_ to_fp 11 53) #x4086232bdd7abcd2)))
(assert (FPCHECK_FMUL_ACCURACY #x4086800000000000 a_ack!81))
