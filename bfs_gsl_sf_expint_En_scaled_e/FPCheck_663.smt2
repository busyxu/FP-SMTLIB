...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1812) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1812) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1812) ((_ to_fp 11 53) #x4085eeaad5511c64))))
