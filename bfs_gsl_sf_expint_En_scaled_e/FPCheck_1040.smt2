...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!2769 #x00000000)))
(assert (not (= #x00000000 a_ack!2769)))
(assert (not (= #x00000001 a_ack!2769)))
(assert (not (= #x00000002 a_ack!2769)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvsub #x00000001 a_ack!2769))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvsub #x00000001 a_ack!2769))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!2768) ((_ to_fp 11 53) #x3fd0000000000000)))
