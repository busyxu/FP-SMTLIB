...
(assert (not (bvult (bvmul #x00000002 b_ack!110) a_ack!111)))
(assert (not (bvult (bvsub a_ack!111 b_ack!110) #x00000040)))
(assert (not (bvult a_ack!111 b_ack!110)))
(assert (not (= b_ack!110 a_ack!111)))
(assert (not (= #x00000000 b_ack!110)))
(assert (bvult a_ack!111 (bvmul #x00000002 b_ack!110)))
(assert (not (bvule a_ack!111 #x000000aa)))
