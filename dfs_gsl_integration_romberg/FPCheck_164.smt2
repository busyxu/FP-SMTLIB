(declare-fun epsabs_ack!1380 () (_ BitVec 64))
(declare-fun epsrel_ack!1381 () (_ BitVec 64))
(declare-fun b_ack!1379 () (_ BitVec 64))
(declare-fun a_ack!1382 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1380)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1381)
            ((_ to_fp 11 53) #x0000000000000000))))
