(declare-fun epsabs_ack!624 () (_ BitVec 64))
(declare-fun epsrel_ack!625 () (_ BitVec 64))
(declare-fun b_ack!623 () (_ BitVec 64))
(declare-fun a_ack!626 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!624)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!625)
            ((_ to_fp 11 53) #x0000000000000000))))
