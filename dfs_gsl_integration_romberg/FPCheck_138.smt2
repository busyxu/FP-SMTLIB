(declare-fun epsabs_ack!1156 () (_ BitVec 64))
(declare-fun epsrel_ack!1157 () (_ BitVec 64))
(declare-fun b_ack!1155 () (_ BitVec 64))
(declare-fun a_ack!1158 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1156)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1157)
            ((_ to_fp 11 53) #x0000000000000000))))
