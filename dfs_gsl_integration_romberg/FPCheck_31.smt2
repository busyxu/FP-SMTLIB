(declare-fun epsabs_ack!218 () (_ BitVec 64))
(declare-fun epsrel_ack!219 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun a_ack!220 () (_ BitVec 64))
(declare-fun b_ack!217 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!218)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!219)
            ((_ to_fp 11 53) #x0000000000000000))))
