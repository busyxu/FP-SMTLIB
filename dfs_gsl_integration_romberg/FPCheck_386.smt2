(declare-fun epsabs_ack!3288 () (_ BitVec 64))
(declare-fun epsrel_ack!3289 () (_ BitVec 64))
(declare-fun b_ack!3287 () (_ BitVec 64))
(declare-fun a_ack!3290 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!3288)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3289)
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!24 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            a!22))))
  (not (fp.lt a!24 ((_ to_fp 11 53) epsabs_ack!3288)))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!3287)
...
(let ((a!41 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!39
                                    ((_ to_fp 11 53) #x404f800000000000))))))
  (not (fp.lt a!41 ((_ to_fp 11 53) epsabs_ack!3288))))))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!3287)
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3fe0000000000000))
                   ((_ to_fp 11 53) #x3fe0000000000000))))
  (FPCHECK_FMUL_ACCURACY #x4014000000000000 a!2))))
