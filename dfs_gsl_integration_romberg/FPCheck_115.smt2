(declare-fun epsabs_ack!948 () (_ BitVec 64))
(declare-fun epsrel_ack!949 () (_ BitVec 64))
(declare-fun b_ack!947 () (_ BitVec 64))
(declare-fun a_ack!950 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!948)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!949)
            ((_ to_fp 11 53) #x0000000000000000))))
