...
(declare-fun epsrel_ack!1249 () (_ BitVec 64))
(declare-fun b_ack!1247 () (_ BitVec 64))
(declare-fun a_ack!1250 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1248)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1249)
            ((_ to_fp 11 53) #x0000000000000000))))
