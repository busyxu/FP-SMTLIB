(declare-fun epsabs_ack!1444 () (_ BitVec 64))
(declare-fun epsrel_ack!1445 () (_ BitVec 64))
(declare-fun b_ack!1443 () (_ BitVec 64))
(declare-fun a_ack!1446 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1444)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1445)
            ((_ to_fp 11 53) #x0000000000000000))))
