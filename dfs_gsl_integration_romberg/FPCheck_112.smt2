(declare-fun epsabs_ack!912 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!912)
...
(let ((a!11 (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            a!10)
                    ((_ to_fp 11 53) #x402e000000000000))))
  (FPCHECK_FMUL_UNDERFLOW epsrel_ack!913 (fp.abs a!11)))))))))
