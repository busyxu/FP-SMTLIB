(declare-fun epsabs_ack!1396 () (_ BitVec 64))
(declare-fun epsrel_ack!1397 () (_ BitVec 64))
(declare-fun b_ack!1395 () (_ BitVec 64))
(declare-fun a_ack!1398 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1396)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1397)
            ((_ to_fp 11 53) #x0000000000000000))))
