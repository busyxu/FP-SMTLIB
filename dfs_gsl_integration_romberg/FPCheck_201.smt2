(declare-fun epsabs_ack!1696 () (_ BitVec 64))
(declare-fun epsrel_ack!1697 () (_ BitVec 64))
(declare-fun b_ack!1695 () (_ BitVec 64))
(declare-fun a_ack!1698 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1696)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1697)
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!23 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.div roundNearestTiesToEven a!23 ((_ to_fp 11 53) #x404f800000000000))
    a!22))))))))))))
