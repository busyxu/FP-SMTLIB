...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!810) ((_ to_fp 11 53) #xc085eeaad5511c64))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!810) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!810) ((_ to_fp 11 53) #x4059000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!810) ((_ to_fp 11 53) #x4085eeaad5511c64)))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) #xc038000000000000)
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    ((_ to_fp 11 53) a_ack!810))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) a_ack!810))
                            a!9))))
  (fp.eq a!11 ((_ to_fp 11 53) #xc038000000000000))))))))))))))
