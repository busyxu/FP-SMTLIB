...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3067) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!3068) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3067))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #xffffffff a_ack!3068))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3067))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           a!2))))
  (fp.eq a!3 a!2))))
(assert (let ((a!1 (not (= #x00000000 (bvand (bvadd #x00000001 a_ack!3068) #x00000001))))
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #xc000000000000000)
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
