...
(assert (fp.lt ((_ to_fp 11 53) b_ack!893) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!894) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!893))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #xffffffff a_ack!894))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!893))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    #x3ec71de3a556c734
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3e5ae64567f544e4)))))
