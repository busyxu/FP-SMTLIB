...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3083) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!3084) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3083))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #xffffffff a_ack!3084))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3083))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!3 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!3 a!2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3083) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FSUB_ACCURACY #x8000000000000000 b_ack!3083))
