...
(assert (not (bvslt (bvadd #x00000001 a_ack!572) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!571) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!572) #x00000096)))
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvmul (bvadd #x00000001 a_ack!572) (bvadd #x00000001 a_ack!572)))
  #x3ff0000000000000))
