...
(assert (not (bvslt (bvadd #x00000001 a_ack!150) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!149) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!150)))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!150) #x00000096)))
(assert (FPCHECK_FADD_ACCURACY
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvmul (bvadd #x00000001 a_ack!150) (bvadd #x00000001 a_ack!150)))
  #x3ff0000000000000))
