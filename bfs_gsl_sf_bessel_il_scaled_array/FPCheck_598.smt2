...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2083) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!2084) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!2083))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2084)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
      ...
      (a!3 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32) roundTowardZero (CF_floor a!1)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW (fp.abs a!2) (CF_log a!3)))))
