...
(assert (not (bvslt (bvadd #x00000001 a_ack!4058) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4057) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!4058) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!4058)
                            (bvadd #x00000001 a_ack!4058)))
...
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW #x3ff2033079f466d3 a!1)))
