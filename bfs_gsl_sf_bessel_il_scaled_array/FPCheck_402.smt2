...
(assert (not (bvslt (bvadd #x00000001 a_ack!1432) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1431) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1432)))
(assert (not (= #x00000000 a_ack!1432)))
(assert (= #x00000001 a_ack!1432))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1431) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1431))
            ((_ to_fp 11 53) #x2020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1431))
            ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (let ((a!1 (CF_exp (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xc000000000000000)
                           (fp.abs ((_ to_fp 11 53) b_ack!1431)))))
