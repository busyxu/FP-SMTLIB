...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3137) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!3138) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3137))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3138)))
(assert (not (= #x00000000 a_ack!3138)))
(assert (not (= #x00000001 a_ack!3138)))
