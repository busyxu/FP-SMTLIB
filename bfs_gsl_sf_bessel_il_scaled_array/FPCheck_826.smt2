...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2880) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2880)))
(assert (= #x00000000 a_ack!2880))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2879))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2879))
...
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!2879)))))
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         ((_ to_fp 11 53) #x3cc0000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!2880 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 a_ack!2880))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2879) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2879))
