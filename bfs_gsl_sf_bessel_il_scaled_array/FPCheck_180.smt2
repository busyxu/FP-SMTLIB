...
(assert (not (bvslt (bvadd #x00000001 a_ack!634) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!633) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!634)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32) roundTowardZero (CF_floor a!1)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_ACCURACY #x3fb999999999999a a!2))))
