...
(assert (not (bvslt (bvadd #x00000001 a_ack!1534) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1533) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!1534) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!1534)
                            (bvadd #x00000001 a_ack!1534)))
