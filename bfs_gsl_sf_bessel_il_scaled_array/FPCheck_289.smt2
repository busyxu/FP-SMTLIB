...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1031) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!1032) #x00000000)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!2))))
(assert (not (bvslt (bvadd #x00000001 a_ack!1032) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!1032)
                            (bvadd #x00000001 a_ack!1032)))
