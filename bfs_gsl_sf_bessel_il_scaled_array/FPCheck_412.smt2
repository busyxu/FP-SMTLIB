...
(assert (not (bvslt (bvadd #x00000001 a_ack!1472) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1471) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1472)))
(assert (not (= #x00000000 a_ack!1472)))
(assert (= #x00000001 a_ack!1472))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1471) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1471))
            ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (FPCHECK_FMUL_OVERFLOW #xc000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!1471))))
