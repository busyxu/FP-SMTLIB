...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3289) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!3290) #x00000000)))
...
(assert (not (= #x00000001 a_ack!3290)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!2))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3290) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!3290)
                            (bvadd #x00000001 a_ack!3290)))
