...
(assert (not (bvslt (bvadd #x00000001 a_ack!120) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!119) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!120)))
(assert (not (= #x00000000 a_ack!120)))
(assert (not (= #x00000001 a_ack!120)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!119))
...
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!120))
  #x3ff8000000000000))
