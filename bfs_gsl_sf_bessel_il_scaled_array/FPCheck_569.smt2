...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1975) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!1976) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!1975))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #xffffffff a_ack!1976))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!1975))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (not (= #x00000000 (bvand (bvadd #x00000001 a_ack!1976) #x00000001))))
