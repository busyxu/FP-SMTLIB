...
(assert (not (bvslt (bvadd #x00000001 a_ack!3010) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3009) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3010)))
(assert (= #x00000000 a_ack!3010))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3009) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3009))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3009))
...
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!3009)))))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!3009)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!3009)))
                   (fp.abs ((_ to_fp 11 53) b_ack!3009)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!3009)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!3009)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
