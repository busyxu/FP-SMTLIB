...
(assert (not (bvslt (bvadd #x00000001 a_ack!2868) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2867) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2868)))
(assert (= #x00000000 a_ack!2868))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2867) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2867))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2867))
...
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!2867)))))
...
(assert (FPCHECK_FMUL_OVERFLOW #xc000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!2867))))
