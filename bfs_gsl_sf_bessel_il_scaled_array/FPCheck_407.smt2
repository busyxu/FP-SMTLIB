...
(assert (not (bvslt (bvadd #x00000001 a_ack!1452) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1451) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1452)))
(assert (not (= #x00000000 a_ack!1452)))
(assert (= #x00000001 a_ack!1452))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1451) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (CF_exp (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!1451)))))
...
(let ((a!5 (fp.abs (fp.div roundNearestTiesToEven
                           ...
                           a!4))))
  (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 a!5)))))
