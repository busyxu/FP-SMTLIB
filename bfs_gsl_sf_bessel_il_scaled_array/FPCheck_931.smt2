...
(assert (not (bvslt (bvadd #x00000001 a_ack!3268) #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3267))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3268)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!2))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3268) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!3268)
                            (bvadd #x00000001 a_ack!3268)))
