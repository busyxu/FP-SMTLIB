...
(assert (not (bvslt (bvadd #x00000001 a_ack!2508) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2507) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2508)))
(assert (not (= #x00000000 a_ack!2508)))
(assert (= #x00000001 a_ack!2508))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2507) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2507))
...
(assert (let ((a!1 (CF_exp (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!2507))))))
