...
(assert (not (bvslt (bvadd #x00000001 a_ack!2550) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2549) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2550)))
(assert (not (= #x00000000 a_ack!2550)))
(assert (= #x00000001 a_ack!2550))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2549) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2549))
...
(assert (FPCHECK_FMUL_OVERFLOW
  (fp.abs ((_ to_fp 11 53) b_ack!2549))
  (fp.abs ((_ to_fp 11 53) b_ack!2549))))
