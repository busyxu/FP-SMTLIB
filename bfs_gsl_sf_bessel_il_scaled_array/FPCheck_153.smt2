...
(assert (not (bvslt (bvadd #x00000001 a_ack!564) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!563) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!564)))
...
(assert (FPCHECK_FMUL_ACCURACY #xc000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!563))))
