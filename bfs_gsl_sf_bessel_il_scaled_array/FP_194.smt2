...
(assert (not (bvslt (bvadd #x00000001 a_ack!2736) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2735) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2736)))
(assert (not (= #x00000000 a_ack!2736)))
(assert (not (= #x00000001 a_ack!2736)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2735))
