...
(assert (not (bvslt (bvadd #x00000001 a_ack!156) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!155) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!156)))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!156) #x00000096)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul (bvadd #x00000001 a_ack!156)
                            (bvadd #x00000001 a_ack!156)))
