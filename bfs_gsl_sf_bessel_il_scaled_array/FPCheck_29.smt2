...
(assert (not (bvslt (bvadd #x00000001 a_ack!124) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!123) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!124)))
(assert (not (= #x00000000 a_ack!124)))
(assert (not (= #x00000001 a_ack!124)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!123))
...
(assert (FPCHECK_FADD_ACCURACY
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!124))
  #x3ff8000000000000))
