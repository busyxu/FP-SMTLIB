...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2312) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2311))
            ((_ to_fp 11 53) #x3f947ae147ae147b))))
(assert (fp.gt ((_ to_fp 11 53) c_ack!2311) ((_ to_fp 11 53) #xc3045f306dc9c883)))
