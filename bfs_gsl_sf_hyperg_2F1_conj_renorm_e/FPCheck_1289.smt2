...
(declare-fun c_ack!5321 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (fp.lt ((_ to_fp 11 53) a_ack!5322) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5321) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) c_ack!5321)
