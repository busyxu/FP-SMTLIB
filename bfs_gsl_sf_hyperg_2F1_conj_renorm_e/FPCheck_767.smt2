...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2793))
            ((_ to_fp 11 53) #x3f947ae147ae147b))))
(assert (fp.gt ((_ to_fp 11 53) c_ack!2793) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) c_ack!2793)))
       ((_ to_fp 11 53) c_ack!2793)))
(assert (FPCHECK_FMUL_ACCURACY #x400921fb54442d18 c_ack!2793))
