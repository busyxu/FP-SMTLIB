...
(assert (not (bvslt (bvadd #x00000001 a_ack!682) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!681) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!682)))
(assert (= #x00000000 a_ack!682))
(assert (fp.eq ((_ to_fp 11 53) b_ack!681) ((_ to_fp 11 53) #x0000000000000000)))
