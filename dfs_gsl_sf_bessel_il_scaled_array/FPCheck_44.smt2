...
(assert (not (bvslt (bvadd #x00000001 a_ack!164) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!163) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!164)))
(assert (= #x00000000 a_ack!164))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!163) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!163))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!163))
...
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!163))
    #x4008000000000000)))
