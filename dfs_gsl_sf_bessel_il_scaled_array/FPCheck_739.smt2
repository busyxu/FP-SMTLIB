...
(declare-fun a_ack!2662 () (_ BitVec 32))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!2662) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2661) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2662)))
(assert (not (= #x00000000 a_ack!2662)))
(assert (not (= #x00000001 a_ack!2662)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2661))
...
(assert (bvslt (bvadd #x00000001 a_ack!2662) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2661))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2661)))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!2661))
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x4000000000000000)))
                   (fp.div roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!1
                           ((_ to_fp 11 53) #x4010000000000000)))))
  (not (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!2661)))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    a!23)))))
  (not (fp.eq (fp.abs a!24) ((_ to_fp 11 53) #x0000000000000000))))))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!25 (fp.div roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!23))
                    a!24)))
  (not (fp.eq (fp.abs a!25) ((_ to_fp 11 53) #x0000000000000000)))))))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!24 (fp.div roundNearestTiesToEven
      ...
      (a!29 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!28 a!11)
                                    (fp.mul roundNearestTiesToEven a!11 a!14))
                            (fp.mul roundNearestTiesToEven
                                    (fp.mul roundNearestTiesToEven a!11 a!14)
                                    a!17))
...
(let ((a!30 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.mul roundNearestTiesToEven a!21 a!24)
                                    a!27)))))
  (not (fp.lt (fp.abs a!30) ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
