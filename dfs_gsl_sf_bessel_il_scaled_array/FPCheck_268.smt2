...
(assert (not (bvslt (bvadd #x00000001 a_ack!968) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!967) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!968)))
(assert (not (= #x00000000 a_ack!968)))
(assert (not (= #x00000001 a_ack!968)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!967))
...
(assert (bvslt (bvadd #x00000001 a_ack!968) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!967))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!967)))
