...
(assert (not (bvslt (bvadd #x00000001 a_ack!576) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!575) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!576)))
(assert (= #x00000000 a_ack!576))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!575) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!575))
       ((_ to_fp 11 53) #x403205966f2b4f12)))
(assert (let ((a!1 (CF_exp (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xc000000000000000)
                           (fp.abs ((_ to_fp 11 53) b_ack!575))))))
