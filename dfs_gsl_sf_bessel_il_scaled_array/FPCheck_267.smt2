...
(assert (not (bvslt (bvadd #x00000001 a_ack!964) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!964)))
...
(assert (bvslt (bvadd #x00000001 a_ack!964) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!963))
            ((_ to_fp 11 53) #x0000000000000000))))
