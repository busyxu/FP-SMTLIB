...
(assert (not (bvslt (bvadd #x00000001 a_ack!770) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!769) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!770)))
...
(assert (bvslt (bvadd #x00000001 a_ack!770) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!769))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!769)))
                  ((_ to_fp 11 53) #x3fc999999999999a))))
  (not a!1)))
(assert (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!769)))
       ((_ to_fp 11 53) #x403205966f2b4f12)))
(assert (FPCHECK_FMUL_OVERFLOW
  #xc000000000000000
  (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!769)))))
