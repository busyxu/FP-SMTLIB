...
(assert (not (bvslt (bvadd #x00000001 a_ack!2576) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2575) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt (bvadd #x00000001 a_ack!2576) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2575))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2575)))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!2575))
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x4000000000000000)))
                   (fp.div roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!1
                           ((_ to_fp 11 53) #x4010000000000000)))))
  (not (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!2575)))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
