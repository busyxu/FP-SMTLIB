...
(assert (not (bvslt (bvadd #x00000001 a_ack!262) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!261) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!262)))
(assert (= #x00000000 a_ack!262))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!261) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!261)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!261)))
                   (fp.abs ((_ to_fp 11 53) b_ack!261)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!261)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!261)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           a!1))))
  (FPCHECK_FADD_ACCURACY #x3f2a01a01a01a01a a!2))))
