...
(assert (not (bvslt (bvadd #x00000001 a_ack!348) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!347) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!348)))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!347)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!347)))
                   (fp.abs ((_ to_fp 11 53) b_ack!347)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!347)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!347)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.abs ((_ to_fp 11 53) b_ack!347)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!347)))))
(assert (bvult (bvmul #x0000000000000008 ((_ sign_extend 32) a_ack!348))
       #x0000000000000319))
