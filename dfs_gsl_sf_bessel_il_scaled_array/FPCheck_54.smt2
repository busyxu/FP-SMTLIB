...
(assert (not (bvslt (bvadd #x00000001 a_ack!204) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!203) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!204)))
...
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!203))))
