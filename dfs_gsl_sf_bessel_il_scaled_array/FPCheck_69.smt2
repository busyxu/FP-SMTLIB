...
(assert (not (bvslt (bvadd #x00000001 a_ack!258) #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!257) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!258)))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!257)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!257)))
                   (fp.abs ((_ to_fp 11 53) b_ack!257)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!257)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!257)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
