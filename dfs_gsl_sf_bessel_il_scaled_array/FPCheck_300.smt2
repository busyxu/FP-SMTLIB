...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1063))
...
(assert (bvslt (bvadd #x00000001 a_ack!1064) #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1063))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!1063)))
