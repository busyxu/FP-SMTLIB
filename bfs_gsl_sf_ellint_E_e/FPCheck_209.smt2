...
(declare-fun c_ack!1244 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!1244 #x00000007)))
       #x0000000000000011))
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             (fp.div roundNearestTiesToEven
                                     ((_ to_fp 11 53) a_ack!1245)
...
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3fe0000000000000))))
      (a!6 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!1244 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!1245)
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x3fd0000000000000)))))
  (FPCHECK_FADD_UNDERFLOW a!6 #x7ff0000000000001)))))))
