...
(assert (fp.leq ((_ to_fp 11 53) b_ack!287) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #x408f400000000000)))
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 a_ack!288))
