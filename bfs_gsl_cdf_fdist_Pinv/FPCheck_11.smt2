...
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!46) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!47) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!48) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!48) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!48) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) #x4000000000000000))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq ((_ to_fp 11 53) x_ack!48) ((_ to_fp 11 53) #x0000000000000000)))
