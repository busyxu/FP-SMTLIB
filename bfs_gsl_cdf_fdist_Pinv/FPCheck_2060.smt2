...
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!10190)
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!10191) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!10191) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!10191) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) x_ack!10191) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ff0000000000000)
                    ((_ to_fp 11 53) x_ack!10191))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!24 (CF_exp (fp.div roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) nu2_ack!10190)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 a!24)))))))))
