...
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!1168) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!1169) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) x_ack!1170) ((_ to_fp 11 53) #x3fe0000000000000)))
