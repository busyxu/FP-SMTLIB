(declare-fun a_ack!3048 () (_ BitVec 32))
...
(assert (not (bvslt a_ack!3048 #x00000000)))
...
(assert (not (= #x00000000 a_ack!3048)))
(assert (not (= #x00000001 a_ack!3048)))
(assert (not (= #x00000002 a_ack!3048)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd (bvmul a_ack!3048 a_ack!3048) a_ack!3048))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) #x3f20000000000000)
                      ((_ to_fp 11 53) b_ack!3047))
              a!1))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3048)
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3047) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3048)
                     ((_ to_fp 11 53) #x3fe0000000000000))
...
(let ((a!12 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 a!12)))))))))
