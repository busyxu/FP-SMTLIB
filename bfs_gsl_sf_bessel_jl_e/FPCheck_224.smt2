...
(assert (= #x00000001 a_ack!788))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!787) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!787))
            ((_ to_fp 11 53) #x0028cccccccccccd))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!787))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) #x3ea937e11175f095))))
(assert (FPCHECK_FDIV_ACCURACY b_ack!787 #x4008000000000000))
