...
(assert (not (= #x00000001 a_ack!1132)))
(assert (= #x00000002 a_ack!1132))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1131) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1131))
            ((_ to_fp 11 53) #x2020000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1131))
