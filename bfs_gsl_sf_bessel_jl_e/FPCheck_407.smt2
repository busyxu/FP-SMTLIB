...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!1294 #x00000000)))
...
(assert (not (= #x00000000 a_ack!1294)))
(assert (not (= #x00000001 a_ack!1294)))
(assert (not (= #x00000002 a_ack!1294)))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1294)
                    ((_ to_fp 11 53) #x3fe0000000000000))
