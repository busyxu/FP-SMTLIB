...
(assert (let ((a!1 (fp.gt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (bvsle #x00000001 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.gt (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) b_ack!896)))
                  ((_ to_fp 11 53) #x7fefffffffffffff))))
  (not a!1)))
(assert (bvsle #x00000002 (bvadd #xffffffff a_ack!897)))
...
(assert (let ((a!1 (fp.gt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (bvsle #x00000003 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000004 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000005 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000006 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000007 (bvadd #xffffffff a_ack!897)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
