...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!140))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!140)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!140)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!140)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!139)))))
