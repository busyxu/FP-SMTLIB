...
(assert (fp.eq ((_ to_fp 11 53) c_ack!3725) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3724) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!3724) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!3724)
                          ((_ to_fp 11 53) #x0000000000000000))
                  #x00000001
                  #xffffffff))))
...
(let ((a!8 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!3724)))
                   (fp.abs ((_ to_fp 11 53) b_ack!3724)))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) b_ack!3724)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!3724))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) #x400921fb54442d18)
