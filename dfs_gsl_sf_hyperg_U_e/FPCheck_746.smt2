...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) c_ack!3998) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!3997) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!2 (bvsub #x00000000
                  ((_ fp.to_sbv 32)
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!1
                            ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_ACCURACY a!1 ((_ to_fp 11 53) roundNearestTiesToEven a!2)))))
