...
(assert (= #x00000001 a_ack!314))
(assert (bvsle #x00000000 a_ack!314))
(assert (bvsle #x00000001 a_ack!314))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!313)
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!314)
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3e50000000000000))))
  (not a!2))))
(assert (FPCHECK_FADD_ACCURACY #x3ff0000000000000 c_ack!313))
