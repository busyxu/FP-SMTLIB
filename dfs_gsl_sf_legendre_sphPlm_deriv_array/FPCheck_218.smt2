...
(assert (not (bvslt a_ack!1193 b_ack!1191)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1192) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1192) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (= #x00000000 b_ack!1191))
...
(assert (bvsle #x0000000a a_ack!1193))
