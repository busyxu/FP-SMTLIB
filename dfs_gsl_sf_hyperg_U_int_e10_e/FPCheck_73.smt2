...
(assert (not (= #xffffffff (bvsub a_ack!342 b_ack!340))))
(assert (not (= #xfffffffe (bvsub a_ack!342 b_ack!340))))
(assert (not (= (bvsub #x00000002 b_ack!340)
        (bvadd #x00000002 (bvsub a_ack!342 b_ack!340)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!342 b_ack!340))))))
...
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!342 b_ack!340)) #x00000000)))
