(declare-fun c_ack!4328 () (_ BitVec 64))
(declare-fun b_ack!4327 () (_ BitVec 32))
(declare-fun a_ack!4329 () (_ BitVec 32))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4328) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4328) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4328) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!4327)))
(assert (not (= #xffffffff (bvsub a_ack!4329 b_ack!4327))))
(assert (not (= #xfffffffe (bvsub a_ack!4329 b_ack!4327))))
(assert (not (= (bvsub #x00000002 b_ack!4327)
        (bvadd #x00000002 (bvsub a_ack!4329 b_ack!4327)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4329 b_ack!4327))))))
...
(let ((a!2 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000002 b_ack!4327))))))
  (not (fp.gt a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fefae147ae147ae)
                          (fp.abs ((_ to_fp 11 53) c_ack!4328))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4329 b_ack!4327))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4014000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4327) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4328) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4329 b_ack!4327))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4327) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4328) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!4329 b_ack!4327)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!4327))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!4328))))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub #x00000002 b_ack!4327))
             ((_ to_fp 11 53) c_ack!4328))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
...
(let ((a!18 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4024000000000000))
                            a!15)
                    (fp.mul roundNearestTiesToEven a!17 a!12))))
(let ((a!21 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4028000000000000))
                            a!18)
                    (fp.mul roundNearestTiesToEven a!20 a!15))))
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    a!5
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4030000000000000))
                            a!24)
                    (fp.mul roundNearestTiesToEven a!26 a!21))))
(let ((a!30 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4032000000000000))
                            a!27)
                    (fp.mul roundNearestTiesToEven a!29 a!24))))
(let ((a!33 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4034000000000000))
                            a!30)
                    (fp.mul roundNearestTiesToEven a!32 a!27))))
(let ((a!36 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    a!5
                                    ((_ to_fp 11 53) #x4036000000000000))
                            a!33)
                    (fp.mul roundNearestTiesToEven a!35 a!30))))
(let ((a!39 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4038000000000000))
                            a!36)
                    (fp.mul roundNearestTiesToEven a!38 a!33))))
(let ((a!42 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x403a000000000000))
                            a!39)
                    (fp.mul roundNearestTiesToEven a!41 a!36))))
(let ((a!45 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x403c000000000000))
                            a!42)
                    (fp.mul roundNearestTiesToEven a!44 a!39))))
(let ((a!48 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    a!5
                                    ((_ to_fp 11 53) #x403e000000000000))
                            a!45)
                    (fp.mul roundNearestTiesToEven a!47 a!42))))
(let ((a!51 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4040000000000000))
                            a!48)
                    (fp.mul roundNearestTiesToEven a!50 a!45))))
(let ((a!54 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4041000000000000))
                            a!51)
                    (fp.mul roundNearestTiesToEven a!53 a!48))))
(let ((a!57 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4042000000000000))
                            a!54)
                    (fp.mul roundNearestTiesToEven a!56 a!51))))
  (FPCHECK_FMUL_OVERFLOW a!3 a!57))))))))))))))))))))))
