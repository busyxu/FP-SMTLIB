...
(assert (not (bvsle #x00000001 b_ack!415)))
(assert (not (= #xffffffff (bvsub a_ack!417 b_ack!415))))
(assert (not (= #xfffffffe (bvsub a_ack!417 b_ack!415))))
(assert (not (= (bvsub #x00000002 b_ack!415)
        (bvadd #x00000002 (bvsub a_ack!417 b_ack!415)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!417 b_ack!415))))))
