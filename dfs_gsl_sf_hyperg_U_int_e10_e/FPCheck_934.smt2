...
(declare-fun b_ack!2965 () (_ BitVec 32))
(declare-fun a_ack!2967 () (_ BitVec 32))
(declare-fun FPCHECK_FDIV_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2966) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2966) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2966) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!2965)))
(assert (not (= #xffffffff (bvsub a_ack!2967 b_ack!2965))))
(assert (not (= #xfffffffe (bvsub a_ack!2967 b_ack!2965))))
(assert (not (= (bvsub #x00000002 b_ack!2965)
        (bvadd #x00000002 (bvsub a_ack!2967 b_ack!2965)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!2967 b_ack!2965))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!2965) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2966) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!2967 b_ack!2965))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!2965) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2966) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!2967 b_ack!2965)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!2965))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!2966))))))
...
(let ((a!40 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW a!40 a!53)))))))))))))))))
