...
(declare-fun b_ack!3517 () (_ BitVec 32))
...
(assert (not (bvsle #x00000001 b_ack!3517)))
(assert (not (= #xffffffff (bvsub a_ack!3519 b_ack!3517))))
(assert (not (= #xfffffffe (bvsub a_ack!3519 b_ack!3517))))
(assert (not (= (bvsub #x00000002 b_ack!3517)
        (bvadd #x00000002 (bvsub a_ack!3519 b_ack!3517)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3519 b_ack!3517))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3517) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3518) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3519 b_ack!3517))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3517) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3518) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3519 b_ack!3517)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3517))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3518))))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub #x00000002 b_ack!3517))
             ((_ to_fp 11 53) c_ack!3518))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
