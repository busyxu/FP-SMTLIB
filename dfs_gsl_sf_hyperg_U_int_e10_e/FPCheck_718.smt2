...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2318) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2318) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!2317)))
(assert (not (= #xffffffff (bvsub a_ack!2319 b_ack!2317))))
(assert (not (= #xfffffffe (bvsub a_ack!2319 b_ack!2317))))
(assert (not (= (bvsub #x00000002 b_ack!2317)
        (bvadd #x00000002 (bvsub a_ack!2319 b_ack!2317)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!2319 b_ack!2317))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!2317) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2318) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!2319 b_ack!2317))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!2317) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2318) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!2319 b_ack!2317)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!2317))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!2318))))))
...
(let ((a!27 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!3 a!27))))))))))))
