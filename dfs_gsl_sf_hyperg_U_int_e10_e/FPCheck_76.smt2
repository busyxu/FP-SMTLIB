...
(assert (not (bvsle #x00000001 b_ack!349)))
(assert (not (= #xffffffff (bvsub a_ack!351 b_ack!349))))
(assert (not (= #xfffffffe (bvsub a_ack!351 b_ack!349))))
(assert (not (= (bvsub #x00000002 b_ack!349)
        (bvadd #x00000002 (bvsub a_ack!351 b_ack!349)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!351 b_ack!349))))))
...
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!351 b_ack!349)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!351 b_ack!349))))))
  (FPCHECK_FADD_UNDERFLOW a!1 c_ack!350)))
