...
(assert (not (bvsle #x00000001 b_ack!3247)))
(assert (not (= #xffffffff (bvsub a_ack!3249 b_ack!3247))))
(assert (not (= #xfffffffe (bvsub a_ack!3249 b_ack!3247))))
(assert (not (= (bvsub #x00000002 b_ack!3247)
        (bvadd #x00000002 (bvsub a_ack!3249 b_ack!3247)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3249 b_ack!3247))))))
...
(let ((a!2 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000002 b_ack!3247))))))
  (not (fp.gt a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fefae147ae147ae)
                          (fp.abs ((_ to_fp 11 53) c_ack!3248))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3249 b_ack!3247))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4014000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3247) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3248) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3249 b_ack!3247))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3247) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3248) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3249 b_ack!3247)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3247))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3248))))))
