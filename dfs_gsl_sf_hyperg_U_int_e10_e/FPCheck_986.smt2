...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!3121)))
(assert (not (= #xffffffff (bvsub a_ack!3123 b_ack!3121))))
(assert (not (= #xfffffffe (bvsub a_ack!3123 b_ack!3121))))
(assert (not (= (bvsub #x00000002 b_ack!3121)
        (bvadd #x00000002 (bvsub a_ack!3123 b_ack!3121)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3123 b_ack!3121))))))
...
(let ((a!2 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000002 b_ack!3121))))))
  (not (fp.gt a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fefae147ae147ae)
                          (fp.abs ((_ to_fp 11 53) c_ack!3122))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3123 b_ack!3121))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4014000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3121) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3122) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3123 b_ack!3121))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3121) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3122) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3123 b_ack!3121)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3121))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3122))))))
...
(let ((a!39 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!3 a!39))))))))))))))))
