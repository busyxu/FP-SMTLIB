...
(assert (not (bvsle #x00000001 b_ack!1057)))
(assert (not (= #xffffffff (bvsub a_ack!1059 b_ack!1057))))
(assert (not (= #xfffffffe (bvsub a_ack!1059 b_ack!1057))))
(assert (not (= (bvsub #x00000002 b_ack!1057)
        (bvadd #x00000002 (bvsub a_ack!1059 b_ack!1057)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!1059 b_ack!1057))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!1057) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1058) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!1059 b_ack!1057))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!1057) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1058) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!1059 b_ack!1057)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!1057))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1058))))))
