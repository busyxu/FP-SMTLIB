...
(assert (not (bvsle #x00000001 b_ack!355)))
(assert (not (= #xffffffff (bvsub a_ack!357 b_ack!355))))
(assert (not (= #xfffffffe (bvsub a_ack!357 b_ack!355))))
(assert (not (= (bvsub #x00000002 b_ack!355)
        (bvadd #x00000002 (bvsub a_ack!357 b_ack!355)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!357 b_ack!355))))))
...
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!357 b_ack!355)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!356))
                 a!1)
