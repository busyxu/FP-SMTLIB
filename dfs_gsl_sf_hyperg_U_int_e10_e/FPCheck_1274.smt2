...
(declare-fun b_ack!3985 () (_ BitVec 32))
(declare-fun a_ack!3987 () (_ BitVec 32))
...
(assert (not (bvsle #x00000001 b_ack!3985)))
(assert (not (= #xffffffff (bvsub a_ack!3987 b_ack!3985))))
(assert (not (= #xfffffffe (bvsub a_ack!3987 b_ack!3985))))
(assert (not (= (bvsub #x00000002 b_ack!3985)
        (bvadd #x00000002 (bvsub a_ack!3987 b_ack!3985)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3987 b_ack!3985))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3985) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3986) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3987 b_ack!3985))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3985) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3986) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3987 b_ack!3985)) #x00000000)))
