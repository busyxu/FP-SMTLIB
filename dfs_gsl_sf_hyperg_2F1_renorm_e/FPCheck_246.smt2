...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) c_ack!1457) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1457) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1457))
...
(assert (let ((a!1 (fp.gt (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!1458) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) d_ack!1458))))
(assert (fp.eq (fp.add roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) c_ack!1457)
                       ((_ to_fp 11 53) b_ack!1456))
...
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) a_ack!1459)))
       ((_ to_fp 11 53) #x3d4f400000000000)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) d_ack!1458))
            ((_ to_fp 11 53) #x3f48406003b2ae5a))))
(assert (FPCHECK_FSUB_ACCURACY #x3ff0000000000000 d_ack!1458))
