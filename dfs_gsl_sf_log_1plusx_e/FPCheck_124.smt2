...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!181) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!181))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!181)
                                   a!4)))))
  (FPCHECK_FADD_OVERFLOW #xbfe0000000000000 a!5)))))))
