...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!173) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!173))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    #x3fd5555555555555
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!173) a!4)))))))
