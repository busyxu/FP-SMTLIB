...
(assert (fp.lt ((_ to_fp 11 53) x_ack!255) ((_ to_fp 11 53) x0_ack!257)))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!256) ((_ to_fp 11 53) y0_ack!254))))
(assert (not (fp.geq ((_ to_fp 11 53) y_ack!256) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq (fp.add roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) x1_ack!253)
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) x0_ack!257)))
       ((_ to_fp 11 53) x0_ack!257)))
(assert (FPCHECK_FSUB_ACCURACY #x3ff0000000000000 y0_ack!254))
