...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!782) ((_ to_fp 11 53) x1_ack!780))))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!783) ((_ to_fp 11 53) y0_ack!781))))
(assert (not (fp.gt ((_ to_fp 11 53) y_ack!783) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!782) ((_ to_fp 11 53) x0_ack!784))))
(assert (fp.geq ((_ to_fp 11 53) x_ack!782) ((_ to_fp 11 53) x1_ack!780)))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!783) ((_ to_fp 11 53) y0_ack!781))))
(assert (not (fp.geq ((_ to_fp 11 53) y_ack!783) ((_ to_fp 11 53) #x3ff0000000000000))))
