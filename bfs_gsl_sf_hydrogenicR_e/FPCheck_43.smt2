...
(assert (not (bvslt a_ack!297 #x00000001)))
(assert (not (bvslt (bvadd #xffffffff a_ack!297) b_ack!294)))
...
(assert (not (bvule (bvadd a_ack!297 b_ack!294) #x000000aa)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp_unsigned 11 53)
                             roundNearestTiesToEven
                             (bvadd a_ack!297 b_ack!294))
