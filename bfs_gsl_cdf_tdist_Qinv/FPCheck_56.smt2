...
(declare-fun mu_ack!228 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!228) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!228) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                  ...
                  (CF_pow #x3fa999999999999a
                          (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) mu_ack!228)
                                  ((_ to_fp 11 53) #x4000000000000000))))))
  (not a!1)))
(assert (FPCHECK_FDIV_ACCURACY mu_ack!228 #x4000000000000000))
