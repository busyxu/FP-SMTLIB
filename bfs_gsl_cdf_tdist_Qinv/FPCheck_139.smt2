...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!530) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!530) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!531) ((_ to_fp 11 53) #x3fe0000000000000)))
