...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!45) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!45) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FDIV_OVERFLOW mu_ack!45 #x4000000000000000))
