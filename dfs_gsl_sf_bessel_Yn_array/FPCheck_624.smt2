...
(assert (not (= #x00000001 a_ack!2957)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2956) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2956) ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                  ...
                  (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53)
                            ...
                            (bvmul a_ack!2957 a_ack!2957))
                          ((_ to_fp 11 53) #x3ff0000000000000)))))
  (not a!1)))
(assert (bvslt #x00000032 a_ack!2957))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2956) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2957)
...
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) c_ack!2956)
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2957))
       ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xc07c700000000000)
                                   a!3)))))
  (FPCHECK_FADD_ACCURACY a!4 #x3f793a7553f0e104))))))
