...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4273) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4273) ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                  ...
                  (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53)
                            ...
                            (bvmul a_ack!4274 a_ack!4274))
                          ((_ to_fp 11 53) #x3ff0000000000000)))))
  (not a!1)))
(assert (bvslt #x00000032 a_ack!4274))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4273) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!4274)
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!4273)
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!4274)))))
