...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1024) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1024) ((_ to_fp 11 53) #x001922d0e5604189))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1024) ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1024) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1024) ((_ to_fp 11 53) #x4330000000000000)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x0000000000000000))
                           ((_ to_fp 11 53) #xbc8cd2b297d889bc)))))
  (FPCHECK_FADD_OVERFLOW a!6 #xbcbc1a3aeda65317))))))))
