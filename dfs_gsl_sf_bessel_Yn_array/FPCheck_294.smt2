...
(assert (= #x00000001 a_ack!1184))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1183) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1183) ((_ to_fp 11 53) #x001922d0e5604189))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1183) ((_ to_fp 11 53) #x3e60000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1183) ((_ to_fp 11 53) #x4010000000000000)))
