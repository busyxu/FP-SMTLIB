...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2944) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2944) ((_ to_fp 11 53) #x4014000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (bvslt #x00000032 a_ack!2945))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2944) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2945)
...
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) c_ack!2944)
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2945))
       ((_ to_fp 11 53) #x3ff0000000000000)))
