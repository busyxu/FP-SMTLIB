...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!130) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!131 #x00000000)))
(assert (= #x00000000 a_ack!131))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!130) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!130) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!130) ((_ to_fp 11 53) #x4330000000000000)))
