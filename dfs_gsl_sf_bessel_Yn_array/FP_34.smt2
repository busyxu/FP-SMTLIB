...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1072) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1072) ((_ to_fp 11 53) #x001922d0e5604189))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1072) ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1072) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1072) ((_ to_fp 11 53) #x4330000000000000)))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven (fp.abs a!5) a!6))))
  (fp.eq a!7 ((_ to_fp 11 53) #x3cbc1a3aeda65317)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4040000000000000)
                           (fp.mul roundNearestTiesToEven
