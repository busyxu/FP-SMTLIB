...
(declare-fun m_ack!45 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.isNaN (fp.abs (fp.add roundNearestTiesToEven
      ...
      (a!2 (fp.eq (fp.abs (fp.add roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x7ff0000000000000))))
  (not (or a!1 a!2))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!43) ((_ to_fp 11 53) b_ack!44))))
(assert (not (fp.geq ((_ to_fp 11 53) m_ack!45) ((_ to_fp 11 53) b_ack!44))))
