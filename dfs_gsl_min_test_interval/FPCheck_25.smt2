...
(declare-fun m_ack!186 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.isNaN (fp.abs (fp.add roundNearestTiesToEven
      ...
      (a!2 (fp.eq (fp.abs (fp.add roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x7ff0000000000000))))
  (not (or a!1 a!2))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!184) ((_ to_fp 11 53) b_ack!185))))
(assert (not (fp.geq ((_ to_fp 11 53) m_ack!186) ((_ to_fp 11 53) b_ack!185))))
(assert (not (fp.leq ((_ to_fp 11 53) m_ack!186) ((_ to_fp 11 53) a_ack!184))))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) a_ack!184)))
       ((_ to_fp 11 53) a_ack!184)))
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!185 m_ack!186))
