...
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!281 b_ack!279))
...
(assert (bvsle #x00000001 b_ack!279))
(assert (not (bvsle #x00000002 b_ack!279)))
(assert (FPCHECK_FMUL_ACCURACY
  c_ack!280
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 (bvmul #x00000002 b_ack!279)))))
