...
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!338 b_ack!336))
...
(assert (bvsle #x00000001 b_ack!336))
(assert (not (bvsle #x00000002 b_ack!336)))
(assert (= a_ack!338 b_ack!336))
