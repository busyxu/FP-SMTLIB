...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!827 b_ack!825))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!827 b_ack!825))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!827 b_ack!825))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (= a_ack!827 b_ack!825)))
(assert (not (= a_ack!827 (bvadd #x00000001 b_ack!825))))
(assert (bvsle (bvadd #x00000002 b_ack!825) a_ack!827))
(assert (bvsle (bvadd #x00000003 b_ack!825) a_ack!827))
