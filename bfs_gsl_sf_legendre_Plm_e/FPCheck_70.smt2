...
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!314 b_ack!312))
...
(assert (bvsle #x00000001 b_ack!312))
(assert (not (bvsle #x00000002 b_ack!312)))
(assert (= a_ack!314 b_ack!312))
