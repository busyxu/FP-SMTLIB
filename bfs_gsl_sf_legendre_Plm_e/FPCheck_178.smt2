...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!926 b_ack!924))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!926 b_ack!924))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!926 b_ack!924))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle (bvadd #x00000004 b_ack!924) a_ack!926))
(assert (bvsle (bvadd #x00000005 b_ack!924) a_ack!926))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000005 b_ack!924))))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!925 a!1)))
