...
(assert (not (= a_ack!671 (bvadd #x00000001 b_ack!669))))
(assert (bvsle (bvadd #x00000002 b_ack!669) a_ack!671))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000002 b_ack!669)))))
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) c_ack!670)
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvmul #x00000002 b_ack!669))))))
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!670) a!1)
