...
(assert (bvsle (bvadd #x00000005 b_ack!1122) a_ack!1124))
(assert (bvsle (bvadd #x00000006 b_ack!1122) a_ack!1124))
(assert (bvsle (bvadd #x00000007 b_ack!1122) a_ack!1124))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000007 b_ack!1122))))))
  (FPCHECK_FMUL_ACCURACY c_ack!1123 a!1)))
