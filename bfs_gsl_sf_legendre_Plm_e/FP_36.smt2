...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!632 b_ack!630))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!632 b_ack!630))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!632 b_ack!630))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (= a_ack!632 (bvadd #x00000001 b_ack!630)))
