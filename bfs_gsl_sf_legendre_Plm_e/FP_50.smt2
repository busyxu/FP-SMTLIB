...
(assert (= #x00000000 b_ack!888))
(assert (not (= a_ack!890 b_ack!888)))
(assert (not (= a_ack!890 (bvadd #x00000001 b_ack!888))))
(assert (bvsle (bvadd #x00000002 b_ack!888) a_ack!890))
(assert (bvsle (bvadd #x00000003 b_ack!888) a_ack!890))
(assert (bvsle (bvadd #x00000004 b_ack!888) a_ack!890))
