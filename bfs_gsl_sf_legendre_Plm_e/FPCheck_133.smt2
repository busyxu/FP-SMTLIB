...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!644 b_ack!642))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!644 b_ack!642))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!644 b_ack!642))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (= a_ack!644 (bvadd #x00000001 b_ack!642))))
(assert (bvsle (bvadd #x00000002 b_ack!642) a_ack!644))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000002 b_ack!642))))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!643 a!1)))
