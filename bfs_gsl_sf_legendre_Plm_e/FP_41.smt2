...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!686 b_ack!684))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!686 b_ack!684))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!686 b_ack!684))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (= a_ack!686 (bvadd #x00000001 b_ack!684))))
(assert (bvsle (bvadd #x00000002 b_ack!684) a_ack!686))
