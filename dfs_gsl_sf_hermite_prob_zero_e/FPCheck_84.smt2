...
(assert (not (bvsle a_ack!360 #x00000000)))
(assert (not (bvslt b_ack!359 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!360 #x00000002) b_ack!359)))
(assert (not (= #x00000000 b_ack!359)))
(assert (not (= #x00000002 a_ack!360)))
(assert (not (bvslt a_ack!360 #x00000015)))
(assert (= #x00000001 b_ack!359))
(assert (bvslt #x00000032 a_ack!360))
(assert (not (= #x00000000 (bvand a_ack!360 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!360 #x00000002) b_ack!359)))))
