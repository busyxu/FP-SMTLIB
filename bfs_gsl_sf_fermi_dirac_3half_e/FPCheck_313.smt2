...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!444) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!444) ((_ to_fp 11 53) #xbff0000000000000)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 (CF_exp a_ack!444))
         (fp.mul roundNearestTiesToEven
                 (CF_exp a_ack!444)
                 (fp.mul roundNearestTiesToEven
                         a!1
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3fe8000000000000))
                   ((_ to_fp 11 53) #x3fe8000000000000))))
  (FPCHECK_FMUL_UNDERFLOW a!1 #x3febb67ae8584caa)))
