...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!448) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!448) ((_ to_fp 11 53) #xbff0000000000000)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 (CF_exp a_ack!448))
         (fp.mul roundNearestTiesToEven
                 (CF_exp a_ack!448)
                 (fp.mul roundNearestTiesToEven
                         a!1
...
(let ((a!3 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!3
    (fp.mul roundNearestTiesToEven a!4 ((_ to_fp 11 53) #x3febb67ae8584caa))))))
