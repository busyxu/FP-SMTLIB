...
(assert (fp.lt ((_ to_fp 11 53) a_ack!422) ((_ to_fp 11 53) #xbff0000000000000)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 (CF_exp a_ack!422))
         (fp.mul roundNearestTiesToEven
                 (CF_exp a_ack!422)
                 (fp.mul roundNearestTiesToEven
                         a!1
...
(let ((a!5 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
  ...
  (not a!5)))))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 (CF_exp a_ack!422)))
