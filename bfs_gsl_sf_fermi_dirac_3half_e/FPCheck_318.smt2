...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!453) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 (CF_exp a_ack!453))
         (fp.mul roundNearestTiesToEven
                 (CF_exp a_ack!453)
                 (fp.mul roundNearestTiesToEven
                         a!1
