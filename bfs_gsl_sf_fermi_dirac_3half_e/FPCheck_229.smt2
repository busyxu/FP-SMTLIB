...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!301) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!301) ((_ to_fp 11 53) #x4010000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!301) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!301) ((_ to_fp 11 53) #x403e000000000000)))
