...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!109) ((_ to_fp 11 53) x1_ack!107))))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!110) ((_ to_fp 11 53) y0_ack!108))))
(assert (not (fp.gt ((_ to_fp 11 53) y_ack!110) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!109) ((_ to_fp 11 53) x0_ack!111))))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) y0_ack!108)))
       ((_ to_fp 11 53) y0_ack!108)))
(assert (FPCHECK_FSUB_ACCURACY y_ack!110 y0_ack!108))
