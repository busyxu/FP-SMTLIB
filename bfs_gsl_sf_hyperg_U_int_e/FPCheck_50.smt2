...
(assert (= (bvsub #x00000002 b_ack!310) (bvadd #x00000002 (bvsub a_ack!312 b_ack!310))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvsub #xffffffff (bvsub a_ack!312 b_ack!310)))
                   (CF_log c_ack!311))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvsub #xffffffff (bvsub a_ack!312 b_ack!310)))
                   (CF_log c_ack!311))))
  (FPCHECK_FADD_OVERFLOW (fp.abs a!1) #x3ff0000000000000)))
