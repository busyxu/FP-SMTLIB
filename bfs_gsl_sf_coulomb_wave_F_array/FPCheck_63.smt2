...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!363) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!362))
(assert (not (bvsle #x00000001 b_ack!362)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!365) ((_ to_fp 11 53) #x0000000000000000)))
