(declare-fun d_ack!347 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!347) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!346))
(assert (not (bvsle #x00000001 b_ack!346)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!349) ((_ to_fp 11 53) #x0000000000000000)))
