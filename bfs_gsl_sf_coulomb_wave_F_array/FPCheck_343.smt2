(declare-fun d_ack!2067 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!2067) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!2066))
(assert (not (bvsle #x00000001 b_ack!2066)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2069) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!2068)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   (CF_atan2 c_ack!2068 #x401e000000000000)))
                   ((_ to_fp 11 53) c_ack!2068)))
      (a!13 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            a!10
