...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1831) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1830))
(assert (not (bvsle #x00000001 b_ack!1830)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1833) ((_ to_fp 11 53) #x0000000000000000)))
