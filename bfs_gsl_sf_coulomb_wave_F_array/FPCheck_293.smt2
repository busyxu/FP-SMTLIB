(declare-fun d_ack!1867 () (_ BitVec 64))
(declare-fun b_ack!1866 () (_ BitVec 32))
(declare-fun a_ack!1869 () (_ BitVec 64))
(declare-fun c_ack!1868 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1867) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1866))
(assert (not (bvsle #x00000001 b_ack!1866)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1869) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1868)))))
