...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1943) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1942))
(assert (not (bvsle #x00000001 b_ack!1942)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1945) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1944)))))
...
(assert (FPCHECK_FMUL_ACCURACY c_ack!1944 (CF_atan2 c_ack!1944 #x401e000000000000)))
