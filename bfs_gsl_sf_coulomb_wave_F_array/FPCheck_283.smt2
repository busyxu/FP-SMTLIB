...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1827) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1826))
(assert (not (bvsle #x00000001 b_ack!1826)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1829) ((_ to_fp 11 53) #x0000000000000000)))
