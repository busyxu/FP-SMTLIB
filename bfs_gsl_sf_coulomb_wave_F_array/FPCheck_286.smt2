...
(declare-fun b_ack!1838 () (_ BitVec 32))
(declare-fun a_ack!1841 () (_ BitVec 64))
(declare-fun c_ack!1840 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1839) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1838))
(assert (not (bvsle #x00000001 b_ack!1838)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1841) ((_ to_fp 11 53) #x0000000000000000)))
