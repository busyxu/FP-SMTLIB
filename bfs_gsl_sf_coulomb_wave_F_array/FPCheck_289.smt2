(declare-fun d_ack!1851 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1851) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1850))
(assert (not (bvsle #x00000001 b_ack!1850)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1853) ((_ to_fp 11 53) #x0000000000000000)))
