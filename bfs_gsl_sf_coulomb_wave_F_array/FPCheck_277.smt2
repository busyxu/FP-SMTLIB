...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1803) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1802))
(assert (not (bvsle #x00000001 b_ack!1802)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1805) ((_ to_fp 11 53) #x0000000000000000)))
