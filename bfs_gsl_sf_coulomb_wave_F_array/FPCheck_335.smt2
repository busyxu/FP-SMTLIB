(declare-fun d_ack!2035 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!2035) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!2034))
(assert (not (bvsle #x00000001 b_ack!2034)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2037) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!2036)))
                   a!2)))
  (FPCHECK_FSUB_UNDERFLOW
    (fp.add roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!2036) a!3)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    (CF_atan2 c_ack!2036 #x401e000000000000)))
    c_ack!2036)))))
