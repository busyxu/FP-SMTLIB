...
(declare-fun FPCHECK_FDIV_ZERO
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1823) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1822))
(assert (not (bvsle #x00000001 b_ack!1822)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1825) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1824)))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) c_ack!1824)))))
  (FPCHECK_FDIV_ZERO (fp.abs a!12) (fp.abs a!12))))))))
