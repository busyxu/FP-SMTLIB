(declare-fun d_ack!1499 () (_ BitVec 64))
...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1499) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1498))
(assert (not (bvsle #x00000001 b_ack!1498)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1501) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    a!9
    (fp.mul roundNearestTiesToEven a!10 ((_ to_fp 11 53) c_ack!1500))))))))
