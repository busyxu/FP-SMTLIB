(declare-fun d_ack!1859 () (_ BitVec 64))
(declare-fun b_ack!1858 () (_ BitVec 32))
(declare-fun a_ack!1861 () (_ BitVec 64))
(declare-fun c_ack!1860 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1859) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1858))
(assert (not (bvsle #x00000001 b_ack!1858)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1861) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1860)))))
