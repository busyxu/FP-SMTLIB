(declare-fun d_ack!1971 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1971) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1970))
(assert (not (bvsle #x00000001 b_ack!1970)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1972)))
                   a!2)))
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!1972)
                                   (CF_atan2 c_ack!1972 #x401e000000000000)))
                   ((_ to_fp 11 53) #x401e000000000000))))
  (FPCHECK_FADD_OVERFLOW a!4 #x3fed67f1c864beb5))))))
