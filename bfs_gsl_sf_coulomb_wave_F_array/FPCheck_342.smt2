(declare-fun d_ack!2063 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!2063) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!2062))
(assert (not (bvsle #x00000001 b_ack!2062)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2065) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!2064)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) c_ack!2064)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!2064)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!2064)
                                   (CF_atan2 c_ack!2064 #x401e000000000000)))
