...
(declare-fun FPCHECK_FDIV_INVALID
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1819) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1818))
(assert (not (bvsle #x00000001 b_ack!1818)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1821) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1820)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1820)))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) c_ack!1820)))))
  (FPCHECK_FDIV_INVALID (fp.abs a!12) (fp.abs a!12))))))))
