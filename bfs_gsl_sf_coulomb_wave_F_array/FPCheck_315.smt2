(declare-fun d_ack!1955 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1955) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1954))
(assert (not (bvsle #x00000001 b_ack!1954)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1957) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1956)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1956)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1956)))
                   a!2)))
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fe0000000000000) a!3)
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) c_ack!1956)
            (CF_atan2 c_ack!1956 #x401e000000000000)))))))
