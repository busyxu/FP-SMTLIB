...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1895) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1894))
(assert (not (bvsle #x00000001 b_ack!1894)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1897) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1896)))))
