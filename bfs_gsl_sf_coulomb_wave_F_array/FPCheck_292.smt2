...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1863) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1862))
(assert (not (bvsle #x00000001 b_ack!1862)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1865) ((_ to_fp 11 53) #x0000000000000000)))
