(declare-fun d_ack!2011 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!2011) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!2010))
(assert (not (bvsle #x00000001 b_ack!2010)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2013) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW
  #x3fe0000000000000
  (CF_atan2 c_ack!2012 #x401e000000000000)))
