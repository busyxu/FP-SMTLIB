(declare-fun d_ack!1999 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1999) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1998))
(assert (not (bvsle #x00000001 b_ack!1998)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2001) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!2000)))
                   a!2)))
  (FPCHECK_FMUL_UNDERFLOW c_ack!2000 a!3)))))
