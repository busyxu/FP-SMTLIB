(declare-fun d_ack!1807 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1807) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1806))
(assert (not (bvsle #x00000001 b_ack!1806)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1809) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1808)))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) c_ack!1808)))))
  (FPCHECK_FDIV_OVERFLOW (fp.abs a!12) (fp.abs a!12))))))))
