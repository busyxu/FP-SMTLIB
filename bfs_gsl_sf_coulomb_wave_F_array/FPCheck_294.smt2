(declare-fun d_ack!1871 () (_ BitVec 64))
...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1871) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1870))
(assert (not (bvsle #x00000001 b_ack!1870)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1873) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1872)))))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.abs a!12)
                                    (fp.abs a!12))))))
  (FPCHECK_FINVALID_LOG a!13 a!13))))))))
