...
(declare-fun b_ack!1906 () (_ BitVec 32))
(declare-fun a_ack!1909 () (_ BitVec 64))
(declare-fun c_ack!1908 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (fp.eq ((_ to_fp 11 53) d_ack!1907) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1906))
(assert (not (bvsle #x00000001 b_ack!1906)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1909) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1908)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1908)))))
...
(let ((a!14 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (CF_log a!13))))))
  (FPCHECK_FMUL_ACCURACY #x3cc0000000000000 a!14)))))))))
