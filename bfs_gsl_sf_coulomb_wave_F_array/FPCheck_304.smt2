(declare-fun d_ack!1911 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1911) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1910))
(assert (not (bvsle #x00000001 b_ack!1910)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1913) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1912)))))
...
(let ((a!14 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (CF_log a!13))))))
  (FPCHECK_FMUL_OVERFLOW #x3cb0000000000000 a!14)))))))))
