(declare-fun d_ack!1835 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1835) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1834))
(assert (not (bvsle #x00000001 b_ack!1834)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1837) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1836)))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) c_ack!1836)))))
  (FPCHECK_FDIV_ACCURACY (fp.abs a!12) (fp.abs a!12))))))))
