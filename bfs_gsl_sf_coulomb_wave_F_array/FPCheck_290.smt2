...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1855) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1854))
(assert (not (bvsle #x00000001 b_ack!1854)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1857) ((_ to_fp 11 53) #x0000000000000000)))
