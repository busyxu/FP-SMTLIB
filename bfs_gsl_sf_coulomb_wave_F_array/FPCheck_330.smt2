(declare-fun d_ack!2015 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!2015) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!2014))
(assert (not (bvsle #x00000001 b_ack!2014)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!2017) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_ACCURACY
  #x3fe0000000000000
  (CF_atan2 c_ack!2016 #x401e000000000000)))
