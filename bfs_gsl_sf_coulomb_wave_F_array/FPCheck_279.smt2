...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1811) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1810))
(assert (not (bvsle #x00000001 b_ack!1810)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1813) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1812)))))
