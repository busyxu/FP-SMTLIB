(declare-fun d_ack!1935 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1935) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!1934))
(assert (not (bvsle #x00000001 b_ack!1934)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1937) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_OVERFLOW c_ack!1936 (CF_atan2 c_ack!1936 #x401e000000000000)))
