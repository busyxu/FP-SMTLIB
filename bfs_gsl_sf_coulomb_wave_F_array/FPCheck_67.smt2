(declare-fun d_ack!379 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!379) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000000 b_ack!378))
(assert (not (bvsle #x00000001 b_ack!378)))
