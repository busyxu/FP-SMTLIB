...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!183))
  ...
  (not a!1)))
(assert (bvslt #x00000002 a_ack!184))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!183))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!183))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 a_ack!184))
...
(assert (bvslt #x00000004 a_ack!184))
...
(assert (bvslt #x00000005 a_ack!184))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!183)
                           ((_ to_fp 11 53) b_ack!183))
