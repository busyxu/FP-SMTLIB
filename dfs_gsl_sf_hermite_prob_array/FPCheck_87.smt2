...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!321))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!322))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!321))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!321))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!321))
...
(assert (bvslt #x00000006 a_ack!322))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!321)
                           ((_ to_fp 11 53) b_ack!321))
...
(assert (bvslt #x00000007 a_ack!322))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!321)
                           ((_ to_fp 11 53) b_ack!321))
...
(assert (bvslt #x00000008 a_ack!322))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!321)
                           ((_ to_fp 11 53) b_ack!321))
...
(assert (bvslt #x00000009 a_ack!322))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!321)
                           ((_ to_fp 11 53) b_ack!321))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4022000000000000)
                 a!7))))))))))))
(assert (bvslt #x0000000a a_ack!322))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!321)
                           ((_ to_fp 11 53) b_ack!321))
