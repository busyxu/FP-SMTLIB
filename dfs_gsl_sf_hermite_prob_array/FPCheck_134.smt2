...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!502))
...
(assert (bvslt #x00000003 a_ack!503))
...
(assert (bvslt #x00000004 a_ack!503))
...
(assert (bvslt #x00000005 a_ack!503))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!502)
                           ((_ to_fp 11 53) b_ack!502))
...
(assert (bvslt #x00000006 a_ack!503))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!502)
                           ((_ to_fp 11 53) b_ack!502))
