...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!255))
  ...
  (not a!1)))
(assert (bvslt #x00000002 a_ack!256))
...
(assert (bvslt #x00000003 a_ack!256))
...
(assert (bvslt #x00000004 a_ack!256))
...
(assert (bvslt #x00000005 a_ack!256))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!255)
                           ((_ to_fp 11 53) b_ack!255))
...
(assert (bvslt #x00000006 a_ack!256))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!255)
                           ((_ to_fp 11 53) b_ack!255))
...
(assert (bvslt #x00000007 a_ack!256))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!255)
                           ((_ to_fp 11 53) b_ack!255))
...
(assert (bvslt #x00000008 a_ack!256))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!255)
                           ((_ to_fp 11 53) b_ack!255))
