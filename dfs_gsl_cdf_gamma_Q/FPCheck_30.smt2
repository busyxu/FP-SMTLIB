...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!182)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) b_ack!181)
                 ((_ to_fp 11 53) #x0000000000000000)))))
...
(assert (not (fp.leq (fp.div roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     ...
                     ((_ to_fp 11 53) a_ack!180)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!180)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!182)
                    ((_ to_fp 11 53) b_ack!181))
            (fp.mul roundNearestTiesToEven
