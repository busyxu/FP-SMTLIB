...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!242)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) b_ack!241)
                 ((_ to_fp 11 53) #x0000000000000000)))))
...
(assert (not (fp.leq (fp.div roundNearestTiesToEven
             ...
             (fp.mul roundNearestTiesToEven
                     ...
                     ((_ to_fp 11 53) a_ack!240)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!240) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!240) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!240)
