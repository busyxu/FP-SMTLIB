...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1833) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!1832) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1833) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!3)
                   a!4)))
  (FPCHECK_FSUB_UNDERFLOW (fp.sub roundNearestTiesToEven a!5 a!6) a!7)))))
