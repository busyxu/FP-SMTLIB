...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1075) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!1074) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1075) ((_ to_fp 11 53) #x408f400000000000)))
