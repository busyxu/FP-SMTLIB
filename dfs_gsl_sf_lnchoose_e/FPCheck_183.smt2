...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!637 b_ack!636)))
(assert (not (= b_ack!636 a_ack!637)))
(assert (not (= #x00000000 b_ack!636)))
(assert (not (bvult a_ack!637 (bvmul #x00000002 b_ack!636))))
(assert (not (bvule a_ack!637 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!637)
                ((_ to_fp 11 53) #x3ff0000000000000))
