...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!591 b_ack!590)))
(assert (not (= b_ack!590 a_ack!591)))
(assert (not (= #x00000000 b_ack!590)))
(assert (not (bvult a_ack!591 (bvmul #x00000002 b_ack!590))))
(assert (not (bvule a_ack!591 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!591)
                ((_ to_fp 11 53) #x3ff0000000000000))
