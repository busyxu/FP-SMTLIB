...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!629 b_ack!628)))
(assert (not (= b_ack!628 a_ack!629)))
(assert (not (= #x00000000 b_ack!628)))
(assert (not (bvult a_ack!629 (bvmul #x00000002 b_ack!628))))
(assert (not (bvule a_ack!629 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!629)
                ((_ to_fp 11 53) #x3ff0000000000000))
