...
(assert (not (bvult a_ack!645 b_ack!644)))
(assert (not (= b_ack!644 a_ack!645)))
(assert (not (= #x00000000 b_ack!644)))
(assert (not (bvult a_ack!645 (bvmul #x00000002 b_ack!644))))
(assert (not (bvule a_ack!645 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!645)
                ((_ to_fp 11 53) #x3ff0000000000000))
