...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!611 b_ack!610)))
(assert (not (= b_ack!610 a_ack!611)))
(assert (not (= #x00000000 b_ack!610)))
(assert (not (bvult a_ack!611 (bvmul #x00000002 b_ack!610))))
(assert (not (bvule a_ack!611 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!611)
                ((_ to_fp 11 53) #x3ff0000000000000))
