...
(assert (not (bvult a_ack!343 b_ack!342)))
(assert (not (= b_ack!342 a_ack!343)))
(assert (not (= #x00000000 b_ack!342)))
(assert (bvult a_ack!343 (bvmul #x00000002 b_ack!342)))
(assert (not (bvule a_ack!343 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!343)
                ((_ to_fp 11 53) #x3ff0000000000000))
