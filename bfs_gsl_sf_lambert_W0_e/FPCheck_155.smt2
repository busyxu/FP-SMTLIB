...
(assert (fp.gt ((_ to_fp 11 53) a_ack!228) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!228)
                           (CF_log (CF_log a_ack!228)))
                   (CF_log (CF_log a_ack!228)))))
  (fp.eq a!1 (CF_log a_ack!228))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!228)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!228)
                           (CF_log (CF_log a_ack!228))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!228)))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (CF_log (CF_log a_ack!228)))
                   a!4)))
  (FPCHECK_FMUL_OVERFLOW a!5 (CF_exp a!5)))))))
