...
(assert (fp.gt ((_ to_fp 11 53) a_ack!287) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!287)
                           (CF_log (CF_log a_ack!287)))
                   (CF_log (CF_log a_ack!287)))))
  (fp.eq a!1 (CF_log a_ack!287))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!287)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!287)
                           (CF_log (CF_log a_ack!287))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!287)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FDIV_ZERO a!6 (CF_exp a!5))))))))
