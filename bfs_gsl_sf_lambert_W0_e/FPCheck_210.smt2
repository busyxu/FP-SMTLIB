...
(assert (fp.gt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!342)
                           (CF_log (CF_log a_ack!342)))
                   (CF_log (CF_log a_ack!342)))))
  (fp.eq a!1 (CF_log a_ack!342))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!342)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!342)
                           (CF_log (CF_log a_ack!342))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!342)))))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   (CF_exp a!5))))
  (FPCHECK_FDIV_ACCURACY #x3ff0000000000000 a!6)))))))
