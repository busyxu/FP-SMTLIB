...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!216) ((_ to_fp 11 53) #x4008000000000000))))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3ff0000000000000))
       (CF_log a_ack!216)))
(assert (not (fp.gt (CF_log a_ack!216) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (CF_log a_ack!216)
                           (CF_exp (CF_log a_ack!216)))
                   ((_ to_fp 11 53) a_ack!216)))
