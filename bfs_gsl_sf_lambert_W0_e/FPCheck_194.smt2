...
(assert (fp.gt ((_ to_fp 11 53) a_ack!310) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!310)
                           (CF_log (CF_log a_ack!310)))
                   (CF_log (CF_log a_ack!310)))))
  (fp.eq a!1 (CF_log a_ack!310))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!310)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!310)
                           (CF_log (CF_log a_ack!310))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!310)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_ACCURACY a!5 (fp.div roundNearestTiesToEven a!6 (CF_exp a!5)))))))))
