...
(assert (fp.gt ((_ to_fp 11 53) a_ack!63) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!63)
                           (CF_log (CF_log a_ack!63)))
                   (CF_log (CF_log a_ack!63)))))
  (fp.eq a!1 (CF_log a_ack!63))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!63)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!63)
                           (CF_log (CF_log a_ack!63))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!63)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (CF_log (CF_log a_ack!63)))
                   a!1)))
  (FPCHECK_FSUB_ACCURACY a!2 a_ack!63))))
