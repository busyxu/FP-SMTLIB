...
(assert (fp.gt ((_ to_fp 11 53) a_ack!193) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!193)
                           (CF_log (CF_log a_ack!193)))
                   (CF_log (CF_log a_ack!193)))))
  (fp.eq a!1 (CF_log a_ack!193))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!193)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!193)
                           (CF_log (CF_log a_ack!193))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!193)))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (CF_log (CF_log a_ack!193)))
                   a!4)))
  (FPCHECK_FMUL_UNDERFLOW #x3ce4000000000000 (fp.abs a!5)))))))
