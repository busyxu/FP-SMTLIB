...
(assert (fp.leq ((_ to_fp 11 53) b_ack!1130) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1131) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x0000000000000000)))))
  (not (fp.gt (fp.abs a!3) ((_ to_fp 11 53) #x3cb0000000000000)))))))
(assert (FPCHECK_FMUL_OVERFLOW #xbfe0000000000000 a_ack!1131))
