...
(assert (fp.leq ((_ to_fp 11 53) b_ack!376) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!377) ((_ to_fp 11 53) #x408f400000000000)))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x0000000000000000))
                 a!3)))))))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 a_ack!377))
