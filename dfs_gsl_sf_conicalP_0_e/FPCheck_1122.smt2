...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3704) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3705) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!3704) ((_ to_fp 11 53) #x3ff8000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW a_ack!3705 a_ack!3705))
