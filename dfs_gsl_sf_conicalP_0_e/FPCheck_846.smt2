...
(declare-fun a_ack!2927 () (_ BitVec 64))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2927) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!2926) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2927) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!11 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!8))
                    a!10)))
  (FPCHECK_FADD_OVERFLOW a!11 (fp.mul roundNearestTiesToEven a!10 a!12))))))))
