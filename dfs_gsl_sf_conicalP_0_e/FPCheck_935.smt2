...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3201) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x3ff8000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3201) ((_ to_fp 11 53) #x4034000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) #x3ff8000000000000) ((_ to_fp 11 53) b_ack!3200))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3200) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!3200))
