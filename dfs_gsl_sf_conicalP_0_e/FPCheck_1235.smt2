...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4030) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4031) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!4030) ((_ to_fp 11 53) #x3ff8000000000000)))
...
(assert (FPCHECK_FMUL_OVERFLOW a_ack!4031 a_ack!4031))
