...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!892))
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fb999999999999a)
                    ((_ to_fp 11 53) a_ack!893)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!893) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!893) ((_ to_fp 11 53) #x4024000000000000))))
