...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1117) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1116))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fb999999999999a)
               ((_ to_fp 11 53) a_ack!1117))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1117) ((_ to_fp 11 53) #x4065600000000000)))
