...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!600))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fb999999999999a)
               ((_ to_fp 11 53) a_ack!601))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!601) ((_ to_fp 11 53) #x4065600000000000)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!601) (CF_floor a_ack!601))))
