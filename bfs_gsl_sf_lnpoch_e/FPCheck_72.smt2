...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!216))
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fb999999999999a)
                    ((_ to_fp 11 53) a_ack!217)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!217) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.gt (fp.mul roundNearestTiesToEven
               (fp.abs ((_ to_fp 11 53) b_ack!216))
               ((_ to_fp 11 53) #x3fe62e42fefa39ef))
       ((_ to_fp 11 53) #x3fb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!217) ((_ to_fp 11 53) #x4065600000000000))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!217 #x3ff0000000000000))
