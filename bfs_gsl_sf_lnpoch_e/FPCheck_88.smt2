...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!260))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fb999999999999a)
               ((_ to_fp 11 53) a_ack!261))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!261) ((_ to_fp 11 53) #x4065600000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (fp.geq ((_ to_fp 11 53) a_ack!261) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!261 #x3ff0000000000000))
