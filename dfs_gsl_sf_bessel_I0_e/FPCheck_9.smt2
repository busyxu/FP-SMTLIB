...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!16)) ((_ to_fp 11 53) #x40862642fefa39ef)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!16))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!16))
             ((_ to_fp 11 53) #x4008000000000000))))
...
(assert (FPCHECK_FDIV_OVERFLOW #x4048000000000000 (fp.abs ((_ to_fp 11 53) a_ack!16))))
