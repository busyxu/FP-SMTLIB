...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4888) ((_ to_fp 11 53) x0_ack!4890))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!4888) ((_ to_fp 11 53) x1_ack!4883))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4889) ((_ to_fp 11 53) x0_ack!4890))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4889) ((_ to_fp 11 53) x1_ack!4883))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!4883)
                    ((_ to_fp 11 53) x0_ack!4890))
            ((_ to_fp 11 53) #x0000000000000000))))
