...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4872) ((_ to_fp 11 53) x0_ack!4874))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!4872) ((_ to_fp 11 53) x1_ack!4867))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4873) ((_ to_fp 11 53) x0_ack!4874))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4873) ((_ to_fp 11 53) x1_ack!4867))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!4867)
                    ((_ to_fp 11 53) x0_ack!4874))
            ((_ to_fp 11 53) #x0000000000000000))))
