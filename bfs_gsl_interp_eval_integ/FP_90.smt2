...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!5002) ((_ to_fp 11 53) x0_ack!5004))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!5002) ((_ to_fp 11 53) x1_ack!5000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!5003) ((_ to_fp 11 53) x0_ack!5004))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!5003) ((_ to_fp 11 53) x1_ack!5000))))
