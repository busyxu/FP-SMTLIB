...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3380) ((_ to_fp 11 53) x0_ack!3382))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!3380) ((_ to_fp 11 53) x1_ack!3375)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!3375) ((_ to_fp 11 53) a_ack!3380))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3381) ((_ to_fp 11 53) x1_ack!3375))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!3381) ((_ to_fp 11 53) x2_ack!3376))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x2_ack!3376)
                    ((_ to_fp 11 53) x1_ack!3375))
            ((_ to_fp 11 53) #x0000000000000000))))
