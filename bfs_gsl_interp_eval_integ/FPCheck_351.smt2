...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4405) ((_ to_fp 11 53) x0_ack!4407))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!4405) ((_ to_fp 11 53) x1_ack!4403))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4406) ((_ to_fp 11 53) x0_ack!4407))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4406) ((_ to_fp 11 53) x1_ack!4403))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!4403)
                    ((_ to_fp 11 53) x0_ack!4407))
            ((_ to_fp 11 53) #x0000000000000000))))
