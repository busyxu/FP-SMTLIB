...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4415) ((_ to_fp 11 53) x0_ack!4417))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!4415) ((_ to_fp 11 53) x1_ack!4413))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4416) ((_ to_fp 11 53) x0_ack!4417))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4416) ((_ to_fp 11 53) x1_ack!4413))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!4413)
                    ((_ to_fp 11 53) x0_ack!4417))
            ((_ to_fp 11 53) #x0000000000000000))))
