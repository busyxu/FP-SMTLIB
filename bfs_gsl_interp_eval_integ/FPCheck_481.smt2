...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!6045) ((_ to_fp 11 53) x0_ack!6047))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!6045) ((_ to_fp 11 53) x1_ack!6040))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6046) ((_ to_fp 11 53) x0_ack!6047))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!6046) ((_ to_fp 11 53) x1_ack!6040)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!6040) ((_ to_fp 11 53) b_ack!6046))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!6040)
                    ((_ to_fp 11 53) x0_ack!6047))
            ((_ to_fp 11 53) #x0000000000000000))))
