...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4904) ((_ to_fp 11 53) x0_ack!4906))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!4904) ((_ to_fp 11 53) x1_ack!4899))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4905) ((_ to_fp 11 53) x0_ack!4906))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4905) ((_ to_fp 11 53) x1_ack!4899))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!4899)
                    ((_ to_fp 11 53) x0_ack!4906))
            ((_ to_fp 11 53) #x0000000000000000))))
