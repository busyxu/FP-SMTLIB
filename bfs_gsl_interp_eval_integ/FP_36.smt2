...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1145) ((_ to_fp 11 53) x0_ack!1147))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!1145) ((_ to_fp 11 53) x1_ack!1143)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!1143) ((_ to_fp 11 53) a_ack!1145))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1146) ((_ to_fp 11 53) x1_ack!1143))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!1146) ((_ to_fp 11 53) x2_ack!1144))))
