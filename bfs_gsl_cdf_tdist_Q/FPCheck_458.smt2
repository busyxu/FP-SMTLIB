...
(assert (fp.gt ((_ to_fp 11 53) mu_ack!1487) ((_ to_fp 11 53) #x403e000000000000)))
...
(assert (not (fp.lt (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x_ack!1488))
            ((_ to_fp 11 53) mu_ack!1487))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) x_ack!1488))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!1488) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) mu_ack!1487)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!1488)
