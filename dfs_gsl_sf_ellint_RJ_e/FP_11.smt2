...
(assert (fp.gt ((_ to_fp 11 53) a_ack!115) ((_ to_fp 11 53) b_ack!111)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!115) ((_ to_fp 11 53) c_ack!112)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!115) ((_ to_fp 11 53) d_ack!113))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!113) ((_ to_fp 11 53) #x551c4b19c41f715f)))
