...
(assert (fp.gt ((_ to_fp 11 53) a_ack!250) ((_ to_fp 11 53) b_ack!246)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!250) ((_ to_fp 11 53) c_ack!247)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!250) ((_ to_fp 11 53) d_ack!248))))
