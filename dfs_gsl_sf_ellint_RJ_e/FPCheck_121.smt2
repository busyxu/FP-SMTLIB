...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1555) ((_ to_fp 11 53) c_ack!1552)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1555) ((_ to_fp 11 53) d_ack!1553)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1555) ((_ to_fp 11 53) #x551c4b19c41f715f)))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3fc999999999999a))
                   ((_ to_fp 11 53) #x3fc999999999999a))))
  (fp.eq a!2 (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) d_ack!1553))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!1555)
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_INVALID
    a!2
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) d_ack!1553))
            ((_ to_fp 11 53) #x3fc999999999999a))))))
