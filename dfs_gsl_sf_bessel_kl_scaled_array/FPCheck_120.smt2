...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!488) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!488) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000001 a_ack!489))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!5 a!3)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!488))
                 a!4))))))))
(assert (bvslt #x00000004 a_ack!489))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!6 a!4)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!488))
                 a!5)))))))))
(assert (bvslt #x00000005 a_ack!489))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!7 a!5)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!488))
                 a!6))))))))))
(assert (bvslt #x00000006 a_ack!489))
(assert (bvslt #x00000007 a_ack!489))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!488))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x402e000000000000)
                 ((_ to_fp 11 53) b_ack!488)))))))))))))
(assert (bvslt #x00000008 a_ack!489))
(assert (bvslt #x00000009 a_ack!489))
(assert (let ((a!1 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
