...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!580) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!580) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!580))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000009 a_ack!581))
(assert (let ((a!1 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
...
(let ((a!11 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!11
         (fp.div roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4033000000000000)
                 ((_ to_fp 11 53) b_ack!580)))))))))))))))
(assert (bvslt #x0000000a a_ack!581))
(assert (bvslt #x0000000b a_ack!581))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x400921fb54442d18)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!13 a!11)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!580))
                 a!12))))))))))))))))
(assert (bvslt #x0000000c a_ack!581))
