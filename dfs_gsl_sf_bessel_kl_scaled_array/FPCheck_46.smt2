...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!184) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!184) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
...
(assert (bvslt #x00000001 a_ack!185))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!3 a!1)
         (fp.mul roundNearestTiesToEven
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) b_ack!184))
                 a!2))))))
(assert (bvslt #x00000002 a_ack!185))
(assert (fp.eq ((_ to_fp 11 53) b_ack!184) ((_ to_fp 11 53) #x0000000000000000)))
