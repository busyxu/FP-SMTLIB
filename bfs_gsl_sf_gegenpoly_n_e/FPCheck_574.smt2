...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2840) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2842)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2840) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2840) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2840) ((_ to_fp 11 53) #x0000000000000000))))
(assert (bvsle #x00000004 a_ack!2842))
(assert (bvsle #x00000005 a_ack!2842))
(assert (bvsle #x00000006 a_ack!2842))
(assert (bvsle #x00000007 a_ack!2842))
(assert (bvsle #x00000008 a_ack!2842))
(assert (bvsle #x00000009 a_ack!2842))
