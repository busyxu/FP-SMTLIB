...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2442) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2444)))
...
(let ((a!14 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!11
                                    ((_ to_fp 11 53) #x4010000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!14 #x4018000000000000)))))))))
