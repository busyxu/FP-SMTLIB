...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1787) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1788))
    a!4)))))
