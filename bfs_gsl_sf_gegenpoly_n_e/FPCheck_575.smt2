...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2848) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2850)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2848) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2848) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2848) ((_ to_fp 11 53) #x0000000000000000))))
(assert (bvsle #x00000004 a_ack!2850))
(assert (bvsle #x00000005 a_ack!2850))
(assert (bvsle #x00000006 a_ack!2850))
(assert (bvsle #x00000007 a_ack!2850))
(assert (bvsle #x00000008 a_ack!2850))
(assert (bvsle #x00000009 a_ack!2850))
...
(let ((a!21 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!2849))
            (fp.div roundNearestTiesToEven
                    a!21
                    ((_ to_fp 11 53) #x4020000000000000)))
    (fp.mul roundNearestTiesToEven
