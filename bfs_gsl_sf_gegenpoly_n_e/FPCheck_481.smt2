...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2445) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!2447 #x00000000)))
(assert (not (= #x00000000 a_ack!2447)))
(assert (not (= #x00000001 a_ack!2447)))
(assert (not (= #x00000002 a_ack!2447)))
(assert (not (= #x00000003 a_ack!2447)))
...
(let ((a!14 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!11
                                    ((_ to_fp 11 53) #x4010000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!14 #x4018000000000000)))))))))
