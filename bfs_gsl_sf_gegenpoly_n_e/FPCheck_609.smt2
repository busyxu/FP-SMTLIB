...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3002) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!3004 #x00000000)))
(assert (not (= #x00000000 a_ack!3004)))
(assert (not (= #x00000001 a_ack!3004)))
(assert (not (= #x00000002 a_ack!3004)))
(assert (not (= #x00000003 a_ack!3004)))
...
(let ((a!24 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3003))
            (fp.div roundNearestTiesToEven
                    a!24
                    ((_ to_fp 11 53) #x4022000000000000)))
    (fp.mul roundNearestTiesToEven
