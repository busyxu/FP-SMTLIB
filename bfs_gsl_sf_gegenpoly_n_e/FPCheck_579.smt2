...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2868) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!2870 #x00000000)))
(assert (not (= #x00000000 a_ack!2870)))
(assert (not (= #x00000001 a_ack!2870)))
(assert (not (= #x00000002 a_ack!2870)))
(assert (not (= #x00000003 a_ack!2870)))
...
(let ((a!23 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!19
                                    ((_ to_fp 11 53) #x401c000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!23 #x4022000000000000))))))))))))
