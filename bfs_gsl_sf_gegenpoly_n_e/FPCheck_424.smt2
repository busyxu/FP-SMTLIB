...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2190) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2191)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2190) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2190) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2190) ((_ to_fp 11 53) #x0000000000000000))))
(assert (bvsle #x00000004 a_ack!2191))
(assert (bvsle #x00000005 a_ack!2191))
