...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2222) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!2224 #x00000000)))
(assert (not (= #x00000000 a_ack!2224)))
(assert (not (= #x00000001 a_ack!2224)))
(assert (not (= #x00000002 a_ack!2224)))
(assert (not (= #x00000003 a_ack!2224)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2222) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2222) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2222) ((_ to_fp 11 53) #x0000000000000000))))
(assert (bvsle #x00000004 a_ack!2224))
(assert (bvsle #x00000005 a_ack!2224))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!2223))
