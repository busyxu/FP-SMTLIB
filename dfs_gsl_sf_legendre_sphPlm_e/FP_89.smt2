...
(assert (not (= #x00000000 b_ack!1851)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1852) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1852) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851)
...
(assert (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
       (fp.mul roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851))))
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851)
       ((_ to_fp 11 53) #x4065600000000000)))
(assert (fp.lt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851)
               ((_ to_fp 11 53) #x3fe0000000000000))
       ((_ to_fp 11 53) #x4065600000000000)))
(assert (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1851)
        ((_ to_fp 11 53) #x0000000000000000)))
