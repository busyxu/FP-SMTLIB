...
(assert (not (= #x00000000 b_ack!2151)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2152) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2152) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2151)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq (fp.add roundNearestTiesToEven
                ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2151)
