...
(declare-fun epsrel_ack!2028 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!2027) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2028)
