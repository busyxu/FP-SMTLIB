(declare-fun limit_ack!4839 () (_ BitVec 64))
(declare-fun epsabs_ack!4837 () (_ BitVec 64))
(declare-fun epsrel_ack!4838 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!4839)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!4837) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!4838)
