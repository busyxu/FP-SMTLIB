...
(declare-fun epsabs_ack!1432 () (_ BitVec 64))
(declare-fun epsrel_ack!1433 () (_ BitVec 64))
(declare-fun b_ack!1431 () (_ BitVec 64))
(declare-fun a_ack!1435 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!1434)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1432) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1433)
