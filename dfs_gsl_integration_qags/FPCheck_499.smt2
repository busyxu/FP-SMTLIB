...
(declare-fun epsabs_ack!5017 () (_ BitVec 64))
(declare-fun epsrel_ack!5018 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!5017) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!5018)
...
(let ((a!37 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!38 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    a!36
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_ACCURACY a!37 a!38)))))))))
