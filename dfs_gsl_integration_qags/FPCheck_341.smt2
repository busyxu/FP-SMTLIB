(declare-fun limit_ack!3454 () (_ BitVec 64))
(declare-fun epsabs_ack!3452 () (_ BitVec 64))
(declare-fun epsrel_ack!3453 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!3454)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3452) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3453)
...
(let ((a!23 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!19)
                    a!22)))
  (FPCHECK_FADD_OVERFLOW a!23 a!26)))))))
