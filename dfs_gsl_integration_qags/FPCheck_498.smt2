...
(declare-fun epsrel_ack!5008 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!5008)
...
(let ((a!37 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    a!36
                                    ((_ to_fp 11 53) #x3fe0000000000000)))))
      (a!38 (fp.abs (fp.sub roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (CF_log a!21)
                                    ((_ to_fp 11 53) #x7ff8000000000001))
                            (fp.mul roundNearestTiesToEven
                                    a!36
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_UNDERFLOW a!37 a!38)))))))))
