(declare-fun limit_ack!4859 () (_ BitVec 64))
(declare-fun epsabs_ack!4857 () (_ BitVec 64))
(declare-fun epsrel_ack!4858 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!4859)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!4857) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!4858)
...
(let ((a!35 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!35
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fc2467b616c0e05) a!38)))))))))))
