(declare-fun limit_ack!3989 () (_ BitVec 64))
(declare-fun epsabs_ack!3987 () (_ BitVec 64))
(declare-fun epsrel_ack!3988 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!3989)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3987) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3988)
