(declare-fun limit_ack!4404 () (_ BitVec 64))
(declare-fun epsabs_ack!4402 () (_ BitVec 64))
(declare-fun epsrel_ack!4403 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!4404)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!4402) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!4403)
