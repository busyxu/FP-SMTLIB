...
(declare-fun epsrel_ack!908 () (_ BitVec 64))
(declare-fun b_ack!906 () (_ BitVec 64))
(declare-fun a_ack!910 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!909)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!907) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!908)
