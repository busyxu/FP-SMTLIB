(declare-fun limit_ack!2583 () (_ BitVec 64))
(declare-fun epsabs_ack!2582 () (_ BitVec 64))
(declare-fun b_ack!2581 () (_ BitVec 64))
(declare-fun a_ack!2584 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!2583)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!2582)
