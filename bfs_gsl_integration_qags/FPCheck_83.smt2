(declare-fun limit_ack!687 () (_ BitVec 64))
(declare-fun epsabs_ack!686 () (_ BitVec 64))
(declare-fun b_ack!685 () (_ BitVec 64))
(declare-fun a_ack!688 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_LOG
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!687)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!686)
