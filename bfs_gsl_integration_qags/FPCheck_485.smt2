(declare-fun limit_ack!3915 () (_ BitVec 64))
(declare-fun epsabs_ack!3914 () (_ BitVec 64))
(declare-fun b_ack!3913 () (_ BitVec 64))
(declare-fun a_ack!3916 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3915)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!3914)
...
(let ((a!36 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!32)
                    a!35)))
  (FPCHECK_FMUL_OVERFLOW a!36 #x3fe0000000000000))))))))
