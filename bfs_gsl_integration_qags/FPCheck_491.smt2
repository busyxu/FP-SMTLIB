(declare-fun limit_ack!3959 () (_ BitVec 64))
(declare-fun epsabs_ack!3958 () (_ BitVec 64))
(declare-fun b_ack!3957 () (_ BitVec 64))
(declare-fun a_ack!3960 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3959)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!3958)
