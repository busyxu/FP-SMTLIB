...
(assert (fp.gt ((_ to_fp 11 53) a_ack!152) ((_ to_fp 11 53) #xc3045f306dc9c883)))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!152)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!152))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!152) ((_ to_fp 11 53) #xc1dfffffff800000))))
