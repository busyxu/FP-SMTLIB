...
(assert (fp.gt ((_ to_fp 11 53) a_ack!148) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!148) ((_ to_fp 11 53) #xc1dfffffff800000))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!148 #x3fe0000000000000))
