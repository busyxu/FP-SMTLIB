...
(assert (not (bvule n_ack!3930 k_ack!3929)))
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp_unsigned 11 53)
                                     roundNearestTiesToEven
                                     k_ack!3929))))))
  (fp.gt ((_ to_fp 11 53) p_ack!3931) a!1)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           a!1))))
  (not (fp.lt (fp.mul roundNearestTiesToEven a!2 (CF_log p_ack!3931))
              ((_ to_fp 11 53) #x0000000000000000))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           a!1))))
  (not (fp.eq (fp.mul roundNearestTiesToEven a!2 (CF_log p_ack!3931))
              ((_ to_fp 11 53) #x0000000000000000))))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           a!1))))
  (fp.leq (fp.mul roundNearestTiesToEven a!2 (CF_log p_ack!3931))
