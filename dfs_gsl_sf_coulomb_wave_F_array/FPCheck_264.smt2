...
(declare-fun b_ack!1669 () (_ BitVec 32))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1670) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1669)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1671)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1671)))
                   a!2)))
  (FPCHECK_FMUL_UNDERFLOW c_ack!1671 a!3)))))
