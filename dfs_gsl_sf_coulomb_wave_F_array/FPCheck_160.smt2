(declare-fun d_ack!1162 () (_ BitVec 64))
...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1162) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1161)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1164) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    a!9
    (fp.mul roundNearestTiesToEven a!10 ((_ to_fp 11 53) c_ack!1163))))))))
