(declare-fun d_ack!1530 () (_ BitVec 64))
(declare-fun b_ack!1529 () (_ BitVec 32))
(declare-fun a_ack!1532 () (_ BitVec 64))
(declare-fun c_ack!1531 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1530) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1529)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1532) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    #x3ff0000000000000
    (fp.mul roundNearestTiesToEven
            (fp.div roundNearestTiesToEven (fp.abs a!12) (fp.abs a!12))
            (fp.div roundNearestTiesToEven (fp.abs a!12) (fp.abs a!12))))))))))
