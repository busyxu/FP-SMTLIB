...
(assert (fp.eq ((_ to_fp 11 53) d_ack!242) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!241)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_ACCURACY c_ack!243 c_ack!243))
