...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1622) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1621)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1624) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1623)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1623)))
                   a!2)))
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fe0000000000000) a!3)
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) c_ack!1623)
            (CF_atan2 c_ack!1623 #x401e000000000000)))))))
