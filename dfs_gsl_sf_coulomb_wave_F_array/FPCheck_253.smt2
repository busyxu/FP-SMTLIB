...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1626) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1625)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1628) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1627)))
                   a!2)))
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fe0000000000000) a!3)
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) c_ack!1627)
            (CF_atan2 c_ack!1627 #x401e000000000000)))))))
