(declare-fun d_ack!1678 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1678) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1677)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1680) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1679)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1679)))))
...
(assert (FPCHECK_FMUL_OVERFLOW
  #x3fe0000000000000
  (CF_atan2 c_ack!1679 #x401e000000000000)))
