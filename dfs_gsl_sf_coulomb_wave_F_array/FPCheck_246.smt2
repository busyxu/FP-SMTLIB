(declare-fun d_ack!1598 () (_ BitVec 64))
(declare-fun b_ack!1597 () (_ BitVec 32))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1598) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1597)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1600) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1599)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1599)))
                   a!2)))
