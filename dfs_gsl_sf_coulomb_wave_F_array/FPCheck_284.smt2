...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1750) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1749)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1752) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1751)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1751)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1751)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   (CF_atan2 c_ack!1751 #x401e000000000000)))
                   ((_ to_fp 11 53) c_ack!1751)))
      (a!13 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            a!10
