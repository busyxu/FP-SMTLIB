...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!850) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!849)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    a!6
    (fp.mul roundNearestTiesToEven a!7 ((_ to_fp 11 53) c_ack!851)))))))
