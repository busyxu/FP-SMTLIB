(declare-fun d_ack!1638 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1638) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1637)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1640) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1639)))
                   a!2)))
  (FPCHECK_FSUB_ACCURACY
    (fp.sub roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) c_ack!1639)
                    (CF_atan2 c_ack!1639 #x401e000000000000)))
    #x401e000000000000)))))
