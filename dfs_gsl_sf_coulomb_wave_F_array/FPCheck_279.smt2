(declare-fun d_ack!1730 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1730) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1729)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1732) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) c_ack!1731)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1731)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!1731)
                                   (CF_atan2 c_ack!1731 #x401e000000000000)))
...
(let ((a!18 (fp.add roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3fe0000000000000)
                                    (CF_log a!17))))))
  (FPCHECK_FMUL_UNDERFLOW #x3cd0000000000000 (fp.abs a!18))))))))))
