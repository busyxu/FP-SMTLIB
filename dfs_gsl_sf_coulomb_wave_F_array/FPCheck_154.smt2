(declare-fun d_ack!1114 () (_ BitVec 64))
...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1114) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1113)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1116) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!9
    (fp.mul roundNearestTiesToEven a!10 ((_ to_fp 11 53) #x401c000000000000))))))))
