...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!934) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!933)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!936) ((_ to_fp 11 53) #x0000000000000000)))
