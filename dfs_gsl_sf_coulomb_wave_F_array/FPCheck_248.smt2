(declare-fun d_ack!1606 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1606) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1605)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1608) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_OVERFLOW c_ack!1607 (CF_atan2 c_ack!1607 #x401e000000000000)))
