...
(declare-fun FPCHECK_FDIV_ZERO
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1494) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1493)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1496) ((_ to_fp 11 53) #x0000000000000000)))
