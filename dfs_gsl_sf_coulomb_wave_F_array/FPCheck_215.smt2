...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1474) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1473)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1476) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) c_ack!1475)))))
  (FPCHECK_FINVALID_LOG (fp.abs a!12) (fp.abs a!12))))))))
