...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!326) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!325)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!328) ((_ to_fp 11 53) #x0000000000000000)))
