(declare-fun d_ack!1010 () (_ BitVec 64))
...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1010) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1009)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.sub roundNearestTiesToEven
            a!6
            (fp.mul roundNearestTiesToEven a!7 ((_ to_fp 11 53) c_ack!1011)))
    (fp.mul roundNearestTiesToEven a!8 ((_ to_fp 11 53) c_ack!1011)))))))
