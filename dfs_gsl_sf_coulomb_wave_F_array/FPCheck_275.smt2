(declare-fun d_ack!1714 () (_ BitVec 64))
(declare-fun b_ack!1713 () (_ BitVec 32))
(declare-fun a_ack!1716 () (_ BitVec 64))
(declare-fun c_ack!1715 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1714) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1713)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1716) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1715)
                                  ((_ to_fp 11 53) #x3ff0000000000000)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1715)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1715)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   (CF_atan2 c_ack!1715 #x401e000000000000)))
                   ((_ to_fp 11 53) c_ack!1715)))
      (a!13 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            a!10
...
(let ((a!16 (fp.sub roundNearestTiesToEven
      ...
      (a!20 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!15
                            ((_ to_fp 11 53) #x4020000000000000)))))
  (FPCHECK_FADD_OVERFLOW a!4 (CF_atan2 a!16 a!20))))))))
