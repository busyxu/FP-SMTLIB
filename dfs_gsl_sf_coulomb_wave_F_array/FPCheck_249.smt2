(declare-fun d_ack!1610 () (_ BitVec 64))
(declare-fun b_ack!1609 () (_ BitVec 32))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1610) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1609)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1612) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW c_ack!1611 (CF_atan2 c_ack!1611 #x401e000000000000)))
