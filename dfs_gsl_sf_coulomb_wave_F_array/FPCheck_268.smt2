(declare-fun d_ack!1686 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1686) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1685)))
...
(assert (FPCHECK_FMUL_ACCURACY
  #x3fe0000000000000
  (CF_atan2 c_ack!1687 #x401e000000000000)))
