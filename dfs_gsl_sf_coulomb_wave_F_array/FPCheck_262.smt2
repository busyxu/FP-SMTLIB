(declare-fun d_ack!1662 () (_ BitVec 64))
(declare-fun b_ack!1661 () (_ BitVec 32))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1662) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1661)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1664) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) c_ack!1663)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1663)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!1663)
                                   (CF_atan2 c_ack!1663 #x401e000000000000)))
...
(let ((a!17 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven a!4 ((_ to_fp 11 53) #x3fed67f1c864beb5))
    (fp.add roundNearestTiesToEven
            (CF_log (fp.abs a!16))
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
