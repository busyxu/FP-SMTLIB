(declare-fun d_ack!1646 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1646) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1645)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1648) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1647)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1647)))
                   a!2)))
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!1647)
                                   (CF_atan2 c_ack!1647 #x401e000000000000)))
