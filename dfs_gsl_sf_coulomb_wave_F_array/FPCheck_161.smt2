...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1170) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1169)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1172) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    a!9
    (fp.mul roundNearestTiesToEven a!10 ((_ to_fp 11 53) c_ack!1171))))))))
