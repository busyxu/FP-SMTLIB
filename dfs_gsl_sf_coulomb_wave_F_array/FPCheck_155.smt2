...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1118) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1117)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1120) ((_ to_fp 11 53) #x0000000000000000)))
