(declare-fun d_ack!1558 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1558) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1557)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1560) ((_ to_fp 11 53) #x0000000000000000)))
