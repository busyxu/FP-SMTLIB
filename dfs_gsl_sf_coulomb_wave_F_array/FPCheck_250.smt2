(declare-fun d_ack!1614 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1614) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1613)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1616) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1615)))))
...
(assert (FPCHECK_FMUL_ACCURACY c_ack!1615 (CF_atan2 c_ack!1615 #x401e000000000000)))
