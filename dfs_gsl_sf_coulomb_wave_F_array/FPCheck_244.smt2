(declare-fun d_ack!1590 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1590) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1589)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1592) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!14 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (CF_log a!13))))))
  (FPCHECK_FMUL_ACCURACY #x3cb0000000000000 a!14)))))))))
