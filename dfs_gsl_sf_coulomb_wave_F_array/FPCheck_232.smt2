(declare-fun d_ack!1542 () (_ BitVec 64))
...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) d_ack!1542) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1541)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1544) ((_ to_fp 11 53) #x0000000000000000)))
