(declare-fun d_ack!1546 () (_ BitVec 64))
...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1546) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1545)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1548) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.abs a!12)
                                    (fp.abs a!12))))))
  (FPCHECK_FMUL_OVERFLOW #x3fe0000000000000 (CF_log a!13)))))))))
