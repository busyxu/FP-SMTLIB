...
(assert (fp.eq ((_ to_fp 11 53) d_ack!1742) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvsle #x00000000 b_ack!1741)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!1744) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) #x401e000000000000)
            (fp.abs ((_ to_fp 11 53) c_ack!1743)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!1743)))
                   a!2))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   (CF_atan2 c_ack!1743 #x401e000000000000)))
                   ((_ to_fp 11 53) c_ack!1743)))
      (a!13 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            a!10
