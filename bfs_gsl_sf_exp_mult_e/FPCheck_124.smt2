...
(assert (fp.lt ((_ to_fp 11 53) a_ack!450) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!450) ((_ to_fp 11 53) #xc076232bdd7abcd2))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!449)
                          ((_ to_fp 11 53) #x0000000000000000))
                  #x00000001
                  #xffffffff)))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!449))))))
  (FPCHECK_FMUL_OVERFLOW
    a!1
    (CF_exp (fp.add roundNearestTiesToEven (CF_floor a_ack!450) a!2)))))
