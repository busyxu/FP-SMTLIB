...
(assert (fp.lt ((_ to_fp 11 53) a_ack!228) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!228) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!227))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (FPCHECK_FADD_ACCURACY a_ack!228 (CF_log (fp.abs ((_ to_fp 11 53) b_ack!227)))))
