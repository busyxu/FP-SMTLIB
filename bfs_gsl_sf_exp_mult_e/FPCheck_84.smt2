...
(assert (fp.lt ((_ to_fp 11 53) a_ack!300) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!300) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299)))))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299)))))
      ...
      (a!3 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!299)
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x3cc0000000000000)
                 (fp.add roundNearestTiesToEven a!1 (fp.abs a!2)))))))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299))))))
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven (CF_floor a_ack!300) a!1)
    #x3ff0000000000000)))
