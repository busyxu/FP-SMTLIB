...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!370) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!370)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!369))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x40862e2e8418f241)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!370)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!369))))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #xc086231762997524)))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!369)))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.geq ((_ to_fp 11 53) b_ack!369)
...
(let ((a!6 (CF_exp (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   (CF_floor a_ack!370))
                           a!5))))
  (FPCHECK_FMUL_OVERFLOW a!2 (fp.abs (fp.mul roundNearestTiesToEven a!4 a!6)))))))
