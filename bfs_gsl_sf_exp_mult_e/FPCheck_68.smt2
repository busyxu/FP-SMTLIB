...
(assert (fp.lt ((_ to_fp 11 53) a_ack!236) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!236) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!235))
       ((_ to_fp 11 53) #x5fe9999999999999)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!235))
       ((_ to_fp 11 53) #x2003333333333333)))
(assert (FPCHECK_FMUL_UNDERFLOW b_ack!235 (CF_exp a_ack!236)))
