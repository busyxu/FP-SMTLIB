...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!281)))))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!281))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!281)))))
      ...
      (a!3 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!281)
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x3cc0000000000000)
                 (fp.add roundNearestTiesToEven a!1 (fp.abs a!2)))))))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!281))))))
  (FPCHECK_FADD_OVERFLOW (CF_floor a_ack!282) a!1)))
