...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!136) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!135))))))
  (FPCHECK_FSUB_ACCURACY (CF_log (fp.abs ((_ to_fp 11 53) b_ack!135))) a!1)))
