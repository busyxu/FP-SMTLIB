...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!166) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!165))))))
  (FPCHECK_FADD_ACCURACY (CF_floor a_ack!166) a!1)))
