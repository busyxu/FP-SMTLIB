...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!198) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!197)
                          ((_ to_fp 11 53) #x0000000000000000))
                  #x00000001
                  #xffffffff)))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!197))))))
