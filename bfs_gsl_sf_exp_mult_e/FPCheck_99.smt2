...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!356) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!355))))))
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven (CF_floor a_ack!356) a!1)
    #x3ff0000000000000)))
