...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!374) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!373)))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.geq ((_ to_fp 11 53) b_ack!373)
