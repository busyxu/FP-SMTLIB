...
(assert (fp.lt ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x40862e2e8418f241)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!292)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291))))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #xc086231762997524)))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291)))))
      (a!2 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291)))))
      ...
      (a!3 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) b_ack!291)
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x3cc0000000000000)
                 (fp.add roundNearestTiesToEven a!1 (fp.abs a!2)))))))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!291))))))
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven (CF_floor a_ack!292) a!1)
    #x3ff0000000000000)))
