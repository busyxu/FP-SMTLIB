...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!162) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) b_ack!161))))))
  (FPCHECK_FADD_UNDERFLOW (CF_floor a_ack!162) a!1)))
