...
(assert (= #x00000001 b_ack!537))
(assert (not (bvslt b_ack!537 #x00000000)))
(assert (not (bvslt a_ack!539 b_ack!537)))
(assert (not (= #x00000000 b_ack!537)))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!539 b_ack!537))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub a_ack!539 b_ack!537))))))
...
(assert (FPCHECK_FMUL_OVERFLOW
  #x3fe0000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd a_ack!539 b_ack!537))))
