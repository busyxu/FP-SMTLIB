...
(assert (not (bvsle #x00000003 a_ack!968)))
(assert (bvsle #x00000000 a_ack!968))
(assert (bvsle #x00000001 a_ack!968))
(assert (FPCHECK_FSUB_UNDERFLOW c_ack!967 #x3ff0000000000000))
