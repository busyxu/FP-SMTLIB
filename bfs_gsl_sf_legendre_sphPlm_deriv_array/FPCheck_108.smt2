...
(assert (= #x00000001 b_ack!483))
(assert (not (bvslt b_ack!483 #x00000000)))
(assert (not (bvslt a_ack!485 b_ack!483)))
(assert (not (= #x00000000 b_ack!483)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!485 b_ack!483))
...
(assert (not (= #x00000000 b_ack!483)))
(assert (FPCHECK_FADD_OVERFLOW #x3ff0000000000000 c_ack!484))
