...
(assert (not (bvslt a_ack!509 b_ack!507)))
(assert (not (= #x00000000 b_ack!507)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!509 b_ack!507))
...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!508) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!508) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000000 b_ack!507))
...
(assert (not (= #x00000000 b_ack!507)))
(assert (bvsle #x00000001 b_ack!507))
(assert (not (bvsle #x00000002 b_ack!507)))
(assert (FPCHECK_FADD_OVERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven b_ack!507))
  #x3ff0000000000000))
