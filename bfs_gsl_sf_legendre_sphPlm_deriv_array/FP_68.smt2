...
(assert (bvsle #x00000000 a_ack!1016))
(assert (bvsle #x00000001 a_ack!1016))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!1015)
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1016)
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
...
(assert (not (bvsle #x00000002 a_ack!1016)))
(assert (bvsle #x00000000 a_ack!1016))
(assert (not (bvsle #x00000001 a_ack!1016)))
