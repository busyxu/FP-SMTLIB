...
(assert (= #x00000001 b_ack!1434))
(assert (not (bvslt b_ack!1434 #x00000000)))
(assert (not (bvslt a_ack!1436 b_ack!1434)))
(assert (not (= #x00000000 b_ack!1434)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!1436 b_ack!1434))
...
(assert (let ((a!1 (fp.lt (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (= #x00000002 b_ack!1434)))
(assert (let ((a!1 (fp.lt (fp.sub roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.abs ((_ to_fp 11 53) c_ack!1435)))
                  ((_ to_fp 11 53) #x3cb0000000000000))))
...
(assert (FPCHECK_FDIV_INVALID
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvsub #x00000000 b_ack!1434))
