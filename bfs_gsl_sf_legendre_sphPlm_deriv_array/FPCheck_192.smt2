...
(assert (not (bvsle #x00000003 a_ack!965)))
(assert (bvsle #x00000000 a_ack!965))
(assert (bvsle #x00000001 a_ack!965))
(assert (FPCHECK_FSUB_OVERFLOW c_ack!964 #x3ff0000000000000))
