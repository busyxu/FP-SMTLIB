...
(assert (= #x00000001 b_ack!756))
(assert (not (bvslt b_ack!756 #x00000000)))
(assert (not (bvslt a_ack!758 b_ack!756)))
(assert (not (= #x00000000 b_ack!756)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!758 b_ack!756))
...
(assert (= a_ack!758 b_ack!756))
(assert (= #x00000001 b_ack!756))
(assert (FPCHECK_FSUB_ACCURACY #x3ff0000000000000 (fp.abs ((_ to_fp 11 53) c_ack!757))))
