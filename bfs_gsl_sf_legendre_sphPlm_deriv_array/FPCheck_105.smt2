...
(assert (not (bvslt a_ack!473 b_ack!471)))
(assert (not (= #x00000000 b_ack!471)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!473 b_ack!471))
...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!472) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!472) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000000 b_ack!471))
...
(assert (not (= #x00000000 b_ack!471)))
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 c_ack!472))
