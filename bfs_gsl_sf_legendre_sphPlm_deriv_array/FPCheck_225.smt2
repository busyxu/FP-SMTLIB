...
(assert (not (= #x00000000 b_ack!1140)))
(assert (not (= #x00000001 b_ack!1140)))
(assert (not (bvslt b_ack!1140 #x00000000)))
(assert (not (bvslt a_ack!1142 b_ack!1140)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1141) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1141) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000000 b_ack!1140))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1141) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1141) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!1140)))
