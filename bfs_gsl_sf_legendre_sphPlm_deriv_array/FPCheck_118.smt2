...
(assert (= #x00000001 b_ack!516))
(assert (not (bvslt b_ack!516 #x00000000)))
(assert (not (bvslt a_ack!518 b_ack!516)))
(assert (not (= #x00000000 b_ack!516)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!518 b_ack!516))
...
(assert (not (= #x00000000 b_ack!516)))
(assert (bvsle #x00000001 b_ack!516))
(assert (not (bvsle #x00000002 b_ack!516)))
