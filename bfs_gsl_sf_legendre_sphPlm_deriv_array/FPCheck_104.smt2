...
(assert (= #x00000001 b_ack!468))
(assert (not (bvslt b_ack!468 #x00000000)))
(assert (not (bvslt a_ack!470 b_ack!468)))
(assert (not (= #x00000000 b_ack!468)))
(assert (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!470 b_ack!468))
...
(assert (not (= #x00000000 b_ack!468)))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 c_ack!469))
