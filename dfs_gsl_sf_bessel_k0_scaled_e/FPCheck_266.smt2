...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!353) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!353) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) #xbe40afa9d3cdef4f)))))
  (FPCHECK_FADD_ACCURACY a!13 #xbed0d595dd239ad5)))))))))))))))
