...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!425) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!425) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!425) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (bvslt a_ack!426 #x000186a0))
(assert (bvsle #x00000002 a_ack!426))
(assert (bvsle #x00000003 a_ack!426))
(assert (not (bvsle #x00000004 a_ack!426)))
