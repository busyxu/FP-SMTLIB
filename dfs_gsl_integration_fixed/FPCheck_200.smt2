...
(declare-fun alpha_ack!590 () (_ BitVec 64))
...
(assert (not (fp.leq ((_ to_fp 11 53) alpha_ack!590)
             ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fe0000000000000)
                          (fp.add roundNearestTiesToEven
                                  ((_ to_fp 11 53) alpha_ack!590)
...
(assert (FPCHECK_FINVALID_SQRT b_ack!589 b_ack!589))
