...
(assert (not (bvslt a_ack!4873 #x00000000)))
(assert (not (= #x00000000 a_ack!4873)))
(assert (not (= #x00000001 a_ack!4873)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4872) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4872) ((_ to_fp 11 53) #x4014000000000000))))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!4873))
                   ((_ to_fp 11 53) c_ack!4872))))
