...
(assert (fp.eq ((_ to_fp 11 53) c_ack!286) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000002 a_ack!287))
(assert (bvsle #x00000003 a_ack!287))
(assert (bvsle #x00000004 a_ack!287))
