...
(assert (fp.eq ((_ to_fp 11 53) c_ack!1578) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000017 a_ack!1579))
(assert (bvsle #x00000018 a_ack!1579))
(assert (bvsle #x00000019 a_ack!1579))
(assert (bvsle #x0000001a a_ack!1579))
(assert (bvsle #x0000001b a_ack!1579))
(assert (bvsle #x0000001c a_ack!1579))
