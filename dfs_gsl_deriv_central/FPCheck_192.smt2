...
(let ((a!6 (fp.div roundNearestTiesToEven
      ...
      (a!9 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) h_ack!812)))
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) x_ack!813))
                           ((_ to_fp 11 53) h_ack!812))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!812))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!813)
                           (fp.div roundNearestTiesToEven
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) h_ack!812)
                            (CF_pow a!11 #x3fd5555555555555)))))
  (fp.eq a!12 ((_ to_fp 11 53) x_ack!813))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!813)
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) h_ack!812)
...
(let ((a!11 (fp.div roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4000000000000000)
                            (fp.abs a!10)))))
(let ((a!12 (CF_pow (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) x_ack!813)
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!812)
                                    (CF_pow a!11 #x3fd5555555555555)))
                    #x3ff8000000000000))
      (a!13 (CF_pow (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) x_ack!813)
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!812)
                                    (CF_pow a!11 #x3fd5555555555555)))
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x3fe0000000000000)
            (fp.sub roundNearestTiesToEven a!12 a!13)))))))))
