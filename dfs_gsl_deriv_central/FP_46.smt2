(declare-fun h_ack!694 () (_ BitVec 64))
...
(let ((a!6 (fp.div roundNearestTiesToEven
      ...
      (a!9 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) h_ack!694)))
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) x_ack!695))
                           ((_ to_fp 11 53) h_ack!694))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!694))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!695)
                           (fp.div roundNearestTiesToEven
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) h_ack!694)
                            (CF_pow a!11 #x3fd5555555555555)))))
  (fp.eq a!12 ((_ to_fp 11 53) x_ack!695))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!695)
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) h_ack!694)
