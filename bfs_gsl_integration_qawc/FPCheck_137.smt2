...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1788) ((_ to_fp 11 53) a_ack!1792)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!1790)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1789) ((_ to_fp 11 53) a_ack!1792))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1789) ((_ to_fp 11 53) b_ack!1788))))
