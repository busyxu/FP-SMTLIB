...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2903) ((_ to_fp 11 53) a_ack!2907)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!2905)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2904) ((_ to_fp 11 53) a_ack!2907))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2904) ((_ to_fp 11 53) b_ack!2903))))
