...
(declare-fun a_ack!7635 () (_ BitVec 64))
(declare-fun b_ack!7630 () (_ BitVec 64))
(declare-fun epsabs_ack!7632 () (_ BitVec 64))
(declare-fun epsrel_ack!7633 () (_ BitVec 64))
(declare-fun c_ack!7631 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!7634)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!7630) ((_ to_fp 11 53) a_ack!7635)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!7632) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7633)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7633)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!7631) ((_ to_fp 11 53) a_ack!7635))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!7631) ((_ to_fp 11 53) b_ack!7630))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) c_ack!7631))
                   ((_ to_fp 11 53) a_ack!7635))))
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven
                         a!1
                         ((_ to_fp 11 53) b_ack!7630))
                 ((_ to_fp 11 53) b_ack!7630))
         a!1)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
