(declare-fun limit_ack!8402 () (_ BitVec 64))
(declare-fun a_ack!8403 () (_ BitVec 64))
(declare-fun b_ack!8398 () (_ BitVec 64))
(declare-fun epsabs_ack!8400 () (_ BitVec 64))
(declare-fun epsrel_ack!8401 () (_ BitVec 64))
(declare-fun c_ack!8399 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!8402)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!8398) ((_ to_fp 11 53) a_ack!8403)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!8400) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!8401)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!8401)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!8399) ((_ to_fp 11 53) a_ack!8403))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!8399) ((_ to_fp 11 53) b_ack!8398))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) c_ack!8399))
                   ((_ to_fp 11 53) a_ack!8403))))
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven
                         a!1
                         ((_ to_fp 11 53) b_ack!8398))
                 ((_ to_fp 11 53) b_ack!8398))
         a!1)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
