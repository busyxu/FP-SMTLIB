...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1828) ((_ to_fp 11 53) a_ack!1832)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!1830)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1829) ((_ to_fp 11 53) a_ack!1832))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1829) ((_ to_fp 11 53) b_ack!1828))))
