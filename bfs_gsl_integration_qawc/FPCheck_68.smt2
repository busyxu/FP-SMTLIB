...
(assert (fp.lt ((_ to_fp 11 53) b_ack!863) ((_ to_fp 11 53) a_ack!868)))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!864) ((_ to_fp 11 53) a_ack!868))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!864) ((_ to_fp 11 53) b_ack!863))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!863))
