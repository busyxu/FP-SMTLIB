...
(assert (fp.lt ((_ to_fp 11 53) b_ack!947) ((_ to_fp 11 53) a_ack!952)))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!948) ((_ to_fp 11 53) a_ack!952))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!948) ((_ to_fp 11 53) b_ack!947))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!947))
...
(assert (FPCHECK_FADD_UNDERFLOW b_ack!947 a_ack!952))
