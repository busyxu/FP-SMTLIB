...
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!875) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!875) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!874) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.gt ((_ to_fp 11 53) nu2_ack!874) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) nu2_ack!874)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) nu2_ack!874))))
(assert (FPCHECK_FDIV_INVALID nu2_ack!874 nu1_ack!873))
