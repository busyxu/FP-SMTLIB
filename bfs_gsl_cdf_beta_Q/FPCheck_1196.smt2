...
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!5361) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!5361) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) nu2_ack!5362) ((_ to_fp 11 53) #x0000000000000000))))
