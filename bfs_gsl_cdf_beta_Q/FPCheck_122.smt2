...
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!605) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) nu1_ack!603) ((_ to_fp 11 53) nu2_ack!604))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!603) ((_ to_fp 11 53) nu2_ack!604))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu2_ack!604)
                    ((_ to_fp 11 53) nu2_ack!604))
            ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (FPCHECK_FSUB_UNDERFLOW nu1_ack!603 #x3ff0000000000000))
