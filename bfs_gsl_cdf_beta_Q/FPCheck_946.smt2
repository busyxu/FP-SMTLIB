...
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!4255) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.gt ((_ to_fp 11 53) nu2_ack!4255) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4254) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!4255) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!4254) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) nu2_ack!4255) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) nu1_ack!4254) ((_ to_fp 11 53) nu2_ack!4255))))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!4254) ((_ to_fp 11 53) nu2_ack!4255)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FSUB_OVERFLOW nu1_ack!4254 #x4000000000000000))
