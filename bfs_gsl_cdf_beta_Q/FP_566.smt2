...
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!9250) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!9249) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) nu2_ack!9250) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!9249) ((_ to_fp 11 53) nu2_ack!9250)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!9249) ((_ to_fp 11 53) nu2_ack!9250))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu2_ack!9250)
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (fp.geq ((_ to_fp 11 53) nu1_ack!9249) ((_ to_fp 11 53) #x3fe0000000000000)))
