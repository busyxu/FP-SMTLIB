...
(assert (fp.lt ((_ to_fp 11 53) a_ack!17) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!16)) ((_ to_fp 11 53) #x4034000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW #x4034000000000000 b_ack!16))
