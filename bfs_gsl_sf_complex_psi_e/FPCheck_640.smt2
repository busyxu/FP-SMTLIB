...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2375) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2375)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2375))
      ...
      (a!6 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!5))
                   a!3)))
  (FPCHECK_FADD_OVERFLOW (fp.mul roundNearestTiesToEven a!4 a!5) a!6)))))
