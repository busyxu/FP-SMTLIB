...
(assert (fp.lt ((_ to_fp 11 53) a_ack!13) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!12)) ((_ to_fp 11 53) #x4034000000000000)))
(assert (FPCHECK_FADD_ACCURACY #x4034000000000000 b_ack!12))
