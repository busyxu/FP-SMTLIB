...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2539) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2539)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2539))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #xbfde79e79e79e79e
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbff0cccccccccccd) a!4))))))
