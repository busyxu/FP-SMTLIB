...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1331) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1331)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1331))
...
(assert (let ((a!1 (CF_log (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) b_ack!1330))))))
  (FPCHECK_FADD_UNDERFLOW a!1 #x7ff0000000000001)))
