...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.geq ((_ to_fp 11 53) a_ack!1619) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1619) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1619) ((_ to_fp 11 53) #x4034000000000000)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfde79e79e79e79e) a!4)
    (fp.add roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!2 a!3)
            (fp.mul roundNearestTiesToEven a!3 a!2)))))))
