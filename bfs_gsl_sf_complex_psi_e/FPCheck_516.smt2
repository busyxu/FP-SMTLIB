...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1861) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1861)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1861))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY a!2 #x3fa97487e6e48ff5))))
