...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1167) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1167)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1167))
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven a!7 a!3) a!9)
    #x3ff0000000000000))))))
