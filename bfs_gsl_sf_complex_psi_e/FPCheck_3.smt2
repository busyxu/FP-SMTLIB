...
(assert (fp.lt ((_ to_fp 11 53) a_ack!7) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!6)) ((_ to_fp 11 53) #x4034000000000000)))
(assert (FPCHECK_FADD_OVERFLOW #x4034000000000000 b_ack!6))
