(declare-fun a_ack!2471 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2471) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.add roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x3ff0000000000000)
                       ((_ to_fp 11 53) a_ack!2471))
               ((_ to_fp 11 53) a_ack!2471))
       ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2471)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2471))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!2470))
                           ((_ to_fp 11 53) #x3fb893c438dd7d5a))))
      (a!2 (CF_ceil (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4018fae0bc28e17b)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    ((_ to_fp 11 53) a_ack!2471))))))
(let ((a!3 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3fb893c438dd7d5a))
