...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (fp.geq ((_ to_fp 11 53) a_ack!1719) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1719) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1719) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1718))
