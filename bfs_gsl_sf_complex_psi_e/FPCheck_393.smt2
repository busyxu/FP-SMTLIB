...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1375) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1375)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1375))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    (CF_atan2 (fp.sub roundNearestTiesToEven
                              ...
                              a!1)
                    a!14)))
  (FPCHECK_FMUL_ACCURACY #x3cc0000000000000 (fp.abs a!15))))))))))))
