...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1919) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1919)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1919))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3fa97487e6e48ff5))
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3fa97487e6e48ff5)))))
