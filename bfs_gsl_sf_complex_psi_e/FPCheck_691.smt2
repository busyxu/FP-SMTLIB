...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2577) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2577)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2577))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbff0cccccccccccd)
                           a!4))))
  (fp.eq a!5 ((_ to_fp 11 53) #x3ff0000000000000)))))))
(assert (let ((a!1 (CF_ceil (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4018fae0bc28e17b)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
      ...
      (a!7 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!6))
                   a!6)))
  (FPCHECK_FSUB_OVERFLOW (fp.mul roundNearestTiesToEven a!5 a!4) a!7))))))
