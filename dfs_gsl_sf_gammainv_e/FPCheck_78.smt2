...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.leq ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!120) (CF_floor a_ack!120))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) #x3fe0000000000000)))
