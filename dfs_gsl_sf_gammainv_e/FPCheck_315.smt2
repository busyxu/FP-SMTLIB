...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!510) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!510) ((_ to_fp 11 53) #x4065600000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!510) (CF_floor a_ack!510))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!510) ((_ to_fp 11 53) #x4065600000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven a!2 a!1)
         (CF_pow a_ack!510
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3fe0000000000000)
                         ((_ to_fp 11 53) a_ack!510)))))))
(assert (let ((a!1 (fp.abs (CF_pow a_ack!510
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   ((_ to_fp 11 53) a_ack!510))))))
