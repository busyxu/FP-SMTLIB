(declare-fun epsabs_ack!984 () (_ BitVec 64))
(declare-fun epsrel_ack!985 () (_ BitVec 64))
(declare-fun b_ack!983 () (_ BitVec 64))
(declare-fun a_ack!986 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!984)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!985)
            ((_ to_fp 11 53) #x0000000000000000))))
