(declare-fun epsabs_ack!2872 () (_ BitVec 64))
(declare-fun epsrel_ack!2873 () (_ BitVec 64))
(declare-fun b_ack!2871 () (_ BitVec 64))
(declare-fun a_ack!2874 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!2872)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2873)
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!24 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            a!22))))
  (not (fp.lt a!24 ((_ to_fp 11 53) epsabs_ack!2872)))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!2871)
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            ...
            (fp.div roundNearestTiesToEven
                    a!33
                    ((_ to_fp 11 53) #x402e000000000000)))
    (fp.div roundNearestTiesToEven a!35 ((_ to_fp 11 53) #x402e000000000000)))))))))))))))
