...
(declare-fun epsrel_ack!1053 () (_ BitVec 64))
(declare-fun b_ack!1051 () (_ BitVec 64))
(declare-fun a_ack!1054 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1052)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1053)
            ((_ to_fp 11 53) #x0000000000000000))))
