(declare-fun epsabs_ack!2956 () (_ BitVec 64))
(declare-fun epsrel_ack!2957 () (_ BitVec 64))
(declare-fun b_ack!2955 () (_ BitVec 64))
(declare-fun a_ack!2958 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!2956)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2957)
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!24 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            a!22))))
  (not (fp.lt a!24 ((_ to_fp 11 53) epsabs_ack!2956)))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!2955)
...
(let ((a!40 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!39
                            ((_ to_fp 11 53) #x404f800000000000)))))
  (FPCHECK_FDIV_OVERFLOW a!40 #x406fe00000000000)))))))))))))))
