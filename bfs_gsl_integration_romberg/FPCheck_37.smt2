(declare-fun epsabs_ack!267 () (_ BitVec 64))
(declare-fun epsrel_ack!268 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun b_ack!266 () (_ BitVec 64))
(declare-fun a_ack!269 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!267)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!268)
            ((_ to_fp 11 53) #x0000000000000000))))
