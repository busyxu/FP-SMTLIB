...
(declare-fun epsrel_ack!1517 () (_ BitVec 64))
(declare-fun b_ack!1515 () (_ BitVec 64))
(declare-fun a_ack!1518 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1516)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1517)
            ((_ to_fp 11 53) #x0000000000000000))))
