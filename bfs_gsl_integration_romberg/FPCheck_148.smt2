...
(declare-fun epsrel_ack!1233 () (_ BitVec 64))
(declare-fun b_ack!1231 () (_ BitVec 64))
(declare-fun a_ack!1234 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1232)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1233)
            ((_ to_fp 11 53) #x0000000000000000))))
