(declare-fun epsabs_ack!6604 () (_ BitVec 64))
(declare-fun epsrel_ack!6605 () (_ BitVec 64))
(declare-fun b_ack!6603 () (_ BitVec 64))
(declare-fun a_ack!6606 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6604)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!6605)
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!24 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            a!22))))
  (not (fp.lt a!24 ((_ to_fp 11 53) epsabs_ack!6604)))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!6603)
...
(let ((a!41 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!39
                                    ((_ to_fp 11 53) #x404f800000000000))))))
  (not (fp.lt a!41 ((_ to_fp 11 53) epsabs_ack!6604))))))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!6603)
...
(let ((a!71 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!69
                                    ((_ to_fp 11 53) #x406fe00000000000))))))
  (not (fp.lt a!71 ((_ to_fp 11 53) epsabs_ack!6604))))))))))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!6603)
