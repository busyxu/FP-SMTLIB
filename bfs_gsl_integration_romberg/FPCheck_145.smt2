(declare-fun epsabs_ack!1208 () (_ BitVec 64))
(declare-fun epsrel_ack!1209 () (_ BitVec 64))
(declare-fun b_ack!1207 () (_ BitVec 64))
(declare-fun a_ack!1210 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1208)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1209)
            ((_ to_fp 11 53) #x0000000000000000))))
