...
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!4824)
...
(let ((a!24 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            a!22))))
  (not (fp.lt a!24 ((_ to_fp 11 53) epsabs_ack!4824)))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!4823)
...
(let ((a!41 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!39
                                    ((_ to_fp 11 53) #x404f800000000000))))))
  (not (fp.lt a!41 ((_ to_fp 11 53) epsabs_ack!4824))))))))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!4823)
