(declare-fun epsabs_ack!1060 () (_ BitVec 64))
(declare-fun epsrel_ack!1061 () (_ BitVec 64))
(declare-fun b_ack!1059 () (_ BitVec 64))
(declare-fun a_ack!1062 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1060)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1061)
            ((_ to_fp 11 53) #x0000000000000000))))
