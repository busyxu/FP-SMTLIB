...
(declare-fun epsrel_ack!1581 () (_ BitVec 64))
(declare-fun b_ack!1579 () (_ BitVec 64))
(declare-fun a_ack!1582 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1580)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1581)
            ((_ to_fp 11 53) #x0000000000000000))))
