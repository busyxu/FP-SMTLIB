(declare-fun epsabs_ack!1044 () (_ BitVec 64))
(declare-fun epsrel_ack!1045 () (_ BitVec 64))
(declare-fun b_ack!1043 () (_ BitVec 64))
(declare-fun a_ack!1046 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1044)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1045)
            ((_ to_fp 11 53) #x0000000000000000))))
