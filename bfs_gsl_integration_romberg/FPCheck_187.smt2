(declare-fun epsabs_ack!1572 () (_ BitVec 64))
(declare-fun epsrel_ack!1573 () (_ BitVec 64))
(declare-fun b_ack!1571 () (_ BitVec 64))
(declare-fun a_ack!1574 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1572)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1573)
            ((_ to_fp 11 53) #x0000000000000000))))
