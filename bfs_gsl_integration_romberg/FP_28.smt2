...
(declare-fun epsrel_ack!613 () (_ BitVec 64))
(declare-fun b_ack!611 () (_ BitVec 64))
(declare-fun a_ack!614 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!612)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!613)
            ((_ to_fp 11 53) #x0000000000000000))))
