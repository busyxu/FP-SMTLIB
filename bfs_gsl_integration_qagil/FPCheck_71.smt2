(declare-fun limit_ack!489 () (_ BitVec 64))
(declare-fun epsabs_ack!487 () (_ BitVec 64))
(declare-fun epsrel_ack!488 () (_ BitVec 64))
(declare-fun b_ack!490 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!489)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!487) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!488)
