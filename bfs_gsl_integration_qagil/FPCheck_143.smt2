(declare-fun limit_ack!937 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!937)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!935) ((_ to_fp 11 53) #x0000000000000000)))
