...
(declare-fun epsabs_ack!1779 () (_ BitVec 64))
(declare-fun epsrel_ack!1780 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1779) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1780)
...
(let ((a!17 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven (fp.abs a!19) (fp.abs a!21))))))))))
