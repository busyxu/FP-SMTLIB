(declare-fun limit_ack!2273 () (_ BitVec 64))
(declare-fun epsabs_ack!2271 () (_ BitVec 64))
(declare-fun epsrel_ack!2272 () (_ BitVec 64))
(declare-fun b_ack!2274 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_LOG
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!2273)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!2271) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2272)
