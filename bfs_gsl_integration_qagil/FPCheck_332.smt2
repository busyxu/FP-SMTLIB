...
(declare-fun epsrel_ack!2140 () (_ BitVec 64))
(declare-fun b_ack!2142 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!2141)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!2139) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2140)
