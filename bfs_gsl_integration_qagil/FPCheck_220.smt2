...
(declare-fun epsabs_ack!1435 () (_ BitVec 64))
(declare-fun epsrel_ack!1436 () (_ BitVec 64))
(declare-fun b_ack!1438 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!1437)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1435) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1436)
