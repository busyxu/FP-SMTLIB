(declare-fun limit_ack!1249 () (_ BitVec 64))
(declare-fun epsabs_ack!1247 () (_ BitVec 64))
(declare-fun epsrel_ack!1248 () (_ BitVec 64))
(declare-fun b_ack!1250 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_SQRT
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!1249)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1247) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1248)
