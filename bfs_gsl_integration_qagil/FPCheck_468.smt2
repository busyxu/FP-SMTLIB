(declare-fun limit_ack!3021 () (_ BitVec 64))
(declare-fun epsabs_ack!3019 () (_ BitVec 64))
(declare-fun epsrel_ack!3020 () (_ BitVec 64))
(declare-fun b_ack!3022 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3021)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3019) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3020)
...
(let ((a!36 (fp.add roundNearestTiesToEven
                    ...
                    a!35)))
  (FPCHECK_FADD_OVERFLOW a!36 a!37))))))))))
