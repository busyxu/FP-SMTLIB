(declare-fun limit_ack!1361 () (_ BitVec 64))
(declare-fun epsabs_ack!1359 () (_ BitVec 64))
(declare-fun epsrel_ack!1360 () (_ BitVec 64))
(declare-fun b_ack!1362 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!1361)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1359) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1360)
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!11
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x3fd86fe74ee32b3d)
