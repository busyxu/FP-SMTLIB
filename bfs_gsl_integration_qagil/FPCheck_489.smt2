(declare-fun limit_ack!3165 () (_ BitVec 64))
(declare-fun epsabs_ack!3163 () (_ BitVec 64))
(declare-fun epsrel_ack!3164 () (_ BitVec 64))
(declare-fun b_ack!3166 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3165)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3163) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3164)
