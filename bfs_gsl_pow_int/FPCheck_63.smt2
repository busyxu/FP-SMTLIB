(declare-fun n_ack!278 () (_ BitVec 32))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun x_ack!279 () (_ BitVec 64))
(assert (not (bvslt n_ack!278 #x00000000)))
(assert (= #x00000000 (bvand n_ack!278 #x00000001)))
(assert (not (= #x00000000 (concat #b0 ((_ extract 31 1) n_ack!278)))))
(assert (= #x00000000 (bvand (concat #b0 ((_ extract 31 1) n_ack!278)) #x00000001)))
(assert (let ((a!1 (concat #b0
                   ((_ extract 31 1) (concat #b0 ((_ extract 31 1) n_ack!278))))))
  (not (= #x00000000 a!1))))
(assert (let ((a!1 (concat #b0
                   ((_ extract 31 1) (concat #b0 ((_ extract 31 1) n_ack!278))))))
