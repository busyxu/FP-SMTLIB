...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!854 #x00000007)))
       #x0000000000000011))
...
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3fe0000000000000))))
      (a!6 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand d_ack!854 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!855)
...
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x400921fb54442d18))))))
(let ((a!3 (fp.gt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!853)
...
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
                 ...
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) c_ack!853)
                         (fp.mul roundNearestTiesToEven a!2 a!2)))
         ((_ to_fp 11 53) #x551c4b19c41f715f)))))
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             (fp.div roundNearestTiesToEven
                                     ((_ to_fp 11 53) a_ack!855)
                                     ((_ to_fp 11 53) #x400921fb54442d18))
