...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!746 #x00000007)))
       #x0000000000000011))
...
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3fe0000000000000))))
      (a!6 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand d_ack!746 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!747)
...
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x400921fb54442d18))))))
  (FPCHECK_FMUL_OVERFLOW c_ack!745 (fp.mul roundNearestTiesToEven a!2 a!2)))))
