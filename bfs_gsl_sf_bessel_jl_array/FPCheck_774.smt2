...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2514) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2514) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2515) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2514) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2514) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2515)))
(assert (= #x00000000 a_ack!2515))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2514) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2514))
            ((_ to_fp 11 53) #x0028cccccccccccd))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2514))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2514))
