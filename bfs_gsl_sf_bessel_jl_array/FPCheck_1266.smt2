...
(assert (not (bvslt (bvadd #x00000001 a_ack!3909) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3908) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3908) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3909)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3909)
                           (bvadd #x00000001 a_ack!3909))
                    a_ack!3909))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!3909))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3908) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!9
                                    ((_ to_fp 11 53) #x3cb94db1c568487f))))))
  (FPCHECK_FADD_ACCURACY a!13 #x3d0225e8a47d9640)))))))))))))))
