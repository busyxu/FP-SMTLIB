...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4578) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4578) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4579) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4578) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4578) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4579)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4579)
                           (bvadd #x00000001 a_ack!4579))
                    a_ack!4579))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4579))
...
(let ((a!32 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!31)))
  (FPCHECK_FSUB_OVERFLOW a!32 a!29))))))))))))))))))))))))))))))))))
