...
(assert (not (bvslt (bvadd #x00000001 a_ack!4223) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4222) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4222) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4223)
                           (bvadd #x00000001 a_ack!4223))
                    a_ack!4223))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4223))
...
(let ((a!21 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW (fp.abs a!21) (fp.abs a!19))))))))))))))))))))))))
