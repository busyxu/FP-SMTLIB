...
(assert (not (bvslt (bvadd #x00000001 a_ack!4287) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4286) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4286) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4287)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4287)
                           (bvadd #x00000001 a_ack!4287))
                    a_ack!4287))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4287))
...
(let ((a!23 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!20 a!17)
                                    ((_ to_fp 11 53) #xbdb2bcfadee8bf50))))))
  (FPCHECK_FADD_ACCURACY a!23 #x3df6eb128f4fdc48)))))))))))))))))))))))))
