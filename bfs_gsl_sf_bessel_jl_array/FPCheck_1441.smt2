...
(assert (not (bvslt (bvadd #x00000001 a_ack!4363) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4362) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4362) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4363)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4363)
                           (bvadd #x00000001 a_ack!4363))
                    a_ack!4363))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4363))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4362) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!26 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!25)))
  (FPCHECK_FSUB_OVERFLOW a!26 a!23))))))))))))))))))))))))))))
