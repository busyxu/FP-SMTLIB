...
(assert (not (bvslt (bvadd #x00000001 a_ack!823) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!822) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!822) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!823)
                           (bvadd #x00000001 a_ack!823))
                    a_ack!823))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!823))
...
(assert (FPCHECK_FMUL_ACCURACY
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!823))
          ((_ to_fp 11 53) #x3fe0000000000000))
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!823))
          ((_ to_fp 11 53) #x3fe0000000000000))))
