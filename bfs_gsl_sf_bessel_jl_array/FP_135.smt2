...
(assert (not (bvslt (bvadd #x00000001 a_ack!1839) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1838) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1838) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1839)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     ((_ fp.to_sbv 32) roundTowardZero (CF_floor a!1)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.geq a!2 ((_ to_fp 11 53) #x3fe0000000000000))))))
