...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4121) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4121)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4121)
                           (bvadd #x00000001 a_ack!4121))
                    a_ack!4121))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4121))
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!15 a!13)
                                    ((_ to_fp 11 53) #x3d49133ca5bb62a1))))))
  (FPCHECK_FADD_OVERFLOW a!19 #x3d90974a94a53d6a)))))))))))))))))))))
