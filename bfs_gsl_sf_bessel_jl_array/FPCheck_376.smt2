...
(assert (fp.gt ((_ to_fp 11 53) b_ack!1182)
       ((_ to_fp 11 53)
         roundNearestTiesToEven
         (bvmul (bvadd #x00000001 a_ack!1183) (bvadd #x00000001 a_ack!1183)))))
(assert (FPCHECK_FMUL_OVERFLOW
  #x3fe0000000000000
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!1183))
          ((_ to_fp 11 53) #x3fe0000000000000))))
