...
(assert (not (bvslt (bvadd #x00000001 a_ack!333) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!332) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!332) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!333)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!333)
                           (bvadd #x00000001 a_ack!333))
                    a_ack!333))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!333))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!332) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FDIV_ZERO
  b_ack!332
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!333))
          ((_ to_fp 11 53) #x3fe0000000000000))))
