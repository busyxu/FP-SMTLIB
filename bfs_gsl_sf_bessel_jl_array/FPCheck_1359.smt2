...
(assert (not (bvslt (bvadd #x00000001 a_ack!4151) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4150) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4150) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4151)
                           (bvadd #x00000001 a_ack!4151))
                    a_ack!4151))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4151))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!19)))
  (FPCHECK_FSUB_ACCURACY a!20 a!17))))))))))))))))))))))
