...
(assert (not (bvslt (bvadd #x00000001 a_ack!4339) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4338) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4338) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4339)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4339)
                           (bvadd #x00000001 a_ack!4339))
                    a_ack!4339))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4339))
...
(let ((a!25 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!21 a!19)
                                    ((_ to_fp 11 53) #x3dd4e08def5bb8fa))))))
  (FPCHECK_FADD_UNDERFLOW a!25 #x3e18c14c2781ff02)))))))))))))))))))))))))))
