(declare-fun a_ack!4041 () (_ BitVec 32))
(declare-fun b_ack!4040 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!4041 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4041) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4041)))
(assert (not (= #x00000000 a_ack!4041)))
(assert (not (= #x00000001 a_ack!4041)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4041))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4041)
                           (bvadd #x00000001 a_ack!4041))
                    a_ack!4041))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4041))
