...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2747) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2747)))
(assert (not (= #x00000000 a_ack!2747)))
(assert (not (= #x00000001 a_ack!2747)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!2747))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2747)
                           (bvadd #x00000001 a_ack!2747))
                    a_ack!2747))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!2747))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x7ff8000000000001))))))
  (FPCHECK_FMUL_UNDERFLOW #x4014000000000000 a!2))))
