...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3829) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3829)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3829)
                           (bvadd #x00000001 a_ack!3829))
                    a_ack!3829))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!3829))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3828) ((_ to_fp 11 53) #x0000000000000000))))
