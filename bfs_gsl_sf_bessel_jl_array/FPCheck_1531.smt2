...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4590) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4590) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4591) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4590) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4590) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4591)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             ...
                             (bvadd #x00000001 a_ack!4591))
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) b_ack!4590)
                      ((_ to_fp 11 53) b_ack!4590))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4591)
                           (bvadd #x00000001 a_ack!4591))
                    a_ack!4591))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4591))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4590) ((_ to_fp 11 53) #x0000000000000000))))
