...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4446) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4446) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4447) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4446) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4446) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4447)))
(assert (not (= #x00000000 a_ack!4447)))
(assert (not (= #x00000001 a_ack!4447)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4447))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4447)
                           (bvadd #x00000001 a_ack!4447))
                    a_ack!4447))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4447))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4446) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven (fp.abs a!27) (fp.abs a!25))
    #x3e5b55d63e79f537)))))))))))))))))))))))))))))
