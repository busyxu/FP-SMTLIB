...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4068) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4068) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4069) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4068) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4068) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4069)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4069)
                           (bvadd #x00000001 a_ack!4069))
                    a_ack!4069))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4069))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4068) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!14 a!11)
                                    ((_ to_fp 11 53) #xbd25707f58f82a61))))))
  (FPCHECK_FADD_UNDERFLOW a!17 #x3d6d035b9ff9bef9)))))))))))))))))))
