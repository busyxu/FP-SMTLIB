...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4662) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4662) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4663) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4662) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4662) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4663)))
(assert (not (= #x00000000 a_ack!4663)))
(assert (not (= #x00000001 a_ack!4663)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4663))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4663)
                           (bvadd #x00000001 a_ack!4663))
                    a_ack!4663))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4663))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4662) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!33 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW (fp.abs a!33) (fp.abs a!31))))))))))))))))))))))))))))))))))))
