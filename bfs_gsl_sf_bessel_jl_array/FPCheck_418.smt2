...
(assert (not (bvslt (bvadd #x00000001 a_ack!1337) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1337)))
(assert (not (= #x00000000 a_ack!1337)))
(assert (= #x00000001 a_ack!1337))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1336))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ZERO
    (fp.mul roundNearestTiesToEven a!1 (CF_sin b_ack!1336))
    b_ack!1336)))
