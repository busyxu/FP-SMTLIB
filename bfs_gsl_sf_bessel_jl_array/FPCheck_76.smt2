...
(assert (not (bvslt (bvadd #x00000001 a_ack!303) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!302) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!302) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!303)))
...
(assert (FPCHECK_FMUL_OVERFLOW #x3f20000000000000 b_ack!302))
