...
(assert (not (bvslt (bvadd #x00000001 a_ack!3791) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3790) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3790) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3791)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3791)
                           (bvadd #x00000001 a_ack!3791))
                    a_ack!3791))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!3791))
...
(let ((a!8 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW (fp.abs a!8) a!9))))))))))
