...
(assert (= #x00000001 a_ack!1417))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1416) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1416))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven a!1 (CF_sin b_ack!1416))
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4008000000000000)
                                   (CF_cos b_ack!1416))
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3cc0000000000000
    (fp.abs (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!1416)))))))
