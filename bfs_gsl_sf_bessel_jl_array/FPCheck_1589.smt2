(declare-fun a_ack!4775 () (_ BitVec 32))
(declare-fun b_ack!4774 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!4775 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4775) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4775)))
(assert (not (= #x00000000 a_ack!4775)))
(assert (not (= #x00000001 a_ack!4775)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4775))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4775)
                           (bvadd #x00000001 a_ack!4775))
                    a_ack!4775))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4775))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4774) ((_ to_fp 11 53) #x0000000000000000))))
