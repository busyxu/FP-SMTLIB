...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!1623))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1622) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x7ff8000000000001))))))
  (FPCHECK_FMUL_OVERFLOW #x4078100000000000 a!2))))
