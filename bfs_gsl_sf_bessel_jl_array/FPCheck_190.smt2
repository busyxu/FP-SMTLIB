...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!657)
                           (bvadd #x00000001 a_ack!657))
                    a_ack!657))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!656) ((_ to_fp 11 53) #x408f400000000000))))
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!657))
  #x3fe0000000000000))
