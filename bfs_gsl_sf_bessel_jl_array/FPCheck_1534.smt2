...
(assert (not (bvslt (bvadd #x00000001 a_ack!4601) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4600) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4600) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4601)
                           (bvadd #x00000001 a_ack!4601))
                    a_ack!4601))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4601))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4600) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!32 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!31)))
  (FPCHECK_FADD_OVERFLOW (fp.abs a!32) (fp.abs a!29)))))))))))))))))))))))))))))))))))
