...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!4149 #x00000000)))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!4149) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4148) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4148) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4149)))
(assert (not (= #x00000000 a_ack!4149)))
(assert (not (= #x00000001 a_ack!4149)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4149))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4149)
                           (bvadd #x00000001 a_ack!4149))
                    a_ack!4149))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4149))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!19)))
  (FPCHECK_FSUB_UNDERFLOW a!20 a!17))))))))))))))))))))))
