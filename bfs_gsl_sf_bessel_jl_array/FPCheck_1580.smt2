(declare-fun a_ack!4743 () (_ BitVec 32))
(declare-fun b_ack!4742 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (bvslt a_ack!4743 #x00000000)))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!4743) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4742) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4742) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4743)))
(assert (not (= #x00000000 a_ack!4743)))
(assert (not (= #x00000001 a_ack!4743)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4743))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4743)
                           (bvadd #x00000001 a_ack!4743))
                    a_ack!4743))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4743))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4742) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!35 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!32 a!29)
                                    ((_ to_fp 11 53) #xbebac63e97202346))))))
  (FPCHECK_FADD_UNDERFLOW a!35 #x3ef6c8e1db3b234a)))))))))))))))))))))))))))))))))))))
