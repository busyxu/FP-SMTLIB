...
(assert (not (bvslt a_ack!4341 #x00000000)))
...
(assert (not (bvslt (bvadd #x00000001 a_ack!4341) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4340) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4340) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4341)))
(assert (not (= #x00000000 a_ack!4341)))
(assert (not (= #x00000001 a_ack!4341)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4341))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4341)
                           (bvadd #x00000001 a_ack!4341))
                    a_ack!4341))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4341))
...
(let ((a!25 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!21 a!19)
                                    ((_ to_fp 11 53) #x3dd4e08def5bb8fa))))))
  (FPCHECK_FADD_ACCURACY a!25 #x3e18c14c2781ff02)))))))))))))))))))))))))))
