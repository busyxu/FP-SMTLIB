...
(assert (not (bvslt (bvadd #x00000001 a_ack!3957) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3956) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3956) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3957)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3957)
                           (bvadd #x00000001 a_ack!3957))
                    a_ack!3957))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!3957))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3956) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!13)))
  (FPCHECK_FADD_ACCURACY (fp.abs a!14) (fp.abs a!11)))))))))))))))))
