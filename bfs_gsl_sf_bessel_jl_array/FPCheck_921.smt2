...
(assert (not (bvslt (bvadd #x00000001 a_ack!2905) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2904) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2904) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2905)
                           (bvadd #x00000001 a_ack!2905))
                    a_ack!2905))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!2905))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   (fp.mul roundNearestTiesToEven a!3 a!3)
                                   a!3)))))
  (FPCHECK_FMUL_OVERFLOW (fp.mul roundNearestTiesToEven a!2 a!3) a!5))))))
