...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4123) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4123)))
(assert (not (= #x00000000 a_ack!4123)))
(assert (not (= #x00000001 a_ack!4123)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4123))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4123)
                           (bvadd #x00000001 a_ack!4123))
                    a_ack!4123))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4123))
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!15 a!13)
                                    ((_ to_fp 11 53) #x3d49133ca5bb62a1))))))
  (FPCHECK_FADD_UNDERFLOW a!19 #x3d90974a94a53d6a)))))))))))))))))))))
