(declare-fun a_ack!4815 () (_ BitVec 32))
(declare-fun b_ack!4814 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (bvslt a_ack!4815 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4814) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4814) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!4815) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4814) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4814) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!4815)))
(assert (not (= #x00000000 a_ack!4815)))
(assert (not (= #x00000001 a_ack!4815)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!4815))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!4815)
                           (bvadd #x00000001 a_ack!4815))
                    a_ack!4815))))
...
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!4815))
       ((_ to_fp 11 53) #x407965fea53d6e3a)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4814) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!37 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!33 a!31)
                                    ((_ to_fp 11 53) #x3ed9214dc6db33a2))))))
  (FPCHECK_FADD_UNDERFLOW a!37 #x3f13dad414e366bf)))))))))))))))))))))))))))))))))))))))
