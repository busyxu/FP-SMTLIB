...
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!418) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!420) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!418) ((_ to_fp 11 53) #x0024000000000001)))
