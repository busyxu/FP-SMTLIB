...
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!523) ((_ to_fp 11 53) #x0024000000000001))))
(assert (not (fp.eq ((_ to_fp 11 53) d_ack!523) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) #x3ff0000000000000)
        (fp.mul roundNearestTiesToEven
                (fp.abs ((_ to_fp 11 53) d_ack!523))
                ((_ to_fp 11 53) #x0010000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!523) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) a_ack!525)
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!522))
...
(assert (let ((a!1 (fp.leq (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.eq ((_ to_fp 11 53) d_ack!523) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!523) ((_ to_fp 11 53) #x3ff3333333333333)))
(assert (FPCHECK_FMUL_ACCURACY #x401921fb54442d18 c_ack!524))
