...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!285) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.mul roundNearestTiesToEven a!2 a!1))
         ((_ to_fp 11 53) #x3feffffffffff950)))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!284))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!284)
                                   ((_ to_fp 11 53) b_ack!284))))))
  (FPCHECK_FMUL_OVERFLOW a!2 b_ack!284))))
