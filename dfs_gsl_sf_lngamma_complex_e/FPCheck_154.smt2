...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!553) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    a!12
                                    ((_ to_fp 11 53) b_ack!552))))))
  (fp.eq a!13 (fp.mul roundNearestTiesToEven a!12 ((_ to_fp 11 53) b_ack!552)))))))))
(assert (FPCHECK_FMUL_ACCURACY b_ack!552 b_ack!552))
