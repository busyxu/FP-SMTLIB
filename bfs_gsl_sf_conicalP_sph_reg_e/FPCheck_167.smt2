...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!575) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!576 #xffffffff)))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!575) ((_ to_fp 11 53) #x3ff0000000000000))))
