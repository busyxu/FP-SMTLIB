...
(declare-fun FPCHECK_FDIV_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1506) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1507 #xffffffff)))
(assert (not (= #xffffffff a_ack!1507)))
...
(assert (fp.lt ((_ to_fp 11 53) c_ack!1506) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!5 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x0000000000000000)
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1507))
                   ((_ to_fp 11 53) #x4000000000000000))))
