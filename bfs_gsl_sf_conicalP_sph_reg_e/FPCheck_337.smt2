...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1479) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1480 #xffffffff)))
(assert (= #xffffffff a_ack!1480))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1479) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1479) ((_ to_fp 11 53) #x3ff0000000000000))))
