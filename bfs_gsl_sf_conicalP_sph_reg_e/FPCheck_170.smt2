...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!604) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!605 #xffffffff)))
(assert (not (= #xffffffff a_ack!605)))
(assert (= #x00000000 a_ack!605))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!604) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!604) ((_ to_fp 11 53) #x3ff0000000000000)))
