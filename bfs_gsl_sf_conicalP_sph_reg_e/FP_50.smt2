...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!910) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!911 #xffffffff)))
...
(assert (fp.lt ((_ to_fp 11 53) c_ack!910) ((_ to_fp 11 53) #x3ff0000000000000)))
