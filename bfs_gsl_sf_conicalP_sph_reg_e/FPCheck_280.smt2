...
(assert (not (= #xffffffff a_ack!1144)))
(assert (= #x00000000 a_ack!1144))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1143) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1143) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
      ...
      (a!3 (fp.abs (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           (fp.abs ((_ to_fp 11 53) c_ack!1143))))))
