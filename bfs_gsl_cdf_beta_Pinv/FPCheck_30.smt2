...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!249) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu1_ack!247)
                ...
                (fp.eq (fp.add roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) #x0000000000000000)))))
  (not a!1)))
(assert (fp.lt ((_ to_fp 11 53) x_ack!249) ((_ to_fp 11 53) #x3fb999999999999a)))
