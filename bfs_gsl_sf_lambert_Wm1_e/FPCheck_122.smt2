...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!195) ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
                       (CF_log a_ack!195)
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3ff0000000000000))
       (CF_log a_ack!195)))
(assert (not (fp.gt (CF_log a_ack!195) ((_ to_fp 11 53) #x0000000000000000))))
