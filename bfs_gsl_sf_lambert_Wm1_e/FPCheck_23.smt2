...
(assert (fp.gt ((_ to_fp 11 53) a_ack!39) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!39) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (FPCHECK_FSUB_ACCURACY #x3ffdb7f12eace66f a_ack!39))
