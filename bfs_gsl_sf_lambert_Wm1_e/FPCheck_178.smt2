...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!262) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!262) ((_ to_fp 11 53) #xbeb0c6f7a0b5ed8d)))
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!262)
                    ((_ to_fp 11 53) #x3fd78b56362cef38))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xbfc123ba200f6a5c)
                                   a!1)))))
  (FPCHECK_FMUL_ACCURACY a!2 (CF_exp a!2)))))
