...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.gt ((_ to_fp 11 53) a_ack!228) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!228) ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
                       (CF_log a_ack!228)
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3ff0000000000000))
       (CF_log a_ack!228)))
(assert (not (fp.gt (CF_log a_ack!228) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (CF_log a_ack!228)
                           (CF_exp (CF_log a_ack!228)))
                   ((_ to_fp 11 53) a_ack!228)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_exp (fp.sub roundNearestTiesToEven
                                   (CF_log a_ack!228)
                                   (fp.div roundNearestTiesToEven a!1 a!3))))))
  (FPCHECK_FSUB_UNDERFLOW a!4 a_ack!228)))))
