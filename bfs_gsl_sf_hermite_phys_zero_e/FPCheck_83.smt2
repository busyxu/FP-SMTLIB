...
(assert (not (bvsle a_ack!350 #x00000000)))
(assert (not (bvslt b_ack!349 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!350 #x00000002) b_ack!349)))
(assert (not (= #x00000000 b_ack!349)))
(assert (not (= #x00000002 a_ack!350)))
(assert (not (bvslt a_ack!350 #x00000015)))
(assert (= #x00000001 b_ack!349))
(assert (bvslt #x00000032 a_ack!350))
(assert (not (= #x00000000 (bvand a_ack!350 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!350 #x00000002) b_ack!349)))))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW #x3ff8a4f044ba5706 a!3)))))
