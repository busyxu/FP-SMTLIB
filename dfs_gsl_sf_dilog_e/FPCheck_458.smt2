...
(assert (fp.geq ((_ to_fp 11 53) a_ack!827) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!827) ((_ to_fp 11 53) #x4000000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 (CF_log a_ack!827)))
