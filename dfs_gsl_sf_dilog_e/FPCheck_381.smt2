...
(assert (fp.geq ((_ to_fp 11 53) a_ack!688) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!688) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!14 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!13
                                    ((_ to_fp 11 53) #x4091300000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x3d29000000000000 a!14)))))))))
