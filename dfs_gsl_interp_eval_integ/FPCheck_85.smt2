...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!920) ((_ to_fp 11 53) x0_ack!921))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!920) ((_ to_fp 11 53) x1_ack!917)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!917) ((_ to_fp 11 53) b_ack!920))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!917)
                    ((_ to_fp 11 53) x0_ack!921))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!919 x0_ack!921))
