...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1141) ((_ to_fp 11 53) x0_ack!1142))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!1141) ((_ to_fp 11 53) x1_ack!1138)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!1138) ((_ to_fp 11 53) b_ack!1141))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!1138)
                    ((_ to_fp 11 53) x0_ack!1142))
            ((_ to_fp 11 53) #x0000000000000000))))
