...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!5891) ((_ to_fp 11 53) x0_ack!5893))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!5891) ((_ to_fp 11 53) x1_ack!5889)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!5889) ((_ to_fp 11 53) a_ack!5891))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!5892) ((_ to_fp 11 53) x1_ack!5889))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!5892) ((_ to_fp 11 53) x2_ack!5890))))
