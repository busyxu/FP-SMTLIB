...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1131) ((_ to_fp 11 53) x0_ack!1132))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!1131) ((_ to_fp 11 53) x1_ack!1128)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!1128) ((_ to_fp 11 53) b_ack!1131))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!1128)
                    ((_ to_fp 11 53) x0_ack!1132))
            ((_ to_fp 11 53) #x0000000000000000))))
