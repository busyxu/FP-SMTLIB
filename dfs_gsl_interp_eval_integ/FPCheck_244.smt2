...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2845) ((_ to_fp 11 53) x0_ack!2847))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2845) ((_ to_fp 11 53) x1_ack!2843))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2846) ((_ to_fp 11 53) x0_ack!2847))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!2846) ((_ to_fp 11 53) x1_ack!2843)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!2843) ((_ to_fp 11 53) b_ack!2846))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!2843)
                    ((_ to_fp 11 53) x0_ack!2847))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!2843))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_ACCURACY b_ack!2846 x1_ack!2843))
