...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4380) ((_ to_fp 11 53) x0_ack!4382))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!4380) ((_ to_fp 11 53) x1_ack!4378)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!4378) ((_ to_fp 11 53) a_ack!4380))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) x1_ack!4378))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) x2_ack!4379))))
(assert (FPCHECK_FSUB_OVERFLOW x2_ack!4379 x1_ack!4378))
