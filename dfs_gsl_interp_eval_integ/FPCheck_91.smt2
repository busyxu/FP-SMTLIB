...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!975) ((_ to_fp 11 53) x0_ack!976))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!975) ((_ to_fp 11 53) x1_ack!972)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!972) ((_ to_fp 11 53) b_ack!975))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!972)
                    ((_ to_fp 11 53) x0_ack!976))
            ((_ to_fp 11 53) #x0000000000000000))))
