...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!416) ((_ to_fp 11 53) x0_ack!417))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!416) ((_ to_fp 11 53) x1_ack!413))))
(assert (FPCHECK_FSUB_UNDERFLOW x1_ack!413 x0_ack!417))
