...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!7235) ((_ to_fp 11 53) x0_ack!7237))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!7235) ((_ to_fp 11 53) x1_ack!7230)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!7230) ((_ to_fp 11 53) a_ack!7235))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!7236) ((_ to_fp 11 53) x1_ack!7230))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!7236) ((_ to_fp 11 53) x2_ack!7231))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x2_ack!7231)
                    ((_ to_fp 11 53) x1_ack!7230))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!7 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!7235)
                           ((_ to_fp 11 53) x1_ack!7230))
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!7236)
                           ((_ to_fp 11 53) x1_ack!7230))))
