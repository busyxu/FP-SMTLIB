...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4395) ((_ to_fp 11 53) x0_ack!4397))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!4395) ((_ to_fp 11 53) x1_ack!4393)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!4393) ((_ to_fp 11 53) a_ack!4395))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4396) ((_ to_fp 11 53) x1_ack!4393))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4396) ((_ to_fp 11 53) x2_ack!4394))))
(assert (FPCHECK_FSUB_ACCURACY x2_ack!4394 x1_ack!4393))
