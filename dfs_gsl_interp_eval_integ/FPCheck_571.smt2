...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!7182) ((_ to_fp 11 53) x0_ack!7184))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!7182) ((_ to_fp 11 53) x1_ack!7177)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!7177) ((_ to_fp 11 53) a_ack!7182))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!7183) ((_ to_fp 11 53) x1_ack!7177))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!7183) ((_ to_fp 11 53) x2_ack!7178))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x2_ack!7178)
                    ((_ to_fp 11 53) x1_ack!7177))
            ((_ to_fp 11 53) #x0000000000000000))))
