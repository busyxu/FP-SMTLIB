...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2078) ((_ to_fp 11 53) x0_ack!2080))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2078) ((_ to_fp 11 53) x1_ack!2073))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2079) ((_ to_fp 11 53) x0_ack!2080))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!2079) ((_ to_fp 11 53) x1_ack!2073)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!2073) ((_ to_fp 11 53) b_ack!2079))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!2073)
                    ((_ to_fp 11 53) x0_ack!2080))
            ((_ to_fp 11 53) #x0000000000000000))))
