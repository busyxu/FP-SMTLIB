...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!380) ((_ to_fp 11 53) x0_ack!382))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!381) ((_ to_fp 11 53) x2_ack!379))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!380) ((_ to_fp 11 53) b_ack!381))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!380) ((_ to_fp 11 53) x0_ack!382))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!380) ((_ to_fp 11 53) x1_ack!378))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!381) ((_ to_fp 11 53) x0_ack!382)))
(assert (FPCHECK_FSUB_OVERFLOW x1_ack!378 x0_ack!382))
