...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4741) ((_ to_fp 11 53) x0_ack!4743))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!4741) ((_ to_fp 11 53) x1_ack!4736)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!4736) ((_ to_fp 11 53) a_ack!4741))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!4742) ((_ to_fp 11 53) x1_ack!4736))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!4742) ((_ to_fp 11 53) x2_ack!4737)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x2_ack!4737)
                    ((_ to_fp 11 53) x1_ack!4736))
            ((_ to_fp 11 53) #x0000000000000000))))
