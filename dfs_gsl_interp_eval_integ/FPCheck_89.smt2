...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!955) ((_ to_fp 11 53) x0_ack!956))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!955) ((_ to_fp 11 53) x1_ack!952)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!952) ((_ to_fp 11 53) b_ack!955))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!952)
                    ((_ to_fp 11 53) x0_ack!956))
            ((_ to_fp 11 53) #x0000000000000000))))
