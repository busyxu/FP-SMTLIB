...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!945) ((_ to_fp 11 53) x0_ack!946))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!945) ((_ to_fp 11 53) x1_ack!942)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!942) ((_ to_fp 11 53) b_ack!945))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!942)
                    ((_ to_fp 11 53) x0_ack!946))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_ACCURACY x1_ack!942 x0_ack!946))
