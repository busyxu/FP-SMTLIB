...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!373))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!375) ((_ to_fp 11 53) b_ack!376))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!375) ((_ to_fp 11 53) x0_ack!377))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!376) ((_ to_fp 11 53) x2_ack!374))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!375) ((_ to_fp 11 53) b_ack!376))))
