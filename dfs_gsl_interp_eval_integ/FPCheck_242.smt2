...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2825) ((_ to_fp 11 53) x0_ack!2827))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2825) ((_ to_fp 11 53) x1_ack!2823))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2826) ((_ to_fp 11 53) x0_ack!2827))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!2826) ((_ to_fp 11 53) x1_ack!2823)))
(assert (not (fp.gt ((_ to_fp 11 53) x1_ack!2823) ((_ to_fp 11 53) b_ack!2826))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) x1_ack!2823)
                    ((_ to_fp 11 53) x0_ack!2827))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x1_ack!2823))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_OVERFLOW b_ack!2826 x1_ack!2823))
