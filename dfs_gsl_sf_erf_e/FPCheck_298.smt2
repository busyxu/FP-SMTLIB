...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!410))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!410))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!410))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!410))
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW (fp.div roundNearestTiesToEven a!5 a!11) (CF_exp a!12)))))))))
