...
(assert (not (bvslt a_ack!653 b_ack!651)))
(assert (= #x00000000 b_ack!651))
(assert (not (bvslt a_ack!653 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!652) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!652) ((_ to_fp 11 53) #x3ff0000000000000))))
