...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2902) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2902) ((_ to_fp 11 53) #x0000000000000000))))
      ...
      (a!63 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!29 a!30))
                            a!55))))
(let ((a!64 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                   a!56
                                   (fp.add roundNearestTiesToEven a!63 a!56)))
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!64)))))))))))))))))
(assert (let ((a!1 ((_ fp.to_sbv 32)
             roundTowardZero
