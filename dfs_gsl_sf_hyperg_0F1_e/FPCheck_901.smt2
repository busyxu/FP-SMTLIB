(declare-fun a_ack!2441 () (_ BitVec 64))
(declare-fun b_ack!2440 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2441) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2441) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2440) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2440) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.add roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) a_ack!2441)
...
(let ((a!11 (fp.mul roundNearestTiesToEven
      ...
      (a!17 (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x7ff0000000000001)
                                    (fp.div roundNearestTiesToEven a!16 a!4)))
                    (fp.sub roundNearestTiesToEven
                            a!4
                            ((_ to_fp 11 53) #x4020000000000000)))))
      ...
      (a!19 (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!18))
                    a!5)))
  (FPCHECK_FMUL_OVERFLOW a!13 a!19)))))))))))
