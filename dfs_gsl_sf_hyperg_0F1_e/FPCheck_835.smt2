...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2309) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2309) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2308) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2308) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_UNDERFLOW
    ...
    (fp.sub roundNearestTiesToEven a!8 ((_ to_fp 11 53) #x4024000000000000)))))))))))
