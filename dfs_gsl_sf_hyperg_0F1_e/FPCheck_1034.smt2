...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2707) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2706) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2706) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!13 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x7ff0000000000001)
                                    a!12)))))
  (FPCHECK_FADD_OVERFLOW #x7ff0000000000001 a!13)))))))))))))
