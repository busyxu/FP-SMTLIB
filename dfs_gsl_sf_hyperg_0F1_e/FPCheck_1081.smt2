...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2801) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2801) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!13 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    a!12
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x7ff0000000000001) a!13))))))))))))))
