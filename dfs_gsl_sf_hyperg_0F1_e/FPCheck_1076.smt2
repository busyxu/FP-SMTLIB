...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2791) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2791) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2790) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) #x4030000000000000)))))
  (FPCHECK_FMUL_OVERFLOW #x7ff0000000000001 a!13)))))))))))))
