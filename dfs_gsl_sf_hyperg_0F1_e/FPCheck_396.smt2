...
(declare-fun b_ack!1268 () (_ BitVec 64))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1269) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1268) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1268) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!11 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!9)
                    a!10))
      (a!21 (fp.abs (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) a_ack!1269)
                                    ((_ to_fp 11 53) #x4000000000000000))
                            a!9))))
