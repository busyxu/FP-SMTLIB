(declare-fun a_ack!2319 () (_ BitVec 64))
(declare-fun b_ack!2318 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2319) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2319) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!10 (fp.mul roundNearestTiesToEven
      ...
      (a!15 (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x7ff0000000000001)
                                    (fp.div roundNearestTiesToEven a!14 a!4)))
                    (fp.sub roundNearestTiesToEven
                            a!4
                            ((_ to_fp 11 53) #x4020000000000000)))))
      ...
      (a!16 (fp.div roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4020000000000000))
                            ((_ to_fp 11 53) #x4024000000000000)))))
  (FPCHECK_FMUL_UNDERFLOW a!11 a!16))))))))))
