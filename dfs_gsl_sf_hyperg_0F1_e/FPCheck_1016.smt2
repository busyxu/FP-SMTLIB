...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2671) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2671) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2670) ((_ to_fp 11 53) #x0000000000000000))))
