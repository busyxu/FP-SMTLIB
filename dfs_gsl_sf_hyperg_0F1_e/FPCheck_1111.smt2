...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2861) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2860) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2860) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.sub roundNearestTiesToEven a!15 ((_ to_fp 11 53) #x3ff0000000000000))
    a!26)))))))))))))))
