...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!467) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!467) ((_ to_fp 11 53) #x4010000000000000)))
(assert (= #x00000000 (bvand b_ack!466 #x00000007)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x0000000000000000))
                           ((_ to_fp 11 53) #x3c670ef54646d497)))))
  (FPCHECK_FADD_OVERFLOW a!6 #x3cc1a773c9ce3ac3))))))))
