...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!104) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!104) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!104) ((_ to_fp 11 53) #x4330000000000000)))
