...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!411))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!412) ((_ to_fp 11 53) #x41dfffffff800000)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.div roundNearestTiesToEven a!5 ((_ to_fp 11 53) #x3ff0000000000000))
