...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2447) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2448) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2447) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2447))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  (fp.mul roundNearestTiesToEven
                          ...
                          (fp.add roundNearestTiesToEven
                                  ((_ to_fp 11 53) a_ack!2448)
                                  ((_ to_fp 11 53) #x3ff0000000000000))))))
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2448) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2447) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2448) ((_ to_fp 11 53) #x0000000000000000))))
