...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!341) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!341))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #x41dfffffff800000)))
