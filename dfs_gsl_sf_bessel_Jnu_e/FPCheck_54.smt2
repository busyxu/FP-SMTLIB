...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!187) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!187))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!188) ((_ to_fp 11 53) #x41dfffffff800000)))
(assert (let ((a!1 ((_ fp.to_sbv 32)
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 b_ack!187))
