...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!829))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!829) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!830) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!830) ((_ to_fp 11 53) #x41dfffffff800000)))
