...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!541) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!541))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!542) ((_ to_fp 11 53) #x41dfffffff800000)))
