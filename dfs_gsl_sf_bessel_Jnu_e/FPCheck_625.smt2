...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2393) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2393))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2394) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2393) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x419e600000000000) a!4)
    a!4))))))
