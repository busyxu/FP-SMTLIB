...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2703))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2704) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2703) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2704) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.div roundNearestTiesToEven a!5 ((_ to_fp 11 53) #x4182fc0000000000))
    a!10)))))))
