(declare-fun x_ack!1220 () (_ BitVec 64))
(declare-fun a_ack!1219 () (_ BitVec 64))
(declare-fun CF_log ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1220) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1220) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1220) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!10 (fp.add roundNearestTiesToEven
  ...
  (not (fp.eq (fp.div roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) #x3ff0000000000000))
              ((_ to_fp 11 53) #x0000000000000000))))))))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1219) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!1219)
...
(let ((a!10 (fp.add roundNearestTiesToEven
  ...
  (not (fp.leq (fp.div roundNearestTiesToEven
               ...
               (fp.mul roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) a_ack!1219)))))))))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1219) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1219) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!1219)
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000))
                            a!9))))
  (fp.leq ((_ to_fp 11 53) a_ack!1219)
          (fp.div roundNearestTiesToEven
                  a!10
                  ((_ to_fp 11 53) #x3ff0000000000000))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1219) ((_ to_fp 11 53) #x4024000000000000)))
