...
(assert (fp.lt ((_ to_fp 11 53) x_ack!2361) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2360) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!8 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!2360)))
                   (fp.abs ((_ to_fp 11 53) a_ack!2360)))))
...
(let ((a!9 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (CF_log a!8))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.lt a!9 ((_ to_fp 11 53) a_ack!2360)))))))))))))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (not (fp.leq a!9
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) #x3fe0000000000000)
                       ((_ to_fp 11 53) a_ack!2360))))))))))))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2360) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2360) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!2360)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3f4ff0a5d7d0b01e)
...
(let ((a!9 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (CF_log a!8))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (fp.leq ((_ to_fp 11 53) a_ack!2360) a!9)))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!2360)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3f4ff0a5d7d0b01e)
