...
(assert (fp.lt ((_ to_fp 11 53) x_ack!824) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!9 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (CF_log a!8))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.lt a!9 ((_ to_fp 11 53) a_ack!823)))))))))))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!823) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 a_ack!823))
