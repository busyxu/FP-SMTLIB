...
(assert (fp.lt ((_ to_fp 11 53) x_ack!758) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!757) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!757) a!6)
