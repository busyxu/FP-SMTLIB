...
(assert (fp.lt ((_ to_fp 11 53) x_ack!1210) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!10 (fp.add roundNearestTiesToEven
  ...
  (not (fp.leq (fp.div roundNearestTiesToEven
               ...
               (fp.mul roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) a_ack!1209)))))))))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1209) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1209) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!1209)
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000))
                            a!9))))
  (fp.leq ((_ to_fp 11 53) a_ack!1209)
          (fp.div roundNearestTiesToEven
                  a!10
                  ((_ to_fp 11 53) #x3ff0000000000000))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1209) ((_ to_fp 11 53) #x4024000000000000)))
