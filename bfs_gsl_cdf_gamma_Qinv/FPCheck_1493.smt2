...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3951) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3951) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3951) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3951) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) a_ack!3950)
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3ff0000000000000))
                   ((_ to_fp 11 53) a_ack!3950))))
  (not (fp.leq (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!3950))
...
(let ((a!21 (fp.mul roundNearestTiesToEven
      ...
      (a!26 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!19)
                    a!20)))
  (FPCHECK_FDIV_OVERFLOW a!21 (fp.add roundNearestTiesToEven a!26 a!21))))))))))))))))))))))))
