...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!2621) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (fp.gt ((_ to_fp 11 53) x_ack!2621) ((_ to_fp 11 53) #x3fee666666666666)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2620) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(let ((a!8 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!2620)))
                   (fp.abs ((_ to_fp 11 53) a_ack!2620)))))
...
(let ((a!9 (CF_exp (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #xc0425e4f7b2737fa))
                           ((_ to_fp 11 53) a_ack!2620)))))
  (fp.leq ((_ to_fp 11 53) a_ack!2620)
          (fp.div roundNearestTiesToEven
                  a!9
                  ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2620) ((_ to_fp 11 53) #x4024000000000000)))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2620 #x3ff0000000000000))
