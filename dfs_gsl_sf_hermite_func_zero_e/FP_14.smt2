...
(assert (not (bvsle a_ack!444 #x00000000)))
(assert (not (bvslt b_ack!443 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!444 #x00000002) b_ack!443)))
(assert (not (= #x00000000 b_ack!443)))
(assert (not (= #x00000002 a_ack!444)))
(assert (not (bvslt a_ack!444 #x00000015)))
(assert (= #x00000001 b_ack!443))
(assert (bvslt #x00000032 a_ack!444))
(assert (not (= #x00000000 (bvand a_ack!444 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!444 #x00000002) b_ack!443)))))
...
(let ((a!8 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   a!3)
                           a!7))))
(let ((a!9 (fp.gt (fp.abs (fp.add roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3ff8a4f044ba5706)
                                  a!3))
                  a!8)))
  (not a!9))))))))))
