...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!428) ((_ to_fp 11 53) #x3e68000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!428) ((_ to_fp 11 53) #x4010000000000000)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FADD_ACCURACY a!4 #x3c409a213cd6d681))))))
