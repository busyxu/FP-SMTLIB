...
(assert (fp.gt ((_ to_fp 11 53) a_ack!519) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!518) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!518 #x3ff0000000000000))
