...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2252) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2252) ((_ to_fp 11 53) #x4049000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!2252) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) b_ack!2252))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) b_ack!2252)))
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) a_ack!2253)
               ((_ to_fp 11 53) b_ack!2252))
       ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2253) ((_ to_fp 11 53) #x4000000000000000)))
