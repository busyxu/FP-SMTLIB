...
(assert (fp.gt ((_ to_fp 11 53) a_ack!495) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!494) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FSUB_ACCURACY a_ack!495 #x3ff0000000000000))
