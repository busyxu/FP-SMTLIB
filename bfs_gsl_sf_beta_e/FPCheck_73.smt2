...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!279) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!279) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) a_ack!279) (CF_floor a_ack!279))
                  #x00000001
                  #x00000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!278) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!279) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!279 b_ack!278))
