...
(assert (fp.gt ((_ to_fp 11 53) a_ack!653) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!652) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!653) ((_ to_fp 11 53) #x4049000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!652) ((_ to_fp 11 53) #x4049000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!653) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!653) ((_ to_fp 11 53) #x4065600000000000)))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 a_ack!653))
