...
(assert (fp.gt ((_ to_fp 11 53) a_ack!569) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!568) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!569) ((_ to_fp 11 53) #x4049000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!568) ((_ to_fp 11 53) #x4049000000000000)))
...
(assert (fp.eq ((_ to_fp 11 53) a_ack!569) (CF_floor a_ack!569)))
(assert (let ((a!1 ((_ sign_extend 32)
             (bvadd #xffffffff
                    ((_ fp.to_sbv 32) roundTowardZero (CF_floor a_ack!569))))))
...
(assert (let ((a!1 ((_ sign_extend 32)
  ...
  (bvult (bvadd #x0000000000000008 (bvmul #x0000000000000018 a!1))
         #x0000000000001001)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!568) ((_ to_fp 11 53) #x3fe0000000000000)))
