...
(assert (= #x00000000 a_ack!3077))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!3076))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!3076))
...
(let ((a!56 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY #x3cb0000000000000 a!56)))))))))))))))))))))))))))))
