...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!860) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 a_ack!861))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!860))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!860))
