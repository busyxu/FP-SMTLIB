...
(assert (= #x00000000 a_ack!2951))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!2950))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!2950))
...
(let ((a!25 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW (fp.abs a!25) (fp.abs a!24))))))))))))))))))))))))))))
