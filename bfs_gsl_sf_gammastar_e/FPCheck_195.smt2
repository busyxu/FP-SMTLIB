...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!274) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!274) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbf5f094bd00128ce)
                           a!1))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!274)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!274)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3f4ff0a5d7d0b01e)
