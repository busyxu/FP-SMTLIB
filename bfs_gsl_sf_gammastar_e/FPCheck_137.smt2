...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!171) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!171) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!171) ((_ to_fp 11 53) #x40c0000000000000)))
(assert (FPCHECK_FMUL_OVERFLOW a_ack!171 a_ack!171))
