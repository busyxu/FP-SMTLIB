...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1244) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1243) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1244) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1243) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1244) a!1)
    #x4018000000000000)))
