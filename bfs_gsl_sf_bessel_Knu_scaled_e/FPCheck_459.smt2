...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1277) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1278) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1277) ((_ to_fp 11 53) #x4000000000000000))))
...
(let ((a!30 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!27
                                    (fp.add roundNearestTiesToEven a!25 a!23))))))
  (not (fp.gt a!30 ((_ to_fp 11 53) #x5fefffffffffffff)))))))))))))))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!24 (fp.div roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            a!20
                            (fp.sub roundNearestTiesToEven a!21 a!23))
                    ((_ to_fp 11 53) b_ack!1277))))
(let ((a!25 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
...
(let ((a!27 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!6)
                            ((_ to_fp 11 53) b_ack!1277))
                    (fp.add roundNearestTiesToEven a!26 a!24))))
(let ((a!28 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4000000000000000)
