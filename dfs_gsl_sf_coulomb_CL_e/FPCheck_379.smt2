...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1279) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1279))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) b_ack!1278))))))
  (FPCHECK_FDIV_OVERFLOW #xbfc1bcb2992b2855 a!2))))
