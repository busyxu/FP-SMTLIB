...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2103) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!2103))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!2102)
                                   ((_ to_fp 11 53) b_ack!2102))))))
  (FPCHECK_FMUL_ACCURACY a!2 b_ack!2102))))
