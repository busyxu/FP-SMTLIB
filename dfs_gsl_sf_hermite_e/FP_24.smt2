...
(assert (not (bvslt #x00000129 (bvadd #xffffffff a_ack!180))))
(assert (let ((a!1 (bvslt (ite (= ((_ extract 31 31) a_ack!180) #b1)
...
(assert (not (bvult (bvadd #xffffffff a_ack!180) #x0000001a)))
