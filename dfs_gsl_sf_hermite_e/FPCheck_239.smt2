...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x4000000000000000))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!959)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!959)))
...
(assert (bvsle #x00000001 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x4000000000000000)))
         ((_ to_fp 11 53) #x4000000000000000))))
(assert (bvsle #x00000002 (bvadd #xffffffff a_ack!960)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   a!3)))
  (fp.eq a!4 a!2)))))
(assert (bvsle #x00000003 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!2)))))
  (fp.eq a!6 a!4))))))))
(assert (bvsle #x00000004 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!5 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4020000000000000)
                 a!2))))))))
(assert (bvsle #x00000005 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4024000000000000)
                 a!3)))))))))
(assert (bvsle #x00000006 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000007 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
...
(assert (bvsle #x00000008 (bvadd #xffffffff a_ack!960)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
