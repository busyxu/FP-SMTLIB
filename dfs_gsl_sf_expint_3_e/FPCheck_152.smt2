...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!203) ((_ to_fp 11 53) #x3ee4519884312501))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!203) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!4
                    ((_ to_fp 11 53) #x3c0d83c94fb6d2ac)))
    a!6)))))))
