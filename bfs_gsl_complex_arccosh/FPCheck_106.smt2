...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!368))
       ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x3fe0000000000000)
                 (fp.add roundNearestTiesToEven a!2 a!4)))))))
(assert (fp.geq ((_ to_fp 11 53) x_ack!368) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) y_ack!367) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (CF_acos (fp.div roundNearestTiesToEven
                            (fp.abs ((_ to_fp 11 53) x_ack!368))
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FMUL_UNDERFLOW #xbff0000000000000 a!1)))
