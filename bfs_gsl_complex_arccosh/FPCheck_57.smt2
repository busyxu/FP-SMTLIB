...
(assert (not (fp.eq ((_ to_fp 11 53) y_ack!215) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!215)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) y_ack!215)))
                   (fp.abs ((_ to_fp 11 53) y_ack!215)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) y_ack!215)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!215)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(assert (fp.leq (fp.div roundNearestTiesToEven
                (fp.abs ((_ to_fp 11 53) x_ack!216))
                ((_ to_fp 11 53) #x3ff0000000000000))
        ((_ to_fp 11 53) #x3fe488ce703afb7f)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!216))
       ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x3fe0000000000000)
                 (fp.add roundNearestTiesToEven a!2 a!4)))))))
(assert (fp.geq ((_ to_fp 11 53) x_ack!216) ((_ to_fp 11 53) #x0000000000000000)))
