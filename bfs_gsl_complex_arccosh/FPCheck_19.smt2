...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!58)) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (FPCHECK_FADD_UNDERFLOW (fp.abs ((_ to_fp 11 53) x_ack!58)) #x3ff0000000000000))
