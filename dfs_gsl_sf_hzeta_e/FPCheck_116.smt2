...
(assert (fp.gt ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!293) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!8)
         a!7)))))))))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 a_ack!294))
