...
(assert (fp.gt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!287) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!8)
         a!7)))))))))
(assert (FPCHECK_FADD_OVERFLOW #x4018000000000000 b_ack!287))
