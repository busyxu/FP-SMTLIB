...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!154) ((_ to_fp 11 53) #x404b000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!154) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!153) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!154) ((_ to_fp 11 53) #x403b000000000000)))
...
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
  ...
  (fp.geq a!1 a!2)))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 a_ack!154))
