...
(assert (fp.gt ((_ to_fp 11 53) a_ack!240) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!239) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!240) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!5)
         a!4))))))
(assert (FPCHECK_FADD_OVERFLOW #x4010000000000000 b_ack!239))
