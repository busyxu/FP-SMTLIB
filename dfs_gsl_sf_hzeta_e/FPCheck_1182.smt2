...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3656) ((_ to_fp 11 53) #x404b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3656) ((_ to_fp 11 53) #x403b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3656) ((_ to_fp 11 53) #x403b000000000000))))
...
(let ((a!23 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!8 a!23))
              ((_ to_fp 11 53) #x3ca0000000000000))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!3656 #x4018000000000000))
