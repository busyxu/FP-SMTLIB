...
(assert (fp.gt ((_ to_fp 11 53) a_ack!174) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!173) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!174) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!3)
         a!2))))
(assert (FPCHECK_FADD_UNDERFLOW #x3ff0000000000000 b_ack!173))
