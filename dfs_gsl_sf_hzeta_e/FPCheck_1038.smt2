...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3188) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3188) ((_ to_fp 11 53) #x404b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3188) ((_ to_fp 11 53) #x403b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3188) ((_ to_fp 11 53) #x403b000000000000))))
...
(let ((a!14 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
  ...
  (not a!14))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!3188 #x0000000000000000))
