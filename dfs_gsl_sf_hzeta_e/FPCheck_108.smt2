...
(assert (fp.gt ((_ to_fp 11 53) a_ack!274) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!273) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!274) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!7)
         a!6))))))))
(assert (FPCHECK_FSUB_ACCURACY #x8000000000000000 a_ack!274))
