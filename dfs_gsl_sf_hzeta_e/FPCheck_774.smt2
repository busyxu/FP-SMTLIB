...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2434) ((_ to_fp 11 53) #x404b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2433) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2434) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2433) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2434) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2433) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fb5555555555555))
       ((_ to_fp 11 53) a_ack!2434)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2434))
...
(let ((a!41 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3ca0000000000000))))
  (not a!41)))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2434 #x4034000000000000))
