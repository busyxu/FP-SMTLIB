...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #x404b000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!291) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!292) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!291) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!8)
         a!7)))))))))
(assert (FPCHECK_FADD_ACCURACY #x4018000000000000 b_ack!291))
