...
(assert (fp.gt ((_ to_fp 11 53) a_ack!108) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!107) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!108) ((_ to_fp 11 53) #x403b000000000000)))
...
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
  ...
  (fp.geq a!1 a!2)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!108 #x3ff0000000000000))
