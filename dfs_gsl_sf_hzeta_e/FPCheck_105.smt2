...
(assert (fp.gt ((_ to_fp 11 53) a_ack!268) ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!267) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!268) ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!7)
         a!6))))))))
(assert (FPCHECK_FADD_ACCURACY #x4014000000000000 b_ack!267))
