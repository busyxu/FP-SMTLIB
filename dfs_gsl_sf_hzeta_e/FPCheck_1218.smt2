...
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3772) ((_ to_fp 11 53) #x404b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3772) ((_ to_fp 11 53) #x403b000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!3772) ((_ to_fp 11 53) #x403b000000000000))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!8 a!7)
                                    a!7)))))
  (FPCHECK_FDIV_UNDERFLOW a!9 (fp.add roundNearestTiesToEven a!24 a!9)))))))))))))))
