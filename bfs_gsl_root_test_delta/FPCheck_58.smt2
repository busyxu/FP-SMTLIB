...
(declare-fun epsrel_ack!172 () (_ BitVec 64))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) x_ack!170) a!2)
                 a!2)
         ((_ to_fp 11 53) x_ack!170)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
...
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!172)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!171)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!3 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) epsrel_ack!172)
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!170)
                                   a!2)))))
  (not (fp.lt a!3
              (fp.add roundNearestTiesToEven
                      ((_ to_fp 11 53) epsabs_ack!171)
                      a!4)))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) x_ack!170))
                           ((_ to_fp 11 53) #x0000000000000000)))))
  (not (fp.eq (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) x_ack!170) a!2)
              ((_ to_fp 11 53) x_ack!170))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
