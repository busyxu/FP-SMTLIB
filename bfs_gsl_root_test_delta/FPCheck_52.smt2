...
(declare-fun epsrel_ack!129 () (_ BitVec 64))
(declare-fun epsabs_ack!128 () (_ BitVec 64))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.add roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) x_ack!127) a!2)
                 a!2)
         ((_ to_fp 11 53) x_ack!127)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
...
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!129)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!128)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
