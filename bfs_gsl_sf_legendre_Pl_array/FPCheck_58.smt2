...
(assert (bvsle #x00000002 a_ack!226))
(assert (bvsle #x00000003 a_ack!226))
(assert (bvsle #x00000004 a_ack!226))
(assert (bvsle #x00000005 a_ack!226))
(assert (bvsle #x00000006 a_ack!226))
(assert (FPCHECK_FMUL_UNDERFLOW b_ack!225 #x4026000000000000))
