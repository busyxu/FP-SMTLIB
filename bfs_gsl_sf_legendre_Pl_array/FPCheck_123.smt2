...
(assert (bvsle #x00000006 a_ack!474))
(assert (bvsle #x00000007 a_ack!474))
(assert (bvsle #x00000008 a_ack!474))
(assert (bvsle #x00000009 a_ack!474))
(assert (bvsle #x0000000a a_ack!474))
