...
(assert (bvsle #x00000004 a_ack!380))
(assert (bvsle #x00000005 a_ack!380))
(assert (bvsle #x00000006 a_ack!380))
(assert (bvsle #x00000007 a_ack!380))
(assert (bvsle #x00000008 a_ack!380))
