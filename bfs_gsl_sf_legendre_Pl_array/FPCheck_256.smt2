...
(assert (bvsle #x0000000f a_ack!968))
(assert (bvsle #x00000010 a_ack!968))
(assert (bvsle #x00000011 a_ack!968))
(assert (bvsle #x00000012 a_ack!968))
(assert (bvsle #x00000013 a_ack!968))
