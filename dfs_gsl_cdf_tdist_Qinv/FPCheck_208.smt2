...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!699) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!699) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!700) ((_ to_fp 11 53) #x3fe0000000000000))))
