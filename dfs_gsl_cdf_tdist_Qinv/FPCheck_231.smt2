...
(declare-fun mu_ack!745 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!745) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!745) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!746) ((_ to_fp 11 53) #x3fe0000000000000))))
