...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!212) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!212) ((_ to_fp 11 53) #xc033000000000000))))
...
(assert (let ((a!1 (CF_pow #x4000000000000000
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         a!1))
         a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!212) ((_ to_fp 11 53) #xc065400000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 a_ack!212))
