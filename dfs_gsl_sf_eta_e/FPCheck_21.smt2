...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!35) ((_ to_fp 11 53) #x4059000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!35) ((_ to_fp 11 53) #x4034000000000000))))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (CF_pow #x4000000000000000
                 (fp.sub roundNearestTiesToEven
                         ((_ to_fp 11 53) #x8000000000000000)
                         ((_ to_fp 11 53) a_ack!35))))))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 a_ack!35))
