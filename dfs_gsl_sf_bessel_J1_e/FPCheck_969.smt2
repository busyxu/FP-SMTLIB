...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1425))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1425))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1425))
                           (fp.abs ((_ to_fp 11 53) a_ack!1425))))))
...
(let ((a!52 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!52
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven (fp.abs a!53) (fp.abs a!50))
