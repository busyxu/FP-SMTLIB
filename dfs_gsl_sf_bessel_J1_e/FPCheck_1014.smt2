...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1509))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1509))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1509))
                           (fp.abs ((_ to_fp 11 53) a_ack!1509))))))
...
(let ((a!27 (fp.abs (fp.div roundNearestTiesToEven
                            ...
                            (fp.abs ((_ to_fp 11 53) a_ack!1509))))))
  (not (fp.lt a!27 ((_ to_fp 11 53) #x3f48406003b2ae5a)))))))))))))))))))))))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4040000000000000)
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1509))
      ...
      (a!28 (fp.sub roundNearestTiesToEven
                    (CF_sin (fp.abs ((_ to_fp 11 53) a_ack!1509)))
                    (CF_cos (fp.abs ((_ to_fp 11 53) a_ack!1509))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           (fp.sub roundNearestTiesToEven
...
(let ((a!26 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!24)
                            ((_ to_fp 11 53) #xbf72b9d550b1f542)))))
(let ((a!27 (CF_cos (fp.div roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!26 a!25)
                                    ((_ to_fp 11 53) #x3fd7b301ba8e73fd))
                            (fp.abs ((_ to_fp 11 53) a_ack!1509))))))
  (FPCHECK_FMUL_UNDERFLOW a!27 a!28)))))))))))))))))))))))))))))
