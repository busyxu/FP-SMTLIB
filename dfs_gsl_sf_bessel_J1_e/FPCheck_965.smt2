...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1420))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1420))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1420))
                           (fp.abs ((_ to_fp 11 53) a_ack!1420))))))
...
(let ((a!25 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY (fp.abs a!25) (fp.abs a!24))))))))))))))))))))))))))))
