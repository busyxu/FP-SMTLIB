...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2575)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2576)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2576) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2576) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2576) ((_ to_fp 11 53) b_ack!2575))))
...
(let ((a!34 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!27 a!34))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!2576 #x403c000000000000))
