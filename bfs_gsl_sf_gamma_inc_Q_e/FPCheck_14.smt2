...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!51)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!52)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!52) ((_ to_fp 11 53) #x412e848000000000)))
(assert (FPCHECK_FSUB_OVERFLOW b_ack!51 a_ack!52))
