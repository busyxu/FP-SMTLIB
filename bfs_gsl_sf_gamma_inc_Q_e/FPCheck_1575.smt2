...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3597) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3597) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3598) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3597)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3598) ((_ to_fp 11 53) b_ack!3597))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3597)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3598)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3598) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3597)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3598)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3597) ((_ to_fp 11 53) a_ack!3598))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!3598 #x404b800000000000))
