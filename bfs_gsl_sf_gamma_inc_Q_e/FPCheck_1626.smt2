...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3699)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3700) ((_ to_fp 11 53) b_ack!3699))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3699)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3700)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3700) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3699)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3700)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3699) ((_ to_fp 11 53) a_ack!3700))))
...
(let ((a!71 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!69 a!70) a!71)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
