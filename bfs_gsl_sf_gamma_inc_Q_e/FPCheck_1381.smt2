...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3209)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!3210)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!3210) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3210) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3210) ((_ to_fp 11 53) b_ack!3209))))
...
(let ((a!44 (fp.mul roundNearestTiesToEven
      ...
      (a!55 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!42)
                    a!43)))
  (FPCHECK_FDIV_UNDERFLOW a!44 (fp.add roundNearestTiesToEven a!55 a!44)))))))))))))))))))))))))))))))))))))))))))))))
