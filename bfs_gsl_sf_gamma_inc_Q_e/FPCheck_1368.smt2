...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3183)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3184) ((_ to_fp 11 53) b_ack!3183))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3183)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3184)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3184) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3183)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3184)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3183) ((_ to_fp 11 53) a_ack!3184))))
...
(let ((a!54 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!43 a!54))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3184 #x4046000000000000))
