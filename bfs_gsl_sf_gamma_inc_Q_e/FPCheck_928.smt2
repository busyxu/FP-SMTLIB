...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2303)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2304)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2304) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2304) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2304) ((_ to_fp 11 53) b_ack!2303))))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
      ...
      (a!25 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!18)
                    a!19)))
  (FPCHECK_FDIV_ZERO a!20 (fp.add roundNearestTiesToEven a!25 a!20)))))))))))))))))))))))
