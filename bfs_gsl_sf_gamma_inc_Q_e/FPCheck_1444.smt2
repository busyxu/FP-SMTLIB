...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3335)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3336) ((_ to_fp 11 53) b_ack!3335))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3335)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3336)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3336) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3335)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3336)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3335) ((_ to_fp 11 53) a_ack!3336))))
...
(let ((a!59 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!47 a!59))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3336 #x4048000000000000))
