...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3391)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3392) ((_ to_fp 11 53) b_ack!3391))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3391)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3392)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3392) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3391)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3392)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3391) ((_ to_fp 11 53) a_ack!3392))))
...
(let ((a!61 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW (fp.add roundNearestTiesToEven a!59 a!60) a!61)))))))))))))))))))))))))))))))))))))))))))))))))))
