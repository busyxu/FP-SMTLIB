...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!555)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!556)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!556) ((_ to_fp 11 53) #x412e848000000000)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW a!2 #x3ff6a09e667f3bcd))))
