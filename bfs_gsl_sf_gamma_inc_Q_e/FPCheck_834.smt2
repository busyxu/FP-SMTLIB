...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2115)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2116)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2116) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2116) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2116) ((_ to_fp 11 53) b_ack!2115))))
...
(let ((a!19 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!15 a!19))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2116 #x4030000000000000))
