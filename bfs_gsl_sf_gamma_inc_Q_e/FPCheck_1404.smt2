...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3255)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3256) ((_ to_fp 11 53) b_ack!3255))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!3256 #x4047000000000000))
