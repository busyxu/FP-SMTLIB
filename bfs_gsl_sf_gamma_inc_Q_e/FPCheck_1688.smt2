...
(declare-fun b_ack!3823 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3823)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) b_ack!3823))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3823)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3824)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3824) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3823)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3824)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3823)
                                   ((_ to_fp 11 53) a_ack!3824))
                           ((_ to_fp 11 53) a_ack!3824))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3823) ((_ to_fp 11 53) a_ack!3824))))
...
(let ((a!60 (fp.mul roundNearestTiesToEven
      ...
      (a!75 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!58)
                    a!59)))
  (FPCHECK_FDIV_ZERO a!60 (fp.add roundNearestTiesToEven a!75 a!60)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
