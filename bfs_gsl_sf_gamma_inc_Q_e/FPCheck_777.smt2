...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2001)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2002) ((_ to_fp 11 53) b_ack!2001))))
...
(let ((a!16 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!16)))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2002 #x402a000000000000))
