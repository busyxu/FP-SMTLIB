...
(declare-fun b_ack!3901 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3902) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3901) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3901) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3902) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3901)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3902) ((_ to_fp 11 53) b_ack!3901))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3901)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3902)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3902) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3901)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3902)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3901)
                                   ((_ to_fp 11 53) a_ack!3902))
                           ((_ to_fp 11 53) a_ack!3902))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3901) ((_ to_fp 11 53) a_ack!3902))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!3902 #x404f800000000000))
