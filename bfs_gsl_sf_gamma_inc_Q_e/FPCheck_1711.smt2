...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3869)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3870) ((_ to_fp 11 53) b_ack!3869))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3869)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3870)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3870) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3869)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3870)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3869) ((_ to_fp 11 53) a_ack!3870))))
