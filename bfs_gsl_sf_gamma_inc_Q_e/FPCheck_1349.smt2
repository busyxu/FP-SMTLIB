...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3145)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3146) ((_ to_fp 11 53) b_ack!3145))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3145)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3146)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3145) ((_ to_fp 11 53) a_ack!3146))))
...
(assert (FPCHECK_FADD_ACCURACY a_ack!3146 #x4045800000000000))
