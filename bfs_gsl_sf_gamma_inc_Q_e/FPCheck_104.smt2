...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!293)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!294)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x412e848000000000)))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) a_ack!294))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) b_ack!293))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!293)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!294)
