...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!95)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!96)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!96) ((_ to_fp 11 53) #x412e848000000000)))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!96) ((_ to_fp 11 53) b_ack!95))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!95)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!96)
                    ((_ to_fp 11 53) #x408f400000000000)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!96) ((_ to_fp 11 53) #x4024000000000000))))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 a_ack!96))
