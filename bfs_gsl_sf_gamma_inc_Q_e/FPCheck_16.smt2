...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!57)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!58)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!58) ((_ to_fp 11 53) #x412e848000000000)))
(assert (FPCHECK_FSUB_ACCURACY b_ack!57 a_ack!58))
