...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1499)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1500)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1500) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1500) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1500) ((_ to_fp 11 53) b_ack!1499))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3cb0000000000000)
                           (fp.abs a!1)))))
  (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) a_ack!1500)) a!3)))))
