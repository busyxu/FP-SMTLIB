...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1358) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1358) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1357)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1358)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!1358) ((_ to_fp 11 53) #x412e848000000000)))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x0000000000000000))
                           ((_ to_fp 11 53) #x3c46aefbb5ad4103))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven a!5 a!6)
                           ((_ to_fp 11 53) #x0000000000000000)))))
  (fp.eq a!7 ((_ to_fp 11 53) #x3c46aefbb5ad4103))))))))))
(assert (let ((a!1 (fp.geq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!1357)
                                   ((_ to_fp 11 53) a_ack!1358))
