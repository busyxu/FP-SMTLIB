...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3941)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3942) ((_ to_fp 11 53) b_ack!3941))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3941)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3942)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3942) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3941)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3942)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3941) ((_ to_fp 11 53) a_ack!3942))))
...
(let ((a!79 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!63 a!79))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!3942 #x4050000000000000))
