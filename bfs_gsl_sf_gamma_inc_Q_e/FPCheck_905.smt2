...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2257)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2258)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2258) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2258) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2258) ((_ to_fp 11 53) b_ack!2257))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!18)
                    a!19)))
  (FPCHECK_FDIV_OVERFLOW a!19 a!24))))))))))))))))))))))
