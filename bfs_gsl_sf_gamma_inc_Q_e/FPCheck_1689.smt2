...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3825)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3826) ((_ to_fp 11 53) b_ack!3825))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3825)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3826)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3826) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3825)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3826)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3825) ((_ to_fp 11 53) a_ack!3826))))
...
(let ((a!76 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!76)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!3826 #x404e800000000000))
