...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!119)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!120)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) #x412e848000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!119)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!120)
