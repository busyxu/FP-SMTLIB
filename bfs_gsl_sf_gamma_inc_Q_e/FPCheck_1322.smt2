...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3091)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3092) ((_ to_fp 11 53) b_ack!3091))))
...
(let ((a!51 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!49 a!50) a!51)))))))))))))))))))))))))))))))))))))))))))
