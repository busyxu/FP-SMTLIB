...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3967)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!3968)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!3968) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3968) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3968) ((_ to_fp 11 53) b_ack!3967))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3967)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3968)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3968) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3967)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3968)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3967) ((_ to_fp 11 53) a_ack!3968))))
...
(let ((a!64 (fp.mul roundNearestTiesToEven
      ...
      (a!80 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!62)
                    a!63)))
  (FPCHECK_FDIV_OVERFLOW a!64 (fp.add roundNearestTiesToEven a!80 a!64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
