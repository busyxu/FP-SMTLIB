...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!171)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!172)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!172) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!172) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!171) ((_ to_fp 11 53) #x4014000000000000)))
(assert (FPCHECK_FADD_UNDERFLOW #x3fe2788cfc6fb619 (CF_log b_ack!171)))
