...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!137)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!138) ((_ to_fp 11 53) b_ack!137))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!137)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!138)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!138) ((_ to_fp 11 53) #x4024000000000000))))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 a_ack!138))
