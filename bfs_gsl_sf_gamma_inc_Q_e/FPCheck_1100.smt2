...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2648) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2648) ((_ to_fp 11 53) b_ack!2647))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!2648 #x403e000000000000))
