...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!83)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!84)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!84) ((_ to_fp 11 53) #x412e848000000000)))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!84) ((_ to_fp 11 53) b_ack!83))))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!84 #x408f400000000000))
