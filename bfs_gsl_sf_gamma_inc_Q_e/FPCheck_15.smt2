...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!53)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!54)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!54) ((_ to_fp 11 53) #x412e848000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!53 a_ack!54))
