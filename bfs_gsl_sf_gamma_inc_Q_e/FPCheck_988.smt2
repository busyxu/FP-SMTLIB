...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2423)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2424)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2424) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2424) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2424) ((_ to_fp 11 53) b_ack!2423))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!23 a!29))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!2424 #x4038000000000000))
