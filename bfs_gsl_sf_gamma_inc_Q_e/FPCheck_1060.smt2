...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2567)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2568)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) b_ack!2567))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2567)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!2568)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2567)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!2568)))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2568) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2567)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2567) ((_ to_fp 11 53) a_ack!2568))))
...
(let ((a!34 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!26)
                    a!27)))
  (FPCHECK_FDIV_INVALID a!27 a!34))))))))))))))))))))))))))))))
