...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3787)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3788) ((_ to_fp 11 53) b_ack!3787))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3787)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3788)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3788) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3787)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3788)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3787) ((_ to_fp 11 53) a_ack!3788))))
...
(let ((a!74 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!59 a!74))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!3788 #x404e000000000000))
