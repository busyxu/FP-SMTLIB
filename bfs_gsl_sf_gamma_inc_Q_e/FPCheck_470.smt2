...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1335)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1336)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) #x412e848000000000)))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) a_ack!1336))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) b_ack!1335))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1335)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!1336)
                    ((_ to_fp 11 53) #x408f400000000000)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1335)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!1336)))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) #x4330000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1335)
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) a_ack!1336)))))
(assert (FPCHECK_FADD_ACCURACY a_ack!1336 #x40c3880000000000))
