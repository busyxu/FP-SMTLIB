...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2267)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2268)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2268) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2268) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2268) ((_ to_fp 11 53) b_ack!2267))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2267)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!2268)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2268) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2267)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!2268)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2267) ((_ to_fp 11 53) a_ack!2268))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!19 a!24))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!2268 #x4034000000000000))
