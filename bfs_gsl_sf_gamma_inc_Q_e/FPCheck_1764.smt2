...
(declare-fun b_ack!3975 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3976) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3975) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3975) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3976) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3975)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3976) ((_ to_fp 11 53) b_ack!3975))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3975)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3976)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3976) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3975)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3976)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3975)
                                   ((_ to_fp 11 53) a_ack!3976))
                           ((_ to_fp 11 53) a_ack!3976))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3975) ((_ to_fp 11 53) a_ack!3976))))
...
(let ((a!64 (fp.mul roundNearestTiesToEven
      ...
      (a!80 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!62)
                    a!63)))
  (FPCHECK_FDIV_ZERO a!64 (fp.add roundNearestTiesToEven a!80 a!64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
