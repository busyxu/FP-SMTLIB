...
(declare-fun b_ack!3903 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3904) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3903) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3903) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3904) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3903)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3904) ((_ to_fp 11 53) b_ack!3903))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3903)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3904)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3904) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3903)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3904)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3903)
                                   ((_ to_fp 11 53) a_ack!3904))
                           ((_ to_fp 11 53) a_ack!3904))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3903) ((_ to_fp 11 53) a_ack!3904))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!3904 #x404f800000000000))
