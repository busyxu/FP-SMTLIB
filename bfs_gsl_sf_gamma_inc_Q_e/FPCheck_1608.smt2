...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3663)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3664) ((_ to_fp 11 53) b_ack!3663))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3663)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3664)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3664) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3663)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3664)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3663) ((_ to_fp 11 53) a_ack!3664))))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
      ...
      (a!70 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!54)
                    a!55)))
  (FPCHECK_FDIV_OVERFLOW a!56 (fp.add roundNearestTiesToEven a!70 a!56)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
