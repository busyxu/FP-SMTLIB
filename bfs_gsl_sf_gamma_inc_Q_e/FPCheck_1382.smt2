...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3211)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3212) ((_ to_fp 11 53) b_ack!3211))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3211)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3212)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3212) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3211)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3212)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3211) ((_ to_fp 11 53) a_ack!3212))))
...
(let ((a!44 (fp.mul roundNearestTiesToEven
      ...
      (a!55 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!42)
                    a!43)))
  (FPCHECK_FDIV_ACCURACY a!44 (fp.add roundNearestTiesToEven a!55 a!44)))))))))))))))))))))))))))))))))))))))))))))))
