...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3221)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3222) ((_ to_fp 11 53) b_ack!3221))))
...
(let ((a!56 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!56)))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3222 #x4046800000000000))
