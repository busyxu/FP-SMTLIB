...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3639) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3640) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3639)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3640) ((_ to_fp 11 53) b_ack!3639))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3639)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3640)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3640) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3639)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3640)))))
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!3639)
                                   ((_ to_fp 11 53) a_ack!3640))
                           ((_ to_fp 11 53) a_ack!3640))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3639) ((_ to_fp 11 53) a_ack!3640))))
...
(let ((a!69 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!55 a!69))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3640 #x404c000000000000))
