...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3485)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3486) ((_ to_fp 11 53) b_ack!3485))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3485)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3486)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3486) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3485)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3486)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3485) ((_ to_fp 11 53) a_ack!3486))))
...
(let ((a!64 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!51 a!64))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!3486 #x404a000000000000))
