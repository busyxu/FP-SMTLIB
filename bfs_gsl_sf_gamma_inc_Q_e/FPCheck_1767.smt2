...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3981)
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!3982) ((_ to_fp 11 53) b_ack!3981))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3981)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!3982)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3982) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3981)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!3982)))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3981) ((_ to_fp 11 53) a_ack!3982))))
...
(let ((a!81 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!81)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3982 #x4050400000000000))
