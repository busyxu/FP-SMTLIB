...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2453)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2454)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x412e848000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) b_ack!2453))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2453)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!2454)
                    ((_ to_fp 11 53) #xffffffffffffffff)))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2453)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fe0000000000000)
                    ((_ to_fp 11 53) a_ack!2454)))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2454) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2453)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2453) ((_ to_fp 11 53) a_ack!2454))))
...
(let ((a!24 (fp.mul roundNearestTiesToEven
      ...
      (a!30 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!22)
                    a!23)))
  (FPCHECK_FDIV_INVALID a!24 (fp.add roundNearestTiesToEven a!30 a!24)))))))))))))))))))))))))))
