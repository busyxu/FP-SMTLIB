(declare-fun mu_ack!1447 () (_ BitVec 64))
(declare-fun x_ack!1448 () (_ BitVec 64))
(assert (fp.gt ((_ to_fp 11 53) mu_ack!1447) ((_ to_fp 11 53) #x403e000000000000)))
(assert (fp.lt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!1448)
               ((_ to_fp 11 53) x_ack!1448))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x4024000000000000)
               ((_ to_fp 11 53) mu_ack!1447))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!1448) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!21 (fp.lt (fp.abs (fp.add roundNearestTiesToEven
                                   (fp.div roundNearestTiesToEven a!20 a!7)
                                   ((_ to_fp 11 53) #x0000000000000000)))
