(declare-fun mu_ack!1451 () (_ BitVec 64))
(declare-fun x_ack!1452 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (fp.gt ((_ to_fp 11 53) mu_ack!1451) ((_ to_fp 11 53) #x403e000000000000)))
(assert (fp.lt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!1452)
               ((_ to_fp 11 53) x_ack!1452))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x4024000000000000)
               ((_ to_fp 11 53) mu_ack!1451))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!1452) ((_ to_fp 11 53) #x0000000000000000)))
