...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2785) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2786) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2785)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2786)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2786) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2786) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2785) ((_ to_fp 11 53) #x4014000000000000)))
...
(assert (FPCHECK_FADD_OVERFLOW #x3fe72ad94dc1fec8 (CF_log b_ack!2785)))
