...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2008) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2007) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    (CF_floor a_ack!2008))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) b_ack!2007)
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2007) ((_ to_fp 11 53) #x4014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) a_ack!2008)
                     (CF_floor a_ack!2008))
             ((_ to_fp 11 53) b_ack!2007))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!2007)
                  (fp.sub roundNearestTiesToEven
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) a_ack!2008)
                                  (CF_floor a_ack!2008))
