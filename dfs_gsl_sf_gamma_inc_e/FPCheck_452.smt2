...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1460) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1459) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1460))
...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    (CF_floor a_ack!1460))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!1459)
