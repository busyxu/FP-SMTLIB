...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1806) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1805) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1806))
...
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ...
                    (CF_floor a_ack!1806))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq ((_ to_fp 11 53) b_ack!1805)
...
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!1805)
                  (fp.sub roundNearestTiesToEven
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) a_ack!1806)
                                  (CF_floor a_ack!1806))
