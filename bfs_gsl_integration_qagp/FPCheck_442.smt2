(declare-fun limit_ack!6663 () (_ BitVec 64))
(declare-fun epsabs_ack!6668 () (_ BitVec 64))
(declare-fun a_ack!6669 () (_ BitVec 64))
(declare-fun x1_ack!6664 () (_ BitVec 64))
(declare-fun x2_ack!6665 () (_ BitVec 64))
(declare-fun x3_ack!6666 () (_ BitVec 64))
(declare-fun b_ack!6667 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!6663)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!6668)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!6664) ((_ to_fp 11 53) a_ack!6669))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!6665) ((_ to_fp 11 53) x1_ack!6664))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!6666) ((_ to_fp 11 53) x2_ack!6665))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6667) ((_ to_fp 11 53) x3_ack!6666))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!6669)
                                   ((_ to_fp 11 53) x1_ack!6664))))))
