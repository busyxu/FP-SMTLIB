(declare-fun limit_ack!6145 () (_ BitVec 64))
(declare-fun epsabs_ack!6150 () (_ BitVec 64))
(declare-fun a_ack!6151 () (_ BitVec 64))
(declare-fun x1_ack!6146 () (_ BitVec 64))
(declare-fun x2_ack!6147 () (_ BitVec 64))
(declare-fun x3_ack!6148 () (_ BitVec 64))
(declare-fun b_ack!6149 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!6145)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!6150)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!6146) ((_ to_fp 11 53) a_ack!6151))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!6147) ((_ to_fp 11 53) x1_ack!6146))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!6148) ((_ to_fp 11 53) x2_ack!6147))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6149) ((_ to_fp 11 53) x3_ack!6148))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!6151)
