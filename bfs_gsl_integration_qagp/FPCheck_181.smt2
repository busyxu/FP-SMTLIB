...
(declare-fun x3_ack!2760 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!2758) ((_ to_fp 11 53) a_ack!2763))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!2759) ((_ to_fp 11 53) x1_ack!2758))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!2760) ((_ to_fp 11 53) x2_ack!2759))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2761) ((_ to_fp 11 53) x3_ack!2760))))
