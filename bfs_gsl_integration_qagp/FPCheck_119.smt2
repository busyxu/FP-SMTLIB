(declare-fun limit_ack!1875 () (_ BitVec 64))
...
(declare-fun x3_ack!1878 () (_ BitVec 64))
(declare-fun b_ack!1879 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!1875)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!1880)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!1876) ((_ to_fp 11 53) a_ack!1881))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!1877) ((_ to_fp 11 53) x1_ack!1876))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!1878) ((_ to_fp 11 53) x2_ack!1877))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1879) ((_ to_fp 11 53) x3_ack!1878))))
