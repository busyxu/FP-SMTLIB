(declare-fun c_ack!2665 () (_ BitVec 64))
(declare-fun a_ack!2666 () (_ BitVec 32))
(declare-fun b_ack!2664 () (_ BitVec 32))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2665))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!2664 a_ack!2666)))
(assert (not (bvslt a_ack!2666 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2665) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2664))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2665))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2665))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2665)))
