...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2758))
...
(assert (= #x00000000 b_ack!2757))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2758))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2758))
