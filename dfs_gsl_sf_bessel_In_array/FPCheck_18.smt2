...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!97))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!97))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!97))
        ((_ to_fp 11 53) #x4020000000000000)))
(assert (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!97)) ((_ to_fp 11 53) #x0000000000000000)))
