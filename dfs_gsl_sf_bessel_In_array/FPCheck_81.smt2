...
(assert (not (bvslt b_ack!351 a_ack!353)))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!352))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!352))
        ((_ to_fp 11 53) #x4008000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 (fp.abs ((_ to_fp 11 53) c_ack!352))))
