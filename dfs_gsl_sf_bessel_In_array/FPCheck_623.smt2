...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2602))
...
(assert (= #x00000000 b_ack!2601))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2602))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2602))
...
(let ((a!35 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!32 a!30)
                            ((_ to_fp 11 53) #x3f120fa37899a1b5)))))
  (FPCHECK_FADD_UNDERFLOW a!35 #x3f9be62aca809cb5)))))))))))))))))))))))))))))))))))))
