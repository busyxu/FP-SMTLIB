...
(assert (not (bvslt b_ack!1389 a_ack!1391)))
(assert (not (bvslt a_ack!1391 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1390) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1389))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1390))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1390))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW (fp.abs a!14) (fp.abs a!12)))))))))))))))))
