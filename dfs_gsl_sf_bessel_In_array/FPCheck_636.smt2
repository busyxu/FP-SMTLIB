...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2668))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!2667 a_ack!2669)))
(assert (not (bvslt a_ack!2669 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2668) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2667))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2668))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2668))
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!60
                    ((_ to_fp 11 53) #x3f6b998ca2e5903f)))
    (fp.add roundNearestTiesToEven a!63 ((_ to_fp 11 53) #x3f9be62aca809cb5))))))))))))))))))))))))))))))))))))))))
