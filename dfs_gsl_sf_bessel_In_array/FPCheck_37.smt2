...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!181))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!180 a_ack!182)))
(assert (not (bvslt a_ack!182 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!181) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!180))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!181))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!181))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!181))
