...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2257))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!2256 a_ack!2258)))
(assert (not (bvslt a_ack!2258 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2257) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2256))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2257))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2257))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2257)))
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!49
                    ((_ to_fp 11 53) #x3e58569280edf9e5)))
    (fp.add roundNearestTiesToEven a!52 ((_ to_fp 11 53) #x3e8b8007d9c3a27d))))))))))))))))))))))))))))))))))
