...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1135))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!1134 a_ack!1136)))
(assert (not (bvslt a_ack!1136 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1135) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1134))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1135))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1135))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!1135)))
