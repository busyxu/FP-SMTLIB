...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!499))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!498 a_ack!500)))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!499)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!499)))
                   (fp.abs ((_ to_fp 11 53) c_ack!499)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) c_ack!499)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!499)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
