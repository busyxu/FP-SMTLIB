...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2785))
...
(assert (= #x00000000 b_ack!2784))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2785))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2785))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!2785)))
