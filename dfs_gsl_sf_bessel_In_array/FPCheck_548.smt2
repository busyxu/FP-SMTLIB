...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2245))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2245))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2245))
...
(let ((a!30 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!26 a!24)
                                    ((_ to_fp 11 53) #x3e2d2c64a9c0b0ac))))))
  (FPCHECK_FADD_UNDERFLOW a!30 #x3e8b8007d9c3a27d))))))))))))))))))))))))))))))))
