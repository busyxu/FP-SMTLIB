...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1237))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!1236 a_ack!1238)))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1237))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1237))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!1237)))
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!16
                    ((_ to_fp 11 53) #x3cf13428ff6ed89c)))
    (fp.add roundNearestTiesToEven a!19 ((_ to_fp 11 53) #x3d057b6f81f8fd0e))))))))))))))))
