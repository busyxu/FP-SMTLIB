...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!235))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!235))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!235))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FADD_UNDERFLOW a!4 #x3c942d169d7dfa04))))))
