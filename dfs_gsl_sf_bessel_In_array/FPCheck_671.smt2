...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2839))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2839))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2839))
             ((_ to_fp 11 53) #x4020000000000000))))
(assert (bvsle #x00000000 (bvsub b_ack!2838 a_ack!2840)))
...
(let ((a!36 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW a!36 (CF_exp (fp.abs ((_ to_fp 11 53) c_ack!2839)))))))))))))))))))))))))))))))))))))))))
