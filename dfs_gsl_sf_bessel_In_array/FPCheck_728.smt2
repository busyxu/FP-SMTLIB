...
(declare-fun b_ack!3036 () (_ BitVec 32))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_exp ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!3037))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!3036 a_ack!3038)))
(assert (not (bvslt a_ack!3038 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3037) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!3036)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!3037))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) c_ack!3037))
                          (fp.abs ((_ to_fp 11 53) c_ack!3037)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!3037)))
