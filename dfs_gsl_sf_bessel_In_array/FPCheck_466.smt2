...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1909))
            ((_ to_fp 11 53) #x40862642fefa39ef))))
(assert (not (bvslt b_ack!1908 a_ack!1910)))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1909))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!1909))
