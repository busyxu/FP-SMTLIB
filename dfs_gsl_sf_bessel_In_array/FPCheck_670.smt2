...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2833))
...
(assert (= #x00000000 b_ack!2832))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!2833))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2833))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2833))
             ((_ to_fp 11 53) #x4020000000000000))))
(assert (bvsle #x00000000 (bvsub b_ack!2832 a_ack!2834)))
...
(let ((a!36 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!36 (CF_exp (fp.abs ((_ to_fp 11 53) c_ack!2833)))))))))))))))))))))))))))))))))))))))))
