...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!2845))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2845))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!2845))
             ((_ to_fp 11 53) #x4020000000000000))))
(assert (bvsle #x00000000 (bvsub b_ack!2844 a_ack!2846)))
...
(let ((a!36 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY a!36 (CF_exp (fp.abs ((_ to_fp 11 53) c_ack!2845)))))))))))))))))))))))))))))))))))))))))
