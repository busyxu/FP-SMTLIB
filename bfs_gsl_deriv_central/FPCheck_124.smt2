      ...
      (a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)))))
  (fp.gt a!2
         (fp.abs (fp.div roundNearestTiesToEven a!5 ((_ to_fp 11 53) h_ack!516)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!516))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!517)
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) h_ack!516)))))
  (fp.eq a!2 ((_ to_fp 11 53) h_ack!516)))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!517)
                                   ((_ to_fp 11 53) h_ack!516))
...
(let ((a!2 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!2
    (fp.div roundNearestTiesToEven
            (fp.abs ((_ to_fp 11 53) x_ack!517))
            ((_ to_fp 11 53) h_ack!516))))))
