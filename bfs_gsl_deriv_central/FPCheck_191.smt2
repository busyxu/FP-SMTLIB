...
(let ((a!6 (fp.div roundNearestTiesToEven
      ...
      (a!9 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) h_ack!808)))
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) x_ack!809))
                           ((_ to_fp 11 53) h_ack!808))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!808))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!809)
                           (fp.div roundNearestTiesToEven
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) h_ack!808)
                            (CF_pow a!11 #x3fd5555555555555)))))
  (fp.eq a!12 ((_ to_fp 11 53) x_ack!809))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!809)
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) h_ack!808)
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (CF_pow (fp.sub roundNearestTiesToEven
                                    ...
                                    a!12)
                            #x3ff8000000000000))))
  (FPCHECK_FMUL_ACCURACY #x3ff5555555555555 a!13))))))))
