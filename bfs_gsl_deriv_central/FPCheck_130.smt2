      ...
      (a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)))))
  (fp.gt a!2
         (fp.abs (fp.div roundNearestTiesToEven a!5 ((_ to_fp 11 53) h_ack!544)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!544))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!545)
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) h_ack!544)))))
  (fp.eq a!2 ((_ to_fp 11 53) h_ack!544)))))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   a!3)))))
  (FPCHECK_FDIV_OVERFLOW a!4 h_ack!544))))
