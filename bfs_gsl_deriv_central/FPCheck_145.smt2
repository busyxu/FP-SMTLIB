(declare-fun h_ack!608 () (_ BitVec 64))
      ...
      (a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)))))
  (fp.gt a!2
         (fp.abs (fp.div roundNearestTiesToEven a!5 ((_ to_fp 11 53) h_ack!608)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!608))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!609)
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) h_ack!608)))))
  (fp.eq a!2 ((_ to_fp 11 53) h_ack!608)))))
