...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!466))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!465))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!466))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!466))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!465))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!466))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!466))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!2
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 ((_ to_fp 11 53) c_ack!466))))))
(assert (bvslt #x00000003 b_ack!465))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) c_ack!466)
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) c_ack!466)) a!3)
    (fp.mul roundNearestTiesToEven
