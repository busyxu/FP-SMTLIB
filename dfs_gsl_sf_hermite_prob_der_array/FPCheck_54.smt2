...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!307))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!306))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!307))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!307))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!306))
...
(assert (FPCHECK_FMUL_ACCURACY #x4000000000000000 c_ack!307))
