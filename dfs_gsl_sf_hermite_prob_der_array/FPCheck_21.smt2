...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!142))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!141))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!142))
       (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) #x7feccccccccccccc)
               (fp.abs ((_ to_fp 11 53) c_ack!142)))))
(assert (FPCHECK_FMUL_ACCURACY (fp.abs ((_ to_fp 11 53) c_ack!142)) #x3cb0000000000000))
