...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!229))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!228))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!229))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!229))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!228))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!229))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!229))
