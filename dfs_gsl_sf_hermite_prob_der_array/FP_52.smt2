...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1132))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!1131))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!1132))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!1132))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!1131))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!2
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 ((_ to_fp 11 53) c_ack!1132))))))
(assert (bvslt #x00000003 b_ack!1131))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) c_ack!1132)
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (bvslt #x00000004 b_ack!1131))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) c_ack!1132))
                 a!4)))))))
(assert (bvslt #x00000005 b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) c_ack!1132))
                 a!5))))))))
(assert (bvslt #x00000006 b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4018000000000000)
                 a!4)))))))))
(assert (bvslt #x00000007 b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
...
(assert (bvslt #x00000008 b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
...
(assert (bvslt #x00000009 b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
...
(let ((a!8 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!8)
         ((_ to_fp 11 53) #x4022000000000000))))))))))
(assert (bvslt #x0000000a b_ack!1131))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1132)
                           ((_ to_fp 11 53) c_ack!1132))
