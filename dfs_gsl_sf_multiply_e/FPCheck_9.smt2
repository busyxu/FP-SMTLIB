...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!47))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!47))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!48))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!48))
            (fp.abs ((_ to_fp 11 53) b_ack!47)))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!47)) ((_ to_fp 11 53) #x5feccccccccccccc)))
(assert (FPCHECK_FMUL_ACCURACY a_ack!48 b_ack!47))
