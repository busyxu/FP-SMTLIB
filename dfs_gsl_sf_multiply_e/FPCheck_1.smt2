...
(assert (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!6)) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!5))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!5))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FDIV_UNDERFLOW #x7feffffffffffffb (fp.abs ((_ to_fp 11 53) b_ack!5))))
