...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!346) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000006 a_ack!347))
(assert (bvsle #x00000007 a_ack!347))
(assert (bvsle #x00000008 a_ack!347))
