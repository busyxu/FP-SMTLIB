...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!996) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!996) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!18 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!16
                                    ((_ to_fp 11 53) #x4031000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!18 #x4033000000000000))))))))))))))))))))
