...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!830) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!830) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000010 a_ack!831))
