...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!542) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!542) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000006 a_ack!543))
(assert (bvsle #x00000007 a_ack!543))
(assert (bvsle #x00000008 a_ack!543))
(assert (bvsle #x00000009 a_ack!543))
(assert (bvsle #x0000000a a_ack!543))
(assert (bvsle #x0000000b a_ack!543))
