...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1324) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1324) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000013 a_ack!1325))
(assert (bvsle #x00000014 a_ack!1325))
(assert (bvsle #x00000015 a_ack!1325))
(assert (bvsle #x00000016 a_ack!1325))
(assert (bvsle #x00000017 a_ack!1325))
(assert (bvsle #x00000018 a_ack!1325))
(assert (bvsle #x00000019 a_ack!1325))
