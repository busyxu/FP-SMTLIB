...
(assert (bvsle #x00000006 a_ack!333))
(assert (bvsle #x00000007 a_ack!333))
(assert (bvsle #x00000008 a_ack!333))
(assert (FPCHECK_FMUL_OVERFLOW b_ack!332 #x402e000000000000))
