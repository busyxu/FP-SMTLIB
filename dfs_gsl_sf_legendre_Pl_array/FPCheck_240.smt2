...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!904) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!904) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (bvsle #x00000011 a_ack!905))
(assert (bvsle #x00000012 a_ack!905))
