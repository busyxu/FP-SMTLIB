...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!606) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!606) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!9
                                    ((_ to_fp 11 53) #x4024000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!11 #x4028000000000000)))))))))))))
