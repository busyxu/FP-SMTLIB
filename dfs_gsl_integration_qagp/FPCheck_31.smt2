...
(declare-fun epsrel_ack!585 () (_ BitVec 64))
(declare-fun a_ack!592 () (_ BitVec 64))
(declare-fun x1_ack!587 () (_ BitVec 64))
(declare-fun x2_ack!588 () (_ BitVec 64))
(declare-fun x3_ack!589 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!585)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!585)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!587) ((_ to_fp 11 53) a_ack!592))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!588) ((_ to_fp 11 53) x1_ack!587))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!589) ((_ to_fp 11 53) x2_ack!588))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!590) ((_ to_fp 11 53) x3_ack!589))))
