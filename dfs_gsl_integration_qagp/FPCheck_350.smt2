...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!5959) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!5953)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!5953)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!5955) ((_ to_fp 11 53) a_ack!5960))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!5956) ((_ to_fp 11 53) x1_ack!5955))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!5957) ((_ to_fp 11 53) x2_ack!5956))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!5958) ((_ to_fp 11 53) x3_ack!5957))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!5960)
