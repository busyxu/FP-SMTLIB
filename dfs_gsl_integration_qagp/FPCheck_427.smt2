(declare-fun limit_ack!7298 () (_ BitVec 64))
(declare-fun epsabs_ack!7303 () (_ BitVec 64))
(declare-fun epsrel_ack!7297 () (_ BitVec 64))
(declare-fun a_ack!7304 () (_ BitVec 64))
(declare-fun x1_ack!7299 () (_ BitVec 64))
(declare-fun x2_ack!7300 () (_ BitVec 64))
(declare-fun x3_ack!7301 () (_ BitVec 64))
(declare-fun b_ack!7302 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!7298)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!7303) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7297)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7297)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!7299) ((_ to_fp 11 53) a_ack!7304))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!7300) ((_ to_fp 11 53) x1_ack!7299))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!7301) ((_ to_fp 11 53) x2_ack!7300))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!7302) ((_ to_fp 11 53) x3_ack!7301))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!7304)
                                   ((_ to_fp 11 53) x1_ack!7299))))))
