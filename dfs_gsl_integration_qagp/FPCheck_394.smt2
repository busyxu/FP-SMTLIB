(declare-fun limit_ack!6706 () (_ BitVec 64))
(declare-fun epsabs_ack!6711 () (_ BitVec 64))
(declare-fun epsrel_ack!6705 () (_ BitVec 64))
(declare-fun a_ack!6712 () (_ BitVec 64))
(declare-fun x1_ack!6707 () (_ BitVec 64))
(declare-fun x2_ack!6708 () (_ BitVec 64))
(declare-fun x3_ack!6709 () (_ BitVec 64))
(declare-fun b_ack!6710 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!6706)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!6711) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!6705)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!6705)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!6707) ((_ to_fp 11 53) a_ack!6712))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!6708) ((_ to_fp 11 53) x1_ack!6707))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!6709) ((_ to_fp 11 53) x2_ack!6708))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6710) ((_ to_fp 11 53) x3_ack!6709))))
