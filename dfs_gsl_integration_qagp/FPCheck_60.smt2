(declare-fun limit_ack!1074 () (_ BitVec 64))
(declare-fun epsabs_ack!1079 () (_ BitVec 64))
(declare-fun epsrel_ack!1073 () (_ BitVec 64))
(declare-fun a_ack!1080 () (_ BitVec 64))
(declare-fun x1_ack!1075 () (_ BitVec 64))
(declare-fun x2_ack!1076 () (_ BitVec 64))
(declare-fun x3_ack!1077 () (_ BitVec 64))
(declare-fun b_ack!1078 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!1074)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!1079) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1073)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1073)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!1075) ((_ to_fp 11 53) a_ack!1080))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!1076) ((_ to_fp 11 53) x1_ack!1075))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!1077) ((_ to_fp 11 53) x2_ack!1076))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1078) ((_ to_fp 11 53) x3_ack!1077))))
