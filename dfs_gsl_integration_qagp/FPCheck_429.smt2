(declare-fun limit_ack!7330 () (_ BitVec 64))
(declare-fun epsabs_ack!7335 () (_ BitVec 64))
(declare-fun epsrel_ack!7329 () (_ BitVec 64))
(declare-fun a_ack!7336 () (_ BitVec 64))
(declare-fun x1_ack!7331 () (_ BitVec 64))
(declare-fun x2_ack!7332 () (_ BitVec 64))
(declare-fun x3_ack!7333 () (_ BitVec 64))
(declare-fun b_ack!7334 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!7330)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!7335) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7329)
            ((_ to_fp 11 53) #x3d09000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!7329)
            ((_ to_fp 11 53) #x3a0fb0f6be506019))))
(assert (not (fp.lt ((_ to_fp 11 53) x1_ack!7331) ((_ to_fp 11 53) a_ack!7336))))
(assert (not (fp.lt ((_ to_fp 11 53) x2_ack!7332) ((_ to_fp 11 53) x1_ack!7331))))
(assert (not (fp.lt ((_ to_fp 11 53) x3_ack!7333) ((_ to_fp 11 53) x2_ack!7332))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!7334) ((_ to_fp 11 53) x3_ack!7333))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!7336)
                                   ((_ to_fp 11 53) x1_ack!7331))))))
