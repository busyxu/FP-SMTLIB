...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!93))
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!93)) ((_ to_fp 11 53) #x40862e42fefa39ef)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!93))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!93))
            ((_ to_fp 11 53) #x0020000000000000))))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!93))
             ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!93))
