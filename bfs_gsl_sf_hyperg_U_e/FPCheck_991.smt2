...
(declare-fun a_ack!4299 () (_ BitVec 64))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!4299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4298) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!4299)
...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!16 (fp.add roundNearestTiesToEven
      ...
      (a!24 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!22)
                    a!23)))
  (FPCHECK_FDIV_OVERFLOW a!16 a!24))))))))
