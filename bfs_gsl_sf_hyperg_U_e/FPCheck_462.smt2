...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2038)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2039) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2039) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2039) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven a!3 a!3) a!3)
    a!3))))
