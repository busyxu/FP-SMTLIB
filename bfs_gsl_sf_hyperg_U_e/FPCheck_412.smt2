...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1768)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1769) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1769) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1769) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!4 (bvsub #x00000000
                  ((_ fp.to_sbv 32)
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!3
                            ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_UNDERFLOW a!3 ((_ to_fp 11 53) roundNearestTiesToEven a!4))))))
