...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2119)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2120) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2120) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!3)))))
  (FPCHECK_FADD_UNDERFLOW #x3f93c8855b9a90b0 a!4)))))
