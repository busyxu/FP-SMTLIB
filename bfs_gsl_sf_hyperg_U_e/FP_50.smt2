...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2407)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2408) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2408) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2408) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_floor (fp.add roundNearestTiesToEven
                                     ((_ to_fp 11 53)
                                       ...
                                       a!1)
                                     ((_ to_fp 11 53) #x3fe0000000000000))))))
  (not (fp.lt (fp.abs a!2) ((_ to_fp 11 53) #x3d19000000000000))))))
