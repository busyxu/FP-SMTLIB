...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1412) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!1411) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!3 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  (fp.mul roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!1412))))))
  (not a!3)))))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
