...
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!303) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FMUL_ACCURACY #x3fefae147ae147ae (fp.abs ((_ to_fp 11 53) c_ack!304))))
