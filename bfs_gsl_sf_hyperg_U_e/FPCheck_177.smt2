...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!881) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_floor (fp.add roundNearestTiesToEven
                                     ...
                                     ((_ to_fp 11 53) #x3fe0000000000000))))))
  (not (fp.lt (fp.abs a!1) ((_ to_fp 11 53) #x3d4f400000000000)))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!881) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) b_ack!880) ((_ to_fp 11 53) #x3ff0000000000000))))
