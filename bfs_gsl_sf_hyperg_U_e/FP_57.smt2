...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2533)
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2534) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2534) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!2534) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
  ...
  (not (fp.lt (fp.sub roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) roundNearestTiesToEven a!2))
              ((_ to_fp 11 53) #xbfb999999999999a)))))
(assert (fp.eq ((_ to_fp 11 53) c_ack!2534) ((_ to_fp 11 53) #x0000000000000000)))
