...
(assert (bvslt a_ack!475 #x000003e8))
...
(assert (not (bvsle #x00000003 a_ack!475)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfe0000000000000)
                           ((_ to_fp 11 53) b_ack!474)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!474))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!474))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (FPCHECK_FMUL_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven a_ack!475)
  #x3cb0000000000000))
