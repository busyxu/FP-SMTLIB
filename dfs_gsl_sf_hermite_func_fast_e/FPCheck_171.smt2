...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (bvslt a_ack!763 #x000003e8))
...
(assert (bvsle #x00000002 a_ack!763))
...
(assert (bvsle #x00000003 a_ack!763))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!762))
...
(assert (bvsle #x00000004 a_ack!763))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!762))
...
(assert (bvsle #x00000005 a_ack!763))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!762))
...
(assert (bvsle #x00000006 a_ack!763))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!762)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!762))
...
(assert (bvsle #x00000007 a_ack!763))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!762))
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) b_ack!762))
            a!9)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3feda05179501504) a!8)))))))))))
