...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (bvslt a_ack!927 #x000003e8))
(assert (not (bvslt a_ack!927 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!926) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 a_ack!927)))
(assert (not (= #x00000001 a_ack!927)))
(assert (bvsle #x00000002 a_ack!927))
...
(assert (bvsle #x00000003 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000004 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000005 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000006 a_ack!927))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!926)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000007 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000008 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x00000009 a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
...
(assert (bvsle #x0000000a a_ack!927))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!926))
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) b_ack!926))
            a!12)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fee5b9d136c6d96) a!11))))))))))))))
