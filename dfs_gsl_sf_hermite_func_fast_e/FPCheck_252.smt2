...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (bvslt a_ack!1135 #x000003e8))
...
(assert (bvsle #x0000000a a_ack!1135))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1134))
...
(assert (bvsle #x0000000b a_ack!1135))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1134))
...
(assert (bvsle #x0000000c a_ack!1135))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1134))
...
(assert (bvsle #x0000000d a_ack!1135))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1134))
...
(assert (bvsle #x0000000e a_ack!1135))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1134))
...
(let ((a!15 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3feea33e2c83c140)
                            a!13))))
  (FPCHECK_FMUL_UNDERFLOW #x3feed6023ba6dba2 a!15))))))))))))))))
