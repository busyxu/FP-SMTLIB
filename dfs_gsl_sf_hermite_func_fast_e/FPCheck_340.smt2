...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (bvslt a_ack!1547 #x000003e8))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!1546)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1546))
...
(assert (bvsle #x00000010 a_ack!1547))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1546))
...
(assert (bvsle #x00000011 a_ack!1547))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1546))
...
(assert (bvsle #x00000012 a_ack!1547))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000013 a_ack!1547))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1546))
...
(assert (bvsle #x00000014 a_ack!1547))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1546))
...
(assert (bvsle #x00000015 a_ack!1547))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
