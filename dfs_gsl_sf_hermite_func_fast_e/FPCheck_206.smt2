...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (bvslt a_ack!923 #x000003e8))
...
(assert (bvsle #x00000006 a_ack!923))
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!922)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!922))
...
(assert (bvsle #x00000007 a_ack!923))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!922))
...
(assert (bvsle #x00000008 a_ack!923))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!922))
...
(assert (bvsle #x00000009 a_ack!923))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!922))
...
(assert (bvsle #x0000000a a_ack!923))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!922))
