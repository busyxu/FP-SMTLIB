...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (bvslt a_ack!1303 #x000003e8))
...
(assert (not (= #x00000001 a_ack!1303)))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!1302)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x0000000b a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x0000000c a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x0000000d a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x0000000e a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x0000000f a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x00000010 a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(assert (bvsle #x00000011 a_ack!1303))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1302))
...
(let ((a!18 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3feeea3950a8511e)
                            a!16))))
  (FPCHECK_FMUL_UNDERFLOW #x3fef0b6848d2af1c a!18)))))))))))))))))))
