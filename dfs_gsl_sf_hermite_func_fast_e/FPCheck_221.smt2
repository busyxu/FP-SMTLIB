...
(assert (bvslt a_ack!989 #x000003e8))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x3fe279a74590331c))
       ((_ to_fp 11 53) b_ack!988)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!988))
...
(assert (bvsle #x0000000a a_ack!989))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!988))
...
(assert (bvsle #x0000000b a_ack!989))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!988))
...
(assert (bvsle #x0000000c a_ack!989))
(assert (FPCHECK_FMUL_OVERFLOW #x3fda20bd700c2c3e b_ack!988))
