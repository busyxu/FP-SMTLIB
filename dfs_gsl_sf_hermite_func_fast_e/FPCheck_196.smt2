...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (bvslt a_ack!875 #x000003e8))
(assert (not (bvslt a_ack!875 #x00000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!874) ((_ to_fp 11 53) #x0000000000000000))))
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) b_ack!874))
            a!11)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fee2b7dddfefa66) a!10)))))))))))))
