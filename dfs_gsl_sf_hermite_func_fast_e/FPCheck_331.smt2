...
(assert (bvslt a_ack!1499 #x000003e8))
...
(assert (bvsle #x0000000f a_ack!1499))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1498))
...
(assert (bvsle #x00000010 a_ack!1499))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1498))
...
(assert (bvsle #x00000011 a_ack!1499))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1498))
...
(assert (bvsle #x00000012 a_ack!1499))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
...
(assert (bvsle #x00000013 a_ack!1499))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1498))
...
(assert (bvsle #x00000014 a_ack!1499))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!1498))
...
(assert (bvsle #x00000015 a_ack!1499))
(assert (FPCHECK_FMUL_ACCURACY #x3fd3c03650e00e03 b_ack!1498))
