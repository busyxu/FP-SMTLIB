...
(declare-fun mu_ack!95 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!95) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) mu_ack!95) ((_ to_fp 11 53) #x4000000000000000))))
