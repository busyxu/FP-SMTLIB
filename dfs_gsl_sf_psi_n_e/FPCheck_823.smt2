...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2232) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2233)
...
(assert (not (fp.gt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) #x3ff0000000000000))
            ((_ to_fp 11 53) #x403b000000000000))))
(assert (FPCHECK_FADD_OVERFLOW #x4024000000000000 b_ack!2232))
