...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (= #x00000000 a_ack!1437))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1436) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1436) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1436) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!1436))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1436) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!19 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!18)))
  (FPCHECK_FADD_OVERFLOW (fp.abs a!19) (fp.abs a!16))))))))))))))))))))))
