...
(assert (not (= #x00000000 a_ack!4059)))
(assert (not (= #x00000001 a_ack!4059)))
(assert (not (bvslt a_ack!4059 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4058) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!4059)
...
(assert (FPCHECK_FADD_OVERFLOW #x4024000000000000 b_ack!4058))
