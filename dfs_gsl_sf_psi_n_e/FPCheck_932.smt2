...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2540) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2541)
               ((_ to_fp 11 53) #x3ff0000000000000))
       ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2540) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_pow (fp.add roundNearestTiesToEven
                           ...
                           a!1))))
  (fp.eq a!6 a!4)))))))
(assert (FPCHECK_FADD_ACCURACY #x4000000000000000 b_ack!2540))
