...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3038) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.gt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3039)
               ((_ to_fp 11 53) #x3ff0000000000000))
       ((_ to_fp 11 53) #x403b000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3038) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3039)
               ((_ to_fp 11 53) #x3ff0000000000000))
       ((_ to_fp 11 53) #x403b000000000000)))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (CF_pow (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) b_ack!3038))
                            a!1))))
  (FPCHECK_FDIV_ACCURACY a!3 (fp.add roundNearestTiesToEven a!15 a!3)))))))))))))))
