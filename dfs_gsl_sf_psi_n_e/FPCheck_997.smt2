...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2692) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2692) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (bvule a_ack!2693 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!2693)
                ((_ to_fp 11 53) #x3ff0000000000000))
