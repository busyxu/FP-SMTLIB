...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2372) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2373)
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2372) ((_ to_fp 11 53) #x3fd0000000000000)))
