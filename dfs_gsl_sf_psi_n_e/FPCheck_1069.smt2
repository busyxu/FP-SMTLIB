...
(assert (not (= #x00000000 a_ack!2881)))
(assert (not (= #x00000001 a_ack!2881)))
(assert (not (bvslt a_ack!2881 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2880) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2881)
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2880) ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (fp.gt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2881)
               ((_ to_fp 11 53) #x3ff0000000000000))
       ((_ to_fp 11 53) #x403b000000000000)))
