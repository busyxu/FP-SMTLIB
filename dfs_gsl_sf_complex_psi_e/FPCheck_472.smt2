...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1715) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1715)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1715))
...
(let ((a!13 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x7ff0000000000001))
    a!13)))))))))
