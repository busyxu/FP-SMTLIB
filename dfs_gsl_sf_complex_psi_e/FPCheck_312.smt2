...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1165) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1165)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1165))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!4 #x7ff0000000000001))))
