...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1397) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1397)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1397))
      ...
      (a!6 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!5))
                   a!5)))
  (FPCHECK_FSUB_ACCURACY (fp.mul roundNearestTiesToEven a!4 a!3) a!6)))))
