...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1943) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1943)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1943))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!1942))
                           ((_ to_fp 11 53) #x3fb893c438dd7d5a)))))
  (FPCHECK_FMUL_UNDERFLOW a!1 #x3fb893c438dd7d5a)))
