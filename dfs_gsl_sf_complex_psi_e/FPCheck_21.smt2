...
(assert (fp.lt ((_ to_fp 11 53) a_ack!57) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!56)) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW b_ack!56 #x3fa8d5ed070ef27d))
