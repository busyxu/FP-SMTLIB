...
(assert (fp.lt ((_ to_fp 11 53) a_ack!33) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!32)) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (let ((a!1 ((_ fp.to_sbv 32)
             ...
             (CF_ceil (fp.sub roundNearestTiesToEven
                              ((_ to_fp 11 53) #x40335d6b2ed19148)
                              ((_ to_fp 11 53) a_ack!33))))))
  (FPCHECK_FADD_OVERFLOW a_ack!33 ((_ to_fp 11 53) roundNearestTiesToEven a!1))))
