...
(assert (fp.lt ((_ to_fp 11 53) a_ack!61) ((_ to_fp 11 53) #x4034000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!60)) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (FPCHECK_FMUL_ACCURACY b_ack!60 #x3fa8d5ed070ef27d))
