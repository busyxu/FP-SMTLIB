...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2111) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2111)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2111))
      ...
      (a!7 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!6))
                   a!6)))
  (FPCHECK_FSUB_UNDERFLOW (fp.mul roundNearestTiesToEven a!5 a!4) a!7))))))
