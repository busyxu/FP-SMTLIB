...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2019) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!2019)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2019))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!3
                                   ((_ to_fp 11 53) #x3fb893c438dd7d5a))))))
  (FPCHECK_FMUL_OVERFLOW #xbff0cccccccccccd a!4)))))
