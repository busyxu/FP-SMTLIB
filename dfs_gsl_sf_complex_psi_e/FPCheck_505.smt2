...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1847) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1847)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1847))
...
(assert (let ((a!1 (fp.abs (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!1847))
                           ((_ to_fp 11 53) #x0000000000000000)))))
  (FPCHECK_FADD_ACCURACY (CF_log a!1) #x398838dd597ae7dc)))
