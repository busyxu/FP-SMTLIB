...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1911) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!1911)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!1911))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             ...
                             ((_ fp.to_sbv 32) roundTowardZero a!1)))
                   ((_ to_fp 11 53) #x3fb893c438dd7d5a))))
  (FPCHECK_FMUL_OVERFLOW a!2 #x3fb893c438dd7d5a))))
