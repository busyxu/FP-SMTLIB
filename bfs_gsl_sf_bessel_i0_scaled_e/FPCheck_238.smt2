...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!349))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!349))
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!27
                    ((_ to_fp 11 53) #x3d5b1cc4818bd483)))
    (fp.add roundNearestTiesToEven a!30 ((_ to_fp 11 53) #x3d69434256cbafff))))))))))))))))))))))
