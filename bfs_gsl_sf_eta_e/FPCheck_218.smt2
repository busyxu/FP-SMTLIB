...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x4059000000000000))))
...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!294) ((_ to_fp 11 53) #xc033000000000000)))
