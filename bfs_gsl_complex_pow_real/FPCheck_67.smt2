...
(declare-fun y1_ack!323 () (_ BitVec 64))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) x1_ack!325))
             (fp.abs ((_ to_fp 11 53) y1_ack!323)))))
(assert (not (fp.eq ((_ to_fp 11 53) x1_ack!325) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) y1_ack!323)))
                   ((_ to_fp 11 53) #x7ff0000000000001))))
  (FPCHECK_FMUL_UNDERFLOW
    (CF_exp (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) x_ack!324)))
    (CF_cos (fp.mul roundNearestTiesToEven
                    (CF_atan2 y1_ack!323 x1_ack!325)
