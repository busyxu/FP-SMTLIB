...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!291) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!291))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!291))
             ((_ to_fp 11 53) #x4014000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!291))
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY a!5 a!11))))))))
