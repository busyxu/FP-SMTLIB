...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!355) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!355))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!355))
             ((_ to_fp 11 53) #x4014000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!355))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
      ...
      (a!15 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.abs (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!6 a!12)
                                    (CF_exp a!13)))))
      (a!17 (fp.abs (CF_log (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!6 a!12)
                                    (CF_exp a!13))))))
(let ((a!16 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!16
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3cc0000000000000) a!17)))))))))))
