...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!342))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
      ...
      (a!15 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.abs (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!6 a!12)
                                    (CF_exp a!13))))))
  (FPCHECK_FADD_OVERFLOW a!14 a!15)))))))))
