...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!352) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!352))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!352))
             ((_ to_fp 11 53) #x4014000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!352))
            ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!352) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!352))
...
(let ((a!13 (fp.abs (CF_log (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!5 a!11)
                                    (CF_exp a!12))))))
  (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 a!13)))))))))
