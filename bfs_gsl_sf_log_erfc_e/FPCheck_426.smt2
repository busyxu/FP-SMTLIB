...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!650) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!650))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x8000000000000000)
                           ((_ to_fp 11 53) a_ack!650)))))
  (fp.eq a!1 ((_ to_fp 11 53) a_ack!650))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!650))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) a_ack!650)))
