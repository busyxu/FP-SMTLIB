...
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!122) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!120) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!121) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) nu2_ack!121) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (fp.geq ((_ to_fp 11 53) nu1_ack!120) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_ACCURACY nu1_ack!120 #x3ff0000000000000))
