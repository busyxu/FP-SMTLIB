...
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!761) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!761) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) nu1_ack!759) ((_ to_fp 11 53) nu2_ack!760))))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!759) ((_ to_fp 11 53) nu2_ack!760)))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu1_ack!759)
                    ((_ to_fp 11 53) nu2_ack!760))
            ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (FPCHECK_FADD_ACCURACY nu1_ack!759 nu2_ack!760))
