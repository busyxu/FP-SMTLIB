...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) nu2_ack!4510) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) nu2_ack!4510) ((_ to_fp 11 53) #x40f86a0000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) nu2_ack!4510)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) nu2_ack!4510))))
...
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!4509) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) nu2_ack!4510)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) nu2_ack!4510) ((_ to_fp 11 53) #x3fe0000000000000)))
