...
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!533) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) nu2_ack!532) ((_ to_fp 11 53) #x40f86a0000000000)))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!531) ((_ to_fp 11 53) #x4024000000000000)))
(assert (fp.lt ((_ to_fp 11 53) x_ack!533)
       (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) nu2_ack!532)
               (fp.add roundNearestTiesToEven
                       ((_ to_fp 11 53) nu1_ack!531)
                       ((_ to_fp 11 53) nu2_ack!532)))))
(assert (not (fp.leq ((_ to_fp 11 53) nu1_ack!531) ((_ to_fp 11 53) #x0000000000000000))))
