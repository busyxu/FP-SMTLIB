...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (= #x00000000 (bvsrem n_ack!550 #x00000002)))
...
(assert (not (= #x00000001 n_ack!550)))
(assert (not (= #x00000002 n_ack!550)))
(assert (not (= #x00000003 n_ack!550)))
(assert (bvslt n_ack!550 #x00000046))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvmul #x00000002 n_ack!550)))
