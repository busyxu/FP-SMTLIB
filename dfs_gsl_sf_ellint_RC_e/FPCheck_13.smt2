...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!97 #x00000007)))
       #x0000000000000011))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!98) ((_ to_fp 11 53) b_ack!96)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!98) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW b_ack!96 a!1)))
