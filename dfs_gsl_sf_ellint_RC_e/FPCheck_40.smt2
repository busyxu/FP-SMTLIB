...
(assert (fp.gt ((_ to_fp 11 53) a_ack!296) ((_ to_fp 11 53) b_ack!294)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!296) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!295 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!2
                                   ((_ to_fp 11 53) #x3fda2e8ba2e8ba2f))))))
  (FPCHECK_FADD_OVERFLOW #x3fc2492492492492 a!3)))))
