...
(assert (fp.gt ((_ to_fp 11 53) a_ack!290) ((_ to_fp 11 53) b_ack!288)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!290) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!289 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
