(declare-fun c_ack!88 () (_ BitVec 32))
(declare-fun a_ack!89 () (_ BitVec 64))
(declare-fun b_ack!87 () (_ BitVec 64))
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!88 #x00000007)))
       #x0000000000000011))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!89) ((_ to_fp 11 53) b_ack!87)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!89) ((_ to_fp 11 53) #x7fc9999999999999)))
