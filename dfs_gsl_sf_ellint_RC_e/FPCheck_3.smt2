...
(assert (fp.gt ((_ to_fp 11 53) a_ack!32) ((_ to_fp 11 53) b_ack!30)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!32) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (FPCHECK_FADD_OVERFLOW a_ack!32 b_ack!30))
