(declare-fun c_ack!481 () (_ BitVec 32))
(declare-fun a_ack!482 () (_ BitVec 64))
(declare-fun b_ack!480 () (_ BitVec 64))
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!481 #x00000007)))
       #x0000000000000011))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!482) ((_ to_fp 11 53) b_ack!480)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!482) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!481 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
