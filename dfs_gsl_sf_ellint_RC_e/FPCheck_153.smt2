...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1100) ((_ to_fp 11 53) b_ack!1098)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1100) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!1099 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   a!1))
                   ((_ to_fp 11 53) #x3fd0000000000000))))
  (FPCHECK_FADD_OVERFLOW #x8000000000000000 a!2))))
