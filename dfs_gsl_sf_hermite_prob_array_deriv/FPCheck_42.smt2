...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!240))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!240))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!239))
...
(assert (bvslt #x00000003 b_ack!239))
...
(assert (bvslt #x00000004 b_ack!239))
...
(assert (bvslt #x00000005 b_ack!239))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!240)
                           ((_ to_fp 11 53) c_ack!240))
