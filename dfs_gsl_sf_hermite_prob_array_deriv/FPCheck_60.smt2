...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!336))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!335))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!336))
...
(assert (bvslt #x00000005 b_ack!335))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!336)
                           ((_ to_fp 11 53) c_ack!336))
...
(assert (bvslt #x00000006 b_ack!335))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!336)
                           ((_ to_fp 11 53) c_ack!336))
...
(assert (bvslt #x00000007 b_ack!335))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!336)
                           ((_ to_fp 11 53) c_ack!336))
