...
(assert (not (= #x00000001 b_ack!416)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!417))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 b_ack!416))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!417))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) c_ack!417))))))
  (not a!1)))
(assert (bvslt #x00000002 b_ack!416))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) c_ack!417))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!417))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 b_ack!416))
...
(assert (bvslt #x00000004 b_ack!416))
...
(assert (bvslt #x00000005 b_ack!416))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!417)
                           ((_ to_fp 11 53) c_ack!417))
...
(assert (bvslt #x00000006 b_ack!416))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!417)
                           ((_ to_fp 11 53) c_ack!417))
...
(assert (bvslt #x00000007 b_ack!416))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!417)
                           ((_ to_fp 11 53) c_ack!417))
...
(assert (bvslt #x00000008 b_ack!416))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!417)
                           ((_ to_fp 11 53) c_ack!417))
