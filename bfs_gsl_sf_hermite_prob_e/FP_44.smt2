...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!505))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!506))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!505))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!506))
...
(assert (bvslt #x00000003 a_ack!506))
...
(assert (bvslt #x00000004 a_ack!506))
