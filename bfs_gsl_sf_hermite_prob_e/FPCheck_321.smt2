...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1157))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!1158))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1157))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!1157))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1157))
...
(let ((a!8 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x401c000000000000)
                           a!6))))
  (FPCHECK_FMUL_ACCURACY #x4022000000000000 a!8)))))))))
