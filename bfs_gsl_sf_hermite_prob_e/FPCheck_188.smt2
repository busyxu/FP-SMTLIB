...
(assert (bvslt #x00000001 a_ack!680))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!679))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!680))
...
(assert (bvslt #x00000003 a_ack!680))
...
(assert (bvslt #x00000004 a_ack!680))
...
(assert (bvslt #x00000005 a_ack!680))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!679)
                           ((_ to_fp 11 53) b_ack!679))
...
(assert (bvslt #x00000006 a_ack!680))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!679)
                           ((_ to_fp 11 53) b_ack!679))
...
(assert (bvslt #x00000007 a_ack!680))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!679)
                           ((_ to_fp 11 53) b_ack!679))
...
(let ((a!7 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4018000000000000)
                           a!5))))
  (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) b_ack!679)) a!7))))))))
