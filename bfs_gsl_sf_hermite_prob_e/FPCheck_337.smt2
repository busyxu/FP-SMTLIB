...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1223))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!1224))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1223))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!1223))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1223))
