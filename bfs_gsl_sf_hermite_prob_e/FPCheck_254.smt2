...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!913))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!914))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!913))
...
(assert (bvslt #x00000004 a_ack!914))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) b_ack!913))
                 a!4)))))))
(assert (bvslt #x00000005 a_ack!914))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!913)
                           ((_ to_fp 11 53) b_ack!913))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) b_ack!913))
                 a!5))))))))
(assert (bvslt #x00000006 a_ack!914))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!913)
                           ((_ to_fp 11 53) b_ack!913))
