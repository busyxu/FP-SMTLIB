...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1119))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!1120))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1119))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4018000000000000)
                 a!4)))))))))
(assert (bvslt #x00000007 a_ack!1120))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1119)
                           ((_ to_fp 11 53) b_ack!1119))
...
(assert (bvslt #x00000008 a_ack!1120))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1119)
                           ((_ to_fp 11 53) b_ack!1119))
...
(assert (bvslt #x00000009 a_ack!1120))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1119)
                           ((_ to_fp 11 53) b_ack!1119))
