...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1149))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!1150))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1149))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!1149))))))
  (not a!1)))
(assert (bvslt #x00000002 a_ack!1150))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!2
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 ((_ to_fp 11 53) b_ack!1149))))))
(assert (bvslt #x00000003 a_ack!1150))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!1149)
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (bvslt #x00000004 a_ack!1150))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) b_ack!1149))
                 a!4)))))))
(assert (bvslt #x00000005 a_ack!1150))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1149)
                           ((_ to_fp 11 53) b_ack!1149))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) b_ack!1149))
                 a!5))))))))
(assert (bvslt #x00000006 a_ack!1150))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1149)
                           ((_ to_fp 11 53) b_ack!1149))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4018000000000000)
                 a!4)))))))))
(assert (bvslt #x00000007 a_ack!1150))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1149)
                           ((_ to_fp 11 53) b_ack!1149))
...
(assert (bvslt #x00000008 a_ack!1150))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1149)
                           ((_ to_fp 11 53) b_ack!1149))
...
(assert (bvslt #x00000009 a_ack!1150))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1149)
                           ((_ to_fp 11 53) b_ack!1149))
