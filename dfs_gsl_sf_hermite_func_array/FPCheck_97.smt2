...
(assert (bvsle #x00000002 a_ack!372))
...
(assert (bvsle #x00000003 a_ack!372))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!371))
...
(assert (bvsle #x00000004 a_ack!372))
(assert (FPCHECK_FMUL_ACCURACY #x3fe6a09e667f3bcd b_ack!371))
