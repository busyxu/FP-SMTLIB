...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!206) ((_ to_fp 11 53) #x4041acdd632f662a))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!206) ((_ to_fp 11 53) #x4086232bdd7abcd2))))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) a_ack!206))
                   ((_ to_fp 11 53) a_ack!206))))
  (FPCHECK_FDIV_INVALID a!1 a_ack!206)))
