...
(assert (fp.gt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!575) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) b_ack!575))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) b_ack!575)))
...
(assert (FPCHECK_FSUB_OVERFLOW a_ack!576 #x3ff0000000000000))
