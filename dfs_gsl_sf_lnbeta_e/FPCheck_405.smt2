...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1377) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) b_ack!1377))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) b_ack!1377)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1378) ((_ to_fp 11 53) #x40c0000000000000)))
(assert (FPCHECK_FMUL_ACCURACY a_ack!1378 a_ack!1378))
