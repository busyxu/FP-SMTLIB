...
(assert (fp.gt ((_ to_fp 11 53) b_ack!3019) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!3020) ((_ to_fp 11 53) b_ack!3019)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3020) ((_ to_fp 11 53) b_ack!3019))))
