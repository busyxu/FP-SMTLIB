...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!892) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!892) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!891) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!892) ((_ to_fp 11 53) b_ack!891))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!892) ((_ to_fp 11 53) b_ack!891)))
