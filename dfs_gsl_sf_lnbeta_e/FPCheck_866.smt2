...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2868) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!2867) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2868) ((_ to_fp 11 53) b_ack!2867)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2868) ((_ to_fp 11 53) b_ack!2867))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (fp.geq ((_ to_fp 11 53) b_ack!2867) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!2867 #x3ff0000000000000))
