...
(assert (fp.gt ((_ to_fp 11 53) a_ack!166) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!165) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!166) ((_ to_fp 11 53) b_ack!165))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!166) ((_ to_fp 11 53) b_ack!165)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) b_ack!165))
       ((_ to_fp 11 53) a_ack!166)))
(assert (FPCHECK_FSUB_ACCURACY a_ack!166 #x3ff0000000000000))
