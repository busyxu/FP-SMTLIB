...
(assert (fp.gt ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!119) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) b_ack!119))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!120) ((_ to_fp 11 53) b_ack!119))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!119)
                    ((_ to_fp 11 53) b_ack!119))
            ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (FPCHECK_FADD_OVERFLOW a_ack!120 b_ack!119))
