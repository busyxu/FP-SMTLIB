...
(assert (fp.gt ((_ to_fp 11 53) a_ack!578) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!577) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!578) ((_ to_fp 11 53) b_ack!577))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!578) ((_ to_fp 11 53) b_ack!577)))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!578 #x3ff0000000000000))
