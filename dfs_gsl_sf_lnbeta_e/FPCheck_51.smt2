...
(assert (fp.gt ((_ to_fp 11 53) b_ack!137) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!138) ((_ to_fp 11 53) b_ack!137))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!138) ((_ to_fp 11 53) b_ack!137)))
(assert (FPCHECK_FDIV_ACCURACY a_ack!138 b_ack!137))
