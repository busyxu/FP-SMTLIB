...
(assert (fp.gt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!179) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) b_ack!179))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) b_ack!179)))
...
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
       ...
       ((_ to_fp 11 53) #x3f847ae147ae147b)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!180 #x4000000000000000))
