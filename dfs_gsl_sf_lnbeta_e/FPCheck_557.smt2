...
(assert (fp.gt ((_ to_fp 11 53) b_ack!1809) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1810) ((_ to_fp 11 53) b_ack!1809))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1810) ((_ to_fp 11 53) b_ack!1809)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1810) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!1810 #x3ff0000000000000))
