...
(assert (fp.gt ((_ to_fp 11 53) b_ack!755) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!756) ((_ to_fp 11 53) b_ack!755))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!756) ((_ to_fp 11 53) b_ack!755)))
