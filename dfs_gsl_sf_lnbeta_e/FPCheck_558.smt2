...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1812) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1811) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1812) ((_ to_fp 11 53) b_ack!1811))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1812) ((_ to_fp 11 53) b_ack!1811)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1812) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_ACCURACY a_ack!1812 #x3ff0000000000000))
