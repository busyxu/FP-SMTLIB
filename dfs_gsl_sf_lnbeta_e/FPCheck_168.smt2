...
(assert (fp.gt ((_ to_fp 11 53) b_ack!543) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!544) ((_ to_fp 11 53) b_ack!543))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!544) ((_ to_fp 11 53) b_ack!543)))
