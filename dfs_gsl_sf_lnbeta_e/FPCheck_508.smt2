...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1688) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1687) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1688) ((_ to_fp 11 53) b_ack!1687))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1688) ((_ to_fp 11 53) b_ack!1687)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1688) ((_ to_fp 11 53) #x4000000000000000)))
