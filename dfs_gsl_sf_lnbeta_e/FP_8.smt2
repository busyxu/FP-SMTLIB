...
(assert (fp.gt ((_ to_fp 11 53) a_ack!98) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!97) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!98) ((_ to_fp 11 53) #xc3045f306dc9c883))))
