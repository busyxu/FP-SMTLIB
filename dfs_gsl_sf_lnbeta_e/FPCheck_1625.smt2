...
(assert (fp.gt ((_ to_fp 11 53) a_ack!5256) ((_ to_fp 11 53) b_ack!5255)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!5256) ((_ to_fp 11 53) b_ack!5255))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!5256) ((_ to_fp 11 53) #x4000000000000000)))
