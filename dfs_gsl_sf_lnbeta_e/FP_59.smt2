...
(assert (fp.gt ((_ to_fp 11 53) b_ack!757) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!758) ((_ to_fp 11 53) b_ack!757))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!758) ((_ to_fp 11 53) b_ack!757)))
