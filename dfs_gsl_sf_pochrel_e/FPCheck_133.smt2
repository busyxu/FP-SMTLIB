...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!444))
  ...
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!445))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!445))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!444)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!445))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!445))))))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fd0000000000000
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) b_ack!444) (CF_log a!2))))))
