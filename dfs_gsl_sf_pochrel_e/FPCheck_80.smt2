...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!248))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!249))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!248)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!249))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!249))))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!249))
                           ((_ to_fp 11 53) b_ack!248)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!248))))
