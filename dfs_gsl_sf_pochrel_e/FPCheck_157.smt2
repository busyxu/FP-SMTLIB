...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!530))
  ...
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!531))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!531))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!530)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!531))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!531))))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!530)
                                   ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW #x40325e4f7b2737fa (CF_log a!1))))
