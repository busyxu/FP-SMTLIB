...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!410))
  ...
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!411))
       ((_ to_fp 11 53) #x4000000000000000)))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!410)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!410))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!411))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!410)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!411))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!411))))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!411))
                           ((_ to_fp 11 53) b_ack!410)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!410))))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fe0000000000000
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) b_ack!410) (CF_log a!2))))))
