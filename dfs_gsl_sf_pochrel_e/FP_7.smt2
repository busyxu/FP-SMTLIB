...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!170)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!170))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!171))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!170)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!171))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!171))))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!171))))))
  (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!170))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!170))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!171))))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) b_ack!170)
                                   ((_ to_fp 11 53) #x3ff0000000000000))))))
  (not (fp.lt a!3 ((_ to_fp 11 53) #x5fba20bd700c2c3d)))))))
