...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!698))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!699))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!698)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!699))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!699))))))
