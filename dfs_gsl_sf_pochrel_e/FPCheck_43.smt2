...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!130))
  ...
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!131))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!131))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!130)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!131))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!131))))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!131))))))
  (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!130))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!130))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!131))))))
