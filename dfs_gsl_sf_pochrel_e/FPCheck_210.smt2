...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!704))
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fb999999999999a)
                          (fp.abs ((_ to_fp 11 53) a_ack!705))))))
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!705))
       ((_ to_fp 11 53) #x4000000000000000)))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!704)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!704))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!705))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!704)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!705))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!705))))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!705))))))
  (fp.eq a!2 (fp.abs ((_ to_fp 11 53) b_ack!704))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!704))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!705))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x3fb999999999999a)))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!704) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!705) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!705) ((_ to_fp 11 53) #x4024000000000000))))
...
(let ((a!3 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!3
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!704)
                 (CF_log a!1)))))))
(assert (FPCHECK_FSUB_UNDERFLOW b_ack!704 #x3ff0000000000000))
