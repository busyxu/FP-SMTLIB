...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!382))
  ...
  (not a!1)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!383))
       ((_ to_fp 11 53) #x4000000000000000)))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!382)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!382))
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!383))))))
  (fp.eq (fp.div roundNearestTiesToEven
                 a!1
                 (fp.abs ((_ to_fp 11 53) b_ack!382)))
         (CF_log (fp.abs ((_ to_fp 11 53) a_ack!383))))))
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) a_ack!383))))))
