...
(assert (not (fp.eq ((_ to_fp 11 53) d_ack!116) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!116) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) a_ack!117)
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!115))
...
(assert (let ((a!1 (fp.leq (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.eq ((_ to_fp 11 53) d_ack!116) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!116) ((_ to_fp 11 53) #x3ff3333333333333))))
