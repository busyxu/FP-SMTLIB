...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3217) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!3219 #x00000000)))
(assert (not (= #x00000000 a_ack!3219)))
(assert (not (= #x00000001 a_ack!3219)))
(assert (not (= #x00000002 a_ack!3219)))
(assert (not (= #x00000003 a_ack!3219)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3217) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3218) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3218) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3217) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3217) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!53 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!49
                                    ((_ to_fp 11 53) #x4032000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!53 #x4034000000000000))))))))))))))))))))
