...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3793) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!3795)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3793) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3794) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3794) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3793) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3793) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!65 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!61
                                    ((_ to_fp 11 53) #x4036000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!65 #x4038000000000000))))))))))))))))))))))))
