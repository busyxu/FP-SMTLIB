...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2640)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2639) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2639) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2638) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!41 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!37
                                    ((_ to_fp 11 53) #x402c000000000000))))))
  (FPCHECK_FDIV_OVERFLOW a!41 #x4030000000000000))))))))))))))))
