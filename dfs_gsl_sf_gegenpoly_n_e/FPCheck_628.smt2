...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2899) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2900) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2900) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2899) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2899) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x0000000b a_ack!2901))
(assert (bvsle #x0000000c a_ack!2901))
(assert (bvsle #x0000000d a_ack!2901))
(assert (bvsle #x0000000e a_ack!2901))
(assert (bvsle #x0000000f a_ack!2901))
(assert (bvsle #x00000010 a_ack!2901))
(assert (bvsle #x00000011 a_ack!2901))
(assert (bvsle #x00000012 a_ack!2901))
