...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2635) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2637)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2635) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2636) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2636) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2635) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2635) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!39 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!2636))
            (fp.div roundNearestTiesToEven
                    a!39
                    ((_ to_fp 11 53) #x402e000000000000)))
    (fp.mul roundNearestTiesToEven
