...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1831) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1833 #x00000000)))
(assert (not (= #x00000000 a_ack!1833)))
(assert (not (= #x00000001 a_ack!1833)))
(assert (not (= #x00000002 a_ack!1833)))
(assert (not (= #x00000003 a_ack!1833)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1831) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!1832) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1832) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1831) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1831) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!24 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1832))
