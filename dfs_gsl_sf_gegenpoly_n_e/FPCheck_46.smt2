...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!261) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (= #x00000003 a_ack!262))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!261) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 b_ack!261))
