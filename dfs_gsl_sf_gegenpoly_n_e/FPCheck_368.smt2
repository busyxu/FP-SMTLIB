...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1765) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1767 #x00000000)))
(assert (not (= #x00000000 a_ack!1767)))
(assert (not (= #x00000001 a_ack!1767)))
(assert (not (= #x00000002 a_ack!1767)))
(assert (not (= #x00000003 a_ack!1767)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1765) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!1766) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1766) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1765) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1765) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000004 a_ack!1767))
(assert (bvsle #x00000005 a_ack!1767))
(assert (bvsle #x00000006 a_ack!1767))
(assert (bvsle #x00000007 a_ack!1767))
(assert (bvsle #x00000008 a_ack!1767))
(assert (bvsle #x00000009 a_ack!1767))
(assert (bvsle #x0000000a a_ack!1767))
...
(let ((a!21 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1766))
            (fp.div roundNearestTiesToEven
                    a!21
                    ((_ to_fp 11 53) #x4022000000000000)))
    (fp.mul roundNearestTiesToEven
