...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2203) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!2205)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2203) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2204) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2204) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2203) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2203) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000004 a_ack!2205))
(assert (bvsle #x00000005 a_ack!2205))
(assert (bvsle #x00000006 a_ack!2205))
(assert (bvsle #x00000007 a_ack!2205))
(assert (bvsle #x00000008 a_ack!2205))
(assert (bvsle #x00000009 a_ack!2205))
(assert (bvsle #x0000000a a_ack!2205))
(assert (bvsle #x0000000b a_ack!2205))
(assert (bvsle #x0000000c a_ack!2205))
(assert (bvsle #x0000000d a_ack!2205))
...
(let ((a!32 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!28
                                    ((_ to_fp 11 53) #x4026000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!32 #x402a000000000000)))))))))))))
