...
(assert (not (= #x00000003 a_ack!2355)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2353) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2354) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2354) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2353) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2353) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!35 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!31
                                    ((_ to_fp 11 53) #x4028000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!35 #x402c000000000000))))))))))))))
