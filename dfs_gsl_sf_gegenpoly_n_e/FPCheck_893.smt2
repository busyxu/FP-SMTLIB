...
(assert (fp.eq ((_ to_fp 11 53) b_ack!4057) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!4058) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4058) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!4057) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!4057) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000013 a_ack!4059))
(assert (bvsle #x00000014 a_ack!4059))
(assert (bvsle #x00000015 a_ack!4059))
(assert (bvsle #x00000016 a_ack!4059))
(assert (bvsle #x00000017 a_ack!4059))
(assert (bvsle #x00000018 a_ack!4059))
(assert (bvsle #x00000019 a_ack!4059))
(assert (bvsle #x0000001a a_ack!4059))
