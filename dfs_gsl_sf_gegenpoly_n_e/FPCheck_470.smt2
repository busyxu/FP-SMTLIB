...
(assert (not (= #x00000003 a_ack!2211)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2209) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2210) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2210) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2209) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2209) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!32 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!28
                                    ((_ to_fp 11 53) #x4026000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!32 #x402a000000000000)))))))))))))
