...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!158) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!160 #x00000000)))
(assert (not (= #x00000000 a_ack!160)))
(assert (not (= #x00000001 a_ack!160)))
(assert (= #x00000002 a_ack!160))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    #xbff0000000000000
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!159)))))
