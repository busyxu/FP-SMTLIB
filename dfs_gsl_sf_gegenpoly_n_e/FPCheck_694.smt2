...
(declare-fun c_ack!3188 () (_ BitVec 64))
...
(assert (fp.geq ((_ to_fp 11 53) c_ack!3188) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3188) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x0000000d a_ack!3189))
(assert (bvsle #x0000000e a_ack!3189))
(assert (bvsle #x0000000f a_ack!3189))
(assert (bvsle #x00000010 a_ack!3189))
(assert (bvsle #x00000011 a_ack!3189))
(assert (bvsle #x00000012 a_ack!3189))
(assert (bvsle #x00000013 a_ack!3189))
(assert (bvsle #x00000014 a_ack!3189))
