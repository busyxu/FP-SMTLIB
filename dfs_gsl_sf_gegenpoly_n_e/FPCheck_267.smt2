...
(assert (fp.eq ((_ to_fp 11 53) b_ack!1321) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!1322) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1322) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1321) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1321) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1322))
            (fp.div roundNearestTiesToEven
                    a!12
                    ((_ to_fp 11 53) #x4018000000000000)))
    (fp.mul roundNearestTiesToEven
