...
(assert (fp.eq ((_ to_fp 11 53) b_ack!3625) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3626) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3626) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3625) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3625) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000010 a_ack!3627))
(assert (bvsle #x00000011 a_ack!3627))
(assert (bvsle #x00000012 a_ack!3627))
(assert (bvsle #x00000013 a_ack!3627))
(assert (bvsle #x00000014 a_ack!3627))
(assert (bvsle #x00000015 a_ack!3627))
(assert (bvsle #x00000016 a_ack!3627))
(assert (bvsle #x00000017 a_ack!3627))
