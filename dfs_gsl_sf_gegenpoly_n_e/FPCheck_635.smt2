...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2935) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2936) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2936) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2935) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2935) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!47 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!43
                                    ((_ to_fp 11 53) #x4030000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!47 #x4032000000000000))))))))))))))))))
