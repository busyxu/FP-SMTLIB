...
(assert (not (= #x00000002 a_ack!2784)))
(assert (not (= #x00000003 a_ack!2784)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2782) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2783) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2783) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2782) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2782) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!44 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!40
                                    ((_ to_fp 11 53) #x402e000000000000))))))
  (FPCHECK_FDIV_OVERFLOW a!44 #x4031000000000000)))))))))))))))))
