...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3931) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (fp.eq ((_ to_fp 11 53) b_ack!3931) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3932) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3932) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3931) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3931) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000012 a_ack!3933))
(assert (bvsle #x00000013 a_ack!3933))
(assert (bvsle #x00000014 a_ack!3933))
(assert (bvsle #x00000015 a_ack!3933))
(assert (bvsle #x00000016 a_ack!3933))
(assert (bvsle #x00000017 a_ack!3933))
(assert (bvsle #x00000018 a_ack!3933))
(assert (bvsle #x00000019 a_ack!3933))
...
(let ((a!66 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3932))
            (fp.div roundNearestTiesToEven
                    a!66
                    ((_ to_fp 11 53) #x4038000000000000)))
    (fp.mul roundNearestTiesToEven
