...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3631) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!3633)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3631) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3632) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3632) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3631) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3631) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!60 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3632))
            (fp.div roundNearestTiesToEven
                    a!60
                    ((_ to_fp 11 53) #x4036000000000000)))
    (fp.mul roundNearestTiesToEven
