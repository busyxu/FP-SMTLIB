...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2752) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2752) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!2753) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2753) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2752) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2752) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x0000000a a_ack!2754))
(assert (bvsle #x0000000b a_ack!2754))
(assert (bvsle #x0000000c a_ack!2754))
(assert (bvsle #x0000000d a_ack!2754))
(assert (bvsle #x0000000e a_ack!2754))
(assert (bvsle #x0000000f a_ack!2754))
(assert (bvsle #x00000010 a_ack!2754))
(assert (bvsle #x00000011 a_ack!2754))
