...
(assert (not (= #x00000003 a_ack!594)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!592) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!593) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!593) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!592) ((_ to_fp 11 53) #x0000000000000000)))
