...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3223) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (not (= #x00000003 a_ack!3225)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3223) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!3224) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3224) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3223) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3223) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!53 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!49
                                    ((_ to_fp 11 53) #x4032000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!53 #x4034000000000000))))))))))))))))))))
