(declare-fun y1_ack!2633 () (_ BitVec 64))
(declare-fun h_ack!2634 () (_ BitVec 64))
(declare-fun y0_ack!2632 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2634)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2633))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2632)
                                   ((_ to_fp 11 53) y0_ack!2632))
...
(let ((a!37 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.abs a!32))
                            a!36))))
  (FPCHECK_FADD_ACCURACY a!37 #x3e45798ee2308c3a)))))))))))))))))))))
