(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(declare-fun y0_ack!1823 () (_ BitVec 64))
(declare-fun y1_ack!1824 () (_ BitVec 64))
(declare-fun h_ack!1825 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!1825)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1824))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1823)
                                   ((_ to_fp 11 53) y0_ack!1823))
...
(let ((a!22 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!1 a!18))
                            a!21))))
  (FPCHECK_FADD_ACCURACY a!19 a!22))))))))))))
