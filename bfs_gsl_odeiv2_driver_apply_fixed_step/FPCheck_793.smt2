(declare-fun y1_ack!3340 () (_ BitVec 64))
(declare-fun h_ack!3341 () (_ BitVec 64))
(declare-fun y0_ack!3339 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3340))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3339)
                                   ((_ to_fp 11 53) y0_ack!3339))
...
(let ((a!48 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!47
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (fp.gt a!48 ((_ to_fp 11 53) #x3ff199999999999a)))))))))))))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!3341)
                           ((_ to_fp 11 53) #x4000000000000000))
...
(let ((a!48 (fp.div roundNearestTiesToEven
  ...
  (fp.lt (fp.div roundNearestTiesToEven
                 ...
                 (CF_pow a!48 #x3fd0000000000000))
         ((_ to_fp 11 53) #x3fc999999999999a)))))))))))))))))))))
(assert (FPCHECK_FMUL_ACCURACY #x3fc999999999999a h_ack!3341))
