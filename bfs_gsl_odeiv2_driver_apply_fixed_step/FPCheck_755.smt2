(declare-fun y1_ack!3032 () (_ BitVec 64))
(declare-fun h_ack!3033 () (_ BitVec 64))
(declare-fun y0_ack!3031 () (_ BitVec 64))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             (_ FloatingPoint 11 53))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!3033)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3032))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3031)
                                   ((_ to_fp 11 53) y0_ack!3031))
...
(let ((a!53 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!52
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (fp.gt a!53 ((_ to_fp 11 53) #x3ff199999999999a)))))))))))))))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!3033)
                           ((_ to_fp 11 53) #x4000000000000000))
...
(let ((a!53 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!52
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (fp.eq (CF_pow a!53 #x3fd0000000000000) ((_ to_fp 11 53) #x0000000000000000)))))))))))))))))))))))
