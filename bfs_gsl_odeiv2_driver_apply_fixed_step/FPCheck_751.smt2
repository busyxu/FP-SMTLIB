(declare-fun y1_ack!3008 () (_ BitVec 64))
(declare-fun h_ack!3009 () (_ BitVec 64))
(declare-fun y0_ack!3007 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_POW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!3009)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3008))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3007)
                                   ((_ to_fp 11 53) y0_ack!3007))
...
(let ((a!53 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!52
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (FPCHECK_FINVALID_POW a!53 a!53))))))))))))))))))))))
