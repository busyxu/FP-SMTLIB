...
(declare-fun y1_ack!2519 () (_ BitVec 64))
(declare-fun h_ack!2520 () (_ BitVec 64))
(declare-fun y0_ack!2518 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2520)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2519))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2518)
                                   ((_ to_fp 11 53) y0_ack!2518))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.abs a!34))))))
  (FPCHECK_FADD_OVERFLOW a!35 #x3e45798ee2308c3a)))))))))))))))))))
