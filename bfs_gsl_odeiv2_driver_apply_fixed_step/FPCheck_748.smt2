(declare-fun y1_ack!2984 () (_ BitVec 64))
(declare-fun h_ack!2985 () (_ BitVec 64))
(declare-fun y0_ack!2983 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2984))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2983)
                                   ((_ to_fp 11 53) y0_ack!2983))
...
(let ((a!48 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!47
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (not (fp.gt a!48 ((_ to_fp 11 53) #x3ff199999999999a))))))))))))))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2985)
                           ((_ to_fp 11 53) #x4000000000000000))
...
(let ((a!48 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!47
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (fp.lt a!48 ((_ to_fp 11 53) #x3fe0000000000000)))))))))))))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2985)
                           ((_ to_fp 11 53) #x4000000000000000))
...
(let ((a!48 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!47
                                    ((_ to_fp 11 53) #x3e45798ee2308c3a))))))
  (FPCHECK_FDIV_UNDERFLOW #x3feccccccccccccd (CF_pow a!48 #x3fc999999999999a)))))))))))))))))))))
