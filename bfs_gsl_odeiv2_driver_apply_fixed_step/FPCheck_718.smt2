(declare-fun y1_ack!2768 () (_ BitVec 64))
(declare-fun h_ack!2769 () (_ BitVec 64))
(declare-fun y0_ack!2767 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2769)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2768))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2767)
                                   ((_ to_fp 11 53) y0_ack!2767))
...
(let ((a!37 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.abs a!32))
                            a!36))))
  (FPCHECK_FADD_OVERFLOW a!37 #x3e45798ee2308c3a)))))))))))))))))))))
