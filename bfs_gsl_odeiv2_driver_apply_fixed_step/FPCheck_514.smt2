(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(declare-fun y1_ack!1866 () (_ BitVec 64))
(declare-fun h_ack!1867 () (_ BitVec 64))
(declare-fun y0_ack!1865 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!1867)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1866))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1865)
                                   ((_ to_fp 11 53) y0_ack!1865))
...
(let ((a!23 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW a!1 a!23)))))))))))))
