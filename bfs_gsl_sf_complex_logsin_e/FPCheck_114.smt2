...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!176) ((_ to_fp 11 53) #x404e000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!176) ((_ to_fp 11 53) #xc04e000000000000))))
...
(let ((a!8 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (CF_cos a_ack!177)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) b_ack!176) a!8)))))))))))
