...
(assert (not (fp.gt ((_ to_fp 11 53) w0_ack!566) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) w1_ack!563) ((_ to_fp 11 53) #x0000000000000000)))
