...
(assert (fp.gt ((_ to_fp 11 53) w1_ack!2241) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!14 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) w0_ack!2244) a!14)
    a!14))))))))))
