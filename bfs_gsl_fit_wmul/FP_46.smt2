...
(assert (fp.gt ((_ to_fp 11 53) w1_ack!2173) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!8 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           a!7))))
  (fp.eq a!8 a!1)))))))))
(assert (not (fp.gt ((_ to_fp 11 53) w0_ack!2176) ((_ to_fp 11 53) #x0000000000000000))))
