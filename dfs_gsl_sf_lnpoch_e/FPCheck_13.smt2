...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!38))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fb999999999999a)
               ((_ to_fp 11 53) a_ack!39))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!39) ((_ to_fp 11 53) #x4065600000000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!39 #x3ff0000000000000))
