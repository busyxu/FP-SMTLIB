...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!492))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fb999999999999a)
               ((_ to_fp 11 53) a_ack!493))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!493) ((_ to_fp 11 53) #x4065600000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!493) ((_ to_fp 11 53) #x4014000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!493) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!493) ((_ to_fp 11 53) #x4065600000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven a!2 a!1)
         (CF_pow a_ack!493
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3fe0000000000000)
                         ((_ to_fp 11 53) a_ack!493)))))))
(assert (let ((a!1 (fp.abs (CF_pow a_ack!493
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   ((_ to_fp 11 53) a_ack!493))))))
