...
(declare-fun epsrel_ack!394 () (_ BitVec 64))
...
(declare-fun FPCHECK_FINVALID_SQRT
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!393)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!394)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!393) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!394)
