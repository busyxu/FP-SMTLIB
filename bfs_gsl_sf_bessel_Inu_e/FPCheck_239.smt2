...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!776) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!776) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!776) ((_ to_fp 11 53) #x41dfffffff800000)))
