...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2340) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2340) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2340) ((_ to_fp 11 53) #x41dfffffff800000)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 (fp.abs a!5))
         ((_ to_fp 11 53) #x3cc0000000000000)))))))
(assert (FPCHECK_FMUL_OVERFLOW b_ack!2339 #x3cb0000000000000))
