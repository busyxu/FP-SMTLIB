...
(assert (fp.eq ((_ to_fp 11 53) a_ack!600) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fd0000000000000)
                           ((_ to_fp 11 53) b_ack!599)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!599))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!599))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (FPCHECK_FADD_ACCURACY a_ack!600 #x4000000000000000))
