...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(let ((a!2 (fp.lt (fp.div roundNearestTiesToEven
  ...
  (not a!2))))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!890))
                  (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53)
                                    roundNearestTiesToEven
                                    a_ack!892))
                          ((_ to_fp 11 53) roundNearestTiesToEven a_ack!892)))))
  (not a!1)))
(assert (fp.eq (CF_tanh c_ack!891) ((_ to_fp 11 53) #x0000000000000000)))
