...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!964 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (= #x00000000 a_ack!964))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!963) ((_ to_fp 11 53) #x0000000000000000))))
