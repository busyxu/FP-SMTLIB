...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (= #x00000001 a_ack!301))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq ((_ to_fp 11 53) c_ack!300) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FDIV_OVERFLOW #x3ff0000000000000 (CF_tanh c_ack!300)))
