...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!369) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!369) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!369) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!369) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!369) ((_ to_fp 11 53) #x3fd0000000000000)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.div roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!2 ((_ to_fp 11 53) a_ack!369))
