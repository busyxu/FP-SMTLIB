...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) b_ack!2460) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2461) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4096b00000000000)))))
  (FPCHECK_FMUL_UNDERFLOW #x3d29000000000000 (fp.abs a!10))))))))))
