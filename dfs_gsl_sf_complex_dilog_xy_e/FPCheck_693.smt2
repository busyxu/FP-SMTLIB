...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) b_ack!2660) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2661) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2661) ((_ to_fp 11 53) #x0000000000000000))))
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.div roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven a!9 a!1)
                    a!1)
            ((_ to_fp 11 53) #x409d400000000000)))))))))))
