...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1545) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1545) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!4
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 (fp.abs a!2))))))))
(assert (FPCHECK_FMUL_UNDERFLOW a_ack!1545 a_ack!1545))
