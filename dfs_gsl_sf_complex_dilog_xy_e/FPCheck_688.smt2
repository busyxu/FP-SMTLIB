...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) b_ack!2624) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2625) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2625) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.abs (fp.div roundNearestTiesToEven a!11 a!1))))))
  (fp.eq (fp.sub roundNearestTiesToEven
                 a!12
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3d29000000000000)
...
(let ((a!10 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ff0000000000000)
                    (fp.div roundNearestTiesToEven a!11 a!1))))))))))))
