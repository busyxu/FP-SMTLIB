...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2640) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2641) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2641) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!11 (fp.abs (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4096b00000000000))
                            a!10))))
  (not (fp.lt a!11 ((_ to_fp 11 53) #x3ca0000000000000))))))))))))
