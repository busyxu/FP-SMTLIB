...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) b_ack!2950) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2951) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2951) ((_ to_fp 11 53) #x0000000000000000))))
