...
(assert (fp.eq ((_ to_fp 11 53) b_ack!2412) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2413) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2413) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY
    (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven a!3 a!1) a!1)
    #x4096b00000000000)))))
