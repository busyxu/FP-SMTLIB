...
(declare-fun FPCHECK_FDIV_ACCURACY
             ...
             Bool)
(assert (fp.eq ((_ to_fp 11 53) b_ack!2366) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2367) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY a!4 (fp.add roundNearestTiesToEven a!9 a!4)))))))))
