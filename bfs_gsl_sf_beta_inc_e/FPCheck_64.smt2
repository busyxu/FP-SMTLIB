...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!303) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!303) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!302) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_ACCURACY a_ack!304 #x3ff0000000000000))
