...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!279) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!279) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!280 #x4000000000000000))
