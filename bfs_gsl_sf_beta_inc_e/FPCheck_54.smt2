...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!270) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!270) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!271 #x3ff0000000000000))
