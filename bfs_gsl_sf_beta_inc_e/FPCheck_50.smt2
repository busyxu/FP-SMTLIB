...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!258) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!258) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!259 b_ack!257))
