...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!237) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!237) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!238 #x3ff0000000000000))
