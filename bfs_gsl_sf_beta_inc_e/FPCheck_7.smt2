...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!41) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!40) (CF_floor b_ack!40))
                  #x00000001
                  #x00000000))))
  (not (not (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!42 b_ack!40))
