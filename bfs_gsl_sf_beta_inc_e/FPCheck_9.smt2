...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!56) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!56) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!55) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!57) ((_ to_fp 11 53) b_ack!55)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!57) ((_ to_fp 11 53) b_ack!55))))
(assert (FPCHECK_FDIV_OVERFLOW b_ack!55 a_ack!57))
