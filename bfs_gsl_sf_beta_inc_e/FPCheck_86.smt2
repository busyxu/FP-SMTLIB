...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) a_ack!409) (CF_floor a_ack!409))
                  #x00000001
                  #x00000000))))
...
(assert (fp.leq ((_ to_fp 11 53) a_ack!409) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!409 #x3fe0000000000000))
