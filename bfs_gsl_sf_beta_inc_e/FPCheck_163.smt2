...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!729) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!729) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!730) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!728) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!729) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) c_ack!729))))
