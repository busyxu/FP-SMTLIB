...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!23) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!23) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!24 b_ack!22))
