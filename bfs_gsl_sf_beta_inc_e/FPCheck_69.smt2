...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!327) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!327) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!326) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!328) ((_ to_fp 11 53) b_ack!326))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!328) ((_ to_fp 11 53) b_ack!326)))
(assert (FPCHECK_FDIV_ZERO a_ack!328 b_ack!326))
