...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!933) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!934) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) a_ack!934) (CF_floor a_ack!934))
                  #x00000001
                  #x00000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!933) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!934) ((_ to_fp 11 53) #x0000000000000000)))
