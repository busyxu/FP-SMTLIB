...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!669) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!669) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!670) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!668) ((_ to_fp 11 53) #x0000000000000000)))
