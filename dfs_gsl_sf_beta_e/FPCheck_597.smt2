...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2078) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!2078) (CF_floor b_ack!2078))
                  #x00000001
                  #x00000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2079) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!2079))
       ((_ to_fp 11 53) #x3f947ae147ae147b)))
(assert (FPCHECK_FADD_UNDERFLOW #x3ff0000000000000 a_ack!2079))
