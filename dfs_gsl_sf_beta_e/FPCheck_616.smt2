...
(declare-fun FPCHECK_FDIV_ZERO
             ...
             Bool)
(assert (fp.gt ((_ to_fp 11 53) a_ack!2135) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2134) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!2134) (CF_floor b_ack!2134))
                  #x00000001
                  #x00000000))))
