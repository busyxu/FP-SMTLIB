...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!778) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!778) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) a_ack!778) (CF_floor a_ack!778))
                  #x00000001
                  #x00000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!778) ((_ to_fp 11 53) #xc3045f306dc9c883)))
