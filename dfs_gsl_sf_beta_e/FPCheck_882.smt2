...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (fp.gt ((_ to_fp 11 53) a_ack!2925) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2924) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!2924) (CF_floor b_ack!2924))
                  #x00000001
                  #x00000000))))
