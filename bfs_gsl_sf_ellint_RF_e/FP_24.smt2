...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!507))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!509) ((_ to_fp 11 53) b_ack!506))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!506) ((_ to_fp 11 53) c_ack!507))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!507) ((_ to_fp 11 53) #x7fc9999999999999)))
