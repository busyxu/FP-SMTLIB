...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!168 #x00000007)))
       #x0000000000000011))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!167))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!169) ((_ to_fp 11 53) b_ack!166)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!169) ((_ to_fp 11 53) c_ack!167)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!169) ((_ to_fp 11 53) #x7fc9999999999999)))
