(declare-fun d_ack!1216 () (_ BitVec 32))
(declare-fun a_ack!1217 () (_ BitVec 64))
(declare-fun b_ack!1214 () (_ BitVec 64))
(declare-fun c_ack!1215 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun const_arr10 () (Array (_ BitVec 32) (_ BitVec 8)))
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!1216 #x00000007)))
       #x0000000000000011))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1217) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1214) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1215) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) a_ack!1217)
                    ((_ to_fp 11 53) c_ack!1215))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!1214)
                    ((_ to_fp 11 53) c_ack!1215))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1217) ((_ to_fp 11 53) b_ack!1214))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1214) ((_ to_fp 11 53) c_ack!1215))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1215) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x4008000000000000)))
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand d_ack!1216 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
