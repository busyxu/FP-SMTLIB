...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!195))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!197) ((_ to_fp 11 53) b_ack!194)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!197) ((_ to_fp 11 53) c_ack!195)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!197) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW a!1 a_ack!197)))
