...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!647))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!649) ((_ to_fp 11 53) b_ack!646))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!646) ((_ to_fp 11 53) c_ack!647))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!647) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY a!1 c_ack!647)))
