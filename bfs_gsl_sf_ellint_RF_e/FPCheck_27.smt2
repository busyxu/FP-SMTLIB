...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!288 #x00000007)))
       #x0000000000000011))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!287))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!289) ((_ to_fp 11 53) b_ack!286)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!289) ((_ to_fp 11 53) c_ack!287)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!289) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!289))
                 a!1)
         ((_ to_fp 11 53) a_ack!289))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
