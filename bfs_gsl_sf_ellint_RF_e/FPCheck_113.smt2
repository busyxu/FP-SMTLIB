...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!1059))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1061) ((_ to_fp 11 53) b_ack!1058))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1058) ((_ to_fp 11 53) c_ack!1059))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!1059) ((_ to_fp 11 53) #x7fc9999999999999)))
