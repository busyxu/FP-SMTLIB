(declare-fun d_ack!468 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand d_ack!468 #x00000007)))
       #x0000000000000011))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) c_ack!467))
            ((_ to_fp 11 53) #x0034000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!469) ((_ to_fp 11 53) b_ack!466))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!466) ((_ to_fp 11 53) c_ack!467))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!467) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!469))
    a!1)))
