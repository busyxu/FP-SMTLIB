...
(assert (let ((a!1 (fp.leq (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.eq ((_ to_fp 11 53) d_ack!86) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!86) ((_ to_fp 11 53) #x3ff3333333333333))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!86)
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x4000000000000000)
                    ((_ to_fp 11 53) c_ack!87)))))
(assert (FPCHECK_FMUL_OVERFLOW #x4010000000000000 d_ack!86))
