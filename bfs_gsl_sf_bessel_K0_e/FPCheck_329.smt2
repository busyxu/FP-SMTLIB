...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!426) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!426) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!426) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!426) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!12
                                    ((_ to_fp 11 53) #x3e850b0771f4ea8b))))))
  (FPCHECK_FADD_UNDERFLOW a!15 #x3f22ef1bcd47bec8)))))))))))))))))
