...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!18 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!18 (CF_exp a!19))
    (CF_exp (fp.add roundNearestTiesToEven a!20 a!21))))))))))))))))))))))
