...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!581) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!581) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!581) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!581) ((_ to_fp 11 53) #x4020000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!53 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.abs ((_ to_fp 11 53) a_ack!581))))))
(let ((a!2 (fp.div roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   a!1
