...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!774) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!774) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!774) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!17 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #xbf789d425fd7dd93)))
                    ((_ to_fp 11 53) #x7ff8000000000001))))
  (fp.lt (fp.abs a!17) ((_ to_fp 11 53) #x5fe9999999999999))))))))))))))))))))
