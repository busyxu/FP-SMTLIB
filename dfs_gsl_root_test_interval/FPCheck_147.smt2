(declare-fun x_hi_ack!778 () (_ BitVec 64))
(declare-fun x_lo_ack!779 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.gt ((_ to_fp 11 53) x_lo_ack!779) ((_ to_fp 11 53) x_hi_ack!778))))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
                       ((_ to_fp 11 53) x_lo_ack!779)
                       ((_ to_fp 11 53) x_hi_ack!778))
               ((_ to_fp 11 53) x_lo_ack!779))
       ((_ to_fp 11 53) x_hi_ack!778)))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) x_hi_ack!778))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) x_hi_ack!778))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
...
(let ((a!2 (fp.leq a!1
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) x_lo_ack!779))))))
  (not a!2))))
