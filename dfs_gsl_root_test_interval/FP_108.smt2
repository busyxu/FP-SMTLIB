(declare-fun x_hi_ack!1870 () (_ BitVec 64))
(declare-fun x_lo_ack!1873 () (_ BitVec 64))
(declare-fun epsrel_ack!1872 () (_ BitVec 64))
(declare-fun epsabs_ack!1871 () (_ BitVec 64))
(assert (not (fp.gt ((_ to_fp 11 53) x_lo_ack!1873) ((_ to_fp 11 53) x_hi_ack!1870))))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
                       ((_ to_fp 11 53) x_lo_ack!1873)
                       ((_ to_fp 11 53) x_hi_ack!1870))
               ((_ to_fp 11 53) x_lo_ack!1873))
       ((_ to_fp 11 53) x_hi_ack!1870)))
(assert (fp.eq (fp.sub roundNearestTiesToEven
               (fp.add roundNearestTiesToEven
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) x_hi_ack!1870))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) x_hi_ack!1870))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
...
(let ((a!2 (fp.leq a!1
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) x_lo_ack!1873))))))
  (not a!2))))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   a!4)))))
  (fp.lt a!5 ((_ to_fp 11 53) x_hi_ack!1870))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1872)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1871)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   a!4)))))
  (not (fp.gt a!5 ((_ to_fp 11 53) x_hi_ack!1870)))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
...
(assert (not (fp.lt ((_ to_fp 11 53) x_hi_ack!1870)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!6 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                                  ...
                                  a!5))
                  (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) epsabs_ack!1871)
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) epsrel_ack!1872)
                                  ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!6))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
