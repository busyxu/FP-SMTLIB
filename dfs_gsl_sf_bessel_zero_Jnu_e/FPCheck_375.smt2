...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1565) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (not (bvule b_ack!1564 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1564)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1565))))
(assert (not (bvule b_ack!1564 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1564)
       (fp.mul roundNearestTiesToEven
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!1565))
                           ((_ to_fp 11 53) a_ack!1565)))))
  (FPCHECK_FMUL_ACCURACY #x429e0327e3572400 a!1)))
