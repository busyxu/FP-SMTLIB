...
(assert (not (bvule b_ack!1560 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1560)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1561))))
(assert (not (bvule b_ack!1560 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1560)
       (fp.mul roundNearestTiesToEven
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!1561))
                           ((_ to_fp 11 53) a_ack!1561)))))
  (FPCHECK_FMUL_OVERFLOW #x429e0327e3572400 a!1)))
