...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1835) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!1834)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1835) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!1834)))
(assert (not (bvule b_ack!1834 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1834)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1835))))
(assert (not (bvule b_ack!1834 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1834)
       (fp.mul roundNearestTiesToEven
...
(let ((a!8 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!4
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3ffa01a01a01a01a) a!8))))))))
