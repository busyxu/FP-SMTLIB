...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1935) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!1934)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1935) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!1934)))
(assert (not (bvule b_ack!1934 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1934)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1935))))
(assert (not (bvule b_ack!1934 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1934)
       (fp.mul roundNearestTiesToEven
...
(let ((a!10 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!9))
                    (fp.div roundNearestTiesToEven a!1 a!3))))
  (FPCHECK_FMUL_UNDERFLOW a!10 (fp.div roundNearestTiesToEven a!1 a!3))))))))))
