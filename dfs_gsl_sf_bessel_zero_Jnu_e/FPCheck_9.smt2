...
(assert (= #x00000001 b_ack!36))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!37) ((_ to_fp 11 53) #x4000000000000000))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!36))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!36))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!36))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!36))
