...
(declare-fun b_ack!1672 () (_ BitVec 32))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1673) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!1672)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1673) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!1672)))
(assert (not (bvule b_ack!1672 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1672)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1673))))
(assert (not (bvule b_ack!1672 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1672)
       (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   (fp.mul roundNearestTiesToEven a!3 a!1))
                           a!1))))
  (FPCHECK_FMUL_ACCURACY #x3fe2e9e8cd187470 a!4))))))
