...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!267) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!266)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!267) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000001 b_ack!266))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!267) ((_ to_fp 11 53) #x4000000000000000))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!266))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!266))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!266))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!266))
...
(let ((a!40 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x0000000000000000))
                            ((_ to_fp 11 53) a!29)))))
  (FPCHECK_FADD_OVERFLOW a!40 a!48)))))))))))))))))
