...
(assert (not (= #x00000001 b_ack!1974)))
(assert (not (bvule b_ack!1974 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1974)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1975))))
(assert (not (bvule b_ack!1974 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1974)
       (fp.mul roundNearestTiesToEven
...
(let ((a!11 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven a!1 a!3))
                    (fp.div roundNearestTiesToEven a!1 a!3))))
  (FPCHECK_FMUL_OVERFLOW a!11 (fp.div roundNearestTiesToEven a!1 a!3)))))))))))
