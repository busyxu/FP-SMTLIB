...
(assert (not (= #x00000000 b_ack!2172)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2173) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!2172)))
(assert (not (bvule b_ack!2172 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!2172)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!2173))))
(assert (not (bvule b_ack!2172 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!2172)
       (fp.mul roundNearestTiesToEven
...
(let ((a!3 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!2)
                   a!2)))
  (FPCHECK_FMUL_ACCURACY (fp.mul roundNearestTiesToEven a!3 a!2) a!2)))))
