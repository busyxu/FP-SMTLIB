...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!645) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!644)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!645) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!644)))
(assert (bvule b_ack!644 #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!645)
            ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!644))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!644))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!644))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!644))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!644))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) a!29)))))
  (FPCHECK_FADD_OVERFLOW (fp.sub roundNearestTiesToEven a!30 a!20) a!38)))))))))))))))
