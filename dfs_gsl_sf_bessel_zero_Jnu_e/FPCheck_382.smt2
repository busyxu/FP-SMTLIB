...
(assert (not (bvule b_ack!1600 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1600)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1601))))
(assert (not (bvule b_ack!1600 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1600)
       (fp.mul roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1))
                   a!1)))
  (FPCHECK_FADD_OVERFLOW #xc244df3f4fdd0000 a!2))))
