...
(assert (not (bvule b_ack!1462 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1462)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1463))))
(assert (not (bvule b_ack!1462 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1462)
       (fp.mul roundNearestTiesToEven
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!1463))
                           ((_ to_fp 11 53) a_ack!1463)))))
  (FPCHECK_FMUL_ACCURACY #x41df2cf87d400000 a!1)))
