...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!91) ((_ to_fp 11 53) #x4000000000000000))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!90))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!90))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!90))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!90))
...
(let ((a!21 (fp.mul roundNearestTiesToEven
                    ...
                    a!20)))
  (FPCHECK_FSUB_UNDERFLOW a!21 #x0000000000000000))))))))))))
