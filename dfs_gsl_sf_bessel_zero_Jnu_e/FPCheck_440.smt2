...
(assert (not (= #x00000001 b_ack!1836)))
(assert (not (bvule b_ack!1836 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1836)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1837))))
(assert (not (bvule b_ack!1836 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1836)
       (fp.mul roundNearestTiesToEven
