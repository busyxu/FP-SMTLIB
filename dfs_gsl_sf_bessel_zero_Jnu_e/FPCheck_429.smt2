...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1785) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!1784)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1785) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!1784)))
(assert (not (bvule b_ack!1784 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1784)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1785))))
(assert (not (bvule b_ack!1784 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1784)
       (fp.mul roundNearestTiesToEven
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    a!4
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fe3813813813814) a!7)))))))
