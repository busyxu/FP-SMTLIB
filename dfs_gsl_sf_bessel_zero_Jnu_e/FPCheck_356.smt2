...
(assert (not (= #x00000001 b_ack!1500)))
(assert (not (bvule b_ack!1500 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1500)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1501))))
(assert (not (bvule b_ack!1500 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1500)
       (fp.mul roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1))
                   a!1)))
  (FPCHECK_FADD_UNDERFLOW #x4186e4a7f0000000 a!2))))
