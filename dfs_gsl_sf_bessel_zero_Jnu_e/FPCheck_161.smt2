...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!733) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (bvule b_ack!732 #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!733)
            ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!732))))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!732))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!732))
       #x0000000000000051))
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 (concat #x00000000 b_ack!732))))
(assert (bvult (bvmul #x0000000000000008 (concat #x00000000 b_ack!732))
...
(let ((a!40 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x0000000000000000))
                            ((_ to_fp 11 53) a!29)))))
  (FPCHECK_FADD_UNDERFLOW a!40 a!48)))))))))))))))))
