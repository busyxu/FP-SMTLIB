...
(assert (not (bvule b_ack!1668 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1668)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!1669))))
(assert (not (bvule b_ack!1668 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!1668)
       (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   (fp.mul roundNearestTiesToEven a!3 a!1))
                           a!1))))
  (FPCHECK_FMUL_UNDERFLOW #x3fe2e9e8cd187470 a!4))))))
