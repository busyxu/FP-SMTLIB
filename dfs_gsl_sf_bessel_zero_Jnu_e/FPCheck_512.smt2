...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2121) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 b_ack!2120)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2121) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000001 b_ack!2120)))
(assert (not (bvule b_ack!2120 #x0000000a)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!2120)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!2121))))
(assert (not (bvule b_ack!2120 #x00000014)))
(assert (fp.gt ((_ to_fp_unsigned 11 53) roundNearestTiesToEven b_ack!2120)
       (fp.mul roundNearestTiesToEven
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x400921fb54442d18))))))
  (FPCHECK_FMUL_OVERFLOW #x4073b00000000000 a!2))))
