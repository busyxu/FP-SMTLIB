...
(declare-fun d_ack!682 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!681) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!683) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!683) ((_ to_fp 11 53) #xc076232bdd7abcd2))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!683)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!681))))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) d_ack!682)
                           (fp.abs ((_ to_fp 11 53) c_ack!681)))
