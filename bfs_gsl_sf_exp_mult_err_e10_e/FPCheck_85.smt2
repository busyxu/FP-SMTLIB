...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!446) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!446)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!444))))))
...
(assert (FPCHECK_FDIV_UNDERFLOW d_ack!445 (fp.abs ((_ to_fp 11 53) c_ack!444))))
