...
(assert (fp.lt ((_ to_fp 11 53) a_ack!163) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!163) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (FPCHECK_FMUL_ACCURACY c_ack!162 (CF_exp a_ack!163)))
