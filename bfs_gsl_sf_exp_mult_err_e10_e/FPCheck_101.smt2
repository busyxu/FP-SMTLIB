...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!533)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!531))))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) d_ack!532)
                           (fp.abs ((_ to_fp 11 53) c_ack!531)))
      ...
      (a!5 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) c_ack!531)
