...
(assert (fp.lt ((_ to_fp 11 53) a_ack!195) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!195) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (FPCHECK_FADD_OVERFLOW
  (fp.abs ((_ to_fp 11 53) d_ack!194))
