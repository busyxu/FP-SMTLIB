...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!461) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!461)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!459))))))
...
(assert (FPCHECK_FDIV_ZERO d_ack!460 (fp.abs ((_ to_fp 11 53) c_ack!459))))
