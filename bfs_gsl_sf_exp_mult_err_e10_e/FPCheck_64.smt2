...
(assert (fp.lt ((_ to_fp 11 53) a_ack!317) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!317) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!315))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!315))))))
