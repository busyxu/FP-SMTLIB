...
(assert (fp.lt ((_ to_fp 11 53) a_ack!131) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!131) ((_ to_fp 11 53) #xc076232bdd7abcd2))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!131)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!130))))))
