...
(declare-fun d_ack!578 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!577) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!579) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!579)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!577))))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
      ...
      (a!5 ((_ to_fp 11 53)
             ...
             (ite (fp.geq ((_ to_fp 11 53) c_ack!577)
