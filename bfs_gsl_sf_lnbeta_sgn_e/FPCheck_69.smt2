...
(assert (fp.gt ((_ to_fp 11 53) a_ack!208) ((_ to_fp 11 53) b_ack!207)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!208) ((_ to_fp 11 53) b_ack!207))))
(assert (FPCHECK_FDIV_OVERFLOW b_ack!207 a_ack!208))
