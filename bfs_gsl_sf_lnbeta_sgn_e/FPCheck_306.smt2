...
(assert (fp.gt ((_ to_fp 11 53) a_ack!914) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!913) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!914) ((_ to_fp 11 53) b_ack!913))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!914) ((_ to_fp 11 53) b_ack!913))))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!914) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!914))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!914) a!6)
