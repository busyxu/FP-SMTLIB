...
(assert (fp.gt ((_ to_fp 11 53) b_ack!71) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!72) ((_ to_fp 11 53) b_ack!71))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!72) ((_ to_fp 11 53) b_ack!71))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!71)
                    ((_ to_fp 11 53) b_ack!71))
            ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!72 b_ack!71))
