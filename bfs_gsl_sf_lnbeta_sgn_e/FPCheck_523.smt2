...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1548) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1547) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1548) ((_ to_fp 11 53) b_ack!1547))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1548) ((_ to_fp 11 53) b_ack!1547)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1548) ((_ to_fp 11 53) #x4330000000000000)))
