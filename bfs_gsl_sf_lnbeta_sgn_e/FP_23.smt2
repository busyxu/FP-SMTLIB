...
(assert (fp.gt ((_ to_fp 11 53) a_ack!206) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!205) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!206) ((_ to_fp 11 53) b_ack!205)))
