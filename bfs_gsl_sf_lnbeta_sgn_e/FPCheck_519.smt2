...
(assert (fp.gt ((_ to_fp 11 53) b_ack!1533) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1534) ((_ to_fp 11 53) b_ack!1533))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1534) ((_ to_fp 11 53) b_ack!1533)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1534) ((_ to_fp 11 53) #x4330000000000000)))
(assert (FPCHECK_FDIV_UNDERFLOW #x3ff0000000000000 a_ack!1534))
