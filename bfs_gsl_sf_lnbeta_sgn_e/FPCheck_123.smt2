...
(assert (fp.gt ((_ to_fp 11 53) b_ack!377) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!378) ((_ to_fp 11 53) b_ack!377))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!378) ((_ to_fp 11 53) b_ack!377))))
...
(assert (FPCHECK_FMUL_OVERFLOW a_ack!378 #xbf3fbdf153d2eadd))
