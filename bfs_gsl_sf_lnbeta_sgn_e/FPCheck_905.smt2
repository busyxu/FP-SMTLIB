...
(assert (fp.gt ((_ to_fp 11 53) b_ack!2739) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2740) ((_ to_fp 11 53) b_ack!2739))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2740) ((_ to_fp 11 53) b_ack!2739)))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!2740 #x3ff0000000000000))
