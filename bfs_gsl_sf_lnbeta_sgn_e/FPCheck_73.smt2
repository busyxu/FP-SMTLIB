...
(assert (fp.gt ((_ to_fp 11 53) a_ack!220) ((_ to_fp 11 53) b_ack!219)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!220) ((_ to_fp 11 53) b_ack!219))))
(assert (FPCHECK_FDIV_ZERO b_ack!219 a_ack!220))
