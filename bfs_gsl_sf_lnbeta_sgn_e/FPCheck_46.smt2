...
(assert (fp.lt ((_ to_fp 11 53) a_ack!116) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) a_ack!116) (CF_floor a_ack!116))
                  #x00000001
                  #x00000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!116 #x3ff0000000000000))
