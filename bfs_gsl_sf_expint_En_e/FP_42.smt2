...
(assert (not (= #x00000002 a_ack!671)))
...
(assert (not (fp.eq ((_ to_fp 11 53)
              ...
              (bvsub #x00000001 a_ack!671))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53)
              roundNearestTiesToEven
              (bvsub #x00000001 a_ack!671))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!670) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!670) ((_ to_fp 11 53) #xc024000000000000)))
