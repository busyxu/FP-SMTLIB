...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!340) ((_ to_fp 11 53) #xc085eeaad5511c64))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!340) ((_ to_fp 11 53) #xc024000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!340) ((_ to_fp 11 53) #xc010000000000000)))
