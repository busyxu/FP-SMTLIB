...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1218) ((_ to_fp 11 53) #xc010000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1218) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!1218) ((_ to_fp 11 53) #x4010000000000000)))
