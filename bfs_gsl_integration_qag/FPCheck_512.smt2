(declare-fun key_ack!5340 () (_ BitVec 32))
(declare-fun limit_ack!5339 () (_ BitVec 64))
(declare-fun epsabs_ack!5338 () (_ BitVec 64))
(declare-fun b_ack!5337 () (_ BitVec 64))
(declare-fun a_ack!5341 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5340 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5340)))
(assert (= #x00000001 key_ack!5340))
(assert (not (bvult #x00000000000003e8 limit_ack!5339)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!5341)
                                   ((_ to_fp 11 53) b_ack!5337))))))
