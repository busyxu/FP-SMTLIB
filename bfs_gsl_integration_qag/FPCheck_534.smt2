(declare-fun key_ack!5540 () (_ BitVec 32))
(declare-fun limit_ack!5539 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5540 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5540)))
(assert (= #x00000001 key_ack!5540))
(assert (not (bvult #x00000000000003e8 limit_ack!5539)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5538)
