(declare-fun key_ack!5775 () (_ BitVec 32))
(declare-fun limit_ack!5774 () (_ BitVec 64))
(declare-fun epsabs_ack!5773 () (_ BitVec 64))
(declare-fun b_ack!5772 () (_ BitVec 64))
(declare-fun a_ack!5776 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5775 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5775)))
(assert (= #x00000001 key_ack!5775))
(assert (not (bvult #x00000000000003e8 limit_ack!5774)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5773)
