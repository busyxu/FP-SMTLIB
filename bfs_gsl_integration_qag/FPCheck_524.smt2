(declare-fun key_ack!5445 () (_ BitVec 32))
(declare-fun limit_ack!5444 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5445 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5445)))
(assert (= #x00000001 key_ack!5445))
(assert (not (bvult #x00000000000003e8 limit_ack!5444)))
