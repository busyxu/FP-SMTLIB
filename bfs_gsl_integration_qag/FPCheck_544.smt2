(declare-fun key_ack!5625 () (_ BitVec 32))
(declare-fun limit_ack!5624 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5625 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5625)))
(assert (= #x00000001 key_ack!5625))
(assert (not (bvult #x00000000000003e8 limit_ack!5624)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5623)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!28 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!23 a!26)
                                    ((_ to_fp 11 53) #x3fe0000000000000)))))
      (a!29 (fp.abs (fp.sub roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (CF_log a!15)
                                    ((_ to_fp 11 53) #x7ff8000000000001))
                            (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fcad04f9087090f) a!27)
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x3f977c5b67d57470)
