(declare-fun key_ack!5855 () (_ BitVec 32))
(declare-fun limit_ack!5854 () (_ BitVec 64))
(declare-fun epsabs_ack!5853 () (_ BitVec 64))
(declare-fun b_ack!5852 () (_ BitVec 64))
(declare-fun a_ack!5856 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5855 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5855)))
(assert (= #x00000001 key_ack!5855))
(assert (not (bvult #x00000000000003e8 limit_ack!5854)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5853)
