(declare-fun key_ack!5765 () (_ BitVec 32))
(declare-fun limit_ack!5764 () (_ BitVec 64))
(declare-fun epsabs_ack!5763 () (_ BitVec 64))
(declare-fun b_ack!5762 () (_ BitVec 64))
(declare-fun a_ack!5766 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5765 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5765)))
(assert (= #x00000001 key_ack!5765))
(assert (not (bvult #x00000000000003e8 limit_ack!5764)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5763)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!30 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!23 a!26)
                                    ((_ to_fp 11 53) #x3fe0000000000000)))))
      (a!31 (fp.abs (fp.sub roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (CF_log a!5)
                                    ((_ to_fp 11 53) #x7ff8000000000001))
                            (fp.mul roundNearestTiesToEven
