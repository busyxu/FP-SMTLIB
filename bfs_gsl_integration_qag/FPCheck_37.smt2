(declare-fun key_ack!419 () (_ BitVec 32))
...
(assert (bvslt key_ack!419 #x00000001))
(assert (not (bvult #x00000000000003e8 limit_ack!418)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!417)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!420)
                                   ((_ to_fp 11 53) b_ack!416))))))
  (FPCHECK_FDIV_OVERFLOW (CF_log a!1) #x1fd0000000000000)))
