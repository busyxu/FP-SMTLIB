(declare-fun key_ack!5520 () (_ BitVec 32))
(declare-fun limit_ack!5519 () (_ BitVec 64))
(declare-fun epsabs_ack!5518 () (_ BitVec 64))
(declare-fun b_ack!5517 () (_ BitVec 64))
(declare-fun a_ack!5521 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5520 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5520)))
(assert (= #x00000001 key_ack!5520))
(assert (not (bvult #x00000000000003e8 limit_ack!5519)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5518)
