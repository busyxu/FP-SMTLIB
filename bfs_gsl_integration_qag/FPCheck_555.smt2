(declare-fun key_ack!5720 () (_ BitVec 32))
(declare-fun limit_ack!5719 () (_ BitVec 64))
(declare-fun epsabs_ack!5718 () (_ BitVec 64))
(declare-fun b_ack!5717 () (_ BitVec 64))
(declare-fun a_ack!5721 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5720 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5720)))
(assert (= #x00000001 key_ack!5720))
(assert (not (bvult #x00000000000003e8 limit_ack!5719)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5718)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!28 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!23 a!26)
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_ACCURACY a!27 a!28))))))))
