(declare-fun key_ack!5895 () (_ BitVec 32))
(declare-fun limit_ack!5894 () (_ BitVec 64))
(declare-fun epsabs_ack!5893 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5895 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5895)))
(assert (= #x00000001 key_ack!5895))
(assert (not (bvult #x00000000000003e8 limit_ack!5894)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5893)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!33 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!23 a!26)
                                    ((_ to_fp 11 53) #x3fe0000000000000)))))
      (a!34 (fp.abs (fp.sub roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (CF_log a!18)
                                    ((_ to_fp 11 53) #x7ff8000000000001))
                            (fp.mul roundNearestTiesToEven
