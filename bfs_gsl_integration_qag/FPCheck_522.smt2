(declare-fun key_ack!5430 () (_ BitVec 32))
(declare-fun limit_ack!5429 () (_ BitVec 64))
(declare-fun epsabs_ack!5428 () (_ BitVec 64))
(declare-fun b_ack!5427 () (_ BitVec 64))
(declare-fun a_ack!5431 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5430 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5430)))
(assert (= #x00000001 key_ack!5430))
(assert (not (bvult #x00000000000003e8 limit_ack!5429)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5428)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!5431)
                                   ((_ to_fp 11 53) b_ack!5427))))))
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!24))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fca2adbcbec9cd8) a!27)))))))))
