(declare-fun key_ack!5710 () (_ BitVec 32))
(declare-fun limit_ack!5709 () (_ BitVec 64))
(declare-fun epsabs_ack!5708 () (_ BitVec 64))
(declare-fun b_ack!5707 () (_ BitVec 64))
(declare-fun a_ack!5711 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5710 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5710)))
(assert (= #x00000001 key_ack!5710))
(assert (not (bvult #x00000000000003e8 limit_ack!5709)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5708)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!5711)
                                   ((_ to_fp 11 53) b_ack!5707))))))
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
      ...
      (a!28 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!23 a!26)
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FADD_UNDERFLOW a!27 a!28))))))))
