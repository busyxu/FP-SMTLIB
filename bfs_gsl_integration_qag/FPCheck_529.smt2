(declare-fun key_ack!5490 () (_ BitVec 32))
(declare-fun limit_ack!5489 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5490 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5490)))
(assert (= #x00000001 key_ack!5490))
(assert (not (bvult #x00000000000003e8 limit_ack!5489)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5488)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #x3fcad04f9087090f a!27))))))))
