(declare-fun key_ack!5265 () (_ BitVec 32))
...
(assert (not (bvslt key_ack!5265 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5265)))
(assert (= #x00000001 key_ack!5265))
(assert (not (bvult #x00000000000003e8 limit_ack!5264)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5263)
