(declare-fun key_ack!5500 () (_ BitVec 32))
(declare-fun limit_ack!5499 () (_ BitVec 64))
(declare-fun epsabs_ack!5498 () (_ BitVec 64))
...
(assert (not (bvslt key_ack!5500 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5500)))
(assert (= #x00000001 key_ack!5500))
(assert (not (bvult #x00000000000003e8 limit_ack!5499)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5498)
...
(let ((a!27 (fp.abs (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3fe0000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3fcad04f9087090f a!27))))))))
