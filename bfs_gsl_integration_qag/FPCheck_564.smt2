(declare-fun key_ack!5800 () (_ BitVec 32))
(declare-fun limit_ack!5799 () (_ BitVec 64))
(declare-fun epsabs_ack!5798 () (_ BitVec 64))
(declare-fun b_ack!5797 () (_ BitVec 64))
(declare-fun a_ack!5801 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvslt key_ack!5800 #x00000001)))
(assert (not (bvslt #x00000006 key_ack!5800)))
(assert (= #x00000001 key_ack!5800))
(assert (not (bvult #x00000000000003e8 limit_ack!5799)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!5798)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!5801)
                                   ((_ to_fp 11 53) b_ack!5797))))))
