...
(assert (not (not (fp.eq ((_ to_fp 11 53) a_ack!68)
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!68))
            (fp.abs ((_ to_fp 11 53) b_ack!67)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_log (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)))))
  (FPCHECK_FADD_ACCURACY (CF_log (fp.abs ((_ to_fp 11 53) b_ack!67))) a!2))))
