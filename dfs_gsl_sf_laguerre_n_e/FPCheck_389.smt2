...
(assert (not (bvslt a_ack!1212 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1211) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1212)
...
(assert (bvslt #x0000000b a_ack!1212))
(assert (bvslt #x0000000c a_ack!1212))
