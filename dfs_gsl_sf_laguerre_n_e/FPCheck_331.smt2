...
(assert (not (bvslt a_ack!1038 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1037) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1038)
...
(assert (bvslt #x00000008 a_ack!1038))
(assert (bvslt #x00000009 a_ack!1038))
(assert (bvslt #x0000000a a_ack!1038))
