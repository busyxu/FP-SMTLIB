...
(assert (not (bvslt a_ack!234 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!233) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!234)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!233) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!232) ((_ to_fp 11 53) #x0000000000000000)))
