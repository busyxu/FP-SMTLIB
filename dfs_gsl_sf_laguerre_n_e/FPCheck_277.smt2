...
(assert (not (bvslt a_ack!876 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!875) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!876)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!875) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!874) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!874) ((_ to_fp 11 53) #xc000000000000000))))
(assert (bvslt #x00000002 a_ack!876))
(assert (bvslt #x00000003 a_ack!876))
(assert (bvslt #x00000004 a_ack!876))
(assert (bvslt #x00000005 a_ack!876))
(assert (bvslt #x00000006 a_ack!876))
(assert (bvslt #x00000007 a_ack!876))
(assert (bvslt #x00000008 a_ack!876))
...
(let ((a!18 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    a!1
    (fp.div roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!18 a!22)
            ((_ to_fp 11 53) #x4020000000000000)))))))))))
