...
(assert (not (bvslt a_ack!1833 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1832) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1833)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1832) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!1831) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvslt #x0000000c a_ack!1833))
(assert (bvslt #x0000000d a_ack!1833))
(assert (bvslt #x0000000e a_ack!1833))
(assert (bvslt #x0000000f a_ack!1833))
(assert (bvslt #x00000010 a_ack!1833))
(assert (bvslt #x00000011 a_ack!1833))
(assert (bvslt #x00000012 a_ack!1833))
(assert (bvslt #x00000013 a_ack!1833))
(assert (bvslt #x00000014 a_ack!1833))
