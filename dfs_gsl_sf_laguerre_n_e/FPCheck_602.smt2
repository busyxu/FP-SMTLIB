...
(assert (not (bvslt a_ack!1851 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1850) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1851)
...
(assert (bvslt #x00000010 a_ack!1851))
(assert (bvslt #x00000011 a_ack!1851))
(assert (bvslt #x00000012 a_ack!1851))
(assert (bvslt #x00000013 a_ack!1851))
(assert (bvslt #x00000014 a_ack!1851))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
      ...
      (a!60 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4034000000000000)))))
  (FPCHECK_FADD_OVERFLOW a!56 a!60))))))))))))))))))))))
