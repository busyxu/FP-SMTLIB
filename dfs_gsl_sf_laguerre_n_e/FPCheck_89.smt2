...
(assert (not (bvslt a_ack!312 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!311) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!310) ((_ to_fp 11 53) #xc000000000000000))))
(assert (FPCHECK_FADD_OVERFLOW #x3ff0000000000000 b_ack!310))
