...
(assert (not (bvslt a_ack!438 #x00000005)))
...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!437) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!436) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FADD_OVERFLOW #x4018000000000000 b_ack!436))
