...
(assert (not (bvslt a_ack!810 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!809) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!810)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!809) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!808) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!808) ((_ to_fp 11 53) #xc000000000000000))))
(assert (bvslt #x00000002 a_ack!810))
(assert (bvslt #x00000003 a_ack!810))
(assert (bvslt #x00000004 a_ack!810))
(assert (bvslt #x00000005 a_ack!810))
(assert (bvslt #x00000006 a_ack!810))
(assert (bvslt #x00000007 a_ack!810))
