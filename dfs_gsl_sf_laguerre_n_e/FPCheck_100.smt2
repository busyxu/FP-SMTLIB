...
(assert (not (bvslt a_ack!345 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!344) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!345)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!344) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!343) ((_ to_fp 11 53) #x0000000000000000)))
