...
(assert (not (bvslt a_ack!726 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!725) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!726)
       ((_ to_fp 11 53) #x416312d000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!725) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) b_ack!724) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!724) ((_ to_fp 11 53) #xc000000000000000))))
(assert (bvslt #x00000002 a_ack!726))
(assert (bvslt #x00000003 a_ack!726))
(assert (bvslt #x00000004 a_ack!726))
(assert (bvslt #x00000005 a_ack!726))
(assert (bvslt #x00000006 a_ack!726))
