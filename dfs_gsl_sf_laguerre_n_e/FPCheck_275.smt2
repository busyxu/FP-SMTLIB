...
(assert (not (bvslt a_ack!870 #x00000005)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!869) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven a_ack!870)
...
(assert (bvslt #x00000006 a_ack!870))
(assert (bvslt #x00000007 a_ack!870))
(assert (bvslt #x00000008 a_ack!870))
