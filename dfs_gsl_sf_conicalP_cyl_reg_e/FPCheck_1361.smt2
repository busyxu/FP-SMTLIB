(declare-fun c_ack!6643 () (_ BitVec 64))
(declare-fun a_ack!6644 () (_ BitVec 32))
(declare-fun b_ack!6642 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!6644 #xffffffff)))
(assert (not (= #xffffffff a_ack!6644)))
(assert (= #x00000000 a_ack!6644))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!6642) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x3fb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6642) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6642) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6642) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!6643) ((_ to_fp 11 53) #x3ff8000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!6642) ((_ to_fp 11 53) #x4034000000000000)))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) c_ack!6643))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!19 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4066c80000000000)
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) b_ack!6642)
                                    ((_ to_fp 11 53) b_ack!6642)))
...
(let ((a!25 (fp.add roundNearestTiesToEven
      ...
      (a!29 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            a!24
                            (fp.mul roundNearestTiesToEven a!26 a!2))
                    (fp.mul roundNearestTiesToEven a!28 a!2))))
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven a!26 a!2)))))
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven a!27 a!29)
                 a!27)
         a!29)))))))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
...
(let ((a!22 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            a!19
                            (fp.mul roundNearestTiesToEven a!20 a!2))
                    (fp.mul roundNearestTiesToEven a!21 a!2)))
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!20 a!2)))
                    a!22)))
(let ((a!30 (fp.abs (fp.div roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!22
                                    ((_ to_fp 11 53) #x0000000000000000))
                            (fp.sub roundNearestTiesToEven
                                    a!29
                                    ((_ to_fp 11 53) #x0000000000000000))))))
  (fp.gt a!30 ((_ to_fp 11 53) #x3cb0000000000000)))))))))))))
(assert (FPCHECK_FMUL_OVERFLOW b_ack!6642 b_ack!6642))
