...
(assert (not (= #xffffffff a_ack!287)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!286) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!285) ((_ to_fp 11 53) #x408f400000000000)))
