...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1702) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1703 #xffffffff)))
(assert (not (= #xffffffff a_ack!1703)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1702) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1701) ((_ to_fp 11 53) #x408f400000000000)))
