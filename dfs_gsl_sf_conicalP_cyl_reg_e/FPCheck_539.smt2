...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2863) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!2864 #xffffffff)))
(assert (not (= #xffffffff a_ack!2864)))
(assert (= #x00000000 a_ack!2864))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2863) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2863) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2862) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!2863) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2862) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 (fp.geq (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!2863)
                                   ((_ to_fp 11 53) c_ack!2863)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!3)
                   a!4)))
  (FPCHECK_FMUL_UNDERFLOW a!5 a!6)))))
