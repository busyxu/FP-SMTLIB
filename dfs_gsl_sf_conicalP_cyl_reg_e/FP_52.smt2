...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1054) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1055 #xffffffff)))
(assert (not (= #xffffffff a_ack!1055)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1054) ((_ to_fp 11 53) #x0000000000000000)))
