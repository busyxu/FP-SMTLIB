...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1156) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1157 #xffffffff)))
(assert (not (= #xffffffff a_ack!1157)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1156) ((_ to_fp 11 53) #x0000000000000000)))
