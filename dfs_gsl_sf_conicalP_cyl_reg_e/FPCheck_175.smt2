...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1006) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1007 #xffffffff)))
(assert (not (= #xffffffff a_ack!1007)))
(assert (= #x00000000 a_ack!1007))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1006) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1006) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1005) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!1006) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1005) ((_ to_fp 11 53) #x408f400000000000)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
                                   ((_ to_fp 11 53) b_ack!1005))))))
  (FPCHECK_FDIV_OVERFLOW a!1 #x402c000000000000)))
