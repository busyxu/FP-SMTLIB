...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3250) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3251 #xffffffff)))
(assert (not (= #xffffffff a_ack!3251)))
(assert (= #x00000000 a_ack!3251))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3250) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3250) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3249) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3250) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3249) ((_ to_fp 11 53) #x408f400000000000)))
