(declare-fun c_ack!4468 () (_ BitVec 64))
(declare-fun a_ack!4469 () (_ BitVec 32))
(declare-fun b_ack!4467 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4468) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!4469 #xffffffff)))
(assert (not (= #xffffffff a_ack!4469)))
(assert (= #x00000000 a_ack!4469))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4468) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4468) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4467) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!4468) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!4467) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 (fp.geq (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!4468)
                                   ((_ to_fp 11 53) c_ack!4468)))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!8)
                            a!9))))
  (FPCHECK_FSUB_ACCURACY a!10 #x0000000000000000))))))
