...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4264) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!4265 #xffffffff)))
(assert (not (= #xffffffff a_ack!4265)))
(assert (= #x00000000 a_ack!4265))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4264) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4264) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4263) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!4264) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!4263) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 (fp.geq (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!4264)
                                   ((_ to_fp 11 53) c_ack!4264)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!3)
                   a!4)))
  (FPCHECK_FMUL_ACCURACY (fp.mul roundNearestTiesToEven a!5 a!6) a!7)))))
