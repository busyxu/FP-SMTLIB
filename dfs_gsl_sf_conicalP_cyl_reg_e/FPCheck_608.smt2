...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3175) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3176 #xffffffff)))
(assert (not (= #xffffffff a_ack!3176)))
(assert (= #x00000000 a_ack!3176))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3175) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3175) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3174) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3175) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3174) ((_ to_fp 11 53) #x408f400000000000)))
