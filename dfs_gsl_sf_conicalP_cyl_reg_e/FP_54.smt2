...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1123) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1123) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1122) ((_ to_fp 11 53) #x408f400000000000)))
