...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1348) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1349 #xffffffff)))
(assert (not (= #xffffffff a_ack!1349)))
(assert (= #x00000000 a_ack!1349))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1348) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1348) ((_ to_fp 11 53) #x0000000000000000)))
