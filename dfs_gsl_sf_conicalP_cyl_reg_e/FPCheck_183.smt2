...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1060) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1061 #xffffffff)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1060) ((_ to_fp 11 53) #x0000000000000000)))
