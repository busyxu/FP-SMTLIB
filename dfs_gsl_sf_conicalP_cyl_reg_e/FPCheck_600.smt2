...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3145) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3146 #xffffffff)))
(assert (not (= #xffffffff a_ack!3146)))
(assert (= #x00000000 a_ack!3146))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3145) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!3145) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3144) ((_ to_fp 11 53) #x408f400000000000)))
