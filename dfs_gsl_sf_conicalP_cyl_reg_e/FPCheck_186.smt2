...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1078) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!1079 #xffffffff)))
(assert (not (= #xffffffff a_ack!1079)))
(assert (= #x00000000 a_ack!1079))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1078) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!1078) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1077) ((_ to_fp 11 53) #x408f400000000000)))
