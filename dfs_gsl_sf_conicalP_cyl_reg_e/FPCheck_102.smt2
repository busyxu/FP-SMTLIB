...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!565) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!565) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!564) ((_ to_fp 11 53) #x408f400000000000)))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x0000000000000000))
                 a!3)))))))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 b_ack!564))
