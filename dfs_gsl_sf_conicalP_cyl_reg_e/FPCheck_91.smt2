...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!508) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!509 #xffffffff)))
(assert (not (= #xffffffff a_ack!509)))
(assert (= #x00000000 a_ack!509))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!508) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!508) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!507) ((_ to_fp 11 53) #x408f400000000000)))
