...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3508) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3509 #xffffffff)))
(assert (not (= #xffffffff a_ack!3509)))
(assert (= #x00000000 a_ack!3509))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3508) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3508) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3507) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3508) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3507) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!10 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!8)
                    a!9)))
  (FPCHECK_FMUL_OVERFLOW (fp.mul roundNearestTiesToEven a!10 a!11) a!12))))))
