...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2974) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!2975 #xffffffff)))
(assert (not (= #xffffffff a_ack!2975)))
(assert (= #x00000000 a_ack!2975))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2974) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!2974) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2973) ((_ to_fp 11 53) #x408f400000000000)))
