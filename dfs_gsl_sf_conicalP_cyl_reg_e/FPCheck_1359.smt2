(declare-fun c_ack!6637 () (_ BitVec 64))
(declare-fun a_ack!6638 () (_ BitVec 32))
(declare-fun b_ack!6636 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!6638 #xffffffff)))
(assert (not (= #xffffffff a_ack!6638)))
(assert (= #x00000000 a_ack!6638))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!6636) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x3fb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6636) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6636) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!6636) ((_ to_fp 11 53) #x4031000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!6637) ((_ to_fp 11 53) #x3ff8000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!6636) ((_ to_fp 11 53) #x4034000000000000)))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) c_ack!6637))
...
(let ((a!29 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_INVALID
    (fp.add roundNearestTiesToEven a!22 ((_ to_fp 11 53) #x0000000000000000))
    (fp.sub roundNearestTiesToEven a!29 ((_ to_fp 11 53) #x0000000000000000)))))))))))))
