...
(declare-fun a_ack!3296 () (_ BitVec 32))
(declare-fun b_ack!3294 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3295) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3296 #xffffffff)))
(assert (not (= #xffffffff a_ack!3296)))
(assert (= #x00000000 a_ack!3296))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3295) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3295) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3294) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!3295) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3294) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!10 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!8)
                    a!9)))
  (FPCHECK_FADD_ACCURACY a!10 #x0000000000000000))))))
