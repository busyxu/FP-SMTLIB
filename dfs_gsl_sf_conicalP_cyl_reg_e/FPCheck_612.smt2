...
(declare-fun a_ack!3191 () (_ BitVec 32))
(declare-fun b_ack!3189 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3190) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!3191 #xffffffff)))
(assert (not (= #xffffffff a_ack!3191)))
(assert (= #x00000000 a_ack!3191))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3190) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!3190) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3189) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!11 (fp.add roundNearestTiesToEven
                    ...
                    a!9)))
  (FPCHECK_FDIV_ZERO
    (fp.add roundNearestTiesToEven a!9 ((_ to_fp 11 53) #x0000000000000000))
    (fp.sub roundNearestTiesToEven a!11 ((_ to_fp 11 53) #x0000000000000000)))))))))
