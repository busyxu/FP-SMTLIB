...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2212) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!2213 #xffffffff)))
(assert (not (= #xffffffff a_ack!2213)))
(assert (= #x00000000 a_ack!2213))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2212) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2212) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2211) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) c_ack!2212) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2211) ((_ to_fp 11 53) #x408f400000000000)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!3)
                   a!4)))
  (FPCHECK_FSUB_UNDERFLOW a!5 a!6)))))
