...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!436) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!437 #xffffffff)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!436) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!435) ((_ to_fp 11 53) #x408f400000000000)))
