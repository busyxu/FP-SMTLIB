...
(assert (fp.leq ((_ to_fp 11 53) c_ack!79) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!78) ((_ to_fp 11 53) #x408f400000000000)))
(assert (FPCHECK_FMUL_OVERFLOW c_ack!79 c_ack!79))
