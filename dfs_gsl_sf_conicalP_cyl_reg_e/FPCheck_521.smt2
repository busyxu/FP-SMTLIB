...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2779) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!2780 #xffffffff)))
(assert (not (= #xffffffff a_ack!2780)))
...
(assert (fp.leq ((_ to_fp 11 53) c_ack!2779) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2778) ((_ to_fp 11 53) #x408f400000000000)))
