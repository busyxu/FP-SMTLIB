...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!43)) ((_ to_fp 11 53) #x5fe9999999999999)))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) c_ack!43))
            ((_ to_fp 11 53) #x2003333333333333))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!44)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!43))))))
