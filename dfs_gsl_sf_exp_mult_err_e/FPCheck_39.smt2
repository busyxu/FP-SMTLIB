...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!203))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!204)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!204))
         (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!204)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!204)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!204)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
...
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) c_ack!203))))))
  (FPCHECK_FADD_UNDERFLOW (CF_floor a_ack!204) a!1)))
