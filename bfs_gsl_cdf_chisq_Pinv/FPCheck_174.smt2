...
(declare-fun nu_ack!454 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x_ack!455) ((_ to_fp 11 53) #x3fa999999999999a)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) nu_ack!454)
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) nu_ack!454)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FADD_OVERFLOW (CF_log a!13) (CF_log x_ack!455)))))))))))))))
