...
(declare-fun nu_ack!480 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x_ack!481) ((_ to_fp 11 53) #x3fa999999999999a)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) nu_ack!480)
...
(let ((a!14 (CF_exp (fp.div roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) nu_ack!480)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FDIV_OVERFLOW a!14 #x3ff0000000000000)))))))))))))))
