...
(declare-fun nu_ack!914 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x_ack!915) ((_ to_fp 11 53) #x3fa999999999999a)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) nu_ack!914)
...
(assert (FPCHECK_FSUB_OVERFLOW x_ack!915 #x0000000000000000))
