...
(declare-fun nu_ack!448 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x_ack!449) ((_ to_fp 11 53) #x3fa999999999999a)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) nu_ack!448)
...
(assert (FPCHECK_FINVALID_LOG x_ack!449 x_ack!449))
