...
(assert (fp.lt ((_ to_fp 11 53) d_ack!507) ((_ to_fp 11 53) #x0024000000000001)))
(assert (bvsle #x00000000 b_ack!506))
(assert (not (bvsle #x00000001 b_ack!506)))
(assert (fp.eq ((_ to_fp 11 53) a_ack!509) ((_ to_fp 11 53) #x0000000000000000)))
