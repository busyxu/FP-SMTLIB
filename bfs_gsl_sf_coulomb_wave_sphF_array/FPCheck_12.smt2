...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!98) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!96) ((_ to_fp 11 53) #x0024000000000001)))
(assert (bvsle #x00000000 b_ack!95))
(assert (not (bvsle #x00000001 b_ack!95)))
