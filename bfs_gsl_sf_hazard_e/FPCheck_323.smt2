...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) a_ack!451) ((_ to_fp 11 53) #x4039000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
      ...
      (a!11 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3ff0000000000000)
                            (fp.abs ((_ to_fp 11 53) a_ack!451))))))
(let ((a!3 (fp.mul roundNearestTiesToEven
                   a!2
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbf5769e97db28853)
...
(let ((a!9 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xc000000000000000)
                                   (fp.mul roundNearestTiesToEven a!1 a!8)))))
      (a!11 (CF_exp (fp.sub roundNearestTiesToEven
                            a!10
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #xc000000000000000)
                                    (fp.mul roundNearestTiesToEven a!1 a!8))))))
  (FPCHECK_FMUL_ACCURACY a!9 a!11)))))))))))
