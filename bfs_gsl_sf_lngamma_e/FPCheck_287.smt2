...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!441))
            ((_ to_fp 11 53) #x3f947ae147ae147b))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!441) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!441) ((_ to_fp 11 53) #xc1dfffffff800000))))
