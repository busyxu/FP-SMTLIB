...
(assert (let ((a!1 (ite (= ((_ extract 31 31) (bvadd #x00000001 a_ack!343)) #b1)
                (concat #b1 ((_ extract 31 1) (bvadd #x00000001 a_ack!343)))
                (concat #b0 ((_ extract 31 1) (bvadd #x00000001 a_ack!343))))))
  (not (= #x00000000 a!1))))
(assert (let ((a!1 (ite (= ((_ extract 31 31) (bvadd #x00000001 a_ack!343)) #b1)
                (concat #b1 ((_ extract 31 1) (bvadd #x00000001 a_ack!343)))
                (concat #b0 ((_ extract 31 1) (bvadd #x00000001 a_ack!343))))))
...
(assert (bvult (bvadd #xffffffff (bvmul #x00000002 a_ack!343)) #x0000001a))
(assert (let ((a!1 (bvmul #x0000000000000018
                  (concat #x00000000
                          (bvadd #xffffffff (bvmul #x00000002 a_ack!343))))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 ((_ to_fp 11 53)
             ...
             (bvadd #xffffffff (bvmul #x00000002 (bvsub #x00000001 a_ack!343))))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!3 (bvmul #x00000002
                  (bvadd #xffffffff
                         (bvmul #x00000002 (bvsub #x00000002 a_ack!343))))))
