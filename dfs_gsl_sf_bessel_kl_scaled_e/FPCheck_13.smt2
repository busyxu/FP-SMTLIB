...
(assert (fp.lt ((_ to_fp 11 53) b_ack!64) ((_ to_fp 11 53) #x4008000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!65) #x00000000)))
(assert (= #x00000000 (bvand (bvadd #x00000001 a_ack!65) #x00000001)))
(assert (FPCHECK_FMUL_UNDERFLOW b_ack!64 b_ack!64))
