...
(assert (not (bvsle a_ack!562 #x00000000)))
(assert (not (bvslt b_ack!561 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!562 #x00000002) b_ack!561)))
(assert (not (= #x00000000 b_ack!561)))
(assert (not (= #x00000002 a_ack!562)))
(assert (not (bvslt a_ack!562 #x00000015)))
(assert (= #x00000001 b_ack!561))
(assert (not (bvslt #x00000032 a_ack!562)))
(assert (let ((a!1 (bvult (bvadd #x00000001
                         (bvsub (bvsdiv a_ack!562 #x00000002) b_ack!561))
                  #x00000001)))
  (not a!1)))
...
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvmul #x00000002 a_ack!562))
  #x3ff0000000000000))
