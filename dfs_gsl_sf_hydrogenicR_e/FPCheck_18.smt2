...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (bvslt a_ack!155 #x00000001)))
(assert (not (bvslt (bvadd #xffffffff a_ack!155) b_ack!152)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!153) ((_ to_fp 11 53) #x0000000000000000))))
