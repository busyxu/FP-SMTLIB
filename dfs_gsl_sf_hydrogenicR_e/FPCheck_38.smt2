...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!279 #x00000001)))
(assert (not (bvslt (bvadd #xffffffff a_ack!279) b_ack!276)))
...
(assert (not (bvule (bvadd a_ack!279 b_ack!276) #x000000aa)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp_unsigned 11 53)
                             roundNearestTiesToEven
                             (bvadd a_ack!279 b_ack!276))
