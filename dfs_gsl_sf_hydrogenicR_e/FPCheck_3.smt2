...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!39 #x00000001)))
(assert (not (bvslt (bvadd #xffffffff a_ack!39) b_ack!36)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!37) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!38) ((_ to_fp 11 53) #x0000000000000000))))
