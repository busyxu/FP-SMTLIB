...
(assert (not (bvslt a_ack!435 #x00000001)))
(assert (not (bvslt (bvadd #xffffffff a_ack!435) b_ack!432)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!433) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!434) ((_ to_fp 11 53) #x0000000000000000))))
(assert (bvule (bvadd a_ack!435 b_ack!432) #x000000aa))
(assert (let ((a!1 (bvadd #x0000000000000008
                  (bvmul #x0000000000000018
                         (concat #x00000000 (bvadd a_ack!435 b_ack!432))))))
  (bvult #x0000000000000000 a!1)))
(assert (let ((a!1 (bvadd #x0000000000000008
                  (bvmul #x0000000000000018
                         (concat #x00000000 (bvadd a_ack!435 b_ack!432))))))
  (bvult a!1 #x0000000000001001)))
(assert (not (bvule (bvadd #xffffffff (bvsub a_ack!435 b_ack!432)) #x000000aa)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp_unsigned 11 53)
                     roundNearestTiesToEven
                     (bvadd #xffffffff (bvsub a_ack!435 b_ack!432)))
