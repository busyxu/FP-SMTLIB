...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!908) ((_ to_fp 11 53) x1_ack!906))))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!909) ((_ to_fp 11 53) y0_ack!907))))
(assert (not (fp.gt ((_ to_fp 11 53) y_ack!909) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!908) ((_ to_fp 11 53) x0_ack!910))))
(assert (fp.geq ((_ to_fp 11 53) x_ack!908) ((_ to_fp 11 53) x1_ack!906)))
(assert (not (fp.lt ((_ to_fp 11 53) y_ack!909) ((_ to_fp 11 53) y0_ack!907))))
(assert (not (fp.geq ((_ to_fp 11 53) y_ack!909) ((_ to_fp 11 53) #x3ff0000000000000))))
