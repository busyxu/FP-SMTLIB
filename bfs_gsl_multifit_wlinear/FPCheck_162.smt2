(declare-fun e0_ack!1255 () (_ BitVec 64))
(declare-fun e1_ack!1256 () (_ BitVec 64))
(declare-fun e2_ack!1257 () (_ BitVec 64))
(declare-fun x2_ack!1252 () (_ BitVec 64))
(declare-fun x1_ack!1251 () (_ BitVec 64))
(declare-fun y1_ack!1253 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y2_ack!1254 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1255)
                    ((_ to_fp 11 53) e0_ack!1255))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1256)
                    ((_ to_fp 11 53) e1_ack!1256))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1257)
                    ((_ to_fp 11 53) e2_ack!1257))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!1251)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!1252)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
