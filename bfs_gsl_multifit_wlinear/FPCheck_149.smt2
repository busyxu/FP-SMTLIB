(declare-fun e0_ack!1060 () (_ BitVec 64))
(declare-fun e1_ack!1061 () (_ BitVec 64))
(declare-fun e2_ack!1062 () (_ BitVec 64))
(declare-fun x2_ack!1058 () (_ BitVec 64))
(declare-fun x1_ack!1057 () (_ BitVec 64))
(declare-fun y1_ack!1059 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1060)
                    ((_ to_fp 11 53) e0_ack!1060))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1061)
                    ((_ to_fp 11 53) e1_ack!1061))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1062)
                    ((_ to_fp 11 53) e2_ack!1062))
            ((_ to_fp 11 53) #x0000000000000000))))
