(declare-fun e0_ack!1940 () (_ BitVec 64))
(declare-fun e1_ack!1941 () (_ BitVec 64))
(declare-fun e2_ack!1942 () (_ BitVec 64))
(declare-fun x2_ack!1939 () (_ BitVec 64))
(declare-fun x1_ack!1938 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1940)
                    ((_ to_fp 11 53) e0_ack!1940))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1941)
                    ((_ to_fp 11 53) e1_ack!1941))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1942)
                    ((_ to_fp 11 53) e2_ack!1942))
            ((_ to_fp 11 53) #x0000000000000000))))
