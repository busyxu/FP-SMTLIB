(declare-fun e0_ack!976 () (_ BitVec 64))
(declare-fun e1_ack!977 () (_ BitVec 64))
(declare-fun e2_ack!978 () (_ BitVec 64))
(declare-fun x2_ack!974 () (_ BitVec 64))
(declare-fun x1_ack!973 () (_ BitVec 64))
(declare-fun y1_ack!975 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!976)
                    ((_ to_fp 11 53) e0_ack!976))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!977)
                    ((_ to_fp 11 53) e1_ack!977))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!978)
                    ((_ to_fp 11 53) e2_ack!978))
            ((_ to_fp 11 53) #x0000000000000000))))
