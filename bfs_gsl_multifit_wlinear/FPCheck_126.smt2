(declare-fun e0_ack!657 () (_ BitVec 64))
(declare-fun e1_ack!658 () (_ BitVec 64))
(declare-fun e2_ack!659 () (_ BitVec 64))
(declare-fun x2_ack!656 () (_ BitVec 64))
(declare-fun x1_ack!655 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!657)
                    ((_ to_fp 11 53) e0_ack!657))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!658)
                    ((_ to_fp 11 53) e1_ack!658))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!659)
                    ((_ to_fp 11 53) e2_ack!659))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x3cb0000000000000
    (fp.add roundNearestTiesToEven (fp.abs a!2) (fp.abs a!5)))))))
