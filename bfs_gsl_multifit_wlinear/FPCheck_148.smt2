(declare-fun e0_ack!1048 () (_ BitVec 64))
(declare-fun e1_ack!1049 () (_ BitVec 64))
(declare-fun e2_ack!1050 () (_ BitVec 64))
(declare-fun x2_ack!1046 () (_ BitVec 64))
(declare-fun x1_ack!1045 () (_ BitVec 64))
(declare-fun y1_ack!1047 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1048)
                    ((_ to_fp 11 53) e0_ack!1048))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1049)
                    ((_ to_fp 11 53) e1_ack!1049))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1050)
                    ((_ to_fp 11 53) e2_ack!1050))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!1045)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!1046)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
