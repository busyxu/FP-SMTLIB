(declare-fun e0_ack!1024 () (_ BitVec 64))
(declare-fun e1_ack!1025 () (_ BitVec 64))
(declare-fun e2_ack!1026 () (_ BitVec 64))
(declare-fun x2_ack!1022 () (_ BitVec 64))
(declare-fun x1_ack!1021 () (_ BitVec 64))
(declare-fun y1_ack!1023 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1024)
                    ((_ to_fp 11 53) e0_ack!1024))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1025)
                    ((_ to_fp 11 53) e1_ack!1025))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1026)
                    ((_ to_fp 11 53) e2_ack!1026))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!1021)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!1022)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
