(declare-fun e0_ack!1269 () (_ BitVec 64))
(declare-fun e1_ack!1270 () (_ BitVec 64))
(declare-fun e2_ack!1271 () (_ BitVec 64))
(declare-fun x2_ack!1266 () (_ BitVec 64))
(declare-fun x1_ack!1265 () (_ BitVec 64))
(declare-fun y1_ack!1267 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y2_ack!1268 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1269)
                    ((_ to_fp 11 53) e0_ack!1269))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1270)
                    ((_ to_fp 11 53) e1_ack!1270))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1271)
                    ((_ to_fp 11 53) e2_ack!1271))
            ((_ to_fp 11 53) #x0000000000000000))))
