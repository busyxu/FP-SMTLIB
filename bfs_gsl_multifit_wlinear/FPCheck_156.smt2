(declare-fun e0_ack!1180 () (_ BitVec 64))
(declare-fun e1_ack!1181 () (_ BitVec 64))
(declare-fun e2_ack!1182 () (_ BitVec 64))
(declare-fun x2_ack!1178 () (_ BitVec 64))
(declare-fun x1_ack!1177 () (_ BitVec 64))
(declare-fun y1_ack!1179 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1180)
                    ((_ to_fp 11 53) e0_ack!1180))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1181)
                    ((_ to_fp 11 53) e1_ack!1181))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1182)
                    ((_ to_fp 11 53) e2_ack!1182))
            ((_ to_fp 11 53) #x0000000000000000))))
