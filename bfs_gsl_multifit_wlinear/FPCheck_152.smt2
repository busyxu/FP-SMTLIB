(declare-fun e0_ack!1108 () (_ BitVec 64))
(declare-fun e1_ack!1109 () (_ BitVec 64))
(declare-fun e2_ack!1110 () (_ BitVec 64))
(declare-fun x2_ack!1106 () (_ BitVec 64))
(declare-fun x1_ack!1105 () (_ BitVec 64))
(declare-fun y1_ack!1107 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1108)
                    ((_ to_fp 11 53) e0_ack!1108))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1109)
                    ((_ to_fp 11 53) e1_ack!1109))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1110)
                    ((_ to_fp 11 53) e2_ack!1110))
            ((_ to_fp 11 53) #x0000000000000000))))
