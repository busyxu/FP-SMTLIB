(declare-fun e0_ack!682 () (_ BitVec 64))
(declare-fun e1_ack!683 () (_ BitVec 64))
(declare-fun e2_ack!684 () (_ BitVec 64))
(declare-fun x2_ack!681 () (_ BitVec 64))
(declare-fun x1_ack!680 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!682)
                    ((_ to_fp 11 53) e0_ack!682))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!683)
                    ((_ to_fp 11 53) e1_ack!683))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!684)
                    ((_ to_fp 11 53) e2_ack!684))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!680)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!681)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!2 #x3fe618dab0184066))))
