(declare-fun e0_ack!1216 () (_ BitVec 64))
(declare-fun e1_ack!1217 () (_ BitVec 64))
(declare-fun e2_ack!1218 () (_ BitVec 64))
(declare-fun x2_ack!1214 () (_ BitVec 64))
(declare-fun x1_ack!1213 () (_ BitVec 64))
(declare-fun y1_ack!1215 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1216)
                    ((_ to_fp 11 53) e0_ack!1216))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1217)
                    ((_ to_fp 11 53) e1_ack!1217))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1218)
                    ((_ to_fp 11 53) e2_ack!1218))
            ((_ to_fp 11 53) #x0000000000000000))))
