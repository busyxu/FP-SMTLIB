(declare-fun e0_ack!1282 () (_ BitVec 64))
(declare-fun e1_ack!1283 () (_ BitVec 64))
(declare-fun e2_ack!1284 () (_ BitVec 64))
(declare-fun x2_ack!1280 () (_ BitVec 64))
(declare-fun x1_ack!1279 () (_ BitVec 64))
(declare-fun y1_ack!1281 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1282)
                    ((_ to_fp 11 53) e0_ack!1282))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1283)
                    ((_ to_fp 11 53) e1_ack!1283))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1284)
                    ((_ to_fp 11 53) e2_ack!1284))
            ((_ to_fp 11 53) #x0000000000000000))))
