(declare-fun e0_ack!1485 () (_ BitVec 64))
(declare-fun e1_ack!1486 () (_ BitVec 64))
(declare-fun e2_ack!1487 () (_ BitVec 64))
(declare-fun x2_ack!1484 () (_ BitVec 64))
(declare-fun x1_ack!1483 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1485)
                    ((_ to_fp 11 53) e0_ack!1485))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1486)
                    ((_ to_fp 11 53) e1_ack!1486))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1487)
                    ((_ to_fp 11 53) e2_ack!1487))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           a!2)
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FMUL_OVERFLOW a!3 #x4000000000000000))))
