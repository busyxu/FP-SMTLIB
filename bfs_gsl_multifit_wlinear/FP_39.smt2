(declare-fun e0_ack!1168 () (_ BitVec 64))
(declare-fun e1_ack!1169 () (_ BitVec 64))
(declare-fun e2_ack!1170 () (_ BitVec 64))
(declare-fun x2_ack!1166 () (_ BitVec 64))
(declare-fun x1_ack!1165 () (_ BitVec 64))
(declare-fun y1_ack!1167 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1168)
                    ((_ to_fp 11 53) e0_ack!1168))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1169)
                    ((_ to_fp 11 53) e1_ack!1169))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1170)
                    ((_ to_fp 11 53) e2_ack!1170))
            ((_ to_fp 11 53) #x0000000000000000))))
