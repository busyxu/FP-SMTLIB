(declare-fun e0_ack!537 () (_ BitVec 64))
(declare-fun e1_ack!538 () (_ BitVec 64))
(declare-fun e2_ack!539 () (_ BitVec 64))
(declare-fun x2_ack!536 () (_ BitVec 64))
(declare-fun x1_ack!535 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!537)
                    ((_ to_fp 11 53) e0_ack!537))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!538)
                    ((_ to_fp 11 53) e1_ack!538))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!539)
                    ((_ to_fp 11 53) e2_ack!539))
            ((_ to_fp 11 53) #x0000000000000000))))
