(declare-fun e0_ack!1905 () (_ BitVec 64))
(declare-fun e1_ack!1906 () (_ BitVec 64))
(declare-fun e2_ack!1907 () (_ BitVec 64))
(declare-fun x2_ack!1904 () (_ BitVec 64))
(declare-fun x1_ack!1903 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1905)
                    ((_ to_fp 11 53) e0_ack!1905))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1906)
                    ((_ to_fp 11 53) e1_ack!1906))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1907)
                    ((_ to_fp 11 53) e2_ack!1907))
            ((_ to_fp 11 53) #x0000000000000000))))
