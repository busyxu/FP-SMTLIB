(declare-fun e0_ack!953 () (_ BitVec 64))
(declare-fun e1_ack!954 () (_ BitVec 64))
(declare-fun e2_ack!955 () (_ BitVec 64))
(declare-fun x2_ack!952 () (_ BitVec 64))
(declare-fun x1_ack!951 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!953)
                    ((_ to_fp 11 53) e0_ack!953))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!954)
                    ((_ to_fp 11 53) e1_ack!954))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!955)
                    ((_ to_fp 11 53) e2_ack!955))
            ((_ to_fp 11 53) #x0000000000000000))))
