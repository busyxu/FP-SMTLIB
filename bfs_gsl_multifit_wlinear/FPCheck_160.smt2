(declare-fun e0_ack!1228 () (_ BitVec 64))
(declare-fun e1_ack!1229 () (_ BitVec 64))
(declare-fun e2_ack!1230 () (_ BitVec 64))
(declare-fun x2_ack!1226 () (_ BitVec 64))
(declare-fun x1_ack!1225 () (_ BitVec 64))
(declare-fun y1_ack!1227 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1228)
                    ((_ to_fp 11 53) e0_ack!1228))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1229)
                    ((_ to_fp 11 53) e1_ack!1229))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1230)
                    ((_ to_fp 11 53) e2_ack!1230))
            ((_ to_fp 11 53) #x0000000000000000))))
