(declare-fun e0_ack!2145 () (_ BitVec 64))
(declare-fun e1_ack!2146 () (_ BitVec 64))
(declare-fun e2_ack!2147 () (_ BitVec 64))
(declare-fun x2_ack!2144 () (_ BitVec 64))
(declare-fun x1_ack!2143 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2145)
                    ((_ to_fp 11 53) e0_ack!2145))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2146)
                    ((_ to_fp 11 53) e1_ack!2146))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2147)
                    ((_ to_fp 11 53) e2_ack!2147))
            ((_ to_fp 11 53) #x0000000000000000))))
