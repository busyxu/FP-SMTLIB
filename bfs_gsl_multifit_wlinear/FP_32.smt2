(declare-fun e0_ack!943 () (_ BitVec 64))
(declare-fun e1_ack!944 () (_ BitVec 64))
(declare-fun e2_ack!945 () (_ BitVec 64))
(declare-fun x2_ack!942 () (_ BitVec 64))
(declare-fun x1_ack!941 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!943)
                    ((_ to_fp 11 53) e0_ack!943))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!944)
                    ((_ to_fp 11 53) e1_ack!944))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!945)
                    ((_ to_fp 11 53) e2_ack!945))
            ((_ to_fp 11 53) #x0000000000000000))))
