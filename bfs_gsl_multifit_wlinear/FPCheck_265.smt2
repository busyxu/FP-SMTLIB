(declare-fun e0_ack!2375 () (_ BitVec 64))
(declare-fun e1_ack!2376 () (_ BitVec 64))
(declare-fun e2_ack!2377 () (_ BitVec 64))
(declare-fun x2_ack!2374 () (_ BitVec 64))
(declare-fun x1_ack!2373 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2375)
                    ((_ to_fp 11 53) e0_ack!2375))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2376)
                    ((_ to_fp 11 53) e1_ack!2376))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2377)
                    ((_ to_fp 11 53) e2_ack!2377))
            ((_ to_fp 11 53) #x0000000000000000))))
