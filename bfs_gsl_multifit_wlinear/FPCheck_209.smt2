(declare-fun e0_ack!1795 () (_ BitVec 64))
(declare-fun e1_ack!1796 () (_ BitVec 64))
(declare-fun e2_ack!1797 () (_ BitVec 64))
(declare-fun x2_ack!1794 () (_ BitVec 64))
(declare-fun x1_ack!1793 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1795)
                    ((_ to_fp 11 53) e0_ack!1795))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1796)
                    ((_ to_fp 11 53) e1_ack!1796))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1797)
                    ((_ to_fp 11 53) e2_ack!1797))
            ((_ to_fp 11 53) #x0000000000000000))))
