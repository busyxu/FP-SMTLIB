(declare-fun e0_ack!477 () (_ BitVec 64))
(declare-fun e1_ack!478 () (_ BitVec 64))
(declare-fun e2_ack!479 () (_ BitVec 64))
(declare-fun x2_ack!476 () (_ BitVec 64))
(declare-fun x1_ack!475 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!477)
                    ((_ to_fp 11 53) e0_ack!477))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!478)
                    ((_ to_fp 11 53) e1_ack!478))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!479)
                    ((_ to_fp 11 53) e2_ack!479))
            ((_ to_fp 11 53) #x0000000000000000))))
