(declare-fun e0_ack!1625 () (_ BitVec 64))
(declare-fun e1_ack!1626 () (_ BitVec 64))
(declare-fun e2_ack!1627 () (_ BitVec 64))
(declare-fun x2_ack!1624 () (_ BitVec 64))
(declare-fun x1_ack!1623 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1625)
                    ((_ to_fp 11 53) e0_ack!1625))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1626)
                    ((_ to_fp 11 53) e1_ack!1626))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1627)
                    ((_ to_fp 11 53) e2_ack!1627))
            ((_ to_fp 11 53) #x0000000000000000))))
