(declare-fun e0_ack!1096 () (_ BitVec 64))
(declare-fun e1_ack!1097 () (_ BitVec 64))
(declare-fun e2_ack!1098 () (_ BitVec 64))
(declare-fun x2_ack!1094 () (_ BitVec 64))
(declare-fun x1_ack!1093 () (_ BitVec 64))
(declare-fun y1_ack!1095 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1096)
                    ((_ to_fp 11 53) e0_ack!1096))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1097)
                    ((_ to_fp 11 53) e1_ack!1097))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1098)
                    ((_ to_fp 11 53) e2_ack!1098))
            ((_ to_fp 11 53) #x0000000000000000))))
