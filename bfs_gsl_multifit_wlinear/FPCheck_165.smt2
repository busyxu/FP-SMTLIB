(declare-fun e0_ack!1309 () (_ BitVec 64))
(declare-fun e1_ack!1310 () (_ BitVec 64))
(declare-fun e2_ack!1311 () (_ BitVec 64))
(declare-fun x2_ack!1306 () (_ BitVec 64))
(declare-fun x1_ack!1305 () (_ BitVec 64))
(declare-fun y1_ack!1307 () (_ BitVec 64))
(declare-fun y2_ack!1308 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1309)
                    ((_ to_fp 11 53) e0_ack!1309))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1310)
                    ((_ to_fp 11 53) e1_ack!1310))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1311)
                    ((_ to_fp 11 53) e2_ack!1311))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (fp.leq a!2 ((_ to_fp 11 53) #x3ca618dab0184066)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!1306)
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!2
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (fp.leq a!3 ((_ to_fp 11 53) #x3ca618dab0184066))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y1_ack!1307)
                                   ((_ to_fp 11 53) #x409f400000000000)))
                   ((_ to_fp 11 53) #xbfe6a09e667f3bcc))))
