(declare-fun e0_ack!767 () (_ BitVec 64))
(declare-fun e1_ack!768 () (_ BitVec 64))
(declare-fun e2_ack!769 () (_ BitVec 64))
(declare-fun x2_ack!764 () (_ BitVec 64))
(declare-fun x1_ack!763 () (_ BitVec 64))
(declare-fun y1_ack!765 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y2_ack!766 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!767)
                    ((_ to_fp 11 53) e0_ack!767))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!768)
                    ((_ to_fp 11 53) e1_ack!768))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!769)
                    ((_ to_fp 11 53) e2_ack!769))
            ((_ to_fp 11 53) #x0000000000000000))))
