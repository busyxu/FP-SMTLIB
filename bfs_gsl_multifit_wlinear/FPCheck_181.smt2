(declare-fun e0_ack!1505 () (_ BitVec 64))
(declare-fun e1_ack!1506 () (_ BitVec 64))
(declare-fun e2_ack!1507 () (_ BitVec 64))
(declare-fun x2_ack!1504 () (_ BitVec 64))
(declare-fun x1_ack!1503 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1505)
                    ((_ to_fp 11 53) e0_ack!1505))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1506)
                    ((_ to_fp 11 53) e1_ack!1506))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1507)
                    ((_ to_fp 11 53) e2_ack!1507))
            ((_ to_fp 11 53) #x0000000000000000))))
