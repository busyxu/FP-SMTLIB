(declare-fun e0_ack!1144 () (_ BitVec 64))
(declare-fun e1_ack!1145 () (_ BitVec 64))
(declare-fun e2_ack!1146 () (_ BitVec 64))
(declare-fun x2_ack!1142 () (_ BitVec 64))
(declare-fun x1_ack!1141 () (_ BitVec 64))
(declare-fun y1_ack!1143 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1144)
                    ((_ to_fp 11 53) e0_ack!1144))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1145)
                    ((_ to_fp 11 53) e1_ack!1145))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1146)
                    ((_ to_fp 11 53) e2_ack!1146))
            ((_ to_fp 11 53) #x0000000000000000))))
