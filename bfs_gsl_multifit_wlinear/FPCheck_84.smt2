(declare-fun e0_ack!447 () (_ BitVec 64))
(declare-fun e1_ack!448 () (_ BitVec 64))
(declare-fun e2_ack!449 () (_ BitVec 64))
(declare-fun x2_ack!446 () (_ BitVec 64))
(declare-fun x1_ack!445 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!447)
                    ((_ to_fp 11 53) e0_ack!447))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!448)
                    ((_ to_fp 11 53) e1_ack!448))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!449)
                    ((_ to_fp 11 53) e2_ack!449))
            ((_ to_fp 11 53) #x0000000000000000))))
