...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (fp.leq ((_ to_fp 11 53) a_ack!363) ((_ to_fp 11 53) #x4014000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!363) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!363) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!363) ((_ to_fp 11 53) #xc033000000000000)))
