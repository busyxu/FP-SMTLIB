...
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!156) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!156) ((_ to_fp 11 53) #xc033000000000000))))
...
(assert (let ((a!1 (CF_pow #x4000000000000000
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         a!1))
         a!1)))
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 a_ack!156))
