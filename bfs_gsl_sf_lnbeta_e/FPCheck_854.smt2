...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2562) ((_ to_fp 11 53) b_ack!2561))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2562) ((_ to_fp 11 53) b_ack!2561)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2562) ((_ to_fp 11 53) #x4024000000000000)))
