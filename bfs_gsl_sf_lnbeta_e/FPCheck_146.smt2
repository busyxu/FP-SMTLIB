...
(assert (fp.gt ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) b_ack!439)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!440) ((_ to_fp 11 53) b_ack!439))))
(assert (not (fp.lt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!439)
                    ((_ to_fp 11 53) a_ack!440))
            ((_ to_fp 11 53) #x3fc999999999999a))))
(assert (FPCHECK_FADD_ACCURACY a_ack!440 b_ack!439))
