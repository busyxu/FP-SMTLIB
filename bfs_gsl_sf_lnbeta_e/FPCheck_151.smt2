...
(assert (fp.gt ((_ to_fp 11 53) b_ack!461) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!462) ((_ to_fp 11 53) b_ack!461))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!462) ((_ to_fp 11 53) b_ack!461)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) b_ack!461))
       ((_ to_fp 11 53) a_ack!462)))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!462 #x3ff0000000000000))
