...
(assert (fp.gt ((_ to_fp 11 53) b_ack!387) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!388) ((_ to_fp 11 53) b_ack!387))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!388) ((_ to_fp 11 53) b_ack!387))))
...
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!388 #x3ff0000000000000))
