...
(assert (fp.gt ((_ to_fp 11 53) b_ack!385) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!386) ((_ to_fp 11 53) b_ack!385))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!386) ((_ to_fp 11 53) b_ack!385))))
...
(assert (FPCHECK_FSUB_OVERFLOW a_ack!386 #x3ff0000000000000))
