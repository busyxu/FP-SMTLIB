...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1156) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1155) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1156) ((_ to_fp 11 53) b_ack!1155)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1156) ((_ to_fp 11 53) b_ack!1155))))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) b_ack!1155))
       ((_ to_fp 11 53) a_ack!1156)))
(assert (FPCHECK_FSUB_ACCURACY a_ack!1156 #x3ff0000000000000))
