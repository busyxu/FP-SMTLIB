...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1440) ((_ to_fp 11 53) b_ack!1439))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1440) ((_ to_fp 11 53) b_ack!1439)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1440) ((_ to_fp 11 53) #x4024000000000000)))
