...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2212) ((_ to_fp 11 53) b_ack!2211)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2212) ((_ to_fp 11 53) b_ack!2211))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2212) ((_ to_fp 11 53) #x4000000000000000)))
