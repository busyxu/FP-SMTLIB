...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1370) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1369) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1370) ((_ to_fp 11 53) b_ack!1369))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1370) ((_ to_fp 11 53) b_ack!1369)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1370) ((_ to_fp 11 53) #x4024000000000000)))
