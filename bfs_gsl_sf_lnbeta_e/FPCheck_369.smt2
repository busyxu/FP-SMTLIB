...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1102) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!1102) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1101) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1102) ((_ to_fp 11 53) b_ack!1101))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1102) ((_ to_fp 11 53) b_ack!1101))))
