...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2084) ((_ to_fp 11 53) b_ack!2083)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2084) ((_ to_fp 11 53) b_ack!2083))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2084) ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!2084 #x3ff0000000000000))
