...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!173 b_ack!171))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!173 b_ack!171))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!173 b_ack!171))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 (fp.abs ((_ to_fp 11 53) c_ack!172))))
