...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!179) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!179) ((_ to_fp 11 53) #x0004000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!179))
...
(assert (let ((a!1 (CF_floor (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.abs ((_ to_fp 11 53) b_ack!179))
    (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3fe921fb40000000)))))
