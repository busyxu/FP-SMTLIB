...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1058) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1057) ((_ to_fp 11 53) #x4000000000000000))))
...
(let ((a!23 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY a!23 (fp.add roundNearestTiesToEven a!21 a!16))))))))))))))
