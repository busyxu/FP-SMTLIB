(declare-fun nu1_ack!840 () (_ BitVec 64))
(declare-fun nu2_ack!841 () (_ BitVec 64))
(declare-fun x_ack!842 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (and (fp.eq ((_ to_fp 11 53) nu2_ack!841)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) nu1_ack!840)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!842)
       (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) nu2_ack!841)
               ((_ to_fp 11 53) nu1_ack!840))))
