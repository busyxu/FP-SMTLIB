...
(assert (fp.lt ((_ to_fp 11 53) a_ack!10) ((_ to_fp 11 53) #x3e66a09e667f3bcd)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!10) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) #x3feb00839f875d26)
                       (CF_pow a_ack!10 #x3fd5555555555555))
               ((_ to_fp 11 53) #x3feb00839f875d26))
       (CF_pow a_ack!10 #x3fd5555555555555)))
(assert (not (fp.eq (fp.abs (CF_pow a_ack!10 #x3fd5555555555555))
