...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!748) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!748) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!748) ((_ to_fp 11 53) #x4010000000000000)))
