...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!358) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!358) ((_ to_fp 11 53) #x4010000000000000)))
(assert (= #x00000000 (bvand b_ack!357 #x00000007)))
