...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!776) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!776) ((_ to_fp 11 53) #x4010000000000000)))
...
(let ((a!16 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         a!16
                         ((_ to_fp 11 53) #xbedb71ef39d04e14))
                 a!16)
         ((_ to_fp 11 53) #xbedb71ef39d04e14)))))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
