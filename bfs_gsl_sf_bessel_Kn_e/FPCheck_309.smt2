...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!399) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!11
                                    ((_ to_fp 11 53) #xbe40afa9d3cdef4f))))))
  (FPCHECK_FADD_ACCURACY a!14 #x3ed0d595dd239ad5))))))))))))))))
