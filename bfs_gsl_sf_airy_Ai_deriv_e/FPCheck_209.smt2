...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) a_ack!620) ((_ to_fp 11 53) #xbff0000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!620) ((_ to_fp 11 53) #xc010000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!620) ((_ to_fp 11 53) #xc000000000000000)))
