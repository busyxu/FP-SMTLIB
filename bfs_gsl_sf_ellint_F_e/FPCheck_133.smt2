(declare-fun c_ack!773 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!773 #x00000007)))
       #x0000000000000011))
...
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3fe0000000000000))))
      (a!6 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!773 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!774)
...
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x400921fb54442d18)))))
      (a!4 (concat (select const_arr10 (bvadd #x00000002 a!3))
                   (concat (select const_arr10 (bvadd #x00000001 a!3))
                           (select const_arr10 a!3)))))
(let ((a!5 (concat (select const_arr10 (bvadd #x00000004 a!3))
                   (concat (select const_arr10 (bvadd #x00000003 a!3)) a!4)))
      (a!8 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!772))
                           (fp.mul roundNearestTiesToEven a!2 a!2)))))
(let ((a!6 (concat (select const_arr10 (bvadd #x00000006 a!3))
                   (concat (select const_arr10 (bvadd #x00000005 a!3)) a!5)))
...
(let ((a!7 ((_ to_fp 11 53)
             (concat (select const_arr10 (bvadd #x00000007 a!3)) a!6)))
...
(let ((a!18 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!17)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_OVERFLOW a!2 (fp.mul roundNearestTiesToEven a!7 (fp.abs a!18)))))))))))))
