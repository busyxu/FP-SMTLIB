(declare-fun c_ack!794 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!794 #x00000007)))
       #x0000000000000011))
...
(assert (let ((a!1 (CF_floor (fp.add roundNearestTiesToEven
                             ...
                             ((_ to_fp 11 53) #x3fe0000000000000))))
      (a!6 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!794 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!795)
...
(let ((a!2 (CF_sin (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x400921fb54442d18)))))
      (a!15 (concat (select const_arr10 (bvadd #x00000002 a!14))
                    (concat (select const_arr10 (bvadd #x00000001 a!14))
                            (select const_arr10 a!14)))))
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!793))
                           (fp.mul roundNearestTiesToEven a!2 a!2))))
      (a!16 (concat (select const_arr10 (bvadd #x00000004 a!14))
                    (concat (select const_arr10 (bvadd #x00000003 a!14)) a!15))))
(let ((a!4 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                           ...
                           a!3)
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!17 (concat (select const_arr10 (bvadd #x00000006 a!14))
                    (concat (select const_arr10 (bvadd #x00000005 a!14)) a!16))))
(let ((a!5 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   a!4
      ...
      (a!8 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4008000000000000))))
      (a!18 ((_ to_fp 11 53)
              (concat (select const_arr10 (bvadd #x00000007 a!14)) a!17))))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!12)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!19 (fp.abs (fp.mul roundNearestTiesToEven
                            a!2
                            (fp.mul roundNearestTiesToEven a!18 (fp.abs a!13))))))
