...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1344) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1344) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!1345) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1344)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1345)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1345) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1345) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1344) ((_ to_fp 11 53) #x4014000000000000)))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (CF_log b_ack!1344)))))
  (fp.eq a!2 a!1))))
(assert (FPCHECK_FADD_OVERFLOW #xc001766553058d6b (CF_log b_ack!1344)))
