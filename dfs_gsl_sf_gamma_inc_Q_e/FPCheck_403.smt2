...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1478)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1479)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1479) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1479) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1478) ((_ to_fp 11 53) #x4014000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (CF_log b_ack!1478))
       ((_ to_fp 11 53) #x3fefda591b88c85d)))
(assert (FPCHECK_FADD_ACCURACY #x400854a14d3a92e3 (CF_log b_ack!1478)))
