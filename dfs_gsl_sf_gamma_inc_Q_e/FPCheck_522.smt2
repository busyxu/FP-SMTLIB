...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1962)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1963)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1963) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1963) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1962) ((_ to_fp 11 53) #x4014000000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #xc0011420a97c81ac)
                         (CF_log b_ack!1962)))))))
(assert (FPCHECK_FADD_UNDERFLOW #x4024af6cecd86415 (CF_log b_ack!1962)))
