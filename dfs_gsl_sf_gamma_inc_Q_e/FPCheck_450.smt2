...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1678)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1679)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1679) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1679) ((_ to_fp 11 53) #x3fc999999999999a)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #xbffea13fc987f9e0)
                         (CF_log b_ack!1678)))))))
(assert (FPCHECK_FADD_UNDERFLOW #x3ff632846dc55ecc (CF_log b_ack!1678)))
