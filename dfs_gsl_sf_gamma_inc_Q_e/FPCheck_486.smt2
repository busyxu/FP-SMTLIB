...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1814)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1815)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1815) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1815) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1814) ((_ to_fp 11 53) #x4014000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (CF_log b_ack!1814))
       ((_ to_fp 11 53) #x4022a491a5eeb992)))
(assert (FPCHECK_FADD_UNDERFLOW #xbffac979781a4eb6 (CF_log b_ack!1814)))
