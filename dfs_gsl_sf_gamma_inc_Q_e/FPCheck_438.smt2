...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1626)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1627)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1627) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1627) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1626) ((_ to_fp 11 53) #x4014000000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #xbffea13fc987f9e0)
                         (CF_log b_ack!1626)))))))
(assert (FPCHECK_FADD_UNDERFLOW #xbfe757804515fa20 (CF_log b_ack!1626)))
