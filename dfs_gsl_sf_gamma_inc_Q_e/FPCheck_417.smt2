...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1539) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1538)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1539)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1539) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1539) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1538) ((_ to_fp 11 53) #x4014000000000000)))
