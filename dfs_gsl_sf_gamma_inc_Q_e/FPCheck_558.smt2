...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2118)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2119)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2119) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2119) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2118) ((_ to_fp 11 53) #x4014000000000000)))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4022a491a5eeb992)
                                    (CF_log b_ack!2118))))))
  (fp.eq a!11 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!2119) a!9))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbec71de3a556c736)
                           (fp.add roundNearestTiesToEven
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (CF_log b_ack!2118)))
                    a!25)))
  (FPCHECK_FMUL_UNDERFLOW a_ack!2119 a!26))))))))))))
