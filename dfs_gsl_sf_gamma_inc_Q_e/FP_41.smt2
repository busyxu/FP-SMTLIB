...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!576)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!577)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!577) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!577) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!576) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!577) ((_ to_fp 11 53) b_ack!576)))
(assert (fp.leq ((_ to_fp 11 53) b_ack!576) ((_ to_fp 11 53) #x412e848000000000)))
