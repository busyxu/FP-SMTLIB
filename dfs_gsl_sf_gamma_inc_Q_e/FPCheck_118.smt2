...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!360)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!361)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!361) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!361) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!360) ((_ to_fp 11 53) #x4014000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!361) ((_ to_fp 11 53) b_ack!360)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!360) ((_ to_fp 11 53) #x412e848000000000))))
