...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1880)
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1880) ((_ to_fp 11 53) #x4014000000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #xc0011420a97c81ac)
                         (CF_log b_ack!1880)))))))
(assert (FPCHECK_FADD_OVERFLOW #x3fdc27e6621d6a75 (CF_log b_ack!1880)))
