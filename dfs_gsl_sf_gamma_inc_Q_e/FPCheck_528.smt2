...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1984)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1985)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1985) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1985) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1984) ((_ to_fp 11 53) #x4014000000000000)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (CF_log b_ack!1984)))))
  (FPCHECK_FMUL_UNDERFLOW a_ack!1985 a!5)))))))
