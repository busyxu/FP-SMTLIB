...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2148) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2148)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!2149)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!2149) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2149) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2148) ((_ to_fp 11 53) #x4014000000000000)))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4022a491a5eeb992)
                                    (CF_log b_ack!2148))))))
  (fp.eq a!11 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!2149) a!9))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbec71de3a556c736)
                           (fp.add roundNearestTiesToEven
...
(let ((a!28 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            a!2
            (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!2149) a!28))))))))))))))
