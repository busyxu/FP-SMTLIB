...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1574)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1575)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1575) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1575) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1574) ((_ to_fp 11 53) #x4014000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (CF_log b_ack!1574))
       ((_ to_fp 11 53) #xc00698442a97b713)))
(assert (FPCHECK_FADD_UNDERFLOW #xbffea13fc987f9e0 (CF_log b_ack!1574)))
