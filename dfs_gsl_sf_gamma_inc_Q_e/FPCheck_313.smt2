...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1108)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1109)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1109) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1109) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1108) ((_ to_fp 11 53) #x4014000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (CF_log b_ack!1108))
       ((_ to_fp 11 53) #x40106e22afa35265)))
(assert (FPCHECK_FADD_ACCURACY #x3ffebde3ab85424e (CF_log b_ack!1108)))
