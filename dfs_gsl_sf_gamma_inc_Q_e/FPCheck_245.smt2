...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!822)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!823)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!823) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!823) ((_ to_fp 11 53) #x3fc999999999999a)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (CF_log b_ack!822))
       ((_ to_fp 11 53) #xbffc21c3e15d140a)))
(assert (FPCHECK_FADD_OVERFLOW #x3fe72ad94dc1fec8 (CF_log b_ack!822)))
