...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1888)
             (fp.mul roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3fe0000000000000)
                     ((_ to_fp 11 53) a_ack!1889)))))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!1889) ((_ to_fp 11 53) #x412e848000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!1889) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1888) ((_ to_fp 11 53) #x4014000000000000)))
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #xc0011420a97c81ac)
                         (CF_log b_ack!1888)))))))
(assert (FPCHECK_FADD_ACCURACY #x3fdc27e6621d6a75 (CF_log b_ack!1888)))
