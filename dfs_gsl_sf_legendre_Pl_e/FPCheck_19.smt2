...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!76) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!76) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (= #x00000000 a_ack!77)))
(assert (not (= #x00000001 a_ack!77)))
(assert (not (= #x00000002 a_ack!77)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!76) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!76) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!77 #x000186a0)))
