...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!178) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (= #x00000000 a_ack!179)))
(assert (not (= #x00000001 a_ack!179)))
(assert (not (= #x00000002 a_ack!179)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!178) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!178) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (bvslt a_ack!179 #x000186a0))
(assert (bvsle #x00000002 a_ack!179))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!178))
