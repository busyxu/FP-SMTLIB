...
(assert (not (and (fp.eq ((_ to_fp 11 53) nu2_ack!1234)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) nu1_ack!1233)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!1235)
            (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) nu2_ack!1234)
                    ((_ to_fp 11 53) nu1_ack!1233)))))
