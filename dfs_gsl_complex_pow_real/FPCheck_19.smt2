...
(assert (not (fp.eq ((_ to_fp 11 53) y1_ack!83) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) x1_ack!85))
             (fp.abs ((_ to_fp 11 53) y1_ack!83)))))
(assert (fp.eq ((_ to_fp 11 53) x1_ack!85) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) y1_ack!83) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) y1_ack!83)))
                   ((_ to_fp 11 53) #x7ff0000000000001))))
  (FPCHECK_FMUL_UNDERFLOW
    (CF_exp (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) x_ack!84)))
    (CF_cos (fp.mul roundNearestTiesToEven
                    (CF_atan2 y1_ack!83 x1_ack!85)
