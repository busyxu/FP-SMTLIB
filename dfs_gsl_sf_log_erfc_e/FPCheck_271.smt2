...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!366) ((_ to_fp 11 53) #x4020000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!366))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!366)) a!4)
    #x4007d4b780645377))))))
