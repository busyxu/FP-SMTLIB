...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!391) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!391))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) a_ack!391)) a!2))))
