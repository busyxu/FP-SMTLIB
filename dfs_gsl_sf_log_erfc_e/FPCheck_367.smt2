...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) #x4020000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!533) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!13 (CF_log (fp.sub roundNearestTiesToEven
