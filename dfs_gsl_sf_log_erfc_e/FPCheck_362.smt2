...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!523) ((_ to_fp 11 53) #x4020000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!523) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!523))
