...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!500) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!500))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!500))
