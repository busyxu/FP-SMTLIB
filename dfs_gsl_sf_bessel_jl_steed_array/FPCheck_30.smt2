...
(assert (fp.lt ((_ to_fp 11 53) b_ack!102) ((_ to_fp 11 53) #x3f30000000000000)))
(assert (bvsle #x00000000 a_ack!103))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           ((_ to_fp 11 53) b_ack!102)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!102))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!102))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
