...
(assert (fp.lt ((_ to_fp 11 53) b_ack!184) ((_ to_fp 11 53) #x3f30000000000000)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fe0000000000000)
                           ((_ to_fp 11 53) b_ack!184)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!184))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!184))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!2))))
  (fp.eq a!3 a!1))))
(assert (bvsle #x00000002 a_ack!185))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3fe0000000000000)
