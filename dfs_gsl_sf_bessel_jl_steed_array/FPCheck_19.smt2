...
(assert (fp.lt ((_ to_fp 11 53) b_ack!68) ((_ to_fp 11 53) #x3f30000000000000)))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!68))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         a!1))
         a!1)))
(assert (FPCHECK_FMUL_UNDERFLOW #x3ff0000000000000 b_ack!68))
