...
(assert (fp.lt ((_ to_fp 11 53) b_ack!90) ((_ to_fp 11 53) #x3f30000000000000)))
(assert (bvsle #x00000000 a_ack!91))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         a!1))
         a!1)))
(assert (bvsle #x00000001 a_ack!91))
(assert (FPCHECK_FMUL_ACCURACY #x3fe0000000000000 b_ack!90))
