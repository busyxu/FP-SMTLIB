...
(assert (fp.eq ((_ to_fp 11 53) a_ack!82) (CF_floor a_ack!82)))
(assert (fp.lt (fp.add roundNearestTiesToEven
               ((_ to_fp 11 53) a_ack!82)
               ((_ to_fp 11 53) b_ack!81))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!81) (CF_floor b_ack!81))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!82 b_ack!81))
