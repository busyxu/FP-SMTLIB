...
(assert (fp.gt ((_ to_fp 11 53) a_ack!412) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!411))
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) a_ack!412)))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!412) ((_ to_fp 11 53) #x4000000000000000))))
(assert (FPCHECK_FMUL_OVERFLOW (fp.abs ((_ to_fp 11 53) b_ack!411)) #x3fe62e42fefa39ef))
