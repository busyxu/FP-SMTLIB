...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!534) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!534)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!532))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x40862e2e8418f241)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!534)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!532))))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #xc086231762997524)))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) c_ack!532))))))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!6
    (fp.mul roundNearestTiesToEven a!4 (fp.abs ((_ to_fp 11 53) b_ack!531)))))))))))
