...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!419) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!419)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!418))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x40862e2e8418f241)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!419)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!418))))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #xc086231762997524)))))
(assert (let ((a!1 (CF_floor (CF_log (fp.abs ((_ to_fp 11 53) c_ack!418))))))
...
(let ((a!3 (CF_exp (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (CF_exp (fp.add roundNearestTiesToEven (CF_floor a_ack!419) a!1))
    a!3)))))
