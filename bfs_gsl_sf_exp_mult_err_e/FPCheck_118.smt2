...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!560) ((_ to_fp 11 53) #xc076232bdd7abcd2))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!560)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!559))))))
  (not (fp.gt a!1 ((_ to_fp 11 53) #x40862e2e8418f241)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!560)
                   (CF_log (fp.abs ((_ to_fp 11 53) c_ack!559))))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #xc086231762997524)))))
(assert (FPCHECK_FSUB_UNDERFLOW a_ack!560 (CF_floor a_ack!560)))
