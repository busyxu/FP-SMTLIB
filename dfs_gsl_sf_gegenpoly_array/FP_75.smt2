...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1238) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (bvsle #x00000002 a_ack!1239))
(assert (bvsle #x00000003 a_ack!1239))
...
(assert (bvsle #x00000008 a_ack!1239))
(assert (bvsle #x00000009 a_ack!1239))
