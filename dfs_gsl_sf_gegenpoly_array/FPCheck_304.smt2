...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1394) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (bvsle #x00000002 a_ack!1396))
(assert (bvsle #x00000003 a_ack!1396))
(assert (bvsle #x00000004 a_ack!1396))
(assert (bvsle #x00000005 a_ack!1396))
(assert (bvsle #x00000006 a_ack!1396))
(assert (bvsle #x00000007 a_ack!1396))
(assert (bvsle #x00000008 a_ack!1396))
(assert (bvsle #x00000009 a_ack!1396))
(assert (bvsle #x0000000a a_ack!1396))
