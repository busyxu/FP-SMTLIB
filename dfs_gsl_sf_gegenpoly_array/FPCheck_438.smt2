...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2012) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (bvsle #x00000002 a_ack!2013))
(assert (bvsle #x00000003 a_ack!2013))
...
(assert (bvsle #x0000000d a_ack!2013))
(assert (bvsle #x0000000e a_ack!2013))
(assert (bvsle #x0000000f a_ack!2013))
(assert (FPCHECK_FADD_OVERFLOW #x402e000000000000 b_ack!2012))
