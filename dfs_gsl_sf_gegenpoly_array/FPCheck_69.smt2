...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!317) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (bvsle #x00000002 a_ack!319))
(assert (bvsle #x00000003 a_ack!319))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!318))
