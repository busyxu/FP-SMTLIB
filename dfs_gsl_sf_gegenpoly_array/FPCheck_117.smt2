...
(assert (bvsle #x00000002 a_ack!534))
(assert (bvsle #x00000003 a_ack!534))
(assert (bvsle #x00000004 a_ack!534))
(assert (bvsle #x00000005 a_ack!534))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!1 c_ack!533)))
