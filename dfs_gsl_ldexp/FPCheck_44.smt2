...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!184) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (or (fp.isNaN (fp.abs ((_ to_fp 11 53) x_ack!184)))
               (fp.eq (fp.abs ((_ to_fp 11 53) x_ack!184))
                      ((_ to_fp 11 53) #x7ff0000000000000)))))
  (not a!1)))
(assert (fp.geq (fp.abs ((_ to_fp 11 53) x_ack!184))
        ((_ to_fp 11 53) #x3fe0000000000000)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!184))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) x_ack!184)))
...
(let ((a!2 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd e_ack!183 ((_ fp.to_sbv 32) roundTowardZero (CF_ceil a!1))))))
...
(let ((a!2 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd e_ack!183 ((_ fp.to_sbv 32) roundTowardZero (CF_ceil a!1))))))
  (fp.leq a!2 ((_ to_fp 11 53) #xc08fe80000000000)))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) x_ack!184)))
                   ((_ to_fp 11 53) #x3fe62e42fefa39ef))))
(let ((a!2 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd e_ack!183 ((_ fp.to_sbv 32) roundTowardZero (CF_ceil a!1))))))
  (FPCHECK_FSUB_UNDERFLOW a!2 #xc08fe80000000000))))
