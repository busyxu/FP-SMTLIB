...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!200) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (or (fp.isNaN (fp.abs ((_ to_fp 11 53) x_ack!200)))
               (fp.eq (fp.abs ((_ to_fp 11 53) x_ack!200))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) x_ack!200)))
...
(let ((a!2 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd e_ack!199 ((_ fp.to_sbv 32) roundTowardZero (CF_ceil a!1))))))
