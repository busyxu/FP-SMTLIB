...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!295) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!295) ((_ to_fp 11 53) #x40862e42fefa39ef))))
