...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!442))
            (fp.abs ((_ to_fp 11 53) b_ack!441)))))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!442))
       (fp.abs ((_ to_fp 11 53) b_ack!441))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) a_ack!442)))
                   a!2)))
