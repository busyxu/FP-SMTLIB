...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!344))
            (fp.abs ((_ to_fp 11 53) b_ack!343)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!343)))
                   ((_ to_fp 11 53) #x0010000000000000))))
  (fp.geq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!344))) a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!344))
                           (fp.abs ((_ to_fp 11 53) b_ack!343)))
                   (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!344))
                           (fp.abs ((_ to_fp 11 53) b_ack!343))))))
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!343)))
                   a!2)))
