...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!873) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!874) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!873) ((_ to_fp 11 53) #x4000000000000000))))
...
(let ((a!30 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!27
                                    (fp.add roundNearestTiesToEven a!25 a!23))))))
  (not (fp.eq a!30 ((_ to_fp 11 53) #x0000000000000000)))))))))))))))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!32 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) b_ack!873))
                    a!31)))
  (fp.eq (fp.div roundNearestTiesToEven a!32 a!31)
         (fp.div roundNearestTiesToEven
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x4000000000000000)
                         a!2)
