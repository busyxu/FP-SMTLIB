...
(assert (fp.leq ((_ to_fp 11 53) a_ack!45) ((_ to_fp 11 53) #x4010000000000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           (CF_pow a_ack!45 #x3fd5555555555555))
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   (CF_pow a_ack!45 #x3fd5555555555555)
                                   (CF_pow a_ack!45 #x3fd5555555555555))
                           (fp.mul roundNearestTiesToEven
                                   (CF_pow a_ack!45 #x3fd5555555555555)
                                   (CF_pow a_ack!45 #x3fd5555555555555))))))
  (FPCHECK_FMUL_UNDERFLOW #x3ce0000000000000 (fp.abs a!1))))
