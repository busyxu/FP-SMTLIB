...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!39) ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!39) ((_ to_fp 11 53) #x4010000000000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (CF_pow a_ack!39 #x3fd5555555555555)
                           (CF_pow a_ack!39 #x3fd5555555555555))
                   (fp.mul roundNearestTiesToEven
                           (CF_pow a_ack!39 #x3fd5555555555555)
                           (CF_pow a_ack!39 #x3fd5555555555555)))))
