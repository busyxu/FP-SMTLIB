...
(assert (not (= #xffffffff a_ack!365)))
(assert (not (= #x00000000 a_ack!365)))
(assert (not (= #x00000001 a_ack!365)))
(assert (= #x00000002 a_ack!365))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!364) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!364) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!364) ((_ to_fp 11 53) #x3ff0000000000000)))
