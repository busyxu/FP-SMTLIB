...
(assert (not (bvslt a_ack!567 #xffffffff)))
(assert (not (= #xffffffff a_ack!567)))
(assert (not (= #x00000000 a_ack!567)))
(assert (not (= #x00000001 a_ack!567)))
(assert (= #x00000002 a_ack!567))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!566) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!566) ((_ to_fp 11 53) #xbff0000000000000)))
