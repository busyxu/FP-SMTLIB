...
(assert (not (bvslt a_ack!126 #xffffffff)))
(assert (not (= #xffffffff a_ack!126)))
(assert (= #x00000000 a_ack!126))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!125) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!125) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!125) ((_ to_fp 11 53) #x4024000000000000))))
