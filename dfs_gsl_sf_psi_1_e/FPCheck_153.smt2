...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!223) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!223) ((_ to_fp 11 53) #xc014000000000000)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             ((_ fp.to_sbv 32)
               ...
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       (CF_floor a_ack!223))))))
  (not (fp.eq (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!223) a!1)
...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             ((_ fp.to_sbv 32)
               ...
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       (CF_floor a_ack!223))))))
  (not (fp.leq (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!223) a!1)
               ((_ to_fp 11 53) #x0000000000000000)))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   a!1))
                   ((_ to_fp 11 53) #x4024000000000000))))
  (fp.eq a!2 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!223) a!1)))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
