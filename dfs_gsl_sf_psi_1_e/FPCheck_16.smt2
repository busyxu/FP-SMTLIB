...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!26) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!26) ((_ to_fp 11 53) #xc000000000000000))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!2
         (fp.add roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4024000000000000)
                 ((_ to_fp 11 53) a_ack!26))))))
(assert (FPCHECK_FADD_UNDERFLOW #x4024000000000000 a_ack!26))
