...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!49) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!49) ((_ to_fp 11 53) #xc000000000000000))))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (CF_pow (fp.add roundNearestTiesToEven
                           ...
                           #xc000000000000000))))
  (fp.eq a!4 a!2))))))
(assert (FPCHECK_FADD_OVERFLOW #x3ff0000000000000 a_ack!49))
