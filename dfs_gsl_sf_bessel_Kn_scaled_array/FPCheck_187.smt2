...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!865) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!865) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!865))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW (CF_log c_ack!865) a!5)))))))
