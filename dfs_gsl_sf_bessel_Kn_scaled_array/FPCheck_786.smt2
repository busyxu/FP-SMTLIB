...
(declare-fun b_ack!3261 () (_ BitVec 32))
(declare-fun c_ack!3262 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!3263 #x00000000)))
(assert (not (bvslt b_ack!3261 a_ack!3263)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3262) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!3261)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3262) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3262) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3262) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3262) ((_ to_fp 11 53) #x4020000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4030000000000000)
                                   ((_ to_fp 11 53) c_ack!3262))
...
(let ((a!18 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!16
    (fp.add roundNearestTiesToEven a!18 ((_ to_fp 11 53) #x3d856b2c54b23e51))))))))))))))
