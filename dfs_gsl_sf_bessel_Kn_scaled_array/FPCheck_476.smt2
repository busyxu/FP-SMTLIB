...
(assert (not (bvslt b_ack!2025 a_ack!2027)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2026) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2025))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2026) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2026) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2026) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!12
                                    ((_ to_fp 11 53) #x3e850b0771f4ea8b))))))
  (FPCHECK_FADD_OVERFLOW a!15 #x3f22ef1bcd47bec8)))))))))))))))))
