...
(assert (not (bvsle #x00000001 b_ack!256)))
(assert (not (= #xffffffff (bvsub a_ack!258 b_ack!256))))
(assert (not (= #xfffffffe (bvsub a_ack!258 b_ack!256))))
(assert (not (= (bvsub #x00000002 b_ack!256)
        (bvadd #x00000002 (bvsub a_ack!258 b_ack!256)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!258 b_ack!256))))))
...
(assert (bvslt (bvadd #x00000001 (bvsub a_ack!258 b_ack!256)) #x00000000))
(assert (FPCHECK_FADD_UNDERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #xfffffffe b_ack!256))
  c_ack!257))
