...
(declare-fun b_ack!3883 () (_ BitVec 32))
...
(assert (not (bvsle #x00000001 b_ack!3883)))
(assert (not (= #xffffffff (bvsub a_ack!3885 b_ack!3883))))
(assert (not (= #xfffffffe (bvsub a_ack!3885 b_ack!3883))))
(assert (not (= (bvsub #x00000002 b_ack!3883)
        (bvadd #x00000002 (bvsub a_ack!3885 b_ack!3883)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3885 b_ack!3883))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3883) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3884) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3885 b_ack!3883))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3883) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3884) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3885 b_ack!3883)) #x00000000)))
