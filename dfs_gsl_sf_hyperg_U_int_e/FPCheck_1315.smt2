...
(declare-fun b_ack!4108 () (_ BitVec 32))
...
(assert (not (bvsle #x00000001 b_ack!4108)))
(assert (not (= #xffffffff (bvsub a_ack!4110 b_ack!4108))))
(assert (not (= #xfffffffe (bvsub a_ack!4110 b_ack!4108))))
(assert (not (= (bvsub #x00000002 b_ack!4108)
        (bvadd #x00000002 (bvsub a_ack!4110 b_ack!4108)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4110 b_ack!4108))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!4108) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4109) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4110 b_ack!4108))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4108) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4109) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!4110 b_ack!4108)) #x00000000)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!1)
                   ((_ to_fp 11 53) c_ack!4109))))
  (FPCHECK_FSUB_OVERFLOW a!2 #x4043000000000000))))
