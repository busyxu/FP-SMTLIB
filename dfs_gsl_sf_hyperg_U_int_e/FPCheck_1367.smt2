...
(declare-fun b_ack!4264 () (_ BitVec 32))
...
(assert (not (bvsle #x00000001 b_ack!4264)))
(assert (not (= #xffffffff (bvsub a_ack!4266 b_ack!4264))))
(assert (not (= #xfffffffe (bvsub a_ack!4266 b_ack!4264))))
(assert (not (= (bvsub #x00000002 b_ack!4264)
        (bvadd #x00000002 (bvsub a_ack!4266 b_ack!4264)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4266 b_ack!4264))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!4264) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4265) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4266 b_ack!4264))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4264) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4265) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!4266 b_ack!4264)) #x00000000)))
