...
(assert (not (bvsle #x00000001 b_ack!3493)))
(assert (not (= #xffffffff (bvsub a_ack!3495 b_ack!3493))))
(assert (not (= #xfffffffe (bvsub a_ack!3495 b_ack!3493))))
(assert (not (= (bvsub #x00000002 b_ack!3493)
        (bvadd #x00000002 (bvsub a_ack!3495 b_ack!3493)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3495 b_ack!3493))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3493) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3494) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3495 b_ack!3493))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3493) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3494) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3495 b_ack!3493)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3493))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3494))))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ((_ to_fp 11 53) roundNearestTiesToEven (bvsub #x00000002 b_ack!3493))
    a!1)))
