...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3287) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3287) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3287) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!3286)))
(assert (not (= #xffffffff (bvsub a_ack!3288 b_ack!3286))))
(assert (not (= #xfffffffe (bvsub a_ack!3288 b_ack!3286))))
(assert (not (= (bvsub #x00000002 b_ack!3286)
        (bvadd #x00000002 (bvsub a_ack!3288 b_ack!3286)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3288 b_ack!3286))))))
...
(let ((a!2 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000002 b_ack!3286))))))
  (not (fp.gt a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fefae147ae147ae)
                          (fp.abs ((_ to_fp 11 53) c_ack!3287))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3288 b_ack!3286))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4014000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3286) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3287) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3288 b_ack!3286))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3286) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3287) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3288 b_ack!3286)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3286))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3287))))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ((_ to_fp 11 53) roundNearestTiesToEven (bvsub #x00000002 b_ack!3286))
    a!1)))
