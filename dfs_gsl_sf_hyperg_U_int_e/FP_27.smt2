...
(assert (not (= #xffffffff (bvsub a_ack!369 b_ack!367))))
(assert (not (= #xfffffffe (bvsub a_ack!369 b_ack!367))))
(assert (not (= (bvsub #x00000002 b_ack!367)
        (bvadd #x00000002 (bvsub a_ack!369 b_ack!367)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!369 b_ack!367))))))
