...
(assert (not (= #xffffffff (bvsub a_ack!3624 b_ack!3622))))
(assert (not (= #xfffffffe (bvsub a_ack!3624 b_ack!3622))))
(assert (not (= (bvsub #x00000002 b_ack!3622)
        (bvadd #x00000002 (bvsub a_ack!3624 b_ack!3622)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3624 b_ack!3622))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3622) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3623) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3624 b_ack!3622))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3622) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3623) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3624 b_ack!3622)) #x00000000)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvsub a_ack!3624 b_ack!3622)))
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FADD_ACCURACY a!1 #x4031000000000000)))
