...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3023) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!3022)))
(assert (not (= #xffffffff (bvsub a_ack!3024 b_ack!3022))))
(assert (not (= #xfffffffe (bvsub a_ack!3024 b_ack!3022))))
(assert (not (= (bvsub #x00000002 b_ack!3022)
        (bvadd #x00000002 (bvsub a_ack!3024 b_ack!3022)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3024 b_ack!3022))))))
...
(assert (bvslt (bvsub #x00000002 b_ack!3022) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3023) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!3024 b_ack!3022))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!3022) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3023) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!3024 b_ack!3022)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!3022))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!3023))))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    ...
    ((_ to_fp 11 53) roundNearestTiesToEven (bvsub #x00000002 b_ack!3022)))))
