(declare-fun c_ack!4394 () (_ BitVec 64))
(declare-fun b_ack!4393 () (_ BitVec 32))
(declare-fun a_ack!4395 () (_ BitVec 32))
(declare-fun FPCHECK_FDIV_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4394) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4394) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4394) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvsle #x00000001 b_ack!4393)))
(assert (not (= #xffffffff (bvsub a_ack!4395 b_ack!4393))))
(assert (not (= #xfffffffe (bvsub a_ack!4395 b_ack!4393))))
(assert (not (= (bvsub #x00000002 b_ack!4393)
        (bvadd #x00000002 (bvsub a_ack!4395 b_ack!4393)))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4395 b_ack!4393))))))
...
(let ((a!2 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000002 b_ack!4393))))))
  (not (fp.gt a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
(assert (let ((a!1 (fp.lt ((_ to_fp 11 53) #x3ff0000000000000)
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3fefae147ae147ae)
                          (fp.abs ((_ to_fp 11 53) c_ack!4394))))))
  (not a!1)))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4395 b_ack!4393))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4014000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4393) #x00000005))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4394) ((_ to_fp 11 53) #x4000000000000000))))
(assert (let ((a!1 (fp.abs ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvsub a_ack!4395 b_ack!4393))))))
  (fp.lt a!1 ((_ to_fp 11 53) #x4024000000000000))))
(assert (bvslt (bvsub #x00000002 b_ack!4393) #x0000000a))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4394) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt (bvadd #x00000001 (bvsub a_ack!4395 b_ack!4393)) #x00000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq ((_ to_fp 11 53)
                 roundNearestTiesToEven
                 (bvsub #x00000002 b_ack!4393))
               (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!4394))))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub #x00000002 b_ack!4393))
             ((_ to_fp 11 53) c_ack!4394))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
      ...
      (a!56 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53)
                              roundNearestTiesToEven
                              (bvsub #x00000002 b_ack!4393)))))
      (a!78 (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    (fp.sub roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!3
...
(let ((a!80 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4044000000000000))
                            a!58)
                    (fp.mul roundNearestTiesToEven a!79 a!55)))
      (a!81 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4044000000000000))
                            a!77)
                    (fp.mul roundNearestTiesToEven a!79 a!76))))
  (FPCHECK_FDIV_ACCURACY
    (fp.div roundNearestTiesToEven a!58 a!77)
    (fp.div roundNearestTiesToEven a!80 a!81)))))))))))))))))))))))))
