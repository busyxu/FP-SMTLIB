...
(assert (not (fp.geq ((_ to_fp 11 53) x_ack!170) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq ((_ to_fp 11 53) y_ack!169) ((_ to_fp 11 53) #x0000000000000000)))
(assert (FPCHECK_FDIV_UNDERFLOW y_ack!169 #x7ff0000000000001))
