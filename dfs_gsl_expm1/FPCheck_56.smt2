...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!113) a!1)
                 ((_ to_fp 11 53) a_ack!113))
         a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!113)
                                   ((_ to_fp 11 53) #x4008000000000000))))))
  (fp.eq a!3 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!113) a!1))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!113)
                           ((_ to_fp 11 53) #x3ff0000000000000))
...
(let ((a!3 (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.mul roundNearestTiesToEven
                 (fp.abs a!5)
                 ((_ to_fp 11 53) #x3cb0000000000000)))))))
(assert (FPCHECK_FDIV_ACCURACY a_ack!113 #x4018000000000000))
