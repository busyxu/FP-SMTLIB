...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!147) a!1)
                 ((_ to_fp 11 53) a_ack!147))
         a!1)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!147)
                                   ((_ to_fp 11 53) #x4008000000000000))))))
  (fp.eq a!3 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) a_ack!147) a!1))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) a_ack!147)
                           ((_ to_fp 11 53) #x3ff0000000000000))
...
(let ((a!3 (fp.mul roundNearestTiesToEven
  ...
  (fp.gt (fp.abs a!3)
         (fp.mul roundNearestTiesToEven
                 (fp.abs (fp.add roundNearestTiesToEven a!5 a!3))
                 ((_ to_fp 11 53) #x3cb0000000000000)))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!147)
                                   ((_ to_fp 11 53) #x401c000000000000))))))
  (fp.eq a!7 (fp.add roundNearestTiesToEven a!4 a!5))))))))
