(declare-fun a_ack!6030 () (_ BitVec 32))
(declare-fun b_ack!6029 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!6030)))
(assert (not (= #x00000001 a_ack!6030)))
(assert (not (bvslt a_ack!6030 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6029) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6030)
...
(let ((a!42 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!14)
                            (fp.div roundNearestTiesToEven a!21 a!19)))))
  (FPCHECK_FDIV_ACCURACY a!22 (fp.add roundNearestTiesToEven a!42 a!22))))))))))))))))))))))
