...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5336)))
(assert (not (= #x00000001 a_ack!5336)))
(assert (not (bvslt a_ack!5336 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5335) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5336)
...
(let ((a!25 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!8 a!9)
                                    a!9)))))
  (FPCHECK_FDIV_OVERFLOW a!10 (fp.add roundNearestTiesToEven a!25 a!10)))))))))))))))))
