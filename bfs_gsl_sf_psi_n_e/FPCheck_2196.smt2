(declare-fun a_ack!5994 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!5994)))
(assert (not (= #x00000001 a_ack!5994)))
(assert (not (bvslt a_ack!5994 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5993) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5994)
...
(let ((a!16 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!15
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3d0355871d652e9e a!16)))))))))))
