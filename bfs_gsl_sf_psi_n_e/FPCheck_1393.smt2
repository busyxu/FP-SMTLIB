...
(assert (= #x00000001 a_ack!3740))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3739) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3739) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3739) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3739) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3739) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!2
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
  (FPCHECK_FDIV_ZERO a!3 (fp.add roundNearestTiesToEven a!18 a!3)))))))))
