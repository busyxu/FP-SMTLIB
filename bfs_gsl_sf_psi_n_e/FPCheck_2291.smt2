(declare-fun a_ack!6258 () (_ BitVec 32))
(declare-fun b_ack!6257 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!6258)))
(assert (not (= #x00000001 a_ack!6258)))
(assert (not (bvslt a_ack!6258 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6257) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6258)
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!17)
                            a!18))))
  (FPCHECK_FMUL_UNDERFLOW #x3cfa000000000000 (fp.abs a!19))))))))))))))))
