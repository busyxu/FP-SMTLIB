...
(assert (= #x00000001 a_ack!5026))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5025) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5025) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5025) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5025) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5025) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (not (fp.gt (fp.abs (fp.add roundNearestTiesToEven a!15 a!16))
