...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!4206)))
(assert (= #x00000001 a_ack!4206))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4205) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4205) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4205) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4205) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4205) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4205))
...
(let ((a!5 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven a!1 a!1))
                   (fp.mul roundNearestTiesToEven a!1 a!1))))
  (FPCHECK_FDIV_OVERFLOW a!5 (fp.mul roundNearestTiesToEven a!1 a!1))))))))
