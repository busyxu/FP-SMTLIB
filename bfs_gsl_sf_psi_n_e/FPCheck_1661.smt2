(declare-fun a_ack!4322 () (_ BitVec 32))
...
(assert (not (= #x00000000 a_ack!4322)))
(assert (= #x00000001 a_ack!4322))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4321) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4321) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4321) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4321) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4321) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven a!30 ((_ to_fp 11 53) #x4000000000000000))
    #x3cb0000000000000)))))))))))))))
