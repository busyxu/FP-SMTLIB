(declare-fun a_ack!5286 () (_ BitVec 32))
...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5286)))
(assert (not (= #x00000001 a_ack!5286)))
(assert (not (bvslt a_ack!5286 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5285) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5286)
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!5285)))
                   a!2)))
  (FPCHECK_FDIV_UNDERFLOW (fp.div roundNearestTiesToEven a!3 a!2) a!2))))
