...
(declare-fun b_ack!4081 () (_ BitVec 64))
...
(assert (= #x00000001 a_ack!4082))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4081) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4081) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4081) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4081) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4081) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4081))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!5
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
  (FPCHECK_FDIV_ACCURACY a!6 (fp.add roundNearestTiesToEven a!24 a!6))))))))))))
