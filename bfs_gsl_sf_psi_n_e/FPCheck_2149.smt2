...
(declare-fun b_ack!5857 () (_ BitVec 64))
(declare-fun CF_log ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (= #x00000000 a_ack!5858)))
(assert (not (= #x00000001 a_ack!5858)))
(assert (not (bvslt a_ack!5858 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5857) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5858)
...
(let ((a!14 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!13
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #xbd57da4e1f79955c a!14))))))))))
