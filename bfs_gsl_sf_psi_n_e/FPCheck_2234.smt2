(declare-fun a_ack!6098 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!6098)))
(assert (not (= #x00000001 a_ack!6098)))
(assert (not (bvslt a_ack!6098 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6097) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6098)
