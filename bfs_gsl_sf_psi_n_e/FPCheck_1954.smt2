...
(declare-fun b_ack!5265 () (_ BitVec 64))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5265) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!23 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3ca0000000000000))))
  (not a!23))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW #x4024000000000000 b_ack!5265))
