...
(assert (not (= #x00000000 a_ack!4294)))
(assert (= #x00000001 a_ack!4294))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4293) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4293) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4293) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4293) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4293) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!28 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW #x0000000000000000 a!28))))))))))))))
