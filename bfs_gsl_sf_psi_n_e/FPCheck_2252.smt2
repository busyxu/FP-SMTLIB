(declare-fun a_ack!6156 () (_ BitVec 32))
(declare-fun b_ack!6155 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!6156)))
(assert (not (= #x00000001 a_ack!6156)))
(assert (not (bvslt a_ack!6156 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6155) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6156)
...
(let ((a!6 (fp.mul roundNearestTiesToEven
      ...
      (a!21 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!20 a!19)
                            a!19)
                    a!19))
      (a!26 (fp.add roundNearestTiesToEven
                    a!25
...
(let ((a!22 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!16)
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!21 a!19)
                            a!19)))
...
(let ((a!42 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!14)
                            (fp.div roundNearestTiesToEven a!21 a!19)))))
(let ((a!43 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                                   a!22
                                   (fp.add roundNearestTiesToEven a!42 a!22)))
                   ((_ to_fp 11 53) #x3ca0000000000000))))
  (not a!43))))))))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
...
(let ((a!6 (fp.mul roundNearestTiesToEven
      ...
      (a!23 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!22 a!21)
                            a!21)
                    a!21))
      (a!28 (fp.add roundNearestTiesToEven
                    a!27
...
(let ((a!24 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!21)
                                    a!21)
                            a!21)))
...
(let ((a!45 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!21)
                                    a!21)))))
  (FPCHECK_FDIV_ACCURACY a!24 (fp.add roundNearestTiesToEven a!45 a!24)))))))))))))))))))))))
