(declare-fun a_ack!4382 () (_ BitVec 32))
...
(assert (not (= #x00000000 a_ack!4382)))
(assert (= #x00000001 a_ack!4382))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4381) ((_ to_fp 11 53) #xc014000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3cc0000000000000
    (fp.div roundNearestTiesToEven ((_ to_fp 11 53) #x4023bd3cc9be45de) a!1))))
