...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (= #x00000000 a_ack!1040))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1039) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1039) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1039) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!1039))
...
(let ((a!31 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!30)))
  (FPCHECK_FSUB_OVERFLOW a!31 a!28)))))))))))))))))))))))))))))))))
