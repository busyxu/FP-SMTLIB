...
(assert (= #x00000000 a_ack!744))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!743) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!743) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!743) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!743))
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!19 a!16)
                                    ((_ to_fp 11 53) #xbe0fa6ae3f8f0dea))))))
  (FPCHECK_FADD_OVERFLOW a!22 #x3e60d5318a2660c2))))))))))))))))))))))))
