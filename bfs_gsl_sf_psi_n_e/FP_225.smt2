(declare-fun a_ack!5016 () (_ BitVec 32))
(declare-fun b_ack!5015 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             (_ FloatingPoint 11 53))
(assert (not (= #x00000000 a_ack!5016)))
(assert (= #x00000001 a_ack!5016))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5015) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5015) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5015) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5015) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5015) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!26
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
  (fp.lt (fp.abs a!27) ((_ to_fp 11 53) #x5fe9999999999999))))))))))))))
