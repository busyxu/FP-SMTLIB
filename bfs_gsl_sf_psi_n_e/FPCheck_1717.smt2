(declare-fun a_ack!4464 () (_ BitVec 32))
...
(assert (not (= #x00000000 a_ack!4464)))
(assert (= #x00000001 a_ack!4464))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4463) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4463) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4463) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4463) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4463) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!16 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!15)
                            a!2))))
  (fp.lt (fp.abs a!16) ((_ to_fp 11 53) #x3ca0000000000000))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (fp.lt (fp.abs a!15) ((_ to_fp 11 53) #x5fe9999999999999))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (fp.gt (fp.abs a!15) ((_ to_fp 11 53) #x2003333333333333))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
...
(let ((a!16 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven a!16 ((_ to_fp 11 53) #x3ff0000000000000)))))))))
