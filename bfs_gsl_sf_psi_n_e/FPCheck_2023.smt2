...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5481) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!6)
                            a!12))))
  (FPCHECK_FDIV_INVALID a!13 (fp.add roundNearestTiesToEven a!29 a!13))))))))))))))))))
