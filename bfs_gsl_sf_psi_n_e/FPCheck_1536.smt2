...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!4072)))
(assert (= #x00000001 a_ack!4072))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4071) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4071) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4071) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4071) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4071) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!23 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!22
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
  (FPCHECK_FADD_OVERFLOW a!23 a!24)))))))))))
