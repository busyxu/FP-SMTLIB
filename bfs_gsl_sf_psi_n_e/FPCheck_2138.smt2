...
(assert (not (= #x00000000 a_ack!5822)))
(assert (not (= #x00000001 a_ack!5822)))
(assert (not (bvslt a_ack!5822 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5821) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5822)
...
(let ((a!36 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3ca0000000000000))))
  (not a!36))))))))))))))))))))
(assert (FPCHECK_FADD_OVERFLOW #x4024000000000000 b_ack!5821))
