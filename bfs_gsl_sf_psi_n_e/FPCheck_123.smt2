...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!315) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!315) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!315))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!6
                                    ((_ to_fp 11 53) #xbcc8e5599ead4654))))))
  (FPCHECK_FADD_ACCURACY a!10 #x3d1a6e3544bdd04d))))))))))))
