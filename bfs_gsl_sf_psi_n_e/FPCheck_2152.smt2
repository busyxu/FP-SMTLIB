...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5870)))
(assert (not (= #x00000001 a_ack!5870)))
(assert (not (bvslt a_ack!5870 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5869) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5870)
...
(let ((a!14 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbd57da4e1f79955c) a!14)
    (fp.div roundNearestTiesToEven
