(declare-fun a_ack!4208 () (_ BitVec 32))
(declare-fun b_ack!4207 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!4208)))
(assert (= #x00000001 a_ack!4208))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4207) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4207) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4207) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4207) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4207) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4207))
...
(let ((a!5 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven a!1 a!1))
                   (fp.mul roundNearestTiesToEven a!1 a!1))))
  (FPCHECK_FDIV_UNDERFLOW a!5 (fp.mul roundNearestTiesToEven a!1 a!1))))))))
