...
(declare-fun b_ack!6159 () (_ BitVec 64))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6159) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!45 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!21)
                                    a!21)))))
  (FPCHECK_FDIV_INVALID a!24 (fp.add roundNearestTiesToEven a!45 a!24)))))))))))))))))))))))
