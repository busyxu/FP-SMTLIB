...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2519) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2519) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2519) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2519) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!10)
                    a!11)))
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!12 a!13) a!14))))))
