...
(assert (not (= #x00000000 a_ack!4362)))
(assert (= #x00000001 a_ack!4362))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4361) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4361) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4361) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4361) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4361) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
                    ...
                    (CF_exp (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!29)))))
  (FPCHECK_FMUL_OVERFLOW a!30 #x0000000000000000)))))))))))))))
