(declare-fun a_ack!5040 () (_ BitVec 32))
...
(assert (not (= #x00000000 a_ack!5040)))
(assert (= #x00000001 a_ack!5040))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5039) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5039) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!5039) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5039) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!5039) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (not (fp.eq (fp.add roundNearestTiesToEven a!15 a!16)
              ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.sub roundNearestTiesToEven
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (fp.lt (fp.abs (fp.add roundNearestTiesToEven a!15 a!16))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (fp.gt (fp.abs (fp.add roundNearestTiesToEven a!15 a!16))
...
(let ((a!17 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.abs (fp.add roundNearestTiesToEven a!15 a!16)))))
