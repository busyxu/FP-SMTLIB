(declare-fun a_ack!3232 () (_ BitVec 32))
...
(assert (not (= #x00000000 a_ack!3232)))
(assert (= #x00000001 a_ack!3232))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3231) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3231) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3231) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3231) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3231) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (FPCHECK_FMUL_ACCURACY a!15 #x3ff0000000000000)))))))
