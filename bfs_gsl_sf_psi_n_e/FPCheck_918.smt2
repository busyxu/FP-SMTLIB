...
(assert (= #x00000001 a_ack!2464))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2463) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2463) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2463) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2463) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2463) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!7 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           a!5)
                   a!6)))
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!7 a!8) a!9)))))
