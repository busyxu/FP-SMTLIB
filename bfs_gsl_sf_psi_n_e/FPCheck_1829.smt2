...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!4839) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!4840)
...
(assert (FPCHECK_FADD_UNDERFLOW #x4024000000000000 b_ack!4839))
