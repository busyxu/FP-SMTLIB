(declare-fun a_ack!6120 () (_ BitVec 32))
(declare-fun b_ack!6119 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!6120)))
(assert (not (= #x00000001 a_ack!6120)))
(assert (not (bvslt a_ack!6120 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6119) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6120)
...
(let ((a!18 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!17
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #xbcaf57d968caacf1 a!18))))))))))))
