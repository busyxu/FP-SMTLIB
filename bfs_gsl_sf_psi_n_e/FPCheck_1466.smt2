...
(declare-fun b_ack!3927 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_ACCURACY
             ...
             Bool)
(assert (not (= #x00000000 a_ack!3928)))
(assert (= #x00000001 a_ack!3928))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3927) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3927) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3927) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3927) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3927) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!3927))
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!4))
                    a!5)))
  (FPCHECK_FDIV_ACCURACY a!5 a!22))))))))))
