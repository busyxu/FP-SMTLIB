...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3187) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (CF_pow a!1 #xc000000000000000)
                                    a!1)))))
  (FPCHECK_FDIV_ZERO a!2 (fp.add roundNearestTiesToEven a!16 a!2))))))))
