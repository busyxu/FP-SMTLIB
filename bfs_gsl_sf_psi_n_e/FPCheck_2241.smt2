...
(declare-fun b_ack!6117 () (_ BitVec 64))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6117) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!18 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    a!17
                                    ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FMUL_OVERFLOW #xbcaf57d968caacf1 a!18))))))))))))
