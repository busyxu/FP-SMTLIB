(declare-fun a_ack!4298 () (_ BitVec 32))
(declare-fun b_ack!4297 () (_ BitVec 64))
...
(assert (not (= #x00000000 a_ack!4298)))
(assert (= #x00000001 a_ack!4298))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4297) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4297))
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!26
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
(let ((a!28 ((_ to_fp 11 53)
              roundNearestTiesToEven
              (ite (fp.geq a!27 ((_ to_fp 11 53) #x0000000000000000))
                   #x00000001
                   #xffffffff)))
      (a!29 (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) #x0000000000000000)
                    (CF_floor (CF_log (fp.abs a!27))))))
  (FPCHECK_FMUL_OVERFLOW a!28 (CF_exp a!29)))))))))))))))
