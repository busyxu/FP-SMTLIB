...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5330)))
(assert (not (= #x00000001 a_ack!5330)))
(assert (not (bvslt a_ack!5330 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5329) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5330)
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!14 a!18)
                                    a!18)))))
  (FPCHECK_FADD_UNDERFLOW a!22 a!25))))))))))))))))
