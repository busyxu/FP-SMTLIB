(declare-fun a_ack!4268 () (_ BitVec 32))
(declare-fun b_ack!4267 () (_ BitVec 64))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!4268)))
(assert (= #x00000001 a_ack!4268))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4267) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4267) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4267) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4267) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4267) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4267))
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!26
                                    (fp.mul roundNearestTiesToEven a!1 a!1))))))
  (FPCHECK_FMUL_UNDERFLOW #x3cfa000000000000 (fp.abs a!27))))))))))))))
