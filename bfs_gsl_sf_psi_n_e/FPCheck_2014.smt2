(declare-fun a_ack!5448 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5448)))
(assert (not (= #x00000001 a_ack!5448)))
(assert (not (bvslt a_ack!5448 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5447) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5448)
...
(let ((a!8 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3e566a8f2bf70ebe) a!8)
    (fp.div roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
