...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5204)))
(assert (not (= #x00000001 a_ack!5204)))
(assert (not (bvslt a_ack!5204 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5203) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5204)
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!2)
                            (fp.div roundNearestTiesToEven a!6 a!7)))))
  (FPCHECK_FDIV_UNDERFLOW a!8 (fp.add roundNearestTiesToEven a!22 a!8))))))))))))))))
