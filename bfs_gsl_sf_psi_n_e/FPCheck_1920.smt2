(declare-fun a_ack!5172 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!5172)))
(assert (not (= #x00000001 a_ack!5172)))
(assert (not (bvslt a_ack!5172 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5171) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5172)
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!3
                                   ((_ to_fp 11 53) #x4000000000000000))))))
  (FPCHECK_FMUL_UNDERFLOW #x3f01566abc011567 a!4)))))
