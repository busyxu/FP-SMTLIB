(declare-fun a_ack!5484 () (_ BitVec 32))
...
(declare-fun FPCHECK_FDIV_ZERO
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5484)))
(assert (not (= #x00000001 a_ack!5484)))
(assert (not (bvslt a_ack!5484 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5483) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5484)
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!6)
                            a!12))))
  (FPCHECK_FDIV_ZERO a!13 (fp.add roundNearestTiesToEven a!29 a!13))))))))))))))))))
