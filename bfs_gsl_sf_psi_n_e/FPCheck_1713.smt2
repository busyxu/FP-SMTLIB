(declare-fun a_ack!4442 () (_ BitVec 32))
...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (= #x00000000 a_ack!4442)))
(assert (= #x00000001 a_ack!4442))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4441) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4441) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4441) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4441) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4441) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!18)
    a!19)))))))))
