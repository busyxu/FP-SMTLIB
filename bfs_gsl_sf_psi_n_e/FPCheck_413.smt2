...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1063) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1063) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!1063))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1063) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!31 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000)))
                    a!30)))
  (FPCHECK_FADD_UNDERFLOW (fp.abs a!31) (fp.abs a!28))))))))))))))))))))))))))))))))))
