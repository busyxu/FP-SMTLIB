(declare-fun a_ack!6136 () (_ BitVec 32))
...
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!6136)))
(assert (not (= #x00000001 a_ack!6136)))
(assert (not (bvslt a_ack!6136 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6135) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6136)
...
(let ((a!4 (fp.mul roundNearestTiesToEven
      ...
      (a!22 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!21 a!20)
                                    a!20)
                            a!20)
                    a!20)))
(let ((a!6 (fp.mul roundNearestTiesToEven
...
(let ((a!18 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbcaf57d968caacf1) a!18)
    a!23))))))))))))
