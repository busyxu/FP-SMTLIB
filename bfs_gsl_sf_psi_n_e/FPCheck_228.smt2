...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!585) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!585) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!585))
             ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!585) ((_ to_fp 11 53) #xbff0000000000000))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!14 a!12)
                                    ((_ to_fp 11 53) #x3d9471fee403ea3c))))))
  (FPCHECK_FADD_ACCURACY a!18 #x3de5b678bb7cab1e))))))))))))))))))))
