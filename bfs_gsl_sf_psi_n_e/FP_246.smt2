(declare-fun a_ack!5310 () (_ BitVec 32))
(declare-fun b_ack!5309 () (_ BitVec 64))
(declare-fun CF_log ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             (_ FloatingPoint 11 53))
(assert (not (= #x00000000 a_ack!5310)))
(assert (not (= #x00000001 a_ack!5310)))
(assert (not (bvslt a_ack!5310 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5309) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5310)
