...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (= #x00000000 a_ack!1192))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1191) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1191) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1191) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!1191))
