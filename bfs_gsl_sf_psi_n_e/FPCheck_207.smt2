...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!531))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!13 a!10)
                                    ((_ to_fp 11 53) #xbd6c0f7c0ebf797c))))))
  (FPCHECK_FADD_ACCURACY a!16 #x3dbdcb973b818cb1))))))))))))))))))
