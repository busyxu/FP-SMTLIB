(declare-fun a_ack!4388 () (_ BitVec 32))
(declare-fun b_ack!4387 () (_ BitVec 64))
...
(assert (not (= #x00000000 a_ack!4388)))
(assert (= #x00000001 a_ack!4388))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4387) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4387) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4387) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4387) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4387) ((_ to_fp 11 53) #xc014000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) #x3ff0000000000000)
                     ((_ to_fp 11 53) b_ack!4387))
...
(let ((a!32 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) #x4023bd3cc9be45de)
                    a!33))))))))))))))))))
