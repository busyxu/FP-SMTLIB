...
(assert (not (= #x00000000 a_ack!4372)))
(assert (= #x00000001 a_ack!4372))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4371) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4371) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!4371) ((_ to_fp 11 53) #xc000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4371) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!4371) ((_ to_fp 11 53) #xc014000000000000))))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!27
                                    (fp.mul roundNearestTiesToEven a!2 a!2))))))
(let ((a!29 ((_ to_fp 11 53)
              roundNearestTiesToEven
              (ite (fp.geq a!28 ((_ to_fp 11 53) #x0000000000000000))
                   #x00000001
                   #xffffffff)))
      (a!30 (fp.add roundNearestTiesToEven
                    ((_ to_fp 11 53) #x0000000000000000)
                    (CF_floor (CF_log (fp.abs a!28)))))
      (a!31 (fp.sub roundNearestTiesToEven
                    (CF_log (fp.abs a!28))
                    (CF_floor (CF_log (fp.abs a!28))))))
(let ((a!32 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven a!29 (CF_exp a!30))
