...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!6152)))
(assert (not (= #x00000001 a_ack!6152)))
(assert (not (bvslt a_ack!6152 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!6151) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!6152)
...
(let ((a!45 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!21)
                                    a!21)))))
  (FPCHECK_FDIV_UNDERFLOW a!24 (fp.add roundNearestTiesToEven a!45 a!24)))))))))))))))))))))))
