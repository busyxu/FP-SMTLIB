(declare-fun a_ack!5904 () (_ BitVec 32))
(declare-fun b_ack!5903 () (_ BitVec 64))
...
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (= #x00000000 a_ack!5904)))
(assert (not (= #x00000001 a_ack!5904)))
(assert (not (bvslt a_ack!5904 #x00000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!5903) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven a_ack!5904)
...
(let ((a!39 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!12)
                            a!19))))
  (FPCHECK_FDIV_INVALID a!20 (fp.add roundNearestTiesToEven a!39 a!20)))))))))))))))))))))
