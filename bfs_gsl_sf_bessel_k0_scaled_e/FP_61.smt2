...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!586) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!586) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!586))
                           a!2))))
  (fp.eq a!4 ((_ to_fp 11 53) #x3eef47476772d4d9)))))))
