...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2608) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (= #x00000002 a_ack!2609)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!2609 #x00000096)))
...
(assert (fp.lt (fp.div roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) b_ack!2608))
               (fp.add roundNearestTiesToEven
                       ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2609)
                       ((_ to_fp 11 53) #x3fe0000000000000)))
