...
(assert (fp.lt ((_ to_fp 11 53) b_ack!518) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt a_ack!519 #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!518))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 a_ack!519))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!518))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven
                         ...
                         (CF_exp a!1)))
         (CF_exp a!1))))
(assert (let ((a!1 (ite (not (= #x00000000 (bvand a_ack!519 #x00000001)))
                #xbff0000000000000
                #x3ff0000000000000))
