...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1820) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (= #x00000002 a_ack!1821)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (bvslt a_ack!1821 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1820))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!1820)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!1820))))))
