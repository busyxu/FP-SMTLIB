...
(assert (not (= #x00000002 a_ack!1683)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!1683 #x00000096)))
...
(assert (FPCHECK_FDIV_UNDERFLOW
  #x3fd28f5c28f5c28f
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvmul a_ack!1683 a_ack!1683))
          ((_ to_fp 11 53) #x3ff0000000000000))))
