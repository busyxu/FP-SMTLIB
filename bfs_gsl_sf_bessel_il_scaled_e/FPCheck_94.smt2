...
(assert (fp.lt ((_ to_fp 11 53) b_ack!362) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 (ite (not (= #x00000000 (bvand a_ack!363 #x00000001)))
                #xbff0000000000000
                #x3ff0000000000000))
...
(let ((a!6 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW a!1 (fp.mul roundNearestTiesToEven (CF_exp a!2) a!6)))))))
