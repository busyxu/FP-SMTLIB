...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1680) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!1681 #x00000096)))
...
(assert (FPCHECK_FDIV_OVERFLOW
  #x3fd28f5c28f5c28f
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvmul a_ack!1681 a_ack!1681))
          ((_ to_fp 11 53) #x3ff0000000000000))))
