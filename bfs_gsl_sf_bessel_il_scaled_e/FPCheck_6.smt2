...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!18) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!18)) ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!18))))
