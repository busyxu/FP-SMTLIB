...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) b_ack!1660) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (= #x00000002 a_ack!1661)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!1661 #x00000096)))
