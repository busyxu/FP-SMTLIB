...
(assert (not (= #x00000002 a_ack!2437)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2436))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) b_ack!2436))
              a!1))))
(assert (bvslt a_ack!2437 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2436))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2436)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_INVALID (fp.abs ((_ to_fp 11 53) b_ack!2436)) a!1)))
