...
(declare-fun a_ack!3523 () (_ BitVec 32))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3522) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (bvslt a_ack!3523 #x00000000)))
(assert (not (fp.eq (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x8000000000000000)
                    ((_ to_fp 11 53) b_ack!3522))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 a_ack!3523)))
(assert (not (= #x00000001 a_ack!3523)))
(assert (not (= #x00000002 a_ack!3523)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (bvslt a_ack!3523 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!3522))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!3522)))
...
(let ((a!2 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!3522))
                           a!1))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!3523))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
