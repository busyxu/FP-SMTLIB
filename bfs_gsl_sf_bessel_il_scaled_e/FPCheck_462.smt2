...
(assert (not (= #x00000002 a_ack!1675)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!1675 #x00000096)))
...
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvmul a_ack!1675 a_ack!1675))
  #x3ff0000000000000))
