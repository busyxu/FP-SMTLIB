...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) b_ack!2168) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (= #x00000002 a_ack!2169)))
...
(let ((a!2 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!1)))
  (not a!2))))
(assert (not (bvslt a_ack!2169 #x00000096)))
...
(assert (FPCHECK_FADD_UNDERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2169)
  #x3fe0000000000000))
