...
(assert (= #x00000001 a_ack!1647))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1646) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1646))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1646))
...
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!1646)))))
