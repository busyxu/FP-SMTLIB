...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2540))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ...
                      ((_ to_fp 11 53) b_ack!2540))
              a!1))))
(assert (bvslt a_ack!2541 #x00000096))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2540))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2540)))
                  ((_ to_fp 11 53) #x3fc999999999999a))))
  (not a!1)))
(assert (fp.lt (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!2540)))
