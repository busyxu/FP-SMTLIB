...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!774) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!774))
            ((_ to_fp 11 53) #x0028000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!774))
       ((_ to_fp 11 53) #x3fd0000000000000)))
(assert (FPCHECK_FSUB_OVERFLOW #x8000000000000000 (fp.abs ((_ to_fp 11 53) b_ack!774))))
