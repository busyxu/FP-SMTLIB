...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!634) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!634) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!634))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) b_ack!634)))
                   (fp.abs ((_ to_fp 11 53) b_ack!634)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) b_ack!634)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) b_ack!634)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
