...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1081) ((_ to_fp 11 53) #x4008000000000000))))
(assert (fp.gt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3ed965fea53d6e41)
               ((_ to_fp 11 53) b_ack!1081))
       ((_ to_fp 11 53)
         roundNearestTiesToEven
         (bvadd #x00000001 (bvmul a_ack!1082 a_ack!1082) a_ack!1082))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1082)
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!1)
                   a!1)))
  (FPCHECK_FMUL_OVERFLOW #x396c5c1c055d57fa (fp.abs a!2)))))
