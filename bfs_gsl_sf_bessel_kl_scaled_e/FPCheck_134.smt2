...
(assert (not (= #x00000002 a_ack!496)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!495) ((_ to_fp 11 53) #x4008000000000000)))
(assert (bvslt (bvadd #x00000001 a_ack!496) #x00000000))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!495) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FDIV_OVERFLOW #x3ff0000000000000 b_ack!495))
