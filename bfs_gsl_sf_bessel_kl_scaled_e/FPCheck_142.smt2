...
(assert (fp.lt ((_ to_fp 11 53) b_ack!521) ((_ to_fp 11 53) #x4008000000000000)))
(assert (not (bvslt (bvadd #x00000001 a_ack!522) #x00000000)))
(assert (not (= #x00000000 (bvand (bvadd #x00000001 a_ack!522) #x00000001))))
(assert (FPCHECK_FMUL_UNDERFLOW #x3ff0000000000000 b_ack!521))
