...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1431) ((_ to_fp 11 53) #x4008000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ed965fea53d6e41)
                          ((_ to_fp 11 53) b_ack!1431))
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    (bvadd #x00000001 (bvmul a_ack!1432 a_ack!1432) a_ack!1432)))))
  (not a!1)))
...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1431) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1431) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
