...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!577) ((_ to_fp 11 53) #x4008000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ed965fea53d6e41)
                          ((_ to_fp 11 53) b_ack!577))
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    (bvadd #x00000001 (bvmul a_ack!578 a_ack!578) a_ack!578)))))
  (not a!1)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.div roundNearestTiesToEven
              ...
              ((_ to_fp 11 53) #x3ed965fea53d6e41)))))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!577) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!577) ((_ to_fp 11 53) #x1fff5de25335c4ee))))
(assert (FPCHECK_FMUL_ACCURACY #x4000000000000000 b_ack!577))
