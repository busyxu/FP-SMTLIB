...
(assert (not (= #x00000002 a_ack!1408)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1407) ((_ to_fp 11 53) #x4008000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ed965fea53d6e41)
                          ((_ to_fp 11 53) b_ack!1407))
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    (bvadd #x00000001 (bvmul a_ack!1408 a_ack!1408) a_ack!1408)))))
  (not a!1)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.eq a!1 ((_ to_fp 11 53) b_ack!1407)))))
