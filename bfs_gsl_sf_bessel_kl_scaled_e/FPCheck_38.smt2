...
(assert (= #x00000002 a_ack!168))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!167) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!167) ((_ to_fp 11 53) #x2aa965fea53d6e98))))
(assert (FPCHECK_FDIV_UNDERFLOW #x4008000000000000 b_ack!167))
