...
(assert (not (= #x00000002 a_ack!1414)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1413) ((_ to_fp 11 53) #x4008000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ed965fea53d6e41)
                          ((_ to_fp 11 53) b_ack!1413))
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    (bvadd #x00000001 (bvmul a_ack!1414 a_ack!1414) a_ack!1414)))))
  (not a!1)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3fe0000000000000)))
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!1414)
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.eq a!1 ((_ to_fp 11 53) b_ack!1413)))))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW #x3ff0000000000000 (CF_log a!1))))
