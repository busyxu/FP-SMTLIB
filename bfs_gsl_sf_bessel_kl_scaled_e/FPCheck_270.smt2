...
(assert (not (= #x00000002 a_ack!984)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!983) ((_ to_fp 11 53) #x4008000000000000))))
(assert (let ((a!1 (fp.gt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ed965fea53d6e41)
                          ((_ to_fp 11 53) b_ack!983))
                  ((_ to_fp 11 53)
                    roundNearestTiesToEven
                    (bvadd #x00000001 (bvmul a_ack!984 a_ack!984) a_ack!984)))))
  (not a!1)))
