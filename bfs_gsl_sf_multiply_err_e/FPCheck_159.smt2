...
(assert (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!950))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) c_ack!948))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!948))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!950))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!950))
       (fp.abs ((_ to_fp 11 53) c_ack!948))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!950))
            (fp.abs ((_ to_fp 11 53) c_ack!948)))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!948))
