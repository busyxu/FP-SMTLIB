...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!792))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!793))
            (fp.abs ((_ to_fp 11 53) c_ack!792)))))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!793))
       (fp.abs ((_ to_fp 11 53) c_ack!792))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_ACCURACY b_ack!791 c_ack!792))
