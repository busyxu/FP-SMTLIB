...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!563))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!562))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!563))
            (fp.abs ((_ to_fp 11 53) c_ack!562)))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!563))
            (fp.abs ((_ to_fp 11 53) c_ack!562)))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!562))
            ((_ to_fp 11 53) #x5feccccccccccccc))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!562))
