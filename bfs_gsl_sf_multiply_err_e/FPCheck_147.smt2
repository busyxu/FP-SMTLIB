...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(declare-fun d_ack!861 () (_ BitVec 64))
...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!862))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) c_ack!860))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!862))
            (fp.abs ((_ to_fp 11 53) c_ack!860)))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!862))
            (fp.abs ((_ to_fp 11 53) c_ack!860)))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!860))
       ((_ to_fp 11 53) #x5feccccccccccccc)))
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) a_ack!862)
                                  ((_ to_fp 11 53) c_ack!860)))
