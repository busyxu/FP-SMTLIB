...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1725) ((_ to_fp 11 53) c_ack!1722))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1722) ((_ to_fp 11 53) d_ack!1723))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1723) ((_ to_fp 11 53) #x551c4b19c41f715f)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) d_ack!1723)))
      (a!4 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand e_ack!1724 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
