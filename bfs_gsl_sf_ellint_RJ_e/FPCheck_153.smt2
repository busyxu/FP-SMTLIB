...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1695) ((_ to_fp 11 53) c_ack!1692))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1692) ((_ to_fp 11 53) d_ack!1693))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1693) ((_ to_fp 11 53) #x551c4b19c41f715f)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) d_ack!1693)))
      (a!4 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand e_ack!1694 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
...
(assert (FPCHECK_FADD_ACCURACY d_ack!1693 #x7ff0000000000001))
