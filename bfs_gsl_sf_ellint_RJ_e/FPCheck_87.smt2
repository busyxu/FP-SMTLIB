...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!980) ((_ to_fp 11 53) b_ack!976))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!976) ((_ to_fp 11 53) c_ack!977))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!977) ((_ to_fp 11 53) d_ack!978))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) d_ack!978)
                           ((_ to_fp 11 53) #x7ff0000000000001)))))
  (FPCHECK_FADD_UNDERFLOW (fp.mul roundNearestTiesToEven a!1 a!1) a!2)))
