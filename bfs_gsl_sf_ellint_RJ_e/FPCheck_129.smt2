...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1445) ((_ to_fp 11 53) c_ack!1442))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1442) ((_ to_fp 11 53) d_ack!1443))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1443) ((_ to_fp 11 53) #x551c4b19c41f715f)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_INVALID
    a!2
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) d_ack!1443))
            ((_ to_fp 11 53) #x3fc999999999999a))))))
