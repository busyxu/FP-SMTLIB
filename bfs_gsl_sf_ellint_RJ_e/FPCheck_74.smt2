...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!850) ((_ to_fp 11 53) b_ack!846))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!846) ((_ to_fp 11 53) c_ack!847))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!847) ((_ to_fp 11 53) d_ack!848))))
...
(assert (FPCHECK_FADD_OVERFLOW d_ack!848 #x7ff0000000000001))
