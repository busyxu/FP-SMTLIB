...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1495) ((_ to_fp 11 53) c_ack!1492))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1492) ((_ to_fp 11 53) d_ack!1493))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1493) ((_ to_fp 11 53) #x551c4b19c41f715f)))
