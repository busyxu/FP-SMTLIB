...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!215) ((_ to_fp 11 53) b_ack!211))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!211) ((_ to_fp 11 53) c_ack!212))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!212) ((_ to_fp 11 53) d_ack!213))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!213) ((_ to_fp 11 53) #x551c4b19c41f715f)))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!215 b_ack!211))
