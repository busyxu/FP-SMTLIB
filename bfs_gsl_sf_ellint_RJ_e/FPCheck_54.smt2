...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!640) ((_ to_fp 11 53) b_ack!636))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!636) ((_ to_fp 11 53) c_ack!637))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!637) ((_ to_fp 11 53) d_ack!638))))
