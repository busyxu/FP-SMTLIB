...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!790) ((_ to_fp 11 53) b_ack!786))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!786) ((_ to_fp 11 53) c_ack!787))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!787) ((_ to_fp 11 53) d_ack!788))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) d_ack!788)))
      (a!4 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand e_ack!789 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
