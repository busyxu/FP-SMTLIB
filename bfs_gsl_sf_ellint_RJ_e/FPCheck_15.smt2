...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!205) ((_ to_fp 11 53) b_ack!201))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!201) ((_ to_fp 11 53) c_ack!202))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!202) ((_ to_fp 11 53) d_ack!203))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!203) ((_ to_fp 11 53) #x551c4b19c41f715f)))
(assert (FPCHECK_FADD_OVERFLOW a_ack!205 b_ack!201))
