...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1380) ((_ to_fp 11 53) c_ack!1377))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1377) ((_ to_fp 11 53) d_ack!1378))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1378) ((_ to_fp 11 53) #x551c4b19c41f715f)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) d_ack!1378))
