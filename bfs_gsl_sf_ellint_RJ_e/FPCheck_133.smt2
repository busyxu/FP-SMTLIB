...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1485) ((_ to_fp 11 53) c_ack!1482))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1482) ((_ to_fp 11 53) d_ack!1483))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1483) ((_ to_fp 11 53) #x551c4b19c41f715f)))
