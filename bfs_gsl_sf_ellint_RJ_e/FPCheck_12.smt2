...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!170) ((_ to_fp 11 53) b_ack!166))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!166) ((_ to_fp 11 53) c_ack!167))))
(assert (fp.gt ((_ to_fp 11 53) c_ack!167) ((_ to_fp 11 53) d_ack!168)))
(assert (fp.lt ((_ to_fp 11 53) c_ack!167) ((_ to_fp 11 53) #x551c4b19c41f715f)))
(assert (FPCHECK_FADD_OVERFLOW a_ack!170 b_ack!166))
