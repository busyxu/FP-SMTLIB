...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1350) ((_ to_fp 11 53) c_ack!1347))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1347) ((_ to_fp 11 53) d_ack!1348))))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1348) ((_ to_fp 11 53) #x551c4b19c41f715f)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY
    a!2
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!1 ((_ to_fp 11 53) d_ack!1348))
            ((_ to_fp 11 53) #x3fc999999999999a))))))
