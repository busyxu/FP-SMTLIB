...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!180) ((_ to_fp 11 53) b_ack!176))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!176) ((_ to_fp 11 53) c_ack!177))))
(assert (fp.gt ((_ to_fp 11 53) c_ack!177) ((_ to_fp 11 53) d_ack!178)))
(assert (fp.lt ((_ to_fp 11 53) c_ack!177) ((_ to_fp 11 53) #x551c4b19c41f715f)))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!180 b_ack!176))
