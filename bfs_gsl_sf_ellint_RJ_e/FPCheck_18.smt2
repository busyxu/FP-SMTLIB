...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!240) ((_ to_fp 11 53) b_ack!236))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!236) ((_ to_fp 11 53) c_ack!237))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!237) ((_ to_fp 11 53) d_ack!238))))
