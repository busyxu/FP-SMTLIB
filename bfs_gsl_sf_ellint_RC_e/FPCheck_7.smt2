...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!56) ((_ to_fp 11 53) b_ack!54))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!54) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!56 b_ack!54))
