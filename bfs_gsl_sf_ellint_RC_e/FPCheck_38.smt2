...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!269) ((_ to_fp 11 53) b_ack!267))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!267) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW b_ack!267 a!1)))
