(declare-fun c_ack!79 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!79 #x00000007)))
       #x0000000000000011))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!80) ((_ to_fp 11 53) b_ack!78)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!80) ((_ to_fp 11 53) #x7fc9999999999999)))
