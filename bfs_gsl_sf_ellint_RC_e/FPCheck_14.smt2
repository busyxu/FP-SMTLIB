...
(assert (fp.gt ((_ to_fp 11 53) a_ack!107) ((_ to_fp 11 53) b_ack!105)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!107) ((_ to_fp 11 53) #x7fc9999999999999)))
