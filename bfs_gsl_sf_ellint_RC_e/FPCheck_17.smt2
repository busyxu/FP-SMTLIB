...
(assert (fp.gt ((_ to_fp 11 53) a_ack!128) ((_ to_fp 11 53) b_ack!126)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!128) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY b_ack!126 a!1)))
