(declare-fun c_ack!748 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!748 #x00000007)))
       #x0000000000000011))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!749) ((_ to_fp 11 53) b_ack!747))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!747) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!748 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
...
(let ((a!5 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           a!2)
                   ((_ to_fp 11 53) #x4008000000000000))))
  (FPCHECK_FDIV_INVALID (fp.add roundNearestTiesToEven a!2 a!5) a!5)))))
