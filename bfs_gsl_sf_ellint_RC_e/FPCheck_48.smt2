(declare-fun c_ack!334 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!334 #x00000007)))
       #x0000000000000011))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!335) ((_ to_fp 11 53) b_ack!333))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!333) ((_ to_fp 11 53) #x7fc9999999999999)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!3 ((_ to_fp 11 53)
             (ite (= #x00000000 (bvand c_ack!334 #x00000007))
                  #x3f50624dd2f1a9fc
                  #x3f9eb851eb851eb8))))
...
(assert (FPCHECK_FINVALID_SQRT a_ack!335 a_ack!335))
