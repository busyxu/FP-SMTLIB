(declare-fun c_ack!121 () (_ BitVec 32))
...
(assert (bvult (bvmul #x0000000000000008
              (concat #x00000000 (bvand c_ack!121 #x00000007)))
       #x0000000000000011))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!122) ((_ to_fp 11 53) b_ack!120)))
(assert (fp.lt ((_ to_fp 11 53) a_ack!122) ((_ to_fp 11 53) #x7fc9999999999999)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW b_ack!120 a!1)))
