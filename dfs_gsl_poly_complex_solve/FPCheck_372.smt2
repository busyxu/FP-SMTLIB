...
(declare-fun a1_ack!2635 () (_ BitVec 64))
(declare-fun a2_ack!2636 () (_ BitVec 64))
(declare-fun a3_ack!2637 () (_ BitVec 64))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x3fb0000000000000))))))
  (FPCHECK_FADD_ACCURACY #x4030000000000000 a!2))))
