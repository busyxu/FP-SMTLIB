(declare-fun a5_ack!569 () (_ BitVec 64))
(declare-fun a0_ack!570 () (_ BitVec 64))
(declare-fun a1_ack!567 () (_ BitVec 64))
(declare-fun a2_ack!568 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!569) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!570))
                           ((_ to_fp 11 53) a5_ack!569)))))
