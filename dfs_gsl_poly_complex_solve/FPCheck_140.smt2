(declare-fun a5_ack!609 () (_ BitVec 64))
(declare-fun a0_ack!610 () (_ BitVec 64))
(declare-fun a1_ack!607 () (_ BitVec 64))
(declare-fun a2_ack!608 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!609) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!610))
                           ((_ to_fp 11 53) a5_ack!609)))))
