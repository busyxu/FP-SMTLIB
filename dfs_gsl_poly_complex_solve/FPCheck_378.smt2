...
(declare-fun a1_ack!2695 () (_ BitVec 64))
(declare-fun a2_ack!2696 () (_ BitVec 64))
(declare-fun a3_ack!2697 () (_ BitVec 64))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x3fb0000000000000))))))
  (FPCHECK_FADD_ACCURACY a!2 #x4050000000000000))))
