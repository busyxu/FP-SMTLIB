...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!341) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!341) ((_ to_fp 11 53) #x4010000000000000)))
(assert (not (= #x00000000 (bvand b_ack!340 #x00000007))))
