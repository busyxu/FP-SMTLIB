...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!469) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!469) ((_ to_fp 11 53) #x4010000000000000)))
(assert (not (= #x00000000 (bvand b_ack!468 #x00000007))))
...
(let ((a!10 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         (fp.sub roundNearestTiesToEven a!10 a!9)
                         ((_ to_fp 11 53) #x3e777acc9d97cc8b))
                 (fp.sub roundNearestTiesToEven a!10 a!9))
         ((_ to_fp 11 53) #x3e777acc9d97cc8b)))))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
