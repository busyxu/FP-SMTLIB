...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!709) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!709) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) a_ack!709) ((_ to_fp 11 53) #x4010000000000000)))
(assert (= #x00000000 (bvand b_ack!708 #x00000007)))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x3ccf98e5b3e6a8e9))
                 (fp.sub roundNearestTiesToEven a!6 a!5))
         ((_ to_fp 11 53) #x3ccf98e5b3e6a8e9)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
...
(let ((a!7 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         (fp.sub roundNearestTiesToEven a!7 a!6)
                         ((_ to_fp 11 53) #xbcea0ff4ed61c1fc))
                 (fp.sub roundNearestTiesToEven a!7 a!6))
         ((_ to_fp 11 53) #xbcea0ff4ed61c1fc))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
...
(let ((a!8 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         (fp.sub roundNearestTiesToEven a!8 a!7)
                         ((_ to_fp 11 53) #x3d05c1b4c5c446d5))
                 (fp.sub roundNearestTiesToEven a!8 a!7))
         ((_ to_fp 11 53) #x3d05c1b4c5c446d5)))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
