...
(declare-fun epsabs_ack!2857 () (_ BitVec 64))
(declare-fun epsrel_ack!2858 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!2857) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2858)
...
(let ((a!36 (fp.add roundNearestTiesToEven
                    ...
                    a!35)))
  (FPCHECK_FADD_UNDERFLOW a!36 a!37))))))))))
