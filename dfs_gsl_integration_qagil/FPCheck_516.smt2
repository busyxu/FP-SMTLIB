...
(declare-fun epsabs_ack!3377 () (_ BitVec 64))
(declare-fun epsrel_ack!3378 () (_ BitVec 64))
(declare-fun b_ack!3380 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3379)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3377) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3378)
...
(let ((a!35 (fp.mul roundNearestTiesToEven
      ...
      (a!38 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fbad384a34814c6)
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!22 a!34))
                            (fp.abs (fp.sub roundNearestTiesToEven a!24 a!34)))))
      (a!39 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fc200ed0f46e8c1)
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!8 a!34))
                            (fp.abs (fp.sub roundNearestTiesToEven a!10 a!34)))))
      (a!40 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fc5a1f266e47d5c)
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!26 a!34))
                            (fp.abs (fp.sub roundNearestTiesToEven a!28 a!34)))))
      (a!42 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fc85d6861c80eb1)
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!13 a!34))
                            (fp.abs (fp.sub roundNearestTiesToEven a!15 a!34)))))
      (a!43 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3fca2adbcbec9cd8)
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!31 a!34))
                            (fp.abs (fp.sub roundNearestTiesToEven a!33 a!34))))))
...
(let ((a!41 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!36 a!37)
                                    a!38)
                            a!39)
                    a!40)))
  (FPCHECK_FADD_UNDERFLOW (fp.add roundNearestTiesToEven a!41 a!42) a!43)))))))))))
