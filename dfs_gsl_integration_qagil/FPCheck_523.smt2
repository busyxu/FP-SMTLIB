(declare-fun limit_ack!3427 () (_ BitVec 64))
(declare-fun epsabs_ack!3425 () (_ BitVec 64))
(declare-fun epsrel_ack!3426 () (_ BitVec 64))
(declare-fun b_ack!3428 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3427)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3425) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3426)
...
(let ((a!35 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.add roundNearestTiesToEven a!13 a!15))))))
  (FPCHECK_FMUL_ACCURACY a!35 #x3fe0000000000000))))))))
