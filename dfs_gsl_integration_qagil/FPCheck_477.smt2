...
(declare-fun epsabs_ack!3105 () (_ BitVec 64))
(declare-fun epsrel_ack!3106 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3105) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3106)
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven a!28 a!2)))))
