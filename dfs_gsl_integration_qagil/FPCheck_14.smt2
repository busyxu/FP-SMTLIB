(declare-fun limit_ack!111 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!111)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!109) ((_ to_fp 11 53) #x0000000000000000)))
