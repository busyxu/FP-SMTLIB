(declare-fun limit_ack!2271 () (_ BitVec 64))
(declare-fun epsabs_ack!2269 () (_ BitVec 64))
(declare-fun epsrel_ack!2270 () (_ BitVec 64))
(declare-fun b_ack!2272 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!2271)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!2269) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!2270)
...
(let ((a!27 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven (fp.abs a!29) (fp.abs a!31))))))))))))
