...
(declare-fun epsabs_ack!3417 () (_ BitVec 64))
(declare-fun epsrel_ack!3418 () (_ BitVec 64))
...
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3417) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3418)
...
(let ((a!35 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.add roundNearestTiesToEven a!13 a!15))))))
  (FPCHECK_FMUL_UNDERFLOW a!35 #x3fe0000000000000))))))))
