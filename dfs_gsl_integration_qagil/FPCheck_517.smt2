(declare-fun limit_ack!3387 () (_ BitVec 64))
...
(assert (not (bvult #x00000000000003e8 limit_ack!3387)))
...
(let ((a!41 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!39)
                    a!40)))
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!41 a!42) a!43)))))))))))
