(declare-fun limit_ack!3355 () (_ BitVec 64))
(declare-fun epsabs_ack!3353 () (_ BitVec 64))
(declare-fun epsrel_ack!3354 () (_ BitVec 64))
(declare-fun b_ack!3356 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3355)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3353) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3354)
...
(let ((a!34 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.add roundNearestTiesToEven a!2 a!33)))
                    ((_ to_fp 11 53) #x3fe0000000000000))))
