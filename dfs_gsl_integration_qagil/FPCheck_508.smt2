(declare-fun limit_ack!3323 () (_ BitVec 64))
(declare-fun epsabs_ack!3321 () (_ BitVec 64))
(declare-fun epsrel_ack!3322 () (_ BitVec 64))
(declare-fun b_ack!3324 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (bvult #x00000000000003e8 limit_ack!3323)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!3321) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!3322)
...
(assert (let ((a!1 (CF_log (fp.mul roundNearestTiesToEven
      ...
      (a!11 (CF_log (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3ff0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) b_ack!3324)
      ...
      (a!29 (CF_log (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3ff0000000000000)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) b_ack!3324)
...
(let ((a!31 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.add roundNearestTiesToEven a!24 a!26)))
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3fc5a1f266e47d5c)
                            (fp.add roundNearestTiesToEven a!28 a!30)))))
(let ((a!34 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            a!31
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3fca2adbcbec9cd8)
                                    (fp.add roundNearestTiesToEven a!33 a!2)))
                    ((_ to_fp 11 53) #x3fe0000000000000))))
  (FPCHECK_FSUB_ACCURACY a!2 a!34))))))))
