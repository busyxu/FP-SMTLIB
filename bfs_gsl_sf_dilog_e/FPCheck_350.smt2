...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (fp.geq ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!9
    (fp.div roundNearestTiesToEven a!10 ((_ to_fp 11 53) #x4082000000000000)))))))))
