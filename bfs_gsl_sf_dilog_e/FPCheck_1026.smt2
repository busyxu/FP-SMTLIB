...
(assert (fp.geq ((_ to_fp 11 53) a_ack!1842) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1842) ((_ to_fp 11 53) #x4000000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 (CF_log a!1))
         a!1)))
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 (CF_log a_ack!1842)))
