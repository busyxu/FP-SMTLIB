...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.geq ((_ to_fp 11 53) a_ack!1315) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1315) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!8 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3ff0000000000000))
                   a!7)))
  (FPCHECK_FMUL_UNDERFLOW #x3cc0000000000000 (fp.abs a!8)))))))))))
