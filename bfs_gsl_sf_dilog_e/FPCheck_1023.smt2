...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.geq ((_ to_fp 11 53) a_ack!1839) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1839) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!14 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!5
                                    ((_ to_fp 11 53) #x4091300000000000))))))
  (fp.lt (fp.abs a!14) ((_ to_fp 11 53) #x3ca0000000000000))))))))))
...
(let ((a!2 (fp.add roundNearestTiesToEven
      ...
      (a!16 (fp.abs (fp.div roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven a!15 (CF_log a!15))
                            (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    ((_ to_fp 11 53) a_ack!1839))))))
...
(let ((a!14 (fp.abs (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3d29000000000000) a!14)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3cc0000000000000) a!16))))))))))
