...
(assert (fp.geq ((_ to_fp 11 53) a_ack!1025) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1025) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!5 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           ((_ to_fp 11 53) a_ack!1025)))))
  (FPCHECK_FDIV_OVERFLOW a!5 #x4096b00000000000)))))))
