...
(assert (fp.geq ((_ to_fp 11 53) a_ack!1321) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1321) ((_ to_fp 11 53) #x4000000000000000)))
...
(assert (FPCHECK_FINVALID_LOG a_ack!1321 a_ack!1321))
