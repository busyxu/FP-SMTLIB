...
(assert (fp.geq ((_ to_fp 11 53) a_ack!1840) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!1840) ((_ to_fp 11 53) #x4000000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 (CF_log a!1))
         a!1)))
(assert (FPCHECK_FINVALID_LOG a_ack!1840 a_ack!1840))
