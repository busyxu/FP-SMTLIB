(declare-fun alpha1_ack!4038 () (_ BitVec 64))
(declare-fun beta_ack!4039 () (_ BitVec 64))
(declare-fun mu_ack!4040 () (_ BitVec 32))
(declare-fun nu_ack!4041 () (_ BitVec 32))
...
(assert (not (fp.lt ((_ to_fp 11 53) alpha1_ack!4038)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) beta_ack!4039)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 mu_ack!4040)))
(assert (= #x00000001 mu_ack!4040))
(assert (= #x00000000 nu_ack!4041))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4022000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4022000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) alpha1_ack!4038)
...
(let ((a!32 (fp.add roundNearestTiesToEven
                    ...
                    a!31)))
  (FPCHECK_FDIV_ZERO
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x8000000000000000) a!32)
    a!33)))))))))))))))))))
