(declare-fun alpha1_ack!2222 () (_ BitVec 64))
(declare-fun beta_ack!2223 () (_ BitVec 64))
(declare-fun mu_ack!2224 () (_ BitVec 32))
(declare-fun nu_ack!2225 () (_ BitVec 32))
(declare-fun CF_pow
...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) alpha1_ack!2222)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) beta_ack!2223)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (= #x00000000 mu_ack!2224))
(assert (= #x00000000 nu_ack!2225))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4022000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4024000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) alpha1_ack!2222)
...
(let ((a!40 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x8000000000000000) a!40)
    a!41)))))))))))))))))))))))
