(declare-fun alpha1_ack!4146 () (_ BitVec 64))
(declare-fun beta_ack!4147 () (_ BitVec 64))
(declare-fun mu_ack!4148 () (_ BitVec 32))
(declare-fun nu_ack!4149 () (_ BitVec 32))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun CF_pow
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             (_ FloatingPoint 11 53))
(assert (not (fp.lt ((_ to_fp 11 53) alpha1_ack!4146)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) beta_ack!4147)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (= #x00000000 mu_ack!4148)))
(assert (= #x00000001 mu_ack!4148))
(assert (= #x00000000 nu_ack!4149))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4024000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) alpha1_ack!4146)
...
(let ((a!36 (fp.add roundNearestTiesToEven
                    (CF_pow #x4000000000000000
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!35)))
  (FPCHECK_FSUB_OVERFLOW #x8000000000000000 a!36)))))))))))))))))))))
