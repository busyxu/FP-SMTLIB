(declare-fun alpha1_ack!2142 () (_ BitVec 64))
(declare-fun beta_ack!2143 () (_ BitVec 64))
(declare-fun mu_ack!2144 () (_ BitVec 32))
(declare-fun nu_ack!2145 () (_ BitVec 32))
(declare-fun CF_pow
...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) alpha1_ack!2142)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) beta_ack!2143)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (= #x00000000 mu_ack!2144))
(assert (= #x00000000 nu_ack!2145))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4022000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4024000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) alpha1_ack!2142)
