(declare-fun alpha1_ack!1792 () (_ BitVec 64))
(declare-fun beta_ack!1793 () (_ BitVec 64))
(declare-fun mu_ack!1794 () (_ BitVec 32))
(declare-fun nu_ack!1795 () (_ BitVec 32))
...
(assert (not (fp.lt ((_ to_fp 11 53) alpha1_ack!1792)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) beta_ack!1793)
            ((_ to_fp 11 53) #xbff0000000000000))))
(assert (= #x00000000 mu_ack!1794))
(assert (= #x00000000 nu_ack!1795))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4022000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4022000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) alpha1_ack!1792)
