...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!169))
            ((_ to_fp 11 53) #x3e50000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!169))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           (fp.abs ((_ to_fp 11 53) a_ack!169)))
                   (CF_cos (fp.abs ((_ to_fp 11 53) a_ack!169))))))
  (FPCHECK_FSUB_OVERFLOW #x3ff921fb54442d18 a!1)))
