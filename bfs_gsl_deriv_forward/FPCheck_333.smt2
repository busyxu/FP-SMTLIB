(declare-fun h_ack!1374 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!1374))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1375)
                                   ((_ to_fp 11 53) h_ack!1374))
...
(let ((a!14 (CF_pow (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4000000000000000
    (fp.sub roundNearestTiesToEven a!14 (CF_pow a!15 #x3ff8000000000000))))))))))
