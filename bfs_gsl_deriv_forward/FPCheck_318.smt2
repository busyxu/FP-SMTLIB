(declare-fun h_ack!1312 () (_ BitVec 64))
(declare-fun x_ack!1313 () (_ BitVec 64))
(declare-fun CF_pow
...
(assert (let ((a!1 (fp.eq (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) x_ack!1313)
                          (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) h_ack!1312)
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!1312))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1313)
                                   ((_ to_fp 11 53) h_ack!1312))
