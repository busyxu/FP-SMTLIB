(declare-fun h_ack!544 () (_ BitVec 64))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!544))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!545)
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) h_ack!544)
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!545)
                                   ((_ to_fp 11 53) h_ack!544))))))
  (FPCHECK_FMUL_UNDERFLOW a!4 #x3cb0000000000000))))))
