(declare-fun h_ack!1284 () (_ BitVec 64))
(declare-fun x_ack!1285 () (_ BitVec 64))
(declare-fun CF_pow
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) x_ack!1285)
                          (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) h_ack!1284)
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!1284))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1285)
                                   ((_ to_fp 11 53) h_ack!1284))
