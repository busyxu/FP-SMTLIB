(declare-fun h_ack!1382 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) h_ack!1382))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (CF_pow (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!1383)
                                   ((_ to_fp 11 53) h_ack!1382))
      ...
      (a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) h_ack!1382)
                                    (CF_pow a!13 #x3fe0000000000000))))))
  (FPCHECK_FSUB_OVERFLOW a!14 (CF_pow a!15 #x3ff8000000000000)))))))))
