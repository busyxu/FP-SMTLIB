(declare-fun h_ack!508 () (_ BitVec 64))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!508))))))))
(assert (FPCHECK_FDIV_UNDERFLOW x_ack!509 h_ack!508))
