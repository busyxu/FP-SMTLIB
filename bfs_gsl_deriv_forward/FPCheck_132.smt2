(declare-fun h_ack!540 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.add roundNearestTiesToEven
                          ((_ to_fp 11 53) x_ack!541)
                          (fp.div roundNearestTiesToEven
                                  ((_ to_fp 11 53) h_ack!540)
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (fp.gt a!3
         (fp.abs (fp.div roundNearestTiesToEven a!7 ((_ to_fp 11 53) h_ack!540))))))))
(assert (let ((a!1 (CF_pow (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) x_ack!541)
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) h_ack!540)
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!541)
                                   ((_ to_fp 11 53) h_ack!540))))))
  (FPCHECK_FMUL_OVERFLOW a!4 #x3cb0000000000000))))))
