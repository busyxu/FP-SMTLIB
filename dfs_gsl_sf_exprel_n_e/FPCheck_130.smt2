...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!438))
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!439)))))
(assert (not (= #x00000000 a_ack!439)))
(assert (not (= #x00000001 a_ack!439)))
(assert (= #x00000002 a_ack!439))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!438) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!438) ((_ to_fp 11 53) #xbf60624dd2f1a9fc)))
