...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!272))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!272) ((_ to_fp 11 53) #xbf60624dd2f1a9fc))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!272) ((_ to_fp 11 53) #x3f60624dd2f1a9fc))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!272) ((_ to_fp 11 53) #x40862e42fefa39ef)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000))
                           ((_ to_fp 11 53) b_ack!272)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!272))))
