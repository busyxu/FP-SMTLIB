...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!200))
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ed965fea53d6e41)
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!201)))))
(assert (not (= #x00000000 a_ack!201)))
(assert (= #x00000001 a_ack!201))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!200) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!200) ((_ to_fp 11 53) #xbf60624dd2f1a9fc)))
