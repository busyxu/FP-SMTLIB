...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!516))
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ed965fea53d6e41)
                    ((_ to_fp 11 53) roundNearestTiesToEven a_ack!517)))))
(assert (not (= #x00000000 a_ack!517)))
(assert (not (= #x00000001 a_ack!517)))
(assert (= #x00000002 a_ack!517))
(assert (fp.lt ((_ to_fp 11 53) b_ack!516) ((_ to_fp 11 53) #xc086232bdd7abcd2)))
