...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!218) ((_ to_fp 11 53) #xbfe0000000000000))))
...
(assert (bvsle #x00000002 a_ack!219))
(assert (FPCHECK_FADD_ACCURACY #x4000000000000000 b_ack!218))
