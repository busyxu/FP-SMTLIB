...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3135) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!3137 #x00000000)))
(assert (not (= #x00000000 a_ack!3137)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3135) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000017 a_ack!3137))
(assert (bvsle #x00000018 a_ack!3137))
