...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1737) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1739 #x00000000)))
(assert (not (= #x00000000 a_ack!1739)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1737) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!34 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1738))
            (fp.div roundNearestTiesToEven
                    a!34
                    ((_ to_fp 11 53) #x4028000000000000)))
    (fp.mul roundNearestTiesToEven
