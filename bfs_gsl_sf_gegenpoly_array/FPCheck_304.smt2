...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1211) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1213 #x00000000)))
(assert (not (= #x00000000 a_ack!1213)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1211) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!22 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!1212))
            (fp.div roundNearestTiesToEven
                    a!22
                    ((_ to_fp 11 53) #x4020000000000000)))
    (fp.mul roundNearestTiesToEven
