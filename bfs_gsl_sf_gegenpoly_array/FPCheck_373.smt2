...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1485) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1487 #x00000000)))
(assert (not (= #x00000000 a_ack!1487)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1485) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!30 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!26
                                    ((_ to_fp 11 53) #x4022000000000000))))))
  (FPCHECK_FDIV_UNDERFLOW a!30 #x4026000000000000)))))))))))))
