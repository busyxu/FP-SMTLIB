...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!957) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!959 #x00000000)))
(assert (not (= #x00000000 a_ack!959)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!957) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!16 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!1 ((_ to_fp 11 53) c_ack!958))
            (fp.div roundNearestTiesToEven
                    a!16
                    ((_ to_fp 11 53) #x4018000000000000)))
    (fp.mul roundNearestTiesToEven
