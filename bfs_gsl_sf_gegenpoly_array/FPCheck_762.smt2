...
(declare-fun FPCHECK_FMUL_OVERFLOW
             ...
             Bool)
(declare-fun c_ack!3006 () (_ BitVec 64))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3005) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!3007 #x00000000)))
(assert (not (= #x00000000 a_ack!3007)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!3005) ((_ to_fp 11 53) #x0000000000000000)))
(assert (bvsle #x00000002 a_ack!3007))
(assert (bvsle #x00000003 a_ack!3007))
(assert (bvsle #x00000004 a_ack!3007))
(assert (bvsle #x00000005 a_ack!3007))
(assert (bvsle #x00000006 a_ack!3007))
(assert (bvsle #x00000007 a_ack!3007))
(assert (bvsle #x00000008 a_ack!3007))
(assert (bvsle #x00000009 a_ack!3007))
(assert (bvsle #x0000000a a_ack!3007))
(assert (bvsle #x0000000b a_ack!3007))
(assert (bvsle #x0000000c a_ack!3007))
(assert (bvsle #x0000000d a_ack!3007))
(assert (bvsle #x0000000e a_ack!3007))
(assert (bvsle #x0000000f a_ack!3007))
(assert (bvsle #x00000010 a_ack!3007))
(assert (bvsle #x00000011 a_ack!3007))
(assert (bvsle #x00000012 a_ack!3007))
(assert (bvsle #x00000013 a_ack!3007))
(assert (bvsle #x00000014 a_ack!3007))
(assert (bvsle #x00000015 a_ack!3007))
(assert (bvsle #x00000016 a_ack!3007))
(assert (bvsle #x00000017 a_ack!3007))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4037000000000000)
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53) b_ack!3005)))
                   ((_ to_fp 11 53) #x4000000000000000)))
