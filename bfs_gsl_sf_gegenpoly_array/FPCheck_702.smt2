...
(declare-fun c_ack!2783 () (_ BitVec 64))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2782) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!2784 #x00000000)))
(assert (not (= #x00000000 a_ack!2784)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2782) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (bvsle #x00000015 a_ack!2784))
...
(let ((a!60 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!56
                                    ((_ to_fp 11 53) #x4033000000000000))))))
  (FPCHECK_FDIV_OVERFLOW a!60 #x4035000000000000)))))))))))))))))))))))
