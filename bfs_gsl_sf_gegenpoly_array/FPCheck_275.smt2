...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!1101) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!1103 #x00000000)))
(assert (not (= #x00000000 a_ack!1103)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!1101) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!21 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!17
                                    ((_ to_fp 11 53) #x4018000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!21 #x4020000000000000))))))))))
