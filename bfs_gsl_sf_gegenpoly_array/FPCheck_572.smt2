...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2271) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (bvslt a_ack!2273 #x00000000)))
(assert (not (= #x00000000 a_ack!2273)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!2271) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!48 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven
                                    a!44
                                    ((_ to_fp 11 53) #x402e000000000000))))))
  (FPCHECK_FDIV_ACCURACY a!48 #x4031000000000000)))))))))))))))))))
