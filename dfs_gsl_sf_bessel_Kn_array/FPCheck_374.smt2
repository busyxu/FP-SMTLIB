...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1645) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1644))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1645) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1645) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1645) ((_ to_fp 11 53) #x4020000000000000))))
