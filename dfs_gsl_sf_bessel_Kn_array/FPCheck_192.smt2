...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!889) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!889) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!889))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    a!7
    (fp.mul roundNearestTiesToEven (CF_log c_ack!889) a!12))))))))))
