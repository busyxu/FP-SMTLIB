...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!871) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!870))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!871) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!871) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW (CF_log c_ack!871) a!5)))))))
