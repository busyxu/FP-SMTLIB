(declare-fun a_ack!5060 () (_ BitVec 32))
(declare-fun b_ack!5058 () (_ BitVec 32))
(declare-fun c_ack!5059 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!5060 #x00000000)))
(assert (not (bvslt b_ack!5058 a_ack!5060)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!5058)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5059) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!30 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!24 a!19)
                                    ((_ to_fp 11 53) #xbe0330e9e355cb2d)))))
      (a!33 (fp.abs (fp.mul roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4000000000000000)
                                    a!2)
                            (fp.add roundNearestTiesToEven
...
(let ((a!31 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!31
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!33 (fp.abs a!28))
