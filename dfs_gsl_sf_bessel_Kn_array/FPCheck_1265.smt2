...
(declare-fun b_ack!5145 () (_ BitVec 32))
(declare-fun c_ack!5146 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!5147 #x00000000)))
(assert (not (bvslt b_ack!5145 a_ack!5147)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!5145)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5146) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!34 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!34
    (fp.add roundNearestTiesToEven a!36 ((_ to_fp 11 53) #x3f3038fb9be6c5aa))))))))))))))))))))))
