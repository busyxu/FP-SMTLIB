...
(declare-fun b_ack!3936 () (_ BitVec 32))
(declare-fun c_ack!3937 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!3938 #x00000000)))
(assert (not (bvslt b_ack!3936 a_ack!3938)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3937) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!3936)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3937) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3937) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3937) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3937) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!16 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            a!14
                            ((_ to_fp 11 53) #x3f22ef1bcd47bec8)))))
  (FPCHECK_FADD_ACCURACY a!16 #xbf789d425fd7dd93))))))))))))))))))
