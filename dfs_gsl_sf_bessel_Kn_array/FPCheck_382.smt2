...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1669) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1668))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1669) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1669) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1669) ((_ to_fp 11 53) #x4020000000000000))))
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven
                    a!18
                    ((_ to_fp 11 53) #x3d856b2c54b23e51)))
    (fp.add roundNearestTiesToEven a!21 ((_ to_fp 11 53) #x3dc15d530f529e11))))))))))))))))
