...
(assert (not (= #x00000000 b_ack!3849)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3850) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3850) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3850) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3850) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!15 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            a!13
                            ((_ to_fp 11 53) #xbed0d595dd239ad5)))))
  (FPCHECK_FADD_OVERFLOW a!15 #xbf82ca43e2075142)))))))))))))))))
