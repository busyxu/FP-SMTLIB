...
(assert (not (bvslt b_ack!2142 a_ack!2144)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2143) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2142))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2143) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2143) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2143) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!13
                                    ((_ to_fp 11 53) #xbed0d595dd239ad5))))))
  (FPCHECK_FADD_UNDERFLOW a!16 #x3f82ca43e2075142))))))))))))))))))
