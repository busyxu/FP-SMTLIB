(declare-fun a_ack!5300 () (_ BitVec 32))
(declare-fun b_ack!5298 () (_ BitVec 32))
(declare-fun c_ack!5299 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!5300 #x00000000)))
(assert (not (bvslt b_ack!5298 a_ack!5300)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!5298)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5299) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!14
                                    ((_ to_fp 11 53) #xbf3038fb9be6c5aa))))))
  (FPCHECK_FADD_OVERFLOW a!17 #x3fa054be5713184a)))))))))))))))))))
