...
(declare-fun b_ack!3948 () (_ BitVec 32))
(declare-fun c_ack!3949 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!3950 #x00000000)))
(assert (not (bvslt b_ack!3948 a_ack!3950)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3949) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!3948)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3949) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3949) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3949) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3949) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!15 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    a!2
    (fp.add roundNearestTiesToEven a!15 ((_ to_fp 11 53) #xbf82ca43e2075142)))))))))))))))))))
