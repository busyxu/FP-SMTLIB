...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1579) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!1578))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1579) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1579) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1579) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.add roundNearestTiesToEven
                                   a!6
                                   ((_ to_fp 11 53) #x3d15aeb434479fad))))))
  (FPCHECK_FADD_ACCURACY a!9 #x3d856b2c54b23e51)))))))))))
