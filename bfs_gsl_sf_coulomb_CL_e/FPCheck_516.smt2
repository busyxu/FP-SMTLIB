...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3ff0000000000000))
                   ((_ to_fp 11 53) #x401e000000000000))))
  (not (fp.lt (fp.abs a!1) (fp.abs ((_ to_fp 11 53) b_ack!1822))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!1823)
                           ...
                           ((_ to_fp 11 53) #x3ff0000000000000))
                   ((_ to_fp 11 53) #x401e000000000000))))
  (not (fp.gt (fp.abs a!1) (fp.abs ((_ to_fp 11 53) b_ack!1822))))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
      ...
      (a!21 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) b_ack!1822)))))
(let ((a!3 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!1822)))
                   a!2))
...
(let ((a!35 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            a!33)
                    a!34)))
  (FPCHECK_FSUB_OVERFLOW a!35 a!36)))))))))))))))
