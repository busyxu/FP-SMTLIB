...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!17)) ((_ to_fp 11 53) #x4016a09e667f3bcd)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3e471e703c5f5815)
                           (fp.abs ((_ to_fp 11 53) x_ack!17)))
                   ((_ to_fp 11 53) #x3e471e703c5f5815))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) x_ack!17)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) x_ack!17)))
