...
(declare-fun FPCHECK_FSUB_OVERFLOW
             ...
             Bool)
(assert (bvslt a_ack!661 #x000003e8))
...
(assert (bvsle #x00000002 a_ack!661))
...
(let ((a!2 (fp.gt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3ff0000000000000))))
  (not a!2))))
(assert (bvsle #x00000003 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
...
(assert (bvsle #x00000004 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
...
(assert (bvsle #x00000005 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
...
(assert (bvsle #x00000006 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
...
(assert (bvsle #x00000007 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
...
(assert (bvsle #x00000008 a_ack!661))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!660))
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) b_ack!660))
            a!7)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fedeeea11683f49) a!6))))))))))
