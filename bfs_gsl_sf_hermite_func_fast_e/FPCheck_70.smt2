...
(assert (not (bvslt a_ack!299 #x000003e8)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!298) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!299 #x00000024)))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvmul #x00000002 a_ack!299))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53)
                             ...
                             (bvmul a_ack!299 a_ack!299)))
                   ((_ to_fp 11 53) #x40aa400000000000))))
  (FPCHECK_FADD_ACCURACY a!1 #x3f3a01a01a01a01a)))
