...
(assert (bvslt a_ack!191 #x000003e8))
...
(assert (bvslt #x00000001 a_ack!191))
(assert (not (bvslt #x00000003 a_ack!191)))
(assert (let ((a!1 (not (= #x00000000 (bvand (bvsdiv a_ack!191 #x00000002) #x00000001)))))
