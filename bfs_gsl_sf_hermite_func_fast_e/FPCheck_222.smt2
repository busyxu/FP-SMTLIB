...
(declare-fun FPCHECK_FSUB_ACCURACY
             ...
             Bool)
(assert (bvslt a_ack!737 #x000003e8))
...
(assert (bvsle #x00000007 a_ack!737))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!736))
...
(assert (bvsle #x00000008 a_ack!737))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!736))
...
(assert (bvsle #x00000009 a_ack!737))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!736))
...
(assert (bvsle #x0000000a a_ack!737))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!736))
...
(assert (bvsle #x0000000b a_ack!737))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff6a09e667f3bcd)
                           ((_ to_fp 11 53) b_ack!736))
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) b_ack!736))
            a!10)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fee82c3f9d89e1c) a!9)))))))))))))
