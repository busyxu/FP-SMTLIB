...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (bvslt a_ack!187 #x000003e8))
(assert (not (bvslt a_ack!187 #x00000000)))
(assert (fp.eq ((_ to_fp 11 53) b_ack!186) ((_ to_fp 11 53) #x0000000000000000)))
(assert (= #x00000000 (bvand a_ack!187 #x00000001)))
(assert (bvslt #x00000001 a_ack!187))
(assert (not (bvslt #x00000003 a_ack!187)))
(assert (let ((a!1 (not (= #x00000000 (bvand (bvsdiv a_ack!187 #x00000002) #x00000001)))))
