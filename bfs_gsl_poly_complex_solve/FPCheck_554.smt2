(declare-fun a5_ack!3184 () (_ BitVec 64))
(declare-fun a0_ack!3185 () (_ BitVec 64))
(declare-fun a1_ack!3180 () (_ BitVec 64))
(declare-fun a2_ack!3181 () (_ BitVec 64))
(declare-fun a3_ack!3182 () (_ BitVec 64))
(declare-fun a4_ack!3183 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3184) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3185))
                           ((_ to_fp 11 53) a5_ack!3184)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3180))
                           ((_ to_fp 11 53) a5_ack!3184)))))
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FDIV_ACCURACY a!6 #x3ff0000000000000))))))
