(declare-fun a5_ack!5800 () (_ BitVec 64))
(declare-fun a0_ack!5801 () (_ BitVec 64))
(declare-fun a1_ack!5796 () (_ BitVec 64))
(declare-fun a2_ack!5797 () (_ BitVec 64))
(declare-fun a3_ack!5798 () (_ BitVec 64))
(declare-fun a4_ack!5799 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5800) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5801))
                           ((_ to_fp 11 53) a5_ack!5800)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5796))
                           ((_ to_fp 11 53) a5_ack!5800)))))
...
(let ((a!25 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!24)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FMUL_OVERFLOW a!25 a!2)))))))))))))
