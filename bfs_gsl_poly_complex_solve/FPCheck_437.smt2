(declare-fun a5_ack!2482 () (_ BitVec 64))
(declare-fun a0_ack!2483 () (_ BitVec 64))
(declare-fun a1_ack!2478 () (_ BitVec 64))
(declare-fun a2_ack!2479 () (_ BitVec 64))
(declare-fun a3_ack!2480 () (_ BitVec 64))
(declare-fun a4_ack!2481 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2482) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2483))
                           ((_ to_fp 11 53) a5_ack!2482)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2478))
                           ((_ to_fp 11 53) a5_ack!2482)))))
