(declare-fun a5_ack!6322 () (_ BitVec 64))
(declare-fun a0_ack!6323 () (_ BitVec 64))
(declare-fun a1_ack!6318 () (_ BitVec 64))
(declare-fun a2_ack!6319 () (_ BitVec 64))
(declare-fun a3_ack!6320 () (_ BitVec 64))
(declare-fun a4_ack!6321 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6322) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6323))
                           ((_ to_fp 11 53) a5_ack!6322)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6318))
                           ((_ to_fp 11 53) a5_ack!6322)))))
