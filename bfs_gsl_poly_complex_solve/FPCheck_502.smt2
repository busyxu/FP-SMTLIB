(declare-fun a5_ack!2872 () (_ BitVec 64))
(declare-fun a0_ack!2873 () (_ BitVec 64))
(declare-fun a1_ack!2868 () (_ BitVec 64))
(declare-fun a2_ack!2869 () (_ BitVec 64))
(declare-fun a3_ack!2870 () (_ BitVec 64))
(declare-fun a4_ack!2871 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2872) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2873))
                           ((_ to_fp 11 53) a5_ack!2872)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2868))
                           ((_ to_fp 11 53) a5_ack!2872)))))
