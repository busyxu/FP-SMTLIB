(declare-fun a5_ack!8272 () (_ BitVec 64))
(declare-fun a0_ack!8273 () (_ BitVec 64))
(declare-fun a1_ack!8268 () (_ BitVec 64))
(declare-fun a2_ack!8269 () (_ BitVec 64))
(declare-fun a3_ack!8270 () (_ BitVec 64))
(declare-fun a4_ack!8271 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8272) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8273))
                           ((_ to_fp 11 53) a5_ack!8272)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8268))
                           ((_ to_fp 11 53) a5_ack!8272)))))
...
(let ((a!69 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!40 a!54)
                            (fp.mul roundNearestTiesToEven
                                    a!65
                                    (fp.sub roundNearestTiesToEven a!57 a!66)))
                    (fp.mul roundNearestTiesToEven
                            a!67
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
...
(let ((a!71 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven a!40 a!54)
...
(let ((a!89 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven a!70 a!71)
                            a!76)
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!63 a!64)
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!88))))
  (FPCHECK_FSUB_UNDERFLOW a!71 a!89)))))))))))))))))))))))))))
