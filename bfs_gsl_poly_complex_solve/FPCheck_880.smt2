(declare-fun a5_ack!5140 () (_ BitVec 64))
(declare-fun a0_ack!5141 () (_ BitVec 64))
(declare-fun a1_ack!5136 () (_ BitVec 64))
(declare-fun a2_ack!5137 () (_ BitVec 64))
(declare-fun a3_ack!5138 () (_ BitVec 64))
(declare-fun a4_ack!5139 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5140) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5141))
                           ((_ to_fp 11 53) a5_ack!5140)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5136))
                           ((_ to_fp 11 53) a5_ack!5140)))))
