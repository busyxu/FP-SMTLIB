(declare-fun a5_ack!6694 () (_ BitVec 64))
(declare-fun a0_ack!6695 () (_ BitVec 64))
(declare-fun a1_ack!6690 () (_ BitVec 64))
(declare-fun a2_ack!6691 () (_ BitVec 64))
(declare-fun a3_ack!6692 () (_ BitVec 64))
(declare-fun a4_ack!6693 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6694) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6695))
                           ((_ to_fp 11 53) a5_ack!6694)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6690))
                           ((_ to_fp 11 53) a5_ack!6694)))))
...
(let ((a!25 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!25 ((_ to_fp 11 53) #x0000000000000000))
    (fp.mul roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
