(declare-fun a5_ack!2764 () (_ BitVec 64))
(declare-fun a0_ack!2765 () (_ BitVec 64))
(declare-fun a1_ack!2760 () (_ BitVec 64))
(declare-fun a2_ack!2761 () (_ BitVec 64))
(declare-fun a3_ack!2762 () (_ BitVec 64))
(declare-fun a4_ack!2763 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2764) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2765))
                           ((_ to_fp 11 53) a5_ack!2764)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2760))
                           ((_ to_fp 11 53) a5_ack!2764)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
      ...
      (a!7 (fp.abs (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!5
                                   ((_ to_fp 11 53) #x3ff0000000000000))))))
  (FPCHECK_FADD_ACCURACY (fp.abs a!6) a!7))))))
