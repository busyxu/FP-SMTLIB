(declare-fun a5_ack!5626 () (_ BitVec 64))
(declare-fun a0_ack!5627 () (_ BitVec 64))
(declare-fun a1_ack!5622 () (_ BitVec 64))
(declare-fun a2_ack!5623 () (_ BitVec 64))
(declare-fun a3_ack!5624 () (_ BitVec 64))
(declare-fun a4_ack!5625 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5626) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5627))
                           ((_ to_fp 11 53) a5_ack!5626)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5622))
                           ((_ to_fp 11 53) a5_ack!5626)))))
...
(let ((a!25 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!24)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FMUL_OVERFLOW a!25 #x0000000000000000)))))))))))))
