(declare-fun a5_ack!2572 () (_ BitVec 64))
(declare-fun a0_ack!2573 () (_ BitVec 64))
(declare-fun a1_ack!2568 () (_ BitVec 64))
(declare-fun a2_ack!2569 () (_ BitVec 64))
(declare-fun a3_ack!2570 () (_ BitVec 64))
(declare-fun a4_ack!2571 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2572) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2573))
                           ((_ to_fp 11 53) a5_ack!2572)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2568))
                           ((_ to_fp 11 53) a5_ack!2572)))))
