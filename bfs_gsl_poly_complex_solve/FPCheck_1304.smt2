(declare-fun a5_ack!7684 () (_ BitVec 64))
(declare-fun a0_ack!7685 () (_ BitVec 64))
(declare-fun a1_ack!7680 () (_ BitVec 64))
(declare-fun a2_ack!7681 () (_ BitVec 64))
(declare-fun a3_ack!7682 () (_ BitVec 64))
(declare-fun a4_ack!7683 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7684) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7685))
                           ((_ to_fp 11 53) a5_ack!7684)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7680))
                           ((_ to_fp 11 53) a5_ack!7684)))))
...
(let ((a!73 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!43 a!73)
            a!74)
    (fp.div roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven a!51 a!62)
