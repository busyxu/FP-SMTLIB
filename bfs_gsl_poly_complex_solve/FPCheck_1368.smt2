(declare-fun a5_ack!8068 () (_ BitVec 64))
(declare-fun a0_ack!8069 () (_ BitVec 64))
(declare-fun a1_ack!8064 () (_ BitVec 64))
(declare-fun a2_ack!8065 () (_ BitVec 64))
(declare-fun a3_ack!8066 () (_ BitVec 64))
(declare-fun a4_ack!8067 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8068) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8069))
                           ((_ to_fp 11 53) a5_ack!8068)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8064))
                           ((_ to_fp 11 53) a5_ack!8068)))))
...
(let ((a!70 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!56)
                            a!57))))
  (FPCHECK_FSUB_OVERFLOW a!43 a!70))))))))))))))))))))))
