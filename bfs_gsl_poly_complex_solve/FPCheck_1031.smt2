(declare-fun a5_ack!6046 () (_ BitVec 64))
(declare-fun a0_ack!6047 () (_ BitVec 64))
(declare-fun a1_ack!6042 () (_ BitVec 64))
(declare-fun a2_ack!6043 () (_ BitVec 64))
(declare-fun a3_ack!6044 () (_ BitVec 64))
(declare-fun a4_ack!6045 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6046) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6047))
                           ((_ to_fp 11 53) a5_ack!6046)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6042))
                           ((_ to_fp 11 53) a5_ack!6046)))))
      ...
      (a!32 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!29)
                            (fp.mul roundNearestTiesToEven a!30 a!8)))))
