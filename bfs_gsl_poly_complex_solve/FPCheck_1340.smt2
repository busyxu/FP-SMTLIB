(declare-fun a5_ack!7900 () (_ BitVec 64))
(declare-fun a0_ack!7901 () (_ BitVec 64))
(declare-fun a1_ack!7896 () (_ BitVec 64))
(declare-fun a2_ack!7897 () (_ BitVec 64))
(declare-fun a3_ack!7898 () (_ BitVec 64))
(declare-fun a4_ack!7899 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7900) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7901))
                           ((_ to_fp 11 53) a5_ack!7900)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7896))
                           ((_ to_fp 11 53) a5_ack!7900)))))
...
(let ((a!68 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!58)
                            a!59))))
  (FPCHECK_FSUB_ACCURACY a!35 a!68))))))))))))))))))))))
