(declare-fun a5_ack!1356 () (_ BitVec 64))
(declare-fun a0_ack!1357 () (_ BitVec 64))
(declare-fun a1_ack!1354 () (_ BitVec 64))
(declare-fun a2_ack!1355 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1356) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1357))
                           ((_ to_fp 11 53) a5_ack!1356)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a2_ack!1355))
                           ((_ to_fp 11 53) a5_ack!1356)))))
  (fp.gt ((_ to_fp 11 53) #x41f0000000000000)
         (fp.mul roundNearestTiesToEven
                 (fp.add roundNearestTiesToEven
                         ((_ to_fp 11 53) #x41f0000000000000)
                         a!1)
