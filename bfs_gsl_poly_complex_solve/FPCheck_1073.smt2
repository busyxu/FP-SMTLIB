(declare-fun a5_ack!6298 () (_ BitVec 64))
(declare-fun a0_ack!6299 () (_ BitVec 64))
(declare-fun a1_ack!6294 () (_ BitVec 64))
(declare-fun a2_ack!6295 () (_ BitVec 64))
(declare-fun a3_ack!6296 () (_ BitVec 64))
(declare-fun a4_ack!6297 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6298) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6299))
                           ((_ to_fp 11 53) a5_ack!6298)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6294))
                           ((_ to_fp 11 53) a5_ack!6298)))))
...
(let ((a!40 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!39))))
  (FPCHECK_FSUB_ACCURACY a!30 a!40))))))))))))))))))
