(declare-fun a5_ack!3370 () (_ BitVec 64))
(declare-fun a0_ack!3371 () (_ BitVec 64))
(declare-fun a1_ack!3366 () (_ BitVec 64))
(declare-fun a2_ack!3367 () (_ BitVec 64))
(declare-fun a3_ack!3368 () (_ BitVec 64))
(declare-fun a4_ack!3369 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3370) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3371))
                           ((_ to_fp 11 53) a5_ack!3370)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3366))
                           ((_ to_fp 11 53) a5_ack!3370)))))
