(declare-fun a5_ack!4972 () (_ BitVec 64))
(declare-fun a0_ack!4973 () (_ BitVec 64))
(declare-fun a1_ack!4968 () (_ BitVec 64))
(declare-fun a2_ack!4969 () (_ BitVec 64))
(declare-fun a3_ack!4970 () (_ BitVec 64))
(declare-fun a4_ack!4971 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4972) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4973))
                           ((_ to_fp 11 53) a5_ack!4972)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4968))
                           ((_ to_fp 11 53) a5_ack!4972)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!23)
                    (fp.abs a!10))))
  (FPCHECK_FDIV_INVALID a!10 a!24))))))))))))
