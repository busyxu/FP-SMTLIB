(declare-fun a5_ack!6718 () (_ BitVec 64))
(declare-fun a0_ack!6719 () (_ BitVec 64))
(declare-fun a1_ack!6714 () (_ BitVec 64))
(declare-fun a2_ack!6715 () (_ BitVec 64))
(declare-fun a3_ack!6716 () (_ BitVec 64))
(declare-fun a4_ack!6717 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6718) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6719))
                           ((_ to_fp 11 53) a5_ack!6718)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6714))
                           ((_ to_fp 11 53) a5_ack!6718)))))
