(declare-fun a5_ack!4666 () (_ BitVec 64))
(declare-fun a0_ack!4667 () (_ BitVec 64))
(declare-fun a1_ack!4662 () (_ BitVec 64))
(declare-fun a2_ack!4663 () (_ BitVec 64))
(declare-fun a3_ack!4664 () (_ BitVec 64))
(declare-fun a4_ack!4665 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4666) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4667))
                           ((_ to_fp 11 53) a5_ack!4666)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4662))
                           ((_ to_fp 11 53) a5_ack!4666)))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!11)
    (fp.mul roundNearestTiesToEven a!15 (fp.div roundNearestTiesToEven a!6 a!7))))))))))))
