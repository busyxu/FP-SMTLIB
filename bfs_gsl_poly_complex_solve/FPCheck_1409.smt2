(declare-fun a5_ack!8314 () (_ BitVec 64))
(declare-fun a0_ack!8315 () (_ BitVec 64))
(declare-fun a1_ack!8310 () (_ BitVec 64))
(declare-fun a2_ack!8311 () (_ BitVec 64))
(declare-fun a3_ack!8312 () (_ BitVec 64))
(declare-fun a4_ack!8313 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8314) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8315))
                           ((_ to_fp 11 53) a5_ack!8314)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8310))
                           ((_ to_fp 11 53) a5_ack!8314)))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
      ...
      (a!32 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x0000000000000000)
                            a!21)
                    (fp.mul roundNearestTiesToEven a!22 a!12))))
(let ((a!25 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
      ...
      (a!33 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!17)
                            (fp.mul roundNearestTiesToEven a!18 a!12))
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!25)
                                    a!26)
...
(let ((a!56 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!51 a!53)
                                    (fp.mul roundNearestTiesToEven a!54 a!55))
                            a!49))))
  (FPCHECK_FMUL_ACCURACY a!49 a!56))))))))))))))))))))))
