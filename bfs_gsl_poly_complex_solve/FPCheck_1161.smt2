(declare-fun a5_ack!6826 () (_ BitVec 64))
(declare-fun a0_ack!6827 () (_ BitVec 64))
(declare-fun a1_ack!6822 () (_ BitVec 64))
(declare-fun a2_ack!6823 () (_ BitVec 64))
(declare-fun a3_ack!6824 () (_ BitVec 64))
(declare-fun a4_ack!6825 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6826) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6827))
                           ((_ to_fp 11 53) a5_ack!6826)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6822))
                           ((_ to_fp 11 53) a5_ack!6826)))))
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_ACCURACY #x0000000000000000 a!27)))))))))))))))
