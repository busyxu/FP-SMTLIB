(declare-fun a5_ack!7516 () (_ BitVec 64))
(declare-fun a0_ack!7517 () (_ BitVec 64))
(declare-fun a1_ack!7512 () (_ BitVec 64))
(declare-fun a2_ack!7513 () (_ BitVec 64))
(declare-fun a3_ack!7514 () (_ BitVec 64))
(declare-fun a4_ack!7515 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7516) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7517))
                           ((_ to_fp 11 53) a5_ack!7516)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7512))
                           ((_ to_fp 11 53) a5_ack!7516)))))
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!17 a!24)
                                    a!25)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!15))))
...
(let ((a!41 (fp.sub roundNearestTiesToEven
      ...
      (a!50 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!43 a!46))
                            (fp.abs (fp.sub roundNearestTiesToEven a!33 a!40)))
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!49)))))
(let ((a!51 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!43 a!46)
                            a!50)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!52 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!33 a!40)
                                    a!50)
                            a!51)
                    a!41))
...
(let ((a!55 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven a!47 a!52)
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!50)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_UNDERFLOW a!41 a!55))))))))))))))))))))))
