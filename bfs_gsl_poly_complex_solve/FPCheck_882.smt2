(declare-fun a5_ack!5152 () (_ BitVec 64))
(declare-fun a0_ack!5153 () (_ BitVec 64))
(declare-fun a1_ack!5148 () (_ BitVec 64))
(declare-fun a2_ack!5149 () (_ BitVec 64))
(declare-fun a3_ack!5150 () (_ BitVec 64))
(declare-fun a4_ack!5151 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5152) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5153))
                           ((_ to_fp 11 53) a5_ack!5152)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5148))
                           ((_ to_fp 11 53) a5_ack!5152)))))
