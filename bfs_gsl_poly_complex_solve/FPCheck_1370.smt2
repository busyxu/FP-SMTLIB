(declare-fun a5_ack!8080 () (_ BitVec 64))
(declare-fun a0_ack!8081 () (_ BitVec 64))
(declare-fun a1_ack!8076 () (_ BitVec 64))
(declare-fun a2_ack!8077 () (_ BitVec 64))
(declare-fun a3_ack!8078 () (_ BitVec 64))
(declare-fun a4_ack!8079 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8080) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8081))
                           ((_ to_fp 11 53) a5_ack!8080)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8076))
                           ((_ to_fp 11 53) a5_ack!8080)))))
...
(let ((a!70 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!56)
                            a!57))))
  (FPCHECK_FSUB_ACCURACY a!43 a!70))))))))))))))))))))))
