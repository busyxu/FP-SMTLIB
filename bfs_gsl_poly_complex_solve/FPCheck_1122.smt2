(declare-fun a5_ack!6592 () (_ BitVec 64))
(declare-fun a0_ack!6593 () (_ BitVec 64))
(declare-fun a1_ack!6588 () (_ BitVec 64))
(declare-fun a2_ack!6589 () (_ BitVec 64))
(declare-fun a3_ack!6590 () (_ BitVec 64))
(declare-fun a4_ack!6591 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6592) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6593))
                           ((_ to_fp 11 53) a5_ack!6592)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6588))
                           ((_ to_fp 11 53) a5_ack!6592)))))
