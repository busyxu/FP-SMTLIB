(declare-fun a5_ack!7486 () (_ BitVec 64))
(declare-fun a0_ack!7487 () (_ BitVec 64))
(declare-fun a1_ack!7482 () (_ BitVec 64))
(declare-fun a2_ack!7483 () (_ BitVec 64))
(declare-fun a3_ack!7484 () (_ BitVec 64))
(declare-fun a4_ack!7485 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7486) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7487))
                           ((_ to_fp 11 53) a5_ack!7486)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7482))
                           ((_ to_fp 11 53) a5_ack!7486)))))
...
(let ((a!44 (fp.sub roundNearestTiesToEven
      ...
      (a!50 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!36 a!43))
...
(let ((a!51 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!36 a!43)
                            a!50)
                    ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!53 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven a!44 a!53)
                    (fp.mul roundNearestTiesToEven a!54 a!28))
            a!55))))))))))))))))))))))
