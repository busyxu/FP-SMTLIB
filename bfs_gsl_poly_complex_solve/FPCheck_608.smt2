(declare-fun a5_ack!3508 () (_ BitVec 64))
(declare-fun a0_ack!3509 () (_ BitVec 64))
(declare-fun a1_ack!3504 () (_ BitVec 64))
(declare-fun a2_ack!3505 () (_ BitVec 64))
(declare-fun a3_ack!3506 () (_ BitVec 64))
(declare-fun a4_ack!3507 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3508) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3509))
                           ((_ to_fp 11 53) a5_ack!3508)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3504))
                           ((_ to_fp 11 53) a5_ack!3508)))))
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) #x0000000000000000)))
    (fp.mul roundNearestTiesToEven a!8 ((_ to_fp 11 53) #x3ff0000000000000)))))))))
