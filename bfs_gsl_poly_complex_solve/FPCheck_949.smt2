(declare-fun a5_ack!5554 () (_ BitVec 64))
(declare-fun a0_ack!5555 () (_ BitVec 64))
(declare-fun a1_ack!5550 () (_ BitVec 64))
(declare-fun a2_ack!5551 () (_ BitVec 64))
(declare-fun a3_ack!5552 () (_ BitVec 64))
(declare-fun a4_ack!5553 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5554) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5555))
                           ((_ to_fp 11 53) a5_ack!5554)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5550))
                           ((_ to_fp 11 53) a5_ack!5554)))))
...
(let ((a!26 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!19)
                            (fp.mul roundNearestTiesToEven a!20 a!9)))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    a!29
    (fp.div roundNearestTiesToEven a!25 ((_ to_fp 11 53) #x3ff0000000000000))))))))))))))))))
