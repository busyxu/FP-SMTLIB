(declare-fun a5_ack!7924 () (_ BitVec 64))
(declare-fun a0_ack!7925 () (_ BitVec 64))
(declare-fun a1_ack!7920 () (_ BitVec 64))
(declare-fun a2_ack!7921 () (_ BitVec 64))
(declare-fun a3_ack!7922 () (_ BitVec 64))
(declare-fun a4_ack!7923 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7924) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7925))
                           ((_ to_fp 11 53) a5_ack!7924)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7920))
                           ((_ to_fp 11 53) a5_ack!7924)))))
...
(let ((a!51 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x3ff0000000000000))
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_OVERFLOW a!51 a!57))))))))))))))))))))
