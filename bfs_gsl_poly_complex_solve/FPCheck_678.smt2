(declare-fun a5_ack!3928 () (_ BitVec 64))
(declare-fun a0_ack!3929 () (_ BitVec 64))
(declare-fun a1_ack!3924 () (_ BitVec 64))
(declare-fun a2_ack!3925 () (_ BitVec 64))
(declare-fun a3_ack!3926 () (_ BitVec 64))
(declare-fun a4_ack!3927 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3928) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3929))
                           ((_ to_fp 11 53) a5_ack!3928)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3924))
                           ((_ to_fp 11 53) a5_ack!3928)))))
