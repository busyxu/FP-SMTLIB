(declare-fun a5_ack!4606 () (_ BitVec 64))
(declare-fun a0_ack!4607 () (_ BitVec 64))
(declare-fun a1_ack!4602 () (_ BitVec 64))
(declare-fun a2_ack!4603 () (_ BitVec 64))
(declare-fun a3_ack!4604 () (_ BitVec 64))
(declare-fun a4_ack!4605 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4606) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4607))
                           ((_ to_fp 11 53) a5_ack!4606)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4602))
                           ((_ to_fp 11 53) a5_ack!4606)))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!14)))))
  (FPCHECK_FMUL_UNDERFLOW a!15 a!8))))))))))
