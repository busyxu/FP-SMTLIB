(declare-fun a5_ack!4732 () (_ BitVec 64))
(declare-fun a0_ack!4733 () (_ BitVec 64))
(declare-fun a1_ack!4728 () (_ BitVec 64))
(declare-fun a2_ack!4729 () (_ BitVec 64))
(declare-fun a3_ack!4730 () (_ BitVec 64))
(declare-fun a4_ack!4731 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4732) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4733))
                           ((_ to_fp 11 53) a5_ack!4732)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4728))
                           ((_ to_fp 11 53) a5_ack!4732)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_OVERFLOW a!6 #x3ff0000000000000))))))
