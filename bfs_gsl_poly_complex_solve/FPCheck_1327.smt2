(declare-fun a5_ack!7822 () (_ BitVec 64))
(declare-fun a0_ack!7823 () (_ BitVec 64))
(declare-fun a1_ack!7818 () (_ BitVec 64))
(declare-fun a2_ack!7819 () (_ BitVec 64))
(declare-fun a3_ack!7820 () (_ BitVec 64))
(declare-fun a4_ack!7821 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7822) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7823))
                           ((_ to_fp 11 53) a5_ack!7822)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7818))
                           ((_ to_fp 11 53) a5_ack!7822)))))
...
(let ((a!13 (fp.add roundNearestTiesToEven
      ...
      (a!66 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!63 a!64)
                                    a!65)
                            (fp.div roundNearestTiesToEven
                                    a!7
                                    ((_ to_fp 11 53) #x3ff0000000000000))))))
...
(let ((a!25 (fp.add roundNearestTiesToEven
      ...
      (a!55 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x0000000000000000)
                            a!50)
                    (fp.mul roundNearestTiesToEven a!54 a!9))))
(let ((a!26 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!18 a!21)
                            a!25)
...
(let ((a!49 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven a!49 a!59)
            a!61)
    (fp.mul roundNearestTiesToEven a!62 a!66)))))))))))))))))))))
