(declare-fun a5_ack!3538 () (_ BitVec 64))
(declare-fun a0_ack!3539 () (_ BitVec 64))
(declare-fun a1_ack!3534 () (_ BitVec 64))
(declare-fun a2_ack!3535 () (_ BitVec 64))
(declare-fun a3_ack!3536 () (_ BitVec 64))
(declare-fun a4_ack!3537 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3538) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3539))
                           ((_ to_fp 11 53) a5_ack!3538)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3534))
                           ((_ to_fp 11 53) a5_ack!3538)))))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           a!8
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FMUL_ACCURACY a!9 a!10))))))))
