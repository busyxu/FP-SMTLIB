(declare-fun a5_ack!6286 () (_ BitVec 64))
(declare-fun a0_ack!6287 () (_ BitVec 64))
(declare-fun a1_ack!6282 () (_ BitVec 64))
(declare-fun a2_ack!6283 () (_ BitVec 64))
(declare-fun a3_ack!6284 () (_ BitVec 64))
(declare-fun a4_ack!6285 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6286) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6287))
                           ((_ to_fp 11 53) a5_ack!6286)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6282))
                           ((_ to_fp 11 53) a5_ack!6286)))))
...
(let ((a!40 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!39))))
  (FPCHECK_FSUB_OVERFLOW a!30 a!40))))))))))))))))))
