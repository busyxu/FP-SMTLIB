(declare-fun a5_ack!5092 () (_ BitVec 64))
(declare-fun a0_ack!5093 () (_ BitVec 64))
(declare-fun a1_ack!5088 () (_ BitVec 64))
(declare-fun a2_ack!5089 () (_ BitVec 64))
(declare-fun a3_ack!5090 () (_ BitVec 64))
(declare-fun a4_ack!5091 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5092) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5093))
                           ((_ to_fp 11 53) a5_ack!5092)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5088))
                           ((_ to_fp 11 53) a5_ack!5092)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!21)
                    (fp.abs a!23))))
  (FPCHECK_FMUL_ACCURACY #xbff0000000000000 a!24))))))))))))
