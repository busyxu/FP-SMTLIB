(declare-fun a5_ack!3670 () (_ BitVec 64))
(declare-fun a0_ack!3671 () (_ BitVec 64))
(declare-fun a1_ack!3666 () (_ BitVec 64))
(declare-fun a2_ack!3667 () (_ BitVec 64))
(declare-fun a3_ack!3668 () (_ BitVec 64))
(declare-fun a4_ack!3669 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3670) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3671))
                           ((_ to_fp 11 53) a5_ack!3670)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3666))
                           ((_ to_fp 11 53) a5_ack!3670)))))
