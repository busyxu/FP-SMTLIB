(declare-fun a5_ack!4708 () (_ BitVec 64))
(declare-fun a0_ack!4709 () (_ BitVec 64))
(declare-fun a1_ack!4704 () (_ BitVec 64))
(declare-fun a2_ack!4705 () (_ BitVec 64))
(declare-fun a3_ack!4706 () (_ BitVec 64))
(declare-fun a4_ack!4707 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4708) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4709))
                           ((_ to_fp 11 53) a5_ack!4708)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4704))
                           ((_ to_fp 11 53) a5_ack!4708)))))
