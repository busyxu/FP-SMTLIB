(declare-fun a5_ack!5716 () (_ BitVec 64))
(declare-fun a0_ack!5717 () (_ BitVec 64))
(declare-fun a1_ack!5712 () (_ BitVec 64))
(declare-fun a2_ack!5713 () (_ BitVec 64))
(declare-fun a3_ack!5714 () (_ BitVec 64))
(declare-fun a4_ack!5715 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5716) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5717))
                           ((_ to_fp 11 53) a5_ack!5716)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5712))
                           ((_ to_fp 11 53) a5_ack!5716)))))
...
(let ((a!27 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x0000000000000000) a!11)
    (fp.mul roundNearestTiesToEven
            a!27
            (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven a!17 a!24)
