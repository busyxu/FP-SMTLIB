(declare-fun a5_ack!7192 () (_ BitVec 64))
(declare-fun a0_ack!7193 () (_ BitVec 64))
(declare-fun a1_ack!7188 () (_ BitVec 64))
(declare-fun a2_ack!7189 () (_ BitVec 64))
(declare-fun a3_ack!7190 () (_ BitVec 64))
(declare-fun a4_ack!7191 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7192) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7193))
                           ((_ to_fp 11 53) a5_ack!7192)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7188))
                           ((_ to_fp 11 53) a5_ack!7192)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_INVALID
    ...
    (fp.add roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven a!32 a!42)
                    a!48)
            ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))))))))))
