(declare-fun a5_ack!6112 () (_ BitVec 64))
(declare-fun a0_ack!6113 () (_ BitVec 64))
(declare-fun a1_ack!6108 () (_ BitVec 64))
(declare-fun a2_ack!6109 () (_ BitVec 64))
(declare-fun a3_ack!6110 () (_ BitVec 64))
(declare-fun a4_ack!6111 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6112) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6113))
                           ((_ to_fp 11 53) a5_ack!6112)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6108))
                           ((_ to_fp 11 53) a5_ack!6112)))))
...
(let ((a!33 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.mul roundNearestTiesToEven a!31 a!17)
                            a!32)
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!15)))))
  (FPCHECK_FSUB_UNDERFLOW a!17 a!33))))))))))))))
