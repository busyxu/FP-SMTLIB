(declare-fun a5_ack!8356 () (_ BitVec 64))
(declare-fun a0_ack!8357 () (_ BitVec 64))
(declare-fun a1_ack!8352 () (_ BitVec 64))
(declare-fun a2_ack!8353 () (_ BitVec 64))
(declare-fun a3_ack!8354 () (_ BitVec 64))
(declare-fun a4_ack!8355 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8356) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8357))
                           ((_ to_fp 11 53) a5_ack!8356)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8352))
                           ((_ to_fp 11 53) a5_ack!8356)))))
