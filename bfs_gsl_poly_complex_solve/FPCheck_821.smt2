(declare-fun a5_ack!4786 () (_ BitVec 64))
(declare-fun a0_ack!4787 () (_ BitVec 64))
(declare-fun a1_ack!4782 () (_ BitVec 64))
(declare-fun a2_ack!4783 () (_ BitVec 64))
(declare-fun a3_ack!4784 () (_ BitVec 64))
(declare-fun a4_ack!4785 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4786) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4787))
                           ((_ to_fp 11 53) a5_ack!4786)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4782))
                           ((_ to_fp 11 53) a5_ack!4786)))))
...
(let ((a!11 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!10)))
  (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 a!11))))))))
