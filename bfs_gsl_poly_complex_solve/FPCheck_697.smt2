(declare-fun a5_ack!4042 () (_ BitVec 64))
(declare-fun a0_ack!4043 () (_ BitVec 64))
(declare-fun a1_ack!4038 () (_ BitVec 64))
(declare-fun a2_ack!4039 () (_ BitVec 64))
(declare-fun a3_ack!4040 () (_ BitVec 64))
(declare-fun a4_ack!4041 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4042) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4043))
                           ((_ to_fp 11 53) a5_ack!4042)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4038))
                           ((_ to_fp 11 53) a5_ack!4042)))))
      ...
      (a!11 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) a2_ack!4039))
                            ((_ to_fp 11 53) a5_ack!4042)))))
  (FPCHECK_FMUL_OVERFLOW (fp.add roundNearestTiesToEven a!9 a!11) a!12))))))))
