(declare-fun a5_ack!8140 () (_ BitVec 64))
(declare-fun a0_ack!8141 () (_ BitVec 64))
(declare-fun a1_ack!8136 () (_ BitVec 64))
(declare-fun a2_ack!8137 () (_ BitVec 64))
(declare-fun a3_ack!8138 () (_ BitVec 64))
(declare-fun a4_ack!8139 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8140) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8141))
                           ((_ to_fp 11 53) a5_ack!8140)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8136))
                           ((_ to_fp 11 53) a5_ack!8140)))))
...
(let ((a!51 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!41 a!45)
                            a!48)
                    a!49))
...
(let ((a!55 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!50
                                    (fp.mul roundNearestTiesToEven a!51 a!52))
      ...
      (a!59 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!56
                                    (fp.mul roundNearestTiesToEven a!51 a!57))
                            (fp.mul roundNearestTiesToEven a!53 a!58))
                    (fp.div roundNearestTiesToEven
                            a!49
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
(let ((a!60 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!48)
                            ((_ to_fp 11 53) #x3ff0000000000000))
                    (fp.sub roundNearestTiesToEven a!56 a!59))))
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
                    a!49
                    ((_ to_fp 11 53) #x3ff0000000000000))
            (fp.sub roundNearestTiesToEven a!50 a!55))
    a!60)))))))))))))))))))))))
