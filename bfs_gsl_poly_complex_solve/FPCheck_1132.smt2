(declare-fun a5_ack!6652 () (_ BitVec 64))
(declare-fun a0_ack!6653 () (_ BitVec 64))
(declare-fun a1_ack!6648 () (_ BitVec 64))
(declare-fun a2_ack!6649 () (_ BitVec 64))
(declare-fun a3_ack!6650 () (_ BitVec 64))
(declare-fun a4_ack!6651 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6652) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6653))
                           ((_ to_fp 11 53) a5_ack!6652)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6648))
                           ((_ to_fp 11 53) a5_ack!6652)))))
...
(let ((a!40 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!39))))
  (FPCHECK_FSUB_UNDERFLOW a!30 a!40)))))))))))))))))))
