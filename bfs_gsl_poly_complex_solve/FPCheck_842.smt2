(declare-fun a5_ack!4912 () (_ BitVec 64))
(declare-fun a0_ack!4913 () (_ BitVec 64))
(declare-fun a1_ack!4908 () (_ BitVec 64))
(declare-fun a2_ack!4909 () (_ BitVec 64))
(declare-fun a3_ack!4910 () (_ BitVec 64))
(declare-fun a4_ack!4911 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4912) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4913))
                           ((_ to_fp 11 53) a5_ack!4912)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4908))
                           ((_ to_fp 11 53) a5_ack!4912)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!21)
                    (fp.abs a!23))))
  (FPCHECK_FDIV_INVALID (fp.sub roundNearestTiesToEven a!10 a!16) a!24))))))))))))
