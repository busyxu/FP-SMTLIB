(declare-fun a5_ack!6814 () (_ BitVec 64))
(declare-fun a0_ack!6815 () (_ BitVec 64))
(declare-fun a1_ack!6810 () (_ BitVec 64))
(declare-fun a2_ack!6811 () (_ BitVec 64))
(declare-fun a3_ack!6812 () (_ BitVec 64))
(declare-fun a4_ack!6813 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6814) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6815))
                           ((_ to_fp 11 53) a5_ack!6814)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6810))
                           ((_ to_fp 11 53) a5_ack!6814)))))
...
(let ((a!27 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_OVERFLOW #x0000000000000000 a!27)))))))))))))))
