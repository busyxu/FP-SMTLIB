(declare-fun a5_ack!5974 () (_ BitVec 64))
(declare-fun a0_ack!5975 () (_ BitVec 64))
(declare-fun a1_ack!5970 () (_ BitVec 64))
(declare-fun a2_ack!5971 () (_ BitVec 64))
(declare-fun a3_ack!5972 () (_ BitVec 64))
(declare-fun a4_ack!5973 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5974) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5975))
                           ((_ to_fp 11 53) a5_ack!5974)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5970))
                           ((_ to_fp 11 53) a5_ack!5974)))))
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.sub roundNearestTiesToEven
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x0000000000000000)
                    a!25)
            (fp.mul roundNearestTiesToEven a!29 a!8))))))))))))))
