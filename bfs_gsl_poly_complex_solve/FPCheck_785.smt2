(declare-fun a5_ack!4570 () (_ BitVec 64))
(declare-fun a0_ack!4571 () (_ BitVec 64))
(declare-fun a1_ack!4566 () (_ BitVec 64))
(declare-fun a2_ack!4567 () (_ BitVec 64))
(declare-fun a3_ack!4568 () (_ BitVec 64))
(declare-fun a4_ack!4569 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4570) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4571))
                           ((_ to_fp 11 53) a5_ack!4570)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4566))
                           ((_ to_fp 11 53) a5_ack!4570)))))
