(declare-fun a5_ack!6898 () (_ BitVec 64))
(declare-fun a0_ack!6899 () (_ BitVec 64))
(declare-fun a1_ack!6894 () (_ BitVec 64))
(declare-fun a2_ack!6895 () (_ BitVec 64))
(declare-fun a3_ack!6896 () (_ BitVec 64))
(declare-fun a4_ack!6897 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6898) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6899))
                           ((_ to_fp 11 53) a5_ack!6898)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6894))
                           ((_ to_fp 11 53) a5_ack!6898)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!47)))))
  (FPCHECK_FDIV_OVERFLOW (fp.sub roundNearestTiesToEven a!30 a!40) a!48)))))))))))))))))))
