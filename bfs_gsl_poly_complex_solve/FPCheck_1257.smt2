(declare-fun a5_ack!7402 () (_ BitVec 64))
(declare-fun a0_ack!7403 () (_ BitVec 64))
(declare-fun a1_ack!7398 () (_ BitVec 64))
(declare-fun a2_ack!7399 () (_ BitVec 64))
(declare-fun a3_ack!7400 () (_ BitVec 64))
(declare-fun a4_ack!7401 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7402) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7403))
                           ((_ to_fp 11 53) a5_ack!7402)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7398))
                           ((_ to_fp 11 53) a5_ack!7402)))))
...
(let ((a!50 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!49)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FADD_OVERFLOW a!41 (fp.mul roundNearestTiesToEven a!50 a!51)))))))))))))))))))))
