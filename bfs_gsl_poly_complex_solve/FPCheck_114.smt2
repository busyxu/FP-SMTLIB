(declare-fun a5_ack!487 () (_ BitVec 64))
(declare-fun a0_ack!488 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!487) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!488))
                           ((_ to_fp 11 53) a5_ack!487)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a0_ack!488))
                           ((_ to_fp 11 53) a5_ack!487)))))
  (FPCHECK_FADD_ACCURACY a!1 #x3f50000000000000)))
