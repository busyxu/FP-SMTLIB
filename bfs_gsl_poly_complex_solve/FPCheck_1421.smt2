(declare-fun a5_ack!8386 () (_ BitVec 64))
(declare-fun a0_ack!8387 () (_ BitVec 64))
(declare-fun a1_ack!8382 () (_ BitVec 64))
(declare-fun a2_ack!8383 () (_ BitVec 64))
(declare-fun a3_ack!8384 () (_ BitVec 64))
(declare-fun a4_ack!8385 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8386) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8387))
                           ((_ to_fp 11 53) a5_ack!8386)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8382))
                           ((_ to_fp 11 53) a5_ack!8386)))))
...
(let ((a!89 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!88))))
  (FPCHECK_FMUL_ACCURACY a!89 a!67)))))))))))))))))))))))))))
