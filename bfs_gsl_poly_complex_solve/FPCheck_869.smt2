(declare-fun a5_ack!5074 () (_ BitVec 64))
(declare-fun a0_ack!5075 () (_ BitVec 64))
(declare-fun a1_ack!5070 () (_ BitVec 64))
(declare-fun a2_ack!5071 () (_ BitVec 64))
(declare-fun a3_ack!5072 () (_ BitVec 64))
(declare-fun a4_ack!5073 () (_ BitVec 64))
(declare-fun FPCHECK_FINVALID_SQRT
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5074) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5075))
                           ((_ to_fp 11 53) a5_ack!5074)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5070))
                           ((_ to_fp 11 53) a5_ack!5074)))))
...
(let ((a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.div roundNearestTiesToEven a!23 a!24)))))
  (FPCHECK_FINVALID_SQRT a!26 a!26))))))))))))))
