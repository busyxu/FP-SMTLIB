(declare-fun a5_ack!7588 () (_ BitVec 64))
(declare-fun a0_ack!7589 () (_ BitVec 64))
(declare-fun a1_ack!7584 () (_ BitVec 64))
(declare-fun a2_ack!7585 () (_ BitVec 64))
(declare-fun a3_ack!7586 () (_ BitVec 64))
(declare-fun a4_ack!7587 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7588) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7589))
                           ((_ to_fp 11 53) a5_ack!7588)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7584))
                           ((_ to_fp 11 53) a5_ack!7588)))))
...
(let ((a!21 (fp.sub roundNearestTiesToEven
      ...
      (a!40 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x0000000000000000)
                            a!19)
                    (fp.mul roundNearestTiesToEven a!20 a!11))))
(let ((a!29 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
      ...
      (a!41 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!25)
                            (fp.mul roundNearestTiesToEven a!26 a!11))
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!21 a!29)
                                    a!30)
...
(let ((a!56 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.abs (fp.sub roundNearestTiesToEven a!38 a!48)))
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!55)))))
(let ((a!57 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!38 a!48)
                            a!56)
                    (fp.add roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!56)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FADD_UNDERFLOW a!33 (fp.mul roundNearestTiesToEven a!57 a!58)))))))))))))))))))))
