(declare-fun a5_ack!6886 () (_ BitVec 64))
(declare-fun a0_ack!6887 () (_ BitVec 64))
(declare-fun a1_ack!6882 () (_ BitVec 64))
(declare-fun a2_ack!6883 () (_ BitVec 64))
(declare-fun a3_ack!6884 () (_ BitVec 64))
(declare-fun a4_ack!6885 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6886) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6887))
                           ((_ to_fp 11 53) a5_ack!6886)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6882))
                           ((_ to_fp 11 53) a5_ack!6886)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!47)))))
  (FPCHECK_FDIV_INVALID (fp.sub roundNearestTiesToEven a!30 a!40) a!48)))))))))))))))))))
