(declare-fun a5_ack!4318 () (_ BitVec 64))
(declare-fun a0_ack!4319 () (_ BitVec 64))
(declare-fun a1_ack!4314 () (_ BitVec 64))
(declare-fun a2_ack!4315 () (_ BitVec 64))
(declare-fun a3_ack!4316 () (_ BitVec 64))
(declare-fun a4_ack!4317 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4318) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4319))
                           ((_ to_fp 11 53) a5_ack!4318)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4314))
                           ((_ to_fp 11 53) a5_ack!4318)))))
