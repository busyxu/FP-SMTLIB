(declare-fun a5_ack!8122 () (_ BitVec 64))
(declare-fun a0_ack!8123 () (_ BitVec 64))
(declare-fun a1_ack!8118 () (_ BitVec 64))
(declare-fun a2_ack!8119 () (_ BitVec 64))
(declare-fun a3_ack!8120 () (_ BitVec 64))
(declare-fun a4_ack!8121 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8122) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8123))
                           ((_ to_fp 11 53) a5_ack!8122)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8118))
                           ((_ to_fp 11 53) a5_ack!8122)))))
...
(let ((a!55 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    (fp.add roundNearestTiesToEven a!49 a!52)
