(declare-fun a5_ack!7006 () (_ BitVec 64))
(declare-fun a0_ack!7007 () (_ BitVec 64))
(declare-fun a1_ack!7002 () (_ BitVec 64))
(declare-fun a2_ack!7003 () (_ BitVec 64))
(declare-fun a3_ack!7004 () (_ BitVec 64))
(declare-fun a4_ack!7005 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7006) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7007))
                           ((_ to_fp 11 53) a5_ack!7006)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7002))
                           ((_ to_fp 11 53) a5_ack!7006)))))
