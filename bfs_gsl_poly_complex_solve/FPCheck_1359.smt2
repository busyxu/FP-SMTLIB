(declare-fun a5_ack!8014 () (_ BitVec 64))
(declare-fun a0_ack!8015 () (_ BitVec 64))
(declare-fun a1_ack!8010 () (_ BitVec 64))
(declare-fun a2_ack!8011 () (_ BitVec 64))
(declare-fun a3_ack!8012 () (_ BitVec 64))
(declare-fun a4_ack!8013 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8014) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8015))
                           ((_ to_fp 11 53) a5_ack!8014)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8010))
                           ((_ to_fp 11 53) a5_ack!8014)))))
...
(let ((a!11 (fp.mul roundNearestTiesToEven
      ...
      (a!65 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!63
                                    (fp.mul roundNearestTiesToEven a!9 a!64))
                            (fp.div roundNearestTiesToEven
                                    a!6
                                    ((_ to_fp 11 53) #x3ff0000000000000)))))
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!23 a!26)
                                    a!27)
                            a!16)))
      (a!34 (fp.add roundNearestTiesToEven
                    a!33
...
(let ((a!50 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!31 a!42))
...
(let ((a!51 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!31 a!42)
                            a!50)
                    ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!59 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!43 a!47)
                                    a!50)
                            ((_ to_fp 11 53) #x3ff0000000000000))
                    a!58))
...
(let ((a!60 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            a!60
            (fp.mul roundNearestTiesToEven a!61 a!69))
    a!70)))))))))))))))))))))
