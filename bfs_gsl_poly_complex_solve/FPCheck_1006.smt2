(declare-fun a5_ack!5896 () (_ BitVec 64))
(declare-fun a0_ack!5897 () (_ BitVec 64))
(declare-fun a1_ack!5892 () (_ BitVec 64))
(declare-fun a2_ack!5893 () (_ BitVec 64))
(declare-fun a3_ack!5894 () (_ BitVec 64))
(declare-fun a4_ack!5895 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5896) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5897))
                           ((_ to_fp 11 53) a5_ack!5896)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5892))
                           ((_ to_fp 11 53) a5_ack!5896)))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!22 a!26))
                            (fp.abs a!21))
                    (fp.abs a!28))))
(let ((a!30 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!22 a!26)
                            a!29)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
