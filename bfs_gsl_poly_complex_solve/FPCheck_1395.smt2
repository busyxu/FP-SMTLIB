(declare-fun a5_ack!8230 () (_ BitVec 64))
(declare-fun a0_ack!8231 () (_ BitVec 64))
(declare-fun a1_ack!8226 () (_ BitVec 64))
(declare-fun a2_ack!8227 () (_ BitVec 64))
(declare-fun a3_ack!8228 () (_ BitVec 64))
(declare-fun a4_ack!8229 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8230) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8231))
                           ((_ to_fp 11 53) a5_ack!8230)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8226))
                           ((_ to_fp 11 53) a5_ack!8230)))))
...
(let ((a!70 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    a!66
                                    (fp.sub roundNearestTiesToEven a!57 a!67)))
                    (fp.mul roundNearestTiesToEven
                            a!68
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
...
(let ((a!74 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven a!71 a!72)
                    (fp.mul roundNearestTiesToEven
                            a!68
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
      ...
      (a!88 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!87
                                    (fp.mul roundNearestTiesToEven a!68 a!1))
                            a!64))))
(let ((a!75 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!71
                            (fp.mul roundNearestTiesToEven a!74 a!64)))))
(let ((a!76 (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            a!64
                            (fp.sub roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!48 a!65)
                                    (fp.mul roundNearestTiesToEven a!70 a!64)))
                    a!75)))
(let ((a!89 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!88))))
  (FPCHECK_FMUL_OVERFLOW a!89 a!66))))))))))))))))))))))))))))
