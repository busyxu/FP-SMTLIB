(declare-fun a5_ack!1306 () (_ BitVec 64))
(declare-fun a0_ack!1307 () (_ BitVec 64))
(declare-fun a1_ack!1304 () (_ BitVec 64))
(declare-fun a2_ack!1305 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1306) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1307))
                           ((_ to_fp 11 53) a5_ack!1306)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!1304))
                           ((_ to_fp 11 53) a5_ack!1306)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x41f0000000000000)
                                   a!1)))))
  (FPCHECK_FMUL_OVERFLOW a!2 #x40f0000000000000))))
