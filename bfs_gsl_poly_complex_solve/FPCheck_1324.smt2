(declare-fun a5_ack!7804 () (_ BitVec 64))
(declare-fun a0_ack!7805 () (_ BitVec 64))
(declare-fun a1_ack!7800 () (_ BitVec 64))
(declare-fun a2_ack!7801 () (_ BitVec 64))
(declare-fun a3_ack!7802 () (_ BitVec 64))
(declare-fun a4_ack!7803 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7804) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7805))
                           ((_ to_fp 11 53) a5_ack!7804)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7800))
                           ((_ to_fp 11 53) a5_ack!7804)))))
...
(let ((a!49 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            a!48)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW a!49 a!53))))))))))))))))))))
