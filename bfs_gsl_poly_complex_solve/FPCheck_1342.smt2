(declare-fun a5_ack!7912 () (_ BitVec 64))
(declare-fun a0_ack!7913 () (_ BitVec 64))
(declare-fun a1_ack!7908 () (_ BitVec 64))
(declare-fun a2_ack!7909 () (_ BitVec 64))
(declare-fun a3_ack!7910 () (_ BitVec 64))
(declare-fun a4_ack!7911 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7912) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7913))
                           ((_ to_fp 11 53) a5_ack!7912)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7908))
                           ((_ to_fp 11 53) a5_ack!7912)))))
...
(let ((a!16 (fp.add roundNearestTiesToEven
      ...
      (a!41 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x0000000000000000)
                            a!25)
                    (fp.mul roundNearestTiesToEven a!26 a!9))))
(let ((a!17 (fp.sub roundNearestTiesToEven
      ...
      (a!30 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!18 a!22))
                            (fp.abs a!27))
                    (fp.abs a!29))))
(let ((a!31 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!18 a!22)
                            a!30)
                    ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!32 (fp.mul roundNearestTiesToEven
      ...
      (a!37 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!27 a!30)
                                    a!31)
                            a!36)))
      (a!42 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!21)
                            (fp.mul roundNearestTiesToEven a!22 a!9))
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!27 a!30)
                                    a!31)
...
(let ((a!33 (fp.add roundNearestTiesToEven
      ...
      (a!39 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!29 a!30)
                                    a!31)
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!38))))
...
(let ((a!59 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    ...
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven a!59 a!35)
                    a!61)
