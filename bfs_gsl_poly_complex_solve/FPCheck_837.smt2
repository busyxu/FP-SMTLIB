(declare-fun a5_ack!4882 () (_ BitVec 64))
(declare-fun a0_ack!4883 () (_ BitVec 64))
(declare-fun a1_ack!4878 () (_ BitVec 64))
(declare-fun a2_ack!4879 () (_ BitVec 64))
(declare-fun a3_ack!4880 () (_ BitVec 64))
(declare-fun a4_ack!4881 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4882) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4883))
                           ((_ to_fp 11 53) a5_ack!4882)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4878))
                           ((_ to_fp 11 53) a5_ack!4882)))))
