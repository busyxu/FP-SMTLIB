(declare-fun a5_ack!3832 () (_ BitVec 64))
(declare-fun a0_ack!3833 () (_ BitVec 64))
(declare-fun a1_ack!3828 () (_ BitVec 64))
(declare-fun a2_ack!3829 () (_ BitVec 64))
(declare-fun a3_ack!3830 () (_ BitVec 64))
(declare-fun a4_ack!3831 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3832) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3833))
                           ((_ to_fp 11 53) a5_ack!3832)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3828))
                           ((_ to_fp 11 53) a5_ack!3832)))))
...
(let ((a!7 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   a!6)))
  (FPCHECK_FMUL_OVERFLOW a!7 #x0000000000000000)))))))
