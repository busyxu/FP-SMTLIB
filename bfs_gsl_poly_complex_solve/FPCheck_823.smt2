(declare-fun a5_ack!4798 () (_ BitVec 64))
(declare-fun a0_ack!4799 () (_ BitVec 64))
(declare-fun a1_ack!4794 () (_ BitVec 64))
(declare-fun a2_ack!4795 () (_ BitVec 64))
(declare-fun a3_ack!4796 () (_ BitVec 64))
(declare-fun a4_ack!4797 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4798) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4799))
                           ((_ to_fp 11 53) a5_ack!4798)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4794))
                           ((_ to_fp 11 53) a5_ack!4798)))))
...
(let ((a!11 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!10)))
  (FPCHECK_FSUB_ACCURACY #x3ff0000000000000 a!11))))))))
