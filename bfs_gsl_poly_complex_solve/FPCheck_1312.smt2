(declare-fun a5_ack!7732 () (_ BitVec 64))
(declare-fun a0_ack!7733 () (_ BitVec 64))
(declare-fun a1_ack!7728 () (_ BitVec 64))
(declare-fun a2_ack!7729 () (_ BitVec 64))
(declare-fun a3_ack!7730 () (_ BitVec 64))
(declare-fun a4_ack!7731 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7732) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7733))
                           ((_ to_fp 11 53) a5_ack!7732)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7728))
                           ((_ to_fp 11 53) a5_ack!7732)))))
...
(let ((a!75 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_UNDERFLOW a!43 a!75))))))))))))))))))))))))
