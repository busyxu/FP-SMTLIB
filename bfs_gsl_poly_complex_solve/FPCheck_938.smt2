(declare-fun a5_ack!5488 () (_ BitVec 64))
(declare-fun a0_ack!5489 () (_ BitVec 64))
(declare-fun a1_ack!5484 () (_ BitVec 64))
(declare-fun a2_ack!5485 () (_ BitVec 64))
(declare-fun a3_ack!5486 () (_ BitVec 64))
(declare-fun a4_ack!5487 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5488) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5489))
                           ((_ to_fp 11 53) a5_ack!5488)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5484))
                           ((_ to_fp 11 53) a5_ack!5488)))))
