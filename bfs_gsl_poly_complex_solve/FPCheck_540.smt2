(declare-fun a5_ack!3100 () (_ BitVec 64))
(declare-fun a0_ack!3101 () (_ BitVec 64))
(declare-fun a1_ack!3096 () (_ BitVec 64))
(declare-fun a2_ack!3097 () (_ BitVec 64))
(declare-fun a3_ack!3098 () (_ BitVec 64))
(declare-fun a4_ack!3099 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3100) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3101))
                           ((_ to_fp 11 53) a5_ack!3100)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3096))
                           ((_ to_fp 11 53) a5_ack!3100)))))
