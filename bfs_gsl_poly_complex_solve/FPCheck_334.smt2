(declare-fun a5_ack!1796 () (_ BitVec 64))
(declare-fun a0_ack!1797 () (_ BitVec 64))
(declare-fun a1_ack!1794 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun a2_ack!1795 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1796) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1797))
                           ((_ to_fp 11 53) a5_ack!1796)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a2_ack!1795))
                           ((_ to_fp 11 53) a5_ack!1796)))))
  (FPCHECK_FADD_OVERFLOW #x3fd0000000000000 a!1)))
