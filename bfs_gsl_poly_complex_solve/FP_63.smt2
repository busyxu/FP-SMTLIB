(declare-fun a5_ack!1847 () (_ BitVec 64))
(declare-fun a0_ack!1848 () (_ BitVec 64))
(declare-fun a1_ack!1846 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1847) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1848))
                           ((_ to_fp 11 53) a5_ack!1847)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a1_ack!1846))
                           ((_ to_fp 11 53) a5_ack!1847)))))
(let ((a!2 (fp.lt ((_ to_fp 11 53) #x4050000000000000)
                  (fp.div roundNearestTiesToEven
                          (fp.add roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3fa0000000000000)
                                  a!1)
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a1_ack!1846))
                           ((_ to_fp 11 53) a5_ack!1847)))))
(let ((a!2 (fp.gt ((_ to_fp 11 53) #x4050000000000000)
                  (fp.mul roundNearestTiesToEven
                          (fp.add roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x3fa0000000000000)
                                  a!1)
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fa0000000000000)
                           a!1))))
  (fp.eq a!2 ((_ to_fp 11 53) #x4050000000000000)))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!1846))
