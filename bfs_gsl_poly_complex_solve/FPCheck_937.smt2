(declare-fun a5_ack!5482 () (_ BitVec 64))
(declare-fun a0_ack!5483 () (_ BitVec 64))
(declare-fun a1_ack!5478 () (_ BitVec 64))
(declare-fun a2_ack!5479 () (_ BitVec 64))
(declare-fun a3_ack!5480 () (_ BitVec 64))
(declare-fun a4_ack!5481 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5482) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5483))
                           ((_ to_fp 11 53) a5_ack!5482)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5478))
                           ((_ to_fp 11 53) a5_ack!5482)))))
