(declare-fun a5_ack!3868 () (_ BitVec 64))
(declare-fun a0_ack!3869 () (_ BitVec 64))
(declare-fun a1_ack!3864 () (_ BitVec 64))
(declare-fun a2_ack!3865 () (_ BitVec 64))
(declare-fun a3_ack!3866 () (_ BitVec 64))
(declare-fun a4_ack!3867 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3868) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3869))
                           ((_ to_fp 11 53) a5_ack!3868)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3864))
                           ((_ to_fp 11 53) a5_ack!3868)))))
