(declare-fun a5_ack!8326 () (_ BitVec 64))
(declare-fun a0_ack!8327 () (_ BitVec 64))
(declare-fun a1_ack!8322 () (_ BitVec 64))
(declare-fun a2_ack!8323 () (_ BitVec 64))
(declare-fun a3_ack!8324 () (_ BitVec 64))
(declare-fun a4_ack!8325 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8326) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8327))
                           ((_ to_fp 11 53) a5_ack!8326)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8322))
                           ((_ to_fp 11 53) a5_ack!8326)))))
...
(let ((a!56 (fp.mul roundNearestTiesToEven
      ...
      (a!60 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!58
                                    (fp.mul roundNearestTiesToEven a!52 a!57))
                            (fp.mul roundNearestTiesToEven a!53 a!59))
                    a!55)))
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.div roundNearestTiesToEven
                    a!49
                    ((_ to_fp 11 53) #x3ff0000000000000))
            (fp.sub roundNearestTiesToEven a!50 a!56))
    (fp.mul roundNearestTiesToEven
            a!55
            (fp.sub roundNearestTiesToEven a!57 a!60))))))))))))))))))))))))
