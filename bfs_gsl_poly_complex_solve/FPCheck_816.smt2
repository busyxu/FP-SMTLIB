(declare-fun a5_ack!4756 () (_ BitVec 64))
(declare-fun a0_ack!4757 () (_ BitVec 64))
(declare-fun a1_ack!4752 () (_ BitVec 64))
(declare-fun a2_ack!4753 () (_ BitVec 64))
(declare-fun a3_ack!4754 () (_ BitVec 64))
(declare-fun a4_ack!4755 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4756) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4757))
                           ((_ to_fp 11 53) a5_ack!4756)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4752))
                           ((_ to_fp 11 53) a5_ack!4756)))))
