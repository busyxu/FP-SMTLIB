(declare-fun a5_ack!4648 () (_ BitVec 64))
(declare-fun a0_ack!4649 () (_ BitVec 64))
(declare-fun a1_ack!4644 () (_ BitVec 64))
(declare-fun a2_ack!4645 () (_ BitVec 64))
(declare-fun a3_ack!4646 () (_ BitVec 64))
(declare-fun a4_ack!4647 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4648) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4649))
                           ((_ to_fp 11 53) a5_ack!4648)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4644))
                           ((_ to_fp 11 53) a5_ack!4648)))))
...
(let ((a!15 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!14)))))
  (FPCHECK_FMUL_ACCURACY a!15 (fp.div roundNearestTiesToEven a!7 a!6)))))))))))
