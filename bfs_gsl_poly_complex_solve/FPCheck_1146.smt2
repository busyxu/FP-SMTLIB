(declare-fun a5_ack!6736 () (_ BitVec 64))
(declare-fun a0_ack!6737 () (_ BitVec 64))
(declare-fun a1_ack!6732 () (_ BitVec 64))
(declare-fun a2_ack!6733 () (_ BitVec 64))
(declare-fun a3_ack!6734 () (_ BitVec 64))
(declare-fun a4_ack!6735 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6736) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6737))
                           ((_ to_fp 11 53) a5_ack!6736)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6732))
                           ((_ to_fp 11 53) a5_ack!6736)))))
