(declare-fun a5_ack!2602 () (_ BitVec 64))
(declare-fun a0_ack!2603 () (_ BitVec 64))
(declare-fun a1_ack!2598 () (_ BitVec 64))
(declare-fun a2_ack!2599 () (_ BitVec 64))
(declare-fun a3_ack!2600 () (_ BitVec 64))
(declare-fun a4_ack!2601 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2602) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2603))
                           ((_ to_fp 11 53) a5_ack!2602)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2598))
                           ((_ to_fp 11 53) a5_ack!2602)))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) a5_ack!2602))
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FSUB_UNDERFLOW #x0000000000000000 a!1)))
