(declare-fun a5_ack!4792 () (_ BitVec 64))
(declare-fun a0_ack!4793 () (_ BitVec 64))
(declare-fun a1_ack!4788 () (_ BitVec 64))
(declare-fun a2_ack!4789 () (_ BitVec 64))
(declare-fun a3_ack!4790 () (_ BitVec 64))
(declare-fun a4_ack!4791 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4792) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4793))
                           ((_ to_fp 11 53) a5_ack!4792)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4788))
                           ((_ to_fp 11 53) a5_ack!4792)))))
...
(let ((a!11 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!10)))
  (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 a!11))))))))
