(declare-fun a5_ack!5086 () (_ BitVec 64))
(declare-fun a0_ack!5087 () (_ BitVec 64))
(declare-fun a1_ack!5082 () (_ BitVec 64))
(declare-fun a2_ack!5083 () (_ BitVec 64))
(declare-fun a3_ack!5084 () (_ BitVec 64))
(declare-fun a4_ack!5085 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5086) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5087))
                           ((_ to_fp 11 53) a5_ack!5086)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5082))
                           ((_ to_fp 11 53) a5_ack!5086)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!21)
                    (fp.abs a!23))))
  (FPCHECK_FMUL_UNDERFLOW #xbff0000000000000 a!24))))))))))))
