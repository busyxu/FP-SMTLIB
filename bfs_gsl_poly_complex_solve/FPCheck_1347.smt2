(declare-fun a5_ack!7942 () (_ BitVec 64))
(declare-fun a0_ack!7943 () (_ BitVec 64))
(declare-fun a1_ack!7938 () (_ BitVec 64))
(declare-fun a2_ack!7939 () (_ BitVec 64))
(declare-fun a3_ack!7940 () (_ BitVec 64))
(declare-fun a4_ack!7941 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7942) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7943))
                           ((_ to_fp 11 53) a5_ack!7942)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7938))
                           ((_ to_fp 11 53) a5_ack!7942)))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
      ...
      (a!34 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x0000000000000000)
                            a!22)
                    (fp.mul roundNearestTiesToEven a!23 a!12))))
