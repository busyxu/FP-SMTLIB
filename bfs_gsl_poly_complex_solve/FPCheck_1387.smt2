(declare-fun a5_ack!8182 () (_ BitVec 64))
(declare-fun a0_ack!8183 () (_ BitVec 64))
(declare-fun a1_ack!8178 () (_ BitVec 64))
(declare-fun a2_ack!8179 () (_ BitVec 64))
(declare-fun a3_ack!8180 () (_ BitVec 64))
(declare-fun a4_ack!8181 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8182) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8183))
                           ((_ to_fp 11 53) a5_ack!8182)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8178))
                           ((_ to_fp 11 53) a5_ack!8182)))))
