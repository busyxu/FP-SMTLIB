(declare-fun a5_ack!672 () (_ BitVec 64))
(declare-fun a0_ack!673 () (_ BitVec 64))
(declare-fun a1_ack!670 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun a2_ack!671 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!672) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!673))
                           ((_ to_fp 11 53) a5_ack!672)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!670))
                           ((_ to_fp 11 53) a5_ack!672)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a2_ack!671))
                           ((_ to_fp 11 53) a5_ack!672)))))
  (FPCHECK_FADD_OVERFLOW #x41f0000000000000 a!1)))
