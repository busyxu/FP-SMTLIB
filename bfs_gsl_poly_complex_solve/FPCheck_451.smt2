(declare-fun a5_ack!2566 () (_ BitVec 64))
(declare-fun a0_ack!2567 () (_ BitVec 64))
(declare-fun a1_ack!2562 () (_ BitVec 64))
(declare-fun a2_ack!2563 () (_ BitVec 64))
(declare-fun a3_ack!2564 () (_ BitVec 64))
(declare-fun a4_ack!2565 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2566) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2567))
                           ((_ to_fp 11 53) a5_ack!2566)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2562))
                           ((_ to_fp 11 53) a5_ack!2566)))))
