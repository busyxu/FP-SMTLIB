(declare-fun a5_ack!892 () (_ BitVec 64))
(declare-fun a0_ack!893 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun a1_ack!891 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!892) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!893))
                           ((_ to_fp 11 53) a5_ack!892)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!891))
                           ((_ to_fp 11 53) a5_ack!892)))))
  (FPCHECK_FADD_UNDERFLOW #x40b0000000000000 a!1)))
