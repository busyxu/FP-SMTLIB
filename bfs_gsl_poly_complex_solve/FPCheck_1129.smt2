(declare-fun a5_ack!6634 () (_ BitVec 64))
(declare-fun a0_ack!6635 () (_ BitVec 64))
(declare-fun a1_ack!6630 () (_ BitVec 64))
(declare-fun a2_ack!6631 () (_ BitVec 64))
(declare-fun a3_ack!6632 () (_ BitVec 64))
(declare-fun a4_ack!6633 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6634) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6635))
                           ((_ to_fp 11 53) a5_ack!6634)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6630))
                           ((_ to_fp 11 53) a5_ack!6634)))))
