(declare-fun a5_ack!8344 () (_ BitVec 64))
(declare-fun a0_ack!8345 () (_ BitVec 64))
(declare-fun a1_ack!8340 () (_ BitVec 64))
(declare-fun a2_ack!8341 () (_ BitVec 64))
(declare-fun a3_ack!8342 () (_ BitVec 64))
(declare-fun a4_ack!8343 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8344) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8345))
                           ((_ to_fp 11 53) a5_ack!8344)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8340))
                           ((_ to_fp 11 53) a5_ack!8344)))))
...
(let ((a!12 (fp.mul roundNearestTiesToEven
      ...
      (a!68 (fp.sub roundNearestTiesToEven
                    a!63
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven a!65 a!67)
                            (fp.div roundNearestTiesToEven
                                    a!6
                                    ((_ to_fp 11 53) #x3ff0000000000000)))))
...
(let ((a!34 (fp.add roundNearestTiesToEven
      ...
      (a!71 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven a!68 a!70)
