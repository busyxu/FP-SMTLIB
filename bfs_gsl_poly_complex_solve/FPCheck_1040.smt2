(declare-fun a5_ack!6100 () (_ BitVec 64))
(declare-fun a0_ack!6101 () (_ BitVec 64))
(declare-fun a1_ack!6096 () (_ BitVec 64))
(declare-fun a2_ack!6097 () (_ BitVec 64))
(declare-fun a3_ack!6098 () (_ BitVec 64))
(declare-fun a4_ack!6099 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6100) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6101))
                           ((_ to_fp 11 53) a5_ack!6100)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6096))
                           ((_ to_fp 11 53) a5_ack!6100)))))
