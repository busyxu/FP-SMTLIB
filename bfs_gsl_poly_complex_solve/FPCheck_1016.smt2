(declare-fun a5_ack!5956 () (_ BitVec 64))
(declare-fun a0_ack!5957 () (_ BitVec 64))
(declare-fun a1_ack!5952 () (_ BitVec 64))
(declare-fun a2_ack!5953 () (_ BitVec 64))
(declare-fun a3_ack!5954 () (_ BitVec 64))
(declare-fun a4_ack!5955 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5956) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5957))
                           ((_ to_fp 11 53) a5_ack!5956)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5952))
                           ((_ to_fp 11 53) a5_ack!5956)))))
