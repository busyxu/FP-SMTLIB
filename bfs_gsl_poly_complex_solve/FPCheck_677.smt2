(declare-fun a5_ack!3922 () (_ BitVec 64))
(declare-fun a0_ack!3923 () (_ BitVec 64))
(declare-fun a1_ack!3918 () (_ BitVec 64))
(declare-fun a2_ack!3919 () (_ BitVec 64))
(declare-fun a3_ack!3920 () (_ BitVec 64))
(declare-fun a4_ack!3921 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3922) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3923))
                           ((_ to_fp 11 53) a5_ack!3922)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3918))
                           ((_ to_fp 11 53) a5_ack!3922)))))
