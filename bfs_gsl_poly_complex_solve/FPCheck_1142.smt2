(declare-fun a5_ack!6712 () (_ BitVec 64))
(declare-fun a0_ack!6713 () (_ BitVec 64))
(declare-fun a1_ack!6708 () (_ BitVec 64))
(declare-fun a2_ack!6709 () (_ BitVec 64))
(declare-fun a3_ack!6710 () (_ BitVec 64))
(declare-fun a4_ack!6711 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6712) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6713))
                           ((_ to_fp 11 53) a5_ack!6712)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6708))
                           ((_ to_fp 11 53) a5_ack!6712)))))
