(declare-fun a5_ack!4942 () (_ BitVec 64))
(declare-fun a0_ack!4943 () (_ BitVec 64))
(declare-fun a1_ack!4938 () (_ BitVec 64))
(declare-fun a2_ack!4939 () (_ BitVec 64))
(declare-fun a3_ack!4940 () (_ BitVec 64))
(declare-fun a4_ack!4941 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_INVALID
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4942) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4943))
                           ((_ to_fp 11 53) a5_ack!4942)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4938))
                           ((_ to_fp 11 53) a5_ack!4942)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.abs a!16))
                    (fp.abs a!23))))
  (FPCHECK_FDIV_INVALID a!16 a!24))))))))))))
