(declare-fun a5_ack!4504 () (_ BitVec 64))
(declare-fun a0_ack!4505 () (_ BitVec 64))
(declare-fun a1_ack!4500 () (_ BitVec 64))
(declare-fun a2_ack!4501 () (_ BitVec 64))
(declare-fun a3_ack!4502 () (_ BitVec 64))
(declare-fun a4_ack!4503 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4504) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4505))
                           ((_ to_fp 11 53) a5_ack!4504)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4500))
                           ((_ to_fp 11 53) a5_ack!4504)))))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!15)))))
  (FPCHECK_FSUB_ACCURACY a!10 a!16)))))))))))
