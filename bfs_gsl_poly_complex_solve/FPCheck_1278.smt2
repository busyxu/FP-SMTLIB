(declare-fun a5_ack!7528 () (_ BitVec 64))
(declare-fun a0_ack!7529 () (_ BitVec 64))
(declare-fun a1_ack!7524 () (_ BitVec 64))
(declare-fun a2_ack!7525 () (_ BitVec 64))
(declare-fun a3_ack!7526 () (_ BitVec 64))
(declare-fun a4_ack!7527 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7528) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7529))
                           ((_ to_fp 11 53) a5_ack!7528)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7524))
                           ((_ to_fp 11 53) a5_ack!7528)))))
...
(let ((a!41 (fp.sub roundNearestTiesToEven
      ...
      (a!49 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.abs (fp.sub roundNearestTiesToEven a!42 a!46)))
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!48))))
...
(let ((a!52 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!42 a!46)
                                    a!49)
                            a!50)
                    a!51))
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven a!41 a!52)
            (fp.mul roundNearestTiesToEven a!53 a!54))
    (fp.div roundNearestTiesToEven a!50 ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))))))))))))
