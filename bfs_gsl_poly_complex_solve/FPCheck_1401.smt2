(declare-fun a5_ack!8266 () (_ BitVec 64))
(declare-fun a0_ack!8267 () (_ BitVec 64))
(declare-fun a1_ack!8262 () (_ BitVec 64))
(declare-fun a2_ack!8263 () (_ BitVec 64))
(declare-fun a3_ack!8264 () (_ BitVec 64))
(declare-fun a4_ack!8265 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!8266) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!8267))
                           ((_ to_fp 11 53) a5_ack!8266)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!8262))
                           ((_ to_fp 11 53) a5_ack!8266)))))
...
(let ((a!89 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000))
                            a!88))))
  (FPCHECK_FSUB_OVERFLOW a!71 a!89)))))))))))))))))))))))))))
