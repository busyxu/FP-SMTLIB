(declare-fun a5_ack!6610 () (_ BitVec 64))
(declare-fun a0_ack!6611 () (_ BitVec 64))
(declare-fun a1_ack!6606 () (_ BitVec 64))
(declare-fun a2_ack!6607 () (_ BitVec 64))
(declare-fun a3_ack!6608 () (_ BitVec 64))
(declare-fun a4_ack!6609 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6610) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6611))
                           ((_ to_fp 11 53) a5_ack!6610)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6606))
                           ((_ to_fp 11 53) a5_ack!6610)))))
