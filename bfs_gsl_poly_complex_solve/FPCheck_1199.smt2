(declare-fun a5_ack!7054 () (_ BitVec 64))
(declare-fun a0_ack!7055 () (_ BitVec 64))
(declare-fun a1_ack!7050 () (_ BitVec 64))
(declare-fun a2_ack!7051 () (_ BitVec 64))
(declare-fun a3_ack!7052 () (_ BitVec 64))
(declare-fun a4_ack!7053 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7054) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7055))
                           ((_ to_fp 11 53) a5_ack!7054)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7050))
                           ((_ to_fp 11 53) a5_ack!7054)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!47)))))
  (FPCHECK_FMUL_OVERFLOW #xbff0000000000000 a!48)))))))))))))))))))
