(declare-fun a5_ack!3700 () (_ BitVec 64))
(declare-fun a0_ack!3701 () (_ BitVec 64))
(declare-fun a1_ack!3696 () (_ BitVec 64))
(declare-fun a2_ack!3697 () (_ BitVec 64))
(declare-fun a3_ack!3698 () (_ BitVec 64))
(declare-fun a4_ack!3699 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3700) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3701))
                           ((_ to_fp 11 53) a5_ack!3700)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3696))
                           ((_ to_fp 11 53) a5_ack!3700)))))
