(declare-fun a5_ack!7510 () (_ BitVec 64))
(declare-fun a0_ack!7511 () (_ BitVec 64))
(declare-fun a1_ack!7506 () (_ BitVec 64))
(declare-fun a2_ack!7507 () (_ BitVec 64))
(declare-fun a3_ack!7508 () (_ BitVec 64))
(declare-fun a4_ack!7509 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7510) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7511))
                           ((_ to_fp 11 53) a5_ack!7510)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7506))
                           ((_ to_fp 11 53) a5_ack!7510)))))
...
(let ((a!55 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    a!50)
                            ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_OVERFLOW a!41 a!55))))))))))))))))))))))
