(declare-fun a5_ack!1828 () (_ BitVec 64))
(declare-fun a0_ack!1829 () (_ BitVec 64))
(declare-fun a1_ack!1826 () (_ BitVec 64))
(declare-fun a2_ack!1827 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1829))
                           ((_ to_fp 11 53) a5_ack!1828)))))
...
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    #x3ff0000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) #x3fd0000000000000) a!1))))
