(declare-fun a5_ack!2746 () (_ BitVec 64))
(declare-fun a0_ack!2747 () (_ BitVec 64))
(declare-fun a1_ack!2742 () (_ BitVec 64))
(declare-fun a2_ack!2743 () (_ BitVec 64))
(declare-fun a3_ack!2744 () (_ BitVec 64))
(declare-fun a4_ack!2745 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2747))
                           ((_ to_fp 11 53) a5_ack!2746)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2742))
                           ((_ to_fp 11 53) a5_ack!2746)))))
