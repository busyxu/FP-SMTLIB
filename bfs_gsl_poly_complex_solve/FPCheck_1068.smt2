(declare-fun a5_ack!6268 () (_ BitVec 64))
(declare-fun a0_ack!6269 () (_ BitVec 64))
(declare-fun a1_ack!6264 () (_ BitVec 64))
(declare-fun a2_ack!6265 () (_ BitVec 64))
(declare-fun a3_ack!6266 () (_ BitVec 64))
(declare-fun a4_ack!6267 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6268) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6269))
                           ((_ to_fp 11 53) a5_ack!6268)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6264))
                           ((_ to_fp 11 53) a5_ack!6268)))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven a!17 a!27)
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
