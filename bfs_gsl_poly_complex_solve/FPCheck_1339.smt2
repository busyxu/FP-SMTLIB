(declare-fun a5_ack!7894 () (_ BitVec 64))
(declare-fun a0_ack!7895 () (_ BitVec 64))
(declare-fun a1_ack!7890 () (_ BitVec 64))
(declare-fun a2_ack!7891 () (_ BitVec 64))
(declare-fun a3_ack!7892 () (_ BitVec 64))
(declare-fun a4_ack!7893 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7894) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7895))
                           ((_ to_fp 11 53) a5_ack!7894)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7890))
                           ((_ to_fp 11 53) a5_ack!7894)))))
      ...
      (a!42 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!16)
                            (fp.mul roundNearestTiesToEven a!17 a!9))
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!22 a!25)
                                    a!26)
...
(let ((a!58 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!40 a!50))
...
(let ((a!59 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!40 a!50)
                            a!58)
                    ((_ to_fp 11 53) #x3ff0000000000000)))
...
(let ((a!68 (fp.mul roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            a!62
                            (fp.mul roundNearestTiesToEven a!63 a!67))
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    (fp.sub roundNearestTiesToEven a!51 a!55)
                                    a!58)
                            a!59))))
  (FPCHECK_FSUB_UNDERFLOW a!35 a!68))))))))))))))))))))))
