(declare-fun a5_ack!1699 () (_ BitVec 64))
(declare-fun a0_ack!1700 () (_ BitVec 64))
(declare-fun a1_ack!1698 () (_ BitVec 64))
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!1699) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!1700))
                           ((_ to_fp 11 53) a5_ack!1699)))))
