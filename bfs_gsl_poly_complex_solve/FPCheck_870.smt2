(declare-fun a5_ack!5080 () (_ BitVec 64))
(declare-fun a0_ack!5081 () (_ BitVec 64))
(declare-fun a1_ack!5076 () (_ BitVec 64))
(declare-fun a2_ack!5077 () (_ BitVec 64))
(declare-fun a3_ack!5078 () (_ BitVec 64))
(declare-fun a4_ack!5079 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!5080) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!5081))
                           ((_ to_fp 11 53) a5_ack!5080)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!5076))
                           ((_ to_fp 11 53) a5_ack!5080)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!21)
                    (fp.abs a!23))))
  (FPCHECK_FMUL_OVERFLOW #xbff0000000000000 a!24))))))))))))
