(declare-fun a5_ack!4744 () (_ BitVec 64))
(declare-fun a0_ack!4745 () (_ BitVec 64))
(declare-fun a1_ack!4740 () (_ BitVec 64))
(declare-fun a2_ack!4741 () (_ BitVec 64))
(declare-fun a3_ack!4742 () (_ BitVec 64))
(declare-fun a4_ack!4743 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4744) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4745))
                           ((_ to_fp 11 53) a5_ack!4744)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4740))
                           ((_ to_fp 11 53) a5_ack!4744)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x3ff0000000000000)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_ACCURACY a!6 #x3ff0000000000000))))))
