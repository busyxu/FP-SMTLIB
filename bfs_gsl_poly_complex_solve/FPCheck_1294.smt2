(declare-fun a5_ack!7624 () (_ BitVec 64))
(declare-fun a0_ack!7625 () (_ BitVec 64))
(declare-fun a1_ack!7620 () (_ BitVec 64))
(declare-fun a2_ack!7621 () (_ BitVec 64))
(declare-fun a3_ack!7622 () (_ BitVec 64))
(declare-fun a4_ack!7623 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7624) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7625))
                           ((_ to_fp 11 53) a5_ack!7624)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7620))
                           ((_ to_fp 11 53) a5_ack!7624)))))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    (fp.mul roundNearestTiesToEven a!61 a!50)))))
...
(let ((a!68 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            a!66
                            (fp.mul roundNearestTiesToEven a!50 a!67)))))
      ...
      (a!74 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!2)))
  (FPCHECK_FADD_UNDERFLOW (fp.add roundNearestTiesToEven a!43 a!73) a!74)))))))))))))))))))))))
