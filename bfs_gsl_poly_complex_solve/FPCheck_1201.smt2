(declare-fun a5_ack!7066 () (_ BitVec 64))
(declare-fun a0_ack!7067 () (_ BitVec 64))
(declare-fun a1_ack!7062 () (_ BitVec 64))
(declare-fun a2_ack!7063 () (_ BitVec 64))
(declare-fun a3_ack!7064 () (_ BitVec 64))
(declare-fun a4_ack!7065 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7066) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7067))
                           ((_ to_fp 11 53) a5_ack!7066)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7062))
                           ((_ to_fp 11 53) a5_ack!7066)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!47)))))
  (FPCHECK_FMUL_ACCURACY #xbff0000000000000 a!48)))))))))))))))))))
