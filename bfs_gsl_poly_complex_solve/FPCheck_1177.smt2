(declare-fun a5_ack!6922 () (_ BitVec 64))
(declare-fun a0_ack!6923 () (_ BitVec 64))
(declare-fun a1_ack!6918 () (_ BitVec 64))
(declare-fun a2_ack!6919 () (_ BitVec 64))
(declare-fun a3_ack!6920 () (_ BitVec 64))
(declare-fun a4_ack!6921 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6922) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6923))
                           ((_ to_fp 11 53) a5_ack!6922)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6918))
                           ((_ to_fp 11 53) a5_ack!6922)))))
...
(let ((a!48 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!47)))))
  (FPCHECK_FDIV_ZERO (fp.sub roundNearestTiesToEven a!30 a!40) a!48)))))))))))))))))))
