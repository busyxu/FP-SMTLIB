(declare-fun a5_ack!7294 () (_ BitVec 64))
(declare-fun a0_ack!7295 () (_ BitVec 64))
(declare-fun a1_ack!7290 () (_ BitVec 64))
(declare-fun a2_ack!7291 () (_ BitVec 64))
(declare-fun a3_ack!7292 () (_ BitVec 64))
(declare-fun a4_ack!7293 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7294) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7295))
                           ((_ to_fp 11 53) a5_ack!7294)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7290))
                           ((_ to_fp 11 53) a5_ack!7294)))))
...
(let ((a!44 (fp.sub roundNearestTiesToEven
      ...
      (a!50 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!38 a!43))
...
(let ((a!51 (fp.add roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!38 a!43)
                            a!50)
                    ((_ to_fp 11 53) #x3ff0000000000000)))
