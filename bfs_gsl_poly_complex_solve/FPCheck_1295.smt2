(declare-fun a5_ack!7630 () (_ BitVec 64))
(declare-fun a0_ack!7631 () (_ BitVec 64))
(declare-fun a1_ack!7626 () (_ BitVec 64))
(declare-fun a2_ack!7627 () (_ BitVec 64))
(declare-fun a3_ack!7628 () (_ BitVec 64))
(declare-fun a4_ack!7629 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!7630) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!7631))
                           ((_ to_fp 11 53) a5_ack!7630)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!7626))
                           ((_ to_fp 11 53) a5_ack!7630)))))
      ...
      (a!74 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x3ff0000000000000)))
                    a!2)))
  (FPCHECK_FADD_ACCURACY (fp.add roundNearestTiesToEven a!43 a!73) a!74)))))))))))))))))))))))
