(declare-fun a5_ack!4054 () (_ BitVec 64))
(declare-fun a0_ack!4055 () (_ BitVec 64))
(declare-fun a1_ack!4050 () (_ BitVec 64))
(declare-fun a2_ack!4051 () (_ BitVec 64))
(declare-fun a3_ack!4052 () (_ BitVec 64))
(declare-fun a4_ack!4053 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!4054) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!4055))
                           ((_ to_fp 11 53) a5_ack!4054)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!4050))
                           ((_ to_fp 11 53) a5_ack!4054)))))
      ...
      (a!11 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) a2_ack!4051))
                            ((_ to_fp 11 53) a5_ack!4054)))))
  (FPCHECK_FMUL_ACCURACY (fp.add roundNearestTiesToEven a!9 a!11) a!12))))))))
