(declare-fun a5_ack!6670 () (_ BitVec 64))
(declare-fun a0_ack!6671 () (_ BitVec 64))
(declare-fun a1_ack!6666 () (_ BitVec 64))
(declare-fun a2_ack!6667 () (_ BitVec 64))
(declare-fun a3_ack!6668 () (_ BitVec 64))
(declare-fun a4_ack!6669 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6670) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6671))
                           ((_ to_fp 11 53) a5_ack!6670)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6666))
                           ((_ to_fp 11 53) a5_ack!6670)))))
...
(let ((a!25 (fp.div roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x3ff0000000000000))
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW a!25 #x0000000000000000)))))))))))))
