(declare-fun a5_ack!2638 () (_ BitVec 64))
(declare-fun a0_ack!2639 () (_ BitVec 64))
(declare-fun a1_ack!2634 () (_ BitVec 64))
(declare-fun a2_ack!2635 () (_ BitVec 64))
(declare-fun a3_ack!2636 () (_ BitVec 64))
(declare-fun a4_ack!2637 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!2638) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!2639))
                           ((_ to_fp 11 53) a5_ack!2638)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!2634))
                           ((_ to_fp 11 53) a5_ack!2638)))))
