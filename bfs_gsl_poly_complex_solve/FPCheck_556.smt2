(declare-fun a5_ack!3196 () (_ BitVec 64))
(declare-fun a0_ack!3197 () (_ BitVec 64))
(declare-fun a1_ack!3192 () (_ BitVec 64))
(declare-fun a2_ack!3193 () (_ BitVec 64))
(declare-fun a3_ack!3194 () (_ BitVec 64))
(declare-fun a4_ack!3195 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!3196) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!3197))
                           ((_ to_fp 11 53) a5_ack!3196)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!3192))
                           ((_ to_fp 11 53) a5_ack!3196)))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FDIV_UNDERFLOW a!6 #x3ff0000000000000))))))
