(declare-fun a5_ack!6508 () (_ BitVec 64))
(declare-fun a0_ack!6509 () (_ BitVec 64))
(declare-fun a1_ack!6504 () (_ BitVec 64))
(declare-fun a2_ack!6505 () (_ BitVec 64))
(declare-fun a3_ack!6506 () (_ BitVec 64))
(declare-fun a4_ack!6507 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) a5_ack!6508) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a0_ack!6509))
                           ((_ to_fp 11 53) a5_ack!6508)))))
  (fp.eq a!1 ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.abs (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) a1_ack!6504))
                           ((_ to_fp 11 53) a5_ack!6508)))))
...
(let ((a!24 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.abs (fp.sub roundNearestTiesToEven a!17 a!21))
                            (fp.abs a!16))
                    (fp.abs a!23))))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!16 a!24)
                            a!26)
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!14)
                            (fp.mul roundNearestTiesToEven a!15 a!8)))))
(let ((a!28 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!20)
                            (fp.mul roundNearestTiesToEven a!21 a!8))
                    a!27)))
