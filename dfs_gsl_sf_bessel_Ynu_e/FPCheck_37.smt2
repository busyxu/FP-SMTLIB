...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!84) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!83) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!83) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!83) ((_ to_fp 11 53) #x408f400000000000)))
(assert (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 b_ack!83))
