...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!756) ((_ to_fp 11 53) #x4049000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!755) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!755) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ...
    (fp.add roundNearestTiesToEven
            (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!756) a!1)
            ((_ to_fp 11 53) #x4000000000000000))))))
