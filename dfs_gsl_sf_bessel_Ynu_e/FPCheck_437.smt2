...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1135) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1135) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1135) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!5 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!1135))
    a!5)))))
