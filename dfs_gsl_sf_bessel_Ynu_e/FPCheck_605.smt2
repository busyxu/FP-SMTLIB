...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1674) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1674) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1673) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1673) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1673) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!5)
                   a!5)))
  (fp.eq a!6 (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!1673))))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!8 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!7)
                   a!7)))
  (fp.eq a!8 (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!1673)))))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!2 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.add roundNearestTiesToEven
            (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1674) a!1)
            ((_ to_fp 11 53) #x4018000000000000))))))
