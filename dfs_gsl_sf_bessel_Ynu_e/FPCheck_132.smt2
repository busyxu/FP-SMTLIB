...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!330) ((_ to_fp 11 53) #x4049000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!329) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!329) ((_ to_fp 11 53) #x408f400000000000))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           a!2
                           ((_ to_fp 11 53) #x400921fb54442d18)))))
  (fp.eq a!3 ((_ to_fp 11 53) b_ack!329))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x4020000000000000))
       ((_ to_fp 11 53) b_ack!329)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!329))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs a!6)
              (fp.mul roundNearestTiesToEven
                      ...
                      a!7))))))))
(assert (FPCHECK_FMUL_UNDERFLOW #x4020000000000000 b_ack!329))
