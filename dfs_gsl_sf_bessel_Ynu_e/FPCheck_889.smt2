...
(assert (fp.gt ((_ to_fp 11 53) a_ack!2772) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2771) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2772) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!2771))
        (fp.mul roundNearestTiesToEven
                (fp.abs ((_ to_fp 11 53) a_ack!2772))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_pow (fp.mul roundNearestTiesToEven
                                   ...
                                   a!2)
                           #x3fe5555555555555))))
  (FPCHECK_FMUL_UNDERFLOW a!4 #x3fd32739463f1312))))))
