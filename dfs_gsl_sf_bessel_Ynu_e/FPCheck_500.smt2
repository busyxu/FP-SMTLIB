...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1336) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1335) ((_ to_fp 11 53) #x4000000000000000))))
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!5)
                   a!5)))
  (fp.eq a!6 (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!1335))))))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4000000000000000
    (fp.add roundNearestTiesToEven
            (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1336) a!1)
            ((_ to_fp 11 53) #x4010000000000000)))))
