...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2767) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!2768) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2767) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!2768) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!2767))
        (fp.mul roundNearestTiesToEven
                (fp.abs ((_ to_fp 11 53) a_ack!2768))
                ((_ to_fp 11 53) #x0010000000000000))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!2768))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ...
                   (CF_pow (fp.mul roundNearestTiesToEven
                                   ...
                                   a!2)
                           #x3fe5555555555555))))
  (FPCHECK_FMUL_OVERFLOW a!4 #x3fd32739463f1312))))))
