...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1080) ((_ to_fp 11 53) #x4049000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1079) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1079) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven a!4 a!8)
                           a!3))))
  (fp.gt (fp.abs a!9) ((_ to_fp 11 53) #x5fefffffffffffff)))))))
