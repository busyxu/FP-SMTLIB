...
(assert (fp.lt ((_ to_fp 11 53) a_ack!3984) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3983) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!3983))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x8000000000000000)
                           ((_ to_fp 11 53) a_ack!3984)))))
  (not (fp.eq a!1 ((_ to_fp 11 53) b_ack!3983)))))
