...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!9) ((_ to_fp 11 53) #x2a9965fea53d6e98))))
...
(assert (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!9)))
...
(assert (let ((a!1 (CF_floor (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY a!1 #x7fdfffffffffffff)))
