...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!34) ((_ to_fp 11 53) #x2a9965fea53d6e98))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!34) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!34))
            ((_ to_fp 11 53) #x3f20000000000000))))
(assert (fp.leq (fp.abs (fp.abs ((_ to_fp 11 53) a_ack!34)))
...
(assert (let ((a!1 (CF_floor (fp.div roundNearestTiesToEven
                             (fp.abs ((_ to_fp 11 53) a_ack!34))
                             ((_ to_fp 11 53) #x3fe921fb54442d18)))))
  (FPCHECK_FMUL_ACCURACY a!1 #x3e64442d00000000)))
