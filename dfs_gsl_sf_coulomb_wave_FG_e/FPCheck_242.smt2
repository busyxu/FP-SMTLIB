...
(declare-fun d_ack!1761 () (_ BitVec 32))
...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1760) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!1760)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!1761))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1759) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1759) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.div roundNearestTiesToEven
            ...
            ((_ to_fp 11 53) b_ack!1759))
    (fp.div roundNearestTiesToEven
            (fp.div roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1762) a!1)
            (fp.add roundNearestTiesToEven
                    a!1
                    ((_ to_fp 11 53) #x3ff0000000000000))))))
