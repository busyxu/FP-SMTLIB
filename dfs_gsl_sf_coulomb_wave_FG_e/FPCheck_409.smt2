(declare-fun b_ack!3063 () (_ BitVec 64))
(declare-fun c_ack!3064 () (_ BitVec 64))
(declare-fun d_ack!3065 () (_ BitVec 32))
(declare-fun a_ack!3066 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3063) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3064) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!3064)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!3065))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3063) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3063) ((_ to_fp 11 53) #x3ff3333333333333)))
