...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2116) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!2116)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!2117))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2115) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2115) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    (fp.div roundNearestTiesToEven a!4 a!10)))
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.abs a!11) ((_ to_fp 11 53) #x3cc0000000000000)))))))))
