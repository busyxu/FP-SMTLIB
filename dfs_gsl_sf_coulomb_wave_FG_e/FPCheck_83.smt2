...
(assert (fp.lt ((_ to_fp 11 53) b_ack!655) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!655)
...
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 a_ack!658))
