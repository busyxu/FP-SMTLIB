...
(declare-fun d_ack!1989 () (_ BitVec 32))
...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1988) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!1988)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!1989))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1987) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1987) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.div roundNearestTiesToEven ((_ to_fp 11 53) #x3ff0000000000000) a!8)
    (fp.sub roundNearestTiesToEven a!3 (fp.div roundNearestTiesToEven a!4 a!10))))))))
