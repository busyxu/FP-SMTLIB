...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!924) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!924)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!925))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!923) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!923) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (bvslt ((_ fp.to_sbv 32)
                  ...
                  d_ack!925)))
  (not a!1)))
(assert (FPCHECK_FDIV_ACCURACY #x3ff0000000000000 b_ack!923))
