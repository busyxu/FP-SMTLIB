...
(assert (let ((a!1 (bvslt ((_ fp.to_sbv 32)
                  ...
                  d_ack!945)))
  (not a!1)))
(assert (FPCHECK_FADD_OVERFLOW c_ack!944 #x3ff0000000000000))
