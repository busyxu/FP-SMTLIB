...
(declare-fun d_ack!2113 () (_ BitVec 32))
...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2112) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!2112)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!2113))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2111) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!2111) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x3ff0000000000000))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FDIV_ZERO a_ack!2114 a!1)))
