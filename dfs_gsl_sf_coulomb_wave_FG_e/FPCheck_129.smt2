...
(assert (let ((a!1 (bvslt ((_ fp.to_sbv 32)
                  ...
                  d_ack!917)))
  (not a!1)))
(assert (FPCHECK_FDIV_OVERFLOW #x3ff0000000000000 b_ack!915))
