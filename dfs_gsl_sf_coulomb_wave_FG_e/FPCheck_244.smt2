...
(declare-fun d_ack!1777 () (_ BitVec 32))
(declare-fun a_ack!1778 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1775) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1776) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!1776)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!1777))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1775) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1775) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.div roundNearestTiesToEven
            ...
            ((_ to_fp 11 53) b_ack!1775))
    (fp.div roundNearestTiesToEven
            (fp.div roundNearestTiesToEven ((_ to_fp 11 53) a_ack!1778) a!1)
            (fp.add roundNearestTiesToEven
                    a!1
                    ((_ to_fp 11 53) #x3ff0000000000000))))))
