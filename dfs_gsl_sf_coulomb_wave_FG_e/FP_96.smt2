...
(declare-fun d_ack!3169 () (_ BitVec 32))
(declare-fun a_ack!3170 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3167) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3168) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!3168)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!3169))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3167) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3167) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           a!6)
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (not (fp.gt (fp.abs a!7) ((_ to_fp 11 53) #x3cc0000000000000))))))))
