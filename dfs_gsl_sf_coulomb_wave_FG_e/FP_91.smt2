...
(declare-fun c_ack!3072 () (_ BitVec 64))
(declare-fun d_ack!3073 () (_ BitVec 32))
(declare-fun a_ack!3074 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3071) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!3072) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!3072)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!3073))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3071) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3071) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(let ((a!4 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           ((_ to_fp 11 53) b_ack!3071)))))
  (fp.eq a!4 (fp.div roundNearestTiesToEven a!2 a!3))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) c_ack!3072)
