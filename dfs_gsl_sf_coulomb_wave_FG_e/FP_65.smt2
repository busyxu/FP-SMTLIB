...
(declare-fun d_ack!1965 () (_ BitVec 32))
(declare-fun a_ack!1966 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!1964) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!1964)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!1965))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1963) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1963) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   a!7)))))
  (fp.lt (fp.abs a!8) ((_ to_fp 11 53) #x39b4484bfeebc2a0)))))))
