...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!564) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!564)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!565))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!563) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!563) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 a_ack!566))
