...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!456) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!456)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!457))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!455) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!455) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!455)
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) a_ack!458)))))
(assert (FPCHECK_FMUL_OVERFLOW #x4000000000000000 a_ack!458))
