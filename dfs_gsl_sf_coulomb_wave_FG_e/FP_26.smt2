...
(declare-fun d_ack!705 () (_ BitVec 32))
(declare-fun a_ack!706 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!703) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!704) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!704)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!705))
             ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!703) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!703) ((_ to_fp 11 53) #x3ff3333333333333)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!703)
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) a_ack!706))
                           ((_ to_fp 11 53) b_ack!703)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!703))))
