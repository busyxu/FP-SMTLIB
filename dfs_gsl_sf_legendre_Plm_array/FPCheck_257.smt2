...
(assert (bvsle #x00000001 b_ack!1326))
(assert (not (bvsle #x00000002 b_ack!1326)))
...
(let ((a!15 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!14
                            ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!15 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1327) a!1)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(assert (bvsle (bvadd #x00000009 b_ack!1326) a_ack!1328))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000009 b_ack!1326)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!2 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1327)
                                  a!1))
...
(let ((a!24 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!23
                            ((_ to_fp 11 53) #x4020000000000000)))))
  (fp.eq a!24 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1327) a!1))))))))))))
(assert (bvsle (bvadd #x0000000a b_ack!1326) a_ack!1328))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x0000000a b_ack!1326)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!2 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1327)
                                  a!1))
...
(let ((a!24 (fp.sub roundNearestTiesToEven
      ...
      (a!25 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000008 (bvadd b_ack!1326 b_ack!1326)))
                    (fp.div roundNearestTiesToEven
                            a!22
                            ((_ to_fp 11 53) #x401c000000000000)))))
...
(let ((a!27 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!26
                            ((_ to_fp 11 53) #x4022000000000000)))))
  (fp.eq a!27 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1327) a!1)))))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!26 (fp.sub roundNearestTiesToEven
      ...
      (a!27 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000009 (bvadd b_ack!1326 b_ack!1326)))
                    (fp.div roundNearestTiesToEven
                            a!24
                            ((_ to_fp 11 53) #x4020000000000000)))))
