...
(assert (bvslt #x00000000 b_ack!171))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!172) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!172) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 c_ack!172))
