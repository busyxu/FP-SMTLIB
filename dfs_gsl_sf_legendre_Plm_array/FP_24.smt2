...
(assert (bvslt #x00000000 b_ack!576))
...
(assert (bvsle #x00000001 b_ack!576))
(assert (not (bvsle #x00000002 b_ack!576)))
...
(assert (bvsle (bvadd #x00000003 b_ack!576) a_ack!578))
(assert (bvsle (bvadd #x00000004 b_ack!576) a_ack!578))
