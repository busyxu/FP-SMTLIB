...
(assert (bvslt #x00000000 b_ack!1101))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1102) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1102) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (not (= #x00000000 b_ack!1101)))
(assert (bvsle #x00000001 b_ack!1101))
(assert (not (bvsle #x00000002 b_ack!1101)))
...
(assert (bvsle (bvadd #x00000005 b_ack!1101) a_ack!1103))
(assert (bvsle (bvadd #x00000006 b_ack!1101) a_ack!1103))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000006 b_ack!1101)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
      ...
      (a!7 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!1101 b_ack!1101)))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
      ...
      (a!9 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1101 b_ack!1101)))
                   (fp.mul roundNearestTiesToEven
                           a!6
                           ((_ to_fp 11 53) #xbff0000000000000)))))
(let ((a!10 (fp.sub roundNearestTiesToEven
      ...
      (a!11 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000003 (bvadd b_ack!1101 b_ack!1101)))
                    (fp.div roundNearestTiesToEven
                            a!8
                            ((_ to_fp 11 53) #x4000000000000000)))))
(let ((a!12 (fp.sub roundNearestTiesToEven
      ...
      (a!13 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000004 (bvadd b_ack!1101 b_ack!1101)))
                    (fp.div roundNearestTiesToEven
                            a!10
                            ((_ to_fp 11 53) #x4008000000000000)))))
...
(let ((a!15 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!14
                            ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!15 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1102) a!1)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!14 (fp.sub roundNearestTiesToEven
      ...
      (a!16 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000005 (bvadd b_ack!1101 b_ack!1101)))
                    (fp.div roundNearestTiesToEven
                            a!12
                            ((_ to_fp 11 53) #x4010000000000000)))))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven a!15 a!16))
         a!16))))))))
(assert (bvsle (bvadd #x00000007 b_ack!1101) a_ack!1103))
(assert (bvsle (bvadd #x00000008 b_ack!1101) a_ack!1103))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000008 b_ack!1101)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!18 (fp.sub roundNearestTiesToEven
      ...
      (a!19 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000006 (bvadd b_ack!1101 b_ack!1101)))
                    (fp.div roundNearestTiesToEven
                            a!16
                            ((_ to_fp 11 53) #x4014000000000000)))))
(let ((a!20 (fp.sub roundNearestTiesToEven
      ...
      (a!21 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000007 (bvadd b_ack!1101 b_ack!1101)))
                    (fp.div roundNearestTiesToEven
                            a!18
                            ((_ to_fp 11 53) #x4018000000000000)))))
