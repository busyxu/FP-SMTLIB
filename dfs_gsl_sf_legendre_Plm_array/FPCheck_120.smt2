...
(assert (bvsle #x00000001 b_ack!564))
(assert (not (bvsle #x00000002 b_ack!564)))
(assert (not (= a_ack!566 b_ack!564)))
(assert (not (= a_ack!566 (bvadd #x00000001 b_ack!564))))
(assert (bvsle (bvadd #x00000002 b_ack!564) a_ack!566))
(assert (bvsle (bvadd #x00000003 b_ack!564) a_ack!566))
(assert (bvsle (bvadd #x00000004 b_ack!564) a_ack!566))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000004 b_ack!564)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!565 a!1)))
