...
(assert (bvsle (bvadd #x00000005 b_ack!2034) a_ack!2036))
(assert (FPCHECK_FMUL_OVERFLOW
  #x4000000000000000
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000005 b_ack!2034))))
