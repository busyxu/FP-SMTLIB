...
(assert (not (bvsle #x00000002 b_ack!1248)))
...
(assert (bvsle (bvadd #x00000006 b_ack!1248) a_ack!1250))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000006 b_ack!1248)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!15 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!14
                            ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!15 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1249) a!1)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!14 (fp.sub roundNearestTiesToEven
      ...
      (a!16 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000005 (bvadd b_ack!1248 b_ack!1248)))
                    (fp.div roundNearestTiesToEven
                            a!12
                            ((_ to_fp 11 53) #x4010000000000000)))))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 (fp.sub roundNearestTiesToEven a!15 a!16))
         a!16))))))))
(assert (bvsle (bvadd #x00000007 b_ack!1248) a_ack!1250))
(assert (bvsle (bvadd #x00000008 b_ack!1248) a_ack!1250))
(assert (bvsle (bvadd #x00000009 b_ack!1248) a_ack!1250))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000009 b_ack!1248)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!2 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1249)
                                  a!1))
...
(let ((a!19 (fp.sub roundNearestTiesToEven
      ...
      (a!20 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000006 (bvadd b_ack!1248 b_ack!1248)))
                    (fp.div roundNearestTiesToEven
                            a!17
                            ((_ to_fp 11 53) #x4014000000000000)))))
(let ((a!21 (fp.sub roundNearestTiesToEven
      ...
      (a!22 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000007 (bvadd b_ack!1248 b_ack!1248)))
                    (fp.div roundNearestTiesToEven
                            a!19
                            ((_ to_fp 11 53) #x4018000000000000)))))
...
(let ((a!24 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!23
                            ((_ to_fp 11 53) #x4020000000000000)))))
  (fp.eq a!24 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1249) a!1))))))))))))
(assert (bvsle (bvadd #x0000000a b_ack!1248) a_ack!1250))
(assert (FPCHECK_FSUB_ACCURACY
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x0000000a b_ack!1248)))
  #x3ff0000000000000))
