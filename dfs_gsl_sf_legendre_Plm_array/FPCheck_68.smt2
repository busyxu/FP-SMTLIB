...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!284 b_ack!282))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!284 b_ack!282))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!284 b_ack!282))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!282))
...
(assert (bvsle #x00000001 b_ack!282))
(assert (not (bvsle #x00000002 b_ack!282)))
