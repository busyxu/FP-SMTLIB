...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!683 b_ack!681))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!683 b_ack!681))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!683 b_ack!681))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!681))
(assert (not (bvsle #x00000002 b_ack!681)))
(assert (not (= a_ack!683 b_ack!681)))
(assert (not (= a_ack!683 (bvadd #x00000001 b_ack!681))))
(assert (bvsle (bvadd #x00000002 b_ack!681) a_ack!683))
(assert (bvsle (bvadd #x00000003 b_ack!681) a_ack!683))
(assert (bvsle (bvadd #x00000004 b_ack!681) a_ack!683))
(assert (bvsle (bvadd #x00000005 b_ack!681) a_ack!683))
