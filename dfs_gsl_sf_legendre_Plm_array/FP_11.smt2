...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!278 b_ack!276))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!278 b_ack!276))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!278 b_ack!276))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!276))
(assert (not (bvsle #x00000002 b_ack!276)))
