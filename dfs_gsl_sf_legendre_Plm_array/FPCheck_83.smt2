...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!377 b_ack!375))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!377 b_ack!375))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!377 b_ack!375))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!375))
(assert (not (bvsle #x00000002 b_ack!375)))
(assert (not (= a_ack!377 b_ack!375)))
(assert (not (= a_ack!377 (bvadd #x00000001 b_ack!375))))
(assert (bvsle (bvadd #x00000002 b_ack!375) a_ack!377))
(assert (FPCHECK_FMUL_OVERFLOW
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 b_ack!375 b_ack!375))
  #xbff0000000000000))
