...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!530 b_ack!528))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!530 b_ack!528))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!530 b_ack!528))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!528))
...
(assert (not (= #x00000000 b_ack!528)))
(assert (bvsle #x00000001 b_ack!528))
(assert (not (bvsle #x00000002 b_ack!528)))
(assert (not (= a_ack!530 b_ack!528)))
(assert (not (= a_ack!530 (bvadd #x00000001 b_ack!528))))
(assert (bvsle (bvadd #x00000002 b_ack!528) a_ack!530))
(assert (bvsle (bvadd #x00000003 b_ack!528) a_ack!530))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000003 b_ack!528)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!528 b_ack!528)))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
      ...
      (a!6 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!528 b_ack!528)))
                   (fp.mul roundNearestTiesToEven
                           a!3
                           ((_ to_fp 11 53) #xbff0000000000000)))))
