...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!221 b_ack!219))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!221 b_ack!219))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!221 b_ack!219))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!219))
(assert (bvsle #x00000002 b_ack!219))
(assert (bvsle #x00000003 b_ack!219))
(assert (bvsle #x00000004 b_ack!219))
(assert (not (bvsle #x00000005 b_ack!219)))
(assert (FPCHECK_FMUL_OVERFLOW
  c_ack!220
  (fp.add roundNearestTiesToEven
          (fp.mul roundNearestTiesToEven
                  ((_ to_fp 11 53) #x4000000000000000)
                  ((_ to_fp 11 53) roundNearestTiesToEven b_ack!219))
          ((_ to_fp 11 53) #x3ff0000000000000))))
