...
(assert (not (bvslt #x00000000 b_ack!2055)))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (not (= a_ack!2057 (bvadd #x00000001 b_ack!2055))))
(assert (bvsle (bvadd #x00000002 b_ack!2055) a_ack!2057))
(assert (bvsle (bvadd #x00000003 b_ack!2055) a_ack!2057))
(assert (bvsle (bvadd #x00000004 b_ack!2055) a_ack!2057))
(assert (bvsle (bvadd #x00000005 b_ack!2055) a_ack!2057))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000005 b_ack!2055)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!2056 a!1)))
