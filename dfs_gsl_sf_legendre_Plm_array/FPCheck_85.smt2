...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!383 b_ack!381))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!383 b_ack!381))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!383 b_ack!381))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!381))
(assert (not (bvsle #x00000002 b_ack!381)))
(assert (not (= a_ack!383 b_ack!381)))
(assert (not (= a_ack!383 (bvadd #x00000001 b_ack!381))))
(assert (bvsle (bvadd #x00000002 b_ack!381) a_ack!383))
(assert (FPCHECK_FMUL_ACCURACY
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 b_ack!381 b_ack!381))
  #xbff0000000000000))
