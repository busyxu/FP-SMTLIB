...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!743 b_ack!741))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!743 b_ack!741))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!743 b_ack!741))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (= a_ack!743 (bvadd #x00000001 b_ack!741))))
(assert (bvsle (bvadd #x00000002 b_ack!741) a_ack!743))
(assert (bvsle (bvadd #x00000003 b_ack!741) a_ack!743))
(assert (bvsle (bvadd #x00000004 b_ack!741) a_ack!743))
(assert (bvsle (bvadd #x00000005 b_ack!741) a_ack!743))
