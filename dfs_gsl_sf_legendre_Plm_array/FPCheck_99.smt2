...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!440 b_ack!438))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!440 b_ack!438))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!440 b_ack!438))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!438))
...
(assert (bvsle #x00000001 b_ack!438))
(assert (not (bvsle #x00000002 b_ack!438)))
(assert (not (= a_ack!440 b_ack!438)))
(assert (not (= a_ack!440 (bvadd #x00000001 b_ack!438))))
(assert (bvsle (bvadd #x00000002 b_ack!438) a_ack!440))
(assert (bvsle (bvadd #x00000003 b_ack!438) a_ack!440))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000003 b_ack!438)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_UNDERFLOW c_ack!439 a!1)))
