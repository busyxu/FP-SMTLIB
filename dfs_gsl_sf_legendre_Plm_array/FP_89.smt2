...
(assert (not (bvslt #x00000000 b_ack!2127)))
(assert (let ((a!1 (CF_log (fp.add roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   ((_ to_fp 11 53)
...
(assert (not (= a_ack!2129 b_ack!2127)))
(assert (not (= a_ack!2129 (bvadd #x00000001 b_ack!2127))))
(assert (bvsle (bvadd #x00000002 b_ack!2127) a_ack!2129))
(assert (bvsle (bvadd #x00000003 b_ack!2127) a_ack!2129))
(assert (bvsle (bvadd #x00000004 b_ack!2127) a_ack!2129))
(assert (bvsle (bvadd #x00000005 b_ack!2127) a_ack!2129))
