...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!593 b_ack!591))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!593 b_ack!591))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!593 b_ack!591))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvslt #x00000000 b_ack!591))
...
(assert (not (= #x00000000 b_ack!591)))
(assert (bvsle #x00000001 b_ack!591))
(assert (not (bvsle #x00000002 b_ack!591)))
(assert (not (= a_ack!593 b_ack!591)))
(assert (not (= a_ack!593 (bvadd #x00000001 b_ack!591))))
(assert (bvsle (bvadd #x00000002 b_ack!591) a_ack!593))
(assert (bvsle (bvadd #x00000003 b_ack!591) a_ack!593))
(assert (bvsle (bvadd #x00000004 b_ack!591) a_ack!593))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000004 b_ack!591)))
                   ((_ to_fp 11 53) #x3ff0000000000000)))
      (a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000001 (bvadd b_ack!591 b_ack!591)))
...
(let ((a!6 (fp.sub roundNearestTiesToEven
      ...
      (a!7 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!591 b_ack!591)))
                   (fp.mul roundNearestTiesToEven
                           a!4
                           ((_ to_fp 11 53) #xbff0000000000000)))))
(let ((a!8 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!592) a!1)
