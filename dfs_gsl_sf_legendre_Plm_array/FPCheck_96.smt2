...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!431 b_ack!429))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!431 b_ack!429))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!431 b_ack!429))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!429))
(assert (not (bvsle #x00000002 b_ack!429)))
(assert (not (= a_ack!431 b_ack!429)))
(assert (not (= a_ack!431 (bvadd #x00000001 b_ack!429))))
(assert (bvsle (bvadd #x00000002 b_ack!429) a_ack!431))
(assert (bvsle (bvadd #x00000003 b_ack!429) a_ack!431))
(assert (FPCHECK_FSUB_UNDERFLOW
  (fp.mul roundNearestTiesToEven
          ((_ to_fp 11 53) #x4000000000000000)
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000003 b_ack!429)))
  #x3ff0000000000000))
