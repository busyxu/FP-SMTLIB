...
(let ((a!15 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!14
                            ((_ to_fp 11 53) #x4014000000000000)))))
  (fp.eq a!15 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1420) a!1)))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!24 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!23
                            ((_ to_fp 11 53) #x4020000000000000)))))
  (fp.eq a!24 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1420) a!1))))))))))))
(assert (bvsle (bvadd #x0000000a b_ack!1419) a_ack!1421))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x0000000a b_ack!1419)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
(let ((a!2 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) c_ack!1420)
                                  a!1))
...
(let ((a!27 (fp.div roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            a!26
                            ((_ to_fp 11 53) #x4022000000000000)))))
  (fp.eq a!27 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) c_ack!1420) a!1)))))))))))))
(assert (bvsle (bvadd #x0000000b b_ack!1419) a_ack!1421))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
...
(let ((a!25 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x0000000a (bvadd b_ack!1419 b_ack!1419)))
