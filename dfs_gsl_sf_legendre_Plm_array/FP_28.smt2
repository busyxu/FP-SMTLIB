...
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!725 b_ack!723))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53)
               roundNearestTiesToEven
               (bvsub a_ack!725 b_ack!723))
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven (bvsub a_ack!725 b_ack!723))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (bvsle #x00000001 b_ack!723))
(assert (not (bvsle #x00000002 b_ack!723)))
(assert (not (= a_ack!725 b_ack!723)))
(assert (not (= a_ack!725 (bvadd #x00000001 b_ack!723))))
(assert (bvsle (bvadd #x00000002 b_ack!723) a_ack!725))
(assert (bvsle (bvadd #x00000003 b_ack!723) a_ack!725))
(assert (bvsle (bvadd #x00000004 b_ack!723) a_ack!725))
(assert (bvsle (bvadd #x00000005 b_ack!723) a_ack!725))
