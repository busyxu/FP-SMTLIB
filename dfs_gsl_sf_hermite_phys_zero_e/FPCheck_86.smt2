...
(assert (not (bvsle a_ack!372 #x00000000)))
(assert (not (bvslt b_ack!371 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!372 #x00000002) b_ack!371)))
(assert (not (= #x00000000 b_ack!371)))
(assert (not (= #x00000002 a_ack!372)))
(assert (not (bvslt a_ack!372 #x00000015)))
(assert (= #x00000001 b_ack!371))
(assert (bvslt #x00000032 a_ack!372))
(assert (not (= #x00000000 (bvand a_ack!372 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!372 #x00000002) b_ack!371)))))
