(declare-fun e0_ack!1891 () (_ BitVec 64))
(declare-fun e1_ack!1892 () (_ BitVec 64))
(declare-fun e2_ack!1893 () (_ BitVec 64))
(declare-fun x2_ack!1890 () (_ BitVec 64))
(declare-fun x1_ack!1889 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1891)
                    ((_ to_fp 11 53) e0_ack!1891))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1892)
                    ((_ to_fp 11 53) e1_ack!1892))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1893)
                    ((_ to_fp 11 53) e2_ack!1893))
            ((_ to_fp 11 53) #x0000000000000000))))
