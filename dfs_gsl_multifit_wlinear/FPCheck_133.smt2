(declare-fun e0_ack!718 () (_ BitVec 64))
(declare-fun e1_ack!719 () (_ BitVec 64))
(declare-fun e2_ack!720 () (_ BitVec 64))
(declare-fun x2_ack!716 () (_ BitVec 64))
(declare-fun x1_ack!715 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!717 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!718)
                    ((_ to_fp 11 53) e0_ack!718))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!719)
                    ((_ to_fp 11 53) e1_ack!719))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!720)
                    ((_ to_fp 11 53) e2_ack!720))
            ((_ to_fp 11 53) #x0000000000000000))))
