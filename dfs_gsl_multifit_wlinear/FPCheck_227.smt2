(declare-fun e0_ack!1791 () (_ BitVec 64))
(declare-fun e1_ack!1792 () (_ BitVec 64))
(declare-fun e2_ack!1793 () (_ BitVec 64))
(declare-fun x2_ack!1790 () (_ BitVec 64))
(declare-fun x1_ack!1789 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1791)
                    ((_ to_fp 11 53) e0_ack!1791))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1792)
                    ((_ to_fp 11 53) e1_ack!1792))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1793)
                    ((_ to_fp 11 53) e2_ack!1793))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!12 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000))
                    ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_ACCURACY a!12 #x4000000000000000))))))))))))))
