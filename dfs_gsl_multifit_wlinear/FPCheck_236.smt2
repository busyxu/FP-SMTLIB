(declare-fun e0_ack!1881 () (_ BitVec 64))
(declare-fun e1_ack!1882 () (_ BitVec 64))
(declare-fun e2_ack!1883 () (_ BitVec 64))
(declare-fun x2_ack!1880 () (_ BitVec 64))
(declare-fun x1_ack!1879 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1881)
                    ((_ to_fp 11 53) e0_ack!1881))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1882)
                    ((_ to_fp 11 53) e1_ack!1882))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1883)
                    ((_ to_fp 11 53) e2_ack!1883))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000))
                    ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_ACCURACY a!13 #x4000000000000000)))))))))))))))
