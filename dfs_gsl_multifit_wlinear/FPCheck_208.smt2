(declare-fun e0_ack!1601 () (_ BitVec 64))
(declare-fun e1_ack!1602 () (_ BitVec 64))
(declare-fun e2_ack!1603 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1601)
                    ((_ to_fp 11 53) e0_ack!1601))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1602)
                    ((_ to_fp 11 53) e1_ack!1602))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1603)
                    ((_ to_fp 11 53) e2_ack!1603))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!10 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000))
                    ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_UNDERFLOW a!10 #x4000000000000000))))))))))))
