(declare-fun e0_ack!585 () (_ BitVec 64))
(declare-fun e1_ack!586 () (_ BitVec 64))
(declare-fun e2_ack!587 () (_ BitVec 64))
(declare-fun x2_ack!584 () (_ BitVec 64))
(declare-fun x1_ack!583 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!585)
                    ((_ to_fp 11 53) e0_ack!585))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!586)
                    ((_ to_fp 11 53) e1_ack!586))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!587)
                    ((_ to_fp 11 53) e2_ack!587))
            ((_ to_fp 11 53) #x0000000000000000))))
