(declare-fun e0_ack!615 () (_ BitVec 64))
(declare-fun e1_ack!616 () (_ BitVec 64))
(declare-fun e2_ack!617 () (_ BitVec 64))
(declare-fun x2_ack!614 () (_ BitVec 64))
(declare-fun x1_ack!613 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!615)
                    ((_ to_fp 11 53) e0_ack!615))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!616)
                    ((_ to_fp 11 53) e1_ack!616))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!617)
                    ((_ to_fp 11 53) e2_ack!617))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (FPCHECK_FADD_OVERFLOW #x3fe618dab0184066 (fp.abs a!2)))))
