(declare-fun e0_ack!981 () (_ BitVec 64))
(declare-fun e1_ack!982 () (_ BitVec 64))
(declare-fun e2_ack!983 () (_ BitVec 64))
(declare-fun x2_ack!980 () (_ BitVec 64))
(declare-fun x1_ack!979 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!981)
                    ((_ to_fp 11 53) e0_ack!981))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!982)
                    ((_ to_fp 11 53) e1_ack!982))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!983)
                    ((_ to_fp 11 53) e2_ack!983))
            ((_ to_fp 11 53) #x0000000000000000))))
