(declare-fun e0_ack!2141 () (_ BitVec 64))
(declare-fun e1_ack!2142 () (_ BitVec 64))
(declare-fun e2_ack!2143 () (_ BitVec 64))
(declare-fun x2_ack!2140 () (_ BitVec 64))
(declare-fun x1_ack!2139 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2141)
                    ((_ to_fp 11 53) e0_ack!2141))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2142)
                    ((_ to_fp 11 53) e1_ack!2142))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2143)
                    ((_ to_fp 11 53) e2_ack!2143))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!16 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000))
                    ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_UNDERFLOW a!16 #x4000000000000000))))))))))))))))))
