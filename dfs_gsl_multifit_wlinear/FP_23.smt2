(declare-fun e0_ack!796 () (_ BitVec 64))
(declare-fun e1_ack!797 () (_ BitVec 64))
(declare-fun e2_ack!798 () (_ BitVec 64))
(declare-fun x2_ack!795 () (_ BitVec 64))
(declare-fun x1_ack!794 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!796)
                    ((_ to_fp 11 53) e0_ack!796))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!797)
                    ((_ to_fp 11 53) e1_ack!797))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!798)
                    ((_ to_fp 11 53) e2_ack!798))
            ((_ to_fp 11 53) #x0000000000000000))))
