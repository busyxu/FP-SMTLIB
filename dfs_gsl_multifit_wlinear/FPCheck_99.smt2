(declare-fun e0_ack!525 () (_ BitVec 64))
(declare-fun e1_ack!526 () (_ BitVec 64))
(declare-fun e2_ack!527 () (_ BitVec 64))
(declare-fun x2_ack!524 () (_ BitVec 64))
(declare-fun x1_ack!523 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!525)
                    ((_ to_fp 11 53) e0_ack!525))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!526)
                    ((_ to_fp 11 53) e1_ack!526))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!527)
                    ((_ to_fp 11 53) e2_ack!527))
            ((_ to_fp 11 53) #x0000000000000000))))
