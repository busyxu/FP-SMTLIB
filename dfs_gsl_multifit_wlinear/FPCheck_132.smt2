(declare-fun e0_ack!706 () (_ BitVec 64))
(declare-fun e1_ack!707 () (_ BitVec 64))
(declare-fun e2_ack!708 () (_ BitVec 64))
(declare-fun x2_ack!704 () (_ BitVec 64))
(declare-fun x1_ack!703 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!705 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!706)
                    ((_ to_fp 11 53) e0_ack!706))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!707)
                    ((_ to_fp 11 53) e1_ack!707))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!708)
                    ((_ to_fp 11 53) e2_ack!708))
            ((_ to_fp 11 53) #x0000000000000000))))
