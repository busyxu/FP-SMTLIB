(declare-fun e0_ack!545 () (_ BitVec 64))
(declare-fun e1_ack!546 () (_ BitVec 64))
(declare-fun e2_ack!547 () (_ BitVec 64))
(declare-fun x2_ack!544 () (_ BitVec 64))
(declare-fun x1_ack!543 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!545)
                    ((_ to_fp 11 53) e0_ack!545))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!546)
                    ((_ to_fp 11 53) e1_ack!546))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!547)
                    ((_ to_fp 11 53) e2_ack!547))
            ((_ to_fp 11 53) #x0000000000000000))))
