(declare-fun e0_ack!440 () (_ BitVec 64))
(declare-fun e1_ack!441 () (_ BitVec 64))
(declare-fun e2_ack!442 () (_ BitVec 64))
(declare-fun x2_ack!439 () (_ BitVec 64))
(declare-fun x1_ack!438 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!440)
                    ((_ to_fp 11 53) e0_ack!440))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!441)
                    ((_ to_fp 11 53) e1_ack!441))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!442)
                    ((_ to_fp 11 53) e2_ack!442))
            ((_ to_fp 11 53) #x0000000000000000))))
