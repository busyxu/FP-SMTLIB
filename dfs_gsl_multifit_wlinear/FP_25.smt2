(declare-fun e0_ack!806 () (_ BitVec 64))
(declare-fun e1_ack!807 () (_ BitVec 64))
(declare-fun e2_ack!808 () (_ BitVec 64))
(declare-fun x2_ack!805 () (_ BitVec 64))
(declare-fun x1_ack!804 () (_ BitVec 64))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!806)
                    ((_ to_fp 11 53) e0_ack!806))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!807)
                    ((_ to_fp 11 53) e1_ack!807))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!808)
                    ((_ to_fp 11 53) e2_ack!808))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!804)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!805)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
