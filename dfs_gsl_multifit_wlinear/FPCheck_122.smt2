(declare-fun e0_ack!640 () (_ BitVec 64))
(declare-fun e1_ack!641 () (_ BitVec 64))
(declare-fun e2_ack!642 () (_ BitVec 64))
(declare-fun x2_ack!639 () (_ BitVec 64))
(declare-fun x1_ack!638 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!640)
                    ((_ to_fp 11 53) e0_ack!640))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!641)
                    ((_ to_fp 11 53) e1_ack!641))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!642)
                    ((_ to_fp 11 53) e2_ack!642))
            ((_ to_fp 11 53) #x0000000000000000))))
