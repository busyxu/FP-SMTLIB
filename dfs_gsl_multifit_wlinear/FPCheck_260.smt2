(declare-fun e0_ack!2121 () (_ BitVec 64))
(declare-fun e1_ack!2122 () (_ BitVec 64))
(declare-fun e2_ack!2123 () (_ BitVec 64))
(declare-fun x2_ack!2120 () (_ BitVec 64))
(declare-fun x1_ack!2119 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2121)
                    ((_ to_fp 11 53) e0_ack!2121))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2122)
                    ((_ to_fp 11 53) e1_ack!2122))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2123)
                    ((_ to_fp 11 53) e2_ack!2123))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!2119)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!2120)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
