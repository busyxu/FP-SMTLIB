(declare-fun e0_ack!1841 () (_ BitVec 64))
(declare-fun e1_ack!1842 () (_ BitVec 64))
(declare-fun e2_ack!1843 () (_ BitVec 64))
(declare-fun x2_ack!1840 () (_ BitVec 64))
(declare-fun x1_ack!1839 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1841)
                    ((_ to_fp 11 53) e0_ack!1841))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1842)
                    ((_ to_fp 11 53) e1_ack!1842))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1843)
                    ((_ to_fp 11 53) e2_ack!1843))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!1839)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!1840)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
