(declare-fun e0_ack!600 () (_ BitVec 64))
(declare-fun e1_ack!601 () (_ BitVec 64))
(declare-fun e2_ack!602 () (_ BitVec 64))
(declare-fun x2_ack!599 () (_ BitVec 64))
(declare-fun x1_ack!598 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!600)
                    ((_ to_fp 11 53) e0_ack!600))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!601)
                    ((_ to_fp 11 53) e1_ack!601))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!602)
                    ((_ to_fp 11 53) e2_ack!602))
            ((_ to_fp 11 53) #x0000000000000000))))
