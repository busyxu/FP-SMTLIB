(declare-fun e0_ack!2051 () (_ BitVec 64))
(declare-fun e1_ack!2052 () (_ BitVec 64))
(declare-fun e2_ack!2053 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2051)
                    ((_ to_fp 11 53) e0_ack!2051))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2052)
                    ((_ to_fp 11 53) e1_ack!2052))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2053)
                    ((_ to_fp 11 53) e2_ack!2053))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!15 (fp.div roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven
                            ...
                            ((_ to_fp 11 53) #x4000000000000000))
                    ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_UNDERFLOW a!15 #x4000000000000000)))))))))))))))))
