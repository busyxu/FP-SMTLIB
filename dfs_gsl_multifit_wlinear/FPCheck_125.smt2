(declare-fun e0_ack!655 () (_ BitVec 64))
(declare-fun e1_ack!656 () (_ BitVec 64))
(declare-fun e2_ack!657 () (_ BitVec 64))
(declare-fun x2_ack!654 () (_ BitVec 64))
(declare-fun x1_ack!653 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!655)
                    ((_ to_fp 11 53) e0_ack!655))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!656)
                    ((_ to_fp 11 53) e1_ack!656))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!657)
                    ((_ to_fp 11 53) e2_ack!657))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x1_ack!653)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
(let ((a!2 (fp.add roundNearestTiesToEven
                   a!1
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) x2_ack!654)
                                   ((_ to_fp 11 53) #x409f400000000000))))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   a!4
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (FPCHECK_FADD_ACCURACY (fp.abs a!2) (fp.abs a!5))))))
