(declare-fun e0_ack!1061 () (_ BitVec 64))
(declare-fun e1_ack!1062 () (_ BitVec 64))
(declare-fun e2_ack!1063 () (_ BitVec 64))
...
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1061)
                    ((_ to_fp 11 53) e0_ack!1061))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1062)
                    ((_ to_fp 11 53) e1_ack!1062))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1063)
                    ((_ to_fp 11 53) e2_ack!1063))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!4 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4000000000000000))
                   ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_UNDERFLOW a!4 #x4000000000000000))))))
