(declare-fun e0_ack!660 () (_ BitVec 64))
(declare-fun e1_ack!661 () (_ BitVec 64))
(declare-fun e2_ack!662 () (_ BitVec 64))
(declare-fun x2_ack!659 () (_ BitVec 64))
(declare-fun x1_ack!658 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!660)
                    ((_ to_fp 11 53) e0_ack!660))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!661)
                    ((_ to_fp 11 53) e1_ack!661))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!662)
                    ((_ to_fp 11 53) e2_ack!662))
            ((_ to_fp 11 53) #x0000000000000000))))
