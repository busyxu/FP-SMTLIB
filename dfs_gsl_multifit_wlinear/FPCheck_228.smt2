(declare-fun e0_ack!1801 () (_ BitVec 64))
(declare-fun e1_ack!1802 () (_ BitVec 64))
(declare-fun e2_ack!1803 () (_ BitVec 64))
(declare-fun x2_ack!1800 () (_ BitVec 64))
(declare-fun x1_ack!1799 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1801)
                    ((_ to_fp 11 53) e0_ack!1801))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1802)
                    ((_ to_fp 11 53) e1_ack!1802))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1803)
                    ((_ to_fp 11 53) e2_ack!1803))
            ((_ to_fp 11 53) #x0000000000000000))))
