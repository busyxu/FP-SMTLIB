(declare-fun e0_ack!1541 () (_ BitVec 64))
(declare-fun e1_ack!1542 () (_ BitVec 64))
(declare-fun e2_ack!1543 () (_ BitVec 64))
(declare-fun x2_ack!1540 () (_ BitVec 64))
(declare-fun x1_ack!1539 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!1541)
                    ((_ to_fp 11 53) e0_ack!1541))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!1542)
                    ((_ to_fp 11 53) e1_ack!1542))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!1543)
                    ((_ to_fp 11 53) e2_ack!1543))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_UNDERFLOW
    (fp.div roundNearestTiesToEven a!9 ((_ to_fp 11 53) #x4000000000000000))
    #x4000000000000000)))))))))))
