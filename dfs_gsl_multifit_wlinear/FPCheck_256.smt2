(declare-fun e0_ack!2081 () (_ BitVec 64))
(declare-fun e1_ack!2082 () (_ BitVec 64))
(declare-fun e2_ack!2083 () (_ BitVec 64))
(declare-fun x2_ack!2080 () (_ BitVec 64))
(declare-fun x1_ack!2079 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e0_ack!2081)
                    ((_ to_fp 11 53) e0_ack!2081))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e1_ack!2082)
                    ((_ to_fp 11 53) e1_ack!2082))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) e2_ack!2083)
                    ((_ to_fp 11 53) e2_ack!2083))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!15 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_UNDERFLOW
    (fp.div roundNearestTiesToEven a!15 ((_ to_fp 11 53) #x4000000000000000))
    #x4000000000000000)))))))))))))))))
