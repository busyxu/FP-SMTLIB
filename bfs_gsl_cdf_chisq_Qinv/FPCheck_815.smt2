...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2350) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2350) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!2350) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!23 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4000000000000000))
                            a!14))))
  (FPCHECK_FMUL_ACCURACY a!23 #x3ff0000000000000)))))))))))))))))
