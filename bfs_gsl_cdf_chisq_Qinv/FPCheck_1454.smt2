...
(declare-fun nu_ack!3929 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3930) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3930) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3930) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3930) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!31 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!23))
                    a!25)))
  (FPCHECK_FDIV_UNDERFLOW a!25 a!31)))))))))))
