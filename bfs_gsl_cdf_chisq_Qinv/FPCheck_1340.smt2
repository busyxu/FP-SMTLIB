...
(declare-fun nu_ack!3701 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3702) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3702) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3702) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3702) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!21 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!15))
                    a!17)))
  (FPCHECK_FDIV_UNDERFLOW a!17 a!21)))))))))
