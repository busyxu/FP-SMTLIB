...
(declare-fun nu_ack!1730 () (_ BitVec 64))
...
(assert (fp.lt ((_ to_fp 11 53) x_ack!1731) ((_ to_fp 11 53) #x3fa999999999999a)))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ((_ to_fp 11 53) nu_ack!1730)
...
(let ((a!23 (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FMUL_OVERFLOW #x3cc0000000000000 a!23)))))))))))))))))
