...
(declare-fun nu_ack!3689 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3690) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3690) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3690) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3690) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!15 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!13)
                    a!14)))
  (FPCHECK_FMUL_UNDERFLOW a!15 a!16)))))))
