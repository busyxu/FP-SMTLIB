...
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2170) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2170) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!2170) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!8 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven a!1 a!7))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (fp.eq a!8 ((_ to_fp 11 53) #x0000000000000000))))))))
