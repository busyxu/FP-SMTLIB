...
(declare-fun nu_ack!5057 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!5058) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!5058) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!5058) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!5058) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.leq (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) x_ack!5058)
...
(let ((a!60 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!58)
                    a!59)))
  (FPCHECK_FMUL_UNDERFLOW a!60 a!61))))))))))))))))
