...
(assert (fp.lt ((_ to_fp 11 53) x_ack!2870) ((_ to_fp 11 53) #x3fa999999999999a)))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) nu_ack!2869)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
(let ((a!14 (fp.lt (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   (CF_log x_ack!2870))
                           (CF_log a!13))
...
(let ((a!13 (fp.div roundNearestTiesToEven
                    ...
                    (fp.abs (fp.div roundNearestTiesToEven
                                    ((_ to_fp 11 53) nu_ack!2869)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
(let ((a!14 (fp.eq (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   (CF_log x_ack!2870))
                           (CF_log a!13))
