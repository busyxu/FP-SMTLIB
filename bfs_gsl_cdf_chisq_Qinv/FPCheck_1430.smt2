...
(declare-fun nu_ack!3881 () (_ BitVec 64))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3882) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3882) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3882) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!3882) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!18)
                    a!19)))
  (FPCHECK_FMUL_ACCURACY (fp.mul roundNearestTiesToEven a!20 a!21) a!22))))))))
