...
(assert (not (= #xffffffff a_ack!234)))
(assert (= #x00000000 a_ack!234))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!233) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!233) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!233) ((_ to_fp 11 53) #x3ff0000000000000))))
