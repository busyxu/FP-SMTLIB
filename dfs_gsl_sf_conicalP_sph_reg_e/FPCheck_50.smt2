...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!266) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (bvslt a_ack!267 #xffffffff)))
(assert (not (= #xffffffff a_ack!267)))
(assert (= #x00000000 a_ack!267))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!266) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!266) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!266) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW (fp.abs a!1) a!2))))
