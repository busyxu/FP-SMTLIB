...
(assert (not (bvsle a_ack!328 #x00000000)))
(assert (not (bvslt b_ack!327 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!328 #x00000002) b_ack!327)))
(assert (not (= #x00000000 b_ack!327)))
(assert (not (= #x00000002 a_ack!328)))
(assert (not (bvslt a_ack!328 #x00000015)))
(assert (= #x00000001 b_ack!327))
(assert (bvslt #x00000032 a_ack!328))
(assert (not (= #x00000000 (bvand a_ack!328 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!328 #x00000002) b_ack!327)))))
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!328)
...
(let ((a!3 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) #x4010000000000000))
                   ((_ to_fp 11 53) #x4000000000000000))))
(let ((a!4 (CF_cos (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff8a4f044ba5706)
                                   a!3)))))
