...
(assert (= #x00000001 b_ack!149))
(assert (bvslt #x00000032 a_ack!150))
(assert (not (= #x00000000 (bvand a_ack!150 #x00000001))))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!150 #x00000002) b_ack!149)))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!150)
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (FPCHECK_FSUB_UNDERFLOW #xc00827f917c78e86 a!2))))
