...
(assert (fp.lt ((_ to_fp 11 53) c_ack!1157) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) a_ack!1158))
                   ((_ to_fp 11 53) b_ack!1156))))
(let ((a!2 (CF_floor (fp.sub roundNearestTiesToEven
                             (fp.add roundNearestTiesToEven
                                     ((_ to_fp 11 53) #x3ff0000000000000)
                                     ((_ to_fp 11 53) a_ack!1158))
                             a!1)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           a!1)
                   a!2)))
  (FPCHECK_FADD_OVERFLOW a!3 (CF_ceil (fp.sub roundNearestTiesToEven a!4 a!3)))))))
