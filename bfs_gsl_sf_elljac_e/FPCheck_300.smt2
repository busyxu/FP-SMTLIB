...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1199))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1199))
...
(let ((a!7 (fp.div roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
         ...
         (fp.abs (fp.mul roundNearestTiesToEven
                         a!4
                         (fp.mul roundNearestTiesToEven a!6 a!3))))))))))
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 b_ack!1199))
