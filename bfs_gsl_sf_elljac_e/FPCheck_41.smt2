...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!129))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_UNDERFLOW
    (fp.add roundNearestTiesToEven a!2 ((_ to_fp 11 53) #x3ff1c103807747d0))
    (fp.add roundNearestTiesToEven a!2 ((_ to_fp 11 53) #x3ff1c1038077625e))))))
