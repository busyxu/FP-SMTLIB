...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!746) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!746) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) x_ack!746) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu1_ack!744)
                       ((_ to_fp 11 53) #x0000000000000000))
                (fp.eq (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) nu1_ack!744)
                               ((_ to_fp 11 53) nu2_ack!745))
                       ((_ to_fp 11 53) #x0000000000000000)))))
  (not a!1)))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ff0000000000000)
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!744) ((_ to_fp 11 53) nu2_ack!745)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!744) ((_ to_fp 11 53) nu2_ack!745))))
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) nu2_ack!745)
               ((_ to_fp 11 53) nu1_ack!744))
       ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.leq ((_ to_fp 11 53) nu1_ack!744) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!744) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!744) ((_ to_fp 11 53) #x4000000000000000)))
