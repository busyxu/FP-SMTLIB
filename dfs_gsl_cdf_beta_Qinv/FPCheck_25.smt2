...
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu1_ack!195)
                       ((_ to_fp 11 53) #x0000000000000000))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) nu2_ack!196)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) nu2_ack!196))))
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) nu2_ack!196)
               ((_ to_fp 11 53) nu1_ack!195))
       ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.leq ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x4000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!195) ((_ to_fp 11 53) #x4330000000000000)))
