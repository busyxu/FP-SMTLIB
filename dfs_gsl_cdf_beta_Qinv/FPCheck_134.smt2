...
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu1_ack!873)
                       ((_ to_fp 11 53) #x0000000000000000))
...
(assert (not (fp.leq ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) nu1_ack!873) ((_ to_fp 11 53) #x4000000000000000)))
