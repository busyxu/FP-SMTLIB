...
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu1_ack!120)
                       ((_ to_fp 11 53) #x0000000000000000))
...
(assert (fp.gt ((_ to_fp 11 53) nu1_ack!120) ((_ to_fp 11 53) nu2_ack!121)))
(assert (not (fp.lt ((_ to_fp 11 53) nu1_ack!120) ((_ to_fp 11 53) nu2_ack!121))))
