(declare-fun limit_ack!808 () (_ BitVec 64))
(declare-fun epsabs_ack!807 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!809 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!808)))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!807)
