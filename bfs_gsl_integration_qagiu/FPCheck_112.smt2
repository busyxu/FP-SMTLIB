...
(declare-fun epsabs_ack!769 () (_ BitVec 64))
(declare-fun epsrel_ack!770 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!772 () (_ BitVec 64))
(assert (not (bvult #x00000000000003e8 limit_ack!771)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!769) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!770)
