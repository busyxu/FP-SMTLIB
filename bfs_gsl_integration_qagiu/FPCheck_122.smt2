(declare-fun limit_ack!852 () (_ BitVec 64))
(declare-fun epsabs_ack!850 () (_ BitVec 64))
(declare-fun epsrel_ack!851 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(declare-fun a_ack!853 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvult #x00000000000003e8 limit_ack!852)))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!850) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!851)
