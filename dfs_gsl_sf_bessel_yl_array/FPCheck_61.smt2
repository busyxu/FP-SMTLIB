...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!256) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 a_ack!257)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!256) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!256) ((_ to_fp 11 53) #x1ff0000000000001))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!256) ((_ to_fp 11 53) #x3fd0000000000000))))
