...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) a_ack!432) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!432) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!432) ((_ to_fp 11 53) #xc1dfffffff800000))))
