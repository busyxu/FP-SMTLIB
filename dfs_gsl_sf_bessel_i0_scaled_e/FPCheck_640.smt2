...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!952))
            ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!952))
...
(let ((a!36 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3cc0000000000000) a!36)
    #x7fffffffffffffff))))))))))))))))))))))))))))))))))))))
