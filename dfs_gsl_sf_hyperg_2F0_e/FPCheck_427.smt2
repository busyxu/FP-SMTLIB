...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) c_ack!2481) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.lt (fp.mul roundNearestTiesToEven
                  ...
                  a!2)))
  (not a!3))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!2482))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!5 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4014000000000000)
                                   (fp.add roundNearestTiesToEven a!1 a!3))))))
  (FPCHECK_FMUL_UNDERFLOW #x4014000000000000 a!5))))))
