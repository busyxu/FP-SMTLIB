...
(assert (let ((a!1 (and (fp.eq (fp.abs ((_ to_fp 11 53) y1_ack!698))
                       ((_ to_fp 11 53) #x0000000000000000))
                (fp.eq (fp.abs ((_ to_fp 11 53) x1_ack!701))
                       ((_ to_fp 11 53) #x0000000000000000)))))
  (not a!1)))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) x2_ack!699))
             (fp.abs ((_ to_fp 11 53) y2_ack!700)))))
(assert (fp.eq ((_ to_fp 11 53) x2_ack!699) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) y2_ack!700) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (CF_log (fp.abs ((_ to_fp 11 53) y2_ack!700)))
