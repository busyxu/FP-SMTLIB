...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!185))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!185))))))
  (FPCHECK_FADD_UNDERFLOW (fp.abs ((_ to_fp 11 53) a_ack!186)) a!1)))
