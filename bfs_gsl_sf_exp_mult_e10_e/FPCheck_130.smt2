...
(assert (fp.lt ((_ to_fp 11 53) a_ack!516) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!516) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!515))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!516)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!515))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!516))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!515))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!516)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!515))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!515))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!516)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!516)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!515))))))
