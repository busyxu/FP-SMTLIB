...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!284) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!284)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!283))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!283))))))
  (FPCHECK_FADD_ACCURACY (fp.abs ((_ to_fp 11 53) a_ack!284)) a!1)))
