...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!209))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!209)))))
...
(let ((a!3 ((_ fp.to_sbv 32)
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.add roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!210)) a!1)
