...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!338) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!338)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!337))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!337)))))
      (a!2 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!338)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!337)))))
      (a!5 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.geq ((_ to_fp 11 53) b_ack!337)
