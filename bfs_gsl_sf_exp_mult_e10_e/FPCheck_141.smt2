...
(assert (fp.lt ((_ to_fp 11 53) a_ack!556) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!556) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!555))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!556)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!556))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!556)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!556)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!556)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!555)))))
...
(let ((a!3 ((_ fp.to_sbv 32)
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!556)) a!1)
