...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!300) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!300)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!299)))))
...
(let ((a!3 ((_ fp.to_sbv 32)
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!300)) a!1)
