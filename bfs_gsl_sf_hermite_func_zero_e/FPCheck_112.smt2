...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (bvsle a_ack!478 #x00000000)))
(assert (not (bvslt b_ack!477 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!478 #x00000002) b_ack!477)))
(assert (not (= #x00000000 b_ack!477)))
(assert (not (= #x00000002 a_ack!478)))
(assert (not (bvslt a_ack!478 #x00000015)))
(assert (not (= #x00000001 b_ack!477)))
(assert (let ((a!1 (bvult (bvadd #x00000001
                         (bvsub (bvsdiv a_ack!478 #x00000002) b_ack!477))
                  #x00000001)))
  (not a!1)))
...
(assert (let ((a!1 ((_ to_fp_unsigned 11 53)
             ...
             (bvadd #x00000001 (bvsub (bvsdiv a_ack!478 #x00000002) b_ack!477)))))
