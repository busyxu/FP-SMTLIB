(declare-fun mu_ack!659 () (_ BitVec 64))
(declare-fun x_ack!660 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (fp.gt ((_ to_fp 11 53) mu_ack!659) ((_ to_fp 11 53) #x403e000000000000)))
(assert (fp.lt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!660)
               ((_ to_fp 11 53) x_ack!660))
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x4024000000000000)
               ((_ to_fp 11 53) mu_ack!659))))
(assert (fp.lt ((_ to_fp 11 53) x_ack!660) ((_ to_fp 11 53) #x0000000000000000)))
