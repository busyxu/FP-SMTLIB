...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!1060) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!1060) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1060) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!1060) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!3 (fp.abs (fp.div roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4000000000000000)
                                   a!2)))))
  (FPCHECK_FMUL_OVERFLOW #x3fe0000000000000 a!3)))))
