...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!2238) ((_ to_fp 11 53) #x3fa999999999999a))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!2238) ((_ to_fp 11 53) #x3fee666666666666))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2238) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) x_ack!2238) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!5 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4000000000000000)
                 a!4))))))))
(assert (FPCHECK_FSUB_OVERFLOW a_ack!2237 #x3ff0000000000000))
