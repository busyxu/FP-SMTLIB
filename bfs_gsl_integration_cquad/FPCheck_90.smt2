...
(declare-fun epsrel_ack!717 () (_ BitVec 64))
...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!716)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!717)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) epsabs_ack!716) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!717)
