(declare-fun epsabs_ack!780 () (_ BitVec 64))
(declare-fun epsrel_ack!781 () (_ BitVec 64))
(declare-fun a_ack!782 () (_ BitVec 64))
(declare-fun b_ack!779 () (_ BitVec 64))
(declare-fun CF_log ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!780)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!781)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!780)
             ((_ to_fp 11 53) #x0000000000000000))))
