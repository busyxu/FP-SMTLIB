(declare-fun epsabs_ack!1996 () (_ BitVec 64))
(declare-fun epsrel_ack!1997 () (_ BitVec 64))
...
(declare-fun FPCHECK_FINVALID_LOG
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!1996)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) epsrel_ack!1997)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) epsabs_ack!1996)
             ((_ to_fp 11 53) #x0000000000000000))))
