...
(declare-fun x_initial_ack!878 () (_ BitVec 64))
...
(assert (let ((a!1 (CF_pow (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) x_initial_ack!878))
...
(let ((a!7 (CF_exp (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   (fp.sub roundNearestTiesToEven a!3 a!6))
                           ((_ to_fp 11 53) #x3f80624dd2f1a9fc)))))
  (not (fp.lt ((_ to_fp 11 53) #x3fd21668fdc00000) a!7)))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) x_initial_ack!878)))
                   ((_ to_fp 11 53) #x3ff0000000000000))))
  (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 (CF_pow a!1 #x4000000000000000))))
