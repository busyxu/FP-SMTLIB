...
(declare-fun x_initial_ack!1059 () (_ BitVec 64))
...
(assert (let ((a!1 (CF_pow (fp.sub roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) x_initial_ack!1059))
...
(let ((a!7 (CF_exp (fp.div roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   (fp.sub roundNearestTiesToEven a!4 a!6))
                           ((_ to_fp 11 53) #x3f80624dd2f1a9fc)))))
  (not (fp.lt ((_ to_fp 11 53) #x3fdf09cec5400000) a!7)))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fec9ef149800000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) #xbfdbd32e04800000)
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) #x3fed474d6dc00000) a!1)
    #x3ff0000000000000)))
