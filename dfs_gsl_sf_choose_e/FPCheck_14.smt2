...
(assert (not (bvult (bvsub a_ack!39 (bvsub a_ack!39 b_ack!38)) #x00000040)))
(assert (not (bvult a_ack!39 (bvsub a_ack!39 b_ack!38))))
(assert (not (= (bvsub a_ack!39 b_ack!38) a_ack!39)))
(assert (not (= #x00000000 (bvsub a_ack!39 b_ack!38))))
(assert (not (bvult a_ack!39 (bvmul #x00000002 (bvsub a_ack!39 b_ack!38)))))
(assert (not (bvule a_ack!39 #x000000aa)))
