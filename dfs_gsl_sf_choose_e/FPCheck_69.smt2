...
(assert (not (bvult (bvsub a_ack!201 (bvsub a_ack!201 b_ack!200)) #x00000040)))
(assert (not (bvult a_ack!201 (bvsub a_ack!201 b_ack!200))))
(assert (not (= (bvsub a_ack!201 b_ack!200) a_ack!201)))
(assert (not (= #x00000000 (bvsub a_ack!201 b_ack!200))))
(assert (bvult a_ack!201 (bvmul #x00000002 (bvsub a_ack!201 b_ack!200))))
(assert (not (bvule a_ack!201 #x000000aa)))
