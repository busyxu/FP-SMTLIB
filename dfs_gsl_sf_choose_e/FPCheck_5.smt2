...
(assert (not (bvult (bvsub a_ack!21 (bvsub a_ack!21 b_ack!20)) #x00000040)))
(assert (not (bvult a_ack!21 (bvsub a_ack!21 b_ack!20))))
(assert (not (= (bvsub a_ack!21 b_ack!20) a_ack!21)))
(assert (not (= #x00000000 (bvsub a_ack!21 b_ack!20))))
(assert (not (bvult a_ack!21 (bvmul #x00000002 (bvsub a_ack!21 b_ack!20)))))
(assert (not (bvule a_ack!21 #x000000aa)))
