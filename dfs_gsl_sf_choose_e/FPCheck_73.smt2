...
(assert (not (bvult (bvsub a_ack!215 (bvsub a_ack!215 b_ack!214)) #x00000040)))
(assert (not (bvult a_ack!215 (bvsub a_ack!215 b_ack!214))))
(assert (not (= (bvsub a_ack!215 b_ack!214) a_ack!215)))
(assert (not (= #x00000000 (bvsub a_ack!215 b_ack!214))))
(assert (bvult a_ack!215 (bvmul #x00000002 (bvsub a_ack!215 b_ack!214))))
(assert (not (bvule a_ack!215 #x000000aa)))
