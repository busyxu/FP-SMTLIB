...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!511 b_ack!510)))
(assert (not (= b_ack!510 a_ack!511)))
(assert (not (= #x00000000 b_ack!510)))
(assert (not (bvule a_ack!511 #x000000aa)))
(assert (not (bvult (bvmul #x00000002 b_ack!510) a_ack!511)))
(assert (not (bvult (bvsub a_ack!511 b_ack!510) #x00000040)))
(assert (not (bvult a_ack!511 b_ack!510)))
(assert (not (= b_ack!510 a_ack!511)))
(assert (not (= #x00000000 b_ack!510)))
(assert (not (bvult a_ack!511 (bvmul #x00000002 b_ack!510))))
(assert (not (bvule a_ack!511 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!511)
                ((_ to_fp 11 53) #x3ff0000000000000))
