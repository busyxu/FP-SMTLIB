...
(assert (not (bvult (bvsub a_ack!223 (bvsub a_ack!223 b_ack!222)) #x00000040)))
(assert (not (bvult a_ack!223 (bvsub a_ack!223 b_ack!222))))
(assert (not (= (bvsub a_ack!223 b_ack!222) a_ack!223)))
(assert (not (= #x00000000 (bvsub a_ack!223 b_ack!222))))
(assert (bvult a_ack!223 (bvmul #x00000002 (bvsub a_ack!223 b_ack!222))))
(assert (not (bvule a_ack!223 #x000000aa)))
