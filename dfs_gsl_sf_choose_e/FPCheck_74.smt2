...
(assert (not (bvult (bvsub a_ack!217 (bvsub a_ack!217 b_ack!216)) #x00000040)))
(assert (not (bvult a_ack!217 (bvsub a_ack!217 b_ack!216))))
(assert (not (= (bvsub a_ack!217 b_ack!216) a_ack!217)))
(assert (not (= #x00000000 (bvsub a_ack!217 b_ack!216))))
(assert (bvult a_ack!217 (bvmul #x00000002 (bvsub a_ack!217 b_ack!216))))
(assert (not (bvule a_ack!217 #x000000aa)))
