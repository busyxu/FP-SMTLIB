...
(assert (not (bvult (bvsub a_ack!203 (bvsub a_ack!203 b_ack!202)) #x00000040)))
(assert (not (bvult a_ack!203 (bvsub a_ack!203 b_ack!202))))
(assert (not (= (bvsub a_ack!203 b_ack!202) a_ack!203)))
(assert (not (= #x00000000 (bvsub a_ack!203 b_ack!202))))
(assert (bvult a_ack!203 (bvmul #x00000002 (bvsub a_ack!203 b_ack!202))))
(assert (not (bvule a_ack!203 #x000000aa)))
