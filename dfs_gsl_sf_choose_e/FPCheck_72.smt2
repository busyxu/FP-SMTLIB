...
(assert (not (bvult (bvsub a_ack!209 (bvsub a_ack!209 b_ack!208)) #x00000040)))
(assert (not (bvult a_ack!209 (bvsub a_ack!209 b_ack!208))))
(assert (not (= (bvsub a_ack!209 b_ack!208) a_ack!209)))
(assert (not (= #x00000000 (bvsub a_ack!209 b_ack!208))))
(assert (bvult a_ack!209 (bvmul #x00000002 (bvsub a_ack!209 b_ack!208))))
(assert (not (bvule a_ack!209 #x000000aa)))
