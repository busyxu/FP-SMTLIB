...
(assert (bvult (bvmul #x00000002 b_ack!218) a_ack!219))
(assert (not (bvult (bvsub a_ack!219 (bvsub a_ack!219 b_ack!218)) #x00000040)))
(assert (not (bvult a_ack!219 (bvsub a_ack!219 b_ack!218))))
(assert (not (= (bvsub a_ack!219 b_ack!218) a_ack!219)))
(assert (not (= #x00000000 (bvsub a_ack!219 b_ack!218))))
(assert (bvult a_ack!219 (bvmul #x00000002 (bvsub a_ack!219 b_ack!218))))
(assert (not (bvule a_ack!219 #x000000aa)))
