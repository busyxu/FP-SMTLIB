...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!517 b_ack!516)))
(assert (not (= b_ack!516 a_ack!517)))
(assert (not (= #x00000000 b_ack!516)))
(assert (not (bvule a_ack!517 #x000000aa)))
(assert (not (bvult (bvmul #x00000002 b_ack!516) a_ack!517)))
(assert (not (bvult (bvsub a_ack!517 b_ack!516) #x00000040)))
(assert (not (bvult a_ack!517 b_ack!516)))
(assert (not (= b_ack!516 a_ack!517)))
(assert (not (= #x00000000 b_ack!516)))
(assert (not (bvult a_ack!517 (bvmul #x00000002 b_ack!516))))
(assert (not (bvule a_ack!517 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!517)
                ((_ to_fp 11 53) #x3ff0000000000000))
