...
(assert (not (bvult (bvmul #x00000002 b_ack!526) a_ack!527)))
(assert (not (bvult (bvsub a_ack!527 b_ack!526) #x00000040)))
(assert (not (bvult a_ack!527 b_ack!526)))
(assert (not (= b_ack!526 a_ack!527)))
(assert (not (= #x00000000 b_ack!526)))
(assert (not (bvult a_ack!527 (bvmul #x00000002 b_ack!526))))
(assert (not (bvule a_ack!527 #x000000aa)))
