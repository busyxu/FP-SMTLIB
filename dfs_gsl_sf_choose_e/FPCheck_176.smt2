...
(assert (not (bvult a_ack!523 b_ack!522)))
(assert (not (= b_ack!522 a_ack!523)))
(assert (not (= #x00000000 b_ack!522)))
(assert (not (bvule a_ack!523 #x000000aa)))
(assert (not (bvult (bvmul #x00000002 b_ack!522) a_ack!523)))
(assert (not (bvult (bvsub a_ack!523 b_ack!522) #x00000040)))
(assert (not (bvult a_ack!523 b_ack!522)))
(assert (not (= b_ack!522 a_ack!523)))
(assert (not (= #x00000000 b_ack!522)))
(assert (not (bvult a_ack!523 (bvmul #x00000002 b_ack!522))))
(assert (not (bvule a_ack!523 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!523)
                ((_ to_fp 11 53) #x3ff0000000000000))
