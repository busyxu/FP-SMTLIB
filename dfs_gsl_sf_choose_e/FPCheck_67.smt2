...
(assert (not (bvult (bvsub a_ack!197 (bvsub a_ack!197 b_ack!196)) #x00000040)))
(assert (not (bvult a_ack!197 (bvsub a_ack!197 b_ack!196))))
(assert (not (= (bvsub a_ack!197 b_ack!196) a_ack!197)))
(assert (not (= #x00000000 (bvsub a_ack!197 b_ack!196))))
(assert (bvult a_ack!197 (bvmul #x00000002 (bvsub a_ack!197 b_ack!196))))
(assert (not (bvule a_ack!197 #x000000aa)))
