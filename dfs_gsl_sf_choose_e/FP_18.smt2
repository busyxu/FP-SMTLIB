...
(assert (not (bvult (bvsub a_ack!191 (bvsub a_ack!191 b_ack!190)) #x00000040)))
(assert (not (bvult a_ack!191 (bvsub a_ack!191 b_ack!190))))
(assert (not (= (bvsub a_ack!191 b_ack!190) a_ack!191)))
(assert (not (= #x00000000 (bvsub a_ack!191 b_ack!190))))
(assert (bvult a_ack!191 (bvmul #x00000002 (bvsub a_ack!191 b_ack!190))))
(assert (not (bvule a_ack!191 #x000000aa)))
