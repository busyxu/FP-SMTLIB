(declare-fun p0_ack!7862 () (_ BitVec 64))
(declare-fun x0_ack!7858 () (_ BitVec 64))
(declare-fun p2_ack!7857 () (_ BitVec 64))
(declare-fun p1_ack!7856 () (_ BitVec 64))
(declare-fun x1_ack!7859 () (_ BitVec 64))
(declare-fun step_size_ack!7860 () (_ BitVec 64))
(declare-fun epsabs_ack!7861 () (_ BitVec 64))
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!7857))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7858)
                                  ((_ to_fp 11 53) p0_ack!7862)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7860))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!7861)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!31 (fp.abs (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!30
                                    ((_ to_fp 11 53) p0_ack!7862))))))
  (not (not (fp.eq a!31 ((_ to_fp 11 53) #x0000000000000000))))))))))))))))))))))))
