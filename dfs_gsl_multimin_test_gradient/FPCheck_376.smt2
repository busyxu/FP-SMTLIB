(declare-fun p0_ack!4243 () (_ BitVec 64))
(declare-fun x0_ack!4239 () (_ BitVec 64))
(declare-fun p2_ack!4238 () (_ BitVec 64))
(declare-fun p1_ack!4237 () (_ BitVec 64))
(declare-fun x1_ack!4240 () (_ BitVec 64))
(declare-fun step_size_ack!4241 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!4238))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4239)
                                  ((_ to_fp 11 53) p0_ack!4243)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4241))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!4242)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) p2_ack!4238)
            (fp.sub roundNearestTiesToEven a!11 ((_ to_fp 11 53) p0_ack!4243)))
    (fp.sub roundNearestTiesToEven a!11 ((_ to_fp 11 53) p0_ack!4243))))))))))))
