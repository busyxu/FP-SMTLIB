(declare-fun p0_ack!5706 () (_ BitVec 64))
(declare-fun x0_ack!5702 () (_ BitVec 64))
(declare-fun p2_ack!5701 () (_ BitVec 64))
(declare-fun p1_ack!5700 () (_ BitVec 64))
(declare-fun x1_ack!5703 () (_ BitVec 64))
(declare-fun step_size_ack!5704 () (_ BitVec 64))
(declare-fun epsabs_ack!5705 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5701))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5702)
                                  ((_ to_fp 11 53) p0_ack!5706)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5704))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!5705)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!18 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    p2_ack!5701
    (fp.sub roundNearestTiesToEven a!18 ((_ to_fp 11 53) p0_ack!5706))))))))))))))))
