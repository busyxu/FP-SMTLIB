(declare-fun p0_ack!6021 () (_ BitVec 64))
(declare-fun x0_ack!6017 () (_ BitVec 64))
(declare-fun p2_ack!6016 () (_ BitVec 64))
(declare-fun p1_ack!6015 () (_ BitVec 64))
(declare-fun x1_ack!6018 () (_ BitVec 64))
(declare-fun step_size_ack!6019 () (_ BitVec 64))
(declare-fun epsabs_ack!6020 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!6016))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6017)
                                  ((_ to_fp 11 53) p0_ack!6021)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!6018)
                                  ((_ to_fp 11 53) p1_ack!6015)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6019))
