(declare-fun p0_ack!3004 () (_ BitVec 64))
(declare-fun x0_ack!3000 () (_ BitVec 64))
(declare-fun p2_ack!2999 () (_ BitVec 64))
(declare-fun p1_ack!2998 () (_ BitVec 64))
(declare-fun x1_ack!3001 () (_ BitVec 64))
(declare-fun step_size_ack!3002 () (_ BitVec 64))
(declare-fun epsabs_ack!3003 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!2999))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3000)
                                  ((_ to_fp 11 53) p0_ack!3004)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!3001)
                                  ((_ to_fp 11 53) p1_ack!2998)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3002))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!3003)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!12 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!11
                            ((_ to_fp 11 53) p0_ack!3004)))))
  (fp.geq (fp.abs a!12) ((_ to_fp 11 53) #x0010000000000000))))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) p2_ack!2999))
...
(let ((a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    (fp.mul roundNearestTiesToEven a!11 a!1)))))
      ...
      (a!19 (fp.abs (fp.mul roundNearestTiesToEven
                            a!18
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) step_size_ack!3002)
                                    ((_ to_fp 11 53) #x4000000000000000))))))
