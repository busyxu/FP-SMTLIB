(declare-fun p0_ack!2409 () (_ BitVec 64))
(declare-fun x0_ack!2405 () (_ BitVec 64))
(declare-fun p2_ack!2404 () (_ BitVec 64))
(declare-fun p1_ack!2403 () (_ BitVec 64))
(declare-fun x1_ack!2406 () (_ BitVec 64))
(declare-fun step_size_ack!2407 () (_ BitVec 64))
(declare-fun epsabs_ack!2408 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!2404))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!2405)
                                  ((_ to_fp 11 53) p0_ack!2409)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!2407))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!2408)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    p2_ack!2404
    (fp.sub roundNearestTiesToEven a!11 ((_ to_fp 11 53) p0_ack!2409))))))))))))
