(declare-fun p0_ack!5104 () (_ BitVec 64))
(declare-fun x0_ack!5100 () (_ BitVec 64))
(declare-fun p2_ack!5099 () (_ BitVec 64))
(declare-fun p1_ack!5098 () (_ BitVec 64))
(declare-fun x1_ack!5101 () (_ BitVec 64))
(declare-fun step_size_ack!5102 () (_ BitVec 64))
(declare-fun epsabs_ack!5103 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!5099))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5100)
                                  ((_ to_fp 11 53) p0_ack!5104)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5102))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!5103)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!12 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!11
                                    ((_ to_fp 11 53) p0_ack!5104))))))
  (FPCHECK_FADD_ACCURACY #x0000000000000000 a!12)))))))))))
