(declare-fun p0_ack!3340 () (_ BitVec 64))
(declare-fun x0_ack!3336 () (_ BitVec 64))
(declare-fun p2_ack!3335 () (_ BitVec 64))
(declare-fun p1_ack!3334 () (_ BitVec 64))
(declare-fun x1_ack!3337 () (_ BitVec 64))
(declare-fun step_size_ack!3338 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!3335))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!3336)
                                  ((_ to_fp 11 53) p0_ack!3340)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!3337)
                                  ((_ to_fp 11 53) p1_ack!3334)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!3338))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!3339)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
