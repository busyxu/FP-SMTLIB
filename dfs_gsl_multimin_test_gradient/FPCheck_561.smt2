(declare-fun p0_ack!6728 () (_ BitVec 64))
(declare-fun x0_ack!6724 () (_ BitVec 64))
(declare-fun p2_ack!6723 () (_ BitVec 64))
(declare-fun p1_ack!6722 () (_ BitVec 64))
(declare-fun x1_ack!6725 () (_ BitVec 64))
(declare-fun step_size_ack!6726 () (_ BitVec 64))
(declare-fun epsabs_ack!6727 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!6723))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6724)
                                  ((_ to_fp 11 53) p0_ack!6728)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!6725)
                                  ((_ to_fp 11 53) p1_ack!6722)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6726))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6727)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!12 (not (fp.eq a!11
                        (fp.add roundNearestTiesToEven
                                ...
                                ((_ to_fp 11 53) #x0000000000000000))))))
  (not a!12)))))))))))
(assert (FPCHECK_FMUL_ACCURACY #x4000000000000000 p2_ack!6723))
