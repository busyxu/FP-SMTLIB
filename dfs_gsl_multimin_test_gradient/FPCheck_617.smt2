(declare-fun p0_ack!7414 () (_ BitVec 64))
(declare-fun x0_ack!7410 () (_ BitVec 64))
(declare-fun p2_ack!7409 () (_ BitVec 64))
(declare-fun p1_ack!7408 () (_ BitVec 64))
(declare-fun x1_ack!7411 () (_ BitVec 64))
(declare-fun step_size_ack!7412 () (_ BitVec 64))
(declare-fun epsabs_ack!7413 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!7409))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7410)
                                  ((_ to_fp 11 53) p0_ack!7414)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7412))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!7413)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!31 (fp.mul roundNearestTiesToEven
      ...
      (a!34 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!33
                            ((_ to_fp 11 53) p1_ack!7408)))))
  (FPCHECK_FADD_OVERFLOW a!31 a!34)))))))))))))))))))))
