(declare-fun p0_ack!4985 () (_ BitVec 64))
(declare-fun x0_ack!4981 () (_ BitVec 64))
(declare-fun p2_ack!4980 () (_ BitVec 64))
(declare-fun p1_ack!4979 () (_ BitVec 64))
(declare-fun x1_ack!4982 () (_ BitVec 64))
(declare-fun step_size_ack!4983 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!4980))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!4981)
                                  ((_ to_fp 11 53) p0_ack!4985)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!4982)
                                  ((_ to_fp 11 53) p1_ack!4979)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!4983))
  ...
  (FPCHECK_FMUL_ACCURACY
    ...
    (fp.mul roundNearestTiesToEven
            (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53) #x4000000000000000)
                    ((_ to_fp 11 53) p2_ack!4980))
            (fp.sub roundNearestTiesToEven a!11 ((_ to_fp 11 53) p0_ack!4985)))))))))))))
