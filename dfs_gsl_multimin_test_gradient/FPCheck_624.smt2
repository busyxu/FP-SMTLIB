(declare-fun p0_ack!7498 () (_ BitVec 64))
(declare-fun x0_ack!7494 () (_ BitVec 64))
(declare-fun p2_ack!7493 () (_ BitVec 64))
(declare-fun p1_ack!7492 () (_ BitVec 64))
(declare-fun x1_ack!7495 () (_ BitVec 64))
(declare-fun step_size_ack!7496 () (_ BitVec 64))
(declare-fun epsabs_ack!7497 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW ((_ BitVec 64) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!7493))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7494)
                                  ((_ to_fp 11 53) p0_ack!7498)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!7495)
                                  ((_ to_fp 11 53) p1_ack!7492)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7496))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!7497)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!31 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.geq (fp.add roundNearestTiesToEven
               ...
               (fp.add roundNearestTiesToEven
                       (fp.add roundNearestTiesToEven a!25 a!26)
                       ((_ to_fp 11 53) #x0000000000000000))))))))))))))))))))))))
(assert (FPCHECK_FMUL_UNDERFLOW #x4000000000000000 p2_ack!7493))
