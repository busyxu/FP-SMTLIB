(declare-fun p0_ack!1438 () (_ BitVec 64))
(declare-fun x0_ack!1435 () (_ BitVec 64))
(declare-fun p2_ack!1434 () (_ BitVec 64))
(declare-fun p1_ack!1433 () (_ BitVec 64))
(declare-fun x1_ack!1436 () (_ BitVec 64))
(declare-fun step_size_ack!1437 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!1434))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!1435)
                                  ((_ to_fp 11 53) p0_ack!1438)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!1437))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x0000000000000000)
                                   (fp.mul roundNearestTiesToEven a!4 a!1))))))
  (FPCHECK_FSUB_OVERFLOW a!5 p0_ack!1438))))))
