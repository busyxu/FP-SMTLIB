(declare-fun p0_ack!6140 () (_ BitVec 64))
(declare-fun x0_ack!6136 () (_ BitVec 64))
(declare-fun p2_ack!6135 () (_ BitVec 64))
(declare-fun p1_ack!6134 () (_ BitVec 64))
(declare-fun x1_ack!6137 () (_ BitVec 64))
(declare-fun step_size_ack!6138 () (_ BitVec 64))
(declare-fun epsabs_ack!6139 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!6135))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6136)
                                  ((_ to_fp 11 53) p0_ack!6140)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!6137)
                                  ((_ to_fp 11 53) p1_ack!6134)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6138))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6139)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
      ...
      (a!14 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    a!13
                                    ((_ to_fp 11 53) p1_ack!6134))))))
(let ((a!15 (fp.geq (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x0000000000000000)
                                    a!12)
                            a!14)
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            a!14)
    (fp.div roundNearestTiesToEven
            ((_ to_fp 11 53) (ite a!15 #x3ff0000000000000 #xbff0000000000000))
            (fp.mul roundNearestTiesToEven
                    (fp.abs a!1)
                    ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))))
