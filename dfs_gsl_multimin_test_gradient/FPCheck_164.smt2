(declare-fun p0_ack!1540 () (_ BitVec 64))
(declare-fun x0_ack!1537 () (_ BitVec 64))
(declare-fun p2_ack!1536 () (_ BitVec 64))
(declare-fun p1_ack!1535 () (_ BitVec 64))
(declare-fun x1_ack!1538 () (_ BitVec 64))
(declare-fun step_size_ack!1539 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!1536))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!1537)
                                  ((_ to_fp 11 53) p0_ack!1540)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!1539))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x0000000000000000)
                                   (fp.mul roundNearestTiesToEven a!4 a!2))))))
  (FPCHECK_FSUB_UNDERFLOW a!5 p1_ack!1535))))))
