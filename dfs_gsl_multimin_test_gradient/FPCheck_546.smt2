(declare-fun p0_ack!6518 () (_ BitVec 64))
(declare-fun x0_ack!6514 () (_ BitVec 64))
(declare-fun p2_ack!6513 () (_ BitVec 64))
(declare-fun p1_ack!6512 () (_ BitVec 64))
(declare-fun x1_ack!6515 () (_ BitVec 64))
(declare-fun step_size_ack!6516 () (_ BitVec 64))
(declare-fun epsabs_ack!6517 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!6513))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!6514)
                                  ((_ to_fp 11 53) p0_ack!6518)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!6516))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!6517)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!28 (fp.div roundNearestTiesToEven
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.abs (fp.mul roundNearestTiesToEven a!18 a!1)))
                    a!27)))
  (FPCHECK_FSUB_ACCURACY #x8000000000000000 a!28))))))))))))))))))
