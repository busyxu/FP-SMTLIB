(declare-fun p0_ack!7148 () (_ BitVec 64))
(declare-fun x0_ack!7144 () (_ BitVec 64))
(declare-fun p2_ack!7143 () (_ BitVec 64))
(declare-fun p1_ack!7142 () (_ BitVec 64))
(declare-fun x1_ack!7145 () (_ BitVec 64))
(declare-fun step_size_ack!7146 () (_ BitVec 64))
(declare-fun epsabs_ack!7147 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!7143))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!7144)
                                  ((_ to_fp 11 53) p0_ack!7148)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!7146))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!7147)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!30 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    p2_ack!7143
    (fp.sub roundNearestTiesToEven a!30 ((_ to_fp 11 53) p0_ack!7148))))))))))))))))))))))
