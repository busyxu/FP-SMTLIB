(declare-fun p0_ack!1462 () (_ BitVec 64))
(declare-fun x0_ack!1459 () (_ BitVec 64))
(declare-fun p2_ack!1458 () (_ BitVec 64))
(declare-fun p1_ack!1457 () (_ BitVec 64))
(declare-fun x1_ack!1460 () (_ BitVec 64))
(declare-fun step_size_ack!1461 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x4000000000000000)
                                  ((_ to_fp 11 53) p2_ack!1458))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!1459)
                                  ((_ to_fp 11 53) p0_ack!1462)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!1461))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x0000000000000000)
                                   (fp.mul roundNearestTiesToEven a!4 a!1))))))
  (FPCHECK_FSUB_ACCURACY a!5 p0_ack!1462))))))
