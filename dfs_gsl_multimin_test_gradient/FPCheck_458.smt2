(declare-fun p0_ack!5300 () (_ BitVec 64))
(declare-fun x0_ack!5296 () (_ BitVec 64))
(declare-fun p2_ack!5295 () (_ BitVec 64))
(declare-fun p1_ack!5294 () (_ BitVec 64))
(declare-fun x1_ack!5297 () (_ BitVec 64))
(declare-fun step_size_ack!5298 () (_ BitVec 64))
(declare-fun epsabs_ack!5299 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5295))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5296)
                                  ((_ to_fp 11 53) p0_ack!5300)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!5297)
                                  ((_ to_fp 11 53) p1_ack!5294)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5298))
...
(let ((a!6 (fp.mul roundNearestTiesToEven
  ...
  (fp.lt (fp.add roundNearestTiesToEven
         ...
         (fp.add roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x0000000000000000)))))))))
(assert (not (fp.lt ((_ to_fp 11 53) epsabs_ack!5299)
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
...
(let ((a!16 (fp.geq (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    a!1
    (fp.div roundNearestTiesToEven
            ((_ to_fp 11 53) (ite a!16 #x3ff0000000000000 #xbff0000000000000))
            (fp.mul roundNearestTiesToEven
                    (fp.abs a!2)
                    ((_ to_fp 11 53) #x3ff0000000000000)))))))))))))))
