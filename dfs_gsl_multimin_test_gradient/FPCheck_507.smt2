(declare-fun p0_ack!5937 () (_ BitVec 64))
(declare-fun x0_ack!5933 () (_ BitVec 64))
(declare-fun p2_ack!5932 () (_ BitVec 64))
(declare-fun p1_ack!5931 () (_ BitVec 64))
(declare-fun x1_ack!5934 () (_ BitVec 64))
(declare-fun step_size_ack!5935 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          (fp.mul roundNearestTiesToEven
                                  ...
                                  ((_ to_fp 11 53) p2_ack!5932))
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x0_ack!5933)
                                  ((_ to_fp 11 53) p0_ack!5937)))
...
(assert (let ((a!1 (fp.eq (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x0000000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) x1_ack!5934)
                                  ((_ to_fp 11 53) p1_ack!5931)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not (not a!1))))
(assert (let ((a!1 (fp.abs (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) step_size_ack!5935))
...
(let ((a!19 (fp.mul roundNearestTiesToEven
      ...
      (a!21 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!20
                            ((_ to_fp 11 53) p1_ack!5931)))))
  (FPCHECK_FADD_OVERFLOW a!19 a!21)))))))))))))))
