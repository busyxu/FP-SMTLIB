...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!439) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!441) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!441) ((_ to_fp 11 53) b_ack!439))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!439))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!439))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!439) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!441))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!441) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!440))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!440))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!439) a!1))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!439)
                           ((_ to_fp 11 53) a_ack!441)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!439))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!439)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!439)
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!440))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!439)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!439)
               ((_ to_fp 11 53) a_ack!441))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!439)
       (fp.abs (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       ((_ to_fp 11 53) c_ack!440)))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
