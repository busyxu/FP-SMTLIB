...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!532) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!534) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!534) ((_ to_fp 11 53) b_ack!532))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!534))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!534) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!533))
       ((_ to_fp 11 53) #x40962e42fefa39ef)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!532) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!533))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!532) a!1))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!532)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!532)
                    ((_ to_fp 11 53) a_ack!534)))))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!532)
                           ((_ to_fp 11 53) a_ack!534)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!532))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!532)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!532)
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!533))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!532)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!532)
               ((_ to_fp 11 53) a_ack!534))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!532)
                  (fp.abs (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x8000000000000000)
                                  ((_ to_fp 11 53) c_ack!533))))))
  (not a!1)))
