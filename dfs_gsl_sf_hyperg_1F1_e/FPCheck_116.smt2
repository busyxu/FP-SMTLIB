...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!541) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!543) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!543) ((_ to_fp 11 53) b_ack!541))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!543))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!543) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!542))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!541) a!1))))
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!542))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!541)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!541)
               ((_ to_fp 11 53) a_ack!543))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!541)
                  (fp.abs (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x8000000000000000)
                                  ((_ to_fp 11 53) c_ack!542))))))
  (not a!1)))
