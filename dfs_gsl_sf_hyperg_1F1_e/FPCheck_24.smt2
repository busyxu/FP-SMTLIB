...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!67) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!69) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!69) ((_ to_fp 11 53) b_ack!67))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!67)) ((_ to_fp 11 53) #x3d19000000000000)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!69))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!67)) ((_ to_fp 11 53) #x3d19000000000000)))
(assert (FPCHECK_FMUL_OVERFLOW c_ack!68 a_ack!69))
