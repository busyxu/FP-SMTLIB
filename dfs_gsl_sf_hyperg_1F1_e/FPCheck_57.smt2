...
(assert (fp.lt ((_ to_fp 11 53) a_ack!282) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!282))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!282) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!281))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!281))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!280) a!1))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!280)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!280)
                    ((_ to_fp 11 53) a_ack!282)))))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
