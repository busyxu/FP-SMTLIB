...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!91) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!93) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!93) ((_ to_fp 11 53) b_ack!91))))
