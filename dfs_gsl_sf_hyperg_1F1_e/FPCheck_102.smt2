...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!463) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!465) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!465) ((_ to_fp 11 53) b_ack!463))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!465))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!464))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!463) a!1))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!463)
                           ((_ to_fp 11 53) a_ack!465)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!463))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!463)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!463)
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!464))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!463)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!463)
               ((_ to_fp 11 53) a_ack!465))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!463)
       (fp.abs (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       ((_ to_fp 11 53) c_ack!464)))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven a!1 (CF_floor a!1))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (FPCHECK_FSUB_OVERFLOW b_ack!463 a!2))))
