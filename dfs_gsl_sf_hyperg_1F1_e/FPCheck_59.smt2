...
(assert (fp.lt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!288))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!288) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!287))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!287))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!286) a!1))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!286)
            (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) b_ack!286)
                    ((_ to_fp 11 53) a_ack!288)))))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!286)
                           ((_ to_fp 11 53) a_ack!288)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!286))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!286)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!286)
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!286)
       (fp.abs (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       ((_ to_fp 11 53) c_ack!287)))))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
