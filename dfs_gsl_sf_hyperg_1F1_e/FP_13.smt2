...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!247) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!249) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!249) ((_ to_fp 11 53) b_ack!247))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!247))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!247))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!247) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!249))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!249) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!248))
       ((_ to_fp 11 53) #x40962e42fefa39ef)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!247) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!248))))))
  (fp.gt ((_ to_fp 11 53) b_ack!247) a!1)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!247) ((_ to_fp 11 53) #x0000000000000000))))
