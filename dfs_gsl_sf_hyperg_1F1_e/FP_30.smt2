...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!586) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!588) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!588) ((_ to_fp 11 53) b_ack!586))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!588))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!586) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!587))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!586) a!1))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!586)
                           ((_ to_fp 11 53) a_ack!588)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!586))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!586)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!586)
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!587))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!586)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!586)
               ((_ to_fp 11 53) a_ack!588))))
(assert (let ((a!1 (fp.gt ((_ to_fp 11 53) b_ack!586)
                  (fp.abs (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) #x8000000000000000)
                                  ((_ to_fp 11 53) c_ack!587))))))
  (not a!1)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven a!1 (CF_floor a!1))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
  (not (fp.eq a!2 ((_ to_fp 11 53) #x3ff0000000000000))))))
