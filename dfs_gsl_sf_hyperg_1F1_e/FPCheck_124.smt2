...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!574) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) b_ack!574))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!576))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!574) ((_ to_fp 11 53) #x4024000000000000))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!574)
                           ((_ to_fp 11 53) a_ack!576)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!574))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!574)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!574)
...
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) c_ack!575))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) b_ack!574)
       (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) b_ack!574)
               ((_ to_fp 11 53) a_ack!576))))
...
(assert (fp.geq ((_ to_fp 11 53) b_ack!574) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (FPCHECK_FADD_UNDERFLOW b_ack!574 #x3fb999999999999a))
