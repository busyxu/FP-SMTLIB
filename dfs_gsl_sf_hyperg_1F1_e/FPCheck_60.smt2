...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!289) ((_ to_fp 11 53) #xbfb999999999999a))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!291) ((_ to_fp 11 53) #xbfb999999999999a)))
...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!291) ((_ to_fp 11 53) b_ack!289))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!289))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!289))
            ((_ to_fp 11 53) #x3d19000000000000))))
(assert (fp.gt ((_ to_fp 11 53) b_ack!289) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) #xbff0000000000000) ((_ to_fp 11 53) a_ack!291))))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.abs (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x8000000000000000)
                                   ((_ to_fp 11 53) c_ack!290))))))
  (not (fp.gt ((_ to_fp 11 53) b_ack!289) a!1))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!289)
                           ((_ to_fp 11 53) a_ack!291)))))
  (fp.eq a!1 ((_ to_fp 11 53) b_ack!289))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 11 53) b_ack!289)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!289)
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!289)
       (fp.abs (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) #x8000000000000000)
                       ((_ to_fp 11 53) c_ack!290)))))
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
