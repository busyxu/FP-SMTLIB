...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1185))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1185))
...
(let ((a!9 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    a!9
    (fp.mul roundNearestTiesToEven a!10 (fp.mul roundNearestTiesToEven a!3 a!5))))))))))
