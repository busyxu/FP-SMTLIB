...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1193))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1193))
...
(let ((a!7 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
  ...
  (not a!7)))))))
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 b_ack!1193))
