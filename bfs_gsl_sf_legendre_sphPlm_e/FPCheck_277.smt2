...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq (fp.add roundNearestTiesToEven
                     ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)
...
(assert (not (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)))))
(assert (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)
       ((_ to_fp 11 53) #x4000000000000000)))
(assert (fp.gt (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               (CF_log ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)))
       ((_ to_fp 11 53) #x3fb999999999999a)))
(assert (not (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!1368)
