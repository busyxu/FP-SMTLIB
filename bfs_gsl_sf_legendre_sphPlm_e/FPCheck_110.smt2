...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!520) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!520) ((_ to_fp 11 53) #xbff0000000000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!519)
             ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FADD_ACCURACY
  ((_ to_fp 11 53) roundNearestTiesToEven b_ack!519)
  #x3fe0000000000000))
