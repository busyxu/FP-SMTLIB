...
(assert (not (= #x00000000 b_ack!270)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!271) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!271) ((_ to_fp 11 53) #xbff0000000000000))))
