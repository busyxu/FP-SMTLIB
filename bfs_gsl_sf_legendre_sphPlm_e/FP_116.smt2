...
(assert (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
       (fp.mul roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313))))
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)
...
(assert (not (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)
            ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)
            ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)
        ((_ to_fp 11 53) #x4065600000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)
            (CF_floor ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2313)))))
