...
(assert (fp.lt ((_ to_fp 11 53) b_ack!210) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) b_ack!210) (CF_floor b_ack!210))
                  #x00000001
                  #x00000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!212) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.leq ((_ to_fp 11 53) b_ack!210) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) c_ack!211))))
...
(assert (let ((a!1 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) a_ack!212)))))
  (not (fp.lt a!1 ((_ to_fp 11 53) #x3d4f400000000000)))))
(assert (fp.geq ((_ to_fp 11 53) a_ack!212) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) #x3ff0000000000000))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!211) ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.lt ((_ to_fp 11 53) c_ack!211) ((_ to_fp 11 53) #x3fefd70a3d70a3d7)))
