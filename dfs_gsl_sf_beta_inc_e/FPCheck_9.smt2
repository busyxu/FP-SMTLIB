...
(assert (fp.lt ((_ to_fp 11 53) b_ack!60) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) b_ack!60) (CF_floor b_ack!60))
                  #x00000001
                  #x00000000))))
...
(assert (FPCHECK_FSUB_OVERFLOW #x3ff0000000000000 b_ack!60))
