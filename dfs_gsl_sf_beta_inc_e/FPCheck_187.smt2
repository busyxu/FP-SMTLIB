...
(assert (fp.lt ((_ to_fp 11 53) b_ack!720) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) b_ack!720) (CF_floor b_ack!720))
                  #x00000001
                  #x00000000))))
...
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) c_ack!721))))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) #x3ff0000000000000))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!721) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!721) ((_ to_fp 11 53) #x3fefd70a3d70a3d7))))
...
(assert (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) b_ack!720)))
       ((_ to_fp 11 53) #x4024000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!721) ((_ to_fp 11 53) #xbfd0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!721) ((_ to_fp 11 53) #x3fe0000000000000))))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3ff0000000000000)
                           ((_ to_fp 11 53) b_ack!720)))))
  (FPCHECK_FADD_OVERFLOW a_ack!722 a!1)))
