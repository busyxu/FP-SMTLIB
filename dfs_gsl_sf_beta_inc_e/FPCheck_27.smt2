...
(assert (fp.lt ((_ to_fp 11 53) b_ack!138) ((_ to_fp 11 53) #x0000000000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.eq ((_ to_fp 11 53) b_ack!138) (CF_floor b_ack!138))
                  #x00000001
                  #x00000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!138) ((_ to_fp 11 53) #x0000000000000000)))
