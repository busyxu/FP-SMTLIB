...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!84) (CF_floor b_ack!84))
                  #x00000001
                  #x00000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!84) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.eq (fp.sub roundNearestTiesToEven
               ...
               (fp.sub roundNearestTiesToEven
                       ...
                       ((_ to_fp 11 53) b_ack!84)))
       ((_ to_fp 11 53) b_ack!84)))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!86 #x3ff0000000000000))
