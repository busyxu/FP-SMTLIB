...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!153) (CF_floor b_ack!153))
                  #x00000001
                  #x00000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!153) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.lt (fp.add roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) #x3ff0000000000000))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FSUB_UNDERFLOW c_ack!154 #x3ff0000000000000))
