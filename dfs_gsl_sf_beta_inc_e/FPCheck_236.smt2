...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.eq ((_ to_fp 11 53) b_ack!969) (CF_floor b_ack!969))
                  #x00000001
                  #x00000000))))
...
(assert (fp.leq ((_ to_fp 11 53) b_ack!969) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) c_ack!970))))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ...
                ((_ to_fp 11 53) #x3ff0000000000000))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.geq ((_ to_fp 11 53) c_ack!970) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!970) ((_ to_fp 11 53) #x3fefd70a3d70a3d7))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x4024000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!971))
