...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!251)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) b_ack!250)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!251) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.div roundNearestTiesToEven
                    ((_ to_fp 11 53) x_ack!251)
                    ((_ to_fp 11 53) b_ack!250))
            ((_ to_fp 11 53) a_ack!249))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!249) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!249) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) x_ack!251)
               ((_ to_fp 11 53) b_ack!250))
