...
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!53)
          ...
          (fp.eq ((_ to_fp 11 53) b_ack!52)
                 ((_ to_fp 11 53) #x0000000000000000)))))
(assert (not (fp.leq ((_ to_fp 11 53) x_ack!53) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (FPCHECK_FMUL_UNDERFLOW #x3fe0000000000000 a_ack!51))
