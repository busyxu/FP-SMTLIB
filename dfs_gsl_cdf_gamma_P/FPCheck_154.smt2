...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (not (and (fp.eq ((_ to_fp 11 53) x_ack!1121)
                 ((_ to_fp 11 53) #x0000000000000000))
          (fp.eq ((_ to_fp 11 53) b_ack!1120)
                 ((_ to_fp 11 53) #x0000000000000000)))))
...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!1119) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!1119) ((_ to_fp 11 53) #x4024000000000000)))
