(declare-fun t_ack!5391 () (_ BitVec 64))
(declare-fun t1_ack!5388 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5388)
                                  ((_ to_fp 11 53) t_ack!5391)))
...
(let ((a!50 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!42
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fd20240028afd67) a!50)))))))))))))))))))))))
