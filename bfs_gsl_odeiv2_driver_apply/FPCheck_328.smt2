(declare-fun t_ack!2559 () (_ BitVec 64))
(declare-fun t1_ack!2556 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!2556)
                                  ((_ to_fp 11 53) t_ack!2559)))
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbf9a1e28caf3b65c
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!2558) a!20))))))))))))
