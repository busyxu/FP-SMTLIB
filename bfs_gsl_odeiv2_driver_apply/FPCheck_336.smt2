...
(declare-fun t1_ack!2628 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2629 () (_ BitVec 64))
(declare-fun y1_ack!2630 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!2628)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2630))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2629)
                                   ((_ to_fp 11 53) y0_ack!2629))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!29 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!21
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3f8a4f6f83ae9731) a!29))))))))))))))))
