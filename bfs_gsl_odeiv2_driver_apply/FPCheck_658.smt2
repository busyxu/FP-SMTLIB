(declare-fun t_ack!5339 () (_ BitVec 64))
(declare-fun t1_ack!5336 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5337 () (_ BitVec 64))
(declare-fun y1_ack!5338 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5336)
                                  ((_ to_fp 11 53) t_ack!5339)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5338))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5337)
                                   ((_ to_fp 11 53) y0_ack!5337))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
