(declare-fun t_ack!4597 () (_ BitVec 64))
(declare-fun t1_ack!4594 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4594)
                                  ((_ to_fp 11 53) t_ack!4597)))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    #x8000000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4595) a!46)))))))))))))))))))))))
