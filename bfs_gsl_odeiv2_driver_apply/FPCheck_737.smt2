(declare-fun t_ack!5991 () (_ BitVec 64))
(declare-fun t1_ack!5988 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5990 () (_ BitVec 64))
(declare-fun y0_ack!5989 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5988)
                                  ((_ to_fp 11 53) t_ack!5991)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5990))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5989)
                                   ((_ to_fp 11 53) y0_ack!5989))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!51 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xc02abe3f2cbe1d36
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5990) a!51))))))))))))))))))))))))
