(declare-fun t_ack!1707 () (_ BitVec 64))
(declare-fun t1_ack!1704 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!1706 () (_ BitVec 64))
(declare-fun y0_ack!1705 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1704)
                                  ((_ to_fp 11 53) t_ack!1707)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1706))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1705)
                                   ((_ to_fp 11 53) y0_ack!1705))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
