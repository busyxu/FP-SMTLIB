(declare-fun t_ack!6063 () (_ BitVec 64))
(declare-fun t1_ack!6060 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!6061 () (_ BitVec 64))
(declare-fun y1_ack!6062 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!6060)
                                  ((_ to_fp 11 53) t_ack!6063)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!6062))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!6061)
                                   ((_ to_fp 11 53) y0_ack!6061))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!65 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    a!54
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x401489672d167d27) a!65))))))))))))))))))))))))))))
