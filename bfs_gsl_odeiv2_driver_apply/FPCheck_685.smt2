(declare-fun t_ack!5549 () (_ BitVec 64))
(declare-fun t1_ack!5546 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5548 () (_ BitVec 64))
(declare-fun y0_ack!5547 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5546)
                                  ((_ to_fp 11 53) t_ack!5549)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5548))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5547)
                                   ((_ to_fp 11 53) y0_ack!5547))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!55 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!5549))
                            a!54))))
  (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 a!55)))))))))))))))))))))))))
