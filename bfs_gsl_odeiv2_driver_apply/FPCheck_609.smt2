(declare-fun t_ack!4911 () (_ BitVec 64))
(declare-fun t1_ack!4908 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4908)
                                  ((_ to_fp 11 53) t_ack!4911)))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    #x4006c85fb0a3e9bf
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4910) a!34))))))))))))))))))
