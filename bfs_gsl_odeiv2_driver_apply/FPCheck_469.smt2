(declare-fun t_ack!3733 () (_ BitVec 64))
(declare-fun t1_ack!3730 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3732 () (_ BitVec 64))
(declare-fun y0_ack!3731 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3730)
                                  ((_ to_fp 11 53) t_ack!3733)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3732))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3731)
                                   ((_ to_fp 11 53) y0_ack!3731))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!37 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!3733))
                            a!36))))
  (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 a!37)))))))))))))))))))
