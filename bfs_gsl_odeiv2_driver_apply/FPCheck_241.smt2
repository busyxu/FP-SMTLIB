(declare-fun t_ack!1841 () (_ BitVec 64))
(declare-fun t1_ack!1838 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1838)
                                  ((_ to_fp 11 53) t_ack!1841)))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1839) a!16)
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1839) a!16)))))))))))
