(declare-fun t_ack!5593 () (_ BitVec 64))
(declare-fun t1_ack!5590 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!5592 () (_ BitVec 64))
(declare-fun y0_ack!5591 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5590)
                                  ((_ to_fp 11 53) t_ack!5593)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5592))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5591)
                                   ((_ to_fp 11 53) y0_ack!5591))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!55 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!5593))
                            a!54))))
  (FPCHECK_FMUL_OVERFLOW a!55 a!55)))))))))))))))))))))))))
