(declare-fun t_ack!4661 () (_ BitVec 64))
(declare-fun t1_ack!4658 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y0_ack!4659 () (_ BitVec 64))
(declare-fun y1_ack!4660 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4658)
                                  ((_ to_fp 11 53) t_ack!4661)))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4659) a!46)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!4659) a!46))
    #x3ff0000000000000))))))))))))))))))))))
