(declare-fun t_ack!3025 () (_ BitVec 64))
(declare-fun t1_ack!3022 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3023 () (_ BitVec 64))
(declare-fun y1_ack!3024 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3022)
                                  ((_ to_fp 11 53) t_ack!3025)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3024))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3023)
                                   ((_ to_fp 11 53) y0_ack!3023))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3023) a!30)
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3023) a!30)))))))))))))))))
