(declare-fun t_ack!5495 () (_ BitVec 64))
(declare-fun t1_ack!5492 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5493 () (_ BitVec 64))
(declare-fun y1_ack!5494 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5492)
                                  ((_ to_fp 11 53) t_ack!5495)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5494))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5493)
                                   ((_ to_fp 11 53) y0_ack!5493))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
