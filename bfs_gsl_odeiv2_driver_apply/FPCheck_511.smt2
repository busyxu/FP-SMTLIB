(declare-fun t_ack!4091 () (_ BitVec 64))
(declare-fun t1_ack!4088 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4090 () (_ BitVec 64))
(declare-fun y0_ack!4089 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4088)
                                  ((_ to_fp 11 53) t_ack!4091)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4090))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4089)
                                   ((_ to_fp 11 53) y0_ack!4089))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4090) a!35)))))))))))))))))))
