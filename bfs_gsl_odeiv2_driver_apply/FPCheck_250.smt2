(declare-fun t_ack!1917 () (_ BitVec 64))
(declare-fun t1_ack!1914 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!1915 () (_ BitVec 64))
(declare-fun y1_ack!1916 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1914)
                                  ((_ to_fp 11 53) t_ack!1917)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1916))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1915)
                                   ((_ to_fp 11 53) y0_ack!1915))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!24 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.sub roundNearestTiesToEven
            ((_ to_fp 11 53) #x8000000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1915) a!16))
    a!24))))))))))))
