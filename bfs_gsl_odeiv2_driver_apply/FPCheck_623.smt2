(declare-fun t_ack!5031 () (_ BitVec 64))
(declare-fun t1_ack!5028 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5030 () (_ BitVec 64))
(declare-fun y0_ack!5029 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5028)
                                  ((_ to_fp 11 53) t_ack!5031)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5030))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5029)
                                   ((_ to_fp 11 53) y0_ack!5029))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!51 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #x3fbfadbee9f5b0f4
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5030) a!51))))))))))))))))))))))))
