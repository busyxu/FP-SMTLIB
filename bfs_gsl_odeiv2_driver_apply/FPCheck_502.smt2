(declare-fun t_ack!4011 () (_ BitVec 64))
(declare-fun t1_ack!4008 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4009 () (_ BitVec 64))
(declare-fun y1_ack!4010 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4008)
                                  ((_ to_fp 11 53) t_ack!4011)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4010))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4009)
                                   ((_ to_fp 11 53) y0_ack!4009))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
