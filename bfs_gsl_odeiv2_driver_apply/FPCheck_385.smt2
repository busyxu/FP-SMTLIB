(declare-fun t_ack!3033 () (_ BitVec 64))
(declare-fun t1_ack!3030 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3030)
                                  ((_ to_fp 11 53) t_ack!3033)))
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3031) a!30)
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3031) a!30)))))))))))))))))
