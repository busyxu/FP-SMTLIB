(declare-fun t_ack!5303 () (_ BitVec 64))
(declare-fun t1_ack!5300 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!5301 () (_ BitVec 64))
(declare-fun y1_ack!5302 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5300)
                                  ((_ to_fp 11 53) t_ack!5303)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5302))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5301)
                                   ((_ to_fp 11 53) y0_ack!5301))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!39 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!30))
                    a!38)))
  (FPCHECK_FMUL_OVERFLOW #x4006c85fb0a3e9bf a!39)))))))))))))))))))
