(declare-fun t_ack!4327 () (_ BitVec 64))
(declare-fun t1_ack!4324 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!4325 () (_ BitVec 64))
(declare-fun y1_ack!4326 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4324)
                                  ((_ to_fp 11 53) t_ack!4327)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4326))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4325)
                                   ((_ to_fp 11 53) y0_ack!4325))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
