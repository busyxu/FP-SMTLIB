(declare-fun t_ack!1869 () (_ BitVec 64))
(declare-fun t1_ack!1866 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(declare-fun y0_ack!1867 () (_ BitVec 64))
(declare-fun y1_ack!1868 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!1866)
                                  ((_ to_fp 11 53) t_ack!1869)))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1867) a!16)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!1867) a!16))
    #x3ff0000000000000))))))))))
