(declare-fun t_ack!5331 () (_ BitVec 64))
(declare-fun t1_ack!5328 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5329 () (_ BitVec 64))
(declare-fun y1_ack!5330 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5328)
                                  ((_ to_fp 11 53) t_ack!5331)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5330))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5329)
                                   ((_ to_fp 11 53) y0_ack!5329))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!33))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x4006c85fb0a3e9bf) a!41))))))))))))))))))))
