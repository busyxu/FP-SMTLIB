(declare-fun t_ack!5207 () (_ BitVec 64))
(declare-fun t1_ack!5204 () (_ BitVec 64))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5204)
                                  ((_ to_fp 11 53) t_ack!5207)))
...
(let ((a!25 (fp.sub roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ...
                                    a!16))
                    a!24)))
  (FPCHECK_FMUL_UNDERFLOW #xbfd2a471c23b2d29 a!25)))))))))))))
