(declare-fun t_ack!5887 () (_ BitVec 64))
(declare-fun t1_ack!5884 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!5886 () (_ BitVec 64))
(declare-fun y0_ack!5885 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5884)
                                  ((_ to_fp 11 53) t_ack!5887)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5886))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5885)
                                   ((_ to_fp 11 53) y0_ack!5885))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xc03000ea32f607ac
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!5886) a!34))))))))))))))))))
