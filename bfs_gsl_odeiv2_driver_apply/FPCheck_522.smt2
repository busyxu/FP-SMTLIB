(declare-fun t_ack!4187 () (_ BitVec 64))
(declare-fun t1_ack!4184 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!4185 () (_ BitVec 64))
(declare-fun y1_ack!4186 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!4184)
                                  ((_ to_fp 11 53) t_ack!4187)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4186))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4185)
                                   ((_ to_fp 11 53) y0_ack!4185))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!46 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!45)))))
  (FPCHECK_FADD_OVERFLOW y0_ack!4185 a!46))))))))))))))))))))))
