(declare-fun t_ack!3101 () (_ BitVec 64))
(declare-fun t1_ack!3098 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!3099 () (_ BitVec 64))
(declare-fun y1_ack!3100 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3098)
                                  ((_ to_fp 11 53) t_ack!3101)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3100))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3099)
                                   ((_ to_fp 11 53) y0_ack!3099))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!38 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.sub roundNearestTiesToEven
            ((_ to_fp 11 53) #x8000000000000000)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3099) a!30))
    a!38))))))))))))))))))
