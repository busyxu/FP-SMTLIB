(declare-fun t_ack!5235 () (_ BitVec 64))
(declare-fun t1_ack!5232 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5233 () (_ BitVec 64))
(declare-fun y1_ack!5234 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5232)
                                  ((_ to_fp 11 53) t_ack!5235)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5234))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5233)
                                   ((_ to_fp 11 53) y0_ack!5233))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!18))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #xbfd2a471c23b2d29) a!26))))))))))))))
