(declare-fun t_ack!5573 () (_ BitVec 64))
(declare-fun t1_ack!5570 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5571 () (_ BitVec 64))
(declare-fun y1_ack!5572 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5570)
                                  ((_ to_fp 11 53) t_ack!5573)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5572))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5571)
                                   ((_ to_fp 11 53) y0_ack!5571))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!62 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!5573))
                            a!61))))
  (FPCHECK_FMUL_UNDERFLOW #x4024000000000000 a!62)))))))))))))))))))))))))))
