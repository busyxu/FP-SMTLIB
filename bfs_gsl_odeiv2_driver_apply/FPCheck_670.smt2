(declare-fun t_ack!5443 () (_ BitVec 64))
(declare-fun t1_ack!5440 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!5441 () (_ BitVec 64))
(declare-fun y1_ack!5442 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!5440)
                                  ((_ to_fp 11 53) t_ack!5443)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!5442))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!5441)
                                   ((_ to_fp 11 53) y0_ack!5441))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    ...
                    a!50))
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fbfadbee9f5b0f4) a!60))))))))))))))))))))))))))
