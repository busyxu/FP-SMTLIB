(declare-fun t_ack!3749 () (_ BitVec 64))
(declare-fun t1_ack!3746 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3747 () (_ BitVec 64))
(declare-fun y1_ack!3748 () (_ BitVec 64))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ff0000000000000)
                          (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 11 53) t1_ack!3746)
                                  ((_ to_fp 11 53) t_ack!3749)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3748))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3747)
                                   ((_ to_fp 11 53) y0_ack!3747))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
...
(let ((a!43 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!3749))
                            a!42))))
  (FPCHECK_FMUL_OVERFLOW #x4024000000000000 a!43)))))))))))))))))))))
