...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!3065))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!3066) ((_ to_fp 11 53) #x4049000000000000)))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!3065) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!2 (CF_pow (fp.mul roundNearestTiesToEven
                   ...
                   #x3fe5555555555555)))
  (FPCHECK_FDIV_OVERFLOW a!2 #x3fe1c71c71c7238e))))
