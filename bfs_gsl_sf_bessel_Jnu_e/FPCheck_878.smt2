...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2797) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2797))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!2798) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2797) ((_ to_fp 11 53) #x408f400000000000))))
