...
(assert (fp.lt ((_ to_fp 11 53) a_ack!2622) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2621) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2621))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2621) ((_ to_fp 11 53) #x408f400000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) #x0000000000000000)))))
  (FPCHECK_FDIV_ACCURACY a!2 #x2000000000000000))))
