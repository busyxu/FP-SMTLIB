...
(assert (fp.lt ((_ to_fp 11 53) a_ack!726) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!725) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!725))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!725) ((_ to_fp 11 53) #x408f400000000000)))
