...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!1752) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1751) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!1752 #x4008000000000000))
