...
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2339) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!2340) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (FPCHECK_FMUL_UNDERFLOW #xbfd0000000000000 b_ack!2339))
