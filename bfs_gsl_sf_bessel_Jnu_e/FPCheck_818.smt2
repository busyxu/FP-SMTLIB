...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2581) ((_ to_fp 11 53) #x408f400000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) b_ack!2581))
    (fp.div roundNearestTiesToEven ((_ to_fp 11 53) b_ack!2581) a!2))))
