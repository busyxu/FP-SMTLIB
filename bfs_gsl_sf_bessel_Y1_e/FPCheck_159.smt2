...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!217) ((_ to_fp 11 53) #x3e60000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!217) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!217) ((_ to_fp 11 53) #x4330000000000000)))
