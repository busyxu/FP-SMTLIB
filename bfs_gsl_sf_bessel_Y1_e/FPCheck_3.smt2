...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!8) ((_ to_fp 11 53) #x1ff0000000000001))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!8) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(assert (let ((a!1 (CF_floor (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW a!1 #x60145f306dc9c882)))
