...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!35) ((_ to_fp 11 53) #x1ff0000000000001))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!35) ((_ to_fp 11 53) #x3fd0000000000000))))
...
(let ((a!2 (bvand ((_ fp.to_sbv 32)
                    ...
                    (fp.sub roundNearestTiesToEven
                            a!1
                            ((_ to_fp 11 53) #x60145f306dc9c882)))
                  #x00000001)))
  (= #x00000000 a!2))))
(assert (let ((a!1 (CF_floor (fp.div roundNearestTiesToEven
                             (fp.abs ((_ to_fp 11 53) a_ack!35))
