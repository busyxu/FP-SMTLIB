...
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!239) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!239) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) x_ack!239) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (not (fp.gt (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) x_ack!239))
            ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (let ((a!1 (and (fp.eq ((_ to_fp 11 53) nu2_ack!238)
                       ((_ to_fp 11 53) #x0000000000000000))
                (fp.eq (fp.add roundNearestTiesToEven
                               ((_ to_fp 11 53) nu2_ack!238)
                               ((_ to_fp 11 53) nu1_ack!237))
                       ((_ to_fp 11 53) #x0000000000000000)))))
  (not a!1)))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) #x3ff0000000000000)
...
(assert (let ((a!1 (fp.eq (fp.div roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3ff0000000000000))))
  (not a!1)))
(assert (not (fp.gt ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) #x40f86a0000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) nu1_ack!237))))
(assert (fp.lt ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) nu1_ack!237)))
(assert (fp.lt (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) nu2_ack!238)
               ((_ to_fp 11 53) nu1_ack!237))
       ((_ to_fp 11 53) #x3fc999999999999a)))
(assert (not (fp.leq ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x3f847ae147ae147b))))
  (not a!1)))
(assert (not (fp.geq ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (fp.eq ((_ to_fp 11 53) nu2_ack!238) ((_ to_fp 11 53) #x0000000000000000)))
