...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (bvult a_ack!575 b_ack!574)))
(assert (not (= b_ack!574 a_ack!575)))
(assert (not (= #x00000000 b_ack!574)))
(assert (bvult a_ack!575 (bvmul #x00000002 b_ack!574)))
(assert (not (bvule a_ack!575 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!575)
                ((_ to_fp 11 53) #x3ff0000000000000))
