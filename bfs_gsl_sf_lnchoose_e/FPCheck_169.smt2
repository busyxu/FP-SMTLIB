...
(assert (not (bvult a_ack!587 b_ack!586)))
(assert (not (= b_ack!586 a_ack!587)))
(assert (not (= #x00000000 b_ack!586)))
(assert (not (bvult a_ack!587 (bvmul #x00000002 b_ack!586))))
(assert (not (bvule a_ack!587 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!587)
                ((_ to_fp 11 53) #x3ff0000000000000))
