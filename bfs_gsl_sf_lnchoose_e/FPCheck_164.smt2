...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvult a_ack!571 b_ack!570)))
(assert (not (= b_ack!570 a_ack!571)))
(assert (not (= #x00000000 b_ack!570)))
(assert (bvult a_ack!571 (bvmul #x00000002 b_ack!570)))
(assert (not (bvule a_ack!571 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!571)
                ((_ to_fp 11 53) #x3ff0000000000000))
