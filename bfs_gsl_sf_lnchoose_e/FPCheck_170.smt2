...
(assert (not (bvult a_ack!589 b_ack!588)))
(assert (not (= b_ack!588 a_ack!589)))
(assert (not (= #x00000000 b_ack!588)))
(assert (not (bvult a_ack!589 (bvmul #x00000002 b_ack!588))))
(assert (not (bvule a_ack!589 #x000000aa)))
...
(assert (fp.geq (fp.add roundNearestTiesToEven
                ((_ to_fp_unsigned 11 53) roundNearestTiesToEven a_ack!589)
                ((_ to_fp 11 53) #x3ff0000000000000))
