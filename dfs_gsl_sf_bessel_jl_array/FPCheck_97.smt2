...
(assert (not (bvslt (bvadd #x00000001 a_ack!385) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!384) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!384) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!385)))
(assert (not (= #x00000000 a_ack!385)))
(assert (= #x00000001 a_ack!385))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!384) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!384))
            ((_ to_fp 11 53) #x2020000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!384))
       ((_ to_fp 11 53) #x3ff4cccccccccccd)))
(assert (FPCHECK_FMUL_ACCURACY b_ack!384 b_ack!384))
