...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3358) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3358) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3359) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3358) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3358) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3359)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3359)
                           (bvadd #x00000001 a_ack!3359))
                    a_ack!3359))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3358) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            a!14))))
  (FPCHECK_FMUL_OVERFLOW (fp.div roundNearestTiesToEven a!1 a!3) a!19))))))))
