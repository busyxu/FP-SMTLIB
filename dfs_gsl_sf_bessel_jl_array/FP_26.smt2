...
(assert (not (bvslt (bvadd #x00000001 a_ack!337) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!337)))
...
(assert (not (bvslt a_ack!337 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!336) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq ((_ to_fp 11 53) b_ack!336) ((_ to_fp 11 53) #x0000000000000000)))
