...
(assert (not (bvslt (bvadd #x00000001 a_ack!3407) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3406) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3406) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3407)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3407)
                           (bvadd #x00000001 a_ack!3407))
                    a_ack!3407))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3406) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!31 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!3 a!30)
                                    a!27)))))
  (FPCHECK_FDIV_ACCURACY (fp.div roundNearestTiesToEven a!21 a!28) a!31)))))))))))
