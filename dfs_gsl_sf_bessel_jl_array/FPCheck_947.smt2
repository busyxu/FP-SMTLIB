...
(assert (not (bvslt (bvadd #x00000001 a_ack!3041) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3041)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3041)
                           (bvadd #x00000001 a_ack!3041))
                    a_ack!3041))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3040) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.div roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3ff0000000000000)
                            a!10))))
  (FPCHECK_FDIV_ACCURACY #x3ff0000000000000 a!11))))))))
