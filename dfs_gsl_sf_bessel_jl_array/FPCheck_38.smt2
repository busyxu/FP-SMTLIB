...
(assert (not (bvslt (bvadd #x00000001 a_ack!143) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!142) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!142) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!142))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
                 ...
                 a!1)
         ((_ to_fp 11 53) #x3ea937e11175f095))))
(assert (FPCHECK_FDIV_OVERFLOW b_ack!142 #x4008000000000000))
