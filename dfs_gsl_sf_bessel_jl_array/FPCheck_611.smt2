(declare-fun a_ack!1987 () (_ BitVec 32))
(declare-fun b_ack!1986 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ZERO ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!1987 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1986) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1986) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!1987) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1986) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1986) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1987)))
(assert (not (= #x00000000 a_ack!1987)))
(assert (not (= #x00000001 a_ack!1987)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!1987))
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) b_ack!1986)
                      ((_ to_fp 11 53) b_ack!1986))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1987)
                           (bvadd #x00000001 a_ack!1987))
                    a_ack!1987))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1986) ((_ to_fp 11 53) #x408f400000000000))))
      ...
      (a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    a!7)))))
(let ((a!13 (fp.eq (fp.mul roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
      ...
      (a!12 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    a!7)))))
(let ((a!13 (fp.eq (fp.abs (fp.div roundNearestTiesToEven
                                   (fp.div roundNearestTiesToEven a!6 a!8)
                                   (fp.div roundNearestTiesToEven a!11 a!12)))
                   ((_ to_fp 11 53) #x0000000000000000))))
  (not a!13)))))))
