...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1823)
                           (bvadd #x00000001 a_ack!1823))
                    a_ack!1823))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1822) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!9 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!9))))))))
(assert (FPCHECK_FSUB_ACCURACY #x8000000000000000 b_ack!1822))
