...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2716) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2716) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2717) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2716) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2716) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2717)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2717)
                           (bvadd #x00000001 a_ack!2717))
                    a_ack!2717))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2716) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.add roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    a!5)))))
  (FPCHECK_FMUL_OVERFLOW (fp.div roundNearestTiesToEven a!1 a!3) a!10)))))
