(declare-fun a_ack!3127 () (_ BitVec 32))
(declare-fun b_ack!3126 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!3127 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3126) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3126) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3127) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3126) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3126) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3127)))
(assert (not (= #x00000000 a_ack!3127)))
(assert (not (= #x00000001 a_ack!3127)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!3127))
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) b_ack!3126)
                      ((_ to_fp 11 53) b_ack!3126))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3127)
                           (bvadd #x00000001 a_ack!3127))
                    a_ack!3127))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3126) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!9 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x0000000000000000)
                                   a!2)))))
(let ((a!12 (fp.abs (fp.add roundNearestTiesToEven
                            a!9
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!3 a!11)
                                    a!6)))))
  (not (fp.gt a!12 ((_ to_fp 11 53) #x5fefffffffffffff)))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!12 (fp.abs (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!3 a!11)
                                    a!6)))))
  (not (fp.lt a!12 ((_ to_fp 11 53) #x2000000000000000)))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            a!11
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!1 a!13)
                                    a!8))
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!1 a!15)
                            a!11))))
  (FPCHECK_FMUL_UNDERFLOW (fp.div roundNearestTiesToEven a!1 a!3) a!16)))))))
