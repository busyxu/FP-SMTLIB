...
(assert (not (bvslt (bvadd #x00000001 a_ack!323) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!322) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!322) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!323)))
(assert (= #x00000000 a_ack!323))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!322) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!322))
            ((_ to_fp 11 53) #x0028cccccccccccd))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!322))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!322))
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) b_ack!322))
                           a!5))))
  (FPCHECK_FMUL_ACCURACY #x3cc0000000000000 (fp.abs a!6)))))))))
