...
(assert (not (bvslt (bvadd #x00000001 a_ack!1937) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1936) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1936) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1937)
                           (bvadd #x00000001 a_ack!1937))
                    a_ack!1937))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1936) ((_ to_fp 11 53) #x408f400000000000))))
