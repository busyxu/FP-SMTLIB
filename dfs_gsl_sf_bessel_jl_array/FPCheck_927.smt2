...
(assert (not (bvslt (bvadd #x00000001 a_ack!2975) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2974) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2974) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2975)
                           (bvadd #x00000001 a_ack!2975))
                    a_ack!2975))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2974) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!23 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!3 a!22)
                                    a!19)))))
  (FPCHECK_FDIV_UNDERFLOW (fp.div roundNearestTiesToEven a!15 a!20) a!23)))))))))
