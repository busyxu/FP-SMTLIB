...
(assert (not (bvslt (bvadd #x00000001 a_ack!1619) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1618) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1618) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1619)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1619)
                           (bvadd #x00000001 a_ack!1619))
                    a_ack!1619))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1618) ((_ to_fp 11 53) #x408f400000000000))))
