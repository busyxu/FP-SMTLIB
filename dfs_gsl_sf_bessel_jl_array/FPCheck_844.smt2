...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2710) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2710) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2711) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2710) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2710) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2711)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2711)
                           (bvadd #x00000001 a_ack!2711))
                    a_ack!2711))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2710) ((_ to_fp 11 53) #x408f400000000000))))
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven
            ...
            (fp.mul roundNearestTiesToEven
                    (fp.div roundNearestTiesToEven a!3 a!11)
                    a!6))
    (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven a!3 a!13) a!9)))))))
