...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1998) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1998) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!1999) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1998) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1998) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1999)
                           (bvadd #x00000001 a_ack!1999))
                    a_ack!1999))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1998) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!11 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 (fp.div roundNearestTiesToEven
                         ...
                         (fp.div roundNearestTiesToEven a!11 a!12)))
         (fp.div roundNearestTiesToEven a!11 a!12)))))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!1998))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) b_ack!1998)))))
  (fp.eq a!2 ((_ to_fp 11 53) b_ack!1998)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
