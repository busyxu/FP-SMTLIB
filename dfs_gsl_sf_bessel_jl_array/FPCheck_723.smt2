...
(assert (not (bvslt (bvadd #x00000001 a_ack!2339) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2338) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2338) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2339)))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             ...
                             (bvadd #x00000001 a_ack!2339))
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
  (not (fp.lt (fp.mul roundNearestTiesToEven
                      ((_ to_fp 11 53) b_ack!2338)
                      ((_ to_fp 11 53) b_ack!2338))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2339)
                           (bvadd #x00000001 a_ack!2339))
                    a_ack!2339))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2338) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!9
    (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven a!3 a!11) a!6)))))))
