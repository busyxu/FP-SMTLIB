(declare-fun a_ack!2463 () (_ BitVec 32))
(declare-fun b_ack!2462 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_ACCURACY ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!2463 #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2462) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2462) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2463) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2462) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2462) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2463)))
(assert (not (= #x00000000 a_ack!2463)))
(assert (not (= #x00000001 a_ack!2463)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!2463))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2463)
                           (bvadd #x00000001 a_ack!2463))
                    a_ack!2463))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2462) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_ACCURACY
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!2463))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x4010000000000000))
