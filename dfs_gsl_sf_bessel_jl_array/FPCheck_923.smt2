...
(assert (not (bvslt (bvadd #x00000001 a_ack!2959) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2958) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2958) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2959)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2959)
                           (bvadd #x00000001 a_ack!2959))
                    a_ack!2959))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2958) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!17 (fp.add roundNearestTiesToEven
      ...
      (a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!3 a!16)
                            a!21))))
  (FPCHECK_FDIV_ACCURACY a!17 a!22))))))))
