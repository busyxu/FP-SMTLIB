...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3378) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3378) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!3379) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3378) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3378) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3379)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3379)
                           (bvadd #x00000001 a_ack!3379))
                    a_ack!3379))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3378) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!23 (fp.add roundNearestTiesToEven
      ...
      (a!30 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!3 a!22)
                            a!29))))
  (FPCHECK_FDIV_OVERFLOW a!23 a!30))))))))))
