...
(assert (not (bvslt (bvadd #x00000001 a_ack!1793) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1792) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1792) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1793)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1793)
                           (bvadd #x00000001 a_ack!1793))
                    a_ack!1793))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1792) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!9 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!9))))))))
(assert (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 b_ack!1792))
