...
(assert (not (bvslt (bvadd #x00000001 a_ack!1041) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1040) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1041)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1041)
                           (bvadd #x00000001 a_ack!1041))
                    a_ack!1041))))
...
(assert (fp.gt ((_ to_fp 11 53) b_ack!1040) ((_ to_fp 11 53) #x408f400000000000)))
(assert (fp.gt ((_ to_fp 11 53) b_ack!1040)
       ((_ to_fp 11 53)
         roundNearestTiesToEven
         (bvmul (bvadd #x00000001 a_ack!1041) (bvadd #x00000001 a_ack!1041)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
