...
(assert (not (bvslt (bvadd #x00000001 a_ack!2637) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2636) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2636) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2637)))
(assert (not (= #x00000000 a_ack!2637)))
(assert (not (= #x00000001 a_ack!2637)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4024000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000001 a_ack!2637))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2637)
                           (bvadd #x00000001 a_ack!2637))
                    a_ack!2637))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2636) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 b_ack!2636))
