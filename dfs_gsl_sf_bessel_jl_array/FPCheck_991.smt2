...
(assert (not (bvslt (bvadd #x00000001 a_ack!3169) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3168) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3168) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!3169)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3169)
                           (bvadd #x00000001 a_ack!3169))
                    a_ack!3169))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3168) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!20 (fp.add roundNearestTiesToEven
      ...
      (a!26 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!3 a!19)
                            a!25))))
  (FPCHECK_FDIV_UNDERFLOW a!20 a!26)))))))))
