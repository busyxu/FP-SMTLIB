...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2374) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2374) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 a_ack!2375) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2374) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2374) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2375)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2375)
                           (bvadd #x00000001 a_ack!2375))
                    a_ack!2375))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2374) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!15 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!3 a!14)
                                    a!11)))))
  (FPCHECK_FDIV_ZERO (fp.div roundNearestTiesToEven a!9 a!12) a!15)))))))
