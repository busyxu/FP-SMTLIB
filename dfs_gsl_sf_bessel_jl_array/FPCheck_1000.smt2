...
(assert (not (bvslt (bvadd #x00000001 a_ack!3205) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3204) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3204) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!3205)
                           (bvadd #x00000001 a_ack!3205))
                    a_ack!3205))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3204) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_OVERFLOW
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!3205))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x401c000000000000))
