...
(assert (not (bvslt (bvadd #x00000001 a_ack!2745) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2744) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2744) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!2745)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2745)
                           (bvadd #x00000001 a_ack!2745))
                    a_ack!2745))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2744) ((_ to_fp 11 53) #x408f400000000000))))
...
(let ((a!14 (fp.add roundNearestTiesToEven
      ...
      (a!18 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven a!3 a!13)
                            a!17))))
  (FPCHECK_FDIV_ACCURACY a!14 a!18)))))))
