...
(assert (not (bvslt (bvadd #x00000001 a_ack!2993) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2992) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2992) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!2993)
                           (bvadd #x00000001 a_ack!2993))
                    a_ack!2993))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2992) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_UNDERFLOW
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!2993))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x4018000000000000))
