...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1839)
                           (bvadd #x00000001 a_ack!1839))
                    a_ack!1839))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1838) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_OVERFLOW
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!1839))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x4008000000000000))
