...
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 ((_ sign_extend 32) a_ack!885))))
(assert (bvult (bvmul #x0000000000000008 ((_ sign_extend 32) a_ack!885))
       #x0000000000000319))
(assert (bvsle #x00000001 a_ack!885))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
      ...
      (a!3 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvmul #x00000002 a_ack!885)))
                   ((_ to_fp 11 53) b_ack!884)))
...
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven a!1 (CF_sin b_ack!884))
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4008000000000000)
                                   (CF_cos b_ack!884))
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.sub roundNearestTiesToEven
            ...
            (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!884)))
