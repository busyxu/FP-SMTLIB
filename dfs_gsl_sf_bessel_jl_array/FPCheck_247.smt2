...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!978) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!978) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!979)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!979)
                           (bvadd #x00000001 a_ack!979))
                    a_ack!979))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!978) ((_ to_fp 11 53) #x408f400000000000))))
(assert (FPCHECK_FADD_ACCURACY
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!979))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x3ff0000000000000))
