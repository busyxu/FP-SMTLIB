...
(assert (bvult #x0000000000000000
       (bvmul #x0000000000000008 ((_ sign_extend 32) a_ack!859))))
(assert (bvult (bvmul #x0000000000000008 ((_ sign_extend 32) a_ack!859))
       #x0000000000000319))
(assert (bvsle #x00000001 a_ack!859))
(assert (FPCHECK_FDIV_ACCURACY
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 (bvmul #x00000002 a_ack!859)))
  b_ack!858))
