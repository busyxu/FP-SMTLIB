...
(assert (not (bvslt (bvadd #x00000001 a_ack!1863) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1862) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1862) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff a_ack!1863)))
...
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001
                    (bvmul (bvadd #x00000001 a_ack!1863)
                           (bvadd #x00000001 a_ack!1863))
                    a_ack!1863))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1862) ((_ to_fp 11 53) #x408f400000000000))))
...
(assert (FPCHECK_FADD_ACCURACY
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000001 a_ack!1863))
          ((_ to_fp 11 53) #x3fe0000000000000))
  #x4008000000000000))
