...
(assert (not (bvsle a_ack!424 #x00000000)))
(assert (not (bvslt b_ack!423 #x00000000)))
(assert (not (bvslt (bvsdiv a_ack!424 #x00000002) b_ack!423)))
(assert (not (= #x00000000 b_ack!423)))
(assert (not (= #x00000002 a_ack!424)))
(assert (not (bvslt a_ack!424 #x00000015)))
(assert (= #x00000001 b_ack!423))
(assert (bvslt #x00000032 a_ack!424))
(assert (= #x00000000 (bvand a_ack!424 #x00000001)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvmul #xfffffffe (bvsub (bvsdiv a_ack!424 #x00000002) b_ack!423)))))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #xc00921fb53c00c10) a!2)
    #xc010000000000000))))
