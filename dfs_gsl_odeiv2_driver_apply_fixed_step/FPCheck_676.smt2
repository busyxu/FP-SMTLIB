...
(declare-fun y1_ack!2528 () (_ BitVec 64))
(declare-fun h_ack!2529 () (_ BitVec 64))
(declare-fun y0_ack!2527 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2529)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2528))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2527)
                                   ((_ to_fp 11 53) y0_ack!2527))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.abs a!34))))))
  (FPCHECK_FADD_ACCURACY a!35 #x3e45798ee2308c3a)))))))))))))))))))
