(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(declare-fun y0_ack!1814 () (_ BitVec 64))
(declare-fun y1_ack!1815 () (_ BitVec 64))
(declare-fun h_ack!1816 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!1816)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!1815))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!1814)
                                   ((_ to_fp 11 53) y0_ack!1814))
...
(let ((a!22 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!1 a!18))
                            a!21))))
  (FPCHECK_FADD_OVERFLOW a!19 a!22))))))))))))
