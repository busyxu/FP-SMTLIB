(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(declare-fun y1_ack!2525 () (_ BitVec 64))
(declare-fun h_ack!2526 () (_ BitVec 64))
(declare-fun y0_ack!2524 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2526)
      ...
      (a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2525))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2524)
                                   ((_ to_fp 11 53) y0_ack!2524))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.abs a!34))))))
  (FPCHECK_FADD_UNDERFLOW a!35 #x3e45798ee2308c3a)))))))))))))))))))
