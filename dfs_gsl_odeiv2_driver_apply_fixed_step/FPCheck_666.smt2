...
(declare-fun y1_ack!2489 () (_ BitVec 64))
(declare-fun h_ack!2490 () (_ BitVec 64))
(declare-fun y0_ack!2488 () (_ BitVec 64))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) h_ack!2490)
                           ((_ to_fp 11 53) #x4000000000000000))
                   ((_ to_fp 11 53) #x4018000000000000)))
      (a!2 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4024000000000000)
                           ((_ to_fp 11 53) y1_ack!2489))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2488)
                                   ((_ to_fp 11 53) y0_ack!2488))
...
(let ((a!32 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW #x0000000000000000 (fp.abs a!32)))))))))))))))))))
