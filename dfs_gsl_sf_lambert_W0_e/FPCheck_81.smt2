...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!154) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!154) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!154)
                           (CF_log (CF_log a_ack!154)))
                   (CF_log (CF_log a_ack!154)))))
  (fp.eq a!1 (CF_log a_ack!154))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!154)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!154)
                           (CF_log (CF_log a_ack!154))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!154)))))
...
(let ((a!7 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           a!5
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))
  (fp.eq a!7 (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))))))
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!154)
                           (CF_log (CF_log a_ack!154)))))
      (a!3 (fp.add roundNearestTiesToEven
...
(let ((a!7 (fp.abs (fp.sub roundNearestTiesToEven
                           a!5
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))
(let ((a!8 (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!6 (CF_exp a!5)))
                  (fp.mul roundNearestTiesToEven
                          ((_ to_fp 11 53) #x3ce4000000000000)
                          a!7))))
  (not a!8)))))))))
...
(let ((a!6 (fp.div roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           a!5
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
(let ((a!7 (CF_exp (fp.sub roundNearestTiesToEven
                           a!5
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))
...
(let ((a!8 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5)))
                   a!7)))
  (fp.eq (fp.div roundNearestTiesToEven a!8 a!7)
         (fp.sub roundNearestTiesToEven
                 a!5
                 (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))))))))
(assert (let ((a!1 (CF_exp (fp.sub roundNearestTiesToEven
...
(let ((a!8 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5)))
                   a!7)))
  (FPCHECK_FSUB_UNDERFLOW a!8 a_ack!154)))))))))
