...
(assert (fp.gt ((_ to_fp 11 53) a_ack!26) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!26)
                           (CF_log (CF_log a_ack!26)))
                   (CF_log (CF_log a_ack!26)))))
  (fp.eq a!1 (CF_log a_ack!26))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!26)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!26)
                           (CF_log (CF_log a_ack!26))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!26)))))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (CF_log (CF_log a_ack!26)))
                   a!1)))
  (FPCHECK_FSUB_OVERFLOW a!2 a_ack!26))))
