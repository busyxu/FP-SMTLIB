...
(assert (fp.gt ((_ to_fp 11 53) a_ack!152) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!152)
                           (CF_log (CF_log a_ack!152)))
                   (CF_log (CF_log a_ack!152)))))
  (fp.eq a!1 (CF_log a_ack!152))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!152)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!152)
                           (CF_log (CF_log a_ack!152))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!152)))))
...
(let ((a!8 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5)))
                   a!7)))
  (FPCHECK_FSUB_OVERFLOW a!8 a_ack!152)))))))))
