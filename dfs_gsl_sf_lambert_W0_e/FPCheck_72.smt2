...
(assert (fp.gt ((_ to_fp 11 53) a_ack!131) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!131)
                           (CF_log (CF_log a_ack!131)))
                   (CF_log (CF_log a_ack!131)))))
  (fp.eq a!1 (CF_log a_ack!131))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!131)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!131)
                           (CF_log (CF_log a_ack!131))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!131)))))
...
(let ((a!7 (fp.abs (fp.sub roundNearestTiesToEven
                           a!5
                           (fp.div roundNearestTiesToEven a!6 (CF_exp a!5))))))
  (FPCHECK_FMUL_UNDERFLOW #x3ce4000000000000 a!7))))))))
