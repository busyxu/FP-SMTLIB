...
(assert (fp.gt ((_ to_fp 11 53) a_ack!77) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!77)
                           (CF_log (CF_log a_ack!77)))
                   (CF_log (CF_log a_ack!77)))))
  (fp.eq a!1 (CF_log a_ack!77))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!77)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!77)
                           (CF_log (CF_log a_ack!77))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!77)))))
...
(let ((a!5 (fp.sub roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           (CF_log (CF_log a_ack!77)))
                   a!4)))
  (FPCHECK_FMUL_UNDERFLOW a!5 (CF_exp a!5)))))))
