...
(assert (not (bvslt n_ack!219 #x00000001)))
(assert (not (= #x00000001 n_ack!219)))
(assert (not (= #x00000002 n_ack!219)))
(assert (not (= #x00000003 n_ack!219)))
(assert (bvslt n_ack!219 #x00000046))
