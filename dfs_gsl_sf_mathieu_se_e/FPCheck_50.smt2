...
(assert (not (bvslt n_ack!221 #x00000001)))
(assert (not (= #x00000001 n_ack!221)))
(assert (not (= #x00000002 n_ack!221)))
(assert (not (= #x00000003 n_ack!221)))
(assert (bvslt n_ack!221 #x00000046))
(assert (FPCHECK_FMUL_OVERFLOW
  #x3ffb333333333333
  ((_ to_fp 11 53) roundNearestTiesToEven n_ack!221)))
