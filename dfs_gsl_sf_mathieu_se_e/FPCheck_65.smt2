...
(assert (not (= #x00000001 n_ack!283)))
(assert (not (= #x00000002 n_ack!283)))
(assert (not (= #x00000003 n_ack!283)))
(assert (bvslt n_ack!283 #x00000046))
(assert (FPCHECK_FMUL_UNDERFLOW #xc000000000000000 a_ack!284))
