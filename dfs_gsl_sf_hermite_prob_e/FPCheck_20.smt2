...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!89)) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!90))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!89))
       (fp.div roundNearestTiesToEven
               ((_ to_fp 11 53) #x7feccccccccccccc)
               (fp.abs ((_ to_fp 11 53) b_ack!89)))))
(assert (FPCHECK_FMUL_UNDERFLOW (fp.abs ((_ to_fp 11 53) b_ack!89)) #x3cb0000000000000))
