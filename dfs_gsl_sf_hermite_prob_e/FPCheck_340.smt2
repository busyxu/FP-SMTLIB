...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1237))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!1238))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1237))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!1238))
...
(assert (bvslt #x00000003 a_ack!1238))
...
(assert (bvslt #x00000004 a_ack!1238))
...
(assert (bvslt #x00000005 a_ack!1238))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1237)
                           ((_ to_fp 11 53) b_ack!1237))
...
(assert (bvslt #x00000006 a_ack!1238))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1237)
                           ((_ to_fp 11 53) b_ack!1237))
...
(assert (bvslt #x00000007 a_ack!1238))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1237)
                           ((_ to_fp 11 53) b_ack!1237))
...
(assert (not (bvslt #x00000008 a_ack!1238)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!1237))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!1237))
...
(let ((a!8 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!8
    (fp.mul roundNearestTiesToEven a!15 ((_ to_fp 11 53) #x3cb0000000000000)))))))))))
