...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!743))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!744))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!743))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!743))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!743))
...
(assert (bvslt #x00000008 a_ack!744))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!743)
                           ((_ to_fp 11 53) b_ack!743))
...
(assert (bvslt #x00000009 a_ack!744))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!743)
                           ((_ to_fp 11 53) b_ack!743))
...
(let ((a!8 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 a!8)
         ((_ to_fp 11 53) #x4022000000000000))))))))))
(assert (bvslt #x0000000a a_ack!744))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!743)
                           ((_ to_fp 11 53) b_ack!743))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ((_ to_fp 11 53) #x4022000000000000)
                            a!8))))
  (FPCHECK_FMUL_OVERFLOW (fp.abs ((_ to_fp 11 53) b_ack!743)) a!10)))))))))))
