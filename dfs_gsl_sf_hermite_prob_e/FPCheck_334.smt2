...
(assert (bvslt #x00000001 a_ack!1222))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1221))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!1222))
...
(assert (bvslt #x00000003 a_ack!1222))
...
(assert (bvslt #x00000004 a_ack!1222))
...
(assert (bvslt #x00000005 a_ack!1222))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1221)
                           ((_ to_fp 11 53) b_ack!1221))
...
(assert (bvslt #x00000006 a_ack!1222))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1221)
                           ((_ to_fp 11 53) b_ack!1221))
...
(assert (bvslt #x00000007 a_ack!1222))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1221)
                           ((_ to_fp 11 53) b_ack!1221))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!1221)) a!7)
