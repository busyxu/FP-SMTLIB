...
(assert (= #x00000000 (bvand a_ack!34 #x00000001)))
(assert (not (bvslt #x00000129 (bvadd #xffffffff a_ack!34))))
(assert (bvult (bvadd #xffffffff a_ack!34) #x0000001a))
(assert (let ((a!1 (bvadd #x0000000000000008
                  (bvmul #x0000000000000018
                         (concat #x00000000 (bvadd #xffffffff a_ack!34))))))
  (bvult #x0000000000000000 a!1)))
(assert (let ((a!1 (bvadd #x0000000000000008
                  (bvmul #x0000000000000018
                         (concat #x00000000 (bvadd #xffffffff a_ack!34))))))
  (bvult a!1 #x0000000000001be9)))
(assert (not (= #x00000000 (bvand (bvsdiv a_ack!34 #x00000002) #x00000001))))
