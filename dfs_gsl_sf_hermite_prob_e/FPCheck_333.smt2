...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1217))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!1218))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1217))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!1218))
...
(assert (bvslt #x00000003 a_ack!1218))
...
(assert (bvslt #x00000004 a_ack!1218))
...
(assert (bvslt #x00000005 a_ack!1218))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1217)
                           ((_ to_fp 11 53) b_ack!1217))
...
(assert (bvslt #x00000006 a_ack!1218))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1217)
                           ((_ to_fp 11 53) b_ack!1217))
...
(assert (bvslt #x00000007 a_ack!1218))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1217)
                           ((_ to_fp 11 53) b_ack!1217))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!1217))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!1217))
...
(let ((a!6 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4014000000000000)
                           a!4))))
  (FPCHECK_FMUL_ACCURACY #x401c000000000000 a!6)))))))
