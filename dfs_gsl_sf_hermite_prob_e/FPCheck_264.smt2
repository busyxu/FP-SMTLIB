...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!973))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!974))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!973))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!974))
...
(assert (bvslt #x00000003 a_ack!974))
...
(let ((a!3 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!973)) a!3)
    (fp.mul roundNearestTiesToEven
