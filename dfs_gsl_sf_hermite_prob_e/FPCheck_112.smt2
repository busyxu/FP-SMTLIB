...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!409))
...
(assert (bvslt #x00000004 a_ack!410))
...
(let ((a!5 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven
         ...
         (fp.mul roundNearestTiesToEven
                 (fp.abs ((_ to_fp 11 53) b_ack!409))
                 a!4)))))))
(assert (bvslt #x00000005 a_ack!410))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!409)
                           ((_ to_fp 11 53) b_ack!409))
...
(let ((a!5 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4010000000000000)
                           a!3))))
  (FPCHECK_FMUL_OVERFLOW (fp.abs ((_ to_fp 11 53) b_ack!409)) a!5))))))
