...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!699))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!700))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!699))
...
(assert (bvslt #x00000008 a_ack!700))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!699)
                           ((_ to_fp 11 53) b_ack!699))
...
(assert (bvslt #x00000009 a_ack!700))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!699)
                           ((_ to_fp 11 53) b_ack!699))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!699)) a!9)
