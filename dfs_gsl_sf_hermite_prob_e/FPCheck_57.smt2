...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!211))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!212))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!211))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!211))))))
  (not a!1)))
(assert (bvslt #x00000002 a_ack!212))
