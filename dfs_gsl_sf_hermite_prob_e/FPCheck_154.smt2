...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!573))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!574))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!573))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!573))))))
  (not a!1)))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!573))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!573))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!573)) a!7)
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x401c000000000000) a!6)))))))))
