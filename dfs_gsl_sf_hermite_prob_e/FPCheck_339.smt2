...
(assert (not (= #x00000000 a_ack!1234)))
(assert (not (= #x00000001 a_ack!1234)))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!1233) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1233))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!1234))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!1233))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!1234))
...
(assert (bvslt #x00000003 a_ack!1234))
...
(assert (bvslt #x00000004 a_ack!1234))
...
(assert (bvslt #x00000005 a_ack!1234))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1233)
                           ((_ to_fp 11 53) b_ack!1233))
...
(assert (bvslt #x00000006 a_ack!1234))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1233)
                           ((_ to_fp 11 53) b_ack!1233))
...
(assert (bvslt #x00000007 a_ack!1234))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1233)
                           ((_ to_fp 11 53) b_ack!1233))
...
(assert (not (bvslt #x00000008 a_ack!1234)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!1233)
                           ((_ to_fp 11 53) b_ack!1233))
...
(let ((a!7 (fp.abs (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!5)))))
  (FPCHECK_FMUL_ACCURACY a!7 #x3cb0000000000000)))))))))
