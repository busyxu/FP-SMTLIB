...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!904 #x00000000)))
...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!903))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (bvslt #x00000001 a_ack!904))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!903))
            ((_ to_fp 11 53) #x7fefffffffffffff))))
(assert (bvslt #x00000002 a_ack!904))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.abs ((_ to_fp 11 53) b_ack!903))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!903))
