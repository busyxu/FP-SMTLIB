...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!697))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!698))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!697))
...
(let ((a!9 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!697)) a!9)
