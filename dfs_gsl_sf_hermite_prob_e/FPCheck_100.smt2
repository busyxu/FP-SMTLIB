...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!363))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!364))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!363))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.mul roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) b_ack!363)) a!4)
