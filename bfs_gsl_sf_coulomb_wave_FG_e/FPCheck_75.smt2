...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!419) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!419)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!420))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_OVERFLOW a_ack!421 a_ack!421))
