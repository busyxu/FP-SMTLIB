...
(declare-fun d_ack!300 () (_ BitVec 32))
...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!299) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!299)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!300))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x0000000000000000)
                                   a!1)))))
  (FPCHECK_FDIV_ACCURACY #x3ff0000000000000 (CF_exp (fp.abs a!2))))))
