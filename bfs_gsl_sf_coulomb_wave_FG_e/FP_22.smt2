...
(declare-fun d_ack!533 () (_ BitVec 32))
(declare-fun a_ack!534 () (_ BitVec 64))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!531) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!532) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!532)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!533))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!534))
