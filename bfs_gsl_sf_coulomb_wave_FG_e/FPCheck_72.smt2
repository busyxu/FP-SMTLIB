...
(declare-fun d_ack!400 () (_ BitVec 32))
...
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!399) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!399)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!400))
...
(assert (fp.eq ((_ to_fp 11 53) c_ack!399) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!3 (fp.div roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   (fp.abs a!2)))
                   a!2)))
  (FPCHECK_FDIV_ACCURACY (fp.abs a!3) (fp.abs a!2))))))
