...
(declare-fun d_ack!368 () (_ BitVec 32))
(declare-fun a_ack!369 () (_ BitVec 64))
(declare-fun CF_exp ((_ FloatingPoint 11 53)) (_ FloatingPoint 11 53))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!366) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!367) ((_ to_fp 11 53) #xbfe0000000000000))))
(assert (not (fp.leq (fp.sub roundNearestTiesToEven
                     ((_ to_fp 11 53) c_ack!367)
                     ((_ to_fp 11 53) roundNearestTiesToEven d_ack!368))
...
(assert (fp.eq ((_ to_fp 11 53) c_ack!367) ((_ to_fp 11 53) #x0000000000000000)))
