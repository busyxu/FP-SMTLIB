...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!602) ((_ to_fp 11 53) #x4049000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!601) ((_ to_fp 11 53) #x4000000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!601) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!601) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ACCURACY
    #x3ff0000000000000
    (fp.sub roundNearestTiesToEven
            (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) b_ack!601))
            (fp.div roundNearestTiesToEven ((_ to_fp 11 53) b_ack!601) a!3))))))
