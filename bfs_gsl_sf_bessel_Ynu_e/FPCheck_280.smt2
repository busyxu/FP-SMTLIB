...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!712) ((_ to_fp 11 53) #x4049000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!711) ((_ to_fp 11 53) #x4000000000000000)))
...
(let ((a!2 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   a!1))
                   ((_ to_fp 11 53) #x4000000000000000))))
  (FPCHECK_FDIV_UNDERFLOW (CF_sin a!2) a!2))))
