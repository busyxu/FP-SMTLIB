...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!576) ((_ to_fp 11 53) #x4049000000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!575) ((_ to_fp 11 53) #x4000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!575) ((_ to_fp 11 53) #x408f400000000000)))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             ((_ fp.to_sbv 32)
               roundTowardZero
...
(assert (let ((a!1 ((_ to_fp 11 53)
  ...
  (FPCHECK_FMUL_ACCURACY
    #x4000000000000000
    (fp.add roundNearestTiesToEven
            (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) a_ack!576) a!1)
            ((_ to_fp 11 53) #x4000000000000000)))))
