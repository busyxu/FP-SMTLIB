...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!85)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) y_ack!85)))
                   (fp.abs ((_ to_fp 11 53) y_ack!85)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) y_ack!85)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!85)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(assert (let ((a!1 (fp.leq (fp.div roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) x_ack!86))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (FPCHECK_FADD_OVERFLOW #x3ff0000000000000 (fp.abs ((_ to_fp 11 53) x_ack!86))))
