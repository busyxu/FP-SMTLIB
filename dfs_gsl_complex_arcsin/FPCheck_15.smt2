...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!49)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) y_ack!49)))
                   (fp.abs ((_ to_fp 11 53) y_ack!49)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) y_ack!49)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) y_ack!49)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) x_ack!50)) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (FPCHECK_FADD_OVERFLOW (fp.abs ((_ to_fp 11 53) x_ack!50)) #x3ff0000000000000))
