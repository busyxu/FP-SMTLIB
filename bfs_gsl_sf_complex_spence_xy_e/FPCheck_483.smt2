...
(let ((a!23 (fp.div roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    (fp.add roundNearestTiesToEven a!22 a!16))))))
  (not (fp.lt (fp.abs a!23) ((_ to_fp 11 53) #x3970000000000000))))))))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
      ...
      (a!9 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.div roundNearestTiesToEven
                                   a!2
                                   ((_ to_fp 11 53) #x7ff8000000000001))
                           (fp.sub roundNearestTiesToEven a!3 a!8))))
      ...
      (a!20 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.div roundNearestTiesToEven
                                    a!2
                                    ((_ to_fp 11 53) #x7ff8000000000001))
                            (fp.sub roundNearestTiesToEven a!16 a!19)))))
(let ((a!21 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!17)
                            a!20))))
  (FPCHECK_FADD_ACCURACY a!18 a!21)))))))))))))
