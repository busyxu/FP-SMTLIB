...
(assert (not (bvslt #x000186a0 a_ack!2969)))
...
(assert (bvslt #x00000001 a_ack!2969))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!2968))
  ...
  (fp.eq a!4
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x3fe0000000000000)
                         a!1))))))))
(assert (bvslt #x00000002 a_ack!2969))
...
(let ((a!4 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!4
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!2968)
                 ((_ to_fp 11 53) #x4014000000000000))))))))
(assert (bvslt #x00000003 a_ack!2969))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) b_ack!2968)
...
(let ((a!5 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!5
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!2968)
                 ((_ to_fp 11 53) #x401c000000000000)))))))))
(assert (bvslt #x00000004 a_ack!2969))
(assert (let ((a!1 (fp.eq (fp.abs (fp.mul roundNearestTiesToEven
                                  ((_ to_fp 11 53) b_ack!2968)
...
(let ((a!6 (fp.div roundNearestTiesToEven
  ...
  (fp.eq a!6
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) b_ack!2968)
                 ((_ to_fp 11 53) #x4022000000000000))))))))))
(assert (bvslt #x00000005 a_ack!2969))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!2968))
            ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x4026000000000000))
       ((_ to_fp 11 53) b_ack!2968)))
(assert (bvslt #x00000006 a_ack!2969))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!2968))
...
(let ((a!8 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 (fp.div roundNearestTiesToEven
                         ...
                         ((_ to_fp 11 53) #x401c000000000000)))
         ((_ to_fp 11 53) #x401c000000000000)))))))))))
(assert (bvslt #x00000007 a_ack!2969))
(assert (bvslt #x00000008 a_ack!2969))
(assert (bvslt #x00000009 a_ack!2969))
(assert (bvslt #x0000000a a_ack!2969))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!2968))
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!12 a!13)
         (fp.mul roundNearestTiesToEven
                 ...
                 (fp.div roundNearestTiesToEven
                         a!10
                         ((_ to_fp 11 53) #x4022000000000000))))))))))))))))))
(assert (bvslt #x0000000b a_ack!2969))
(assert (let ((a!1 (CF_log (fp.div roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x3ff0000000000000)
                                   ((_ to_fp 11 53) b_ack!2968))
