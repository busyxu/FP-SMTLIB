...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!794) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!794) ((_ to_fp 11 53) #x4018000000000000)))
(assert (FPCHECK_FMUL_OVERFLOW #x3fe0000000000000 b_ack!794))
