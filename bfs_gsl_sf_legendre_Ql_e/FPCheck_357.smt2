...
(assert (bvslt #x000186a0 a_ack!1119))
(assert (fp.lt ((_ to_fp 11 53) b_ack!1118) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.lt (CF_acos b_ack!1118) ((_ to_fp 11 53) #x3f20000000000000))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_ZERO
    ...
    (fp.mul roundNearestTiesToEven (CF_acos b_ack!1118) (CF_acos b_ack!1118)))))
