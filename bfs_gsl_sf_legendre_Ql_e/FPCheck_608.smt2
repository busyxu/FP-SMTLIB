...
(assert (not (bvslt #x000186a0 a_ack!1975)))
...
(assert (FPCHECK_FADD_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 a_ack!1975))
  #x0000000000000000))
