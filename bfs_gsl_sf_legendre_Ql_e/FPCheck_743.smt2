...
(declare-fun FPCHECK_FDIV_OVERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!2410) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2410) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt a_ack!2411 #x00000000)))
(assert (not (= #x00000000 a_ack!2411)))
(assert (not (= #x00000001 a_ack!2411)))
(assert (not (bvslt #x000186a0 a_ack!2411)))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2410) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4000000000000000)
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 a_ack!2411))
                           ((_ to_fp 11 53) #x0000000000000000))))
      (a!2 (fp.add roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53) roundNearestTiesToEven a_ack!2411)
...
(let ((a!19 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!18)
                            a!13))))
  (fp.eq (fp.sub roundNearestTiesToEven a!19 a!17)
         (fp.mul roundNearestTiesToEven
                 (fp.sub roundNearestTiesToEven
                         ((_ to_fp 11 53) #x0000000000000000)
                         a!18)
      ...
      (a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!18)
                            a!24))))
  (FPCHECK_FDIV_OVERFLOW a!19 a!28)))))))))))))
