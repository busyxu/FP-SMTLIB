...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!134) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!134) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (bvslt a_ack!135 #x00000000)))
(assert (= #x00000000 a_ack!135))
(assert (not (fp.leq ((_ to_fp 11 53) b_ack!134) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!134) ((_ to_fp 11 53) #x3ff0000000000000))))
