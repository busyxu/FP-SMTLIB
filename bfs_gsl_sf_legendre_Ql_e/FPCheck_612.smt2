...
(assert (not (bvslt #x000186a0 a_ack!1983)))
...
(assert (FPCHECK_FMUL_UNDERFLOW
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 a_ack!1983))
          ((_ to_fp 11 53) #x0000000000000000))
  (fp.add roundNearestTiesToEven
          ((_ to_fp 11 53) roundNearestTiesToEven (bvadd #x00000004 a_ack!1983))
          ((_ to_fp 11 53) #x0000000000000000))))
