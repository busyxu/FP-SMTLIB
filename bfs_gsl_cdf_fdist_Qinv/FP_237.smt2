...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3390) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3390) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3390) ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) x_ack!3390) ((_ to_fp 11 53) #x3fe0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) x_ack!3390) ((_ to_fp 11 53) #x3fb999999999999a))))
...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) x_ack!3390))))
(assert (not (fp.gt ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) x_ack!3390))))
