...
(assert (let ((a!1 ((_ to_fp 11 53)
             ...
             (ite (fp.gt ((_ to_fp 11 53) b_ack!312)
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (not (fp.lt (fp.div roundNearestTiesToEven a!2 ((_ to_fp 11 53) a_ack!314))
              (fp.div roundNearestTiesToEven ((_ to_fp 11 53) c_ack!313) a!2))))))
