...
(assert (not (bvult b_ack!776 a_ack!777)))
(assert (= a_ack!777 b_ack!776))
...
(assert (bvult (bvadd #x0000000000000008
       ...
       #x0000000000001001))
(assert (not (bvslt a_ack!777 #x00000000)))
(assert (= #x00000000 (bvand a_ack!777 #x00000001)))
...
(assert (bvslt (bvsub b_ack!776 a_ack!777) #x00000000))
