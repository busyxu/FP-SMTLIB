(declare-fun a_ack!2992 () (_ BitVec 64))
(declare-fun b_ack!2991 () (_ BitVec 64))
(declare-fun FPCHECK_FDIV_ACCURACY
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2992) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2992) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2991) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2991) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.add roundNearestTiesToEven
               (fp.sub roundNearestTiesToEven
                       ((_ to_fp 11 53) a_ack!2992)
      ...
      (a!60 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!10 a!52))
                            a!59)
                    (fp.mul roundNearestTiesToEven a!17 a!53)))
      ...
      (a!63 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    ...
                                    (fp.mul roundNearestTiesToEven a!24 a!54))
                            a!62)
                    (fp.mul roundNearestTiesToEven
                            (fp.add roundNearestTiesToEven
                                    a!27
                                    (fp.mul roundNearestTiesToEven a!29 a!30))
                            a!55))))
  (FPCHECK_FDIV_ACCURACY a!56 (fp.add roundNearestTiesToEven a!63 a!56)))))))))))))))))
