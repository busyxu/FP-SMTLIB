...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2654) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2654) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!10 (fp.div roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) #x4024000000000000))
                            ((_ to_fp 11 53) #x4028000000000000)))))
  (FPCHECK_FMUL_ACCURACY #x7ff0000000000001 a!10)))))))))))
