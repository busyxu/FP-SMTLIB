...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3822) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3822) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!3821) ((_ to_fp 11 53) #x0000000000000000)))
...
(let ((a!2 (CF_pow #x2772c2fc595456a7
  ...
  (FPCHECK_FDIV_OVERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x2772c2fc595456a7) a!2)
    #x3ff0000000000000))))
