...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3328) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!3328) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3327) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!3327) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!6 (fp.eq (fp.mul roundNearestTiesToEven
                  ...
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!6))))))
(assert (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 a_ack!3328))
