...
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!2870) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2869) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) b_ack!2869) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!58 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!57)
                    a!51)))
  (FPCHECK_FDIV_INVALID a!51 a!58)))))))))))))))))
