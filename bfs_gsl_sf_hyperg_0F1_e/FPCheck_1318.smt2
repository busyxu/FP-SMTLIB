...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3443) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!18 (fp.add roundNearestTiesToEven
      ...
      (a!20 (CF_exp (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven a!17 (CF_floor a!17))
                            a!19))))
  (FPCHECK_FMUL_UNDERFLOW
    (fp.mul roundNearestTiesToEven a!7 (CF_exp a!18))
    a!20)))))))))
