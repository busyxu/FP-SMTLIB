...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!4480) ((_ to_fp 11 53) #x0000000000000000))))
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    ((_ to_fp 11 53) a_ack!4480))))))
  (not (fp.gt a!10 ((_ to_fp 11 53) #xc076232bdd7abcd2))))))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ((_ to_fp 11 53) a_ack!4480)
...
(let ((a!10 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            ...
                            (fp.sub roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x3ff0000000000000)
                                    ((_ to_fp 11 53) a_ack!4480))))))
  (fp.gt (fp.add roundNearestTiesToEven a!10 (CF_log (fp.abs a!16)))
