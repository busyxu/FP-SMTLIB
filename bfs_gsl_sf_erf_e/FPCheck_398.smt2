...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!878))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 ((_ to_fp 11 53) a_ack!878))
         (fp.div roundNearestTiesToEven
                 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) a_ack!878) a!1)
                 ((_ to_fp 11 53) #x4008000000000000))))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) #x4008000000000000)))))
  (fp.eq a!3 ((_ to_fp 11 53) a_ack!878))))))
...
(let ((a!32 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY
    a!32
    (fp.div roundNearestTiesToEven a!33 ((_ to_fp 11 53) #x4046800000000000)))))))))))))))))
