...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1164))
...
(let ((a!2 (fp.add roundNearestTiesToEven
  ...
  (fp.eq (fp.sub roundNearestTiesToEven a!2 ((_ to_fp 11 53) a_ack!1164))
         (fp.div roundNearestTiesToEven
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) a_ack!1164)
                         a!1)
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ...
                                   a!1)
                           ((_ to_fp 11 53) #x4008000000000000)))))
  (fp.eq a!3 ((_ to_fp 11 53) a_ack!1164))))))
...
(let ((a!44 (fp.add roundNearestTiesToEven
                    ...
                    a!43)))
  (FPCHECK_FMUL_ACCURACY #x3ff20dd750429b6d a!44)))))))))))))))))))
