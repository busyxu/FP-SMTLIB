...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!1503))
            ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!1503))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) a_ack!1503))
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) a_ack!1503))
...
(let ((a!14 (fp.mul roundNearestTiesToEven
      ...
      (a!15 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.abs (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!6 a!12)
                                    (CF_exp a!13)))))
      (a!16 (fp.abs (fp.sub roundNearestTiesToEven
                            ((_ to_fp 11 53) #x3ff0000000000000)
                            (fp.mul roundNearestTiesToEven
                                    (fp.div roundNearestTiesToEven a!6 a!12)
                                    (CF_exp a!13))))))
