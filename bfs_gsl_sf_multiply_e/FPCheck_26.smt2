...
(assert (not (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!117))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!118))
            (fp.abs ((_ to_fp 11 53) b_ack!117)))))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) a_ack!118))
       (fp.abs ((_ to_fp 11 53) b_ack!117))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!118))
            ((_ to_fp 11 53) #x5feccccccccccccc))))
(assert (FPCHECK_FDIV_ACCURACY #x7feffffffffffffb (fp.abs ((_ to_fp 11 53) a_ack!118))))
