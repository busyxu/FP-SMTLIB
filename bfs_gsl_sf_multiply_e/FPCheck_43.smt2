...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) b_ack!201))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.leq (fp.abs ((_ to_fp 11 53) b_ack!201))
        ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) a_ack!202))
             ((_ to_fp 11 53) #x3ff0000000000000))))
...
(assert (FPCHECK_FMUL_OVERFLOW a_ack!202 b_ack!201))
