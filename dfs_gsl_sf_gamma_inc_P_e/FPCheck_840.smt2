...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1977) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1978) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1977)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1977)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1977) ((_ to_fp 11 53) a_ack!1978))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1978 #x403f000000000000))
