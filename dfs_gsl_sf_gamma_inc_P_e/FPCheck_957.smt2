...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2211) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2212) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2211)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2211)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2211) ((_ to_fp 11 53) a_ack!2212))))
