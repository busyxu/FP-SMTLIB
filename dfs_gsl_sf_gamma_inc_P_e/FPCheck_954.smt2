...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2205) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2206) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2205)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2205)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2205) ((_ to_fp 11 53) a_ack!2206))))
...
(let ((a!46 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!46)))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!2206 #x4042800000000000))
