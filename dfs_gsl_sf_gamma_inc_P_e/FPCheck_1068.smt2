...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2433) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2434) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2433)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2434) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2433)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2433) ((_ to_fp 11 53) a_ack!2434))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!2434 #x4045800000000000))
