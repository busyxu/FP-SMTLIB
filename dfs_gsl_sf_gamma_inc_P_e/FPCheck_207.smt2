...
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!708) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt ((_ to_fp 11 53) b_ack!707) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!708) ((_ to_fp 11 53) #x4024000000000000))))
