...
(assert (fp.lt ((_ to_fp 11 53) b_ack!601)
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!602) ((_ to_fp 11 53) #x4330000000000000)))
(assert (FPCHECK_FDIV_OVERFLOW #x3ff0000000000000 a_ack!602))
