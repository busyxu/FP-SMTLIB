...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1483) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1483) ((_ to_fp 11 53) a_ack!1484))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1484 #x4032000000000000))
