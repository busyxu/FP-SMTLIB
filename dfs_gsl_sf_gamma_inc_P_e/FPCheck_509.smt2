...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1315) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1316) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!1315)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1316) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1315)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1315) ((_ to_fp 11 53) a_ack!1316))))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW (fp.add roundNearestTiesToEven a!14 a!15) a!16)))))))))))))))
