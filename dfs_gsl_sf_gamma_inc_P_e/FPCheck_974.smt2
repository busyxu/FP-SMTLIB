...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2245) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2246) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2245)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2245)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2245) ((_ to_fp 11 53) a_ack!2246))))
...
(assert (FPCHECK_FADD_ACCURACY a_ack!2246 #x4043000000000000))
