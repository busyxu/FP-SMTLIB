...
(assert (fp.lt ((_ to_fp 11 53) b_ack!3271) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!3272) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!3271)
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3271)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!3271) ((_ to_fp 11 53) a_ack!3272))))
...
(let ((a!81 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!81)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!3272 #x4050400000000000))
