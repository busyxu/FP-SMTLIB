...
(assert (fp.lt ((_ to_fp 11 53) b_ack!2431) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2432) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!2431)
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!2432) ((_ to_fp 11 53) #x4330000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2431)
            (fp.mul roundNearestTiesToEven
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!2431) ((_ to_fp 11 53) a_ack!2432))))
...
(assert (FPCHECK_FADD_OVERFLOW a_ack!2432 #x4045800000000000))
