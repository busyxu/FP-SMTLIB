...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1447) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1447) ((_ to_fp 11 53) a_ack!1448))))
...
(let ((a!21 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!21)))))))))))))))))))
(assert (FPCHECK_FADD_ACCURACY a_ack!1448 #x4031000000000000))
