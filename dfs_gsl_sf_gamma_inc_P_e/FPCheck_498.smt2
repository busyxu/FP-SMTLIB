...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1293) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1293) ((_ to_fp 11 53) a_ack!1294))))
...
(let ((a!16 (fp.lt (fp.abs (fp.div roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3cb0000000000000))))
  (not a!16)))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1294 #x402a000000000000))
