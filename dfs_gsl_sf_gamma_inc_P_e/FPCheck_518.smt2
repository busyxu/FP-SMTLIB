...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1333) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1333) ((_ to_fp 11 53) a_ack!1334))))
...
(assert (FPCHECK_FADD_ACCURACY a_ack!1334 #x402c000000000000))
