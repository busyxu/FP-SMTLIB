...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1217) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1217) ((_ to_fp 11 53) a_ack!1218))))
...
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1218 #x4026000000000000))
