...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1439) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1439) ((_ to_fp 11 53) a_ack!1440))))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
      ...
      (a!20 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            a!14)
                    a!15)))
  (FPCHECK_FDIV_INVALID a!16 (fp.add roundNearestTiesToEven a!20 a!16)))))))))))))))))))
