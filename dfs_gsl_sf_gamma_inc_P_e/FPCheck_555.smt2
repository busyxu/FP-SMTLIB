...
(assert (fp.lt ((_ to_fp 11 53) b_ack!1407) ((_ to_fp 11 53) #x4034000000000000)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1408) ((_ to_fp 11 53) #x4024000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1408) ((_ to_fp 11 53) #x40c0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!1408) ((_ to_fp 11 53) #x4330000000000000))))
...
(assert (not (fp.gt ((_ to_fp 11 53) b_ack!1407) ((_ to_fp 11 53) a_ack!1408))))
...
(let ((a!19 (fp.add roundNearestTiesToEven
  ...
  (not (fp.lt (fp.abs (fp.div roundNearestTiesToEven a!15 a!19))
              ((_ to_fp 11 53) #x3cb0000000000000))))))))))))))))))))
(assert (FPCHECK_FADD_UNDERFLOW a_ack!1408 #x4030000000000000))
