...
(assert (fp.lt ((_ to_fp 11 53) b_ack!519) ((_ to_fp 11 53) #x4034000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!520) ((_ to_fp 11 53) #x4024000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!519)
       (fp.mul roundNearestTiesToEven
               ((_ to_fp 11 53) #x3fe0000000000000)
               ((_ to_fp 11 53) a_ack!520))))
(assert (FPCHECK_FDIV_OVERFLOW b_ack!519 a_ack!520))
