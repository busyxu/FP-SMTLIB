...
(declare-fun FPCHECK_FDIV_ZERO
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!353) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!353) ((_ to_fp 11 53) #xbff0000000000000)))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           (fp.add roundNearestTiesToEven
                                   ...
                                   a!1)
                           a!2)
                   (fp.add roundNearestTiesToEven (CF_exp a_ack!353) a!1))))
  (fp.eq a!3 a!2)))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (CF_exp a_ack!353)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ...
                           a!2)
                   a!2)))
  (fp.eq a!3 (fp.add roundNearestTiesToEven (CF_exp a_ack!353) a!1))))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (CF_exp a_ack!353)
                   (fp.mul roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
