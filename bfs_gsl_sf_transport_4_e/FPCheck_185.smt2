...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!260) ((_ to_fp 11 53) #x3e68000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) a_ack!260) ((_ to_fp 11 53) #x4010000000000000))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!260) ((_ to_fp 11 53) #x404205966f2b4f12)))
