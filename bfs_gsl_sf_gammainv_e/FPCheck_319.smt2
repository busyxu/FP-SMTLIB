...
(assert (fp.leq ((_ to_fp 11 53) a_ack!528) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!528) (CF_floor a_ack!528))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!528) ((_ to_fp 11 53) #x3fe0000000000000)))
