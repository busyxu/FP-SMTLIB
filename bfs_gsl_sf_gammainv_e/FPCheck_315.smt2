...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (fp.leq ((_ to_fp 11 53) a_ack!516) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!516) (CF_floor a_ack!516))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!516) ((_ to_fp 11 53) #xc3045f306dc9c883)))
