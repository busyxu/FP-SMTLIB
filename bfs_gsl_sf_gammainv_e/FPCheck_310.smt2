...
(declare-fun FPCHECK_FDIV_UNDERFLOW
             ...
             Bool)
(assert (fp.leq ((_ to_fp 11 53) a_ack!508) ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.eq ((_ to_fp 11 53) a_ack!508) (CF_floor a_ack!508))))
(assert (fp.lt ((_ to_fp 11 53) a_ack!508) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (fp.eq (fp.div roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) #x400921fb54442d18))
       ((_ to_fp 11 53) a_ack!508)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!508))
