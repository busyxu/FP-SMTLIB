...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4564) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4563) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4564) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4563)))
(assert (= #x00000000 b_ack!4563))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4564))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4564))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4564))
                           (fp.abs ((_ to_fp 11 53) c_ack!4564))))))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
      ...
      (a!28 (fp.sub roundNearestTiesToEven
                    (CF_sin (fp.abs ((_ to_fp 11 53) c_ack!4564)))
                    (CF_cos (fp.abs ((_ to_fp 11 53) c_ack!4564))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           (fp.sub roundNearestTiesToEven
