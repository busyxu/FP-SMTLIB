(declare-fun a_ack!4457 () (_ BitVec 32))
(declare-fun b_ack!4455 () (_ BitVec 32))
(declare-fun c_ack!4456 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!4457 #x00000000)))
(assert (not (bvslt b_ack!4455 a_ack!4457)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4456) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4455) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4456) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4455)))
(assert (= #x00000000 b_ack!4455))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4456))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4456))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4456))
                           (fp.abs ((_ to_fp 11 53) c_ack!4456))))))
...
(let ((a!52 (fp.add roundNearestTiesToEven
      ...
      (a!54 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.abs a!50))
                    ((_ to_fp 11 53) #x3f72b9d550b1f542)))
      (a!55 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    a!50)
                            ((_ to_fp 11 53) #xbf72b9d550b1f542)))))
  (FPCHECK_FADD_OVERFLOW
    (fp.add roundNearestTiesToEven a!52 a!54)
    (fp.add roundNearestTiesToEven
            (fp.add roundNearestTiesToEven (fp.abs a!55) (fp.abs a!53))
            ((_ to_fp 11 53) #x3fd7b301ba8e73fd))))))))))))))))))))))))))))))
