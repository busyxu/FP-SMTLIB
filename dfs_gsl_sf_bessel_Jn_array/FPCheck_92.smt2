...
(assert (not (bvslt (bvadd #x00000001 b_ack!411) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!412) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!411)))
...
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!412)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.abs ((_ to_fp 11 53) c_ack!412)))
                   (fp.abs ((_ to_fp 11 53) c_ack!412)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) c_ack!412)))))
(assert (let ((a!1 (fp.eq (fp.abs (fp.abs ((_ to_fp 11 53) c_ack!412)))
                  ((_ to_fp 11 53) #x0000000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.abs ((_ to_fp 11 53) c_ack!412)))))
  (fp.eq a!1 (fp.abs ((_ to_fp 11 53) c_ack!412)))))
(assert (bvsle a_ack!413 b_ack!411))
(assert (bvult (bvmul #x0000000000000008
              ((_ sign_extend 32) (bvsub b_ack!411 a_ack!413)))
       #x0000000000000319))
