...
(assert (not (bvslt (bvadd #x00000001 b_ack!216) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!217) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!216)))
(assert (= #x00000000 b_ack!216))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!217))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!217))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!217))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!217))
...
(let ((a!4 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    #x0000000000000000
    (fp.add roundNearestTiesToEven a!4 ((_ to_fp 11 53) #x3c895d4100811d0c))))))))
