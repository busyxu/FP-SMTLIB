...
(assert (not (bvslt b_ack!3141 a_ack!3143)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3142) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!3141) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3142) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!3141)))
(assert (= #x00000000 b_ack!3141))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!3142))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!3142))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!3142))
                           (fp.abs ((_ to_fp 11 53) c_ack!3142))))))
