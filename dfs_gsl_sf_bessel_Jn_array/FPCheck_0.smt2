...
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!22) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!21) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!22) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!21)))
(assert (not (= #x00000000 b_ack!21)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!22) ((_ to_fp 11 53) #x0000000000000000))))
(assert (FPCHECK_FMUL_OVERFLOW c_ack!22 c_ack!22))
