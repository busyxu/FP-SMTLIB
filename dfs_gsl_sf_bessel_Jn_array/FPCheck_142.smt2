...
(assert (not (bvslt (bvadd #x00000001 b_ack!639) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!640) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!639)))
(assert (= #x00000000 b_ack!639))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!640))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!640))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   (fp.abs (fp.mul roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 11 53) #x0000000000000000)))
                   ((_ to_fp 11 53) #x0000000000000000))))
  (FPCHECK_FADD_ACCURACY a!4 #x3c8cd2b297d889bc))))))
