...
(declare-fun FPCHECK_FADD_OVERFLOW
             ...
             Bool)
(assert (not (bvslt a_ack!1511 #x00000000)))
(assert (not (bvslt b_ack!1509 a_ack!1511)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!1510) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!1509) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!1510) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!1509)))
(assert (= #x00000000 b_ack!1509))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!1510))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!1510))
