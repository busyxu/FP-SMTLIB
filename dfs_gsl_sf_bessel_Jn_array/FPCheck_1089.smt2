(declare-fun a_ack!4475 () (_ BitVec 32))
(declare-fun b_ack!4473 () (_ BitVec 32))
(declare-fun c_ack!4474 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(assert (not (bvslt a_ack!4475 #x00000000)))
(assert (not (bvslt b_ack!4473 a_ack!4475)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4474) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4473) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4474) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4473)))
(assert (= #x00000000 b_ack!4473))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4474))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4474))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) c_ack!4474))
                           (fp.abs ((_ to_fp 11 53) c_ack!4474))))))
...
(let ((a!56 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW #x3cb0000000000000 a!56)))))))))))))))))))))))))))))
