...
(assert (not (bvslt b_ack!177 a_ack!179)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!178) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!177) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!178) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!177)))
(assert (= #x00000000 b_ack!177))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!178))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!178))
            ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!178))
            ((_ to_fp 11 53) #x3e66a09e667f3bcd))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!178))
       ((_ to_fp 11 53) #x4010000000000000)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x3fc0000000000000)
                           (fp.abs ((_ to_fp 11 53) c_ack!178)))
                   (fp.abs ((_ to_fp 11 53) c_ack!178)))))
