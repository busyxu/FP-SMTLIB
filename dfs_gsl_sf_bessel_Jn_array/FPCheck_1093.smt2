(declare-fun a_ack!4496 () (_ BitVec 32))
(declare-fun b_ack!4494 () (_ BitVec 32))
(declare-fun c_ack!4495 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ BitVec 64))
             Bool)
(assert (not (bvslt a_ack!4496 #x00000000)))
(assert (not (bvslt b_ack!4494 a_ack!4496)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!4495) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt (bvadd #x00000001 b_ack!4494) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4495) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!4494)))
(assert (= #x00000000 b_ack!4494))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!4495))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) c_ack!4495))
...
(let ((a!56 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3cb0000000000000) a!56)
    #x3c870ef54646d497)))))))))))))))))))))))))))))
