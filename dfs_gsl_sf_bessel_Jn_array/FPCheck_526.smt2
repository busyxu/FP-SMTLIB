...
(assert (not (bvslt (bvadd #x00000001 b_ack!2118) #x00000000)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2119) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #xffffffff b_ack!2118)))
(assert (= #x00000000 b_ack!2118))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!2119))
