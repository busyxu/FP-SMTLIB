...
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!453))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!453))))))
  (not a!1)))
(assert (bvslt #x00000002 a_ack!454))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!453))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!453))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 a_ack!454))
...
(assert (bvslt #x00000004 a_ack!454))
