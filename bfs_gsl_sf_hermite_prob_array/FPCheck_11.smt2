...
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!41)) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (FPCHECK_FDIV_ACCURACY #x7feccccccccccccc (fp.abs ((_ to_fp 11 53) b_ack!41))))
