...
(assert (not (= #x00000001 a_ack!646)))
(assert (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!645))
       ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (bvslt #x00000001 a_ack!646))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!645))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!645))))))
  (not a!1)))
(assert (bvslt #x00000002 a_ack!646))
...
(assert (bvslt #x00000003 a_ack!646))
...
(assert (bvslt #x00000004 a_ack!646))
...
(assert (bvslt #x00000005 a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(assert (bvslt #x00000006 a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(assert (bvslt #x00000007 a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(assert (bvslt #x00000008 a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(assert (bvslt #x00000009 a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(let ((a!9 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!9
         (fp.mul roundNearestTiesToEven
                 ((_ to_fp 11 53) #x4022000000000000)
                 a!7))))))))))))
(assert (bvslt #x0000000a a_ack!646))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
...
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) b_ack!645))
...
(let ((a!9 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #x4022000000000000)
                                   a!7)))))
  (fp.eq (fp.div roundNearestTiesToEven a!9 ((_ to_fp 11 53) b_ack!645))
         (fp.sub roundNearestTiesToEven
                 a!8
                 (fp.mul roundNearestTiesToEven
                         ((_ to_fp 11 53) #x4022000000000000)
...
(let ((a!10 (fp.div roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ((_ to_fp 11 53) #x4022000000000000)
                                    a!7)))))
  (fp.eq a!10 ((_ to_fp 11 53) b_ack!645)))))))))))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!645)
                           ((_ to_fp 11 53) b_ack!645))
