...
(assert (bvslt #x00000001 a_ack!596))
(assert (let ((a!1 (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!595))
                  (fp.div roundNearestTiesToEven
                          ((_ to_fp 11 53) #x7feccccccccccccc)
                          (fp.abs ((_ to_fp 11 53) b_ack!595))))))
  (not a!1)))
(assert (bvslt #x00000002 a_ack!596))
...
(let ((a!2 (fp.gt a!1
                  (fp.div roundNearestTiesToEven
                          ...
                          (fp.abs ((_ to_fp 11 53) b_ack!595))))))
  (not a!2))))
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!595))
            ((_ to_fp 11 53) #x7fdccccccccccccc))))
(assert (bvslt #x00000003 a_ack!596))
...
(assert (bvslt #x00000004 a_ack!596))
...
(assert (bvslt #x00000005 a_ack!596))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!595)
                           ((_ to_fp 11 53) b_ack!595))
...
(assert (bvslt #x00000006 a_ack!596))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!595)
                           ((_ to_fp 11 53) b_ack!595))
...
(assert (bvslt #x00000007 a_ack!596))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!595)
                           ((_ to_fp 11 53) b_ack!595))
...
(assert (bvslt #x00000008 a_ack!596))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!595)
                           ((_ to_fp 11 53) b_ack!595))
...
(assert (bvslt #x00000009 a_ack!596))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) b_ack!595)
                           ((_ to_fp 11 53) b_ack!595))
