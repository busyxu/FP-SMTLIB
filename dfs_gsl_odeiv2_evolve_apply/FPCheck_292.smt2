...
(declare-fun h_ack!2710 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2709 () (_ BitVec 64))
(declare-fun y0_ack!2708 () (_ BitVec 64))
...
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) t_ack!2706))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!2710) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!2707)
                ((_ to_fp 11 53) t_ack!2706))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!2710)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!2709))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!2708)
                                   ((_ to_fp 11 53) y0_ack!2708))
...
(let ((a!22 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!2706))
                            a!21))))
  (FPCHECK_FSUB_UNDERFLOW #x8000000000000000 a!22)))))))))))))
