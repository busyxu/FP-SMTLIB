...
(declare-fun t1_ack!2758 () (_ BitVec 64))
(declare-fun h_ack!2761 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!2760 () (_ BitVec 64))
(declare-fun y0_ack!2759 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!2758)
...
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) t_ack!2757))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!2761) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!2758)
                ((_ to_fp 11 53) t_ack!2757))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!2761)
