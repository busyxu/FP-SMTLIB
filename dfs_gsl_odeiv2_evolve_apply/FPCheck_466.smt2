(declare-fun t_ack!4390 () (_ BitVec 64))
(declare-fun t1_ack!4391 () (_ BitVec 64))
(declare-fun h_ack!4394 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4393 () (_ BitVec 64))
(declare-fun y0_ack!4392 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4391)
                    ((_ to_fp 11 53) t_ack!4390))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!4391)
               ((_ to_fp 11 53) t_ack!4390))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!4394) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!4391)
                ((_ to_fp 11 53) t_ack!4390))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!4394)
...
(let ((a!37 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!4390))
                            a!36))))
  (FPCHECK_FMUL_UNDERFLOW a!37 a!37)))))))))))))))))))
