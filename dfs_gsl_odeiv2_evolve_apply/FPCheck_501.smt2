(declare-fun t_ack!4739 () (_ BitVec 64))
(declare-fun t1_ack!4740 () (_ BitVec 64))
(declare-fun h_ack!4743 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4742 () (_ BitVec 64))
(declare-fun y0_ack!4741 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4740)
                    ((_ to_fp 11 53) t_ack!4739))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!4740)
               ((_ to_fp 11 53) t_ack!4739))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!4743) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!4740)
                ((_ to_fp 11 53) t_ack!4739))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!4743)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4742))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4741)
                                   ((_ to_fp 11 53) y0_ack!4741))
...
(let ((a!35 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ...
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!4742) a!35)))))))))))))))))))
