(declare-fun t_ack!3858 () (_ BitVec 64))
(declare-fun t1_ack!3859 () (_ BitVec 64))
(declare-fun h_ack!3862 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!3861 () (_ BitVec 64))
(declare-fun y0_ack!3860 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3859)
                    ((_ to_fp 11 53) t_ack!3858))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!3859)
               ((_ to_fp 11 53) t_ack!3858))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!3862) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!3859)
                ((_ to_fp 11 53) t_ack!3858))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!3862)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3861))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3860)
                                   ((_ to_fp 11 53) y0_ack!3860))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY
    #xbfc61b7ccdaf2f38
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3861) a!34))))))))))))))))))
