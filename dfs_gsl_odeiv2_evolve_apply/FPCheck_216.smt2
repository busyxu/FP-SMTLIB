(declare-fun t_ack!1996 () (_ BitVec 64))
(declare-fun t1_ack!1997 () (_ BitVec 64))
(declare-fun h_ack!2000 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!1999 () (_ BitVec 64))
(declare-fun y0_ack!1998 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!1997)
                    ((_ to_fp 11 53) t_ack!1996))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!1997)
               ((_ to_fp 11 53) t_ack!1996))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!2000) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!1997)
                ((_ to_fp 11 53) t_ack!1996))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!2000)
...
(let ((a!20 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    ...
                                    a!19)))))
  (FPCHECK_FADD_OVERFLOW y1_ack!1999 a!20)))))))))))
