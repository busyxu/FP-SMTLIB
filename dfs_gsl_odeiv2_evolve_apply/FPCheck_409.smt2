(declare-fun t_ack!3848 () (_ BitVec 64))
(declare-fun t1_ack!3849 () (_ BitVec 64))
(declare-fun h_ack!3852 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ BitVec 64) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!3851 () (_ BitVec 64))
(declare-fun y0_ack!3850 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3849)
                    ((_ to_fp 11 53) t_ack!3848))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!3849)
               ((_ to_fp 11 53) t_ack!3848))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!3852) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!3849)
                ((_ to_fp 11 53) t_ack!3848))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!3852)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!3851))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!3850)
                                   ((_ to_fp 11 53) y0_ack!3850))
...
(let ((a!34 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #xbfc61b7ccdaf2f38
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3851) a!34))))))))))))))))))
