(declare-fun t_ack!5406 () (_ BitVec 64))
(declare-fun t1_ack!5407 () (_ BitVec 64))
(declare-fun h_ack!5410 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(declare-fun y0_ack!5408 () (_ BitVec 64))
(declare-fun y1_ack!5409 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!5407)
                    ((_ to_fp 11 53) t_ack!5406))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!5407)
               ((_ to_fp 11 53) t_ack!5406))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!5410) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!5407)
                ((_ to_fp 11 53) t_ack!5406))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!5410)
...
(let ((a!46 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW
    (fp.mul roundNearestTiesToEven
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!5408) a!46)
            (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!5408) a!46))
    #x3ff0000000000000))))))))))))))))))))))
