(declare-fun t_ack!4777 () (_ BitVec 64))
(declare-fun t1_ack!4778 () (_ BitVec 64))
(declare-fun h_ack!4781 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4778)
                    ((_ to_fp 11 53) t_ack!4777))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!4778)
               ((_ to_fp 11 53) t_ack!4777))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!4781) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!4778)
                ((_ to_fp 11 53) t_ack!4777))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!4781)
...
(let ((a!43 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!4777))
                            a!42))))
  (FPCHECK_FMUL_UNDERFLOW #x3fcb16e62e7158fc a!43)))))))))))))))))))))
