(declare-fun t_ack!4139 () (_ BitVec 64))
(declare-fun t1_ack!4140 () (_ BitVec 64))
(declare-fun h_ack!4143 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y1_ack!4142 () (_ BitVec 64))
(declare-fun y0_ack!4141 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4140)
                    ((_ to_fp 11 53) t_ack!4139))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!4140)
               ((_ to_fp 11 53) t_ack!4139))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!4143) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!4140)
                ((_ to_fp 11 53) t_ack!4139))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!4143)
...
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) y1_ack!4142))
                   (fp.sub roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) y0_ack!4141)
                                   ((_ to_fp 11 53) y0_ack!4141))
...
(let ((a!33 (fp.sub roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    a!27
    (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) #x3fc93651ea2bd3c4) a!33)))))))))))))))))
