...
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) t_ack!3042))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!3046) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!3043)
                ((_ to_fp 11 53) t_ack!3042))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!3046)
...
(let ((a!28 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!3042))
                            a!27))))
  (FPCHECK_FMUL_ACCURACY #x3f8a4f6f83ae9731 a!28)))))))))))))))
