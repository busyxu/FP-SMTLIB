...
(declare-fun t1_ack!3472 () (_ BitVec 64))
(declare-fun h_ack!3475 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y0_ack!3473 () (_ BitVec 64))
(declare-fun y1_ack!3474 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!3472)
...
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) t_ack!3471))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!3475) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!3472)
                ((_ to_fp 11 53) t_ack!3471))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!3475)
...
(let ((a!30 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    #x8000000000000000
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!3473) a!30)))))))))))))))))
