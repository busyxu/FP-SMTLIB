(declare-fun t_ack!4339 () (_ BitVec 64))
(declare-fun t1_ack!4340 () (_ BitVec 64))
(declare-fun h_ack!4343 () (_ BitVec 64))
(declare-fun FPCHECK_FSUB_ACCURACY ((_ BitVec 64) (_ FloatingPoint 11 53)) Bool)
(declare-fun y1_ack!4342 () (_ BitVec 64))
(declare-fun y0_ack!4341 () (_ BitVec 64))
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ((_ to_fp 11 53) t1_ack!4340)
                    ((_ to_fp 11 53) t_ack!4339))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!4340)
               ((_ to_fp 11 53) t_ack!4339))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!4343) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!4340)
                ((_ to_fp 11 53) t_ack!4339))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!4343)
...
(let ((a!37 (fp.add roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            (fp.sub roundNearestTiesToEven
                                    ...
                                    ((_ to_fp 11 53) t_ack!4339))
                            a!36))))
  (FPCHECK_FSUB_ACCURACY #x8000000000000000 a!37)))))))))))))))))))
