...
(declare-fun h_ack!2128 () (_ BitVec 64))
(declare-fun FPCHECK_FMUL_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(declare-fun y0_ack!2126 () (_ BitVec 64))
(declare-fun y1_ack!2127 () (_ BitVec 64))
...
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ...
               ((_ to_fp 11 53) t_ack!2124))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!2128) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!2125)
                ((_ to_fp 11 53) t_ack!2124))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!2128)
...
(let ((a!16 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!2126) a!16)
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y0_ack!2126) a!16)))))))))))
