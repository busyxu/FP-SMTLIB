(declare-fun t_ack!3726 () (_ BitVec 64))
(declare-fun t1_ack!3727 () (_ BitVec 64))
(declare-fun h_ack!3730 () (_ BitVec 64))
...
(assert (not (fp.lt (fp.sub roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) t_ack!3726))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.gt (fp.sub roundNearestTiesToEven
               ((_ to_fp 11 53) t1_ack!3727)
               ((_ to_fp 11 53) t_ack!3726))
       ((_ to_fp 11 53) #x0000000000000000)))
(assert (not (fp.lt ((_ to_fp 11 53) h_ack!3730) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.geq (fp.sub roundNearestTiesToEven
                ((_ to_fp 11 53) t1_ack!3727)
                ((_ to_fp 11 53) t_ack!3726))
        ((_ to_fp 11 53) #x0000000000000000)))
(assert (fp.gt ((_ to_fp 11 53) h_ack!3730)
...
(let ((a!20 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    #x3fa26ba035d10b6d
    (fp.add roundNearestTiesToEven ((_ to_fp 11 53) y1_ack!3729) a!20))))))))))))
