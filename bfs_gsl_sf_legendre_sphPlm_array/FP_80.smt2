...
(assert (bvslt #x00000000 b_ack!2028))
...
(assert (not (fp.leq ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2028)
...
(assert (not (fp.gt ((_ to_fp 11 53) #x3fe0000000000000)
            (fp.mul roundNearestTiesToEven
                    ...
                    ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2028)))))
(assert (not (fp.gt ((_ to_fp 11 53) roundNearestTiesToEven b_ack!2028)
