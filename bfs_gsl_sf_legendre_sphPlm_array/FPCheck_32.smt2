...
(assert (not (bvslt #x00000000 b_ack!165)))
(assert (= #x00000000 b_ack!165))
(assert (not (= a_ack!167 b_ack!165)))
(assert (not (= a_ack!167 (bvadd #x00000001 b_ack!165))))
(assert (bvsle (bvadd #x00000002 b_ack!165) a_ack!167))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!165)))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000002 b_ack!165))))))
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!165 b_ack!165)))
                   a!1)))
