...
(assert (not (bvslt #x00000000 b_ack!2187)))
(assert (= #x00000000 b_ack!2187))
(assert (not (= a_ack!2189 b_ack!2187)))
(assert (not (= a_ack!2189 (bvadd #x00000001 b_ack!2187))))
(assert (bvsle (bvadd #x00000002 b_ack!2187) a_ack!2189))
(assert (bvsle (bvadd #x00000003 b_ack!2187) a_ack!2189))
(assert (bvsle (bvadd #x00000004 b_ack!2187) a_ack!2189))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvadd b_ack!2187 b_ack!2187)))
                   ((_ to_fp 11 53) #x3fd20dd750429b6d))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000003 (bvadd b_ack!2187 b_ack!2187)))
                   a!3)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) #x3ff5775c544ff263))
         a!4)))))
(assert (bvsle (bvadd #x00000005 b_ack!2187) a_ack!2189))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!2188)
                           ((_ to_fp 11 53) #x3ffbb67ae8584caa))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!2187 b_ack!2187)))
                   a!1)))
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!2188)
...
(let ((a!8 (fp.sub roundNearestTiesToEven
      ...
      (a!10 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000004 (bvadd b_ack!2187 b_ack!2187)))
                    a!6)))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!11
         (fp.mul roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x3ff40e9b94633b4c)))))))))))
(assert (bvsle (bvadd #x00000006 b_ack!2187) a_ack!2189))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4014000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000006 b_ack!2187 b_ack!2187))
