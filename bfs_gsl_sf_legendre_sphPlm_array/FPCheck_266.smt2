...
(assert (not (bvslt #x00000000 b_ack!1200)))
(assert (= #x00000000 b_ack!1200))
(assert (not (= a_ack!1202 b_ack!1200)))
(assert (not (= a_ack!1202 (bvadd #x00000001 b_ack!1200))))
(assert (bvsle (bvadd #x00000002 b_ack!1200) a_ack!1202))
(assert (bvsle (bvadd #x00000003 b_ack!1200) a_ack!1202))
(assert (bvsle (bvadd #x00000004 b_ack!1200) a_ack!1202))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvadd b_ack!1200 b_ack!1200)))
                   ((_ to_fp 11 53) #x3fd20dd750429b6d))))
(let ((a!3 (fp.sub roundNearestTiesToEven
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1200 b_ack!1200)))
                   a!1)))
...
(let ((a!6 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_ACCURACY c_ack!1201 a!6))))))
