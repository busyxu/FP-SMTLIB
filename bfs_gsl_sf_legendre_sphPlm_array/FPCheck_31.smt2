...
(assert (not (bvslt #x00000000 b_ack!162)))
(assert (= #x00000000 b_ack!162))
(assert (not (= a_ack!164 b_ack!162)))
(assert (not (= a_ack!164 (bvadd #x00000001 b_ack!162))))
(assert (bvsle (bvadd #x00000002 b_ack!162) a_ack!164))
(assert (let ((a!1 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!162)))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xffffffff (bvmul #x00000002 (bvadd #x00000002 b_ack!162))))))
(let ((a!2 (fp.mul roundNearestTiesToEven
                   (fp.div roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!162 b_ack!162)))
                   a!1)))
