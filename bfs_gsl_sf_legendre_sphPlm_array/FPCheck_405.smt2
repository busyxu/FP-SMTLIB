...
(assert (bvsle (bvadd #x00000004 b_ack!1815) a_ack!1817))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvadd b_ack!1815 b_ack!1815)))
                   ((_ to_fp 11 53) #x3fd20dd750429b6d))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000003 (bvadd b_ack!1815 b_ack!1815)))
                   a!3)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) #x3ff5775c544ff263))
         a!4)))))
(assert (bvsle (bvadd #x00000005 b_ack!1815) a_ack!1817))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1816)
                           ((_ to_fp 11 53) #x3ffbb67ae8584caa))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1815 b_ack!1815)))
                   a!1)))
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1816)
...
(let ((a!7 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000004 (bvadd b_ack!1815 b_ack!1815)))
                   a!6)))
