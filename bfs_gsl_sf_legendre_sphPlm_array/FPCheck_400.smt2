...
(assert (bvsle (bvadd #x00000004 b_ack!1791) a_ack!1793))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvadd b_ack!1791 b_ack!1791)))
                   ((_ to_fp 11 53) #x3fd20dd750429b6d))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000003 (bvadd b_ack!1791 b_ack!1791)))
                   a!3)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) #x3ff5775c544ff263))
         a!4)))))
(assert (bvsle (bvadd #x00000005 b_ack!1791) a_ack!1793))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1792)
                           ((_ to_fp 11 53) #x3ffbb67ae8584caa))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!1791 b_ack!1791)))
                   a!1)))
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!1792)
...
(let ((a!6 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_OVERFLOW
    ((_ to_fp 11 53)
      roundNearestTiesToEven
      (bvadd #x00000004 (bvadd b_ack!1791 b_ack!1791)))
    a!6))))))
