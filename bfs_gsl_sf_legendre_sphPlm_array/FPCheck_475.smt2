...
(let ((a!3 (fp.sub roundNearestTiesToEven
      ...
      (a!5 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000002 (bvadd b_ack!2214 b_ack!2214)))
                   a!1)))
(let ((a!4 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) c_ack!2215)
...
(let ((a!8 (fp.sub roundNearestTiesToEven
      ...
      (a!10 (fp.mul roundNearestTiesToEven
                    ((_ to_fp 11 53)
                      roundNearestTiesToEven
                      (bvadd #x00000004 (bvadd b_ack!2214 b_ack!2214)))
                    a!6)))
...
(let ((a!11 (fp.sub roundNearestTiesToEven
  ...
  (fp.eq a!11
         (fp.mul roundNearestTiesToEven
                 a!10
                 ((_ to_fp 11 53) #x3ff40e9b94633b4c)))))))))))
(assert (bvsle (bvadd #x00000006 b_ack!2214) a_ack!2216))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4014000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000006 b_ack!2214 b_ack!2214))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000006 b_ack!2214)))))
      (a!4 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xfffffffd (bvmul #x00000002 (bvadd #x00000006 b_ack!2214))))))
