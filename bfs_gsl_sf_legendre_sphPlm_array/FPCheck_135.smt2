...
(assert (not (bvslt #x00000000 b_ack!624)))
(assert (= #x00000000 b_ack!624))
(assert (not (= a_ack!626 b_ack!624)))
(assert (not (= a_ack!626 (bvadd #x00000001 b_ack!624))))
(assert (bvsle (bvadd #x00000002 b_ack!624) a_ack!626))
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             ...
                             (bvadd #x00000001 b_ack!624 b_ack!624))
                           ((_ to_fp 11 53) #x3fd20dd750429b6d))
