...
(assert (not (bvslt #x00000000 b_ack!192)))
(assert (= #x00000000 b_ack!192))
(assert (not (= a_ack!194 b_ack!192)))
(assert (not (= a_ack!194 (bvadd #x00000001 b_ack!192))))
(assert (bvsle (bvadd #x00000002 b_ack!192) a_ack!194))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!192 b_ack!192))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!192)))))
      (a!4 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xfffffffd (bvmul #x00000002 (bvadd #x00000002 b_ack!192))))))
