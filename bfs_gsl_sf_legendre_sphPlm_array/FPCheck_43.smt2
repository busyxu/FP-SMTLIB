...
(assert (not (bvslt #x00000000 b_ack!198)))
(assert (= #x00000000 b_ack!198))
(assert (not (= a_ack!200 b_ack!198)))
(assert (not (= a_ack!200 (bvadd #x00000001 b_ack!198))))
(assert (bvsle (bvadd #x00000002 b_ack!198) a_ack!200))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!198 b_ack!198))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!198)))))
      (a!4 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xfffffffd (bvmul #x00000002 (bvadd #x00000002 b_ack!198))))))
