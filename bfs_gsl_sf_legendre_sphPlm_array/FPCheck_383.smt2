...
(assert (bvsle (bvadd #x00000003 b_ack!1713) a_ack!1715))
(assert (bvsle (bvadd #x00000004 b_ack!1713) a_ack!1715))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
      ...
      (a!2 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvadd #x00000001 (bvadd b_ack!1713 b_ack!1713)))
                   ((_ to_fp 11 53) #x3fd20dd750429b6d))))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvadd #x00000003 (bvadd b_ack!1713 b_ack!1713)))
                   a!3)))
...
(let ((a!4 (fp.mul roundNearestTiesToEven
  ...
  (fp.eq (fp.div roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) #x3ff5775c544ff263))
         a!4)))))
(assert (bvsle (bvadd #x00000005 b_ack!1713) a_ack!1715))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x4010000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000005 b_ack!1713 b_ack!1713))
