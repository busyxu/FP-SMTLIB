...
(assert (not (bvslt #x00000000 b_ack!171)))
(assert (= #x00000000 b_ack!171))
(assert (not (= a_ack!173 b_ack!171)))
(assert (not (= a_ack!173 (bvadd #x00000001 b_ack!171))))
(assert (bvsle (bvadd #x00000002 b_ack!171) a_ack!173))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!171 b_ack!171))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
