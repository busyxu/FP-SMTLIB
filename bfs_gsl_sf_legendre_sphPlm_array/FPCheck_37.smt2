...
(assert (not (bvslt #x00000000 b_ack!180)))
(assert (= #x00000000 b_ack!180))
(assert (not (= a_ack!182 b_ack!180)))
(assert (not (= a_ack!182 (bvadd #x00000001 b_ack!180))))
(assert (bvsle (bvadd #x00000002 b_ack!180) a_ack!182))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!180 b_ack!180))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!180))))))
