...
(assert (not (bvslt #x00000000 b_ack!174)))
(assert (= #x00000000 b_ack!174))
(assert (not (= a_ack!176 b_ack!174)))
(assert (not (= a_ack!176 (bvadd #x00000001 b_ack!174))))
(assert (bvsle (bvadd #x00000002 b_ack!174) a_ack!176))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!174 b_ack!174))
                           ((_ to_fp 11 53) #x3ff0000000000000)))))
