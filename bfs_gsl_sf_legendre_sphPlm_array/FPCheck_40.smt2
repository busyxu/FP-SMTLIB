...
(assert (not (bvslt #x00000000 b_ack!189)))
(assert (= #x00000000 b_ack!189))
(assert (not (= a_ack!191 b_ack!189)))
(assert (not (= a_ack!191 (bvadd #x00000001 b_ack!189))))
(assert (bvsle (bvadd #x00000002 b_ack!189) a_ack!191))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvadd #x00000002 b_ack!189 b_ack!189))
                           ((_ to_fp 11 53) #x3ff0000000000000))))
      (a!3 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #x00000001 (bvmul #x00000002 (bvadd #x00000002 b_ack!189)))))
      (a!4 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (bvadd #xfffffffd (bvmul #x00000002 (bvadd #x00000002 b_ack!189))))))
