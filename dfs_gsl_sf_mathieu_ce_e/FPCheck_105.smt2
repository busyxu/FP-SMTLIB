...
(assert (= #x00000000 (bvsrem n_ack!502 #x00000002)))
...
(assert (not (= #x00000001 n_ack!502)))
(assert (not (= #x00000002 n_ack!502)))
(assert (not (= #x00000003 n_ack!502)))
(assert (bvslt n_ack!502 #x00000046))
(assert (FPCHECK_FMUL_OVERFLOW
  #x3fd0000000000000
  ((_ to_fp 11 53)
    roundNearestTiesToEven
    (bvadd #x00000001 (bvmul #x00000002 n_ack!502)))))
