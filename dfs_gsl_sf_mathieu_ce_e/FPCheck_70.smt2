...
(assert (not (bvslt n_ack!348 #x00000046)))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (fp.add roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvmul n_ack!348 n_ack!348))
...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   ((_ to_fp 11 53) #x3f50624dd2f1a9fc))))
  (fp.eq a!1
         ((_ to_fp 11 53) roundNearestTiesToEven (bvmul n_ack!348 n_ack!348)))))
(assert (not (= #x00000000 n_ack!348)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ((_ to_fp 11 53) #x4000000000000000)
                           ((_ to_fp 11 53) a_ack!349)))))
  (fp.eq a!1 ((_ to_fp 11 53) a_ack!349))))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) a_ack!349))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.div roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
  ...
  (fp.eq a!1
         (fp.mul roundNearestTiesToEven
                 ...
                 ((_ to_fp 11 53) a_ack!349)))))
(assert (not (= #x00000002 n_ack!348)))
(assert (bvslt #x00000000 (bvadd #xffffffff (bvsdiv n_ack!348 #x00000002))))
(assert (FPCHECK_FMUL_OVERFLOW a_ack!349 a_ack!349))
