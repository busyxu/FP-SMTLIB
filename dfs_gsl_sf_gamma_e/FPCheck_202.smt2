...
(declare-fun FPCHECK_FMUL_ACCURACY
             ...
             Bool)
(assert (fp.lt ((_ to_fp 11 53) a_ack!332) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!332) ((_ to_fp 11 53) #xc065200000000000))))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!332) ((_ to_fp 11 53) #xc1dfffffff800000))))
