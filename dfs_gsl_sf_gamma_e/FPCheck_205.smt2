...
(assert (fp.lt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #x3fe0000000000000)))
...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #xc065200000000000))))
...
(assert (fp.gt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #xc3045f306dc9c883)))
...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!342) ((_ to_fp 11 53) #xc1dfffffff800000))))
