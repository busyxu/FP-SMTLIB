...
(assert (let ((a!1 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven
  ...
  (not a!1)))
(assert (not (fp.lt ((_ to_fp 11 53) d_ack!597) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) #x3ff0000000000000) ((_ to_fp 11 53) d_ack!597))))
...
(assert (FPCHECK_FMUL_ACCURACY d_ack!597 d_ack!597))
