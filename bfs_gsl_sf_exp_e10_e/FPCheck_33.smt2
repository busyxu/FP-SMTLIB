...
(assert (not (fp.gt ((_ to_fp 11 53) a_ack!49) ((_ to_fp 11 53) #x41dfffffff800000))))
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!49) ((_ to_fp 11 53) #xc1dfffffffc00000))))
(assert (fp.gt ((_ to_fp 11 53) a_ack!49) ((_ to_fp 11 53) #x40862e42fefa39ef)))
