...
(declare-fun d_ack!829 () (_ BitVec 64))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) d_ack!829))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!828) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) d_ack!829))
       ((_ to_fp 11 53) #x3fd0000000000000)))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) a_ack!830))
...
(let ((a!3 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!2
                                   ((_ to_fp 11 53) d_ack!829))))))
  (FPCHECK_FSUB_UNDERFLOW #x3ff0000000000000 a!3)))))
