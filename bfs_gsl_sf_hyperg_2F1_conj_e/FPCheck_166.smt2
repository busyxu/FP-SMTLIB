...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) d_ack!1084))
...
(assert (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!1082))
       ((_ to_fp 11 53) #x4024000000000000)))
(assert (fp.lt ((_ to_fp 11 53) d_ack!1084) ((_ to_fp 11 53) #xbfd0000000000000)))
