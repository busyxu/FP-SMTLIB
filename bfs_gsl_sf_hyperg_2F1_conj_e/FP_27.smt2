...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) d_ack!553))
...
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) d_ack!553))
            ((_ to_fp 11 53) #x3fd0000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!552) ((_ to_fp 11 53) #x0000000000000000))))
