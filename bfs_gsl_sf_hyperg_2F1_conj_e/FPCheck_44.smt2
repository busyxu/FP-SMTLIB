...
(declare-fun d_ack!291 () (_ BitVec 64))
...
(assert (not (fp.geq (fp.abs ((_ to_fp 11 53) d_ack!291))
             ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!290) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt (fp.abs ((_ to_fp 11 53) d_ack!291))
...
(let ((a!2 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    ...
    (fp.mul roundNearestTiesToEven
            ((_ to_fp 11 53) #x3ff0000000000000)
            (fp.mul roundNearestTiesToEven a!2 ((_ to_fp 11 53) d_ack!291)))))))
