...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2946) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          ...
                          ((_ to_fp 11 53) c_ack!2946))
                  ((_ to_fp 11 53) #x3ff0000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul a_ack!2947 a_ack!2947))
...
(assert (fp.lt (CF_cosh c_ack!2946) ((_ to_fp 11 53) #x5fdfffffffffffff)))
