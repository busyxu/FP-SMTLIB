...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3669) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!3668))
...
(assert (fp.lt (CF_cosh c_ack!3669) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_OVERFLOW a!27 a!31))))))))))
