...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3057) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (fp.lt (CF_cosh c_ack!3057) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
      ...
      (a!20 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!8
                            (fp.add roundNearestTiesToEven a!18 a!19)))))
  (FPCHECK_FADD_ACCURACY a!16 a!20))))))))
