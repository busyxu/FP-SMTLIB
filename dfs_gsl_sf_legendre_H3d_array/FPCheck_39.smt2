...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!222) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (FPCHECK_FSUB_OVERFLOW
  ((_ to_fp 11 53) roundNearestTiesToEven (bvsub #x00000000 a_ack!223))
  #x3fe0000000000000))
