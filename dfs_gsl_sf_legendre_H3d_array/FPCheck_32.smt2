...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!177) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvmul a_ack!178 a_ack!178))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!176))
                           (fp.abs ((_ to_fp 11 53) b_ack!176))))))
  (FPCHECK_FDIV_ZERO
    (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3ff0000000000000))
    (fp.mul roundNearestTiesToEven (CF_cosh c_ack!177) (CF_cosh c_ack!177)))))
