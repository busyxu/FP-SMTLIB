...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3765) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!3764))
...
(assert (fp.lt (CF_cosh c_ack!3765) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!23 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FADD_ACCURACY (fp.abs a!23) (fp.abs a!26)))))))))))
