...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!897) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt (CF_cosh c_ack!897) ((_ to_fp 11 53) #x5fdfffffffffffff))))
...
(let ((a!9 (fp.mul roundNearestTiesToEven
                   ...
                   (fp.add roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   (fp.div roundNearestTiesToEven a!8 a!7)
                                   ((_ to_fp 11 53) #x0000000000000000))))))
  (FPCHECK_FDIV_OVERFLOW a!9 #x3ff0000000000000)))))))
