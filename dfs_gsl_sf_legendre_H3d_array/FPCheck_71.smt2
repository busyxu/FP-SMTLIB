...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!339) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt (CF_cosh c_ack!339) ((_ to_fp 11 53) #x5fdfffffffffffff))))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3fe0000000000000)
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53)
                             roundNearestTiesToEven
                             (bvsub #x00000000 a_ack!340))
                           ((_ to_fp 11 53) #x3fe0000000000000)))))
