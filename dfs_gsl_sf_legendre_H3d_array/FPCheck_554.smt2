...
(declare-fun FPCHECK_FADD_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3051) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!3052 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3051) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!3052)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3051) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3051) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!3052)))
(assert (not (= #x00000001 a_ack!3052)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3051) ((_ to_fp 11 53) #x0000000000000000))))
...
(assert (fp.lt (CF_cosh c_ack!3051) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!16 (fp.mul roundNearestTiesToEven
      ...
      (a!20 (fp.mul roundNearestTiesToEven
                    ...
                    (fp.mul roundNearestTiesToEven
                            a!8
                            (fp.add roundNearestTiesToEven a!18 a!19)))))
  (FPCHECK_FADD_UNDERFLOW a!16 a!20))))))))
