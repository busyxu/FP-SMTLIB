...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3504) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!3503))
...
(assert (fp.lt (CF_cosh c_ack!3504) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xbfe0000000000000)
                                   ((_ to_fp 11 53) b_ack!3503))))))
  (FPCHECK_FMUL_UNDERFLOW a!4 #x4008000000000000)))))
