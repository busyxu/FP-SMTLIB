...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!303) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt (CF_cosh c_ack!303) ((_ to_fp 11 53) #x5fdfffffffffffff))))
(assert (FPCHECK_FMUL_OVERFLOW #xbfe0000000000000 b_ack!302))
