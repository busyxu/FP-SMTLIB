...
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!504) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!505 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!504) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt (CF_cosh c_ack!504) ((_ to_fp 11 53) #x5fdfffffffffffff))))
