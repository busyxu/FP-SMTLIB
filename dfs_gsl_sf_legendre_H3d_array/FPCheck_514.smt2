...
(declare-fun FPCHECK_FADD_ACCURACY
             ...
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2796) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!2797 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2796) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!2795))
...
(assert (fp.lt (CF_cosh c_ack!2796) ((_ to_fp 11 53) #x5fdfffffffffffff)))
