...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1578) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!1577))
...
(assert (not (fp.lt (CF_cosh c_ack!1578) ((_ to_fp 11 53) #x5fdfffffffffffff))))
