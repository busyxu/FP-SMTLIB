(declare-fun c_ack!3846 () (_ BitVec 64))
(declare-fun a_ack!3847 () (_ BitVec 32))
(declare-fun b_ack!3845 () (_ BitVec 64))
(declare-fun CF_cosh ((_ BitVec 64)) (_ FloatingPoint 11 53))
(declare-fun FPCHECK_FMUL_UNDERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3846) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!3847 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3846) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!3847)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!3846) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3846) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!3847)))
(assert (not (= #x00000001 a_ack!3847)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!3846) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!3845))
                          ((_ to_fp 11 53) c_ack!3846))
                  ((_ to_fp 11 53) #x3ff0000000000000))))
  (not a!1)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     roundNearestTiesToEven
                     (bvmul a_ack!3847 a_ack!3847))
...
(assert (fp.lt (CF_cosh c_ack!3846) ((_ to_fp 11 53) #x5fdfffffffffffff)))
(assert (let ((a!1 (fp.mul roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x8000000000000000)
                           ((_ to_fp 11 53) b_ack!3845))
                   (fp.sub roundNearestTiesToEven
                           ((_ to_fp 11 53) #x8000000000000000)
                           ((_ to_fp 11 53) b_ack!3845)))))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FMUL_UNDERFLOW
    (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x4008000000000000))
    (fp.add roundNearestTiesToEven a!27 a!31)))))))))))
