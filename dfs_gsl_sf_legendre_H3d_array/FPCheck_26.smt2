...
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!141) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (bvslt a_ack!142 #x00000000)))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!141) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
  ...
  (not a!1)))
(assert (FPCHECK_FMUL_UNDERFLOW (CF_cosh c_ack!141) (CF_cosh c_ack!141)))
