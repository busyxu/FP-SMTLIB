...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!663) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!662))
...
(assert (not (fp.lt (CF_cosh c_ack!663) ((_ to_fp 11 53) #x5fdfffffffffffff))))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xbfe0000000000000)
                                   ((_ to_fp 11 53) b_ack!662))))))
  (FPCHECK_FMUL_OVERFLOW a!4 #x3ff0000000000000)))))
