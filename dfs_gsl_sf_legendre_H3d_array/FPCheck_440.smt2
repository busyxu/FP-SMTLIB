...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2418) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (fp.lt (CF_cosh c_ack!2418) ((_ to_fp 11 53) #x5fdfffffffffffff)))
