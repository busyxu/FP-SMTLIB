...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2163) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!2164)))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2163) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!2163) ((_ to_fp 11 53) #x40862e42fefa39ef))))
(assert (not (= #x00000000 a_ack!2164)))
(assert (not (= #x00000001 a_ack!2164)))
(assert (not (fp.eq ((_ to_fp 11 53) c_ack!2163) ((_ to_fp 11 53) #x0000000000000000))))
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!2162))
...
(assert (fp.lt (CF_cosh c_ack!2163) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!4 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) #xbfe0000000000000)
                                   ((_ to_fp 11 53) b_ack!2162))))))
  (FPCHECK_FMUL_UNDERFLOW a!4 #x3ff0000000000000)))))
