...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3681) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (fp.lt (CF_cosh c_ack!3681) ((_ to_fp 11 53) #x5fdfffffffffffff)))
...
(let ((a!27 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY a!27 a!31))))))))))
