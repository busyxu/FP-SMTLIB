...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!3747) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.lt (fp.mul roundNearestTiesToEven
                          (fp.abs ((_ to_fp 11 53) b_ack!3746))
...
(assert (fp.lt (CF_cosh c_ack!3747) ((_ to_fp 11 53) #x5fdfffffffffffff)))
