...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!174) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53)
                     ...
                     (bvmul a_ack!175 a_ack!175))
                   (fp.mul roundNearestTiesToEven
                           (fp.abs ((_ to_fp 11 53) b_ack!173))
                           (fp.abs ((_ to_fp 11 53) b_ack!173))))))
  (FPCHECK_FDIV_INVALID
    (fp.div roundNearestTiesToEven a!1 ((_ to_fp 11 53) #x3ff0000000000000))
    (fp.mul roundNearestTiesToEven (CF_cosh c_ack!174) (CF_cosh c_ack!174)))))
