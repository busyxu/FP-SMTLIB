...
(assert (not (fp.gt ((_ to_fp 11 53) c_ack!1125) ((_ to_fp 11 53) #x40862e42fefa39ef))))
...
(assert (not (fp.lt (CF_cosh c_ack!1125) ((_ to_fp 11 53) #x5fdfffffffffffff))))
