...
(assert (fp.gt ((_ to_fp 11 53) a_ack!566) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
(assert (not (fp.lt (fp.abs ((_ to_fp 11 53) b_ack!565))
            ((_ to_fp 11 53) #x5fe9999999999999))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!566)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!1 ((_ to_fp 11 53) a_ack!566))
         (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!566)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565))))))
(let ((a!2 (fp.sub roundNearestTiesToEven
                   a!1
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565))))))
  (fp.eq a!2 ((_ to_fp 11 53) a_ack!566)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!566)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!565)))))
