...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!364) ((_ to_fp 11 53) #x40762e42fefa39ef))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!363)))))
      (a!2 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!364)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!363)))))
      (a!5 ((_ to_fp 11 53)
             roundNearestTiesToEven
             (ite (fp.geq ((_ to_fp 11 53) b_ack!363)
