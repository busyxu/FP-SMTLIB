...
(assert (not (fp.gt (fp.abs ((_ to_fp 11 53) b_ack!181))
            ((_ to_fp 11 53) #x2003333333333333))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!182)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!181))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!181))))))
  (FPCHECK_FADD_OVERFLOW (fp.abs ((_ to_fp 11 53) a_ack!182)) a!1)))
