...
(assert (not (fp.lt ((_ to_fp 11 53) a_ack!278) ((_ to_fp 11 53) #x40762e42fefa39ef))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) a_ack!278)
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!277))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!277))))))
  (FPCHECK_FADD_OVERFLOW (fp.abs ((_ to_fp 11 53) a_ack!278)) a!1)))
