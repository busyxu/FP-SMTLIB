...
(assert (fp.lt ((_ to_fp 11 53) a_ack!208) ((_ to_fp 11 53) #x40762e42fefa39ef)))
(assert (fp.gt ((_ to_fp 11 53) a_ack!208) ((_ to_fp 11 53) #xc076232bdd7abcd2)))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (CF_log (fp.abs ((_ to_fp 11 53) b_ack!207))))))
...
(assert (let ((a!1 (fp.abs (CF_log (fp.abs ((_ to_fp 11 53) b_ack!207)))))
...
(let ((a!3 ((_ fp.to_sbv 32)
  ...
  (FPCHECK_FADD_UNDERFLOW
    (fp.add roundNearestTiesToEven (fp.abs ((_ to_fp 11 53) a_ack!208)) a!1)
