...
(declare-fun b_ack!890 () (_ BitVec 32))
(declare-fun c_ack!891 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!892 #x00000000)))
(assert (not (bvslt b_ack!890 a_ack!892)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (= #x00000000 b_ack!890)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!891) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!12 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.add roundNearestTiesToEven
                            a!10
                            ((_ to_fp 11 53) #x3dffb014035fe5c4)))))
  (FPCHECK_FADD_OVERFLOW a!12 #x3e850b0771f4ea8b))))))))))))))
