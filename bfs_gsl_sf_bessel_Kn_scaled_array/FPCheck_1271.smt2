...
(assert (not (bvslt a_ack!5125 #x00000000)))
(assert (not (bvslt b_ack!5123 a_ack!5125)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5124) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!5123))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5124) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!5124) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5124))
...
(let ((a!7 (fp.add roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_ACCURACY
    a!7
    (fp.mul roundNearestTiesToEven (CF_log c_ack!5124) a!12))))))))))
