...
(assert (not (= #x00000000 b_ack!4622)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x4020000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x0020000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!4623) ((_ to_fp 11 53) #x4020000000000000))))
(assert (bvsle (bvadd #x00000001 a_ack!4624) (bvadd #x00000001 b_ack!4622)))
...
(let ((a!17 (fp.div roundNearestTiesToEven
  ...
  (fp.lt a!17 ((_ to_fp 11 53) #x7fefffffffffffff))))))))))))))))))))
