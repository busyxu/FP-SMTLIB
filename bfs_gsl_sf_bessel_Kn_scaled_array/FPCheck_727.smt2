...
(declare-fun b_ack!2837 () (_ BitVec 32))
(declare-fun c_ack!2838 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW ((_ FloatingPoint 11 53) (_ BitVec 64)) Bool)
(assert (not (bvslt a_ack!2839 #x00000000)))
(assert (not (bvslt b_ack!2837 a_ack!2839)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2838) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2837))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2838) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2838) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2838) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!17 (fp.add roundNearestTiesToEven
                    ...
                    (fp.abs (fp.add roundNearestTiesToEven
                                    a!14
                                    ((_ to_fp 11 53) #x3f22ef1bcd47bec8))))))
  (FPCHECK_FADD_OVERFLOW a!17 #x3f789d425fd7dd93)))))))))))))))))))
