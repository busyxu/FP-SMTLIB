...
(assert (not (bvslt b_ack!2102 a_ack!2104)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2103) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2102))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2103) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2103) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2103) ((_ to_fp 11 53) #x4020000000000000))))
...
(let ((a!8 (fp.add roundNearestTiesToEven
                   ...
                   (fp.abs (fp.add roundNearestTiesToEven
                                   a!5
                                   ((_ to_fp 11 53) #xbce15ca386b00802))))))
  (FPCHECK_FADD_OVERFLOW a!8 #x3d4d319102e9251a))))))))))
