(declare-fun a_ack!2950 () (_ BitVec 32))
(declare-fun b_ack!2948 () (_ BitVec 32))
(declare-fun c_ack!2949 () (_ BitVec 64))
(declare-fun FPCHECK_FADD_OVERFLOW
             ((_ FloatingPoint 11 53) (_ FloatingPoint 11 53))
             Bool)
(assert (not (bvslt a_ack!2950 #x00000000)))
(assert (not (bvslt b_ack!2948 a_ack!2950)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2949) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!2948))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2949) ((_ to_fp 11 53) #x0000000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) c_ack!2949) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!2949) ((_ to_fp 11 53) #x4020000000000000))))
