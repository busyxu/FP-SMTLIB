(declare-fun a_ack!5314 () (_ BitVec 32))
(declare-fun b_ack!5312 () (_ BitVec 32))
...
(assert (not (bvslt a_ack!5314 #x00000000)))
(assert (not (bvslt b_ack!5312 a_ack!5314)))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5313) ((_ to_fp 11 53) #x0000000000000000))))
(assert (= #x00000000 b_ack!5312))
(assert (not (fp.leq ((_ to_fp 11 53) c_ack!5313) ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.lt ((_ to_fp 11 53) c_ack!5313) ((_ to_fp 11 53) #x3ff0000000000000)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5313))
            ((_ to_fp 11 53) #x0000000000000000))))
(assert (fp.eq (fp.div roundNearestTiesToEven
               (fp.mul roundNearestTiesToEven
                       ((_ to_fp 11 53) c_ack!5313)
                       ((_ to_fp 11 53) c_ack!5313))
               ((_ to_fp 11 53) c_ack!5313))
       ((_ to_fp 11 53) c_ack!5313)))
(assert (not (fp.eq (fp.abs ((_ to_fp 11 53) c_ack!5313))
...
(let ((a!13 (fp.add roundNearestTiesToEven
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log c_ack!5313)
                                    a!12))
                    (fp.mul roundNearestTiesToEven (CF_log c_ack!5313) a!12))))
  (fp.eq a!13 a!7))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3e14c2029d5d2fb5)
                   (fp.mul roundNearestTiesToEven
...
(let ((a!13 (fp.sub roundNearestTiesToEven
                    ...
                    (fp.sub roundNearestTiesToEven
                            ...
                            (fp.mul roundNearestTiesToEven
                                    (CF_log c_ack!5313)
                                    a!12)))))
  (fp.eq a!13 (fp.mul roundNearestTiesToEven (CF_log c_ack!5313) a!12)))))))))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ((_ to_fp 11 53) #x3ff999999999999a)
                   (fp.mul roundNearestTiesToEven
                           (fp.abs (CF_log c_ack!5313))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           (fp.abs (CF_log c_ack!5313))
                           ((_ to_fp 11 53) #x3fe3333333333333)))))
  (FPCHECK_FMUL_UNDERFLOW (CF_exp c_ack!5313) a!1)))
