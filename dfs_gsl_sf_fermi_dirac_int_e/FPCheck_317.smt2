...
(assert (= #x00000002 a_ack!880))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!879) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!879) ((_ to_fp 11 53) #xbff0000000000000))))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!879) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!879) ((_ to_fp 11 53) #x4010000000000000)))
