...
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!735) ((_ to_fp 11 53) #x3ff0000000000000))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!735) ((_ to_fp 11 53) #x4010000000000000)))
