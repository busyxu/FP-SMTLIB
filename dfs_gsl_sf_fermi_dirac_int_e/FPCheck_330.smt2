...
(assert (= #x00000002 a_ack!926))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!925) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!925) ((_ to_fp 11 53) #xbff0000000000000)))
