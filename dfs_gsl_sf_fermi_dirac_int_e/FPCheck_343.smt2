...
(assert (= #x00000002 a_ack!978))
(assert (not (fp.lt ((_ to_fp 11 53) b_ack!977) ((_ to_fp 11 53) #xc086232bdd7abcd2))))
(assert (fp.lt ((_ to_fp 11 53) b_ack!977) ((_ to_fp 11 53) #xbff0000000000000)))
...
(let ((a!2 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   a!1
                                   ((_ to_fp 11 53) #x3fe0000000000000))))))
  (fp.eq (fp.sub roundNearestTiesToEven a!2 (CF_exp b_ack!977))
         (fp.mul roundNearestTiesToEven
                 (CF_exp b_ack!977)
                 (fp.mul roundNearestTiesToEven
                         a!1
