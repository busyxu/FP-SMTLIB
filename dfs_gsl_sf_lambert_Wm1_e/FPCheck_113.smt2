...
(declare-fun FPCHECK_FSUB_UNDERFLOW
             ...
             Bool)
(assert (fp.gt ((_ to_fp 11 53) a_ack!189) ((_ to_fp 11 53) #x0000000000000000)))
...
(assert (fp.lt ((_ to_fp 11 53) a_ack!189) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FSUB_UNDERFLOW #x3fea34b4b6225768 a!1)))
