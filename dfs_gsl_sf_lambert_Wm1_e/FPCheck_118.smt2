...
(assert (fp.lt ((_ to_fp 11 53) a_ack!196) ((_ to_fp 11 53) #x3ff0000000000000)))
...
(assert (let ((a!1 (fp.div roundNearestTiesToEven
  ...
  (FPCHECK_FADD_OVERFLOW
    (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) #x3fea34b4b6225768) a!1)
    #x3ff0000000000000)))
