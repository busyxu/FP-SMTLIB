...
(assert (fp.gt ((_ to_fp 11 53) a_ack!393) ((_ to_fp 11 53) #x4008000000000000)))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!393)
                           (CF_log (CF_log a_ack!393)))
                   (CF_log (CF_log a_ack!393)))))
  (fp.eq a!1 (CF_log a_ack!393))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   (CF_log a_ack!393)
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!393)
                           (CF_log (CF_log a_ack!393))))))
  (fp.eq a!1 (CF_log (CF_log a_ack!393)))))
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           (CF_log a_ack!393)
                           (CF_log (CF_log a_ack!393)))
...
(let ((a!2 (fp.mul roundNearestTiesToEven
  ...
  (FPCHECK_FDIV_INVALID
    (fp.sub roundNearestTiesToEven a!2 ((_ to_fp 11 53) a_ack!393))
    a!3))))
